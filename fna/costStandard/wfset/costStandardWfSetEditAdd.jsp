...
//"第#LineNumber#行报销金额超出标准，此项最多报销#BaseLimit#元！";
String overStandardTips = FnaLanguage.getPromptSC_costStandardWfSetEditAdd(user.getLanguage());
boolean enable = true;
String templateFile = FnaWfSet.TEMPLATE_COST_STANDARD_FILE;
String templateFileMobile = FnaWfSet.TEMPLATE_COST_STANDARD_FILE_MOBILE;
%>
<%@page import="weaver.filter.XssUtil"%>
<%@page import="weaver.fna.general.FnaLanguage"%><HTML><HEAD>
...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value="<%=SystemEnv.getHtmlLabelName(125597,user.getLanguage()) %>"/>
</jsp:include>

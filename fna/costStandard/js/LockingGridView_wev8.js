...
Ext.ux.grid.LockingGridView = Ext.extend(Ext.grid.GridView, {
    ...
    syncScroll : function(e){
        ...
        if(this.scroller.dom>this.lockedScroller.dom.scrollTop)
        	alert(this.lockedScroller.dom.scrollTop);
    },
    syncScroll2 : function(e){
        var mb = this.lockedScroller.dom;
		this.scroller.dom.scrollTop = mb.scrollTop;
    },
    ...
    doRender : function(cs, rs, ds, startRow, colCount, stripe){
        ...
        for(var j = 0, len = rs.length; j < len; j++){
            ...
            for(var i = 0; i < colCount; i++){
                ...
                p.style = c.style + (c.style=="width:0px;"?"display:none;":"");
    ...
    syncRowHeights: function(row1, row2){
    	//alert("syncRowHeights row1="+row1+";row2="+row2+";syncHeights="+this.syncHeights);
        if(this.syncHeights){
            ...
            var el1Dom = Ext.getDom(row1),
            	el2Dom = Ext.getDom(row2);
            ...
            /*
            var el1DomCellInnerJQuery = jQuery(el1Dom).find(".x-grid3-cell-inner");
            jQuery(el1DomCellInnerJQuery).css("height", h3);
            
            var el2DomCellInnerJQuery = jQuery(el2Dom).find(".x-grid3-cell-inner");
            jQuery(el2DomCellInnerJQuery).css("height", h3+2);
            */
        }
    },
    ...
    renderUI : function(){
        ...
        this.lockedScroller.on('scroll', this.syncScroll2,  this);

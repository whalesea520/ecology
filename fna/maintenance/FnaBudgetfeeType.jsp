...
<td  height=100% id=oTd1 name=oTd1 width="220px" style=’padding:0px’>
	<IFRAME name=leftframe id=leftframe src="/fna/maintenance/FnaBudgetfeeTypeLeft.jsp" width="100%" height="100%" frameborder=no scrolling=no>
	//浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</IFRAME>
</td>
<td height=100% id=oTd2 name=oTd2 width="*" style=’padding:0px’>
	<IFRAME name=optFrame id=optFrame src="/fna/maintenance/FnaBudgetfeeTypeView.jsp" width="100%" height="100%" frameborder=no scrolling=yes>
	//浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</IFRAME>
</td>
</tr>
</TBODY>

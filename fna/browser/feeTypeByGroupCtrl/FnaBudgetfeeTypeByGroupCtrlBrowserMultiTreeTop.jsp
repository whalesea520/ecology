...
var setting = {
	async: {
		enable: true,
		url:"/fna/browser/feeTypeByGroupCtrl/FnaBudgetfeeTypeByGroupCtrlBrowserMultiTreeAjax.jsp",
		autoParam:["id"],
		otherParam:{"otherParam":"0","feeperiod":"<%=feeperiod %>"},
		dataFilter: filter
	},
	callback: {
...
function fnaWfTree_onClick(event, treeId, treeNode, clickFlag) {
	try{
	    ...
	    parent.jQuery("#supsubject").val(id);
	    parent.btnOnSearch();
	}catch(e){
		alert(e.message);
	}

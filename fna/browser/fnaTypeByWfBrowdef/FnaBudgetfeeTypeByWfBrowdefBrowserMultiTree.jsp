...
String optFrame1 = "/fna/browser/fnaTypeByWfBrowdef/FnaBudgetfeeTypeByWfBrowdefBrowserMultiTreeTop.jsp";
String optFrame3 = "/fna/browser/fnaTypeByWfBrowdef/FnaBudgetfeeTypeByWfBrowdefBrowserMultiQuery.jsp";
String optFrame = "";
String type = "";
if(tabId==1){
	type = "tree";
...
<div class="zDialog_div_content">
	<FORM id="weaver" NAME="SearchForm" STYLE="margin-bottom:0" action="" onsubmit="return false;" method=post>
		...
		<input type="hidden" name="feeperiod" id="feeperiod" value="" />
...
function showMultiDialog(selectids){
    ...
    config.srcurl = "/fna/browser/fnaTypeByWfBrowdef/FnaBudgetfeeTypeByWfBrowdefBrowserMultiAjax.jsp?src=src";
    config.desturl = "/fna/browser/fnaTypeByWfBrowdef/FnaBudgetfeeTypeByWfBrowdefBrowserMultiAjax.jsp?src=dest";
    config.pagesize = 10;

...
String optFrame1 = "/fna/browser/costCenter/costCenterByWfBrowdef/costCenterByWfBrowdefMultiTreeTop.jsp";
String optFrame3 = "/fna/browser/costCenter/costCenterByWfBrowdef/costCenterByWfBrowdefMultiQuery.jsp";
String optFrame = "";
String type = "";
if(tabId==1){
	type = "tree";
...
<div class="zDialog_div_content">
	<FORM id="weaver" NAME="SearchForm" STYLE="margin-bottom:0" action="" onsubmit="return false;" method=post>
		...
		<input type="hidden" name="fccId" id="fccId" value="0" />
...
function showMultiDialog(selectids){
    ...
    config.srcurl = "/fna/browser/costCenter/costCenterByWfBrowdef/costCenterByWfBrowdefMultiAjax.jsp?src=src";
    config.desturl = "/fna/browser/costCenter/costCenterByWfBrowdef/costCenterByWfBrowdefMultiAjax.jsp?src=dest";
    config.pagesize = 10;

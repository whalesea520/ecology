...
String ysxxUrl = "/fna/browser/costCenter/costCenterByWfBrowdef/costCenterByWfBrowdefMultiTree.jsp";
if(tabId == 1){
	tabId1Class = "current";
}else if(tabId == 3){
	tabId2Class = "current";
...
<BODY scroll="no">
	...
	<div class="e8_boxhead">
	    ...
	    <div class="tab_box">
	        <div>
	            <iframe src="<%=ysxxUrl+"?tabId="+tabId+"&selectids="+selectids %>" onload="update();" id="tabcontentframe1" name="tabcontentframe1" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
	        </div>
	    </div>
	</div>     

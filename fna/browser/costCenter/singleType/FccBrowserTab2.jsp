...
<BODY>
	<FORM id=SearchForm name=SearchForm STYLE="margin-bottom:0" action="/fna/browser/costCenter/singleType/FccBrowserList.jsp" method=post target="frame2">
	...
	<input class=inputstyle type=hidden name=selectedid value=<%=selectedid%>>
	<input class=inputstyle type=hidden name=fcctype value=<%=fcctype%>>

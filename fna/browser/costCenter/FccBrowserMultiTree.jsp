...
String optFrame1 = "/fna/browser/costCenter/FccBrowserMultiTreeTop.jsp";
String optFrame3 = "/fna/browser/costCenter/FccBrowserMultiQuery.jsp";
String optFrame = "";
String type = "";
if(tabId==1){
	type = "tree";
...
function showMultiDialog(selectids){
    ...
    config.srcurl = "/fna/browser/costCenter/FccBrowserMultiAjax.jsp?src=src";
    config.desturl = "/fna/browser/costCenter/FccBrowserMultiAjax.jsp?src=dest";
    config.pagesize = 10;

...
String optFrame1 = "/fna/browser/FnaType4Report/FnaType4ReportBrowserMultiTreeTop.jsp?feeperiod="+feeperiod;
String optFrame3 = "/fna/browser/FnaType4Report/FnaType4ReportBrowserMultiQuery.jsp?_feeperiod="+feeperiod;
String optFrame = "";
String type = "";
if(tabId==1){
	type = "tree";
...
function showMultiDialog(selectids){
    ...
    config.srcurl = "/fna/browser/FnaType4Report/FnaType4ReportBrowserMultiAjax.jsp?src=src";
    config.desturl = "/fna/browser/FnaType4Report/FnaType4ReportBrowserMultiAjax.jsp?src=dest";
    config.pagesize = 10;

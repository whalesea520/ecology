...
String optFrame3 = "/fna/browser/fnaControlSchemeSet/FnaControlSchemeSetMultiQuery.jsp";
String optFrame = "";
String type = "";
if(tabId==3){
	type = "query";
...
function showMultiDialog(selectids){
    ...
    config.srcurl = "/fna/browser/fnaControlSchemeSet/FnaControlSchemeSetMultiAjax.jsp?src=src";
    config.desturl = "/fna/browser/fnaControlSchemeSet/FnaControlSchemeSetMultiAjax.jsp?src=dest";
    config.pagesize = 10;

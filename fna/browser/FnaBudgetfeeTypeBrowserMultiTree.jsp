...
String optFrame1 = "/fna/browser/FnaBudgetfeeTypeBrowserMultiTreeTop.jsp";
String optFrame3 = "/fna/browser/FnaBudgetfeeTypeBrowserMultiQuery.jsp";
String optFrame = "";
String type = "";
if(tabId==1){
	type = "tree";
...
function showMultiDialog(selectids){
    ...
    config.srcurl = "/fna/browser/FnaBudgetfeeTypeBrowserMultiAjax.jsp?src=src";
    config.desturl = "/fna/browser/FnaBudgetfeeTypeBrowserMultiAjax.jsp?src=dest";
    config.pagesize = 10;

...
<%
	//设置好搜索条件
	//select * from FnaAdvanceInfoAmountLog a where a.dtlid = 275 ORDER BY a.id desc 
	String backFields =" createUid, amountAdvanceAfter, createDate, memo1 ";//禁用
	String fromSql = " from FnaAdvanceInfoAmountLog a \r";
	...
	String tableString=""+
       ...
       "<head>"+
			...
			"<col width=\"20%\"  text=\""+SystemEnv.getHtmlLabelName(83278,user.getLanguage())+"\" column=\"amountAdvanceAfter\" "+//调整后金额
					" />"+

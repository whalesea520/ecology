...
<%
	...
	String fromSql = " from fnaFeeWfInfoLogic a \n";
	String sqlWhere = " where (a.totalAmtVerification is null or a.totalAmtVerification = 0) and a.isApplicationBudgetWf = 2 and a.mainId = "+mainId+" ";
	...
	String tableString=""+
       "<table instanceid=\"FNA_WF_SET_EDIT_PAGE_LOGIC_LIST\" pageId=\""+PageIdConst.FNA_WF_SET_EDIT_PAGE_LOGIC_LIST+"\" "+
      		" pagesize=\""+PageIdConst.getPageSize(PageIdConst.FNA_WF_SET_EDIT_PAGE_LOGIC_LIST,user.getUID(),PageIdConst.FNA)+"\" tabletype=\""+tabletype+"\">"+
	...
	<wea:layout type="1col">
		<wea:group context="" attributes="{'groupDisplay':'none'}">
			<wea:item attributes="{'isTableList':'true'}">
				<input type="hidden" name="pageId" id="pageId" value="<%=PageIdConst.FNA_WF_SET_EDIT_PAGE_LOGIC_LIST %>" />
...
function doBatchDel(){
	...
	var _data = "operation=batchFnaWfSetLogicApplicationEditPageDel&mainId=<%=mainId %>&ids="+ids;
...
function doDel_grid(id){
	var _data = "operation=FnaWfSetLogicApplicationEditPageDel&mainId=<%=mainId %>&id="+id;
...
function doEdit_grid(id, param2, param3, tabId, parentWin){
	...
	_fnaOpenDialog("/fna/budget/FnaWfSetLogicApplicationEditPage.jsp?mainId=<%=mainId %>&id="+id, 
			"<%=SystemEnv.getHtmlLabelName(93,user.getLanguage())+SystemEnv.getHtmlLabelName(84634,user.getLanguage()) %>", 
			_w, _h);
}
...
function doAdd(){
	var _w = 650;
	var _h = 525;
	_fnaOpenDialog("/fna/budget/FnaWfSetLogicApplicationEditPage.jsp?mainId=<%=mainId %>", 
			"<%=SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(84634,user.getLanguage()) %>", 
			_w, _h);
}

...
<form id="form2" name="form2" method="post"  action="/fna/budget/wfset/FnaBorrowWfSetEditInner.jsp">
<table id="topTitle" cellpadding="0" cellspacing="0">
	<tr>
		<td>
		</td>
		<td class="rightSearchSpan" style="text-align:right; width:500px!important">
			<input type="button" value="<%=SystemEnv.getHtmlLabelName(82,user.getLanguage()) %>"  class="e8_btn_top" onclick="doAddAndCreate();"/><!-- 新建 -->
...
<%
	...
	String sqlWhere = " where a.fnaWfType = 'borrow' ";
	if(!"".equals(nameQuery)){
...
function openEditPage(id, param2, param3, tabId, parentWin){
	...
	_fnaOpenDialog("/fna/budget/wfset/FnaBorrowWfSetEditPage.jsp?id="+id+"&tabId="+tabId, 
			"<%=SystemEnv.getHtmlLabelName(93,user.getLanguage())+SystemEnv.getHtmlLabelName(83182,user.getLanguage()) %>", 
			_w, _h);
}
...
function doAdd(){
	var _w = 600;
	var _h = 360;
	_fnaOpenDialog("/fna/budget/wfset/FnaBorrowWfSetEditAdd.jsp", 
			"<%=SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(83182,user.getLanguage()) %>", 
			_w, _h);
}
//新建
function doAddAndCreate(){
	var _w = 720;
	var _h = 580;
	_fnaOpenDialog("/fna/guide/FnaWfCreat.jsp?creatType=borrow", 
			"<%=SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(83182,user.getLanguage()) %>", 
			_w, _h);
}

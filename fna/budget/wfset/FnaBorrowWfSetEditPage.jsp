...
String FnaWfSetEditPageBaseInfoUrl = "/fna/budget/wfset/FnaBorrowWfSetEditPageBaseInfo.jsp?id="+id;
String FnaWfSetEditPageFieldSetUrl = "/fna/budget/wfset/FnaBorrowWfSetEditPageFieldSet.jsp?id="+id;
String FnaWfSetEditPageActionSetUrl = "/fna/budget/wfset/FnaBorrowWfSetEditPageActionSet.jsp?id="+id;
String FnaWfSetEditPageLogicSetUrl = "/fna/budget/wfset/FnaBorrowWfSetEditPageLogicSet.jsp?id="+id;
...
jQuery('.e8_box').Tabs({
    ...
    objName:<%=JSONObject.quote(SystemEnv.getHtmlLabelName(83182, user.getLanguage())) %>,
	staticOnLoad:true
});
</script>
</body>

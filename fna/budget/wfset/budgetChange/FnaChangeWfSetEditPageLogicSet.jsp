...
<%
	...
	String sqlWhere = " where (a.totalAmtVerification is null or a.totalAmtVerification = 0) and a.isApplicationBudgetWf = 1 and a.mainId = "+mainId+" ";
...
function doBatchDel(){
	...
	var _data = "operation=batchFnaWfSetLogicEditPageDel&mainId=<%=mainId %>&ids="+ids;
...
function doDel_grid(id){
	var _data = "operation=FnaWfSetLogicEditPageDel&mainId=<%=mainId %>&id="+id;
...
function doEdit_grid(id, param2, param3, tabId, parentWin){
	...
	_fnaOpenDialog("/fna/budget/wfset/budgetChange/FnaChangeWfSetLogicEditPage.jsp?mainId=<%=mainId %>&id="+id, 
...
function doAdd(){
	var _w = 650;
	var _h = 525;
	_fnaOpenDialog("/fna/budget/wfset/budgetChange/FnaChangeWfSetLogicEditPage.jsp?mainId=<%=mainId %>", 

...
String frozeNode1Ids = FnaWfSet.getActionSet4Wf(workflowid, "frozeChangeNode1Ids");
	...
	<wea:group context="">
		...
		<wea:item>
			<span style="margin-left: 5px;">
				<%=SystemEnv.getHtmlLabelName(124892,user.getLanguage()) %>
			</span>
		</wea:item><!-- 冻结变更预算 -->
		<wea:item><!-- 执行节点(节点前附加操作) -->
			<%
		...
		<wea:item>
			<span style="margin-left: 5px;">
				<%=SystemEnv.getHtmlLabelName(124893,user.getLanguage()) %>
			</span>
		</wea:item><!-- 生效变更预算 -->
		<wea:item><!-- 执行节点(节点前附加操作) -->
			<%
		...
		<wea:item>
			<span style="margin-left: 5px;">
				<%=SystemEnv.getHtmlLabelName(124894,user.getLanguage()) %>
			</span>
		</wea:item><!-- 释放冻结的变更预算 -->
		<wea:item><!-- 执行节点(节点前附加操作) -->
			<%

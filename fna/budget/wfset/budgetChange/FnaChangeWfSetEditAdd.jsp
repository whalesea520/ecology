...
String titlename = SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(124864,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value="<%=SystemEnv.getHtmlLabelName(124864,user.getLanguage()) %>"/>
</jsp:include>

...
<form id="form2" name="form2" method="post"  action="/fna/budget/wfset/budgetChange/FnaChangeWfSetEditInner.jsp">
...
<%
	...
	String sqlWhere = " where a.fnaWfType = 'change' ";
	if(!"".equals(nameQuery)){
...
function openEditPage(id, param2, param3, tabId, parentWin){
	...
	_fnaOpenDialog("/fna/budget/wfset/budgetChange/FnaChangeWfSetEditPage.jsp?id="+id+"&tabId="+tabId, 
			"<%=SystemEnv.getHtmlLabelName(93,user.getLanguage())+SystemEnv.getHtmlLabelName(124864,user.getLanguage()) %>", 
			_w, _h);
}
...
function doAdd(){
	var _w = 600;
	var _h = 360;
	_fnaOpenDialog("/fna/budget/wfset/budgetChange/FnaChangeWfSetEditAdd.jsp", 
			"<%=SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(124864,user.getLanguage()) %>", 
			_w, _h);
}
//新建
function doAddAndCreate(){
	var _w = 720;
	var _h = 580;
	_fnaOpenDialog("/fna/guide/FnaWfCreat.jsp?creatType=change", 
			"<%=SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(124864,user.getLanguage()) %>", 
			_w, _h);
}

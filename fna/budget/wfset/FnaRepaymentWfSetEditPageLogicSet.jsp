...
if(mainId > 0){
	...
	promptSC = FnaLanguage.getPromptSC_FnaRepaymentWfSetEditPageLogicSet(user.getLanguage());
}
...
<wea:layout type="2col">
	<wea:group context='<%=SystemEnv.getHtmlLabelName(83194,user.getLanguage())+" 1"%>'><!-- 校验规则 -->
		...
		<wea:item>
			...
			<%=SystemEnv.getHtmlLabelName(126680,user.getLanguage()) %><!-- 还款金额合计 必须等于 冲销金额合计 -->
		</wea:item>

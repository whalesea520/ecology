...
String FnaWfSetEditPageBaseInfoUrl = "/fna/budget/wfset/budgetAdvance/FnaAdvanceWfSetEditPageBaseInfo.jsp?id="+id;
String FnaWfSetEditPageFieldSetUrl = "/fna/budget/wfset/budgetAdvance/FnaAdvanceWfSetEditPageFieldSet.jsp?id="+id;
String FnaWfSetEditPageActionSetUrl = "/fna/budget/wfset/budgetAdvance/FnaAdvanceWfSetEditPageActionSet.jsp?id="+id;
...
jQuery('.e8_box').Tabs({
    ...
    objName:<%=JSONObject.quote(SystemEnv.getHtmlLabelName(128576, user.getLanguage())) %>,
	staticOnLoad:true
});
</script>
</body>

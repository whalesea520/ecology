...
boolean enable = true;
String templateFile = FnaWfSet.TEMPLATE_ADVANCE_FILE;
String templateFileMobile = FnaWfSet.TEMPLATE_ADVANCE_FILE_MOBILE;
%>
...
String titlename = SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(128576,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value="<%=SystemEnv.getHtmlLabelName(128576,user.getLanguage()) %>"/>
</jsp:include>

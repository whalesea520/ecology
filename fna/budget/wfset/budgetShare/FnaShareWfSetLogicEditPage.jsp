...
String promptSC = FnaLanguage.getPromptSC_FnaShareWfSetLogicEditPage(user.getLanguage());
		...
		top.Dialog.confirm("<%=SystemEnv.getHtmlLabelName(32130,user.getLanguage()) %>",
			function(){
				var _data = "operation=FnaWfSetLogicEditPage&mainId="+mainId+"&id="+id+"&workflowid="+workflowid+
					...
					"&depId="+depId+"&hrmId="+hrmId+"&fccId="+fccId+"&promptSC="+promptSC+"&__multilangpre_promptSC="+__multilangpre_promptSC;;

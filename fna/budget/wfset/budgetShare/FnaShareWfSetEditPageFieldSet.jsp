...
<wea:layout type="2col">
	...
	<wea:group context='<%=SystemEnv.getHtmlLabelName(382392,user.getLanguage())+"（formtable_main_"+Math.abs(formid)+"_dt1）"%>'><!-- 费用分摊信息字段（明细表1） -->
		<wea:item><%=SystemEnv.getHtmlLabelName(124968,user.getLanguage()) %></wea:item><!-- 调出科目 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelName(124970,user.getLanguage()) %></wea:item><!-- 调出主体类型 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelName(124972,user.getLanguage()) %></wea:item><!-- 调出主体 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelName(124974,user.getLanguage()) %></wea:item><!-- 调出期间 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelName(124976,user.getLanguage()) %></wea:item><!-- 分摊金额 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelNames("124972,15402",user.getLanguage()) %></wea:item><!-- 调出主体个人预算 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelNames("124972,15401",user.getLanguage()) %></wea:item><!-- 调出主体部门预算 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelNames("124972,18654",user.getLanguage()) %></wea:item><!-- 调出主体分部预算 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelNames("124972,515,386",user.getLanguage()) %></wea:item><!-- 调出主体成本中心预算 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelName(124969,user.getLanguage()) %></wea:item><!-- 调入科目 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelName(124971,user.getLanguage()) %></wea:item><!-- 调入主体类型 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelName(124973,user.getLanguage()) %></wea:item><!-- 调入主体 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelName(124975,user.getLanguage()) %></wea:item><!-- 调入期间 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelNames("124973,15402",user.getLanguage()) %></wea:item><!-- 调入主体个人预算 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelNames("124973,15401",user.getLanguage()) %></wea:item><!-- 调入主体部门预算 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelNames("124973,18654",user.getLanguage()) %></wea:item><!-- 调入主体分部预算 -->
		<wea:item>
		...
		<wea:item><%=SystemEnv.getHtmlLabelNames("124973,515,386",user.getLanguage()) %></wea:item><!-- 调入主体成本中心预算 -->
		<wea:item>
...
function doSave(_openEditPage){
	...
	if(fieldIdSubject==""
			...
			|| fieldIdOccurdate==""
			|| fieldIdAmount==""){
		top.Dialog.alert("<%=SystemEnv.getHtmlLabelNames("124968,125163,124970,125163,124972,125163,124974,125163,124976,18019",user.getLanguage())%>!");//xxxx必填
		return;
	}

...
function doEdit_grid(id, param2, param3, tabId, parentWin){
	...
	_fnaOpenDialog("/fna/budget/wfset/budgetShare/FnaShareWfSetLogicEditPage.jsp?mainId=<%=mainId %>&id="+id, 
...
function doAdd(){
	var _w = 650;
	var _h = 525;
	_fnaOpenDialog("/fna/budget/wfset/budgetShare/FnaShareWfSetLogicEditPage.jsp?mainId=<%=mainId %>", 

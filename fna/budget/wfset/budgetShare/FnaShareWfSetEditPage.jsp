...
String FnaWfSetEditPageBaseInfoUrl = "/fna/budget/wfset/budgetShare/FnaShareWfSetEditPageBaseInfo.jsp?id="+id;
String FnaWfSetEditPageFieldSetUrl = "/fna/budget/wfset/budgetShare/FnaShareWfSetEditPageFieldSet.jsp?id="+id;
String FnaWfSetEditPageActionSetUrl = "/fna/budget/wfset/budgetShare/FnaShareWfSetEditPageActionSet.jsp?id="+id;
String FnaWfSetEditPageLogicSetUrl = "/fna/budget/wfset/budgetShare/FnaShareWfSetEditPageLogicSet.jsp?id="+id;
...
jQuery('.e8_box').Tabs({
    ...
    objName:<%=JSONObject.quote(SystemEnv.getHtmlLabelName(124980, user.getLanguage())) %>,
	staticOnLoad:true
});
</script>
</body>

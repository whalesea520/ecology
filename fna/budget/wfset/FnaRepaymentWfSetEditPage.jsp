...
String FnaWfSetEditPageBaseInfoUrl = "/fna/budget/wfset/FnaRepaymentWfSetEditPageBaseInfo.jsp?id="+id;
String FnaWfSetEditPageFieldSetUrl = "/fna/budget/wfset/FnaRepaymentWfSetEditPageFieldSet.jsp?id="+id;
String FnaWfSetEditPageActionSetUrl = "/fna/budget/wfset/FnaRepaymentWfSetEditPageActionSet.jsp?id="+id;
String FnaWfSetEditPageLogicSetUrl = "/fna/budget/wfset/FnaRepaymentWfSetEditPageLogicSet.jsp?id="+id;
...
jQuery('.e8_box').Tabs({
    ...
    objName:<%=JSONObject.quote(SystemEnv.getHtmlLabelName(83183, user.getLanguage())) %>,
	staticOnLoad:true
});
</script>
</body>

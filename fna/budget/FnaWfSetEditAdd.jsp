...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value="<%=SystemEnv.getHtmlLabelName(33075,user.getLanguage()) %>"/>
</jsp:include>
...
<wea:layout type="2col">
	<wea:group context='<%=SystemEnv.getHtmlLabelName(1361,user.getLanguage())%>'>
		...
		<wea:item>
   			<input id="fnaWfTypeReverseAdvance" name="fnaWfTypeReverseAdvance" value="1" type="checkbox" tzCheckbox="true" />
		</wea:item>
...
function doSave(_openEditPage){
	...
	hideRightMenuIframe();
	try{
		var _data = "operation=add&workflowid="+workflowid+"&enable="+enable+"&fnaControlSchemeIds="+fnaControlSchemeIds+

...
jQuery(function(){
    jQuery('.e8_box').Tabs({
        ...
        objName:<%=JSONObject.quote(SystemEnv.getHtmlLabelName(82502, user.getLanguage())) %>,
        staticOnLoad:true
    });
});
</script>
...
String _ysxxUrlQry = "/fna/report/fanRptTotalBudget/fanRptTotalBudgetInner.jsp";
String _ysxxUrlHistory = "/fna/report/common/fanRptHistory.jsp?rptTypeName=fanRptTotalBudget";

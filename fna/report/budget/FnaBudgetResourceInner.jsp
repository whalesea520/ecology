...
<%
	...
	String tableString=""+
       "<table instanceid=\"FNA_BUDGET_RESOURCE_INNER_LIST\" pageId=\""+PageIdConst.FNA_BUDGET_RESOURCE_INNER_LIST+"\" "+
      		" pagesize=\""+PageIdConst.getPageSize(PageIdConst.FNA_BUDGET_RESOURCE_INNER_LIST,user.getUID(),PageIdConst.FNA)+"\" tabletype=\"none\">"+
	...
	<wea:layout type="1col">
		<wea:group context="" attributes="{'groupDisplay':'none'}">
			<wea:item attributes="{'isTableList':'true'}">
				<input type="hidden" name="pageId" id="pageId" value="<%=PageIdConst.FNA_BUDGET_RESOURCE_INNER_LIST %>" />

...
<%
RCMenu += "{"+SystemEnv.getHtmlLabelName(1290,user.getLanguage())+",/fna/report/budget/FnaBudgetDepartment.jsp,_self} " ; 
...
<input class=inputstyle id=budgetinfoid type=hidden name=budgetinfoid value="<%=budgetinfoid%>">
 ...
 <TR class=Line1><TD colspan="14" >
    <COLGROUP> <COL width="15%">
    </COL> <COL width="40%"></COL><COL width="5%"></COL> 
    <COL width="15%"></COL> 
    <COL width="25%"></COL> <THEAD> 
    <TR class=Title> 
    <TH colspan="2"> 

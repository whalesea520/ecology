...
/* if(!HrmUserVarify.checkUserRight("ManageFeeDetail:All", user)){
  ...
  String level=HrmUserVarify.getRightLevel("ManageFeeDetail:All",user);
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    ...
    <TD align=left><SPAN id=BacoTitle style="FONT-WEIGHT: bold; FONT-SIZE: 12pt"><%=SystemEnv.getHtmlLabelName(15407,user.getLanguage())%>:<%=SystemEnv.getHtmlLabelName(15364,user.getLanguage())%></SPAN></TD>
    <TD align=right>&nbsp;</TD>
    <TD width=5></TD>
...
<FORM id=weaver action="RptManagementDetail.jsp" method=post>
...
<TABLE class=ViewForm>
  ...
  <TBODY>
    ...
    <INPUT type=hidden class=InputStyle  maxLength=2 size=5 name="level" value="3">
    <INPUT type=hidden class=InputStyle maxLength=15 size=5 name="currency" value="1">
    <TR>

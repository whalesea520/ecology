...
jQuery(function(){
    jQuery('.e8_box').Tabs({
        ...
        objName:<%=JSONObject.quote(SystemEnv.getHtmlLabelName(125498, user.getLanguage())) %>,
        staticOnLoad:true
    });
});
</script>
...
String _ysxxUrlQry = "/fna/report/LoanRepaymentAnalysis/LoanRepaymentAnalysisInner.jsp";
String _ysxxUrlHistory = "/fna/report/common/fanRptHistory.jsp?rptTypeName=LoanRepaymentAnalysis";

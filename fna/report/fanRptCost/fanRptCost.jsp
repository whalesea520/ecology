...
jQuery(function(){
    jQuery('.e8_box').Tabs({
        ...
        objName:<%=JSONObject.quote(SystemEnv.getHtmlLabelName(82605, user.getLanguage())) %>,
        staticOnLoad:true
    });
});
</script>
...
String _ysxxUrlQry = "/fna/report/fanRptCost/fanRptCostInner.jsp";
String _ysxxUrlHistory = "/fna/report/common/fanRptHistory.jsp?rptTypeName=fanRptCost";

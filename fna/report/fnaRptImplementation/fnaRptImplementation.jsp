...
jQuery(function(){
    jQuery('.e8_box').Tabs({
        ...
        objName:<%=JSONObject.quote(SystemEnv.getHtmlLabelName(82612, user.getLanguage())) %>,
        staticOnLoad:true
    });
});
</script>
...
String _ysxxUrlQry = "/fna/report/fnaRptImplementation/fnaRptImplementationInner.jsp";
String _ysxxUrlHistory = "/fna/report/common/fanRptHistory.jsp?rptTypeName=fnaRptImplementation";

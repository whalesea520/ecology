...
jQuery(function(){
    jQuery('.e8_box').Tabs({
        ...
        objName:<%=JSONObject.quote(SystemEnv.getHtmlLabelName(82629, user.getLanguage())) %>,
        staticOnLoad:true
    });
});
</script>
...
String _ysxxUrlQry = "/fna/report/budgetDetailed/budgetDetailedInner.jsp";
String _ysxxUrlHistory = "/fna/report/common/fanRptHistory.jsp?rptTypeName=budgetDetailed";

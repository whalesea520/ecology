...
if(operation.equals("addindicator")){
	...
	String para = indicatorid + separator + ledgerid ;
        ...
        String sql="select id from FnaIndicatordetail where indicatorid="+indicatorid+" and ledgerid="+ledgerid;
        RecordSet.executeSql(sql);
        if(RecordSet.next())
        response.sendRedirect("FnaIndicatorEdit.jsp?msgid=39&id="+indicatorid);
        else{

	...
	$.ajax({
		...
		success:function(data){
			...
			if(status == "no") {
				...
				window.location.href="matchruleresult.jsp?type=1&ruleid="+id+"&tabtype=<%=tabtype %>&ishtml=<%=ishtml%>&navName=<%=navName%>&path="+path;
			}
		}
	});
	...
	$.ajax({
		...
		success:function(data){
			...
			if(status == "no") {
				...
				window.location.href="matchruleresult.jsp?type=1&ruleid="+ids+"&tabtype=<%=tabtype %>&ishtml=<%=ishtml%>&navName=<%=navName%>&path="+path;
			}
		}
	});

...
(function( $ ){
	...
	$.fn.themeswitcher = function( options ) {
			...
			var themes = [
				{
					title: "Black Tie",
					name: "black-tie",
					icon: "theme_90_black_tie_wev8.png"
				},
				{
					title: "Blitzer",
					name: "blitzer",
					icon: "theme_90_blitzer_wev8.png"
				},
				{
					title: "Cupertino",
					name: "cupertino",
					icon: "theme_90_cupertino_wev8.png"
				},
				{
					title: "Dark Hive",
					name: "dark-hive",
					icon: "theme_90_dark_hive_wev8.png"
				},
				{
					title: "Dot Luv",
					name: "dot-luv",
					icon: "theme_90_dot_luv_wev8.png"
				},
				{
					title: "Eggplant",
					name: "eggplant",
					icon: "theme_90_eggplant_wev8.png"
				},
				{
					title: "Excite Bike",
					name: "excite-bike",
					icon: "theme_90_excite_bike_wev8.png"
				},
				{
					title: "Flick",
					name: "flick",
					icon: "theme_90_flick_wev8.png"
				},
				{
					title: "Hot Sneaks",
					name: "hot-sneaks",
					icon: "theme_90_hot_sneaks_wev8.png"
				},
				{
					title: "Humanity",
					name: "humanity",
					icon: "theme_90_humanity_wev8.png"
				},
				{
					title: "Le Frog",
					name: "le-frog",
					icon: "theme_90_le_frog_wev8.png"
				},
				{
					title: "Mint Choc",
					name: "mint-choc",
					icon: "theme_90_mint_choco_wev8.png"
				},
				{
					title: "Overcast",
					name: "overcast",
					icon: "theme_90_overcast_wev8.png"
				},
				{
					title: "Pepper Grinder",
					name: "pepper-grinder",
					icon: "theme_90_pepper_grinder_wev8.png"
				},
				{
					title: "Redmond",
					name: "redmond",
					icon: "theme_90_windoze_wev8.png"
				},
				{
					title: "Smoothness",
					name: "smoothness",
					icon: "theme_90_smoothness_wev8.png"
				},
				{
					title: "South Street",
					name: "south-street",
					icon: "theme_90_south_street_wev8.png"
				},
				{
					title: "Start",
					name: "start",
					icon: "theme_90_start_menu_wev8.png"
				},
				{
					title: "Sunny",
					name: "sunny",
					icon: "theme_90_sunny_wev8.png"
				},
				{
					title: "Swanky Purse",
					name: "swanky-purse",
					icon: "theme_90_swanky_purse_wev8.png"
				},
				{
					title: "Trontastic",
					name: "trontastic",
					icon: "theme_90_trontastic_wev8.png"
				},
				{
					title: "UI Darkness",
					name: "ui-darkness",
					icon: "theme_90_ui_dark_wev8.png"
				},
				{
					title: "UI Lightness",
					name: "ui-lightness",
					icon: "theme_90_ui_light_wev8.png"
				},
				{
					title: "Vader",
					name: "vader",
					icon: "theme_90_black_matte_wev8.png"
				}
			]
		}else{
		...
		var switcherLinkStyle = {
			...
			"font-size": "11px",
			"color": "#666",
			"background": "#eee url("+settings.imgpath+"buttonbg_wev8.png) repeat-x 50% 50%",
		...
		$("<span/>").addClass("jquery-ui-switcher-arrow")
			.css({
				...
				"width": "16px",
				"height": "16px",
				"background": "url("+settings.imgpath+"icon_color_arrow_wev8.gif) no-repeat 50% 50%"
			})
		...
		$.each(themes, function(k,v){
			...
			var listLink = $("<a>")
				...
				.bind({
					mouseenter: function(){
						listLink.css("background","url("+settings.imgpath+"menuhoverbg_wev8.png) repeat-x 50% 50%");
					},
					mouseleave: function(){
		...
		if (!url) {
			...
			url = urlPrefix + data.name + "/jquery-ui_wev8.css";

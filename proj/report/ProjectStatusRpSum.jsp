...
String url="/proj/report/ProjectStatusRpSum.jsp?isfromProjTab=1";
...
$(function(){
	try{
		parent.setTabObjName("<%=SystemEnv.getHtmlLabelName(587,user.getLanguage()) %>");
	}catch(e){}
});
</script>
</head>
...
<div class="advancedSearchDiv" id="advancedSearchDiv" style="display:none;" >
	...
	<wea:layout type="4col">
	    ...
	    <wea:item>
		    <brow:browser viewType="0" name="status" browserValue='<%= ""+status %>' 
					browserUrl="/systeminfo/BrowserMain.jsp?url=/proj/Maint/ProjectStatusBrowser.jsp?resourceids="
					hasInput="true" isSingle="true" hasBrowser = "true" isMustInput='1'
					completeUrl="/data.jsp?type=246" 
					browserSpanValue='<%=ProjectStatusComInfo.getProjectStatusdesc (status) %>'>
			</brow:browser>
	    </wea:item>
...
String tableString=""+
   ...
   "<head>"+							 
		 "<col width=\"10%\" text=\""+SystemEnv.getHtmlLabelName(602,user.getLanguage())+"\" column=\"status\"  orderkey=\"status\" transmethod='weaver.proj.Maint.ProjectStatusComInfo.getProjectStatusdesc' />"+

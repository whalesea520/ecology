...
String url="/proj/report/WorkTypeRpSum.jsp?isfromProjTab=1";
...
$(function(){
	try{
		parent.setTabObjName("<%=SystemEnv.getHtmlLabelName(432,user.getLanguage()) %>");
	}catch(e){}
});
</script>
</head>
...
<div class="advancedSearchDiv" id="advancedSearchDiv" style="display:none;" >
	...
	<wea:layout type="4col">
	    ...
	    <wea:item>
		    <brow:browser viewType="0" name="worktype" browserValue='<%= ""+worktype %>' 
					browserUrl="/systeminfo/BrowserMain.jsp?url=/proj/Maint/WorkTypeBrowser.jsp?resourceids="
					hasInput="true" isSingle="true" hasBrowser = "true" isMustInput='1'
					completeUrl="/data.jsp?type=245" 
					browserSpanValue='<%=WorkTypeComInfo .getWorkTypename (worktype) %>'>
			</brow:browser>
	    </wea:item>
...
String backfields=" t1.worktype,COUNT(t1.id) AS resultcount ";
String sqlform = " Prj_ProjectInfo  t1  ";
String orderby=" resultcount ";
String groupby=" t1.worktype ";
String primarykey=" t1.worktype ";

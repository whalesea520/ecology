...
String sqlwhere="";
sqlwhere=" where prjid = "+ProjID+" and  finish < '100' and isdelete<>'1' and enddate <= '"+CurrentDate+"'";
...
<table class=viewform>
  <tr>
     <th width="118" align=left><%=SystemEnv.getHtmlLabelName(15291,user.getLanguage())%></th>
      <td> 
			<%RCMenu += "{-}";

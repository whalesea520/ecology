...
String url="/proj/report/ProjectTypeRpSum.jsp?isfromProjTab=1";
...
$(function(){
	try{
		parent.setTabObjName("<%=SystemEnv.getHtmlLabelName(586,user.getLanguage()) %>");
	}catch(e){}
});
</script>
</head>
	...
	<wea:layout type="4col">
	    ...
	    <wea:item>
		    <brow:browser viewType="0" name="prjtype" browserValue='<%= ""+prjtype %>' 
					browserUrl="/systeminfo/BrowserMain.jsp?url=/proj/Maint/ProjectTypeBrowser.jsp?resourceids="
...
String backfields=" t1.prjtype,COUNT(t1.id) AS resultcount ";
String sqlform = " Prj_ProjectInfo  t1  ";
String groupby=" t1.prjtype ";
String orderby=" resultcount ";
String primarykey=" t1.prjtype ";
...
String tableString=""+
   ...
   "<head>"+							 
		 "<col width=\"10%\" text=\""+SystemEnv.getHtmlLabelName(586,user.getLanguage())+"\" column=\"prjtype\"  orderkey=\"prjtype\" transmethod='weaver.proj.Maint.ProjectTypeComInfo.getProjectTypename' />"+

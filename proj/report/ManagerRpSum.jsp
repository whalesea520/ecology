...
String url="/proj/report/ManagerRpSum.jsp?isfromProjTab=1";
...
$(function(){
	try{
		parent.setTabObjName("<%=SystemEnv.getHtmlLabelName(16573,user.getLanguage()) %>");
	}catch(e){}
});
</script>
</head>
...
String tableString=""+
   ...
   "<head>"+							 
		 "<col width=\"10%\" text=\""+SystemEnv.getHtmlLabelName(16573,user.getLanguage())+"\" column=\"manager\"  orderkey=\"manager\" transmethod='weaver.hrm.resource.ResourceComInfo.getResourcename' />"+

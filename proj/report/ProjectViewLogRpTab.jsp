...
//String url="/proj/report/ProjectViewLogRp.jsp?isfromProjTab=1";
...
$(function(){
	try{
		//parent.setTabObjName("<%=SystemEnv.getHtmlLabelName(16576,user.getLanguage()) %>");
	}catch(e){}
});
</script>
</head>
...
<div class="advancedSearchDiv" id="advancedSearchDiv" style="display:none;" >
	...
	<wea:layout type="4col">
		<wea:group context='<%=SystemEnv.getHtmlLabelName(15774,user.getLanguage())%>'>
	     <wea:item><%=SystemEnv.getHtmlLabelNames("730,101",user.getLanguage())%></wea:item>
	     <wea:item>
...
String sqlwhere= " where t3.id=t1.id and ( "+CommonShareManager.getPrjShareWhereByUser(user) +" ) ";
if(!"".equals(viewer)){
	sqlwhere+=" and t3.viewer='"+viewer+"' ";
}
if(!fromdate.equals("")){
	sqlwhere+=" and t3.viewdate>='"+fromdate+"' ";
}
if(!todate.equals("")){
	sqlwhere+=" and t3.viewdate<='"+todate+"' ";
}
if(!"".equals(prjname)){
...
String sqlform = " Prj_ViewLog1  t3, prj_projectinfo t1  ";
String orderby=" t3.viewdate ,t3.viewtime ";
//String groupby=" t1.manager ";
String primarykey=" t3.id ";
...
String tableString=""+
   ...
   "<head>"+							 
		 "<col width=\"10%\" text=\""+SystemEnv.getHtmlLabelName(1273,user.getLanguage())+"\" column=\"viewer\" orderkey=\"viewer\" transmethod='weaver.hrm.resource.ResourceComInfo.getResourcename' href='/hrm/resource/HrmResource.jsp' linkkey='id' target='_fullwindow'  />"+
		 "<col width=\"8%\" text=\""+SystemEnv.getHtmlLabelNames("730,97",user.getLanguage())+"\" column=\"viewdate\"  orderkey=\"viewdate\"  />"+
		 "<col width=\"8%\" text=\""+SystemEnv.getHtmlLabelName(1272,user.getLanguage())+"\" column=\"viewtime\"  orderkey=\"viewtime\"  />"+
		 "<col width=\"8%\" text=\""+SystemEnv.getHtmlLabelName(1353,user.getLanguage())+"\" column=\"id\"  orderkey=\"id\" transmethod='weaver.proj.Maint.ProjectInfoComInfo.getProjectInfoname' href='/proj/data/ViewProject.jsp' linkkey='ProjID' target='_fullwindow'  />"+
		 "<col width=\"8%\" text=\""+SystemEnv.getHtmlLabelName(16573,user.getLanguage())+"\" column=\"manager\"  orderkey=\"manager\" transmethod='weaver.hrm.resource.ResourceComInfo.getResourcename' href='/hrm/resource/HrmResource.jsp' linkkey='id' target='_fullwindow'  />"+
		 "<col width=\"10%\" text=\"IP "+SystemEnv.getHtmlLabelName(110,user.getLanguage())+"\" column=\"ipaddress\" orderkey=\"ipaddress\"  />"+
   "</head>"+
   "</table>";
%>

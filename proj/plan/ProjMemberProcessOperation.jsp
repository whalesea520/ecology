...
if(method.equals("add"))
{
	...
	ProcPara += flag+cost;
	RecordSet.executeProc("Prj_MemberProcess_Insert",ProcPara);
...
if(method.equals("edit"))
{
	...
	ProcPara += flag+workday;
	ProcPara += flag+cost;
	RecordSet.executeProc("Prj_MemberProcess_Update",ProcPara);
...
{
	ProcPara = recordid;
	RecordSet.executeProc("Prj_MemberProcess_Delete",ProcPara);

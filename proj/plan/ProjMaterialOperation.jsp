...
if(method.equals("add"))
{
	...
	ProcPara += flag+cost;
	RecordSet.executeProc("Prj_Material_Insert",ProcPara);
...
if(method.equals("edit"))
{
	...
	ProcPara += flag+quantity;
	ProcPara += flag+cost;
	RecordSet.executeProc("Prj_Material_Update",ProcPara);
...
if(method.equals("delete"))
{
	ProcPara = recordid;
	ProcPara += flag+version;
	RecordSet.executeProc("Prj_Material_Delete",ProcPara);

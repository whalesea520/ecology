...
<form name=weaver method=post action="PlanDspRequest.jsp">
...
String sqlwhere=" where t1.requestid = t2.requestid and t2.userid = "+CurrentUser+" and t2.usertype=" + usertype + " and t1.requestid = t3.requestid  and t3.type = '1' and t3.prjid = "+ProjID+" and t3.version <= " + Version;

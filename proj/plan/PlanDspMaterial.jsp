...
<form name=weaver method=post action="PlanDspMaterial.jsp">
...
RecordSet.executeProc("Prj_Material_SumPlan",ProcPara);
...
<%
			isLight = !isLight;
	ProcPara = ProjID + flag + Version + flag + RecordSet.getString("material");
	RecordSet2.executeProc("Prj_Material_SelectAllPlan",ProcPara);

...
RecordSet.executeProc("Prj_Find_Toolbyid",recordid);
String prjid="";
String taskid="";
String relateid="";
String begindate="";
...
%>
<%
RCMenu += "{"+SystemEnv.getHtmlLabelName(91,user.getLanguage())+",ProjToolOperation.jsp?taskrecordid="+taskrecordid+"&recordid="+recordid+"&method=delete,_self} " ;
RCMenuHeight += RCMenuHeightStep;
%>
<%
...
<FORM id=weaver action="ProjToolOperation.jsp" method=post >
...
<TABLE class=viewform>
  ...
  <TR class=spacing>
		  ...
		  <BUTTON class=Browser id=Selectrelateid onClick="onShowrelateid()"></BUTTON> <span 
            id=Prjrelateidspan><A href="/cpt/capital/CptCapital.jsp?id=<%=relateid%>">
          <%=Util.toScreen(CapitalComInfo.getCapitalname(relateid),user.getLanguage())%></a></span> 

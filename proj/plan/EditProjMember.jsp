...
RecordSet.executeProc("Prj_Find_Memberbyid",recordid);
...
%>
<%
RCMenu += "{"+SystemEnv.getHtmlLabelName(91,user.getLanguage())+",ProjMemberOperation.jsp?taskrecordid="+taskrecordid+"&recordid="+recordid+"&method=delete,_self} " ;
RCMenuHeight += RCMenuHeightStep;
%>
<%

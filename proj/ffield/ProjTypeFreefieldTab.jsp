...
String from = "prjtypefield_def" ;
String optFrameSrc="";
if(!paraid.equals(""))
    optFrameSrc = "prjFreefieldTab.jsp?from="+from+"&paraid="+paraid;
else
    optFrameSrc = "prjFreefieldTab.jsp?from="+from;
%>
<HTML>
<HEAD>
...
<IFRAME name=leftframe id=leftframe src="/proj/Maint/PrjTypeTree.jsp?urlType=prjtypeFieldList" width="100%" height="100%" frameborder=no scrolling=no >

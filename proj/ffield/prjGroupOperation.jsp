...
<jsp:useBean id="CptFieldComInfo" class="weaver.proj.util.PrjCardGroupComInfo" scope="page" />
...
String grouptablename="prj_prjcardgroup";
		...
		for(int i=0;i<dtJsonArray.size();i++){
			...
			if(dtJsonArray2!=null&&dtJsonArray2.size()>=4){
				...
				if(groupid>0){
					...
					sql="insert into "+grouptablename+"(groupname,grouplabel,dsporder,isopen,prjtype) values('"+labelname+"','"+lableid+"','"+(i+1)+"','1','-1') ";
				}

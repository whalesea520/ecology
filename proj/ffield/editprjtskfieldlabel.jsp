...
<form name="fieldlabelfrm" id=fieldlabelfrm method=post action="/proj/ffield/editprjtskfieldlabel.jsp">
...
while(CptCardGroupComInfo.next()){
    ...
    String sql = "select id,fieldname,fieldlabel,viewtype,issystem from prjtskDefineField  where groupid="+CptCardGroupComInfo.getGroupid() ;
  			if(qname.length()>0){
...
function fieldlablesall0(){
	fieldlabelfrm.action="/proj/ffield/prjtskfieldoperation.jsp";

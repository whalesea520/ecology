...
tableString =   " <table instanceid=\"CptCapitalAssortmentTable\" tabletype=\"none\" pagesize=\""+perpage+"\" >"+
                ...
                "           <col width=\"5%\"  text=\""+SystemEnv.getHtmlLabelName(63,user.getLanguage())+"\" column=\"logtype\" orderkey=\"logtype\" otherpara='"+user.getLanguage()+"' transmethod='weaver.proj.util.ProjectTransUtil.getPrjLogTypeName' />"+
                "           <col width=\"5%\"  text=\""+SystemEnv.getHtmlLabelNames("454,58",user.getLanguage())+"\" column=\"documentid\" orderkey=\"documentid\" transmethod='weaver.docs.docs.DocComInfo.getDocname'  />"+
                "       </head>"+
                /**"		<operates>"+

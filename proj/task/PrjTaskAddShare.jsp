...
String capitalid = Util.null2String(request.getParameter("taskrecordid"));
...
<FORM id=weaver name=weaver action="/proj/task/PrjTaskShareOperation.jsp" >
 ...
 function onSubmit()
{
	...
	if (check_form(weaver,checkstr)){
		...
		checkshareifexists("Prj_TaskShareInfo",poststr,function(){

...
<%
	String navName = "";
	navName = SystemEnv.getHtmlLabelNames("93,18375",user.getLanguage());
    ...
    function getIframeDocument(){
    	...
    	if(!!_contentDocument){
			...
			jQuery("#agenda").bind("click",function(){
				jQuery("#agenda").parent.className="current"; 
				_contentDocument = getIframeDocument2();
...
<%
	String url = "/proj/Templet/ProjTempletEdit.jsp?isfromProjTab=1";

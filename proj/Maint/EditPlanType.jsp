...
<%
	...
	RecordSet.executeProc("Prj_PlanType_SelectByID",id);
	...
	RecordSet.first();
boolean canedit = HrmUserVarify.checkUserRight("EditPlanType:Edit",user);
%>
<HTML><HEAD>
...
String titlename = SystemEnv.getHtmlLabelName(93,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(407,user.getLanguage())+SystemEnv.getHtmlLabelName(63,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<BODY>
...
<FORM id=weaver action="/proj/Maint/PlanTypeOperation.jsp" method=post >

<%
if(HrmUserVarify.checkUserRight("EditPlanType:Edit", user)){
%><%
...
if(HrmUserVarify.checkUserRight("EditPlanType:Delete", user)){
%>
<%

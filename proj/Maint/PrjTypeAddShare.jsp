...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value='<%=SystemEnv.getHtmlLabelNames("586,119",user.getLanguage()) %>'/>
</jsp:include>
<FORM id=weaver name=weaver action="/proj/data/TypeShareOperation.jsp" >
<input type="hidden" name="method" value="add">
<input type="hidden" name="typeid" value="<%=assortid%>">
...
<wea:layout>
	<wea:group context='<%=SystemEnv.getHtmlLabelNames("2112",user.getLanguage())%>' attributes="" >
		...
		<wea:item><%=SystemEnv.getHtmlLabelName(31464,user.getLanguage())%></wea:item>
		<wea:item>
		    <INPUT type="checkbox" tzCheckbox="true" checked="checked" class=InputStyle name="norepeatedname" value="1" >
		</wea:item>
 ...
 function onSubmit()
{
	...
	if (check_form(weaver,checkstr)){
		...
		checkshareifexists("Prj_T_ShareInfo",poststr,function(){

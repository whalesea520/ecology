...
<%
	...
	RecordSet.executeProc("Prj_PlanSort_SelectByID",id);
	...
	RecordSet.first();
boolean canedit = HrmUserVarify.checkUserRight("EditPlanSort:Edit",user);
%>
<HTML><HEAD>
...
String titlename = SystemEnv.getHtmlLabelName(93,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(407,user.getLanguage())+SystemEnv.getHtmlLabelName(455,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<BODY>
...
<FORM id=weaver action="/proj/Maint/PlanSortOperation.jsp" method=post >

<%
if(HrmUserVarify.checkUserRight("EditPlanSort:Edit", user)){
%><%
...
if(HrmUserVarify.checkUserRight("EditPlanSort:Delete", user)){
%>
<%

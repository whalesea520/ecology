...
String titlename = SystemEnv.getHtmlLabelName(82,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(407,user.getLanguage())+SystemEnv.getHtmlLabelName(455,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<BODY>

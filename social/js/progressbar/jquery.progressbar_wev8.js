	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				width			: 120,											// Width of the progressbar - don't forget to adjust your image too!!!												// Image to use in the progressbar. Can be a single image too: 'images/progressbg_green_wev8.gif'
				height			: 12,											// Height of the progressbar - don't forget to adjust your image too!!!
				callback		: null,											// Calls back with the config object that has the current percentage, target percentage, current image, etc
				boxImage		: '/social/js/progressbar/images/progressbar_wev8.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/social/js/progressbar/images/progressbg_green_wev8.gif',
									30: '/social/js/progressbar/images/progressbg_green_wev8.gif',
									70: '/social/js/progressbar/images/progressbg_green_wev8.gif'
								},
			...
			this.construct = function(arg1, arg2) {
				...
				return this.each(function(child) {
					...
					if (argvalue != null && this.bar != null && this.config != null) {
						...
						if(config.barColor!='')
							$bar.css("background-color",config.barColor);
						else{	

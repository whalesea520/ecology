...
%>
<script> var IS_BASE_ON_OPENFIRE = <%=IS_BASE_ON_OPENFIRE%>; var M_SDK_VER = <%=RONG_SDK_VER%>; var ZERO_TIME_MILLIS = <%=zeroTimeMillis%></script>
...
<jsp:include page="/social/im/SocialIMUtil-nw.jsp"></jsp:include> 
...
%>
<script>var loginuserid = "<%=user.getUID()%>";</script>

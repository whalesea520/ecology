    ...
    if (b.RongIMClient) {
        ...
        function initCss() {
            ...
            if (document.createStyleSheet) {
                ...
                _style.innerHTML = ".RC_Expression {width:22px;height:22px;background-image:url('"+window.RongOpts["EMOJI_BG_IMAGE"]+"');display:inline-block}";
        ...
        throw new Error("Please load WeaverIMClient.min.js")
    }
})(window);

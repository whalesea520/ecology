	...
	<HEAD>
		...
		<%
			...
			if(_fromURL.equals("NetworkSegmentStrategyAdd")){
				...
				url = "/hrm/group/"+method+".jsp?cmd="+cmd+"&isdialog=1&groupid="+id+"&hrmids="+hrmIds+"&hrmnames="+hrmnames+_appendUrl;
				...
				if(cmd.equals("schedulediff")){//考勤相关报表
					...
					String resourceId = Util.null2String(request.getParameter("resourceId"));
					title = "15880,17463";
					url = "/hrm/report/schedulediff/HrmScheduleDiffMonthAttDateDetail.jsp?isdialog=1&curDate="+curDate+"&resourceId="+resourceId;
				}
			...
			}else if(_fromURL.equals("GetGroupIcon")){
				title = "130874";
				url ="/social/manager/SocialGetGroupIcon.jsp?discussid="+request.getParameter("discussid");
			}

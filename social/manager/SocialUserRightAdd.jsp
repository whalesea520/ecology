...
<html>
    ...
    <%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>
        ...
        <jsp:include page="/systeminfo/commonTabHead.jsp">
           ...
           <jsp:param name="navName" value="<%=SystemEnv.getHtmlLabelName(127333,user.getLanguage()) %>"/>
        </jsp:include>
        ...
        <div class="zDialog_div_content" style="height:196px;">
            <form id="weaver" name="weaver" action="/social/manager/SocialUserRightOperation.jsp" method="post" onsubmit="return check_form(this,"itemtype,permissionType,relatedshareid,seclevel")">

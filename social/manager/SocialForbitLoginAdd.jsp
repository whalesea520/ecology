...
<html>
    ...
    <%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>
        ...
        <div class="zDialog_div_content" style="height:196px;">
            <form id="weaver" name="weaver" action="/social/manager/SocialForbitLoginOperation.jsp" method="post" onsubmit="return check_form(this,"itemtype,permissionType,relatedshareid,seclevel")">

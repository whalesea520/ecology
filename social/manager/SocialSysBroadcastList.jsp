    ...
    <body>
        ...
        <form id="weaver" name="frmmain" method="post" action="SocialSysBroadcastList.jsp">
            <%
                ...
                String sqlFrom = " Social_IMSysBroadcast ";
                String sql_page = "select pageSize from ecology_pagesize where pageId = 'SocialSysBroadcast' and userId="+user.getUID();
                ...
                String tableString=""+
                			  "<table tabletype=\"checkbox\" pageId=\"SocialSysBroadcast\" pagesize=\""+perpage+"\">"+
        ...
        <script type="text/javascript">
            ...
            function addShare(){
            	...
            	var url = "/social/manager/SocialSysBroadcastAdd.jsp?isfromtab=true&itemtype=2&isfromCrmTab=true";
            ...
            function delShare(){
            	...
            	window.top.Dialog.confirm("<%=SystemEnv.getHtmlLabelName(129890, user.getLanguage())%>",function(){
            		jQuery.post("/social/manager/SocialSysBroadcastOperation.jsp",{"method":"batchDelete", "id":id},function(){
            ...
            function delShareQuick(id){
            	window.top.Dialog.confirm("<%=SystemEnv.getHtmlLabelName(129890, user.getLanguage())%>",function(){
            		jQuery.ajax({
	            		url : "/social/manager/SocialSysBroadcastOperation.jsp?method=delete&id="+id,
	            		type : "post",
	            		async : false,

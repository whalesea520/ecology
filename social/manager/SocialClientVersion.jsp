		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				...
				<div>
					<ul class="tab_menu">
						<li class="current">
							<a href="" target="tabcontentframe" _datetype="NT">windows客户端管理</a>
						</li>
						<li>
							<a href="" target="tabcontentframe" _datetype="MAC">mac客户端管理</a>
						</li>
					</ul>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
	    $('.e8_box').Tabs({
			...
			staticOnLoad:true,
			objName:"<%=SystemEnv.getHtmlLabelName(126737,user.getLanguage())%>"
		});
		attachUrl();
	});
	function attachUrl(){
		...
		$("a[target='tabcontentframe']").each(function(){
			...
			$(this).attr("href","SocialClientVersionInner.jsp?target="+datetype+"&"+new Date().getTime());

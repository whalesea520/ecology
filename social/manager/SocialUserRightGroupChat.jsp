...
<html>
    ...
    <body>
        ...
        <form id="weaver" name="frmmain" method="post" action="SocialUserRightGroupChat.jsp">
            <%
                ...
                String sqlFrom = " Social_IMUserRight ";
                //String perpage = PageIdConst.getPageSize("UserRightGroupChat",user.getUID());
				//System.out.println("..............jsp:"+perpage);
				String sql_page = "select pageSize from ecology_pagesize where pageId = 'UserRightGroupChat' and userId="+user.getUID();
                ...
                String tableString=""+
                			  "<table tabletype=\"checkbox\" pageId=\"UserRightGroupChat\" pagesize=\""+perpage+"\">"+
        ...
        <script type="text/javascript">
            ...
            function addShare(){
            	...
            	var url = "/social/manager/SocialUserRightAdd.jsp?isfromtab=true&itemtype=2&isfromCrmTab=true";
            ...
            function delShare(){
            	...
            	window.top.Dialog.confirm("<%=SystemEnv.getHtmlLabelName(129890, user.getLanguage())%>",function(){
            		jQuery.post("/social/manager/SocialUserRightOperation.jsp",{"method":"batchDelete", "id":id},function(){
            ...
            function delShareQuick(id){
            	window.top.Dialog.confirm("<%=SystemEnv.getHtmlLabelName(129890, user.getLanguage())%>",function(){
            		jQuery.ajax({
	            		url : "/social/manager/SocialUserRightOperation.jsp?method=delete&id="+id,
	            		type : "post",
	            		async : false,

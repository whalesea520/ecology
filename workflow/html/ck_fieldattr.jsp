			...
			<col width="30%">
				...
				<tr valign="top">
					...
					<td align="left" valign="top">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr valign="top">
								<td width="100%">
									<button id="wfcreater" name="wfcreater" title="<%=SystemEnv.getHtmlLabelName(18015,user.getLanguage())+SystemEnv.getHtmlLabelName(882,user.getLanguage())%>" class="e8_btn_top middle" style="border:1px solid #aecef1 !important;" onclick="insertMark(' $wfcreater$ ')" ><%=SystemEnv.getHtmlLabelName(18015,user.getLanguage())+SystemEnv.getHtmlLabelName(882,user.getLanguage())%></button>
								</td>
							</tr>
							<tr valign="top">
								<td width="100%">
									<button id="createrdept" name="createrdept" title="<%=SystemEnv.getHtmlLabelName(882,user.getLanguage())+SystemEnv.getHtmlLabelName(15393,user.getLanguage())%>" class="e8_btn_top middle" style="border:1px solid #aecef1 !important;" onclick="insertMark(' $wfcredept$ ')" ><%=SystemEnv.getHtmlLabelName(882,user.getLanguage())+SystemEnv.getHtmlLabelName(15393,user.getLanguage())%></button>
								</td>
							</tr>
							<tr valign="top">
								<td width="100%">
							...
							<tr valign="top">
								<td width="100%">
									<button id="requestid" name="requestid" title="<%=SystemEnv.getHtmlLabelName(28610,user.getLanguage())%>" class="e8_btn_top middle" style="border:1px solid #aecef1 !important;" onclick="insertMark(' $requestid$ ')" ><%=SystemEnv.getHtmlLabelName(28610,user.getLanguage())%></button>
								</td>
							</tr>
							<!-- 
							<tr valign="top">
								<td width="100%">
									<button id="id" name="id" title="<%=SystemEnv.getHtmlLabelName(81287,user.getLanguage())%>" class="btn" onclick="insertMark(' $id$ ')" ><%=SystemEnv.getHtmlLabelName(81287,user.getLanguage())%></button>
								</td>
							</tr>
							 -->
						</table>
				...
				<tr>
					<td align="left" colspan="3">
						...
						<br>&nbsp;
							<font color="#ff0000">
								<%=SystemEnv.getHtmlLabelName(129066, user.getLanguage())%>
							</font>
						</div>

							...
							<tr valign="top">
								<td width="100%">
									...
									<%if(saptriggerflag.equals("1") || saptriggerflag.equalsIgnoreCase("y")){ %>
										<button id="sapoperation" name="sapoperation" title="SAP" class="e8_btn_top middle" style="border:1px solid #aecef1 !important;" onclick="sapOperation()" >SAP</button>
										<span id="sapoperationspan"></span>
									<%}else{ %>
										<button id="sapoperation" disabled="disabled" name="sapoperation" title="SAP" class="e8_btn_top middle" style="border:1px solid #aecef1 !important;" onclick="sapOperation()" >SAP</button>
									<%} %>
								</td>
							</tr>
						</table>

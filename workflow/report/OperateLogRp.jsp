...
<%
String dateselect = "1";
String url = "/workflow/report/OperateDefineLog.jsp?dateselect="+dateselect;
%>
<html>
<head>	
...
<% 
String navName = SystemEnv.getHtmlLabelName(33777,user.getLanguage());
%>	
...
<SCRIPT language="javascript">
	...
	function settab0(){
		$("#tabcontentframe").attr("src","/workflow/report/OperateDefineLog.jsp?dateselect=0");
	}
	function settab1(){
		$("#tabcontentframe").attr("src","/workflow/report/OperateDefineLog.jsp?dateselect=1");
	}
	function settab2(){
		$("#tabcontentframe").attr("src","/workflow/report/OperateDefineLog.jsp?dateselect=2");
	}
	function settab3(){
		$("#tabcontentframe").attr("src","/workflow/report/OperateDefineLog.jsp?dateselect=3");
	}
	function settab4(){
		//$("#tabcontentframe").attr("src","/workflow/form/addformrowcal0.jsp?formid=");
		$("#tabcontentframe").attr("src","/workflow/report/OperateDefineLog.jsp?dateselect=4");
	}
	function settab5(){
		//$("#tabcontentframe").attr("src","/workflow/form/addformcolcal0.jsp?formid=");
		$("#tabcontentframe").attr("src","/workflow/report/OperateDefineLog.jsp?dateselect=5");
	}

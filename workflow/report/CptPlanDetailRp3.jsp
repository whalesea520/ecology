...
String titlename = SystemEnv.getHtmlLabelName(1316,user.getLanguage());
...
<%
String sqlstr = "select  t1.departmentid,t3.name,t3.mark,t3.capitalspec,t2.number_n,t2.unitprice,t2.amount,t2.purpose,t3.id as cptid  from bill_CptPlanMain  t1,bill_CptPlanDetail  t2,CptCapital  t3  where t1.id = t2.cptplanid and t2.cptid=t3.id and t1.groupid=5  order by t1.departmentid desc" ;

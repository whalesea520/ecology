...
<%
String dateselect = "1";
String url = "/workflow/report/DeleteDefineLog.jsp?dateselect="+dateselect;
...
<% 
String navName = SystemEnv.getHtmlLabelName(33778,user.getLanguage());
%>	
...
<SCRIPT language="javascript">
	...
	function settab0(){
		$("#tabcontentframe").attr("src","/workflow/report/DeleteDefineLog.jsp?dateselect=0");
	}
	function settab1(){
		$("#tabcontentframe").attr("src","/workflow/report/DeleteDefineLog.jsp?dateselect=1");
	}
	function settab2(){
		$("#tabcontentframe").attr("src","/workflow/report/DeleteDefineLog.jsp?dateselect=2");
	}
	function settab3(){
		$("#tabcontentframe").attr("src","/workflow/report/DeleteDefineLog.jsp?dateselect=3");
	}
	function settab4(){
		//$("#tabcontentframe").attr("src","/workflow/form/addformrowcal0.jsp?formid=");
		$("#tabcontentframe").attr("src","/workflow/report/DeleteDefineLog.jsp?dateselect=4");
	}
	function settab5(){
		//$("#tabcontentframe").attr("src","/workflow/form/addformcolcal0.jsp?formid=");
		$("#tabcontentframe").attr("src","/workflow/report/DeleteDefineLog.jsp?dateselect=5");
	}

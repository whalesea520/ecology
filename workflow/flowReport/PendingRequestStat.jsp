...
%>
		<script type="text/javascript">
			jQuery(function(){
			    jQuery('.e8_box').Tabs({
			        ...
			        staticOnLoad:true,
			        objName:"<%=SystemEnv.getHtmlLabelName(19028,user.getLanguage())%>"
			    });
			});
			
			function setHref(a, type) {
				if (tabcontentframe.window.setHref) {
					tabcontentframe.window.setHref(a, type);
				}
			}
			
			function settab1(){
				$("#tabcontentframe").attr("src","/workflow/flowReport/PendingRequestStatShow.jsp?objType=1");
			}
			function settab2(){
				$("#tabcontentframe").attr("src","/workflow/flowReport/PendingRequestStatShow.jsp?objType=2");
			}
			function settab3(){
				$("#tabcontentframe").attr("src","/workflow/flowReport/PendingRequestStatShow.jsp?objType=3");
			}
	...
	<BODY scroll="no">
		<div class="e8_box demo2">
			...
			<div class="tab_box">
				<div>
					<iframe src="/workflow/flowReport/PendingRequestStatShow.jsp" onload="update();" id="tabcontentframe" name="tabcontentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
				</div>
			</div>

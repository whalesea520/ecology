...
<body>
	<div class="loadDiv">
		<div class="left">
			<div class="img"></div>
			<span><%=SystemEnv.getHtmlLabelNames("257,558",user.getLanguage()) %></span>
		</div>
		<div class="right">
			<div class="right_top">
				<span><%=SystemEnv.getHtmlLabelName(128063, user.getLanguage())%></span>
			</div>
			<div class="right_bottom">
				<a href="/workflow/exceldesign/loadAdobeReader.jsp?begload=true"><%=SystemEnv.getHtmlLabelName(128064, user.getLanguage())%></a>
			</div>
		</div>
	</div>
</body>

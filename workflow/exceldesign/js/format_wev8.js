...
function dynamicFormatObj(fieldid,realval,formatJSON,triggerFlag){
	try{
		...
		if(numberType===1){			//1常规
			...
			jQuery.ajax({
				type:"POST",
				url:"/workflow/exceldesign/excelAjaxData.jsp?src=formatToDate&realVal="+realval+"&formatPattern="+formatJSON["formatPattern"],
			...
			jQuery.ajax({
				type:"POST",
				url:"/workflow/exceldesign/excelAjaxData.jsp?src=formatToTime&realVal="+realval+"&formatPattern="+formatJSON["formatPattern"],
				success:function(res){
					formatval=jQuery.trim(res);
					dynamicfun();
				}
			...
			jQuery.ajax({
				type:"POST",
				url:"/workflow/exceldesign/excelAjaxData.jsp?src=formatToPercent&realVal="+realval+"&decimals="+formatJSON["decimals"],
				success:function(res){
					formatval=jQuery.trim(res);
					dynamicfun();
				}
			...
			jQuery.ajax({
				type:"POST",
				url:"/workflow/exceldesign/excelAjaxData.jsp?src=formatToScience&realVal="+realval+"&decimals="+formatJSON["decimals"],
				success:function(res){
					formatval=jQuery.trim(res);
					dynamicfun();
				}
			...
			jQuery.ajax({
				type:"POST",
				url:"/workflow/exceldesign/excelAjaxData.jsp?src=formatToSpecial&realVal="+realval+"&formatPattern="+formatJSON["formatPattern"],
				success:function(res){
					formatval=jQuery.trim(res);
					dynamicfun();
				}
			...
			jQuery.ajax({
				type:"POST",
				url:"/workflow/exceldesign/excelAjaxData.jsp?src=formatToMoneyUpper&realVal="+realval,
				success:function(res){
					formatval=jQuery.trim(res);
					dynamicfun();
				}
...
function formatValue_float(realval,decimals,thousands,formatPattern){
	...
	if(decimals === 0){		//需取整
		...
		if(decimals >= pointLength){		//需补零
			...
			formatval = toFix(realval,decimals);
		}
	}

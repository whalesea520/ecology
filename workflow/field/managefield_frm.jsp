...
//}
if(detachable==0){
    response.sendRedirect("managefieldTab.jsp");
    return;
}
%>
<HTML><HEAD>
...
var contentUrl = (window.location+"").substring(0,(window.location+"").lastIndexOf("/")+1)+"managefieldTab.jsp";
//alert(contentUrl);
...
<IFRAME name=contentframe id=contentframe src="managefieldTab.jsp" width="100%" height="100%" frameborder=no scrolling=yes>
<%=SystemEnv.getHtmlLabelName(15017, user.getLanguage())%></IFRAME>
</td>
</tr>
  </TBODY>

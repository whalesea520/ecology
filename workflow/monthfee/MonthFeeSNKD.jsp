...
String titlename =  SystemEnv.getHtmlLabelName(15470,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(15464,user.getLanguage()) ;
String needfav ="1";
String needhelp ="";
%>
<BODY>
...
<input type=hidden name=src value="snkd">
...
<table class="viewform">
  ...
  <td><%=SystemEnv.getHtmlLabelName(15471,user.getLanguage())%></td>
...
String sql="select t1.* from workflow_form t1,workflow_requestbase t2 where t1.requestid = t2.requestid "+
            " and t2.workflowid=120 and t2.currentnodetype='3'";
...
while(RecordSet.next()){
    ...
    String tmpcrmid=RecordSet.getString("relatedcustomer");
...
<script>
function doRefresh(){
    frmmain.action="MonthFeeSNKD.jsp";
    frmmain.submit();
}
function doSave(){

...
String sqlwhere = "select t3.id,t2.requestname,t3.defcountprice,t3.countprice from workflow_form t1,workflow_requestbase t2,LgcStockInOut t3 where t1.requestid = t2.requestid and t1.billid = t3.id and t1.billformid = 2";
...
<FORM NAME=SearchForm STYLE="margin-bottom:0" action="StockInBrowser.jsp" method=post>

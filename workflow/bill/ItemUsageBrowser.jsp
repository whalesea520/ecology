...
String sqlwhere = "select t3.id,t2.requestname,t3.itemid from workflow_form t1,workflow_requestbase t2,bill_itemusage t3 where t1.requestid = t2.requestid and t1.billid = t3.id and t1.billformid = 1";
...
<FORM NAME=SearchForm STYLE="margin-bottom:0" action="ItemUsageBrowser.jsp" method=post>
...
<TABLE ID=BrowseTabl class="BroswerStyle"  cellspacing="1">
<TR class=DataHeader>
...
<TH width=30%><%=SystemEnv.getHtmlLabelName(145,user.getLanguage())%></TH></tr> 
...
<TR class=DataDark>
	...
	<TD><%=AssetAssortmentComInfo.getAssortmentName(RecordSet.getString(3))%>
	</TD>

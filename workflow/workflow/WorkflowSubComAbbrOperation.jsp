...
<%
	...
	String enableSubcode=Util.null2String(request.getParameter("enableSubcode"));
    ...
    RecordSet.executeSql("delete from workflow_subComAbbr where workflowId="+workflowId+" and enableSubcode=1");
    if(!enableSubcode.equals("1")){
    	...
    	RecordSet.executeSql("insert into workflow_subComAbbr(workflowId,enableSubcode) values("+workflowId+",'1')");
    }
    response.sendRedirect("WorkflowSubComAbbr.jsp?ajax="+ajax+"&isclose=1&workflowId="+workflowId);
%>

...
<BODY onload="initTree()">
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="WorkflowCodeSeqReserved_frmtwo.jsp" method=post target="contentframe">
...
function setSubcompany(nodeid){ 
    ...
    document.SearchForm.action="WorkflowCodeSeqReserved_frmtwo.jsp";

   ...
   function onClear() {
	...
	function onClose(){
		...
		function getUrl(treeId, treeNode) {
			...
			return "/workflow/workflow/MutilWorkflow_BrowserXML.jsp?wftypeid=<%=wftypeid%>&userid=<%=user.getUID()%>&reportwfid=<%=reportwfid%>&isopenos=<%=isopenos %>&showos=<%=showos%>&" + param;
		}

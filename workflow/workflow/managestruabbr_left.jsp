...
%>
	...
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="managestruabbr_help.jsp" method=post target="contentframe">
...
function initTree(){
CXLoadTreeItem("", "managestruabbr_leftXML.jsp?rightStr=<%=rightStr%><%if(nodeid!=null){%>&init=true&nodeid=<%=nodeid%><%}%>");
...
%>
   document.SearchForm.action="/workflow/workflow/StruAbbrTab.jsp?_fromURL=1";
<%
}else{
%>
    document.SearchForm.action="/workflow/workflow/StruAbbrTab.jsp?_fromURL=3";
<%
}
%>
...
function setSubcompany(nodeid){ 
    ...
    document.SearchForm.action="/workflow/workflow/StruAbbrTab.jsp?_fromURL=2";
    document.SearchForm.submit();
}

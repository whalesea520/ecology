...
<BODY onload="initTree()">
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="WorkflowCodeSeq_frmtwo.jsp" method=post target="contentframe">
...
function setSubcompany(nodeid){ 
    ...
    document.SearchForm.action="WorkflowCodeSeq_frmtwo.jsp";

...
<div id=odiv_1 style="display:''">
						...
						<wea:group context='<%=SystemEnv.getHtmlLabelName(106,user.getLanguage())%>'>
							...
							<wea:item>
								...
								<brow:browser onPropertyChange='<%=opchange %>' name="id_0" viewType="0" hasBrowser="true" hasAdd="false" 
							...
							<wea:item>
								...
								<brow:browser onPropertyChange='<%=opchange %>' name="id_1" viewType="0" hasBrowser="true" hasAdd="false" 
							...
							<wea:item>
								...
								<%if(!ajax.equals("1")){
								String opchange = "browpropertychange(this,'id_1')";%>
								<brow:browser onPropertyChange='<%= opchange%>' name="id_2" viewType="0" hasBrowser="true" hasAdd="false" 
								...
								<span id="relatedshareSpan_58" style="float:left;display:none;">
									<brow:browser name="relatedshareid_58" viewType="0" hasBrowser="true" hasAdd="false" 
						    				   ...
						    				   isMustInput="2" isSingle="false" hasInput="true"
						     				   completeUrl="javascript:getajaxurl(58)"  width="120px" browserValue="" browserSpanValue=""/>
						     	</span>
							</wea:item>
							...
							<wea:item>
								...
								<brow:browser onPropertyChange='<%=opchange %>' name="id_3" viewType="0" hasBrowser="true" hasAdd="false" 
						...
						<wea:group context='<%=SystemEnv.getHtmlLabelName(106,user.getLanguage())%>'>
							...
							<wea:item>
								...
								String opchange = "browpropertychange(this,'level_50')";%>
			      					<brow:browser onPropertyChange='<%=opchange %>' name="level_50" viewType="0" hasBrowser="true" hasAdd="false" 
			      						browserUrl="/systeminfo/BrowserMain.jsp?url=/hrm/roles/HrmRolesBrowser.jsp"
			            				_callback ="callbackMeth"
			            				isMustInput="1" isSingle="true" hasInput="true"
			            				completeUrl="/data.jsp?type=65"  width="150px" browserValue="" browserSpanValue="" />  
...
<%-- 文档字段 ，项目字段，资产字段，客户字段，创建人，客户门户相关，节点操作者，相关负责人 在addoperatorgroup_inner2.jsp中 --%>
<jsp:include page="/workflow/workflow/addoperatorgroup_inner2.jsp" flush="true">

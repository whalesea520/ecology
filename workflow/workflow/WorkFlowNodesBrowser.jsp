...
try{
    istemp = Util.null2String(wfid.split("_")[3]) ;
}catch(Exception e){
    istemp = "0" ;
}
String titlename = SystemEnv.getHtmlLabelName(125066,user.getLanguage()) ;//模板
if(istemp.equals("1")){
    titlename = SystemEnv.getHtmlLabelName(125020,user.getLanguage()) ;//设置
}
%>
<BODY>

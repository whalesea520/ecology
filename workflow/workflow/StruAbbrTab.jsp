...
<%
	...
	if(_fromURL.equals("1")||_fromURL.equals("")){//分部代字
		url = "/workflow/workflow/managestruabbr_subcompany.jsp?subCompanyId="+kv.get("companyid");
	}else if(_fromURL.equals("2")){//部门代字
		url = "/workflow/workflow/managestruabbr_department.jsp?subCompanyId="+kv.get("subCompanyId");
	}else if(_fromURL.equals("3")){//帮助
		url = "/workflow/workflow/managestruabbr_help.jsp";
	}
%>

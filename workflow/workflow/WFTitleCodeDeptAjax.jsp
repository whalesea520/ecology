...
if(user == null){
	...
	try{
		...
		String bh="";
	    	...
	    	if(valuestr.equals("")){
				valuestr=""+user.getUserDepartment();	
			} 
	    	RecordSet.executeSql("select departmentcode,departmentname,departmentmark from HrmDepartmentAllView where id="+valuestr+"");
    		if(RecordSet.next()){
    			jc=Util.null2String(RecordSet.getString("departmentname"));
    			qc=Util.null2String(RecordSet.getString("departmentmark"));
    			bh=Util.null2String(RecordSet.getString("departmentcode"));
    		}

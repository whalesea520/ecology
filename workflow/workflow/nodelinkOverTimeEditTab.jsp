...
<%
	String url = "/workflow/workflow/nodelinkOverTimeEdit.jsp";
...
$(function() {
    $(".e8_box").Tabs({
        ...
        staticOnLoad: true,
        objName: "<%=SystemEnv.getHtmlLabelName(125632, user.getLanguage()) %>"
    });
});
</script>
</head>
	...
	<div class="e8_boxhead">
		...
		<div class="e8_ultab">
			...
			<div>
				<ul class="tab_menu">
					<li class="defaultTab">
						<a href="#" target="tabcontentframe"><%=TimeUtil.getCurrentTimeString() %></a>
					</li>
				</ul>

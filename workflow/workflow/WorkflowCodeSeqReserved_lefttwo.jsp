...
<BODY onload="initTree()" style="overflow:hidden;">
    <FORM NAME=SearchForm STYLE="margin-bottom:0" action="WorkflowCodeSeqReservedHelp.jsp" method=post target="wfmainFrame">
...
CXLoadTreeItem("", "/workflow/workflow/WorkflowCodeSeqReserved_lefttwoXML.jsp?&init=true&subCompanyId=<%=subCompanyId%>&operatelevel=<%=operatelevel%>&nodeid=<%=nodeid%>&sqlwhere=<%=xssUtil.put(sqlwhere)%>");
...
//jQuery("#webfx-tree-object-7-cont").("display","block");

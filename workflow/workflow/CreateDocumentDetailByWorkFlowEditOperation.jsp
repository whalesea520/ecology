...
<%
    ...
    WFDocumentManager.saveCreateDocDetailEdit(workFlowID, selectItemID, secCategoryID, docMouldID, bookMarkIDList, formDictIDList,dateShowTypeList);    
    if(isdialog.equals("1")){
    	response.sendRedirect("/workflow/workflow/CreateDocumentDetailByWorkFlowEdit.jsp?isclose=1&ajax=1&wfid=" + workFlowID + "&formid=" + request.getParameter("formID"));
    }else{
    	response.sendRedirect("/workflow/workflow/CreateDocumentByWorkFlowEdit.jsp?ajax=1&wfid=" + workFlowID + "&formid=" + request.getParameter("formID"));
    }
%>
    </HEAD>
<BODY>

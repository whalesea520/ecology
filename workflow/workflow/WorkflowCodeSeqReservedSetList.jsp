...
<wea:group context="" attributes="{'groupDisplay':'none'}">
	<wea:item type="toolbar">
		<input type="submit" value="<%=SystemEnv.getHtmlLabelName(197,user.getLanguage())%>" class="e8_btn_submit" onclick="onSearchCodeSeqReservedSet();"/>
...
if("1".equals(struSeqAlone)){
	...
	//System.out.println("struSb.toString() = " + struSb.toString());
...
function onSearchCodeSeqReservedSet() {
	if(checkValueCodeSeqSet()){
		obj.disabled = true;
		document.formCodeSeqSet.action="WorkflowCodeSeqReservedSetList.jsp" ;

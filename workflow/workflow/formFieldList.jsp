...
<% 
String navName = SystemEnv.getHtmlLabelName(21740,user.getLanguage());
...
<%
	String url = "/workflow/workflow/formFieldListTab.jsp?selectedids="+selectedids+"&groupid="+groupid+"&isbill="+isbill+"&formid="+formid;
%>

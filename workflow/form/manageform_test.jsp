...
%>
<form name="fromaddtab" method="post" id="fromaddtab">
<input type=hidden name=formid value="<%= formid %>">
<input type=hidden name=formname value="<%= formname %>">
<input type=hidden name=formdes value="<%= formdes %>">
<input type=hidden name="ajax" value="<%=ajax%>">
<input type="hidden" name="pageId" id="pageId" value="<%= PageIdConst.WF_FORM_MANAGEFORM_TEST %>"/>
...
<table id="topTitle" cellpadding="0" cellspacing="0">
	<tr>
		...
		<div id="tabDiv" >
			...
			<span style="margin-left:-4px;"  class="selectedTitle" ><%=SystemEnv.getHtmlLabelName(125026, user.getLanguage())%></span>
...
String sqlWhere = " where (isoldornew = 0 or id <0) ";
...
sqlWhere+=" and not exists  (select 1 from ModeFormExtend b where a.id = b.formid and isvirtualform=1) ";
...
tableString =   " <table instanceid=\"workflowFormListTable\" tabletype=\"checkbox\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.WF_FORM_MANAGEFORM_TEST,user.getUID())+"\" >"+
...
function submitData()
{
	...
	top.Dialog.confirm("<%=SystemEnv.getHtmlLabelName(15097,user.getLanguage())%>", function (){
		window.location = "/workflow/form/delforms.jsp?oldformids="+oldformids+"&newformids="+newformids;
				//fromaddtab.submit();
...
function doSearchForm(){
    fromaddtab.action = "/workflow/form/manageform_test.jsp";
    fromaddtab.submit();
}
</script>
<%
...
function onBtnSearchClick(){
	...
	window.location="/workflow/form/manageform_test.jsp?formnameForSearch="+typename;
}

...
<BODY onload="initTree()">
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="/workflow/form/manageformTab.jsp" method=get target="contentframe">
...
cxtree_obj.expand();
$("#overFlowDiv").height($("#contentframe",window.parent.document).height()-10);
$("#overFlowDivTree").height($("#contentframe",window.parent.document).height()-10);
}

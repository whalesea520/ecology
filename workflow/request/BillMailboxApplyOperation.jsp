...
if( RequestManager.getNextNodetype().equals("3") ) {
	rs.executeSql(" select resourceid , mailid from bill_MailboxApply where id = " + billid ) ;
	if( rs.next() ) {
		String mailid = Util.null2String(rs.getString("mailid"));
		String resourceid = Util.null2String(rs.getString("resourceid")); 
		rs1.executeSql(" select email from HrmResource where id = " + resourceid ) ;
		rs1.next();
		String email = Util.null2String(rs1.getString("email")); 
		if (!email.equals("")) email += "," + mailid ;
        rs.executeSql("update HrmResource set email = '" + email +  "' where id = " + resourceid );
	}
}

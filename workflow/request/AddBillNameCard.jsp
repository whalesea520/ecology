...
%>
	...
	if(fieldhtmltype.equals("1")){
        ...
        <input type=text name="field<%=fieldid%>" onKeyPress="ItemCount_KeyPress()" onBlur='checkcount1(this)' size=10>
        <%}
			}
		}
        ...
        <input type=text name="field<%=fieldid%>" onKeyPress="ItemNum_KeyPress()" onBlur='checknumber1(this)' size=10>
        <%}
			}
		}
	}
...
%>
    ...
    <tr>
    <td>姓名（中文）</td>
    <td class=field><input type=text name="cname" size=40 onchange="checkinput('cname','cnamespan')"
    value="<%=Util.toScreenToEdit(RecordSet.getString("cname"),user.getLanguage())%>">
    <span id=cnamespan><%if(RecordSet.getString("cname").equals("")){%>
    <img src="/images/BacoError_wev8.gif" align=absmiddle><%}%></span></td>
    </tr>
    <tr>
    <td>职位（中文）</td>
    <td class=field><input type=text name="cjobtitle" size=40 onchange="checkinput('cjobtitle','cjobtitlespan')"
    value="<%=Util.toScreenToEdit(RecordSet.getString("cjobtitle"),user.getLanguage())%>">
    <span id=cjobtitlespan><%if(RecordSet.getString("cjobtitle").equals("")){%>
    <img src="/images/BacoError_wev8.gif" align=absmiddle><%}%></span></td>
    </tr>
    <tr>
    <td>部门（中文）</td>
    <td class=field><input type=text name="cdepartment" size=40 onchange="checkinput('cdepartment','cdepartmentspan')"
    value="<%=Util.toScreenToEdit(RecordSet.getString("cdepartment"),user.getLanguage())%>">
    <span id=cdepartmentspan><%if(RecordSet.getString("cdepartment").equals("")){%>
    <img src="/images/BacoError_wev8.gif" align=absmiddle><%}%></span></td>
    </tr>
    <tr>
    <td>电话（分机）</td>
    <td class=field><input type=text name="phone" size=40 onKeyPress="ItemPhone_KeyPress()"
    onBlur="checkphone1(this);checkinput('phone','phonespan')"
    value="<%=Util.toScreenToEdit(RecordSet.getString("phone"),user.getLanguage())%>">
    <span id=phonespan><%if(RecordSet.getString("phone").equals("")){%>
    <img src="/images/BacoError_wev8.gif" align=absmiddle><%}%></span></td>
    </tr>
    <tr>
    <td>手机</td>
    <td class=field><input type=text name="mobile" size=40 onKeyPress="ItemPhone_KeyPress()"
    onBlur="checkphone1(this);checkinput('mobile','mobilespan')"
    value="<%=Util.toScreenToEdit(RecordSet.getString("mobile"),user.getLanguage())%>">
    <span id=mobilespan><%if(RecordSet.getString("mobile").equals("")){%>
    <img src="/images/BacoError_wev8.gif" align=absmiddle><%}%></span></td>
    </tr>  
    <tr>
    <td>Email</td>
    <td class=field><input type=text name="email" size=40 onchange="checkinput_email('email','emailspan')"
    value="<%=Util.toScreenToEdit(RecordSet.getString("email"),user.getLanguage())%>">
    <span id=emailspan><%if(RecordSet.getString("email").equals("")){%>
    <img src="/images/BacoError_wev8.gif" align=absmiddle><%}%></span></td>
    </tr>
    <tr>
    <td>姓名（英文）</td>
    <td class=field><input type=text name="ename" size=40 onchange="checkinput('ename','enamespan')"
    value="<%=Util.toScreenToEdit(RecordSet.getString("ename"),user.getLanguage())%>">
    <span id=enamespan><%if(RecordSet.getString("ename").equals("")){%>
    <img src="/images/BacoError_wev8.gif" align=absmiddle><%}%></span></td>
    </tr>
    <tr>
    <td>职位（英文）</td>
    <td class=field><input type=text name="ejobtitle" size=40 onchange="checkinput('ejobtitle','ejobtitlespan')"
    value="<%=Util.toScreenToEdit(RecordSet.getString("ejobtitle"),user.getLanguage())%>">
    <span id=ejobtitlespan><%if(RecordSet.getString("ejobtitle").equals("")){%>
    <img src="/images/BacoError_wev8.gif" align=absmiddle><%}%></span></td>
    </tr>
    <tr>
    <td>部门（英文）</td>
    <td class=field><input type=text name="edepartment" size=40 onchange="checkinput('edepartment','edepartmentspan')"
    value="<%=Util.toScreenToEdit(RecordSet.getString("edepartment"),user.getLanguage())%>">
    <span id=edepartmentspan><%if(RecordSet.getString("edepartment").equals("")){%>
    <img src="/images/BacoError_wev8.gif" align=absmiddle><%}%></span></td>
    </tr>    	      	  
	<tr class="Title">

...
rs_11.executeSql("select * from workflow_billfield where  billid = 156");
while(rs_11.next()){
	String fieldname = Util.null2String(rs_11.getString("fieldname")).trim();
	if(fieldname.equals("subject")){
		subjectFieldId = rs_11.getInt("id");
	}else if(fieldname.equals("organizationid")){
		organizationidFieldId = rs_11.getInt("id");
	}
}

...
<input type=hidden name ="topage" value="<%=topage%>">
  ...
  <div align="center"><br>
    <font style="font-size:14pt;FONT-WEIGHT: bold">本月工作目标</font> <br>
    <br>
  </div>
  <table class=form>
    ...
    <tr> 
      <td>说明</td>
      <td class=field> 
        <input type=text name=requestname onChange="checkinput('requestname','requestnamespan')" style="width:50%" maxlength=25>

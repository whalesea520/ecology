...
<wea:layout>
	...
	<table class=ListStyle cellspacing=1 id="oTable_3">
	    ...
	    <TR class="Title" style="text-align: left;">
    	  <TH colSpan=4><%=SystemEnv.getHtmlLabelName(101,user.getLanguage())%><%=Util.toScreen(ProjectInfoComInfo.getProjectInfoname(theprojectid),user.getLanguage())%></TH>
        </TR>
        <tr class=datalight >
	...
	<table class=ListStyle cellspacing=1 id="oTable_4">
        ...
        <%} %>
	    <TR class="Title" style="text-align: left;">
    	  <TH colSpan=4>CRM<%=Util.toScreen(CustomerInfoComInfo.getCustomerInfoname(thecrmid),user.getLanguage())%></TH>
        </TR>
        <tr class=datalight >

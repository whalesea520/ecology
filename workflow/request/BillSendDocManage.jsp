    ...
    <tr>
      ...
      <%
            ...
            if(fieldtype.equals("2") ||fieldtype.equals("19")  )	showname=fieldvalue; // 日期时间
                ...
                if(fieldtype.equals("17")|| fieldtype.equals("18")||fieldtype.equals("27")||fieldtype.equals("37")||fieldtype.equals("56")) {    // 多人力资源,多客户,多会议，多文档
                ...
                while(RecordSet.next()){
                    ...
                    if(!linkurl.equals(""))
                    {
        				if("/hrm/resource/HrmResource.jsp?id=".equals(linkurl))
                    	{
        					...
        					showname = "<a href='"+linkurl+showid+"'>"+tempshowname+"</a>&nbsp";
        			}
                    else

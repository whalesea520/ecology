	...
	while(RecordSet.next()){
		String  capitalid = Util.toScreen(RecordSet.getString("id"),user.getLanguage()) ;
           ...
           <TD><%=capitalnum%></TD>
            ...
            <TD><%=RecordSet.getFloat("realnumber")-RecordSet.getFloat("theorynumber")%></TD>
            <td><%=(float)(((int)((RecordSet.getFloat("realnumber")-RecordSet.getFloat("theorynumber"))*tempcapitalprice*100))/100.00)%></td>

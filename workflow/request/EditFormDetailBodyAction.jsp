...
String initDetailIframeStrAdd = "";
    ...
    boolean editdetailbodyflag=true;
  ...
  //TD10029
    ...
    String isdeview="1" ;    //字段是否显示
    String isdeedit="1" ;    //字段是否可以编辑
    ...
    //if(isbill.equals("0")){  xwj for td3131 20051117  除去单据或表单的判断
        //得到计算公式的字符串
              ...
              while(stk.hasMoreTokens()){
                ...
                String dtladd = "1";//WFNodeDtlFieldManager.getIsadd();
                String dtledit = "1";//WFNodeDtlFieldManager.getIsedit();
                String dtldelete = "1";//WFNodeDtlFieldManager.getIsdelete();
                String dtldefault = "0";
                String dtlneed = "0";
                 //zzl---老表单的代办页面
   ...
   %>
    ...
    %>
        ...
        <%          }
                        ...
                        <td width="4%">
                        <input type='checkbox' name='check_node<%=detailno%>' value="<%=derecorderindex%>" >

...
{
RecordSet.execute("select * from bill_cptlend where  requestid="+requestid);
if (RecordSet.next())
	{

capitalid =RecordSet.getString("lendCpt"); 
String hrmid =RecordSet.getString("lendPerson"); 
String departmentid = RecordSet.getString("lendDepartment"); 
String lenddate =RecordSet.getString("lenddate"); 
String location = RecordSet.getString("saveAddress"); 

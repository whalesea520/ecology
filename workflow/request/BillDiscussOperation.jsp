...
//特殊处理
String isEnd=Util.null2String(fu.getParameter("isend"));
if (!isEnd.equals("")&&!nodetype.equals("0"))
{
rs.execute("update bill_discuss set isend='1' where requestid="+requestid);
}

...
$(function(){
    $('.e8_box').Tabs({
        ...
        staticOnLoad:true,
        objName:"<%=SystemEnv.getHtmlLabelName(2112, user.getLanguage())%>"
    });
...
int userid=user.getUID();  
	String url = "/workflow/request/WorkflowPrmsnAdd.jsp";
	if(request.getQueryString() != null){
		url += "?f_weaver_belongto_userid="+userid+"&f_weaver_belongto_usertype="+f_weaver_belongto_usertype+"&"+request.getQueryString();
	}
%>

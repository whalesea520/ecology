...
<LINK href="/css/remark3_wev8.css" type=text/css rel=STYLESHEET>
				...
				<div class="panel_state_content" id="u7_state0_content">
		            ...
		            <div class="ax_xz ax_title">
		              <div class="text" id="u9">
		                <p><span><%=SystemEnv.getHtmlLabelName(84509,user.getLanguage())%></span></p>
		              </div>
		            </div>
		            ...
		            <div class="ax_all ax_noselected" id="u16" style="color: #242424;">
		            	<span style="cursor: pointer;" onclick="allBtnOnClick()"><b><%=SystemEnv.getHtmlLabelName(82857,user.getLanguage())%></b></span>
		            </div>
		            ...
		            <div class="ax_handed ax_noselected" id="u18" style="color: #242424;">
		            	<span style="cursor: pointer;" onclick="handedBtnOnClick()"><b><%=SystemEnv.getHtmlLabelName(28499,user.getLanguage())%></b></span>
		            </div>
		            ...
		            <div class="ax_nohanded ax_noselected" id="u20" style="color: #242424;">
		            	<span style="cursor: pointer;" onclick="nohandedBtnOnClick()"><b><%=SystemEnv.getHtmlLabelName(28500,user.getLanguage())%></b></span>
		            </div>

				...
				if(edittypes.indexOf("2_1")!=-1){
			        ...
			        try
			        {
			        	...
			        	if(mandtypes.indexOf("2_1")!=-1){
						   ...
						   linkUrl:"#",
						   isSingle:true,
						   completeUrl:"/data.jsp?type=23&cptstateid=2&inculdeNumZero=0",
						   browserUrl:"",
						   width:'90%',
						   hasAdd:false,
						   isSingle:true,
			...
			case 3: 
				...
				if(edittypes.indexOf("3_1")!=-1){
					if(mandtypes.indexOf("3_1")!=-1){ 
						sHtml = "<input type='text' class=Inputstyle name='node_"+rowindex+"_number'  onBlur=\"checkinput('node_"+rowindex+"_number','node_"+rowindex+"_numberspan');checknumber1(this);\"><span id='node_"+rowindex+"_numberspan'>";
			...
			case 4: 
				...
				if(edittypes.indexOf("4_1")!=-1){
					if(mandtypes.indexOf("4_1")!=-1){
						sHtml = "<input type='text'  class=Inputstyle  name='node_"+rowindex+"_unitprice'   onBlur=\"checkinput('node_"+rowindex+"_unitprice','node_"+rowindex+"_unitpricespan');checknumber1(this);\"><span id='node_"+rowindex+"_unitpricespan'>";
						sHtml += "<img src='/images/BacoError_wev8.gif' align=absmiddle>";
			...
			case 5: 
				...
				if(edittypes.indexOf("5_1")!=-1){
					if(mandtypes.indexOf("5_1")!=-1){
						sHtml = "<input type='text' class=Inputstyle   name='node_"+rowindex+"_amount'   onBlur=\"checkinput('node_"+rowindex+"_amount','node_"+rowindex+"_amountspan');checknumber1(this);\"><span id='node_"+rowindex+"_amountspan'>";
						sHtml += "<img src='/images/BacoError_wev8.gif' align=absmiddle>";
        					needcheck += ","+"node_"+rowindex+"_amount";
        					sHtml+="</span>"
        				}else{
        					sHtml = "<input type='text' onBlur='checknumber1(this);' class=Inputstyle  name='node_"+rowindex+"_amount'>";
        				}
...
{
	return "/systeminfo/BrowserMain.jsp?url=/cpt/capital/CapitalBrowser.jsp?sqlwhere=where isdata=2&cptstateid=2&inculdeNumZero=0";
}
...
sub onShowCptCapital(spanname,inputname)
	mand = 1
...
sub onShowCptType(spanname,inputname)
	mand = 1

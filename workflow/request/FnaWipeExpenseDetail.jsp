...
((TreeSet)crmsubjectmaps.get(""+relatedcrm)).add(s);
            ...
            for( Iterator i=subjects.iterator() ;i.hasNext(); ) {
                ...
                double resourcecurrentexpense = cur_exp.getRealExpense()+cur_exp1.getRealExpense()+cur_exp1.getPendingExpense();
                //double resourcebeforeexpense = before_exp.getRealExpense()+before_exp1.getRealExpense()+before_exp1.getPendingExpense();
                double resourceyearexpense = year_exp.getRealExpense()+year_exp1.getRealExpense()+year_exp1.getPendingExpense();
                double resourcebeforeexpense = resourceyearexpense - resourcecurrentexpense;
...
((TreeSet)crmsubjectmaps.get(""+relatedcrm)).add(s);
            ...
            for( Iterator i=subjects.iterator() ;i.hasNext(); ) {
                ...
                double departmentcurrentexpense = cur_exp.getRealExpense()+cur_exp1.getRealExpense()+cur_exp1.getPendingExpense();
                //double departmentbeforeexpense = before_exp.getRealExpense()+before_exp1.getRealExpense()+before_exp1.getPendingExpense();
                double departmentyearexpense = year_exp.getRealExpense()+year_exp1.getRealExpense()+year_exp1.getPendingExpense();
                double departmentbeforeexpense = departmentyearexpense - departmentcurrentexpense;

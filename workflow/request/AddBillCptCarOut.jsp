...
<TR class=Section>
  ...
  <tr>
  <table Class=ListShort cols=15 id="oTable"><COLGROUP>
      	
   <tr class=header> 
    	   <td rowspan=2 width="2%">选中</td>
...
function addRow()
{
	...
	for(j=0; j<ncol; j++) {
		...
		switch(j) {
			...
			case 4: 
				var oDiv = document.createElement("div"); 
				var sHtml = "<button class=Browser onClick='onShowDate(node_"+rowindex+"_begindatespan,node_"+rowindex+"_begindate)'></button> " + 
        					"<span class=saveHistory id=node_"+rowindex+"_begindatespan></span> "+
        					"<input type='hidden' name='node_"+rowindex+"_begindate' id='node_"+rowindex+"_begindate'>";
				oDiv.innerHTML = sHtml;   
				oCell.appendChild(oDiv);  
				break;			
			case 5: 
				var oDiv = document.createElement("div"); 
				var sHtml = "<button class=Browser onClick='onShowTime(node_"+rowindex+"_begintimespan,node_"+rowindex+"_begintime)'></button> " + 
        					"<span class=saveHistory id=node_"+rowindex+"_begintimespan></span> "+
        					"<input type='hidden' name='node_"+rowindex+"_begintime' id='node_"+rowindex+"_begintime'>";
				oDiv.innerHTML = sHtml;   
				oCell.appendChild(oDiv);  
				break;	
			case 6: 
				var oDiv = document.createElement("div"); 
				var sHtml = "<button class=Browser onClick='onShowDate(node_"+rowindex+"_enddatespan,node_"+rowindex+"_enddate)'></button> " + 
        					"<span class=saveHistory id=node_"+rowindex+"_enddatespan></span> "+
        					"<input type='hidden' name='node_"+rowindex+"_enddate' id='node_"+rowindex+"_enddate'>";
				oDiv.innerHTML = sHtml;   
				oCell.appendChild(oDiv);  
				break;			
			case 7: 
				var oDiv = document.createElement("div"); 
				var sHtml = "<button class=Browser onClick='onShowTime(node_"+rowindex+"_endtimespan,node_"+rowindex+"_endtime)'></button> " + 
        					"<span class=saveHistory id=node_"+rowindex+"_endtimespan></span> "+
        					"<input type='hidden' name='node_"+rowindex+"_endtime' id='node_"+rowindex+"_endtime'>";
				oDiv.innerHTML = sHtml;   
				oCell.appendChild(oDiv);  
				break;					
			case 8: 
				var oDiv = document.createElement("div"); 
				var sHtml = "<input type='text' name='node_"+rowindex+"_frompos' style=width:100%>";
				oDiv.innerHTML = sHtml;   
				oCell.appendChild(oDiv); 
				break;	
			case 9: 
				var oDiv = document.createElement("div"); 
				var sHtml = "<input type='text' style=width:100%  name='node_"+rowindex+"_beginnumber' onchange='changenumber("+rowindex+")'>";
				oDiv.innerHTML = sHtml;   
				oCell.appendChild(oDiv);  
				break;	
			case 10: 
				var oDiv = document.createElement("div"); 
				var sHtml = "<input type='text' style=width:100%  name='node_"+rowindex+"_endnumber' onchange='changenumber("+rowindex+")'>";
				oDiv.innerHTML = sHtml;   
				oCell.appendChild(oDiv);  
				break;
			case 11: 
				var oDiv = document.createElement("div"); 
				var sHtml = "<span id='node_"+rowindex+"_number' name='node_"+rowindex+"_number'></span>";
				oDiv.innerHTML = sHtml;   
				oCell.appendChild(oDiv);  
				break;
			case 12: 
				var oDiv = document.createElement("div"); 
				var sHtml = "<button class=Browser onClick='onShowResource(node_"+rowindex+"_useridspan,node_"+rowindex+"_userid)'></button> " + 
        					"<span class=saveHistory id=node_"+rowindex+"_useridspan></span> "+
        					"<input type='hidden' name='node_"+rowindex+"_userid' id='node_"+rowindex+"_userid'>";
				oDiv.innerHTML = sHtml;   
				oCell.appendChild(oDiv);  
				break;	
			case 13: 
				var oDiv = document.createElement("div"); 
				var sHtml = "<button class=Browser onClick='onShowDepartment(node_"+rowindex+"_userdepidspan,node_"+rowindex+"_userdepid)'></button> " + 
        					"<span class=saveHistory id=node_"+rowindex+"_userdepidspan></span> "+
        					"<input type='hidden' name='node_"+rowindex+"_userdepid' id='node_"+rowindex+"_userdepid'>";
				oDiv.innerHTML = sHtml;   
				oCell.appendChild(oDiv);  
				break;
			case 14:
				var oDiv = document.createElement("div");
				var sHtml = "<input type='checkbox' name='node_"+rowindex+"_isotherplace' value='1'>"; 
				oDiv.innerHTML = sHtml;
				oCell.appendChild(oDiv);
				break;
		}

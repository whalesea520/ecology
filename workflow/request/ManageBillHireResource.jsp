...
RecordSet.executeProc("Bill_HireResource_SelectByID",billid+"");
RecordSet.next();
...
<%
String userdepartment = ResourceComInfo.getDepartmentID(""+userid);

if(userdepartment.equals("2")){
%>
	<tr>
		<td><%=SystemEnv.getHtmlLabelName(16311,user.getLanguage())%></td>
		<td>
		<select class=inputstyle  name="cptgivetype" size=1 onchange="onChangetype(this.value)" style="width:20%">
			<option value="A">A<%=SystemEnv.getHtmlLabelName(15324,user.getLanguage())%></option>
			<option value="B">B<%=SystemEnv.getHtmlLabelName(15324,user.getLanguage())%></option>
		</select>
		</td>
	</tr>
	<tr>
	  <td colspan=2>
		...
		<table class=liststyle cellspacing=1  >
			...
			<tr class="Title"><th colspan=3><%=SystemEnv.getHtmlLabelName(16312,user.getLanguage())%></th></tr>
			<TR class="Spacing"><TD class="Line1" colSpan=3></TD></TR>
			<tr class=header>
				<td><%=SystemEnv.getHtmlLabelName(16313,user.getLanguage())%></td>
				<td><%=SystemEnv.getHtmlLabelName(16314,user.getLanguage())%></td>
				<td><%=SystemEnv.getHtmlLabelName(1331,user.getLanguage())%></td>
			</tr>
			<tr class=datalight>
				<td><%=SystemEnv.getHtmlLabelName(16315,user.getLanguage())%>GL8<input type=hidden name="cpt_1_id" value="20"></td>
				<td><%=SystemEnv.getHtmlLabelName(920,user.getLanguage())%><input type=hidden name="cpt_1_desc" value="<%=SystemEnv.getHtmlLabelName(920,user.getLanguage())%>"></td>
				<td>1<input type=hidden name="cpt_1_sum" value="1"></td>
			</tr>
		</table>
		</div>
		...
		<table class=liststyle cellspacing=1  >
			...
			<tr class=datalight>
				<td><%=SystemEnv.getHtmlLabelName(16316,user.getLanguage())%><input type=hidden name="cpt_1_id" value="7"></td>
				<td><%=SystemEnv.getHtmlLabelName(16317,user.getLanguage())%><input type=hidden name="cpt_1_desc" value="<%=SystemEnv.getHtmlLabelName(16317,user.getLanguage())%>"></td>
				<td>3<input type=hidden name="cpt_1_sum" value="3"></td>
			</tr>
		</table>
		</div>
	  </td>
...
if(nodetype.equals("3")){
	RecordSet.executeSql("select cptgivetype from bill_HireResource where id="+billid);
	RecordSet.next();
	String cptgivetype=RecordSet.getString("cptgivetype");
%>
	<tr>
		<td><%=SystemEnv.getHtmlLabelName(16311,user.getLanguage())%></td>
		<td><%=cptgivetype%><%=SystemEnv.getHtmlLabelName(15324,user.getLanguage())%></td>
	</tr>
<%
}
%>

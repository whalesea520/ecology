										...
										<tbody>
											...
											<tr>
												...
												<td class=field><!-- Sap方法 -->
													...
													<br>
													 <%=SystemEnv.getHtmlLabelName(27927, user.getLanguage())%>
												</td>
											</tr>
											<tr><td class=line colspan=2></td></tr>
											<tr>
													...
													<td colspan=2>
														<table class="ListStyle" id="oTable0" >
															...
															<TBODY>
																<tr class="header">
																<td width="3%"></td>
																<td width="12%" nowrap><%=SystemEnv.getHtmlLabelName(561,user.getLanguage())%><%=SystemEnv.getHtmlLabelName(63,user.getLanguage())%></td>
																<td width="18%" nowrap><%=SystemEnv.getHtmlLabelName(23481,user.getLanguage())%></td>
											...
											<tr>
												<td colspan="2">
													<%=SystemEnv.getHtmlLabelName(27928,user.getLanguage())%>：
													<br>
													<%=SystemEnv.getHtmlLabelName(27903,user.getLanguage())%>：<%=SystemEnv.getHtmlLabelName(27929,user.getLanguage())%>
													<br>
													Sap<%=SystemEnv.getHtmlLabelName(27904,user.getLanguage())%>：<%=SystemEnv.getHtmlLabelName(27930,user.getLanguage())%><%=SystemEnv.getHtmlLabelName(27931,user.getLanguage())%>：$name1$:$field001$,$name2$:$field002$
													<br>
													<%=SystemEnv.getHtmlLabelName(27905,user.getLanguage())%>：<%=SystemEnv.getHtmlLabelName(27932,user.getLanguage())%><%=SystemEnv.getHtmlLabelName(27931,user.getLanguage())%>：$name1$:$field001$,$name2$:$field002$
													<br>
													<font color="#ff0000"><b><%=SystemEnv.getHtmlLabelName(18739,user.getLanguage())%></b>：<%=SystemEnv.getHtmlLabelName(27933,user.getLanguage())%></font>
													<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#ff0000"><%=SystemEnv.getHtmlLabelName(27926,user.getLanguage())%></font>
													<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#ff0000"><%=SystemEnv.getHtmlLabelName(27934,user.getLanguage())%></font>
												</td>
											</tr>
											<tr><td class=line colspan=2></td></tr>
											<tr>
											<td colspan="2">
												<table class="liststyle" style="LEFT: 0px; WIDTH: 100%;WORD-WRAP: break-word;" cellspacing="0" cellpadding="0">
													<colgroup>
														...
														<col width="70%">
													<tr class="Header">
													<td><%=SystemEnv.getHtmlLabelName(27906,user.getLanguage())%></td>
													<td align="right">
														<BUTTON Class="BtnFlow" type="button" onclick="addRow(1)"><%=SystemEnv.getHtmlLabelName(611,user.getLanguage())%></BUTTON>
														<BUTTON Class="BtnFlow" type="button" onclick="deleteRow(1)"><%=SystemEnv.getHtmlLabelName(91,user.getLanguage())%></BUTTON>
													</td>
													</tr>
													<tr>
													<td colspan=2>
														<table class="ListStyle" id="oTable1" >
															...
															<TBODY>
																...
																<td width="12%" nowrap><%=SystemEnv.getHtmlLabelName(561,user.getLanguage())%><%=SystemEnv.getHtmlLabelName(63,user.getLanguage())%></td>
																<td width="18%" nowrap><%=SystemEnv.getHtmlLabelName(23481,user.getLanguage())%></td>
																<td width="67%" nowrap><%=SystemEnv.getHtmlLabelName(1338,user.getLanguage())%>SQL</td>
																</tr>
														<%
															int indexnum1 = 0;
															String submitdtlid1 = "";
											...
											<tr>
												<td colspan="2">
													<%=SystemEnv.getHtmlLabelName(27928,user.getLanguage())%>：
													<br>
													<%=SystemEnv.getHtmlLabelName(27935,user.getLanguage())%>
													SQL<%=SystemEnv.getHtmlLabelName(27924,user.getLanguage())%>：
													<br>
													update formtable_main_100 set field001='$name1$', field002=$name2$ where requestid=$requestid$
													<br>
													<font color="#ff0000"><b><%=SystemEnv.getHtmlLabelName(18739,user.getLanguage())%></b>：<%=SystemEnv.getHtmlLabelName(27933,user.getLanguage())%></font>
													<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#ff0000"><%=SystemEnv.getHtmlLabelName(27925,user.getLanguage())%></font>
													<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#ff0000"><%=SystemEnv.getHtmlLabelName(27937,user.getLanguage())%></font>
												</td>
											</tr>
											<tr><td class=line colspan=2></td></tr>
											<tr>
											...
											<tr>
												<td colspan=2>
													<table width="100%" class="liststyle">
														...
														<tbody>
															<tr class="Header">
																<td colspan="5"><%=SystemEnv.getHtmlLabelName(19325, user.getLanguage())%><%=groupCount%><%=SystemEnv.getHtmlLabelName(261, user.getLanguage())%></td>
															</tr>
															<tr class="Line"><th colspan="5"></th></tr>
														<%
														if(isbill == 0){

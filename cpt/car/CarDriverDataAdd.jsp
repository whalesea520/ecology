...
<TABLE class=viewform>
  ...
  <TR>
    ...
    <a href="/hrm/resource/HrmResource.jsp?id=<%=driverid%>"></a><%if(driverid<=0){%><IMG src="/images/BacoError_wev8.gif" align="absMiddle"><%}else {%>
...
%>
  ...
  <TR>
    ...
    <SPAN id=startkmspan><IMG src="/images/BacoError_wev8.gif" align=absMiddle></SPAN></TD>
    ...
    <SPAN id=backkmspan><IMG src="/images/BacoError_wev8.gif" align=absMiddle></SPAN></TD>
  </TR>
  <TR><TD class=Line colspan=4></TD></TR> 
  <TR>

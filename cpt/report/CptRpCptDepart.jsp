            ...
            <TD vAlign=top> 
              <TABLE width="100%">
                ...
                <tr> 
                  ...
                  <td class=Field> 
                   <button class=Browser onClick='onShowDepartment(departmentidspan,departmentid)'></button>
	<span class=saveHistory id=departmentidspan></span> 
...
function onSearch(){
	document.frmain.action="CptRpCptDepartResult.jsp";
	frmain.submit();
}
</SCRIPT>
<SCRIPT language=VBS>

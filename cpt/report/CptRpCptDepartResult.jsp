...
String titlename = SystemEnv.getHtmlLabelName(15355,user.getLanguage()) ;
String needfav ="1";
String needhelp ="";
%>
<BODY>
...
<img src="/weaver/weaver.cpt.report.ShowCptDepartFee?startdate=<%=begindate%>&enddate=<%=enddate%>&departmentid=<%=departmentid%>" border=0>
</td>
</tr>
<tr>
<td colspan=2 align=center>
<font size = 4><b><%=Util.toScreen(DepartmentComInfo.getDepartmentname(""+departmentid),user.getLanguage())%>
<%= SystemEnv.getHtmlLabelName(15356,user.getLanguage()) %>
</b></font>
</td>
</tr>
<TR class=Section>

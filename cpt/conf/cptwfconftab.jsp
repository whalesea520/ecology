...
2.<%=SystemEnv.getHtmlLabelName(128263,user.getLanguage())%>;
...
function getBrowserUrlFn(data){
	...
	switch(fieldname){
		...
		case "cptno":
			...
			break;
		case "zcz":
			url+="%26htmltype=3%26type=25";
			break;
		case "zclx":
			url+="%26htmltype=3%26type=242";
			break;
		case "rkrq":

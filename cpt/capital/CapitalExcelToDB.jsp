...
msg=SystemEnv.getHtmlLabelName(19326,user.getLanguage());
}else{
    int preRownum=0;
...
%>
	...
	<wea:group context='<%=SystemEnv.getHtmlLabelName(19010,user.getLanguage())%>'>
		<wea:item attributes="{'colspan':'full'}">
			<div>
				<br>
				<%=SystemEnv.getHtmlLabelName(28447,user.getLanguage())%><a style="color: #1d98f8;cursor: pointer;" href="CapitalExcelToDBnew.xls?V=<%=System.currentTimeMillis()%>"><%=SystemEnv.getHtmlLabelName(28446,user.getLanguage())%></a>.
				<br><br>

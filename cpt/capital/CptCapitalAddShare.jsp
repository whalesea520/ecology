...
<table id="topTitle" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td class="rightSearchSpan" style="text-align:right;">
			<input type="button" id="submitid" value="<%=SystemEnv.getHtmlLabelName(86,user.getLanguage())%>" class="e8_btn_top" onclick="onSubmit();">
...
<FORM id=weaver name=weaver action="/cpt/capital/ShareOperation.jsp" >
...
<wea:layout>
	<wea:group context='<%=SystemEnv.getHtmlLabelNames("2112",user.getLanguage())%>' attributes="" >
		...
		<wea:item><%=SystemEnv.getHtmlLabelNames("18495",user.getLanguage())%></wea:item>
		<wea:item>
 ...
 function onSubmit()
{
	...
	if (check_form(weaver,checkstr)){
		...
		checkshareifexists("CptCapitalShareInfo",poststr,function(){

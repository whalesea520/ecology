...
<FORM id=frmain action=SearchMouldOperation.jsp method=post >
<div style="margin-top:30px!important;">
<wea:layout>
	<wea:group context="" attributes="{'groupDisplay':'none'}">
		<wea:item attributes="{'customAttrs':'nowrap=true'}"><%=SystemEnv.getHtmlLabelName(18151,user.getLanguage()) %></wea:item>
		<wea:item>
			<wea:required id="assortmentname_span" required="true">
				<input id=assortmentname  name=assortmentname size="30" onchange="checkinput(this.name,'assortmentname_span')"  >
			</wea:required>
		</wea:item>

...
<%
	...
	String url = "/cpt/maintenance/cptmodifytab.jsp?"+queryString;
	String title = SystemEnv.getHtmlLabelName(82856,user.getLanguage());
	...
	if(detachable==1&&"".equals(from)){
		response.sendRedirect("/cpt/maintenance/CptDetachableFrame.jsp?from=cptmodify");
		return;
	}

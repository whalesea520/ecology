...
<%!
	public void initJobtitleAndStatus(String id,String invited){
		String stepSql = "select * from HrmCareerInviteStep where inviteid="+invited ;
		...
		String updateSql = "update HrmCareerApply set jobtitle="+invited+" , nowstep=? where id="+id ;
		rs.executeUpdate(updateSql,noStep) ;
	}
%>
...
String sql = "";
String para = "";
String userpara = ""+0+separator+currentdate;
...
int picture=Util.getIntValue(request.getParameter("picture"),0);/*照片*/
...
String islabourunion = Util.fromScreen(request.getParameter("islabouunion"),7) ;
...
if(operation.equals("add")){
  ...
  initJobtitleAndStatus(id,inviteid);

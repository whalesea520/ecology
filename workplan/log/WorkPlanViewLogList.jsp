...
if (Util.getIntValue(workPlanId, -1) != -1)
{
    if (isHead)
    {
        isHead = false;
        term += " WHERE workPlanId = " + String.valueOf(workPlanId);
    }
    else
    {
        term += " AND workPlanId = " + String.valueOf(workPlanId);
    }
}
...
<div id="tabDiv" >
		<span id="hoverBtnSpan" class="hoverBtnSpan">
			<span ><%=SystemEnv.getHtmlLabelName(17480,user.getLanguage())%></span>
			
	 </span>
</div>
<div class="advancedSearchDiv" id="advancedSearchDiv">
	<FORM id="frmmain" name="frmmain" method="post" action="WorkPlanViewLogList.jsp">
		...
		<wea:layout type="4col">
			<wea:group context='<%=SystemEnv.getHtmlLabelName(20331, user.getLanguage())%>' >
				...
				<wea:item><button type="button" class="Calendar" id="SelectStartDate" onclick="getDate(trmstartdatespan,trmstartdate)"></BUTTON>
...
<div class="zDialog_div_content">
	...
	<%
		String sqlForm = "WorkPlanViewLog";
		...
		String tableString=""+
		    ...
		    "<head>"+
		    "<col width=\"25%\"  text=\""+SystemEnv.getHtmlLabelName(16652,user.getLanguage())+"\" column=\"workPlanId\" orderkey=\"workPlanId\"  transmethod=\"weaver.WorkPlan.WorkPlanHandler.getWorkPlanName\"/>"+
		    "<col width=\"10%\"  text=\""+SystemEnv.getHtmlLabelName(685,user.getLanguage()) + "\" column=\"viewType\" orderkey=\"viewType\" otherpara=\""+user.getLanguage()+"\" transmethod=\"weaver.WorkPlan.WorkPlanLogMan.getLogViewTypeDesc\" />"+
			"<col width=\"15%\"  text=\""+SystemEnv.getHtmlLabelName(17482,user.getLanguage()) + "\" column=\"userId\" orderkey=\"userId\" transmethod=\"weaver.splitepage.transform.SptmForWorkPlan.getResourceName\" />"+
			"<col width=\"20%\"  text=\""+SystemEnv.getHtmlLabelName(17484,user.getLanguage()) + "\" column=\"ipAddress\" orderkey=\"ipAddress\" />"+
			"<col width=\"30%\"  text=\""+SystemEnv.getHtmlLabelName(2061,user.getLanguage()) + "\" column=\"logDate\" orderkey=\"logDate\" otherpara=\"column:logTime\" transmethod=\"weaver.splitepage.transform.SptmForWorkPlan.getShowDataTime\" />"+
		    "</head>"+
		"</table>";
	%>

...
if (PortalUtil.isuserdeploy()) {
    request.getRequestDispatcher("/rdeploy/workplan/workPlanSearchTab.jsp").forward(request, response);
    return;
}
...
$(function(){
    $('.e8_box').Tabs({
        ...
        staticOnLoad:true,
        objName:"<%=SystemEnv.getHtmlLabelName(18482,user.getLanguage()) %>"
    });
...
<%
	String url = "/workplan/search/WorkPlanSearchResult.jsp";

...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        $("#CreateBox #ViewBox-closebtn").click(function(){
			$("#CreateBox").css({"visibility":"hidden"});
			 realsedragevent();
        });
        ...
        function quickd(type) {
            $("#ViewBox").css("visibility", "hidden");
            var calid = $("#workPlanArrayIdView").val();
        ...
        function dayshow(e, data) {
        	...
        	$("#ViewBox .ViewBox-body").html($("#workPlanViewSplash").html());
        	$("#workPlanType").html("<option value=1>工作日程</option>");
			var iLeft = ($(window).width()/2-600/2)+"px"; //获得窗口的水平位置;
			//alert((window.screen.availWidth)+"px")
			$("#ViewBox").css({"width":"600px","left":iLeft,"top":"20px"});
        	$("#ViewBox").css("visibility","visible");
        	$.post("/workplan/data/WorkPlanViewOperation.jsp",{method:"getCalendarItem",id:data[0]},function(result){
        		var item=$.z4x(result).item;
        		fillSplash(item);
        		if(data[8]=="1"){
        			$("#deleteCalendarButtonView").bind("click",function(){
        		...
        		$("#eidtCalendarButtonView").bind("click",function(){
        			$("#ViewBox").css("visibility","hidden");
        			$("#CreateBox").css("visibility","visible");
        			  var viewBox=$("#CreateBox");
                      //  $("#ViewBox .ViewBox-body").html($("#workPlanCreateSplash").html());
                        $("#workPlanType").html("<option value=0>工作日程</option>");
            			var iLeft = ($(window).width()/2-600/2)+"px"; //获得窗口的水平位置;
            			//alert((window.screen.availWidth)+"px")
            			$("#CreateBox").css({"width":"600px","left":iLeft,"top":"20px"});
                    	$("#CreateBox").css("visibility","visible");
                    	$.post("/workplan/data/WorkPlanViewOperation.jsp",{method:"getCalendarItem",id:data[0]},function(result){
                    		var item=$.z4x(result).item;
                    		calendarItemType=item["type"][0].$$;
	                    	var options="";
	                    	initEdit(item);
	                    	for(var i=0;i<workPlanType.length;i++){
	                    		options+="<option value="+workPlanType[i].id+">"+workPlanType[i].name+"</option>"
	                    		
	                    		if(1 <= calendarItemType && calendarItemType <= 6)
	                    		{
	                    			if(calendarItemType == workPlanType[i].id)
	                    			{
	                    				$("#CreateBox #workPlanType").html(options);
	                    				$("#CreateBox #workPlanType").disabled = true;
	
	                    			}
	                    		}
	                    		else
	                    		{
	                    			if(0 == workPlanType[i].id || workPlanType[i].id >= 7)
	                    			{
	                    				$("#CreateBox  #workPlanType").html(options);
	                    			}
...
//	                    	$("#saveCalendar").unbind("click");
	                    	$("#CreateBox").find("#saveCalendar").bind("click",function(){
	                    		if (option.isloading) {
	                                return false;
	                            }
	                            option.isloading = true;
	                    		...
	                    		var workPlanType=viewBox.find("select[name=workPlanType]").val();
	                    		var beginDate=viewBox.find("input[name=beginDate]").val();
	                    		var beginTime=viewBox.find("input[name=beginTime]").val();
	                    		var endDate=viewBox.find("input[name=endDate]").val();
	                    		var endTime=viewBox.find("input[name=endTime]").val();
	                    		var remindBeforeStart=viewBox.find("input[name=remindBeforeStart]").val();
	                    		var remindBeforeEnd=viewBox.find("input[name=remindBeforeEnd]").val();
	                    		var planName=viewBox.find("input[name=planName]").val();
	                    		var urgentLevel="";
	                    		
	                    		viewBox.find("input[name=urgentLevel]").each(function(){
	                    			if(this.checked){
	                    				urgentLevel=this.value;
	                    			}
	                    		});
	                    		var remindType="";
	                    		viewBox.find("input[name=remindType]").each(function(){
	                    			if(this.checked){
	                    				remindType=$(this).val();
	                    			}
	                    		});
	                    		var workplanIdVal=$("#workplanId").val();
	                    		var remindDateBeforeStart=viewBox.find("input[name=remindDateBeforeStart]").val();
	                    		var remindDateBeforeEnd=viewBox.find("input[name=remindDateBeforeEnd]").val();
	                    		var remindTimeBeforeStart=viewBox.find("input[name=remindTimeBeforeStart]").val();
	                    		var remindTimeBeforeEnd=viewBox.find("input[name=remindTimeBeforeEnd]").val();
	                    		var memberIDs=viewBox.find("input[name=memberIDs]").val();
	                    		var description=viewBox.find("TEXTAREA[name=description]").val();
	                    		var crmIDs=viewBox.find("input[name=crmIDs]").val();
	                    		var docIDs=viewBox.find("input[name=docIDs]").val();
	                    		var projectIDs=viewBox.find("input[name=projectIDs]").val();
	                    		var requestIDs=viewBox.find("input[name=requestIDs]").val();
	                    		var param={
	                    				"id":workplanIdVal,
	                            		...
	                            		"remindDateBeforeStart":remindDateBeforeStart,
	                            		"remindDateBeforeEnd":remindDateBeforeEnd,
	                            		"remindTimeBeforeStart":remindTimeBeforeStart,
	                            		"remindTimeBeforeEnd":remindTimeBeforeEnd,
	                            		"memberIDs":memberIDs,
	                    		...
	                    		var tId = data[0];
	                    		 option.onBeforeRequestData && option.onBeforeRequestData(2);
	                    		 $.post(option.updateUrl, param, function(data) {
	                                 if (data) {
	                    		 ...
	                    		 newdata=rebyKey(tId, true);
	                             var sd = strtodate(beginDate+" "+beginTime);
	                             var ed = strtodate(endDate+" "+endTime);
	                             var diff = DateDiff("d", sd, ed);
	                             newdata[2]=sd;
	                             newdata[3]=ed;
        		...
        		$("#shareCalendarButtonView").bind("click",function(){
        			$("#ViewBox").css("visibility","hidden");
        			$("#ShareBox").css("visibility","visible");
        			var iLeft = ($(window).width()/2-600/2)+"px"; //获得窗口的水平位置;
        			//alert((window.screen.availWidth)+"px")
        			$("#ShareBox").css({"width":"600px","left":iLeft,"top":"20px"});
        			$("#workPlanShareSplash").show();
        		
        			loadShareInfo(data[0]);
        			$("#ShareBox #ViewBox-closebtn").click(function(){
        			...
        			$("#addShareBtn").bind("click",function(){
        				var shareParam={
        						...
        						"shareType":$("select[name=shareTypeShare]").val(),
        						"shareId":$("input[name=shareIdShare]").val(),
        						"roleLevel":$("#roleLevelShare").val(),
        						"secLevel":$("#secLevelShare").val(),
        						"shareLevel":$("#shareLevelShare").val()
        				};
        				$.post("/workplan/data/WorkPlanViewOperation.jsp",shareParam,function(dataShare){
        	...
        	$("#ViewBox-closebtn").bind("click",function(){
        		$("#ViewBox").css("visibility","hidden");
        	});
        	...
        	diag.InvokeElementId="workPlanCreateSplash";
        	diag.OKEvent = function(){$id("planName").value||Dialog.alert("用户名不能为空");$id("userpwd").value||Dialog.alert("密码不能为空")};//点击确定后调用的方法
        	diag.show();
        	return;
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
              ...
              //  $("#ViewBox .ViewBox-body").html($("#workPlanCreateSplash").html());
    			...
    			$("#CreateBox").css({"width":"600px","left":iLeft,"top":"20px"});
            	$("#CreateBox").css("visibility","visible");
            	alert(dateFormat.call(start,"HH:mm"));
            	
            	$("#beginDate").val(dateFormat.call(start,"yyyy-MM-dd"));
            	$("#selectBeginDateSpan").html(dateFormat.call(start,"yyyy-MM-dd"));
            	$("#beginTime").val(dateFormat.call(start,"HH:mm"));
            	$("#selectBeginTimeSpan").html(dateFormat.call(start,"HH:mm"));
            	
            	$("#endDate").val(dateFormat.call(end,"yyyy-MM-dd"));
            	$("#endDateSpan").html(dateFormat.call(end,"yyyy-MM-dd"));
            	$("#endTime").val(dateFormat.call(end,"HH:mm"));
            	$("#endTimeSpan").html(dateFormat.call(end,"HH:mm"));
            	
            	//$("#selectBeginDateSpan").text(dateFormat.call(start,"HH:mm"));
            	$("#CreateBox #saveCalendar").click(function(){
            		if (option.isloading) {
                        return false;
                    }
                    option.isloading = true;
            		...
            		var tId = -1;
            		 ...
            		 $.post(option.quickAddUrl, param, function(data) {
                         if (data) {
                             if (data.IsSuccess == true) {
                                 option.isloading = false;
                                 data.Data[2]=strtodate(data.Data[2]);
                                 data.Data[3]=strtodate(data.Data[3]);
                                 option.eventItems[tId] = data.Data;
            	...
            	buddle.mousedown(function(e) { return true });
            }
            if(buddle.length == 9){
               return;
            ...
            $(document).one("mousedown", function(e) {
                if($("#CreateBox").css("visibility")!="visible"){
	            	$("#bbit-cal-buddle").css("visibility", "hidden");
	                realsedragevent();
                }
            });

...
$(function(){
    $('.e8_box').Tabs({
        ...
        staticOnLoad:true,
        objName:"<%=SystemEnv.getHtmlLabelName(20221,user.getLanguage()) %>"
    });
...
<%
	...
	String url = "/workplan/share/WorkPlanShareList.jsp";
...
function goBack() {
	<%if("cal".equalsIgnoreCase(frm)){%>
    	document.frmmain.action = "/workplan/calendar/data/WorkPlanDetailCal.jsp";
    <%} else {%>

...
(function($) {
	...
	$.fn.poshytip.defaults = {
		...
		showAniDuration: 	100,		// show animation duration - set to 0 if you don't want show animation
		hideAniDuration: 	100		// hide animation duration - set to 0 if you don't want hide animation
	};

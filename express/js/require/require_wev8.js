...
(function () {
    ...
    function newContext(contextName) {
            ...
            if (name && name.charAt(0) === ".") {
                ...
                if (baseName) {
                    if (config.pkgs[baseName]) {
                        ...
                        //"one/two/three_wev8.js", but we want the directory, "one/two" for
                        //this normalization.
            ...
            for (i = 0; i < depArray.length; i++) {
                ...
                if (depArg) {
                    ...
                    if (depName === "require") {
                        ...
                        //executed. See r_wev8.js's requirePatch_wev8.js for more info
                        //on fullExec.
        ...
        context = {
            ...
            configure: function (cfg) {
                ...
                //config object before require_wev8.js is loaded.
            ...
            nameToUrl: function (moduleName, ext, relModuleMap) {
                ...
                if (req.jsExtRegExp.test(moduleName)) {
                    ...
                    //Add extension if it is included. This is a bit wonky, only non-_wev8.js things pass
    ...
    if (isBrowser) {
        //Figure out baseUrl. Get it from the script tag with require_wev8.js in it.
        scripts = document.getElementsByTagName("script");
        ...
        for (i = scripts.length - 1; i > -1 && (script = scripts[i]); i--) {
            ...
            if ((dataMain = script.getAttribute('data-main'))) {
                if (!cfg.baseUrl) {
                    ...
                    //Set final config.
                    cfg.baseUrl = subPath;
                    //Strip off any trailing _wev8.js since dataMain is now
                    //like a module name.
    ...
    //works well in that environment, since require_wev8.js is normally
    ...
    if (req.isAsync && typeof setTimeout !== "undefined") {
        ...
        setTimeout(function () {
            ...
            //Any modules included with the require_wev8.js file will be in the

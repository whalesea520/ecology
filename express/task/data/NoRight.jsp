...
<%
	...
	rs.executeSql("select id,name,tasklevel,status,remark,risk,difficulty,assist,tag,principalid,begindate,enddate,taskids,docids,wfids,meetingids,crmids,projectids,fileids,creater,createdate,createtime from TM_TaskInfo where id="+taskId+" and (deleted=0 or deleted is null)");
...
<div id="rightinfo" style="width: 100%;height: 100%;position: relative;overflow: hidden;">
	...
	background:-webkit-gradient(linear, 0 0, 0 bottom, from(#F2F2F2), to(#F6F6F6)) !important;
		...
		<div style="position: absolute;top: 3px;left:0px;height: 23px;width: 100%;">
			<div style="margin-left: 10px;font-weight: bold;width: 65px;background: url('../images/warn_wev8.png') left center no-repeat;text-align: center;">
				提示</div>
		</div>
	</div>

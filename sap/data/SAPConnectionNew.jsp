...
String _hostname = Util.null2String(request.getParameter("hostname"));
		...
		<td valign="top">
			  <TABLE class=ViewForm>
				...
				<tr>
				  ...
				  <td class=Field>
				  	<input class="inputstyle" type=text id="code" name="code" MaxLength="10" onChange="checkinput('code','codespan')" value=<%=code %> >
				  	<span id="codespan"><%if("".equals(code)){ %><img src="/images/BacoError_wev8.gif" align=absmiddle><%} %></span>
				  </td>
				</tr>

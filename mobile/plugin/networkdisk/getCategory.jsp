...
if(user == null){
   ...
   user.setLanguage(Util.getIntValue(result.get("language").toString()));
   user.setLogintype(Util.null2String(result.get("logintype").toString()));
   user.setUserDepartment(Util.getIntValue(result.get("departmentid").toString()));
   user.setSeclevel(Util.null2String(result.get("seclevel").toString()));
   user.setType(Util.getIntValue(result.get("type").toString()));
   user.setUserSubCompany1(Util.getIntValue(result.get("subcompanyid").toString()));
}

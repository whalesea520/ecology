...
root.setIcon("/images/treeimages/global16_wev8.gif");
//if(needPeop){
...
if(superId.equals("")){
	...
	DocTreeDocFieldManager.getTreeDocFieldTreeList(root,DocTreeDocFieldConstant.TREE_DOC_FIELD_ROOT_ID,0,maxLevel,"treeDocFieldMulti","",needPeop,user);   
}else{
	DocTreeDocFieldManager.getTreeDocFieldTreeList(envelope,superId,0,maxLevel,"treeDocFieldMulti","",needPeop,user);
}
	//envelope.marshal(sw);
Map iconMap=new HashMap();
iconMap.put("categoryIcon","/plugin/ecology/js/zTree/css/zTreeStyle/img/dept16_wev8.gif");

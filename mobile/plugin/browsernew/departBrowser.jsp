...
<script type="text/javascript" src="/mobile/plugin/browsernew/js/fastclick.min_wev8.js?2"></script>
<script type="text/javascript" src="/mobile/plugin/browsernew/js/jquery.sortable.min.js?2"></script>
<link type="text/css" rel="stylesheet" href="/mobile/plugin/browsernew/css/departBrowser_wev8.css" />
<script type="text/javascript">
var ifInit = false;
function resetBrowser(obj){
	...
	if(selectedIds != ""){
		...
		$.ajax({
			url:"/mobile/plugin/browsernew/departBrowserAction.jsp",

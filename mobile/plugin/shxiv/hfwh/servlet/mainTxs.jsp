...
<div class="wrapper m-wrapper">
    ...
    <div class="m-hd">
        <div class="m-breadcrumb" id="headId">
            <i class="ico-line"></i> <a href="#"><span class="big"><%=name%></span></a> <i class="ico-line"></i> <a href="#">线上</a>
        </div>
        <div class="m-type">
            <dl>
                <dt>筛选</dt>
    ...
    <div class="m-imgroll-wrap">
        ...
        <div class="m-imgroll">
            <div class="m-imgroll-hd">
                ...
                <a class="more" href="${pageContext.request.contextPath}/mobile/plugin/shxiv/hfwh/servlet/mainTcList.jsp?more=2&name=<%=name%>&xs=<%=xs%>&tkName=经典图库&zt=0">更多</a>
            </div>
        ...
        <div class="m-imgroll" >
            <div class="m-imgroll-hd">
                ...
                <a class="more" href="${pageContext.request.contextPath}/mobile/plugin/shxiv/hfwh/servlet/mainTcList.jsp?more=3&name=<%=name%>&xs=<%=xs%>&tkName=往季图库&zt=0">更多</a>
            </div>
        ...
        <div class="m-imgroll">
            <div class="m-imgroll-hd">
                ...
                <a class="more" href="${pageContext.request.contextPath}/mobile/plugin/shxiv/hfwh/servlet/mainTcList.jsp?more=4&name=<%=name%>&xs=<%=xs%>&tkName=主推图库&zt=0">更多</a>
            </div>
		 ...
		 <div class="m-imgroll">
            <div class="m-imgroll-hd">
                <span class="tit">历史图库</span>
                <a class="more" href="${pageContext.request.contextPath}/mobile/plugin/shxiv/hfwh/servlet/mainTcList.jsp?more=5&name=<%=name%>&xs=<%=xs%>&tkName=历史图库&zt=0">更多</a>
            </div>
            <div class="m-imgroll-bd " id="fifthList">
...
<script  type="text/javascript">
    ...
    function getHtml(){
        let head="";
        head+="<i class='ico-line'></i> <a href='/mobile/plugin/shxiv/hfwh/servlet/mainTk.jsp'><span class='big'>"+name+"</span></a><i class='ico-line'></i><a href='/mobile/plugin/shxiv/hfwh/servlet/mainXs.jsp?name="+name+"'>线上</a>";

...
<%
	String sql = "select createUid, amountBorrowAfter, createDate, memo1" +
					"	from FnaBorrowInfoAmountLog a " +
 	...
 	while(rs.next()){
 		...
 		String amountBorrowAfter = Util.null2String(rs.getString("amountBorrowAfter"));

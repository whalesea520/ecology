...
<%
	...
	String setting = Util.null2String(request.getParameter("setting"));	//模块设置中选择的流程ID
	String listtypes = Util.null2String(request.getParameter("listtypes"));	//所有流程所覆盖的类型集合
	...
	if(!selectedIds.trim().equals("")){
		...
		while(rs.next()){
			...
			selectedObj.put("name", rs.getString("workflowname"));//名称
...
<div id="page">
	<div id="page-title">
		<div id="nav-header">
			...
			<div class="header-center">工作流</div>
			...
			<div id="center-content-inner">
				<div id="tree-org-container" class="data-container org-container">
					<ul class="tree-page root-tree-page">
						<li>
							<div class="one-tree-data company-data closed" data-id="1" data-type="1" data-haschild="1">流程类型</div>
						</li>
					</ul>
				</div>
			</div>

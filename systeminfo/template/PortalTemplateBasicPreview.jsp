	...
	<td height="71px" id="topMenuTd">
		<Table id="topMenuTbl" height="100%" width="100%" cellspacing="0" cellpadding="0" style="background:url(<%=topBgImage %>) repeat-x;">
			<tr id="topMenuLogo" height="43px">
				<td  width="198px" height="43px" tbname='SystemTemplate' field='logotop' style=" position:relative;background:url(<%=(logoTop == null || logoTop.equals("")) ? "/wui/theme/ecologyBasic/page/images/logo_up_wev8.png" : logoTop %>) no-repeat;">
				&nbsp;
				</td>
				<td width="*">
				</td>
			...
			<%
					...
					%>
			<tr height="28px">
				<td height="28px"  tbname='SystemTemplate' field='logobottom' width="198px" style="background:url(<%=logoBtmImgSrc %>) no-repeat;">
				</td>
...
<tr>
	<td style="padding:0px 0px 0px 0px;">
		...
		<tr>
			...
			%>
				<iframe height="100%" frameborder=0 id="mainframe" scrolling="NO" style="background: #ffffff;"  width="100%" border=0 src="<%=url %>"></iframe>
			</td>
		</tr>
		</table>

...
<%!public String grtlftMenu(List elements, User user, boolean isPotal) {
		...
		String tmpLi = "<li><div>";
		//String tmpLi = "<li><div style='width:100%;'>";
		tmpLi += "<a class='lfMenuItem' href='";
		...
		tmpLi += "</div>";
		tmpLi += "<div class=\"leftMenuItemRight\" style=\"\"></div>";
		tmpLi += "<div style='width:4px;display:none;'></div></a></div>";
		tmpLi += "</li>";
	...
	public List getPortalMenus(User user,String from) throws Exception {
		...
		String sql = "select id,infoname,subcompanyid from hpinfo h where  pid=0 and subcompanyid>0  and isuse=1 order by ordernum1,id";
   ...
   /* var myLftMenu = new drilldownmenu(
    ...
    jQuery(".drillmenu ul li a").bind("click", function() {
        ...
        if(!selFlg) {
		   ...
		   //jQuery(this).closest("li").css("width",jQuery("#leftmenucontainer").css("width"));
    ...
    if(paramValue==536){
	    ...
	    //syncLMHeight();
	   	jQuery("#drillmenu").load("/email/new/leftmenu.jsp?"+new Date().getTime(),function(){
            ...
            jQuery("#leftMenu").scrollTo( {top:'0px',left:+'0px'}, 0 );
            $("#drillmenu").height($("#leftMenu").height());

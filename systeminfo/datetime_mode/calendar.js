...
function My97DP(languageId) {
	...
	if(languageId == 8){
		$d.innerHTML = "<div id=dpTitle><div title='Last year' style=\"float:left\" class=\"navImg NavImgll\"></div><div title='Last month' style=\"float:left\" class=\"navImg NavImgl\"></div><div title='Select month' style=\"float:left\"><div class=\"menuSel MMenu\" style=\"z-index:1\"></div><input class=yminput style=\"width:50px\" tabindex=1></div><div title='Select year' style=\"float:left\"><div class=\"menuSel YMenu\" style=\"z-index:1\"></div><input class=yminput style=\"width:50px\" tabindex=2></div><div title='Next year'style=\"float:right\" class=\"navImg NavImgrr\"></div><div title='Next month' style=\"float:right\" class=\"navImg NavImgr\"></div></div><div style=\"position:absolute;overflow:hidden\"></div><div></div><div id=dpTime><div class=\"menuSel hhMenu\" style=\"z-index:1\"></div><div class=\"menuSel mmMenu\" style=\"z-index:1\"></div><div class=\"menuSel ssMenu\" style=\"z-index:1\"></div><table cellspacing=0 cellpadding=0 border=0><tr><td rowspan=2><span id=dpTimeStr></span>&nbsp;<input class=tB maxlength=2 tabindex=3><input value=\":\" class=tm readonly><input class=tE maxlength=2 tabindex=4><input value=\":\" class=tm readonly><input class=tE maxlength=2 tabindex=5></td><td><button id=dpTimeUp></button></td></tr><tr><td><button id=dpTimeDown></button></td></tr></table></div><div title='&#x5FEB;&#x901F;&#x9009;&#x62E9;' id=dpQS></div><div id=dpControl><input class=dpButton id=dpClearInput type=button tabindex=6> <input class=dpButton id=dpTodayInput type=button tabindex=7> <input class=dpButton id=dpOkInput type=button tabindex=8></div>";
	}else{
	    $d.innerHTML = "<div id=dpTitle><div title='&#x4E0A;&#x4E00;&#x5E74;' style=\"float:left\" class=\"navImg NavImgll\"></div><div title='&#x4E0A;&#x4E00;&#x6708;' style=\"float:left\" class=\"navImg NavImgl\"></div><div title='&#x9009;&#x62E9;&#x6708;&#x4EFD;' style=\"float:left\"><div class=\"menuSel MMenu\" style=\"z-index:1\"></div><input class=yminput style=\"width:50px\" tabindex=1></div><div title='&#x9009;&#x62E9;&#x5E74;&#x4EFD;' style=\"float:left\"><div class=\"menuSel YMenu\" style=\"z-index:1\"></div><input class=yminput style=\"width:50px\" tabindex=2></div><div title='&#x4E0B;&#x4E00;&#x5E74;'style=\"float:right\" class=\"navImg NavImgrr\"></div><div title='&#x4E0B;&#x4E00;&#x6708;' style=\"float:right\" class=\"navImg NavImgr\"></div></div><div style=\"position:absolute;overflow:hidden\"></div><div></div><div id=dpTime><div class=\"menuSel hhMenu\" style=\"z-index:1\"></div><div class=\"menuSel mmMenu\" style=\"z-index:1\"></div><div class=\"menuSel ssMenu\" style=\"z-index:1\"></div><table cellspacing=0 cellpadding=0 border=0><tr><td rowspan=2><span id=dpTimeStr></span>&nbsp;<input class=tB maxlength=2 tabindex=3><input value=\":\" class=tm readonly><input class=tE maxlength=2 tabindex=4><input value=\":\" class=tm readonly><input class=tE maxlength=2 tabindex=5></td><td><button id=dpTimeUp></button></td></tr><tr><td><button id=dpTimeDown></button></td></tr></table></div><div title='&#x5FEB;&#x901F;&#x9009;&#x62E9;' id=dpQS></div><div id=dpControl><input class=dpButton id=dpClearInput type=button tabindex=6> <input class=dpButton id=dpTodayInput type=button tabindex=7> <input class=dpButton id=dpOkInput type=button tabindex=8></div>";
	}
...
My97DP.prototype = {init:function () {
	...
	H.a("<table class=WdayTable width=100% border=1 cellspacing=0 cellpadding=0>");

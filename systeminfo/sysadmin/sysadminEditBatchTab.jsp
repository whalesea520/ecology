...
int title = 0;
String frmSrc = "";
if(_fromURL.equals("sysadminEditBatch")){
	//分权管理员设置
	title = 31978;
	frmSrc = "/systeminfo/sysadmin/sysadminEditBatch.jsp";
}
...
jQuery(function(){
    jQuery('.e8_box').Tabs({
        ...
        objName:<%=JSONObject.quote(SystemEnv.getHtmlLabelName(title, user.getLanguage())) %>,
        staticOnLoad:true
    });
});
</script>

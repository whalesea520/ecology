			...
			<TBODY>
				<tr>
				  ...
				  <td class=Field>
					...
					<input type="radio" name="displayUsage_3" value="0" <%if(info.getFromModule()==1&&info.getMenuType()==3&&info.getDisplayUsage()!=1){%>checked<%}%>><%=SystemEnv.getHtmlLabelName(320,user.getLanguage())%>
					<input type="radio" name="displayUsage_3" value="1" <%if(info.getFromModule()==1&&info.getMenuType()==3&&info.getDisplayUsage()==1){%>checked<%}%>><%=SystemEnv.getHtmlLabelName(19064,user.getLanguage())%>

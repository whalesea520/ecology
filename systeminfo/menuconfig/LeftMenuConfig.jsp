...
<BR>
<B>3、<%=SystemEnv.getHtmlLabelName(18383,user.getLanguage())%></B>：<%=SystemEnv.getHtmlLabelName(18384,user.getLanguage())%><img src="/images/collapsed_wev8.gif" align="absmiddle"><%=SystemEnv.getHtmlLabelName(18385,user.getLanguage())%><BR>
<B>4、<%=SystemEnv.getHtmlLabelName(18386,user.getLanguage())%></B>：<%=SystemEnv.getHtmlLabelName(18387,user.getLanguage())%><BR>
<BR>
<B><%=SystemEnv.getHtmlLabelName(15736,user.getLanguage())%></B>：<%=SystemEnv.getHtmlLabelName(18388,user.getLanguage())%><img src="/images/ArrowLeftRed_wev8.gif" align="absmiddle"><%=SystemEnv.getHtmlLabelName(18389,user.getLanguage())%><BR>
</TD>
</TR>
</TBODY>
</table>

...
//System.out.println("?resourceId="+resourceId+"&resourceType="+resourceType+"&id="+infoId+"&sync="+sync+"&type="+type);
int userid=0;
userid=user.getUID();
	    ...
	    <TABLE class=ViewForm>
			...
			<TBODY>
				...
				<tr>
				  ...
				  <td class=Field>
					<input type="radio" name="customModule" value="1" onClick="onChangeModule(this);" <%if(info.getFromModule()==1){%>checked<%}%>><%=SystemEnv.getHtmlLabelName(58,user.getLanguage())%>
					<input type="radio" name="customModule" value="2" onClick="onChangeModule(this);" <%if(info.getFromModule()==2){%>checked<%}%>><%=SystemEnv.getHtmlLabelName(18015,user.getLanguage())%>
					<input type="radio" name="customModule" value="3" onClick="onChangeModule(this);" <%if(info.getFromModule()==3){%>checked<%}%>><%=SystemEnv.getHtmlLabelName(136,user.getLanguage())%>
					<input type="radio" name="customModule" value="4" onClick="onChangeModule(this);" <%if(info.getFromModule()==4){%>checked<%}%>><%=SystemEnv.getHtmlLabelName(101,user.getLanguage())%>
				  </td>
				</tr>
                <TR  style="height: 1px"><TD class=Line colSpan=2></TD></TR>
				...
				<tr>
				  ...
				  <td class=Field>
				  	<select name="customType_1" style="display:block" onChange="onChangeModuleType(this);">
				  		<option value="1" <%if(info.getFromModule()==1&&info.getMenuType()==1){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(1986,user.getLanguage())%></option>
				  		<option value="2" <%if(info.getFromModule()==1&&info.getMenuType()==2){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(1212,user.getLanguage())%></option>
				  		<option value="3" <%if(info.getFromModule()==1&&info.getMenuType()==3){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(16397,user.getLanguage())%></option>
				  		<option value="4" <%if(info.getFromModule()==1&&info.getMenuType()==4){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(16398,user.getLanguage())%></option>
				  	</select>	
				  	<select name="customType_2" style="display:none" onChange="onChangeModuleType(this);">
				  		<option value="1" <%if(info.getFromModule()==2&&info.getMenuType()==1){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(16392,user.getLanguage())%></option>
				  		<option value="2" <%if(info.getFromModule()==2&&info.getMenuType()==2){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(1207,user.getLanguage())%></option>
				  		<option value="3" <%if(info.getFromModule()==2&&info.getMenuType()==3){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(17991,user.getLanguage())%></option>
				  		<option value="4" <%if(info.getFromModule()==2&&info.getMenuType()==4){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(17992,user.getLanguage())%></option>
						<option value="6" <%if(info.getFromModule()==2&&info.getMenuType()==6){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(21639,user.getLanguage())%></option>
						<option value="7" <%if(info.getFromModule()==2&&info.getMenuType()==7){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(21640,user.getLanguage())%></option>
						<%if(!"".equals(hasOvertime)){%>
						<option value="8" <%if(info.getFromModule()==2&&info.getMenuType()==8){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(21641,user.getLanguage())%></option>
						<%}%>
						<%if(!"".equals(hasChangStatus)){%>
						<option value="9" <%if(info.getFromModule()==2&&info.getMenuType()==9){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(21643,user.getLanguage())%></option>
						<%}%>
				  		<option value="5" <%if(info.getFromModule()==2&&info.getMenuType()==5){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(1210,user.getLanguage())%></option>
				  	</select>
				  	<select name="customType_3" style="display:none" onChange="onChangeModuleType(this);">
				  		<option value="1" <%if(info.getFromModule()==3&&info.getMenuType()==1){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(15006,user.getLanguage())%></option>
				  	</select>
				  	<select name="customType_4" style="display:none" onChange="onChangeModuleType(this);">
				  		<option value="1" <%if(info.getFromModule()==4&&info.getMenuType()==1){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(15007,user.getLanguage())%></option>
				  		<option value="2" <%if(info.getFromModule()==4&&info.getMenuType()==2){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(16408,user.getLanguage())%></option>
				  		<option value="3" <%if(info.getFromModule()==4&&info.getMenuType()==3){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(16409,user.getLanguage())%></option>
				  		<option value="4" <%if(info.getFromModule()==4&&info.getMenuType()==4){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(16410,user.getLanguage())%></option>
				  		<option value="5" <%if(info.getFromModule()==4&&info.getMenuType()==5){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(16411,user.getLanguage())%></option>
				  		<option value="6" <%if(info.getFromModule()==4&&info.getMenuType()==6){%>selected<%}%>><%=SystemEnv.getHtmlLabelName(16412,user.getLanguage())%></option>
				  	</select>
				  </td>
				</tr>
                <TR  style="height: 1px"><TD class=Line colSpan=2></TD></TR>

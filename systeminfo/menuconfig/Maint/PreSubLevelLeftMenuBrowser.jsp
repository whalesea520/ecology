...
int infoId = Util.getIntValue(request.getParameter("menuId"));
...
ArrayList subLevelLeftMenuInfos = leftMenuInfoHandler.getPreSubLevelMenuInfos(infoId,parentId);

for(int i=0;i<subLevelLeftMenuInfos.size();i++){
    LeftMenuInfo info = (LeftMenuInfo)subLevelLeftMenuInfos.get(i);
	if(i%2==0){
%>
<TR class=DataLight>
<%

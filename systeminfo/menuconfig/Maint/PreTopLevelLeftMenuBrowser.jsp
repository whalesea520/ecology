...
int infoId = Util.getIntValue(request.getParameter("infoId"));

LeftMenuInfoHandler leftMenuInfoHandler = new LeftMenuInfoHandler();
ArrayList topLevelLeftMenuInfos = leftMenuInfoHandler.getPreTopLevelMenuInfos(infoId);

for(int i=0;i<topLevelLeftMenuInfos.size();i++){
    LeftMenuInfo info = (LeftMenuInfo)topLevelLeftMenuInfos.get(i);
	if(i%2==0){
%>
<TR class=DataLight>
<%

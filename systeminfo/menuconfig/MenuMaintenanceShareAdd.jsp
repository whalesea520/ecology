	...
	<jsp:include page="/systeminfo/commonTabHead.jsp">
	   ...
	   <jsp:param name="navName" value="<%=SystemEnv.getHtmlLabelName(33466, user.getLanguage())%>"/>  
		...
		<div class="zDialog_div_content">
			...
			<FORM id=weaverA name=weaverA action="MenuMaintenanceShareOperation.jsp"
				method="post">
				...
				<input type="hidden" value="<%=subCompanyId %>" name="subCompanyId" id="subCompanyId" />
				<input type="hidden" value="<%=infoid %>" name="infoid" id="infoid" />
				<input type="hidden" value="<%=customid %>" name="customid" id="customid" />
				<input type="hidden" value="<%=type %>" name="menutype" id="menutype" />
				...
				<wea:layout type="2col">
					<wea:group context='<%=SystemEnv.getHtmlLabelName(1361, user.getLanguage())%>' >
						...
						<wea:item>
							<SELECT  class="InputStyle" name="permissiontype" id="permissiontype" onchange="onChangePermissionType()" style="float:left">
						...
						<wea:item attributes="{'samePair':\"objtr\"}" >	
							...
							<span id=showrolelevel name=showrolelevel style="float:left;margin-left:10px;display:none">
							  <div style="float:left;margin-top:7px;height:17px;line-height:17px;">&nbsp;&nbsp;&nbsp;&nbsp;<%=SystemEnv.getHtmlLabelName(139,user.getLanguage())%>&nbsp;&nbsp;</div>
							  <SELECT class="InputStyle" name="rolelevel" id="rolelevel"  _notParent=true style="width: 60px">

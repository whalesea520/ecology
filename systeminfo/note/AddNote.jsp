...
String titlename = SystemEnv.getHtmlLabelName(82,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(24960,user.getLanguage());
String needfav ="1";
String needhelp ="";
...
<form id="weaver" name="weaver" action="NoteOperation.jsp" method=post>
<wea:layout>
		...
		<wea:group context='<%= SystemEnv.getHtmlLabelNames("176,33439",user.getLanguage())%>'>
          ...
          <input type=hidden value="addnote" name="operation">
</FORM>
	</div>

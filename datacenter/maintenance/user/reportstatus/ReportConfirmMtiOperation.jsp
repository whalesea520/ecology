...
if(operation.equals("edit")){
    ...
    if(confirmid.equals("0"))
        response.sendRedirect("ReportConfirmMtiDetail.jsp?thetable="+thetable+"&thedate="+thedate+"&inprepid="+inprepid+"&inprepbudget="+inprepbudget);
    else 
    ...
    String sql = " update " + thetable + " set inputstatus='1' , confirmuserid = "+ usertitle+ " where reportdate = '" + thedate +"' and crmid =" + crmid ;
    ...
    String sql = " update " + thetable + " set inputstatus='0' where reportdate = '" + thedate +"' and crmid =" + crmid ;

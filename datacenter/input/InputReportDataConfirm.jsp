...
this.rs=rs;
this.req=request;
Map crmMap=this.getHrmSecurityInfoByUserId(user.getUID(),Integer.parseInt(inprepid));
...
dspdate = Util.toScreen(rs2.getString("inprepdspdate"),user.getLanguage()) ;
...
<%
RCMenu += "{"+SystemEnv.getHtmlLabelName(1290,user.getLanguage())+",DataCenterInput.jsp,_self} " ;

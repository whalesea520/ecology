...
function showE8TypeOption(closed){
	...
	if(jQuery("#e8TypeOption").css("display")=="none"){
		...
		if(jQuery("#e8TypeOption").height()>=jQuery(document.body).height()){
		 jQuery("#e8TypeOption").height("100%");
...
function setCompany(nodeid){
	...
	var virtualtype = jQuery("#virtualtype").val();
	if(virtualtype=="1"){
		document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmCompanyDsp";
	}else{
		document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmCompanyDspVirtual";
	}
...
function setSubcompany(nodeid){ 
	...
	var virtualtype = jQuery("#virtualtype").val();
	if(virtualtype=="1"){
		document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmSubCompanyDsp";
	}else{
		document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmSubCompanyDspVirtual";
	}
	document.SearchForm.submit();
}
...
function setDepartment(nodeid){
	...
	var virtualtype = jQuery("#virtualtype").val();
	if(virtualtype=="1"){
		document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmDepartmentDsp";
	}else{
		document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmDepartmentDspVirtual";
	}
	document.SearchForm.submit();
}
</script>

...
<%
	...
	if(!strUtil.vString(detachCommonInfo.getDetachable()).equals("1")) {
		response.sendRedirect("/hrm/schedule/hrmScheduleSet/tab.jsp?topage=list");
		return;
	}
%>
<html>
			...
			<tbody>
				<tr>
					<td height="100%" id="oTd1" name="oTd1" width="220px">
						<iframe name="leftframe" id="leftframe" src="/hrm/schedule/hrmScheduleSet/left.jsp?rightStr=HrmScheduling:set" width="100%" height="100%" frameborder="no" scrolling="no"></iframe>
					</td>
					<td height="100%" id="oTd2" name="oTd2" width="*">
						<iframe name="contentframe" id="contentframe" src="/hrm/schedule/hrmScheduleSet/tab.jsp?topage=list" width="100%" height="100%" frameborder="no" scrolling="yes"></iframe>
					</td>
				</tr>
			</tbody>
		</table>

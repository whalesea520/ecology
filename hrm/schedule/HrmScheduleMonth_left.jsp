...
<BODY onload="initTree()">
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="HrmScheduleMonth.jsp" method=post target="contentframe">
...
function initTree(){
	...
	tree.add(rti = new WebFXLoadTreeItem("", "/hrm/schedule/ScheduleMonthXML.jsp?rightStr=<%=rightStr%>"));
	...
	*/
	...
	CXLoadTreeItem("", "/hrm/schedule/ScheduleMonthXML.jsp?rightStr=<%=rightStr%>");
	var tree = new WebFXTree();
	tree.add(cxtree_obj);
	//document.write(tree);
	document.getElementById('deeptree').innerHTML = tree;
...
function setCompany(id){
    ...
    document.SearchForm.action="HrmScheduleMonthHelp.jsp";
...
function setSubcompany(nodeid){ 
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmScheduleMonth&subcompanyid1="+subid;
    document.SearchForm.submit();
}
function setDepartment(nodeid){
    ...
    document.all("tabid").value=0;
    document.all("nodeid").value=nodeid;
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmScheduleMonth&departmentid="+deptid;
    document.SearchForm.submit();
}

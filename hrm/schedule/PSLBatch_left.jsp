...
<BODY onload="initTree()">
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="/hrm/HrmTab.jsp?_fromURL=PSLBatchView" method=post target="contentframe">
...
function setCompany(id){
    if("<%=right%>"==2){
       ...
       document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=PSLBatchView&companyid=0";
...
function setSubcompany(nodeid){ 
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=PSLBatchView&subcompanyid="+subid;
    document.SearchForm.submit();
}
function setDepartment(nodeid){
    ...
    document.all("tabid").value=0;
    document.all("nodeid").value=nodeid;
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=PSLBatchView&departmentid="+deptid;
    document.SearchForm.submit();
}

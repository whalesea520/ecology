...
<IFRAME name=leftframe id=leftframe src="/hrm/schedule/AnnualPeriod_left.jsp?rightStr=AnnualPeriod:All" width="100%" height="100%" frameborder=no scrolling=no>
...
<IFRAME name=contentframe id=contentframe src="/hrm/HrmTab.jsp?_fromURL=AnnualPeriodView&companyid=0" width="100%" height="100%" frameborder=no scrolling=yes>
<%=SystemEnv.getHtmlLabelName(15017, user.getLanguage())%></IFRAME>
</td>
</tr>
  </TBODY>

...
<BODY onload="initTree()">
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="/hrm/HrmTab.jsp?_fromURL=HrmDefaultSechedule" method=post target="contentframe">
...
function initTree(){
	...
	rti.expand();
	*/
	CXLoadTreeItem("", "HrmDefaultScheduleXML.jsp?rightStr=<%=rightStr%>");
	var tree = new WebFXTree();
	tree.add(cxtree_obj);
	//document.write(tree);
	document.getElementById('deeptree').innerHTML = tree;
...
function setCompany(nodeid){
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmDefaultSechedule&companyid="+comid;
...
function setSubcompany(nodeid){ 
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmDefaultSechedule&subcompanyid1="+subid;
    document.SearchForm.submit();
}
function setDepartment(nodeid){
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmDefaultSechedule&departmentid="+deptid+"&subcompanyid1="+subCompanyId;
    document.SearchForm.submit();
}

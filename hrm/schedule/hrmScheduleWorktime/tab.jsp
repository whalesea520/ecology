...
<%
	String url = "";
	String title = SystemEnv.getHtmlLabelName(125799, user.getLanguage());
	...
	if(topage.equals("list")) {
		url = "/hrm/schedule/hrmScheduleWorktime/list.jsp";
	} else if(topage.equals("content")) {
		url = "/hrm/schedule/hrmScheduleWorktime/content.jsp";
	}

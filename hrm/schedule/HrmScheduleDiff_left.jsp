...
<BODY onload="initTree()">
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="HrmScheduleDiff.jsp" method=post target="contentframe">
...
function initTree(){
	...
	tree.add(rti = new WebFXLoadTreeItem("", "/hrm/tree/HrmCompany_XML.jsp?rightStr=<%=rightStr%>"));
...
function setCompany(id){
    ...
    document.all("tabid").value=0;
    document.SearchForm.action="HrmScheduleDiffHelp.jsp";
...
function setSubcompany(nodeid){ 
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmScheduleDiff&subcompanyid1="+subid;
    document.SearchForm.submit();
}
function setDepartment(nodeid){
    ...
    document.all("tabid").value=0;
    document.all("nodeid").value=nodeid;
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmScheduleDiff&departmentid="+deptid+"&subcompanyid1="+subCompanyId;
    document.SearchForm.submit();
}

...
<%
	String url = "";
	String title = SystemEnv.getHtmlLabelName(125817, user.getLanguage());
	...
	if(topage.equals("list")) {
		url = "/hrm/schedule/hrmScheduleShiftsDetail/list.jsp";
	} else if(topage.equals("content")) {
		url = "/hrm/schedule/hrmScheduleShiftsDetail/content.jsp";
	}

...
String titlename = SystemEnv.getHtmlLabelName(131560,user.getLanguage()) + " : "+SystemEnv.getHtmlLabelName(93 , user.getLanguage()) ; 
String needfav = "1" ; 
String needhelp = "" ; 
%>
<BODY>
...
<wea:layout type="2col">
    ...
    <wea:item><%=SystemEnv.getHtmlLabelName(24043,user.getLanguage())%></wea:item>
    <wea:item>

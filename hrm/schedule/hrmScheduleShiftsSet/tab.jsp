...
<%
	String url = "";
	String title = SystemEnv.getHtmlLabelName(125800, user.getLanguage());
	...
	if(topage.equals("list")) {
		...
		url = "/hrm/schedule/hrmScheduleShiftsSet/list.jsp";
	} else if(topage.equals("content")) {
		url = "/hrm/schedule/hrmScheduleShiftsSet/content.jsp";
	}

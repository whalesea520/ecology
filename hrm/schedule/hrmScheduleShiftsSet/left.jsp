...
<html>
	...
	<body onload="initTree()">
		<form id="weaver" name="SearchForm" style="margin-bottom:0" action="/hrm/schedule/hrmScheduleShiftsSet/tab.jsp?topage=list" method="post" target="contentframe">
		...
		<script type="text/javascript">
			...
			function getAction() {
				return "/hrm/schedule/hrmScheduleShiftsSet/tab.jsp?topage=list&"+$("#weaver").serialize();
			}
		</script>
	</body>
</html>

...
response.sendRedirect("/hrm/HrmTab.jsp?_fromURL=LeaveTypeColorEdit");
%>
...
<IFRAME name=leftframe id=leftframe src="LeaveTypeColor_left.jsp?rightStr=LeaveTypeColor:All" width="100%" height="100%" frameborder=no scrolling=no>
...
<IFRAME name=contentframe id=contentframe src="/hrm/HrmTab.jsp?_fromURL=LeaveTypeColorEdit" width="100%" height="100%" frameborder=no scrolling=yes>
<%=SystemEnv.getHtmlLabelName(15017, user.getLanguage())%></IFRAME>
</td>
</tr>
  </TBODY>

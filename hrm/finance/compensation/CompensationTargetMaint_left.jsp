...
<BODY onload="initTree()">
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="/hrm/HrmTab.jsp?_fromURL=CompensationTargetMaintList" method=post target="contentframe">
...
function setSubcompany(nodeid){
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=CompensationTargetMaint&subCompanyId="+subid;
    document.SearchForm.submit();
}
function setDepartment(nodeid){
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=CompensationTargetMaint&departmentid="+deptid;
    document.SearchForm.submit();
}

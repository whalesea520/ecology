...
<BODY onload="initTree()">
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="/hrm/HrmTab.jsp?_fromURL=CompensationTargetSet" method=post target="contentframe">
...
function setSubcompany(nodeid){
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=CompensationTargetSet&subCompanyId="+subid;
    document.SearchForm.submit();
}
function setDepartment(nodeid){
    ...
    $GetEle("tabid").value=0;
    $GetEle("nodeid").value=nodeid;
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=CompensationTargetSet&departmentid="+deptid;
    document.SearchForm.submit();
}

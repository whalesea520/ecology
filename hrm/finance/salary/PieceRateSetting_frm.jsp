...
<IFRAME name=leftframe id=leftframe src="PieceRateSetting_left.jsp?rightStr=PieceRate:setting" width="100%" height="100%" frameborder=no scrolling=no>
...
<IFRAME name=contentframe id=contentframe src="PieceRateSetHelp.jsp" width="100%" height="100%" frameborder=no scrolling=yes>
<%=SystemEnv.getHtmlLabelName(15017, user.getLanguage())%></IFRAME>
</td>
</tr>
  </TBODY>

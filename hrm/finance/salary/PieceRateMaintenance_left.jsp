...
<BODY onload="initTree()">
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="PieceRateMaintenance.jsp" method=post target="contentframe">
...
function setCompany(nodeid){
    ...
    document.SearchForm.action="PieceRateMaintenance.jsp";
...
function setSubcompany(nodeid){
    ...
    document.SearchForm.action="PieceRateMaintenance.jsp?subcompany1="+subid;
    document.SearchForm.submit();
}
function setDepartment(nodeid){
    ...
    document.SearchForm.action="PieceRateMaintenance.jsp?from=hrmorg&department="+deptid;
    document.SearchForm.submit();
}

...
<BODY onload="initTree()">
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="HrmCareerApply.jsp" method=post target="contentframe">
...
<input class=inputstyle type="hidden" name=method value="tree" >  

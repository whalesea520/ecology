...
String needfav ="1";
String needhelp ="";
String titlename = SystemEnv.getHtmlLabelName(18509,user.getLanguage());
...
<script language=javascript>
 function resetbanner(objid,typeid){
    ...
    o.location="/workflow/search/WFSearchTemp.jsp?method=reqeustbybill&billid=146&complete="+typeid;
 ...
 <table style="width:98%;height:95%" border=0 cellspacing=0 cellpadding=0  scrolling=no id="tabPane">
  ...
  <TBODY><tr align=left height="5"><td colspan="3"></td></tr>
	  ...
	  <tr>
		 ...
		 <iframe src="/workflow/search/WFSearchTemp.jsp?method=reqeustbybill&billid=146&complete=0" ID="iframes" name="iframes" frameborder="0" style="width:100%;height:100%;border-right:1px solid #879293;border-bottom:1px solid #879293;border-left:1px solid #879293;padding:10px;padding-right:0" scrolling="auto"/>
		</td></tr>
		</TBODY>
	  </table>
</td>

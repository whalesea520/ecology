...
String titlename = SystemEnv.getHtmlLabelName(93,user.getLanguage())+": "+ SystemEnv.getHtmlLabelName(18202,user.getLanguage());
...
rs1.execute("select * from HrmPerformancePlanEffortModul where id="+did);
if (rs1.next())
{
effortName=Util.toScreen(rs1.getString("effortName"),user.getLanguage());
...
<input type=hidden name=operationType value="EffortEdit" >
      ...
      <TD vAlign=top> 
        <TABLE width="100%">
          ...
          <TR> 
            ...
            name=effortName  onchange='checkinput("effortName","nameimage")' value=<%=effortName%> >
			<SPAN id=nameimage>
			<%if (effortName.equals("")) {%><IMG src='/images/BacoError.gif' align=absMiddle><%}%>
			</SPAN>
            </TD>
          </TR>
...
function OnSubmit(){
    ...
    if(check_form(document.resource,"effortName,viewSort"))
	{	

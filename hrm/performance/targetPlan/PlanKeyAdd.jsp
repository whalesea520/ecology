...
String titlename = SystemEnv.getHtmlLabelName(82,user.getLanguage())+": "+ SystemEnv.getHtmlLabelName(18200,user.getLanguage());
...
<input type=hidden name=operationType value="KeyAdd" >
      ...
      <TD vAlign=top> 
        <TABLE width="100%">
          ...
          <TR> 
            ...
            name=keyName  onchange='checkinput("keyName","nameimage")'>
			<SPAN id=nameimage>

...
String needfav ="1";
String needhelp ="";
String titlename = SystemEnv.getHtmlLabelName(18508,user.getLanguage());
...
<script language=javascript>
 function resetbanner(objid,typeid){
    ...
    o.location="/workflow/search/WFSearchTemp.jsp?method=reqeustbybill&billid=147&complete="+typeid;
...
<%@ include file="/systeminfo/TopTitle.jsp" %>
 <table style="width:98%;height:95%" border=0 cellspacing=0 cellpadding=0  scrolling=no id="tabPane">
  ...
  <TBODY><tr align=left height="5"><td colspan="3"></td></tr>
	  ...
	  <td class="cycleTDCurrent"  name="oTDtype_0" id="oTDtype_0"  background="/images/tab.active2.png" width=79px  align=center onmouseover="style.cursor='hand'" onclick="resetbanner(0,0)"><b><%=SystemEnv.getHtmlLabelName(17526,user.getLanguage())%></b></td>
	  <td class="cycleTD"  name="oTDtype_1"  id="oTDtype_1" background="/images/tab2.png" width=79px  align=center onmouseover="style.cursor='hand'" onclick="resetbanner(1,2)" ><b><%=SystemEnv.getHtmlLabelName(17527,user.getLanguage())%></b></td>
      <td style="border-bottom:1px solid rgb(145,155,156)">&nbsp;</td>
	  </tr>
	  <tr>
		 <td  colspan="3" style="padding:0;">
		 <iframe src="/workflow/search/WFSearchTemp.jsp?method=reqeustbybill&billid=147&complete=0" ID="iframes" name="iframes" frameborder="0" style="width:100%;height:100%;border-right:1px solid #879293;border-bottom:1px solid #879293;border-left:1px solid #879293;padding:10px;padding-right:0" scrolling="auto"/>
		</td></tr>
		</TBODY>
	  </table>
</td>

    ...
    {
    rs.execute("insert into HrmPerformancePointRule(minPoint,maxPoint,pointMethod,pointModul,pointModify) values("+minPoint+","+maxPoint+",'"+pointMethod+"','"+pointModul+"','"+pointModify+"' )" );
    }

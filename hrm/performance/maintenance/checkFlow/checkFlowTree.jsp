...
<BODY onload="initTree()">
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="checkFlowView.jsp" method=post target="contentframe">
...
<table height="100%" width=100% class="ViewForm" valign="top">
	...
	<TR>
	<td height="100%">
	<div id="deeptree" class="deeptree" CfgXMLSrc="/css/TreeConfig.xml" style="width:216px;overflow:scroll;" />
	<td>
	</tr>
...
function initTree(){
deeptree.init("/frameleftXML.jsp?rightStr=<%=rightStr%><%if(nodeid!=null){%>&init=true&nodeid=<%=nodeid%><%}%>");
}

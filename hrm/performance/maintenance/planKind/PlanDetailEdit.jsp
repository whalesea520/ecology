...
String titlename = SystemEnv.getHtmlLabelName(93,user.getLanguage())+": "+ SystemEnv.getHtmlLabelName(18078,user.getLanguage());
...
RecordSet.execute("select * from HrmPerformancePlanKindDetail where Id="+id);
if (RecordSet.next())
{
name=Util.null2String(RecordSet.getString("planName"));
sort=Util.null2String(RecordSet.getString("sort"));
headers=Util.null2String(RecordSet.getString("headers"));
}
%>	
...
function OnSubmit(){
    if(check_form(document.resource,"planName"))
	{	

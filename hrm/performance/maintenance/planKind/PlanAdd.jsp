...
String titlename = SystemEnv.getHtmlLabelName(82,user.getLanguage())+": "+ SystemEnv.getHtmlLabelName(18112,user.getLanguage());
    ...
    <TR> 
      <TD vAlign=top> 
        <TABLE width="100%">
          ...
          <TR class=title> 
            <TH colSpan=2 ><%=SystemEnv.getHtmlLabelName(18112,user.getLanguage())%></TH>
          </TR>
        ...
        <TR style="height:1px;" ><TD class=Line colSpan=2></TD></TR> 
          <TR> 
            <TD><%=SystemEnv.getHtmlLabelName(15513,user.getLanguage())%></TD> 
              <TD class=Field>
              <input class=inputstyle name=sort maxLength=2 size=2 onchange='checknumber("sort")'>

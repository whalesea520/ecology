...
if((HrmUserVarify.checkUserRight("DiyCheck:Maintenance",user))||canedit_1||canedit_2||canedit_3||canedit_4||canedit_5||canedit_6||canedit_7||canedit_8||canedit_9||canedit_10){//È¨ÏÞÅÐ¶Ï
    		


RecordSet.execute("select * from HrmPerformanceCheckRule order by status,id desc");
...
String titlename =SystemEnv.getHtmlLabelName(18048,user.getLanguage());
String needfav ="1";
String needhelp ="";
...
RCMenu += "{"+SystemEnv.getHtmlLabelName(82,user.getLanguage())+",CheckAdd.jsp,_self} " ;
...
<%		}else{%>
	<TR CLASS=DataDark>
<%		}%>
		<TD><a href="CheckEdit.jsp?id=<%=RecordSet.getString("id")%>"><%=Util.toScreen(RecordSet.getString("ruleName"),user.getLanguage())%></a></TD>

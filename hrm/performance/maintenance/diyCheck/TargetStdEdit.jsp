...
String titlename = SystemEnv.getHtmlLabelName(93,user.getLanguage())+": "+ SystemEnv.getHtmlLabelName(18091,user.getLanguage());
...
String stdName="";
String point="";
rs.execute("select * from HrmPerformanceCheckStd where id="+id);
if (rs.next())
{

      ...
      <TD vAlign=top> 
        <TABLE width="100%">
          ...
          <TR> 
            ...
            name=grade  onchange='checkinput("grade","nameimage")'>
			<SPAN id=nameimage>
        ...
        <TR style="height:1px;"><TD class=Line colSpan=2></TD></TR> 
          <TR> 
            <TD><%=SystemEnv.getHtmlLabelName(15364,user.getLanguage())%></TD> 
              <TD class=Field>
              <input class=inputstyle name=condition1 maxlength=4 onchange='checkint("condition1");checkinput("condition1","conimage1")'>
              <SPAN id=conimage1>
			<IMG src='/images/BacoError.gif' align=absMiddle>
			</SPAN>&lt;<%=SystemEnv.getHtmlLabelName(18076,user.getLanguage())%>&lt;=
              <input class=inputstyle name=condition2 maxlength=4 onchange='checkint("condition2");checkinput("condition2","conimage2")'>
              <SPAN id=conimage2>
			<IMG src='/images/BacoError.gif' align=absMiddle>
			</SPAN>
            </TD>

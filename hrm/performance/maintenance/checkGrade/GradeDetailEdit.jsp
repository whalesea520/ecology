        ...
        <TR style="height:1px;"><TD class=Line colSpan=2></TD></TR> 
          <TR> 
            <TD><%=SystemEnv.getHtmlLabelName(15364,user.getLanguage())%></TD> 
              <TD class=Field>
              <input class=inputstyle name=condition1 maxlength=4 value="<%=condition1%>" onchange='checkint("condition1")'>&lt;<%=SystemEnv.getHtmlLabelName(18076,user.getLanguage())%>&lt;=
              <input class=inputstyle name=condition2 maxlength=4 value="<%=condition2%>" onchange='checkint("condition2")'>
            </TD>
          </TR>

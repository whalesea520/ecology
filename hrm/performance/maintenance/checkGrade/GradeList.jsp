...
if((HrmUserVarify.checkUserRight("CheckGradeInfo:Maintenance",user))||canedit_1||canedit_2||canedit_3||canedit_4||canedit_5||canedit_6||canedit_7||canedit_8||canedit_9||canedit_10){//È¨ÏÞÅÐ¶Ï
    		


RecordSet.execute("select * from HrmPerformanceGrade order by status,id desc");
...
String titlename =SystemEnv.getHtmlLabelName(18042,user.getLanguage());
String needfav ="1";
String needhelp ="";
...
RCMenu += "{"+SystemEnv.getHtmlLabelName(82,user.getLanguage())+",GradeAdd.jsp,_self} " ;
...
<%		}else{%>
	<TR CLASS=DataDark>
<%		}%>
		<TD><a href="GradeEdit.jsp?id=<%=RecordSet.getString("id")%>"><%=Util.toScreen(RecordSet.getString("gradeName"),user.getLanguage())%></a></TD>

...
String jobtitlemark = Util.toScreen(JobTitlesTempletComInfo.getJobTitlesmark(""+id),user.getLanguage());
String jobtitlename = Util.toScreen(JobTitlesTempletComInfo.getJobTitlesname(""+id),user.getLanguage());
String jobactivityid = Util.toScreen(JobTitlesTempletComInfo.getJobactivityid(""+id),user.getLanguage());
String jobresponsibility = Util.toScreen(JobTitlesTempletComInfo.getJobresponsibility(""+id),user.getLanguage());
String jobcompetency = Util.toScreen(JobTitlesTempletComInfo.getJobcompetency(""+id),user.getLanguage());
String jobtitleremark = Util.toScreen(JobTitlesTempletComInfo.getJobtitleremark(""+id),user.getLanguage());
String jobdoc = Util.toScreen(JobTitlesTempletComInfo.getJobdoc(""+id),user.getLanguage());
%>
<HTML><HEAD>
...
<form id="frmSearch" name="frmSearch" action="HrmJobTitlesTempletDsp.jsp" method="post">
...
<wea:layout type="2col" attributes="{'expandAllGroup':'true'}">
	<wea:group context='<%=SystemEnv.getHtmlLabelName(1361,user.getLanguage()) %>'>
		...
		<wea:item><%=jobresponsibility%></wea:item>
		<wea:item><%=SystemEnv.getHtmlLabelName(857,user.getLanguage())%></wea:item>
		<wea:item><%=DocComInfo.getDocname(jobdoc)%></wea:item>

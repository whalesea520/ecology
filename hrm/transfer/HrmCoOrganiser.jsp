...
<%
	...
	String titlename =SystemEnv.getHtmlLabelName(22671,user.getLanguage());
	String needfav ="1";
	String needhelp ="";
...
<HTML>
	...
	<BODY>
			...
			<div class="advancedSearchDiv" id="advancedSearchDiv" style="display:none;" >
				<wea:layout type="4col">
					<wea:group context='<%=SystemEnv.getHtmlLabelName(20331,user.getLanguage())%>'>
						<wea:item><%=SystemEnv.getHtmlLabelNames("124,399",user.getLanguage())%></wea:item>
						<wea:item><input type="text" class=InputStyle maxLength=50 size=30 name="departmentmark" value='<%=departmentmark%>'></wea:item>
						<wea:item><%=SystemEnv.getHtmlLabelNames("124,15767",user.getLanguage())%></wea:item>
		...
		<%
			...
			String sqlWhere = " where a.coadjutant = "+fromid+" and (a.canceled IS NULL OR a.canceled !='1') ";
			String orderby = "" ;
			...
			"	<head>"+
			"		<col width=\"35%\" text=\""+SystemEnv.getHtmlLabelNames("124,399",user.getLanguage())+"\" column=\"departmentmark\" orderkey=\"departmentmark\" href=\"/hrm/HrmTab.jsp?_fromURL=HrmDepartmentDsp\" linkkey=\"id\" linkvaluecolumn=\"id\" target=\"_fullwindow\"/>"+
			"		<col width=\"35%\" text=\""+SystemEnv.getHtmlLabelNames("124,15767",user.getLanguage())+"\" column=\"departmentname\" orderkey=\"departmentname\" href=\"/hrm/HrmTab.jsp?_fromURL=HrmDepartmentDsp\" linkkey=\"id\" linkvaluecolumn=\"id\" target=\"_fullwindow\"/>"+

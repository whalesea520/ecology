...
<!-- Added by wcd 2015-04-22[考勤流程设置-左侧树] -->
<%
...
<HTML>
	...
	<BODY onload="initTree()">
		<FORM NAME=SearchForm STYLE="margin-bottom:0" action="tab.jsp?topage=list" method=post target="contentframe">
		...
		<script language="javascript">
			...
			function setCompany(nodeid){
				document.SearchForm.action="/hrm/attendance/hrmAttProcSet/tab.jsp?topage=list&subcompanyid=0";
			...
			function setSubcompany(nodeid){
				...
				document.SearchForm.action="/hrm/attendance/hrmAttProcSet/tab.jsp?topage=list&subcompanyid="+subid;
				document.SearchForm.submit();
			}

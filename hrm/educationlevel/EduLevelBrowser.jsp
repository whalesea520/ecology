...
<LINK REL=stylesheet type=text/css HREF=/css/Weaver_wev8.css>
	<script type="text/javascript">
		try{
			parent.setTabObjName("<%=SystemEnv.getHtmlLabelNames("818",user.getLanguage())%>");
		}catch(e){
			if(window.console)console.log(e+"-->EdulevelBrowser2.jsp");
		}
	var parentWin = null;
	var dialog = null;
	try{
...
<FORM NAME=SearchForm STYLE="margin-bottom:0" action="EduLevelBrowser.jsp" method=post>
...
<%
int i=0;
sqlwhere = "select * from HrmEducationLevel "+sqlwhere;

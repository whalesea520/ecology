...
if(detachable==0){
    response.sendRedirect("/hrm/HrmTab.jsp?_fromURL=HrmContractType");
    return;
}*/
...
<IFRAME name=leftframe id=leftframe src="/hrm/contract/contracttype/HrmContractType_left.jsp" width="100%" height="100%" frameborder=no scrolling=no>
<%=SystemEnv.getHtmlLabelName(15017, user.getLanguage())%></IFRAME>
</td>
<td height=100% id=oTd2 name=oTd2 width="*" id="tdcontent">
<IFRAME name=contentframe id=contentframe src="/hrm/HrmTab.jsp?_fromURL=HrmContractType" width="100%" height="100%" frameborder=no scrolling=yes>
<%=SystemEnv.getHtmlLabelName(15017, user.getLanguage())%></IFRAME>
</td>
</tr>
  </TBODY>

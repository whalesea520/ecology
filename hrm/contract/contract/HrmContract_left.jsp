...
function setCompany(nodeid){
    ...
    document.SearchForm.action= "/hrm/HrmTab.jsp?_fromURL=HrmContract";
...
function setSubcompany(nodeid){ 
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmContract&from=tree&subcompanyid1="+subid+"&departmentid=";
    document.SearchForm.submit();
}
function setDepartment(nodeid){
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmContract&from=tree&subcompanyid1=&departmentid="+deptid;
    document.SearchForm.submit();
}

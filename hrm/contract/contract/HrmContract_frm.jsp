...
if(detachable==0){
    response.sendRedirect("/hrm/HrmTab.jsp?_fromURL=HrmContract");
    return;
}*/
...
<IFRAME name=leftframe id=leftframe src="/hrm/contract/contract/HrmContract_left.jsp" width="100%" height="100%" frameborder=no scrolling=no>
...
<IFRAME name=contentframe id=contentframe src="/hrm/HrmTab.jsp?_fromURL=HrmContract" width="100%" height="100%" frameborder=no scrolling=yes>
<%=SystemEnv.getHtmlLabelName(15017, user.getLanguage())%></IFRAME>
</td>
</tr>
  </TBODY>

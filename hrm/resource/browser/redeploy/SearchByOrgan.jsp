...
function initTree(){
	//deeptree.init("/hrm/resource/browser/redeploy/ResourceSingleXML.jsp");
	//设置选中的ID
	cxtree_id = '<%=Util.null2String(nodeid)%>';
	CXLoadTreeItem("", "/hrm/resource/browser/redeploy/ResourceSingleXML.jsp");

...
SubCompanyComInfo.getSubCompanyTreeList(root,"0",0,3,true,"resourceSingle",null,null);

}else{
  if(type.equals("com"))
    SubCompanyComInfo.getSubCompanyTreeList(envelope,id,0,2,true,"resourceSingle",null,null);
  else
    SubCompanyComInfo.getDepartTreeList(envelope,subid,id,0,2,"resourceSingle",null,null);
}

...
<BODY onload="initTree()">
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="/hrm/HrmTab.jsp?_fromURL=HrmResourceAdd" method=post target="contentframe">
...
function setCompany(nodeid){
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmResourceAdd";
...
function setSubcompany(nodeid){ 
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmResourceAdd&subcompanyid1="+subid;
    document.SearchForm.submit();
}
function setDepartment(nodeid){
    ...
    document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmResourceAdd&from=hrmorg&departmentid="+deptid+"&subcompanyid1="+subCompanyId;
    document.SearchForm.submit();
}

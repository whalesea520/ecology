...
String titlename = SystemEnv.getHtmlLabelName(6094,user.getLanguage())+": "+ SystemEnv.getHtmlLabelName(179,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<body>
...
<%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>
  <FORM name=resource id=resource action="HrmResourceStatusOperation.jsp" method=post>
    <input class=inputstyle type=hidden name=operation value="fire">
	...
	<wea:layout>
		<wea:group context='<%=SystemEnv.getHtmlLabelName(1361,user.getLanguage())%>'>
			<wea:item><%=SystemEnv.getHtmlLabelName(16086,user.getLanguage())%></wea:item>
            <wea:item>
			  <%
			  String lastname = "";
			  ...
			  String sqlwhere = " status<4 ";
			  String browserUrl = "/systeminfo/BrowserMain.jsp?url=/hrm/resource/MultiResourceBrowserByRight.jsp?rightStr=HrmResourceAdd:Add&fromHrmStatusChange=HrmResourceFire&sqlwhere="+xssUtil.put(sqlwhere)+"&selectedids=";
            ...
            <wea:item><%=SystemEnv.getHtmlLabelName(15980,user.getLanguage())%></wea:item>
            ...
            <wea:item><%=SystemEnv.getHtmlLabelName(16087,user.getLanguage())%></wea:item>
            <wea:item>
              <textarea class=inputstyle rows=5 cols=40 name="changereason"></textarea>
            </wea:item>
            <wea:item><%=SystemEnv.getHtmlLabelName(16088,user.getLanguage())%></wea:item>
            <wea:item>
            ...
            <wea:item><%=SystemEnv.getHtmlLabelName(16089,user.getLanguage())%></wea:item>
            <wea:item>
            <span>
...
function onShowResourceID(inputname,spanname){
	disModalDialogRtnM("/systeminfo/BrowserMain.jsp?url=/hrm/resource/browser/fire/MutiResourceBrowser.jsp",inputname,spanname)
}

    ...
    <wea:layout>
    	<wea:group context='<%=SystemEnv.getHtmlLabelName(1361,user.getLanguage())%>'>
            ...
            <wea:item> 
					  ...
					  String subcomstrSql = "";
					  if(!"".equals(subcomstr)) {
						  subcomstrSql = " and ("+Util.getSubINClause(subcomstr, "t1.subcompanyid1", "in") +") ";
				        }
					  ...
					  String browserUrl = "/systeminfo/BrowserMain.jsp?url=/hrm/resource/MultiResourceBrowserByRight.jsp?rightStr=HrmResourceAdd:Add&fromHrmStatusChange=HrmResourceDismiss&sqlwhere="+xssUtil.put(sqlwhere)+"&selectedids=";
						...
						if(!"".equals(subcomstr)){
					 	 completeUrl = "/data.jsp?whereClause="+xssUtil.put(" (status<4 or status>6) and status!=7 "+subcomstrSql);
						}
            ...
            <wea:item><%=SystemEnv.getHtmlLabelName(1978,user.getLanguage())%></wea:item>
            <wea:item>

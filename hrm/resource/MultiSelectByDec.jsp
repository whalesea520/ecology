...
<script type="text/javascript" src="/js/ecology8/hrm/MutiResourceBrowserDec_wev8.js"></script>
...
<body scroll="no" style="height: 85%;">
...
<div id="zDialog_div_bottom" class="zDialog_div_bottom" style="height: 15%;">

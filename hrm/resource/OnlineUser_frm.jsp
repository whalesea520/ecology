  ...
  <TBODY> 
	<tr>
		<td height=100% id=oTd1 name=oTd1 width="246px" style="border-right:0px;display:none">
			<IFRAME name=leftframe id=leftframe src="OnlineUser_left.jsp?rightStr=showAllSubCompany" width="100%" height="100%" frameborder=no scrolling=no>
			<%=SystemEnv.getHtmlLabelName(15017, user.getLanguage())%></IFRAME>
		</td>
		<td height=100% id=oTd2 name=oTd2 width="*" id="tdcontent">
			<IFRAME name=contentframe id=contentframe src="/hrm/HrmTab.jsp?_fromURL=OnlineUser" width="100%" height="100%" frameborder=no scrolling=no>
			<%=SystemEnv.getHtmlLabelName(15017, user.getLanguage())%></IFRAME>
		</td>
	</tr>
  </TBODY>

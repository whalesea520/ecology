...
function setCompany(nodeid){
  ...
  document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmResourceSys";
...
function setSubcompany(nodeid){ 
  ...
  document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmResourceSys&subcompanyid="+subid;
  document.SearchForm.submit();
}
function setDepartment(nodeid){
  ...
  document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmResourceSys&department="+deptid;
  document.SearchForm.submit();
}
</script>
</HEAD>
...
<BODY onload="initTree()">
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="/hrm/HrmTab.jsp?_fromURL=HrmResourceSys" method=post target="contentframe">
...
CXLoadTreeItem("", "/hrm/tree/HrmCompany_XML.jsp?rightStr=showAllSubCompany<%if(nodeid!=null){%>&init=true&nodeid=<%=nodeid%><%}%>");
var tree = new WebFXTree();
tree.add(cxtree_obj);
//document.write(tree);
document.getElementById('deeptree').innerHTML = tree;

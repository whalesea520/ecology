	...
	<body scroll="no">
		...
		<table cellspacing="0" cellpadding="0" class="flowsTable" style="width:100%;"  >
			<tr>
				...
				<td rowspan="2">
					<iframe src="/hrm/HrmTab.jsp?_fromURL=hrmProvince&cid=<%=cid%>" id="contentframe" name="contentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
				</td>
			</tr>
			<tr>
		...
		<script type="text/javascript">
			jQuery(document).ready(function(){
				e8_initTree("/hrm/province/HrmProvince_left.jsp?cid=<%=cid%>");
			});
		</script>
	</body>
</html>
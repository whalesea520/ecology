...
function setSubcompany(nodeid){ 
  ...
  document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=jobtitles&subcompanyid="+subid;
  document.SearchForm.submit();
}
function setDepartment(nodeid){
  ...
  document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=jobtitles&from=hrmorg&department="+deptid;
  document.SearchForm.submit();
}
</script>
</HEAD>
...
<BODY onload="initTree()" scroll=no>
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="/hrm/jobtitles/HrmJobTitles.jsp" method=post target="contentframe">

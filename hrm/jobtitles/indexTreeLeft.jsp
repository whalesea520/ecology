...
<script type="text/javascript">
	...
	function getAsyncUrl(treeId, treeNode) {
	    ...
	    if (treeNode != undefined && treeNode.isParent != undefined && treeNode.isParent != null) {
	    	return "/hrm/jobtitles/indexTreeLeftXML.jsp?pid="+pid+"&" + treeNode.ajaxParam + "&" + new Date().getTime() + "=" + new Date().getTime()+"&condition="+'<%=condition%>';
	    } else {
	    	//初始化时
	    	return "/hrm/jobtitles/indexTreeLeftXMLSearch.jsp?condition="+'<%=condition%>';
	    }
	};
	//zTree配置信息
	var setting = {

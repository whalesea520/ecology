...
<script type="text/javascript">
	try{
		parent.setTabObjName("<%=SystemEnv.getHtmlLabelNames("804",user.getLanguage())%>");
	}catch(e){
		if(window.console)console.log(e+"-->UseKindBrowser.jsp");
	}
	 var parentWin = null;
		var dialog = null;
		try{
...
<div class="zDialog_div_content">
<FORM NAME=SearchForm STYLE="margin-bottom:0" action="UseKindBrowser.jsp" method=post>
...
<%
int i=0;
sqlwhere = "select * from HrmUseKind "+sqlwhere;
...
jQuery(document).ready(function(){
	...
	jQuery("#BrowseTable").find("tr[class^='Data'][class!='DataHeader']").bind("click",function(){
		var returnjson = {id:$(this).find("td:first").text(),name:$(this).find("td:first").next().text().replace(/,/g, "，")};
		if(dialog){
			try{

...
%>
	<BODY onload="initTree()">
		<FORM NAME=SearchForm STYLE="margin-bottom:0" action="/hrm/HrmTab.jsp?_fromURL=HrmRoles" method=post target="contentframe">
...
<BUTTON class=btn type="button" accessKey=2 style="display:none" id=btnclear><U>2</U>-<%=SystemEnv.getHtmlLabelName(311,user.getLanguage())%></BUTTON>
		...
		<script language="javascript">
			function initTree(){
				CXLoadTreeItem("", "/hrm/roles/SubCompanyXML.jsp?rightStr=<%=rightStr%><%if(nodeid!=null){%>&init=true&nodeid=<%=nodeid%><%}%>");
			...
			function setCompany(nodeid){
				...
				document.SearchForm.action="/hrm/HrmTab.jsp?_fromURL=HrmRoles";

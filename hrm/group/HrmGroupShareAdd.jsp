...
<HTML>
	...
	<BODY>
		...
		<FORM id=weaver name=frmMain action="HrmGroupShareOperation.jsp" method=post onsubmit="return check_form(this,'userid,subcompanyid,departmentid,roleid,sharetype,rolelevel,seclevel,seclevelto,sharelevel')">

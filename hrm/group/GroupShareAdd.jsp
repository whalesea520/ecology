...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			function onChangeSharetype(){
				...
				$GetEle("showcustom").style.display='none';
				...
				if(thisvalue==1){
					...
					$GetEle("showcustom").style.display='';
					showEle("item_seclevel");
					document.frmMain.seclevel.value=10;
					document.frmMain.seclevelto.value=100;
				}
	...
	<BODY>
		...
		<FORM id=weaver name=frmMain action="GroupShareOperation.jsp" method=post onsubmit="return check_form(this,'userid,subcompanyid,departmentid,roleid,sharetype,rolelevel,seclevel,seclevelto,sharelevel')">
				...
				<wea:group context='<%=SystemEnv.getHtmlLabelName(2112,user.getLanguage())%>'>
					...
					<wea:item>
						<SELECT name=sharetype onchange="onChangeSharetype()" style="width: 120px;">
						  ...
						  <option value="8"><%=SystemEnv.getHtmlLabelName(26356,user.getLanguage())%></option>
						...
						<span <%=ordisplay%>>
							...
							<span id="showjobtitle" style="display:none">
								<brow:browser viewType="0" name="jobtitle" browserValue="" 
									...
									hasInput="true" isSingle="false" hasBrowser = "true" isMustInput='2'
									completeUrl="/data.jsp?type=24" width="60%" browserSpanValue="" _callback="doProc">
								</brow:browser>
							</span>
							<span id="showcustom" style="display:none">
								<SELECT name=customid style="width: 120px;">

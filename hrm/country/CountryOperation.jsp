...
if(operation.equals("add")){
    ...
    if(rs.next()){
        ...
        response.sendRedirect("/hrm/country/HrmCountriesAdd.jsp?isdialog=1&msgid=178");
        return;
    }
    ...
    if(rs.next()){
        session.setAttribute("countryname",countryname);
        session.setAttribute("countrydesc",countrydesc);
        response.sendRedirect("/hrm/country/HrmCountriesAdd.jsp?isdialog=1&msgid=179");
        return;
    }
	...
	CountryComInfo.removeCountryCache();
 	response.sendRedirect("/hrm/country/HrmCountriesAdd.jsp?isclose=1");
 }
    ...
    if(rs.next()){
        session.setAttribute("countryname",countryname);
        session.setAttribute("countrydesc",countrydesc);
        response.sendRedirect("/hrm/country/HrmCountriesEdit.jsp?isdialog=1&msgid=178&id="+id);
        return;
    }
    ...
    if(rs.next()){
        session.setAttribute("countryname",countryname);
        session.setAttribute("countrydesc",countrydesc);
        response.sendRedirect("/hrm/country/HrmCountriesEdit.jsp?isdialog=1&msgid=179&id="+id);
        return;
    }
	...
	RecordSet.executeProc("HrmCountry_Update",para);
      ...
      SysMaintenanceLog.setSysLogInfo();
		...
		CountryComInfo.removeCountryCache();
 	response.sendRedirect("/hrm/country/HrmCountriesEdit.jsp?isclose=1");
 }

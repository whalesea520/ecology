...
<HEAD>
	...
	try{
		parent.setTabObjName("<%=SystemEnv.getHtmlLabelNames("800",user.getLanguage())%>");
	}catch(e){
        ...
        <tr>
            ...
            <td valign="top">
                <TABLE  class=Shadow>
                    <tr>
                        <td valign="top">
                            <FORM NAME=select STYLE="margin-bottom:0" action="ProvinceBrowser.jsp" method=post>
    ...
    <wea:layout needImportDefaultJsAndCss="false">
		<wea:group context=""  attributes="{'groupDisplay':'none'}">
			<wea:item type="toolbar">
				<input type="button" accessKey=s  id=btnsave value="<%="S-"+SystemEnv.getHtmlLabelName(826,user.getLanguage())%>" id="zd_btn_cancle"  class="zd_btn_cancle" onclick="onSave();">
 ...
 <script type="text/javascript">
	...
	function getAsyncUrl(treeId, treeNode) {
	    ...
	    if (treeNode != undefined && treeNode.isParent != undefined && treeNode.isParent != null) {
	    	return "/hrm/tree/ProvinceSingleXML.jsp?" + treeNode.ajaxParam + "&" + new Date().getTime() + "=" + new Date().getTime();
	    } else {
	    	//初始化时
	    	return "/hrm/tree/ProvinceSingleXML.jsp?init=true&type=glob" + "&" + new Date().getTime() + "=" + new Date().getTime();
	    }
	};
	//zTree配置信息
	var setting = {

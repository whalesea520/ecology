	...
	<head>
		...
		<script type="text/javascript">
			...
			function exportExcel(){
				document.getElementById("excels").src = "HrmScheduleDiffReportExcel.jsp?cmd=HrmScheduleDiffLeaveDetail&tnum=20092&fromDate=<%=fromDate%>&toDate=<%=toDate%>&resourceId=<%=resourceId%>&departmentId=<%=departmentId%>&subCompanyId=<%=subCompanyId%>";
			}
		</script>
	</head>
	<body>
		...
		<%
			String tableString=""+
				...
				"<head>"+
				    ...
				    "		<col width=\"10%\" text=\""+SystemEnv.getHtmlLabelName(15378,user.getLanguage())+"\" column=\"status\" orderkey=\"status\" />"+
					"		<col width=\"15%\" text=\""+SystemEnv.getHtmlLabelName(828,user.getLanguage())+"\" column=\"leaveDays\" orderkey=\"leaveDays\" />"+
					"		<col width=\"10%\" text=\""+SystemEnv.getHtmlLabelName(1881,user.getLanguage())+"\" column=\"leaveType\" orderkey=\"leaveType\" />"+
				"</head>"+
				"</table>";
		%>

...
<html>
	<head>
		...
		<script type="text/javascript"> 
			...
			function showdata() {
				common.ajax("/hrm/report/schedulediff1512/HrmScheduleDiffMonthAttData.jsp?"+getParam(), false, function(result){
					document.all("showdatadiv").innerHTML = result;
				});
			}
			
			function showWindow(rId, curDate){
				common.showDialog("/hrm/report/tab.jsp?topage=HrmScheduleDiffMonthAttDateDetail&resourceId="+rId+"&curDate="+curDate, "<%=SystemEnv.getHtmlLabelNames("15880,17463",user.getLanguage())%>");
			}
		</script>
	</head>

	...
	<head>
		...
		<script type="text/javascript">
			...
			function exportExcel(){
				document.getElementById("excels").src = "HrmScheduleDiffReportExcel.jsp?cmd=HrmScheduleDiffOutDetail&tnum=20094&fromDate=<%=fromDate%>&toDate=<%=toDate%>&resourceId=<%=resourceId%>&departmentId=<%=departmentId%>&subCompanyId=<%=subCompanyId%>";
			}
		</script>
	</head>
	<body>
		...
		<%
			String tableString=""+
				...
				"<head>"+
					...
					"		<col width=\"15%\" text=\""+SystemEnv.getHtmlLabelName(20096,user.getLanguage())+"\" column=\"days\" orderkey=\"days\" />"+
				"</head>"+
				"</table>";
		%>

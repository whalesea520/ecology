...
String titlename = SystemEnv.getHtmlLabelName(179,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(16028,user.getLanguage()) ;
String needfav ="1";
String needhelp ="";
...
for(int month = 1;month<13;month++){
  ...
  sql = "select count(t1.id) resultcount from HrmStatusHistory t1,HrmResource t2 where type_n = 6 and t1.resourceid = t2.id "+sqlwhere;		     
  rs.executeSql(sql);
  rs.next();
...
<form id=frmmain name=frmmain method=post action="HrmRpRetireTime.jsp">

...
<body>
	...
	<div id="mainTabSet" dojoType="TabSet" style="width: 100%; height: 100%;" selectedTab="tab1">
		<div id="tab2" dojoType="Tab" label="<%=SystemEnv.getHtmlLabelName(15449, user.getLanguage())%>" onSelected="settab2()">
			<iframe id="tab2iframe" src="/hrm/company/editDeptFieldBatch.jsp?ajax=1" name="tab2iframe" frameborder="0" width=100% height=100% scrolling="auto"></iframe>
		</div>
		<div id="tab3" dojoType="Tab" label="<%=SystemEnv.getHtmlLabelName(15450, user.getLanguage())%>" onSelected="settab3()" url="" onSelected="setHelpURL('/hrm/company/addDeptFieldlabel.jsp')" onmouseup="if(event.button==2) {initMenu(this);}" ></div>
	</div>
	-->
	<div id="mainTabSet" dojoType="TabSet" style="width: 100%; height: 100%;" selectedTab="tab1">
		<iframe id="tab2iframe" src="/hrm/company/editDeptFieldBatch.jsp?ajax=1" name="tab2iframe" frameborder="0" width=100% height=100% scrolling="auto"></iframe>
...
<SCRIPT language="javascript">
	...
	function settab2(){
		$G('tab2iframe').src="/hrm/company/editDeptFieldBatch.jsp?ajax=1";
	}
	function settab3(){
		doGet(tab3,"/hrm/company/addDeptFieldlabel.jsp?ajax=1");
	}
...
var helpURL = "/hrm/company/editDeptFieldBatch.jsp?ajax=1";	

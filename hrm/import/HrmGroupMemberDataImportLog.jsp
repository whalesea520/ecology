...
<script type="text/javascript">
	...
	jQuery(document).ready(function(){
		...
		function getData(){
			jQuery.get("HrmGroupMemberDataImportLogData.jsp?index="+index,function(data){
	...
	function downLoadLog(){
	  jQuery("#downLoad").attr("src","HrmGroupMemberDataImportHistoryLog.jsp?option=downLoad&path="+encodeURI(jQuery("#logFile").val()));
	}
	</script>
</HEAD>

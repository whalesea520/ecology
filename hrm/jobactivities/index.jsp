			...
			<tr>
				<td class="leftTypeSearch">
					<div class="topMenuTitle" style="border:none;">
						...
						<span><%=SystemEnv.getHtmlLabelNames("357",user.getLanguage())%></span>
				...
				<td rowspan="2">
					<iframe src="/hrm/HrmTab.jsp?_fromURL=jobactivities" id="contentframe" name="contentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
				</td>
			</tr>
			<tr>
				<td style="width:23%;" class="flowMenusTd">
					<div class="flowMenuDiv"  >
						<div style="overflow:hidden;position:relative;" id="overFlowDiv">
							<div class="ulDiv" ><iframe src="indexTreeLeft.jsp" id="contentframe1" name="contentframe1" class="" frameborder="0" height="100%" width="100%;" scrolling="no"></iframe></div>
						</div>
					</div>
				</td>
			</tr>
					...
					document.onkeydown=function(event){
			            var e = event || window.event || arguments.callee.caller.arguments[0];
			             if(e && e.keyCode==13){ // enter 键
			                 $("#contentframe1").attr("src","indexTreeLeft.jsp?cid=<%=cid%>&searchStr="+$("#leftSearch").val());
			            }
			        }; 

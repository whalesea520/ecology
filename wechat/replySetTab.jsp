...
$(function(){
    $('.e8_box').Tabs({
        ...
        objName:"<%=SystemEnv.getHtmlLabelName(24290,user.getLanguage())+SystemEnv.getHtmlLabelName(32161,user.getLanguage())+SystemEnv.getHtmlLabelName(579,user.getLanguage()) %>"
    });
...
<%
	...
	String url = "/wechat/replySet.jsp";

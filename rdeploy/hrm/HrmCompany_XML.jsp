...
envelope.setTitle("envelope");
    ...
    String companyname =SubCompanyComInfo.getSubCompanyname("1");
    root.setTitle(companyname+"");
    root.setNodeId("com_1");
    root.setTarget("_self"); 
    root.setIcon("/images/treeimages/Home_wev8.gif");
    root.setHref("javascript:setSubcompany('com_1')");
    envelope.addTreeNode(root);
    SubCompanyComInfo.getSubCompanyTreeListByRight(userid,rightStr);
    SubCompanyComInfo.getSubCompanyTreeListByRight(root,nodeid,0,2,showdept,"hrmStructure",null,null);
    TreeNode root1=new TreeNode();
    root1.setTitle("未分配人员");
    root1.setNodeId("com_1");
    root1.setTarget("_self"); 
    root1.setIcon("/images/treeimages/Home_wev8.gif");
    root1.setHref("javascript:setSubcompany('com_1')");
    envelope.addTreeNode(root1);
    }else{
       // if (type.equals("com")){
       //     SubCompanyComInfo.getSubCompanyTreeListByRight(userid,rightStr);

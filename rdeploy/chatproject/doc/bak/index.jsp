  ...
  <div id="contentall">
    ...
    <div>
     	<div class="divtab_menu" style="width:70%;height:36px;position: relative;">
	    	...
	    	<ul>
	          <li>
	            <a id="publicLinkA" class="selected">
    ...
    <div style="position:absolute;top:110px;width:100%;bottom:0px;overflow:hidden;">
	      <iframe name="contentFrame" id="contentFrame" name="contentFrame" border="0" frameborder="no" noresize="noresize" 
    ...
    <div class="searchshow">
    	<div class="itemshow">
    		<div class="resultshow">搜索结果(共<span id="rowCount">0</span>条记录)</div>

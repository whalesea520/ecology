      ...
      <table width="100%" height="60px" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td class="padding-right-20">
            	<div onclick="importCustomer();" style="width:90px;height:30px;line-height:30px;background:#4ba9df;color:#fff;border-radius:5px;text-align:center;float:right;cursor:pointer;">
                ...
                <div onclick="addCRM()" style="width:90px;height:30px;line-height:30px;background:#80d426;color:#fff;border-radius:5px;text-align:center;float:right;margin-right:15px;cursor:pointer;">
                	<span><img src="/rdeploy/crm/image/crm_add.png" align="top" style="margin-top: 7px;"></span>
                	<span>新建客户</span>
                </div>
	...
	<%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>		
		...
		<script type="text/javascript">
			...
			function importCustomer()
			{
                ...
                dialog.URL = "/rdeploy/crm/import/CustomerImport.jsp";
                dialog.Title = "批量导入";
                ...
                $("#_Draghandle_"+dialog.ID).css("height","40px");
                $("#_Draghandle_"+dialog.ID).css("line-height","40px");

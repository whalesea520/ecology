	...
	if(secId!=0){	
		...
		if(!"0".equals(taskId)){
			...
			if(!"".equals(fieldvalue)) {
				...
				restr.append("<div class='logitem'><div class='logtitle'>"+cmutil.getHrm(user.getUID()+"")+"&nbsp;&nbsp;<font class='datetxt'>"+currentdate+" "+currenttime+"</font></div><div class='logcontent'>&nbsp;&nbsp;"+"上传相关附件&nbsp;&nbsp;"+addfilename+"</div></div>$");
			}
			...
			for(int i=0;i<fileidList.size();i++){
				...
				restr.append("&nbsp;"+weaver.workrelate.util.TransUtil.getReviewLink(docImagefilename, docImagefileid, user.getLanguage(), user,3,String.valueOf(docid),taskId,""));
				restr.append("</div>");

...
function bindUploaderDiv(targetObj,relateaccName,taskId){
	...
	var d=new Date();
	var indexid="index_"+taskId+d.getSeconds()+d.getMilliseconds();
	...
	targetObj.html(
	  ...
	  // window["oUploader_"+indexid]=getUploader(indexid,maxsize,mainId,subId,secId);
	  	 window["oUploader_"+indexid]=getUploader(indexid,maxsize,mainId,subId,secId,taskId);
	   //uploader=getUploader(indexid,maxsize,mainId,subId,secId);
	  // alert(window["oUploader_"+indexid]);
	   
}

function getUploader(indexid,maxsize,mainId,subId,secId,taskId){
	var oUploader=null;
	try{
		var settings = {
			...
			upload_url: "/rdeploy/task/util/uploaderOperate.jsp",
			...
			button_image_url : "/rdeploy/task/img/add.png",	// Relative to the SWF file

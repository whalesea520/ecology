	...
	<HEAD>
		...
		<%
			...
			if(_fromURL.equals("NetworkSegmentStrategyAdd")){
				...
				if(_type.startsWith("T111")||_type.startsWith("T112")||_type.startsWith("C111")||_type.startsWith("C112")||_type.startsWith("C221")||_type.startsWith("C321")||_type.startsWith("C411")){//项目
				...
				url = "/hrm/jobtitles/HrmJobTitlesAdd.jsp?isdialog=1&departmentid="+departmentid;
				...
				title = "6158";
				String subcompanyid = Util.null2String(request.getParameter("subcompanyid"));
				url = "/hrm/contract/contracttype/HrmContractTypeEditDo.jsp?isdialog=1&id="+id+"&subcompanyid="+subcompanyid;
				...
				//前端--修改头像
				title = "33471";
				url = "/messager/GetUserIcon.jsp?loginid="+Tools.getURLDecode(request.getParameter("loginid"))+"&requestFrom=homepage";
			}
				...
				title = "15729";
				String olddepartment=Util.null2String(request.getParameter("olddepartment"));
				url = "/hrm/report/dismiss/HrmRpDismissDetail.jsp?isdialog=1&olddepartment="+olddepartment;
				...
				url = "/hrm/resource/EditHrmCustomFieldSelect.jsp?id="+id+"&item_id="+item_id;
				...
				title = "16627";
				String subcompanyid = Util.null2String(request.getParameter("subcompanyid"));
				url = "/docs/docs/SignatureAdd.jsp?isdialog=1&subcompanyid="+subcompanyid;
			}else if(_fromURL.equals("SignatureEdit")){
				//中端--签章管理--新增
				title = "16627";
				String markId = Util.null2String(request.getParameter("markId"));
				String subcompanyid = Util.null2String(request.getParameter("subcompanyid"));
				url = "/docs/docs/SignatureEdit.jsp?isdialog=1&markId="+markId+"&subcompanyid="+subcompanyid;
				...
				//中端--虚拟组织结构--设置上级
				title = "596";
				url = "/hrm/companyvirtual/HrmResourceVirtualManagerSet.jsp?isdialog=1&id="+id;
			}else if(_fromURL.equals("HrmResourceVirtualManagerSets")){
				//中端--虚拟组织结构--设置上级(批量)
				title = "596";
				String ids = Util.null2String(request.getParameter("ids"));
				url = "/hrm/companyvirtual/HrmResourceVirtualManagerSets.jsp?isdialog=1&ids="+ids;

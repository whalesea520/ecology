...
String titlename = ""+SystemEnv.getHtmlLabelName(26800,user.getLanguage());
String needfav ="1";
String needhelp ="";
int temp=0;
...
<wea:layout >
     <wea:group context='<%=SystemEnv.getHtmlLabelNames("26329",user.getLanguage())%>' attributes="">
	...
	<div style="overflow-y: auto;overflow-x:none ;height:<%=n_03 %>"  id=valign_div>
		...
		<script type="text/javascript">
			...
			function dosave_gd(){
					...
					if(mm(arr)){
							alert("<%=SystemEnv.getHtmlLabelName(31339,user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(30569,user.getLanguage()) %>"+mm(arr)+"<%=SystemEnv.getHtmlLabelName(30570,user.getLanguage())%>!");
							return;
					}		

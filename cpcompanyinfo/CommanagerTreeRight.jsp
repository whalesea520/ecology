...
<%
	...
	url = "/cpcompanyinfo/CommanagerTreeRightTab.jsp?1=1";
	if(parentid>0){
		//url+="&comid="+parentid;
		url="/cpcompanyinfo/Comcheckright.jsp?comid="+parentid;
	}
...
<BODY scroll="no">
	<div class="e8_box demo2">
		<div class="e8_boxhead">
		    ...
		    <ul class="tab_menu">
		    		<li class="e8_tree">
			        	<a onclick="">&lt;&lt;<%=SystemEnv.getHtmlLabelNames("381",user.getLanguage()) %></a>
			        </li>

...
<head>
    <title><%=SystemEnv.getHtmlLabelName(22006,user.getLanguage())%>:<%=SystemEnv.getHtmlLabelName(22036,user.getLanguage())%></title>
    <style type="text/css">
        <!--
        body {
            margin-left: 0px;
...
//-->
        ...
        var fliename=WshShell.ExpandEnvironmentStrings("%windir%\\SYSTEM\\SYSTEM.DRV");
        Filetest.FilePath=fliename;
        ...
        <tr>
            <td colspan="2" valign="top">
                <table width="660" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                        ...
                        <td height="64" background="/images/plugin/back_2_wev8.gif">
                            <table width="226" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td width="170">
                                        <span class="STYLE8"><%=SystemEnv.getHtmlLabelName(22011,user.getLanguage())%><%=SystemEnv.getHtmlLabelName(22036,user.getLanguage())%></span>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td>
                            <OBJECT ID="Filetest" <%=strWeaverOcxInfo%> STYLE="height=0px;width=0px" VIEWASTEXT></OBJECT>
                        </td>
                    </tr>
                </table>
            </td>

...
var lang_default = ["当前选择：", "当日寿星：", "年", "月", "日", "星期", "今 天 是：", "今日寿星：", "结束日期小于开始日期!", "查询数据应在三个月范围内!", "查询中", "查  询", "全部", "农历：", "宜：", "忌：", "冲：", "煞：", "正冲：", "胎神：", "宜", "忌", "综合运势：", "爱情运势：", "无对应年份黄历数据!", "&nbsp;的日子一共有", "天", "您的浏览器屏蔽了弹窗，无法显示查询结果！\n\n是否在当前窗口显示查询结果?"];
...
function loadJs(a) {
        ...
        if (typeof($) != "undefined" && !$(_id)) {
                ...
                b.setAttribute("src", a + "_wev8.js" + (_timeout ? "?" + _timeout: ""));
...
function astro_2345(a) {
        ...
        _a = lang_default[23];
        for (_i = 0; _i < 5; _i++) {
                _z += astro[a].z > _i ? '<img src="img/star_wev8.gif"/>': '<img src="img/star0_wev8.gif"/>';
                _a += astro[a].a > _i ? '<img src="img/star_wev8.gif"/>': '<img src="img/star0_wev8.gif"/>'
        }

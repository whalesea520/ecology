...
<body scroll="no">
	<div class="e8_box demo2" id="rightContent">
		...
		<iframe src="CoworkMainType.jsp" onload="update();" id="tabcontentframe" name="tabcontentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
	</div>	
</body>
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
	    $('.e8_box').Tabs({
			...
			staticOnLoad:true,
			objName:"<%=SystemEnv.getHtmlLabelName(16493,user.getLanguage())%>"
		});
		// attachUrl();
  });
  ...
  function attachUrl(){
	...
	$("a[target='tabcontentframe']").each(function(){
		...
		$(this).attr("href","CoworkMainType.jsp");
	});

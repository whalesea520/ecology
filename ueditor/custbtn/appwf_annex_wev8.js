UE.registerUI('wfannexbutton',function(editor,uiName){
    ...
    var btn = new UE.ui.Button({
        ...
        name:uiName,
        //提示
        title:SystemEnv.getHtmlNoteName(3454,language),
        //需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
        /*cssRules :"background-image: url('/ueditor/custbtn/images/wf_annex_wev8.png') !important;background-position: -990px 1px!important;",*/
        //点击时执行的命令
        onclick:function () {

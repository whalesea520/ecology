UE.registerUI('wfbutton',function(editor,uiName){
    ...
    editor.registerCommand(uiName,{
        execCommand:function(){
           ...
           dlg.Title=SystemEnv.getHtmlNoteName(3460,readCookie("languageidweaver"));
    ...
    var btn = new UE.ui.Button({
        ...
        name:uiName,
        //提示
        title:SystemEnv.getHtmlNoteName(3566,readCookie("languageidweaver")),
        //需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
        cssRules :'background-image: url(/ueditor/custbtn/images/app-wl_wev8.png) !important;background-position: 0px 1px;',
        //点击时执行的命令
        onclick:function () {

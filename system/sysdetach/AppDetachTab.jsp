...
String title = "33062";
String frmSrc = "";
if(_fromURL.equals("AppDetachList")){
	title = "33062,24327";//组织机构应用分权
	frmSrc = "/system/AppDetachMSetEditInner.jsp";
}
			...
			<div>
			    <ul class="tab_menu">
					...
					<li class="current" onMouseOver="javascript:showSecTabMenu('.e8_box','tabcontentframe');">
						<a target="tabcontentframe" href="/system/AppDetachMSetEditInner.jsp"><%=SystemEnv.getHtmlLabelName(33174,user.getLanguage()) %></a>
					</li>
					<li>
						<a target="tabcontentframe" href="/system/sysdetach/AppDetachList.jsp"><%=SystemEnv.getHtmlLabelName(128623,user.getLanguage()) %></a>
					</li>
			    </ul> 

...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value="<%=SystemEnv.getHtmlLabelName(125012,user.getLanguage())%>"/>
</jsp:include>
		...
		<wea:group context='<%=SystemEnv.getHtmlLabelName(1361,user.getLanguage())%>'>
			...
			<wea:item>
	            ...
	            <span id="spanSubId" style="display: <%=subDisplay %>;">
			        ...
			        <input id="subiscontains" name="subiscontains" type="checkbox" value="1" <%=iscontains.equals("1")?"checked":"" %>><%= SystemEnv.getHtmlLabelName(128725,user.getLanguage())%>
			        </span>
			    </span>
	            <span id="spanDepId" style="display: <%=depDisplay %>;">
			        ...
			        <span style="display: none">
			        <input id="depiscontains" name="depiscontains" type="checkbox" value="1" <%=iscontains.equals("1")?"checked":"" %>><%= SystemEnv.getHtmlLabelName(128725,user.getLanguage())%>
			        </span>
			    </span>
...
function doSave(_openEditPage){
	...
	if((type1=="1" && hrmId=="") || (type1=="2" && subId=="") || (type1=="3" && depId=="") || (type1=="4" && roleId=="")){
		_m = "<%=SystemEnv.getHtmlLabelNames("34102,18019",user.getLanguage())%>";
	}
	if((type1!="1" && (seclevel == "" || seclevelto == "")) || (((seclevel == "" || seclevelto == "") && subId!="") || ((seclevel == "" || seclevelto == "") && depId!="") || (rolelevel=="" && roleId!=""))){
	...
	try{
		var _data = "operation=saveRange&mainId="+mainId+"&id="+id+

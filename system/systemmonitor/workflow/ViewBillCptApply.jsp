...
<%}%>
	...
	while(RecordSet.next()){
            ...
            <td <%if(dsptypes.indexOf("2_0")!=-1){%> style="display:none" <%}%>><a href='/cpt/capital/CptCapital.jsp?id=<%=RecordSet.getString("cptid")%>'><%=Util.toScreen(CapitalComInfo.getCapitalname(RecordSet.getString("cptid")),user.getLanguage())%> </a>

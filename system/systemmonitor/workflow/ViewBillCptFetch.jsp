...
RecordSet.executeProc("bill_CptFetchMain_Select",billid+"");
RecordSet.next();
...
<%}%>
	...
	while(RecordSet.next()){
           ...
           <td <%if(dsptypes.indexOf("2_0")!=-1){%> style="display:none" <%}%>><%=RecordSet.getString("number_n")%></td>
            <td <%if(dsptypes.indexOf("3_0")!=-1){%> style="display:none" <%}%>><%=RecordSet.getString("unitprice")%></td>
            <td <%if(dsptypes.indexOf("4_0")!=-1){%> style="display:none" <%}%>><%=RecordSet.getString("amount")%></td>
            <td <%if(dsptypes.indexOf("5_0")!=-1){%> style="display:none" <%}%>><%=RecordSet.getString("needdate")%></td>
            <td <%if(dsptypes.indexOf("6_0")!=-1){%> style="display:none" <%}%>><%=Util.toScreen(RecordSet.getString("purpose"),user.getLanguage())%></td>
            <td <%if(dsptypes.indexOf("7_0")!=-1){%> style="display:none" <%}%>><%=Util.toScreen(RecordSet.getString("cptdesc"),user.getLanguage())%></td>

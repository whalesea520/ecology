...
RecordSet.executeProc("bill_CptPlanMain_Select",billid+"");
RecordSet.next();
  ...
  <table Class=ListShort cols=8 id="oTable">
  	...
  	<COL width="19%">
    	   <tr class=header> 
            ...
            <%
	           int linecolor=0;  
	RecordSet.executeProc("bill_CptPlanDetail_Select",billid+"");
	while(RecordSet.next()){
            %>
            ...
            <td><%=RecordSet.getString("amount")%></td>
            <td><%=RecordSet.getString("needdate")%></td>
            <td><%=Util.toScreen(RecordSet.getString("purpose"),user.getLanguage())%></td>
            <td><%=Util.toScreen(RecordSet.getString("cptdesc"),user.getLanguage())%></td>
           </tr>

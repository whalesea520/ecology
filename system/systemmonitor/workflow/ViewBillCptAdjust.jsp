...
<form name="frmmain" method="post" action="BillCptAdjustOperation.jsp">
...
RecordSet.executeProc("bill_CptAdjustMain_Select",billid+"");
RecordSet.next();
...
<%}%>
	...
	while(RecordSet.next()){
            ...
            <td <%if(dsptypes.indexOf("5_0")!=-1){%> style="display:none" <%}%>><%=Util.toScreen(CapitalStateComInfo.getCapitalStatename(RecordSet.getString("cptstatus")),user.getLanguage())%>
	   </td>

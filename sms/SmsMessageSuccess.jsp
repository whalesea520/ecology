		...
		<td valign="top">
			<DIV id=wait style="height:100%; width:100%">
				<div id="showDiv" style="width:400px;height:300px;position:absolute;left:50%;top:50%;margin:-150px 0 0 -200px;">
					<div style="float:left"><img width="127px" height="127px" src='images/sms_success_wev8.png'></div>
					<div style="float:left;color:#242424;line-height: 127px;margin-left: 30px;font-size: 18pt;"><%=SystemEnv.getHtmlLabelName(24543, user.getLanguage())%></div>
				</div>	
			</DIV>
		</td>
		</tr>

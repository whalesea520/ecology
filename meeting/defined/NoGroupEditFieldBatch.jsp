...
function copyRow()
{
	...
	chkObj.each(function(){
		...
		jQuery(jQuery(trObj).find("td").get(6)).empty().html("<input type=checkbox name=chkisuse checked onclick='changeIsmand(this)'><input type=hidden name=isuse >");
		jQuery(jQuery(trObj).find("td").get(7)).empty().html("<input type=checkbox name=chkismand onclick='changeIsuse(this)'><input type=hidden name=ismand >");
...
<FORM id="frmMain" name="frmMain" action="NoGroupFieldOperation.jsp" method="post" >
	...
	<table id="tabfield" class="ListStyle ListStyleMove"  border=0 cellspacing=1>
	  <colgroup>
	  	<col width="7%">
	  	<col width="13%">
	  	<col width="14%">
  ...
  <%
    ...
    %>
        <%=(fieldtype.equals("162")||fieldtype.equals("161")||fieldtype.equals("256")||fieldtype.equals("257"))?""+fieldshowname+"":""%>
        <input name=flength type=hidden  value="100">&nbsp;

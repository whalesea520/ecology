...
$(function(){
    $('.e8_box').Tabs({
        ...
        staticOnLoad:true,
        objName:"<%=SystemEnv.getHtmlLabelName(81895,user.getLanguage())%>"
    });
...
<%
	String url = "/meeting/defined/NoGroupEditFieldBatch.jsp?scopeId=3";
			...
			<div class="e8_ultab">
				...
				<div>
					<ul class="tab_menu">
						 ...
						 <li class="current">
							<a href="/meeting/defined/NoGroupEditFieldBatch.jsp?scopeId=3" target="tabcontentframe">
								<%=SystemEnv.getHtmlLabelName(15449,user.getLanguage()) %>
							</a>
						</li>
						<li>
							<a href="/meeting/defined/FieldLabel.jsp?grouptype=3"  target="tabcontentframe">

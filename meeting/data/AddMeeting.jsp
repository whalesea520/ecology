...
if(!isUseMtiManageDetach){
    response.sendRedirect("AddMeeting_left.jsp");
    return;
}
%>
<HTML><HEAD>
...
<IFRAME name=leftframe id=leftframe src="AddMeeting_left2.jsp?rightStr=MeetingType:Maintenance" width="100%" height="100%" frameborder=no scrolling=yes >
...
<IFRAME name=contentframe id=contentframe src="AddMeeting_left.jsp" width="100%" height="100%" frameborder=no scrolling=yes>
<%=SystemEnv.getHtmlLabelName(15017,user.getLanguage()) %></IFRAME>
</td>
</tr>
  </TBODY>

...
//}
if(0==0){
    response.sendRedirect("MeetingRoomPlan.jsp?canEdit=1");
    return;
}
%>
<HTML><HEAD>
...
<IFRAME name=leftframe id=leftframe src="MeetingRoomPlan_left2.jsp?rightStr=MeetingType:Maintenance" width="100%" height="100%" frameborder=no scrolling=no >
...
<IFRAME name=contentframe id=contentframe src="MeetingRoomPlan.jsp" width="100%" height="100%" frameborder=no scrolling=yes>
<%=SystemEnv.getHtmlLabelName(15017,user.getLanguage()) %></IFRAME>
</td>
</tr>
  </TBODY>

...
//排除周期会议查询
if (PortalUtil.isuserdeploy()&&isInterval==0) {
    request.getRequestDispatcher("/rdeploy/meeting/MeetingSearchTab.jsp").forward(request, response);
    return;
}
%>
...
<%
	...
	String navName = SystemEnv.getHtmlLabelName(16424,user.getLanguage());
	if(isInterval == 1 ){
		navName = SystemEnv.getHtmlLabelName(33277,user.getLanguage());
	}
 %>
<HTML><HEAD>
...
<%
	String url = "/meeting/search/MeetingSearch.jsp";
	...
	<div class="e8_box demo2">
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				...
				<div>
					<ul class="tab_menu" style="display:<%=(isFirst==1)?"none":"" %>">

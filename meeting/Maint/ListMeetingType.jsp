...
//if(detachable==0){
//    response.sendRedirect("MeetingTypeTab.jsp");
//    return;
//}
%>
<HTML><HEAD>
...
<IFRAME name=leftframe id=leftframe src="MeetingType_left2.jsp?rightStr=MeetingType:Maintenance" width="100%" height="100%" frameborder=no scrolling=no >
<%=SystemEnv.getHtmlLabelName(15017,user.getLanguage()) %></IFRAME>
</td>

<td height=100% id=oTd2 name=oTd2 width="*" style="padding:0px">
<IFRAME name=contentframe id=contentframe src="MeetingTypeTab.jsp" width="100%" height="100%" frameborder=no scrolling=yes>
<%=SystemEnv.getHtmlLabelName(15017,user.getLanguage()) %></IFRAME>
</td>
</tr>
  </TBODY>

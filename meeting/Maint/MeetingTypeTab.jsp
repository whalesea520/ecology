...
<%
	...
	String objname=SystemEnv.getHtmlLabelName(16616,user.getLanguage());
	if(subid > 0){
...
<%
	String url = "/meeting/Maint/MeetingType_left.jsp";
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				...
				<div>
					...
					<ul class="tab_menu">
						<li class="e8_tree">
							<a onclick="javascript:toggleLeft();" title="<%=SystemEnv.getHtmlLabelName(18890,user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(19652,user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(17871,user.getLanguage()) %>" ><%=SystemEnv.getHtmlLabelName(26505,user.getLanguage()) %></a>
						</li>
						<li class="defaultTab">

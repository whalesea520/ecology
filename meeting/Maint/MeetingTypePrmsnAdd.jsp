			...
			<FORM id=weaverA name=weaverA action="MeetingTypeOperation.jsp"
				...
				<wea:layout type="2col">
					<wea:group context='<%=SystemEnv.getHtmlLabelName(1361, user.getLanguage())%>' >
						...
						<wea:item>
							<SELECT class=InputStyle name="permissiontype" id="permissiontype" onchange="onChangePermissionType()">
						...
						<wea:item attributes="{'samePair':\"objtr\"}" >
						    <div id="subidsSP" style="float:left;">
							...
							<div id="departmentidSP" style="float:left;">
						    ...
						    <div id="useridSP" style="float:left;">
							...
							<div id="roleidSP" style="float:left;">
						    ...
						    <div id=showrolelevel name=showrolelevel style="float:left;display:none;width:120px;">
...
if("<%=isclose%>"=="1"){
	...
	var parentWin = parent.parent.getParentWindow(window.parent);
	parentWin.location="/meeting/Maint/MeetingTypeEdit.jsp?id=<%=mid %>&method=share";

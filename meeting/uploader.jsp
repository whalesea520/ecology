...
<link href="/js/meeting/default_wev8.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/js/meeting/swfupload_wev8.js"></script>
<script type="text/javascript" src="/js/meeting/swfupload.queue_wev8.js"></script>
<script type="text/javascript" src="/js/meeting/fileprogress_wev8.js"></script>
<script type="text/javascript" src="/js/meeting/handlers_wev8.js"></script>
...
function getUploader(indexid,maxsize,mainId,subId,secId,uploadLimit,uploadType){
	...
	try{  
		...
		var settings = {
			...
			upload_url: "/meeting/uploaderOperate.jsp",

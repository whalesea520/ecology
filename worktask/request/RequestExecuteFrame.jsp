...
<script>
   	   ...
   	   function resetbanner(objid, typeid){
			...
			//动态查询
			var href="RequestExecuteList.jsp?wtid="+wtid+"&worktaskStatus="+worktaskStatus+"&type_d=<%=type_d%>&objId=<%=objId%>";
   ...
   <input name='worktaskStatus'  type='hidden'  value='<%=worktaskStatus%>'>
	...
	<div class="e8_box demo2" id="rightContent">
		...
		<script type="text/javascript">
			...
			var src="RequestExecuteList.jsp?wtid=<%=wtid%>&worktaskStatus=<%=worktaskStatus%>&type_d=<%=type_d%>&objId=<%=objId%>&years=<%=years%>&months=<%=months%>&quarters=<%=quarters%>&weeks=<%=weeks%>";;
			...
			function resetDateitem(){
			    ...
			    alert(doc.find("input[name='years']").length);
			}
			//按时间索引
            function  searchDataByTime(){
			  ...
			  var worktaskStatus=$("select[name='worktaskStatus']").val();
			   ...
			   var href="RequestExecuteList.jsp?type_d="+type_d+"&objId="+objId+"&wtid="+wtid+"&worktaskStatus="+worktaskStatus+"&years="+year;
			...
			$(document).ready(function(){
			  ...
			  $(".tab_menu").find("a").click(function(e){
					 ...
					 var wtid=$("select[name='wtid']").val();
					 var worktaskStatus=$("select[name='worktaskStatus']").val();
					 var newhref="RequestExecuteList.jsp?type_d="+type_d+"&objId="+objId+"&wtid="+wtid+"&worktaskStatus="+worktaskStatus+"&"+currentitem.attr("dateparam");
					 ...
					 if(datetype==='day'){
						 var href="RequestExecuteList.jsp?type_d="+type_d+"&objId="+objId+"&wtid="+wtid+"&worktaskStatus="+worktaskStatus;
						 var cdate=new Date();

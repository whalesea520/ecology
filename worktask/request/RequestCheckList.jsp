...
String operateString= "<operates width=\"15%\">";
		...
		operateString+="     <operate   href=\"javascript:doCheck();\"  text=\""+SystemEnv.getHtmlLabelName(15357,user.getLanguage())+"\"   index=\"0\"/>";
						   ...
						   <wea:item>
							...
							<%
							   if((htmltype.equals("1")&& type.equals("1"))||htmltype.equals("2")){		//文本输入框
										...
										oneQueryStr.append("<input type=\"text\" class=InputStyle style='vertical-align:middle' size=\"12\" name=\"con"+id+"_value\" onfocus=\"changelevel('"+tmpcount+"')\" >\n");
										...
										oneQueryStr.append("</select>\n");
										oneQueryStr.append("<input type=text class=\"InputStyle\" style='vertical-align:middle' style='vertical-align:middle' size=\"10\" name=\"con"+id+"_value\" onblur=\"checknumber('con"+id+"_value')\" onfocus=\"changelevel('"+tmpcount+"')\" >\n");
										...
										oneQueryStr.append("<option value=\"6\" >"+SystemEnv.getHtmlLabelName(15506, languageID)+"</option>\n");
										oneQueryStr.append("</select>\n");
										oneQueryStr.append("<input type=\"text\" class=\"InputStyle\" style='vertical-align:middle' size=\"10\" name=\"con"+id+"_value1\" onblur=\"checknumber('con"+id+"_value1')\" onfocus=\"changelevel('"+tmpcount+"')\" >\n");
							  ...
							  <%
								...
								<%		
										...
										oneQueryStr.append("<option value=\"6\" >"+SystemEnv.getHtmlLabelName(15506, languageID)+"</option>\n");
										oneQueryStr.append("</select>\n");
										oneQueryStr.append("<input type=\"text\" class=\"InputStyle\" style='vertical-align:middle' size=\"10\" name=\"con"+id+"_value\" onfocus=\"changelevel('"+tmpcount+"')\" >\n");
										oneQueryStr.append("<select class=\"inputstyle\" name=\"con"+id+"_opt1\" style=\"width:20%\" onfocus=\"changelevel('"+tmpcount+"')\" >\n");
										oneQueryStr.append("<option value=\"1\" >"+SystemEnv.getHtmlLabelName(15508, languageID)+"</option>\n");
										oneQueryStr.append("<option value=\"2\" >"+SystemEnv.getHtmlLabelName(325, languageID)+"</option>\n");
										oneQueryStr.append("<option value=\"3\" >"+SystemEnv.getHtmlLabelName(15509, languageID)+"</option>\n");
										...
										oneQueryStr.append("<option value=\"6\" >"+SystemEnv.getHtmlLabelName(15506, languageID)+"</option>\n");
										oneQueryStr.append("</select>\n");
										oneQueryStr.append("<input type=\"text\" class=\"InputStyle\" style='vertical-align:middle' size=\"10\" name=\"con"+id+"_value1\" onfocus=\"changelevel('"+tmpcount+"')\" >\n");
								...
								<%
									...
									oneQueryStr.append("<option value=\"6\" >"+SystemEnv.getHtmlLabelName(15506, languageID)+"</option>\n");
									oneQueryStr.append("</select>\n");
									oneQueryStr.append("<button  type='button' class=\"Browser\" onfocus=\"changelevel('"+tmpcount+"')\" ");
									if(stype.equals("2")){
...
//-->
     ...
     function doCheck(requestid){
	   ...
	   openFullWindowHaveBar("CheckWorktask.jsp?operatorid="+opid+"");	 
	 }

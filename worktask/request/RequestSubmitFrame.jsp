...
if(wtid > 0 && isNewWindow == 1){
	//out.println("<script>openFullWindowForXtable(\"/worktask/request/AddworktaskFrame.jsp?wtid="+wtid+"\");</script>");
	out.println("<script>window.showModalDialog(\"/worktask/request/AddWorktaskFrame.jsp?wtid="+wtid+"\", window);</script>");
}
%>
...
<script>
   	   ...
   	   function resetbanner(objid, typeid){
			...
			//动态查询
			var href="RequestSubmitList.jsp?wtid="+wtid+"&worktaskStatus="+worktaskStatus+"&type_d=<%=type_d%>&objId=<%=objId%>";
   ...
   <input name='worktaskStatus'  type='hidden'  value='<%=worktaskStatus%>'>
	...
	<div class="e8_box demo2" id="rightContent">
		...
		<script type="text/javascript">
			...
			var src="RequestSubmitList.jsp?type_d=<%=type_d%>&objId=<%=objId%>&wtid=<%=wtid%>&worktaskStatus=<%=worktaskStatus%>";
            ...
            function  searchDataByTime(){
			  ...
			  var worktaskStatus=$("select[name='worktaskStatus']").val();
			   ...
			   var href="RequestSubmitList.jsp?type_d="+type_d+"&objId="+objId+"&wtid="+wtid+"&worktaskStatus="+worktaskStatus+"&years="+year;
			...
			$(document).ready(function(){
			  ...
			  $(".tab_menu").find("a").click(function(e){
					 ...
					 var wtid=$("select[name='wtid']").val();
					 var worktaskStatus=$("select[name='worktaskStatus']").val();
					 var newhref="RequestSubmitList.jsp?type_d="+type_d+"&objId="+objId+"&wtid="+wtid+"&worktaskStatus="+worktaskStatus+"&"+currentitem.attr("dateparam");
					 ...
					 if(datetype==='day'){
						 var href="RequestSubmitList.jsp?type_d="+type_d+"&objId="+objId+"&wtid="+wtid+"&worktaskStatus="+worktaskStatus;
						 var cdate=new Date();

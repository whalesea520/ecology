...
int worktaskStatus = Util.getIntValue(request.getParameter("worktaskStatus"), 2);//默认为待审批
...
<script>
   	   ...
   	   function resetbanner(objid, typeid){
			...
			//动态查询
			var href="RequestApproveList.jsp?wtid="+wtid+"&worktaskStatus="+worktaskStatus+"&type_d=<%=type_d%>&objId=<%=objId%>";
   ...
   <input name='worktaskStatus'  type='hidden'  value='<%=worktaskStatus%>'>
	...
	<div class="e8_box demo2" id="rightContent">
		...
		<script type="text/javascript">
			...
			var src="RequestApproveList.jsp?wtid=<%=wtid%>&worktaskStatus=<%=worktaskStatus%>&type=<%=type%>&type_d=<%=type_d%>&objId=<%=objId%>&isfromleft=<%=isfromleft%>";
            ...
            function  searchDataByTime(){
			  ...
			  var worktaskStatus=$("select[name='worktaskStatus']").val();
			   ...
			   var href="RequestApproveList.jsp?type_d="+type_d+"&objId="+objId+"&wtid="+wtid+"&worktaskStatus="+worktaskStatus+"&years="+year;
			...
			$(document).ready(function(){
			  ...
			  $(".tab_menu").find("a").click(function(){
					 ...
					 var wtid=$("select[name='wtid']").val();
					 var worktaskStatus=$("select[name='worktaskStatus']").val();
					 var newhref="RequestApproveList.jsp?type_d="+type_d+"&objId="+objId+"&wtid="+wtid+"&worktaskStatus="+worktaskStatus+"&"+currentitem.attr("dateparam");
					 ...
					 if(datetype==='day'){
						 ...
						 var href="RequestApproveList.jsp?type_d="+type_d+"&objId="+objId+"&wtid="+wtid+"&worktaskStatus="+worktaskStatus;
						 var cdate=new Date();

...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value='<%=SystemEnv.getHtmlLabelName(82,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(22183,user.getLanguage()) %>'/>
</jsp:include>
		...
		<%
		 ...
		 <wea:item>
	       ...
	       <wea:item attributes="{'samePair':\"sectr\"}">
			...
			<wea:item  attributes="{'samePair':\"objtr\"}">
					<INPUT type="text" id="times" name="times" style="width:80px" size=5 maxlength="4" class=inputStyle value=""  onChange="inputint('times')">

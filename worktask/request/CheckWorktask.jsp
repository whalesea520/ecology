...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value='<%=SystemEnv.getHtmlLabelName(15357,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(16539,user.getLanguage()) %>'/>
</jsp:include>
					...
					if(needcheck == 1){
						...
						for(int i=0; i<idList.size(); i++){
							...
							if(!"3".equals(fieldhtmltype_tmp) || ("3".equals(fieldhtmltype_tmp) && (fieldtype==2 || fieldtype==19))){//非浏览框,除日期浏览框
								sHtml = wtRequestManager.getFieldCellWithValueExecute(textheight_tmp,fieldid_tmp, fieldname_tmp, fieldlen_tmp, 
										crmname_tmp, fieldhtmltype_tmp, type_tmp, isedit_tmp, ismand_tmp, value_tmp, operatorid);
							}

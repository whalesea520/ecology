...
if("true".equals(hasCanCreateTasks)){
	out.println("<script>openFullWindowHaveBarTmp(\"/worktask/request/AddWorktaskTemplate.jsp?wtid="+wtid+"\");window.parent.close();</script>");
	return;
}
%>
<HTML>
...
function doChangeWorktask(obj){
	...
	if(document.taskform.selectWorktask.value != "0"){
		...
		openFullWindowHaveBarTmp("/worktask/request/AddWorktaskTemplate.jsp?wtid="+wtid);

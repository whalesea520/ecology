...
$(function(){
    $('.e8_box').Tabs({
        ...
        staticOnLoad:true,
        objName:"<%=SystemEnv.getHtmlLabelName(21928, user.getLanguage()) %>"
...
<body scroll="no">
	...
	<div class="e8_boxhead">
		...
		<ul class="tab_menu" >
			<li class="current">
				<a href="" urs='/worktask/base/worktaskFieldEdit.jsp' target="tabcontentframe"><%=SystemEnv.getHtmlLabelName(16510, user.getLanguage()) %></a>
			</li>
			
			<!--<li style="display:none">
				<a href="" urs='/worktask/base/worktaskListEdit.jsp' target="tabcontentframe"><%=SystemEnv.getHtmlLabelName(21929, user.getLanguage()) %></a>
			</li>-->
			<li class="">
					<a href="" urs='/worktask/base/worktaskMonitorSet.jsp' target="tabcontentframe"><%=SystemEnv.getHtmlLabelName(17989, user.getLanguage()) %></a>
			</li>

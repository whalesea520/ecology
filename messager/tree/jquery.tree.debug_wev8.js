...
(function($) {
				...
				if(this.settings.ui.theme_name !== false) {
					if(this.settings.ui.theme_path === false) {
						$("script").each(function () { 
							if(this.src.toString().match(/jquery\.tree.*?js$/)) { _this.settings.ui.theme_path = this.src.toString().replace(/jquery\.tree.*?js$/, "") + "themes/" + _this.settings.ui.theme_name + "/style_wev8.css"; return false; }
						});
					}
	...
	$(function () {
		...
		tree_component_wev8.css = tree_component.add_sheet({ str : css });
	});
})(jQuery);

...
<HTML>
    ...
    <BODY>
        ...
        <div id="subSearchContent" style="width:99%;">
            <div style="width:100%;height:34px;border-bottom:1px #ECECEC solid;margin-bottom:10px;">
                ...
                <div id="maintitle" class="maintitle"><%=currYear %>年第<%=currMonth %>月考核分数段统计报表</div>
            </div>
        </div>
        <!-- 按分部查询条件 end -->
        <!-- 按人员查询条件 -->
        <div id="workerSearchContent" style="width:99%;display:none;">
            <div style="width:100%;height:34px;border-bottom:1px #ECECEC solid;margin-bottom:10px;">
                ...
                <div id="workerMaintitle" class="maintitle"><%=currYear %>年考核分数段统计报表</div>
            </div>
        ...
        <div id="subConpanyCont">
            <jsp:include page="SCSubCpyReport.jsp">
    ...
    <script type="text/javascript">
        ...
        function searchOrg(){
            ...
            $("#subConpanyCont").html("");
            $("body").showLoading();
            $("#subConpanyCont").load("SCSubCpyReport.jsp",{
                "year":year,
                "month":month,
                "week":week,
                "type":type
        ...
        function loadSubDept(subCpyId){
            ...
            if(isOpened == "no"){
                ...
                $("body").showLoading();
                newTr.load("SCSearchSubDept.jsp",{
                    "year":year,
                    "month":month,
                    "week":week,
                    "type":type,
        ...
        function searchWorker(){
            ...
            $("#workerCont").html("");
            $("body").showLoading();
            $("#workerCont").load("SCWorkerReport.jsp",{
                "year":year,
                "type":type,
                "hrmids":hrmids,
       ...
       //年添加点击事件
        ...
        function setMonthInfo(){
            $("#maintitle").html($("#year").val()+"年第"+$("#month").val()+"月考核分数段统计报表");
        }
        /**
         * 按人员查询设置周展示信息
         */
        function setWorkerMonthInfo(){
            $("#workerMaintitle").html($("#workerYear").val()+"年考核分数段统计报表");
        }
        /**
         * 通过周找到周的日期
         */
        ...
        function getDatas(){
            var datas = new Array();
            var colnum = $("#listTable thead td").size()-1;
        ...
        function getCategories(){
            var datas = new Array();
            var checkboxes = $("#listTable thead td").each(function(index){
                if(index==0){
                    return true;
                }
                datas[index-1] = $(this).text();
            });
            return datas;
        }
        /**

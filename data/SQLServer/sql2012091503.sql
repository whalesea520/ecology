ALTER procedure HrmEditRightPath_SeByURId @userid int,@rightstr varchar(100),@level int, @flag integer output , @msg varchar(80) output AS
...
insert @temptree1
select a.subcompanyid,a.rightlevel from (select subcompanyid,max(rightlevel) as rightlevel

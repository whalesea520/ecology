...
GO
insert into SystemRightsLanguage (id,languageid,rightname,rightdesc) values (1836,10,'Поток настройки коммутатора','Поток настройки коммутатора') 
GO
...
insert into SystemRightDetail (id,rightdetailname,rightdetail,rightid) values (43066,'流程交换设置','WFEC:SETTING',1836) 
GO

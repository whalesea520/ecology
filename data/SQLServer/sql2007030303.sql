...
if
(
	@departmentid_1 is not null and @olddepartmentid_1 is not null and 
	(
...
ALTER COLUMN userId varchar(1600)
GO

ALTER TABLE WorkPlanShare
ALTER COLUMN deptId varchar(1600)
GO

ALTER TABLE WorkPlanShare
ALTER COLUMN roleId varchar(1600)
GO

ALTER TABLE WorkPlanShare
ALTER COLUMN subCompanyId varchar(1600)
GO

UPDATE WorkPlanShare SET userId = ',' + userId + ','
WHERE userId <> '0' AND userId IS NOT null
GO

UPDATE WorkPlanShare SET deptId = ',' + deptId + ','
WHERE deptId <> '0' AND deptId IS NOT null
GO

UPDATE WorkPlanShare SET subCompanyId = ',' + subCompanyId + ','
...
(
	@workPlanId_1 int, 
	@shareType_1 char(1), 
	@userId_1 varchar(1600),
	@subCompanyID_1 varchar(1600),
	@deptId_1 varchar(1600),
	@roleId_1 varchar(1600),
	@forAll_1 char(1), 
	@roleLevel_1 char(1), 

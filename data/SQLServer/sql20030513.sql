...
CREATE PROCEDURE CRM_T_ShareInfo_SbyRelateid 
(@relateditemid int , 
@flag integer output , @msg varchar(80) output )
AS
select * from CRM_T_ShareInfo where ( relateditemid = @relateditemid ) order by sharetype 
GO

CREATE PROCEDURE CRM_T_ShareInfo_Delete 
(@id int, @flag integer output, @msg varchar(80) output )
AS
DELETE from CRM_T_ShareInfo  WHERE ( id = @id)
GO


CREATE PROCEDURE CRM_T_ShareInfo_Insert
(@relateditemid int, 
@sharetype tinyint,
@seclevel  tinyint,
@rolelevel tinyint,
...
VALUES
( @relateditemid , @sharetype , @seclevel , @rolelevel , @sharelevel, @userid, @departmentid, @roleid, @foralluser  ) set @flag=1 set @msg='ok'
GO


CREATE PROCEDURE CRM_T_ShareInfo_SID
(@id int , @flag integer output , @msg varchar(80) output )
AS 
select * from CRM_T_ShareInfo where (id = @id ) 
GO


CREATE PROCEDURE CRM_ShareInfo_Update
(
@typeid_1 int , 
@customerid_1 int,
@flag integer output ,
...
declare @theid_1 int,
	...
	select id from CRM_T_ShareInfo WHERE relateditemid = @typeid_1
	OPEN @all_cursor FETCH NEXT FROM @all_cursor INTO @theid_1  
	WHILE @@FETCH_STATUS = 0 
		begin 
			
			select   @sharetype_1 =sharetype, @seclevel_1 =seclevel ,
			@rolelevel_1= rolelevel, @sharelevel_1 =sharelevel,@userid_1 =userid,@departmentid_1 =departmentid,
			@roleid_1 =roleid,@foralluser_1 =foralluser,@crmid_1 =crmid from CRM_T_ShareInfo WHERE id = @theid_1
			...
			FETCH NEXT FROM @all_cursor INTO @theid_1 
		end 
...
CREATE PROCEDURE Prj_T_ShareInfo_SbyRelateid 
(@relateditemid int , 
@flag integer output , @msg varchar(80) output )
AS
...
CREATE PROCEDURE Prj_T_ShareInfo_Delete 
(@id int, @flag integer output, @msg varchar(80) output )
AS
DELETE from Prj_T_ShareInfo  WHERE ( id = @id)
GO
...
CREATE PROCEDURE Prj_T_ShareInfo_SID
(@id int , @flag integer output , @msg varchar(80) output )
AS 
select * from Prj_T_ShareInfo where (id = @id ) 
GO	 
...
declare @theid_1 int,
	...
	WHILE @@FETCH_STATUS = 0 
		begin 
			...
			select   @sharetype_1 =sharetype, @seclevel_1 =seclevel ,
			@rolelevel_1= rolelevel, @sharelevel_1 =sharelevel,@userid_1 =userid,@departmentid_1 =departmentid,
			@roleid_1 =roleid,@foralluser_1 =foralluser,@crmid_1 =crmid from Prj_T_ShareInfo WHERE id = @theid_1
			insert INTO  Prj_ShareInfo (relateditemid ,	sharetype  ,seclevel ,rolelevel  ,sharelevel,userid
			,departmentid ,	roleid,	foralluser ,crmid ) 			values(@prjid_1,@sharetype_1,@seclevel_1,@rolelevel_1,@sharelevel_1,@userid_1,@departmentid_1,			@roleid_1,@foralluser_1,@crmid_1) 
			FETCH NEXT FROM @all_cursor INTO @theid_1 
		end 
	CLOSE @all_cursor DEALLOCATE @all_cursor 
go
...
CREATE TABLE Bill_crmcontract (
	...
	contractid int NULL ,
	typeid int NULL ,
	docids varchar(255) NULL,
	price decimal(10, 2) NULL ,
	startdate  char(10) NULL,
	enddate  char(10) NULL,
	crmid	int NULL ,
	prjid	int NULL ,
	approvids  varchar (255) NULL,
	requestid  int
) 
GO

ALTER PROCEDURE CRM_ContractProduct_DelAll
	(@contractId_1 	[int] ,
	 @IdStr_1 	[varchar](255) ,	
	 @flag	[int]	output, 
	 @msg	[varchar](80)	output)
...
ALTER PROCEDURE CRM_ContractPayMethod_DelAll
	(@contractId_1 	[int] ,
	 @IdStr_1 	[varchar](255) ,	
	 @flag	[int]	output, 
	 @msg	[varchar](80)	output)
...
ALTER PROCEDURE CRM_ContractProduct_Select
	(@contractId_1 [int] ,
	 @flag	[int]	output, 
	 @msg	[varchar](80)	output)
...
ALTER PROCEDURE CRM_ContractPayMethod_Select
	(@contractId_1 [int] ,
	 @flag	[int]	output, 
	 @msg	[varchar](80)	output)
...
/* 工作流浏览框 */
INSERT INTO workflow_browserurl (labelid,fielddbtype,browserurl,tablename,columname,keycolumname,linkurl) VALUES ( 6160,'int','/systeminfo/BrowserMain.jsp?url=/CRM/data/ContractBrowser.jsp?status=0','CRM_Contract','name','id','/CRM/data/ContractView.jsp?id=')
GO
INSERT INTO workflow_browserurl (labelid,fielddbtype,browserurl,tablename,columname,keycolumname,linkurl) VALUES ( 6083,'int','/systeminfo/BrowserMain.jsp?url=/CRM/data/ContractTypeBrowser.jsp','CRM_ContractType','name','id','/CRM/Maint/CRMContractTypeList.jsp?id=')
GO
INSERT INTO workflow_browserurl (labelid,fielddbtype,browserurl,tablename,columname,keycolumname,linkurl) VALUES ( 6163,'text','/systeminfo/BrowserMain.jsp?url=/docs/docs/MutiDocBrowser.jsp','DocDetail','docsubject','id','/docs/docs/DocDsp.jsp?isrequest=1&id=')
GO
...
GO
INSERT INTO workflow_billfield ( billid, fieldname, fieldlabel, fielddbtype, fieldhtmltype, type, dsporder, viewtype) VALUES (49,'resource_n',368,'int',3,1,1,0)
GO
INSERT INTO workflow_billfield ( billid, fieldname, fieldlabel, fielddbtype, fieldhtmltype, type, dsporder, viewtype) VALUES (49,'depid',6141,'int',3,4,2,0)
GO
INSERT INTO workflow_billfield ( billid, fieldname, fieldlabel, fielddbtype, fieldhtmltype, type, dsporder, viewtype) VALUES (49,'contractid',6161,'int',3,35,4,0)
GO
INSERT INTO workflow_billfield ( billid, fieldname, fieldlabel, fielddbtype, fieldhtmltype, type, dsporder, viewtype) VALUES (49,'typeid',6083,'int',3,36,5,0)
GO
INSERT INTO workflow_billfield ( billid, fieldname, fieldlabel, fielddbtype, fieldhtmltype, type, dsporder, viewtype) VALUES (49,'docids',6162,'varchar(255)',3,37,6,0)
GO
INSERT INTO workflow_billfield ( billid, fieldname, fieldlabel, fielddbtype, fieldhtmltype, type, dsporder, viewtype) VALUES (49,'price',6146,'decimal(10,2)',1,3,7,0)
GO
...
GO
INSERT INTO workflow_billfield ( billid, fieldname, fieldlabel, fielddbtype, fieldhtmltype, type, dsporder, viewtype) VALUES (49,'crmid',783,'int',3,7,10,0)
GO
INSERT INTO workflow_billfield ( billid, fieldname, fieldlabel, fielddbtype, fieldhtmltype, type, dsporder, viewtype) VALUES (49,'prjid',782,'int',3,8,11,0)
GO
INSERT INTO workflow_billfield ( billid, fieldname, fieldlabel, fielddbtype, fieldhtmltype, type, dsporder, viewtype) VALUES (49,'approvids',6164,'varchar(255)',3,17,3,0)
GO
...
itemid  int ,                           /*工资项目id*/
cityid  int ,                           /*城市id*/
personwelfarerate   int ,               /*个人费率id*/
companywelfarerate  int                /*公司费率*/
)
GO

create NONCLUSTERED INDEX HrmSalaryWelfarerate_in on HrmSalaryWelfarerate(itemid)
GO

create NONCLUSTERED INDEX HrmSalaryRank_in on HrmSalaryRank(itemid)
GO

create NONCLUSTERED INDEX HrmSalaryTaxbench_in on HrmSalaryTaxbench(itemid)
GO

create NONCLUSTERED INDEX HrmSalaryTaxrate_in on HrmSalaryTaxrate(benchid)
GO

CREATE PROCEDURE HrmSalaryWelfarerate_Insert
    (@itemid_1 	int,
     @cityid_2 	int,
     @personwelfarerate_3 	int,
     @companywelfarerate_4 	int,
     @flag          integer output, 
     @msg           varchar(80) output)
...
CREATE PROCEDURE HrmSalaryWelfarerate_Delete
	(@id_1 	int,
     @flag          integer output, 
     @msg           varchar(80) output)

AS DELETE HrmSalaryWelfarerate 

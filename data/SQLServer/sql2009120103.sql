alter table DocReceiveUnit add subcompanyid int
GO
...
alter table Workflow_DocProp add objId int default -1
GO
...
CREATE TABLE Workflow_SelectitemObj (
	...
	objId int null ,
	objType char(1) null ,
	docPath varchar(400) null ,
	docCategory varchar(400) null 
)
GO

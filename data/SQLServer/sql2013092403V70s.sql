create  procedure mode_pageexpand_historydata
as
...
begin
	...
	begin
		select @icount=count(*) from mode_pageexpand where modeid=@modeid and expendname='¥Ú”°'
		if @icount<1
			begin 
...
go
exec mode_pageexpand_historydata;
go
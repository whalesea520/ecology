...
CREATE TABLE workflow_browdef_fieldconf (
	...
	namelabel VARCHAR(100) NOT NULL,
	conditionfieldtype VARCHAR(100) NOT NULL,
	defaultshoworder VARCHAR(100) NOT NULL
)
GO
...
CREATE TABLE workflow_browdef_selitemconf (
	...
	showorder VARCHAR(100) NOT NULL,
	browsertype INT,
	singlebrowser CHAR(1),
	browserparams VARCHAR(500),
	defaultitem CHAR(1)
)
GO

...
CREATE PROCEDURE HrmRoleMembersShare(@resourceid_1 int, @roleid_1 int, @rolelevel_1 int, @rolelevel_2 int, @flag_1 int, @flag integer output, @msg varchar(80) output)  AS

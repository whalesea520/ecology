...
@tinyintfield4 tinyint, @tinyintfield5 tinyint, @bankName varchar(200), @accountName varchar(40), @accounts varchar(200), @crmCode varchar(100),
...
@accounts varchar(200), @crmCode varchar(100), @flag int output, @msg	varchar(80) output)  
AS 

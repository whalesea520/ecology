alter trigger Prj_ProjectInfo_getCrm ON Prj_ProjectInfo FOR INSERT,UPDATE AS DECLARE @relateditemid int ,@managerview int,@description char(4000),@crmid int, @all_cursor cursor 
begin 
...
begin
 ...
 begin
 if @crmid != '' and @crmid is not null
 begin
insert into Prj_ShareInfo (relateditemid,sharetype,crmid,sharelevel) values 
 (@relateditemid,9,@crmid,1) 
 end
	FETCH NEXT FROM @all_cursor INTO @crmid

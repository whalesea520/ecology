alter table hrmresource alter column serial varchar(20)
go

alter PROCEDURE HrmResourceSystemInfo_Insert (@id_1 int, @loginid_2 varchar(20), @password_3 varchar(60), @systemlanguage_4 int, @seclevel_5 int, @email_6 varchar(60) ,@needusb1 int,@serial1 varchar(20),@account_2 varchar(60),@lloginid_2 varchar(60),@needdynapass_2 int,@flag int output, @msg varchar(60) output) AS
   declare @count int

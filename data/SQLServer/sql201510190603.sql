...
@departmentid_1 varchar(4000),@subcompanyid_1 varchar(4000),@subcompanyidsub_1 varchar(4000), @departmentidsub_1 varchar(4000),@roleid_1 varchar(4000),@flag int output, @msg varchar(4000) output)  AS
declare @count_1 int
declare @result int
set @result = 0
if @usertype_1 = 0 begin
    set @count_1 = (select count(sourceid) from DirAccessControlDetail  where  sourceid = @dirid_1 and  sourcetype=@dirtype_1 and  sharelevel=@operationcode_1 and ((type=1 and includesub=0 and content in (select * from SplitStr(@departmentid_1,',')) and seclevel<=@seclevel_1 and seclevelmax>=@seclevel_1 ) or (type=1 and includesub=1 and content in (select * from SplitStr(@departmentidsub_1,',')) and seclevel<=@seclevel_1 and seclevelmax>=@seclevel_1 ) or (type=2 and  content in (select * from SplitStr(@roleid_1,',')) and seclevel<=@seclevel_1  and seclevelmax>=@seclevel_1 ) or (type=3 and seclevel<=@seclevel_1  and seclevelmax>=@seclevel_1 ) or (type=4 and content=@usertype_1 and seclevel<=@seclevel_1  and seclevelmax>=@seclevel_1 ) or (type=5 and content=@userid_1) or (type=6 and includesub=0 and content in (select * from SplitStr(@subcompanyid_1,',')) and seclevel<=@seclevel_1  and seclevelmax>=@seclevel_1 ) or (type=6 and includesub=1 and content in (select * from SplitStr(@subcompanyidsub_1,',')) and seclevel<=@seclevel_1  and seclevelmax>=@seclevel_1 ) ))
end
else begin
...
set @result = 0
if @usertype_1 = 0 begin
    set @count_1 = (select count(sourceid) from DirAccessControlDetail  where  sourceid = @dirid_1 and  sourcetype=@dirtype_1 and  sharelevel=@operationcode_1 and ((type=1 and includesub=0 and content in(select * from SplitStr(@departmentid_1,',')) and seclevel<=@seclevel_1  and seclevelmax>=@seclevel_1 ) or (type=1 and includesub=1 and content in(select * from SplitStr(@departmentidsub_1,',')) and seclevel<=@seclevel_1  and seclevelmax>=@seclevel_1 ) or (type=2 and  content in (select * from SplitStr(@roleid_1,',')) and seclevel<=@seclevel_1  and seclevelmax>=@seclevel_1 ) or (type=3 and seclevel<=@seclevel_1  and seclevelmax>=@seclevel_1 ) or (type=4 and content=@usertype_1 and seclevel<=@seclevel_1  and seclevelmax>=@seclevel_1 ) or (type=5 and content in(select * from SplitStr(@userid_1,','))) or (type=6 and includesub=0 and content in(select * from SplitStr(@subcompanyid_1,',')) and seclevel<=@seclevel_1  and seclevelmax>=@seclevel_1 )  or (type=6 and includesub=1 and content in(select * from SplitStr(@subcompanyidsub_1,',')) and seclevel<=@seclevel_1  and seclevelmax>=@seclevel_1 )))
end
else begin
    set @count_1 = (select count(mainid) from DirAccessControlList where dirid=@dirid_1 and dirtype=@dirtype_1 and operationcode=@operationcode_1 and ((permissiontype=3 and seclevel<=@seclevel_1  and seclevelmax>=@seclevel_1 ) or (permissiontype=4 and usertype=@usertype_1 and seclevel<=@seclevel_1  and seclevelmax>=@seclevel_1 )))
end
...
alter PROCEDURE Doc_DirAcl_CheckPermissionEx(@dirid_1 int, @dirtype_1 int, @userid_1 int, @usertype_1 int, @seclevel_1 int, @operationcode_1 int,@departmentid_1 varchar(4000),@subcompanyid_1 varchar(4000), @subcompanyidsub_1 varchar(4000), @departmentidsub_1 varchar(4000),@roleid_1 varchar(4000),@flag int output, @msg varchar(4000) output) AS 
declare @result_1 int
declare @mainid_1 int
execute Doc_DirAcl_CheckPermissionEx1 @dirid_1, @dirtype_1, @userid_1, @usertype_1, @seclevel_1, @operationcode_1,@departmentid_1,@subcompanyid_1,@subcompanyidsub_1,@departmentidsub_1,@roleid_1, @result_1 output, 1, 1
if @result_1 <> 1 begin
    ...
    if @dirtype_1 = 1 begin
       ...
       execute Doc_DirAcl_CheckPermissionEx1 @mainid_1, 0, @userid_1, @usertype_1, @seclevel_1, @operationcode_1,@departmentid_1,@subcompanyid_1,@subcompanyidsub_1,@departmentidsub_1,@roleid_1, @result_1 output, 1, 1
       if @result_1=1 begin
           set @fatherid_1 = -1
       end
    end
    ...
    while @fatherid_1 <> -1 begin
        execute Doc_DirAcl_CheckPermissionEx1 @fatherid_1, 1, @userid_1, @usertype_1, @seclevel_1, @operationcode_1,@departmentid_1,@subcompanyid_1,@subcompanyidsub_1,@departmentidsub_1,@roleid_1, @result_1 output, 1, 1
        if @result_1 <> 1 begin
...
@departmentid_1 varchar(4000),@subcompanyid_1 varchar(4000),@subcompanyidsub_1 varchar(4000), @departmentidsub_1 varchar(4000),  @roleid_1 varchar(4000), @haspermission_1 int output, @flag int output, @msg varchar(4000) output)  AS 
declare @count_1 int
declare @result int
set @result = 0
if @usertype_1 = 0 begin
...
if @result_1 <> 1 begin
    ...
    while @fatherid_1 <> -1 begin
        execute Doc_DirAcl_CheckPermissionEx1 @fatherid_1, 2, @userid_1, @usertype_1, @seclevel_1, @operationcode_1,@departmentid_1,@subcompanyid_1,@subcompanyidsub_1 , @departmentidsub_1 ,@roleid_1, @result_1 output, 1, 1
        if @result_1 <> 1 begin
...
begin
    set @detail_insert_cursor = cursor FORWARD_ONLY static for select mainid, dirid,dirtype,seclevel,seclevelmax,includesub,userid,subcompanyid,departmentid,usertype,roleid,rolelevel,operationcode,permissiontype,DocSecCategoryTemplateId from inserted
    OPEN @detail_insert_cursor 
    fetch next from @detail_insert_cursor INTO @id_1 , @dirid_1,@dirtype_1,@seclevel_1,@seclevelmax_1,@includesub_1,@userid_1,@subcompanyid_1,@departmentid_1,@usertype_1,@roleid_1,@rolelevel_1,@operationcode_1,@permissiontype_1,@docSecCategoryTemplateId_1
    while @@FETCH_STATUS = 0 
    begin 
        begin
            set	@srcfrom_1 = @id_1;

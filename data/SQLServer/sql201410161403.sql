...
updateTime,deleted,detailurl,parmtype,provparm,cityparm,datefromparm,datetoparm) VALUES ('客户分布统计', '客户数量(个)', '', 'select t2.provincename as province,count(t1.id) as amount from (#crmsql#) t1,HrmProvince t2,HrmCity t3

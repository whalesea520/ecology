alter table CRM_CustomerInfo alter column accountName varchar(40)
GO
...
@tinyintfield4 tinyint, @tinyintfield5 tinyint, @bankName varchar(20), @accountName varchar(40), @accounts varchar(20), @crmCode varchar(100),
...
@textfield1 varchar(100), @textfield2 varchar(100), @textfield3 varchar(100), @textfield4 varchar(100), 
@textfield5 varchar(100), @tinyintfield1 tinyint, @tinyintfield2 tinyint, @tinyintfield3 tinyint, 
@tinyintfield4 tinyint, @tinyintfield5 tinyint, @createdate varchar(10), @bankName varchar(20), @accountName varchar(40),

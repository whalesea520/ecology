ALTER TABLE CRM_CustomerInfo 
ADD bankName VARCHAR(20) NULL, accountName varchar(20) NULL, accounts varchar(20) NULL,crmcode VARCHAR(100) NULL
GO
INSERT INTO HtmlLabelIndex values(17085,'银行帐号') 
GO
INSERT INTO HtmlLabelInfo VALUES(17085,'银行帐号',7) 
GO
INSERT INTO HtmlLabelInfo VALUES(17085,'Accounts',8) 
GO
INSERT INTO HtmlLabelIndex values(17084,'开户银行') 
GO
INSERT INTO HtmlLabelInfo VALUES(17084,'开户银行',7) 
GO
INSERT INTO HtmlLabelInfo VALUES(17084,'Bank Name',8) 
go
CREATE PROCEDURE Sales_CRM_CreditInfo_Select (
@creditAmount varchar(20), @flag integer output , @msg varchar(80) output)
AS 
SELECT id FROM CRM_CreditInfo WHERE creditamount <= convert(money, @creditAmount) AND highamount >= convert(money, @creditAmount)
GO

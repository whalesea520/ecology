alter table DirAccessControlList
ADD subcompanyid int NULL
GO

CREATE PROCEDURE Doc_DirAcl_Insert_Type6(@dirid_1 int, @dirtype_1 int, @operationcode_1 int, @subcompanyid_1 int, @seclevel_1 int, @flag int output, @msg varchar(80) output)  AS
...
ALTER PROCEDURE Doc_DirAcl_GUserP_BasicChange(@userid_1 int, @departmentid_1 int, @subcompanyid_1 int, @seclevel_1 int)  AS
...
ALTER PROCEDURE Doc_DirAcl_GrantUserPermission(@userid_1 int, @flag int output, @msg varchar(80) output)  AS


declare @departmentid_1 int, @subcompanyid_1 int, @seclevel_1 int
declare user_cursor cursor for
select departmentid, subcompanyid1, seclevel from HrmResource where id = @userid_1
open user_cursor
...
ALTER PROCEDURE Doc_DirAcl_DUserPermission(@userid_1 int, @flag int output, @msg varchar(80) output)  AS
...
ALTER PROCEDURE Doc_DirAcl_DUserP_BasicChange(@userid_1 int, @departmentid_1 int, @subcompanyid_1 int, @seclevel_1 int)  AS

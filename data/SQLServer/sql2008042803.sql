...
GO
alter table workflow_base add annexdoccategory varchar(200)
GO
alter table workflow_RequestLog add annexdocids varchar(2000)
GO
...
@agentorbyagentid  int,@agenttype  char(1),@showorder int,@annexdocids varchar(2000), @flag integer output , @msg varchar(80) output
AS 

...
/*新闻中心 子菜单 BEGIN*/
CREATE PROCEDURE NewPageInfo_Insert_All(
    @flag	int	output, 
...
GO
/*报表设定 二级子菜单 模版设计*/
INSERT INTO MainMenuInfo (id,labelId,linkAddress,parentFrame,defaultParentId,defaultLevel,defaultIndex,needRightToVisible,needSwitchToVisible,relatedModuleId) VALUES(197,17496,'/datacenter/design/index.htm','mainFrame',188,2,5,0,0,8)
GO
...
/*初始化每个用户的主菜单配置信息*/
CREATE PROCEDURE MainMenuConfig_Insert_All
AS
DECLARE @id_1 int,
    ...
    WHILE @@FETCH_STATUS = 0
    BEGIN
        DECLARE mainMenuInfo_cursor_1 CURSOR FOR
        SELECT id,defaultParentId, defaultIndex, defaultLevel FROM MainMenuInfo
        
        OPEN mainMenuInfo_cursor_1
        FETCH NEXT FROM mainMenuInfo_cursor_1 INTO @id_1,@defaultParentId_1,@defaultIndex_1,@defaultLevel_1
        ...
        CLOSE mainMenuInfo_cursor_1
        DEALLOCATE mainMenuInfo_cursor_1

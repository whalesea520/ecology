...
declare childid_cursor cursor for   
 ...
 UNION ALL SELECT a.resourceid,a.managerid,a.virtualtype FROM hrmresourcevirtual a join hrmresource c on ( c.id=a.resourceid and c.status in (0,1,2,3) and c.loginid is not null and c.loginid<>'') ,allhrm b where a.resourceid = b.managerid  and a.virtualtype=b.virtualtype

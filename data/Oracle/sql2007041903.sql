...
update workflow_currentoperator set operatedate = currentdate,operatetime = currenttime where requestid = requestid_1 and userid = userid_2 and isremark='0' and groupid = groupid_1;

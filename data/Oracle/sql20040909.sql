...
alter table CRM_CustomerInfo add bankName varchar2(20)
/

alter table CRM_CustomerInfo add accountName varchar2(20)
/

alter table CRM_CustomerInfo add accounts varchar2(20)
/

alter table CRM_CustomerInfo add crmCode varchar2(100)
/

...
ALTER TABLE cowork_label   ADD isUsed integer null
/

ALTER TABLE cowork_label   ADD labelOrder integer null
/

ALTER TABLE cowork_label   ADD labelType varchar2(100) null
/

ALTER TABLE cowork_label RENAME  COLUMN icon TO labelColor
/
...
VALUES
  ( name_1,
   ...
   mutil_prjs_19,
   lastdiscussant_20);
select max(id) into flag from cowork_items;
end;
/

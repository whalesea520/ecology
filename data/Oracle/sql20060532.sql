...
values(requestid1,userid1,groupid1, workflowid1,workflowtype2,usertype1,isremark1,nodeid,agentorbyagentid,agenttype,showorder,receivedate,receivetime,0,0,1,groupdetailid_1,isremark1); 
else
...
values(requestid1,userid1,groupid1, workflowid1,workflowtype1,usertype1,isremark1,nodeid,agentorbyagentid,agenttype,showorder,receivedate,receivetime,0,0,1,groupdetailid_1,isremark1); 
end if ;
...
begin
  ...
  Update workflow_requestbase set requestlevel=1 where requestid=requestid1;
  else

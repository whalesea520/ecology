...
begin
    ...
    if mcount>0 then
      ...
      ,operatetime
      ,nodetype
  FROM workflow_currentoperator,workflow_flownode  where workflow_currentoperator.nodeid=workflow_flownode.nodeid and requestid = requestid_1) a,workflow_nodebase b
	     where a.nodeid=b.id
      ...
      ,operatetime
      ,nodetype
  FROM workflow_currentoperator,workflow_flownode  where workflow_currentoperator.nodeid=workflow_flownode.nodeid and requestid = requestid_1) a,workflow_flownode b

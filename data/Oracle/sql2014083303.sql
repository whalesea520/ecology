CREATE TABLE synergy_base(
	id int NOT NULL,
	frommodule varchar2(50) NOT NULL,
	frompage varchar2(200) NULL,
	wftype int NULL,
	wfid int NULL,
	supid int NULL,
	modulename int NOT NULL,
	orderkey int NULL,
	styleid varchar2(50) NULL,
	layoutid int NULL,
	subcompanyid int NULL,
	haslayout int NULL,
	showtree int NULL,
	frompagepara varchar2(200) NULL,
	samepageid int NULL
)
/
CREATE TABLE synergy_params(
	id int NOT NULL,
	paramname varchar2(50) NULL,
	paramlabelid int NULL,
	elementbaseid varchar2(50) NULL,
	synergybaseid int NULL,
	wfid int NULL,
	ftype int NULL,
	browserid varchar2(200) NULL
)
/
create sequence synergy_params_id
start with 1
increment by 1
nomaxvalue
nocycle
/
create or replace trigger synergy_params_id_trigger
before insert on synergy_params
for each row 
begin
select synergy_params_id.nextval into :new.id from dual;
end;
/
CREATE TABLE sypara_expressionbase(
	...
	valueName varchar2(1000) NULL,
	valueVariableid int NULL,
	systemParam varchar2(255) NULL
) 
/
...
CREATE TABLE sypara_expressions(
	...
	eid int NOT NULL,
	relation int NULL,
	expids varchar2(500) NULL,
	expbaseid varchar2(500) NULL
)
/

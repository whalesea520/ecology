...
tabletype integer NULL,
modetype integer NULL,
memo varchar(200) NULL
)
/
create sequence Sys_tabledict_Id
	start with 1
	increment by 1
	nomaxvalue
	nocycle
/
CREATE OR REPLACE TRIGGER Sys_tabledict_Id_Trigger
	before insert on Sys_tabledict
	for each row
	begin
	select Sys_tabledict_Id.nextval into :new.id from dual;
	end;
/

create table Sys_fielddict
(
tabledictid integer NOT NULL,
...
/
insert into Sys_fielddict(tabledictid,fieldname,fielddesc,fielddescen,fielddbtype,fieldhtmltype,type,dsporder) values(15,'maincate/ry','文档主目录','main cate/ry','int',1,2,1)
/
insert into Sys_fielddict(tabledictid,fieldname,fielddesc,fielddescen,fielddbtype,fieldhtmltype,type,dsporder) values(15,'subcate/ry','文档分目录','subcate/ry','int',1,2,2)
/
insert into Sys_fielddict(tabledictid,fieldname,fielddesc,fielddescen,fielddbtype,fieldhtmltype,type,dsporder) values(15,'seccate/ry','文档子目录','subdirectory','int',1,2,3)
/
...
insert into Sys_tabledict(tablename,tabledesc,tabledescen,tabletype,modetype,memo) values('DocMainCate/ry','文档主目录信息表','document main cate/ry information',0,2,'文档主目录信息表')
/
insert into Sys_fielddict(tabledictid,fieldname,fielddesc,fielddescen,fielddbtype,fieldhtmltype,type,dsporder) values(16,'cate/ryname','文档主目录描述','name of main cate/ry','varchar(200)',1,1,1)
/
insert into Sys_fielddict(tabledictid,fieldname,fielddesc,fielddescen,fielddbtype,fieldhtmltype,type,dsporder) values(16,'coder','文档主目录编码','code of main cate/ry','varchar(20)',1,1,2)
/

insert into Sys_tabledict(tablename,tabledesc,tabledescen,tabletype,modetype,memo) values('DocSubCate/ry','文档分目录信息表','document sub cate/ry information',0,2,'文档分目录信息表')
/
insert into Sys_fielddict(tabledictid,fieldname,fielddesc,fielddescen,fielddbtype,fieldhtmltype,type,dsporder) values(17,'maincate/ryid','文档主目录','main cate/ry','int',1,2,1)
/
insert into Sys_fielddict(tabledictid,fieldname,fielddesc,fielddescen,fielddbtype,fieldhtmltype,type,dsporder) values(17,'cate/ryname','文档分目录描述','name of subcate/ry','varchar(200)',1,1,2)
/
...
insert into Sys_tabledict(tablename,tabledesc,tabledescen,tabletype,modetype,memo) values('DocSecCate/ry','文档子目录信息表','document subdirectory information',0,2,'文档子目录信息表')
/
insert into Sys_fielddict(tabledictid,fieldname,fielddesc,fielddescen,fielddbtype,fieldhtmltype,type,dsporder) values(18,'cate/ryname','文档子目录描述','name of subdirectory','varchar(200)',1,1,1)
/

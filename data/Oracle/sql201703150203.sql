ALTER TABLE DocSecCategoryTemplate ADD pushOperation number(2) DEFAULT 0
/
ALTER TABLE DocSecCategory ADD pushOperation number(2) DEFAULT 0
/
ALTER TABLE DocSecCategoryTemplate ADD pushways varchar2(200) DEFAULT '0,0,0,0'
/
ALTER TABLE DocSecCategory ADD pushways varchar2(200) DEFAULT '0,0,0,0'
/
...
( 
  ...
  maxUploadFileSize_41 integer,
    ...
    pushOperation_53 integer,
    pushways_54 varchar2,
  flag  out integer,
  msg out varchar2, 
...
begin 
  ...
  maxUploadFileSize=maxUploadFileSize_41,
    ...
    pushOperation    = pushOperation_53,
    pushways = pushways_54
  where id= id_1;
end;
/
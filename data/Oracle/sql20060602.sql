...
/
update HtmlLabelInfo set labelname='News Pages'  where indexid = 17559 and languageid = 8
/
update HtmlLabelInfo set labelname='Plan Pages'  where indexid = 17560 and languageid = 8
/

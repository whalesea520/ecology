...
update hrmresource a 
set pinyinlastname=lower(getpinyin(lastname)), a.ecology_pinyin_search=lower(getpinyin(lastname)) 
/ 
update hrmsubcompany company 
set company.ecology_pinyin_search=lower(getpinyin(company.subcompanyname)) 
/ 
update hrmdepartment department 
set department.ecology_pinyin_search=lower(getpinyin(department.departmentname)) 
/ 
update hrmjobtitles jobtitle 
set jobtitle.ecology_pinyin_search=lower(getpinyin(jobtitle.jobtitlename)) 
/
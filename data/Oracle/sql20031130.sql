/*  对于合同共享的时候选择了人力资源表更改为选择人力资源trigger 表  */
...
update HrmRoleMembers set rolelevel=level_1 where roleid = roleid_1 and resourceid = employeeid_1;
open thecursor for
...
CREATE TABLE HrmRoleMembers_Tri (
	roleid integer NULL ,
...
delete HrmRoleMembers_Tri 
/

insert into HrmRoleMembers_Tri(roleid,resourceid,rolelevel) select roleid,resourceid,rolelevel from HrmRoleMembers
/

CREATE or replace PROCEDURE HrmRoleMembers_Tri_In
(employeeid_1 integer, 
roleid_1 integer, 
level_1 integer, 
flag out integer,
...
select  count(id) into count_01 from HrmRoleMembers where roleid = roleid_1 and resourceid = employeeid_1;
if count_01>0 then
insert into HrmRoleMembers_Tri(roleid,resourceid,rolelevel) values(roleid_1,employeeid_1,level_1);
else
update HrmRoleMembers_Tri set rolelevel=level_1 where roleid = roleid_1 and resourceid = employeeid_1;
end if ;
end;
/


CREATE or REPLACE PROCEDURE HrmRoleMembers_Tri_Up
 ( employeeid_1 integer, 
  roleid_1 integer,  
 rolelevel_2 	char, 
 flag out integer, 
...
as 
begin 
 update HrmRoleMembers_Tri set rolelevel=rolelevel_2 where roleid = roleid_1 and resourceid = employeeid_1;
 end;
/

CREATE or REPLACE PROCEDURE HrmRoleMembers_Tri_De
 ( employeeid_1 integer, 
  roleid_1 integer,  
 flag out integer, 
 msg out varchar2, 
...
as 
begin 
 delete HrmRoleMembers_Tri where roleid = roleid_1 and resourceid = employeeid_1;
 end;
/

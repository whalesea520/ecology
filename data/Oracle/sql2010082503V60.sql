...
if((flag_1 = 1 and (departmentid_1<>olddepartmentid_1 or oldsubcompanyid_1<>subcompanyid_1 or seclevel_1<>oldseclevel_1) ) or flag_1 = 0) then
    ...
    /* 修改目录许可表 */
    if (flag_1 = 1 and ((olddepartmentid_1 <> departmentid_1) or (oldseclevel_1 <> seclevel_1) or (oldsubcompanyid_1<>subcompanyid_1))) then
        Doc_DirAcl_DUserP_BasicChange (resourceid_1, olddepartmentid_1, oldsubcompanyid_1, oldseclevel_1);
    end if;
    if ((flag_1 = 0) or (olddepartmentid_1 <> departmentid_1) or (oldseclevel_1 <> seclevel_1) or (oldsubcompanyid_1<>subcompanyid_1)) then

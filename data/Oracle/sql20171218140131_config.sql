...
/
call updateconfigFileManager('1','2','1','action.xml','\WEB-INF\service\action.xml','跨版本升级至E8后标准action.xml配置','20000','8.100.0531','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('2','2','1','web.xml','\WEB-INF\web.xml','跨版本升级至E8后标准web.xml配置','10000','8.100.0531','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('3','2','1','action.xml','\WEB-INF\service\action.xml','E8--KB81001507补丁包 action.xml配置','20001','KB81001507','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('4','2','1','web.xml','\WEB-INF\web.xml','E8: 基础版本--KB81001509补丁包web.xml配置','10001','KB81001509','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('5','2','1','web.xml','\WEB-INF\web.xml','E8: KB81001509--KB81001510补丁包web.xml配置','10002','KB81001510','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('6','2','1','web.xml','\WEB-INF\web.xml','E8: 	KB81001510--KB81001511补丁包web.xml配置','10003','KB81001511','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('8','2','1','action.xml','\WEB-INF\service\action.xml','E8: KB81001507-KB81001508标准action.xml配置','20003','KB81001508','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('9','2','1','web.xml','\WEB-INF\web.xml','E8: KB81001512--KB81001603补丁包web.xml配置','10005','KB81001603','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('10','2','1','web.xml','\WEB-INF\web.xml','E8: KB81001603--KB81001606补丁包web.xml配置','10006','KB81001606','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('11','2','1','web.xml','\WEB-INF\web.xml','E8: KB81001606--KB8100161000补丁包web.xml 配置','10007','KB8100161000','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('12','2','1','web.xml','\WEB-INF\web.xml','E8: KB8100161000--KB8100161100补丁包web.xml配置','10008','KB8100161100','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('13','2','1','action.xml','\WEB-INF\service\action.xml','E8: KB81001508-KB81001603标准action.xml配置','20004','KB81001603','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('16','2','1','web.xml','\WEB-INF\web.xml','E8: KB8100161100--KB8100170200补丁包web.xml 配置','10009','KB8100170200','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('17','2','1','services.xml','\classbean\META-INF\xfire\services.xml','跨版本升级至E8后标准services.xml配置','30001','8.100.0531','0')
/
...
/
call updatePropertiesFile('2','19','element.customPath','/page/elementCustom/','自定义元素发布路径','1','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('20','1','1','weaver_initmodule.properties','\WEB-INF\prop\weaver_initmodule.properties','需要手动修改配置，初始化后，cusupdate的值由 1 变成 0','259177','KB8100170400','0')
/
call updatePropertiesFile('3','20','cusupdate','1','初始化后会置为0','0','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('7','2','1','web.xml','\WEB-INF\web.xml','E8: 	KB81001511--	KB81001512补丁包web.xml配置','10004','KB81001512','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('14','2','1','action.xml','\WEB-INF\service\action.xml','E8: KB81001603-KB8100161000标准action.xml配置','20005','KB8100161000','0')
/
...
insert into CustomerSysVersion(name) values ('8.100.0531')
/
call updateconfigFileManager('15','2','1','action.xml','\WEB-INF\service\action.xml','E8: KB8100161000-KB8100170300标准action.xml配置','20006','KB8100170300','0')
/

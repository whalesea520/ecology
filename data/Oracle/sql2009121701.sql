...
/
INSERT INTO HtmlLabelInfo VALUES(24022,'關鍵字之間以空格分隔,選擇and搜索包含全部關鍵詞的信息;選擇or搜索包含任意一個關鍵詞的信息.',9) 
/

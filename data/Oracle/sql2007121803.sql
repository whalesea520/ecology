...
update DirAccessPermission set createdoc=1 where createdoc=2
/
update DirAccessPermission set createdir=1 where createdir=2
/
update DirAccessPermission set movedoc=1 where movedoc=2
/
update DirAccessPermission set copydoc=1 where copydoc=2
/

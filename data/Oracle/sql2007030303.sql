...
SELECT DISTINCT workPlanShare.workPlanId, workPlanShare.shareLevel
    ...
    /* 角色 */
    OR (workPlan.id = workPlanShare.workPlanId 
...
ALTER TABLE WorkPlanShare ADD TEMP_userId   varchar2(1600)
/

ALTER TABLE WorkPlanShare ADD TEMP_deptId   varchar2(1600)
/
ALTER TABLE WorkPlanShare ADD TEMP_roleId   varchar2(1600)
/
ALTER TABLE WorkPlanShare ADD TEMP_subCompanyId   varchar2(1600)
/

update WorkPlanShare set TEMP_userId=userId
/
update WorkPlanShare set TEMP_deptId=deptId
/
update WorkPlanShare set TEMP_roleId=roleId
/
update WorkPlanShare set TEMP_subCompanyId=subCompanyId
/

ALTER TABLE WorkPlanShare drop column userId  
/
ALTER TABLE WorkPlanShare drop column deptId   
/
ALTER TABLE WorkPlanShare drop column roleId  
/
ALTER TABLE WorkPlanShare drop column subCompanyId   
/


ALTER TABLE WorkPlanShare ADD userId   varchar2(1600)
/

ALTER TABLE WorkPlanShare ADD deptId   varchar2(1600)
/
ALTER TABLE WorkPlanShare ADD roleId   varchar2(1600)
/
ALTER TABLE WorkPlanShare ADD subCompanyId   varchar2(1600)
/

update WorkPlanShare set userId=TEMP_userId
/
update WorkPlanShare set deptId=TEMP_deptId
/
update WorkPlanShare set roleId=TEMP_roleId
/
update WorkPlanShare set subCompanyId=TEMP_subCompanyId
/
ALTER TABLE WorkPlanShare drop column TEMP_userId  
/

ALTER TABLE WorkPlanShare drop column TEMP_deptId   
/
ALTER TABLE WorkPlanShare drop column TEMP_roleId  
/
ALTER TABLE WorkPlanShare drop column TEMP_subCompanyId   
/


UPDATE WorkPlanShare SET userId =concat(concat( ',' , userId) , ',')
WHERE userId <> '0' AND userId IS NOT null
/

UPDATE WorkPlanShare SET deptId = concat(concat(',' , deptId) , ',')
WHERE deptId <> '0' AND deptId IS NOT null
/

UPDATE WorkPlanShare SET subCompanyId = concat(concat(',' , subCompanyId) , ',')
WHERE subCompanyId <> '0' AND subCompanyId IS NOT null
/

ALTER TABLE DocSecCategoryShare ADD downloadlevel INTEGER
/
ALTER TABLE secCreaterDocPope ADD (PCreaterDL INTEGER, PCreaterManagerDL INTEGER, PCreaterSubCompDL INTEGER, PCreaterDepartDL INTEGER, PCreaterWDL INTEGER, PCreaterManagerWDL INTEGER)
/
ALTER TABLE DocShare ADD downloadlevel INTEGER
/
ALTER TABLE ShareouterDoc ADD downloadlevel INTEGER
/
ALTER TABLE ShareinnerDoc ADD downloadlevel INTEGER
/
...
values (secid_1,sharetype_2,seclevel_3,rolelevel_4,sharelevel_5,userid_6,subcompanyid_7,departmentid_8,roleid_9,foralluser_10,crmid_11,orgGroupId_12,downloadlevel_13);
end;
/
...
values (secid_1,sharetype_2,seclevel_3,rolelevel_4,sharelevel_5,userid_6,subcompanyid_7,departmentid_8,roleid_9,foralluser_10,crmid_11,downloadlevel_12);
end;
/
...
begin 
    ...
    subcompanyid,departmentid,roleid,foralluser,crmid,orgGroupId,downloadlevel)
    values( docid_1, sharetype_2, seclevel_3, rolelevel_4, sharelevel_5, 
    userid_6, subcompanyid_7, departmentid_8, roleid_9, foralluser_10, crmid_11, orgGroupId_12, downloadlevel_13);

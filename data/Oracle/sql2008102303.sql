ALTER table  HrmSearchMould  ADD num varchar(60)
/
update   HrmSearchMould set num = department
/
ALTER table  HrmSearchMould  drop column department
/
ALTER TABLE HrmSearchMould RENAME COLUMN num TO department
/

create or replace view workflowactionview as
...
union 
select to_char(s.id) as id, s.actionname, s.actionorder, s.nodeid, s.workflowId, s.nodelinkid, s.ispreoperator, 2 as actiontype,1 as isused from sapactionset s
/

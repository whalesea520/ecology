...
String titlename = "" + SystemEnv.getHtmlLabelName(572,user.getLanguage()) + ":" + SystemEnv.getHtmlLabelName(611,user.getLanguage());
String needfav ="1";
String needhelp ="";
...
Event.observe(window, "load", function(){
	if($F("mailUserEmail")!=""){
		$("mailUserEmailSpan").innerHTML = "";
	}
});
function doSubmit(keepon){
...
<%
RCMenu += "{"+SystemEnv.getHtmlLabelName(86,user.getLanguage())+",javascript:doSubmit(0),_self} " ;    
RCMenuHeight += RCMenuHeightStep;
RCMenu += "{"+SystemEnv.getHtmlLabelName(86,user.getLanguage())+"&"+SystemEnv.getHtmlLabelName(1256,user.getLanguage())+",javascript:doSubmit(1),_self} " ;    
RCMenuHeight += RCMenuHeightStep;
...
<input type="hidden" name="operation" value="contacterAdd" />
<input type="hidden" name="groupId" value="<%=groupId%>" />
<input type="hidden" id="keepon" name="keepon" value="" />
...
<tr>
	...
	<td class="Field">
		<input type="text" name="mailUserName" class="inputstyle" maxlength="20" onchange="checkinput('mailUserName','mailUserNameSpan')" />
		<SPAN id="mailUserNameSpan"><IMG src='/images/BacoError_wev8.gif' align="absMiddle"></SPAN>
	</td>
</tr>
...
<tr>
	...
	<td class="Field">
		<input type="text" name="mailUserEmail" class="inputstyle" value="<%=mailAddress%>" onchange="checkinput('mailUserEmail','mailUserEmailSpan')" />
		<SPAN id="mailUserEmailSpan"><IMG src='/images/BacoError_wev8.gif' align="absMiddle"></SPAN>
	</td>
</tr>
<tr style="height:1px"><td class="Line" colspan="2"></td></tr>
<tr>
	...
	<td class="Field">
		<input type="text" name="mailUserDesc" class="inputstyle" />
	</td>
</tr>
<tr style="height:1px"><td class="Line" colspan="2"></td></tr>
<tr class="Title">
...
<tr>
	...
	<td class="Field">
		<input type="text" name="mailUserTelP" class="inputstyle" />
	</td>
</tr>
<tr style="height:1px"><td class="Line" colspan="2"></td></tr>
<tr>
	...
	<td class="Field">
		<input type="text" name="mailUserMobileP" class="inputstyle" />
	</td>
</tr>
<tr style="height:1px"><td class="Line" colspan="2"></td></tr>
<tr>
	...
	<td class="Field">
		<input type="text" name="mailUserIMP" class="inputstyle" />
	</td>
</tr>
<tr style="height:1px"><td class="Line" colspan="2"></td></tr>
<tr>
	...
	<td class="Field">
		<input type="text" name="mailUserAddressP" class="inputstyle" />
	</td>
</tr>
<tr style="height:1px"><td class="Line" colspan="2"></td></tr>
<tr class="Title">
...
<tr>
	<td><%=SystemEnv.getHtmlLabelName(421,user.getLanguage())%></td>
	<td class="Field">
		<input type="text" name="mailUserTelW" class="inputstyle" />
	</td>
</tr>
<tr style="height:1px"><td class="Line" colspan="2"></td></tr>
<tr>
	...
	<td class="Field">
		<input type="text" name="mailUserFaxW" class="inputstyle" />
	</td>
</tr>
<tr style="height:1px"><td class="Line" colspan="2"></td></tr>
<tr>
	...
	<td class="Field">
		<input type="text" name="mailUserCompanyW" class="inputstyle" />
	</td>
</tr>
<tr style="height:1px"><td class="Line" colspan="2"></td></tr>
<tr>
	...
	<td class="Field">
		<input type="text" name="mailUserDepartmentW" class="inputstyle" />
	</td>
</tr>
<tr style="height:1px"><td class="Line" colspan="2"></td></tr>
<tr>
	...
	<td class="Field">
		<input type="text" name="mailUserPostW" class="inputstyle" />
	</td>
</tr>
<tr style="height:1px"><td class="Line" colspan="2"></td></tr>
<tr>
	...
	<td class="Field">
		<input type="text" name="mailUserAddressW" class="inputstyle" />
	</td>
</tr>
<tr style="height:1px"><td class="Line" colspan="2"></td></tr>
</table>

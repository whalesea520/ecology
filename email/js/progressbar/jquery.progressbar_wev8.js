	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '/email/js/progressbar/images/progressbar_wev8.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/email/js/progressbar/images/progressbg_green_wev8.gif',
									30: '/email/js/progressbar/images/progressbg_green_wev8.gif',
									70: '/email/js/progressbar/images/progressbg_green_wev8.gif'
								},

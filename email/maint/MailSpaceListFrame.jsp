...
<body scroll="no">
	<div class="e8_box demo2">
		...
		<div class="tab_box">
			<iframe src="MailSpaceList.jsp?subcompanyid=<%=subcompanyid %>&departmentid=<%=departmentid%>" onload="update()" id="tabcontentframe" name="tabcontentframe" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
	    $('.e8_box').Tabs({
			...
			staticOnLoad:true,
			objName:"<%=SystemEnv.getHtmlLabelName(33450,user.getLanguage()) %>"
		});

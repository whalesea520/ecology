...
<body scroll="no">
	<div class="e8_box demo2" id="rightContent">
		...
		<iframe src="/email/new/Attachment.jsp" onload="update();" id="tabcontentframe" name="tabcontentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
	</div>	
</body>
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
	    $('.e8_box').Tabs({
			...
			staticOnLoad:true,
			objName:"<%=SystemEnv.getHtmlLabelName(156, user.getLanguage())%><%=SystemEnv.getHtmlLabelName(426, user.getLanguage())%>"
		});

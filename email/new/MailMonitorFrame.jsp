...
<body scroll="no">
	<div class="e8_box demo2" id="rightContent">
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				...
				<div>
					<ul class="tab_menu">
						<li class="defaultTab">
							<a href="" target="tabcontentframe" _datetype=""><%=TimeUtil.getCurrentTimeString() %></a>
						</li>
					</ul>
		...
		<iframe src="/email/new/MailMonitor.jsp" onload="update();" id="tabcontentframe" name="tabcontentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
	</div>	
</body>
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
	    $('.e8_box').Tabs({
			...
			staticOnLoad:true,
			objName:"<%=SystemEnv.getHtmlLabelName(71, user.getLanguage())+SystemEnv.getHtmlLabelName(665, user.getLanguage())%>"
		});

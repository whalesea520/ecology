...
jQuery("#addMail").bind("click",function(){
	try{
		...
		if(right_url.indexOf("MailInBox.jsp")==-1){
		 ...
		 right_url=window.parent.document.getElementById("<%=frame%>").src;
		if(right_url.indexOf("MailInBox.jsp")==-1){
				//表示右边结构被切换到邮件设计或联系人界面
				
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?opNewEmail=1&folderid=0&isInternal="+$(this).attr("target");
				return;
		}
	}
	try{
...
jQuery("#inboxBtn").bind("click",function(){
	...
	if(menu_userLayout==3){
		try{
				window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("2","/email/new/MailInboxList.jsp?folderid=0&receivemailid=0&receivemail=true&"+new Date().getTime(),$(this).text());
		}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?folderid=0&receivemailid=0&receivemail=true&"+new Date().getTime();
		}
	}else{
		try{
			window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("2","/email/new/MailInboxListMain.jsp?folderid=0&receivemailid=0&receivemail=true&"+new Date().getTime(),$(this).text());
		}catch(e){
			//表示右边结构被切换到邮件设计或联系人界面
			window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?folderid=0&receivemailid=0&receivemail=true&"+new Date().getTime();
		}
...
jQuery("#receiveMail").bind("click",function(){
	...
	if(menu_userLayout==3){
		try{
				window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("2","/email/new/MailInboxList.jsp?folderid=0&receivemailid=-1&receivemail=true&"+new Date().getTime());
		}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?folderid=0&receivemailid=-1&receivemail=true&"+new Date().getTime();
		}
	}else{
			try{
				window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("2","/email/new/MailInboxListMain.jsp?folderid=0&receivemailid=-1&receivemail=true&"+new Date().getTime());
		}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?folderid=0&receivemailid=-1&receivemail=true&"+new Date().getTime();
		}
...
jQuery("#outboxBtn").bind("click",function(){
	...
	if(menu_userLayout==3){
			try{
				window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("3","/email/new/MailInboxList.jsp?folderid=-1&"+new Date().getTime(),$(this).text());
			}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?folderid=-1&"+new Date().getTime();
			}
	}else{
			try{
     			window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("3","/email/new/MailInboxListMain.jsp?folderid=-1&"+new Date().getTime(),$(this).text());
     		}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?folderid=-1&"+new Date().getTime();
			}
...
jQuery("#drafboxBtn").bind("click",function(){
	...
	if(menu_userLayout==3){
		try{
				window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("4","/email/new/MailInboxList.jsp?folderid=-2&"+new Date().getTime(),$(this).text());
		}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?folderid=-2&"+new Date().getTime();
			}
	}else{
		try{
				window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("4","/email/new/MailInboxListMain.jsp?folderid=-2&"+new Date().getTime(),$(this).text());
		}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?folderid=-2&"+new Date().getTime();
		}
...
jQuery("#delboxBtn").bind("click",function(){
	...
	if(menu_userLayout==3){
			try{
					...
					window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("5","/email/new/MailInboxList.jsp?folderid=-3&"+new Date().getTime(),$(this).find(".title").text());
			}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?folderid=-3&"+new Date().getTime();
			}
	}else{
		try{
				window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("5","/email/new/MailInboxListMain.jsp?folderid=-3&"+new Date().getTime(),$(this).find(".title").text());
		}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?folderid=-3&"+new Date().getTime();
		}
...
jQuery("#star").bind("click",function(){
	...
	if(menu_userLayout==3){
		try{
				window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("7","/email/new/MailInboxList.jsp?star=1&"+new Date().getTime(),$(this).text());
		}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?star=1&"+new Date().getTime();
		}
	}else{
		try{
				window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("7","/email/new/MailInboxListMain.jsp?star=1&"+new Date().getTime(),$(this).text());
		}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?star=1&"+new Date().getTime();
		}
...
jQuery("#internal").bind("click",function(){
	...
	if(menu_userLayout==3){
			try{
				window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("6","/email/new/MailInboxList.jsp?isInternal=1&"+new Date().getTime(),$(this).text());
			}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?isInternal=1&"+new Date().getTime();
			}
	}else{
		try{
				window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("6","/email/new/MailInboxListMain.jsp?isInternal=1&"+new Date().getTime(),$(this).text());
		}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?isInternal=1&"+new Date().getTime();
		}
...
jQuery(".subfolder").bind("click",function(){
	...
	if(menu_userLayout==3){
		try{
				window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("8","/email/new/MailInboxList.jsp?folderid="+$(this).attr("target")+"&"+new Date().getTime(),$(this).text());
		}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?folderid="+$(this).attr("target")+"&"+new Date().getTime();
		}
	}else{
		try{
				window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("8","/email/new/MailInboxListMain.jsp?folderid="+$(this).attr("target")+"&"+new Date().getTime(),$(this).text());
		}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?folderid="+$(this).attr("target")+"&"+new Date().getTime();
		}
...
jQuery(".label").bind("click",function(){
	...
	if(menu_userLayout==3){
		try{
				window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("8","/email/new/MailInboxList.jsp?labelid="+$(this).attr("target")+"&"+new Date().getTime(),$(this).text());
		}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?labelid="+$(this).attr("target")+"&"+new Date().getTime();
		}
	}else{
		try{
				window.parent.parent.document.getElementById("<%=frame%>").contentWindow.refreshTab("8","/email/new/MailInboxListMain.jsp?labelid="+$(this).attr("target")+"&"+new Date().getTime(),$(this).text());
		}catch(e){
				//表示右边结构被切换到邮件设计或联系人界面
				window.parent.document.getElementById("<%=frame%>").src="/email/new/MailInBox.jsp?labelid="+$(this).attr("target")+"&"+new Date().getTime();
		}
...
jQuery(document).ready(function(){
	jQuery("#inboxBtn").trigger("click");
	if("<%=act%>"=="add")
		jQuery("#addMail").trigger("click");
})

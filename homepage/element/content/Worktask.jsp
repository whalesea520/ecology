...
<%
	...
	*/
	...
	String returnStr="";		
	ArrayList toalList=Util.TokenizerString(strsqlwhere, "^,^");
	...
	sqlWhere += requestShare.getViewShareStrAll(user.getUID());

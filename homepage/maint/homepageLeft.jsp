...
<BODY onload="initTree9old();">
	<FORM NAME=SearchForm STYLE="margin-bottom:0" action="HomepageTabs.jsp?_fromURL=hpManit&loginview=0" method=post target="contentframe">

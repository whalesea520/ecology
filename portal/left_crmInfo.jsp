...
<script type="text/javascript">
	parent.mainFrame.location.href="/CRM/data/ViewCustomer.jsp?CustomerID=<%=user.getUID()%>&fromPortal=true";
</script>
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" >
  <tr> 
	...
	<div style="font-size: 14px;color: rgb(161, 158, 158);padding-left:10px;height:40px;line-height: 40px;">
		<div style="line-height: 30px;height:30px;padding-top:5px;">个人</div>
	</div>
	<%if(logintype.equals("2")){%>
		...
		<tr > 
		  <td width="40" height="40" class='icon_right' style="line-height:40px;"><img alt="个人资料" style="padding-top:12px;" src="/wui/theme/ecology8/page/images/menuicon/bright/25_wev8.png"></td><!-- <i class="iconfont">&#xe60b;</i> -->
		  <td width="80" align="center"><a href="/CRM/data/ViewCustomer.jsp?CustomerID=<%=user.getUID()%>&fromPortal=true" class="zlm"  target="mainFrame"><%=SystemEnv.getHtmlLabelName(16650,user.getLanguage())%></a></td>

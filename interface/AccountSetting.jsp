...
<body scroll="no" >
<%
	//qc296829  [80]集成登录-集成登录账号设置页面优化 
	String  sysid=Util.null2String(request.getParameter("sysid"));
	String loadurl="/interface/AccountSettingFrame.jsp?sysid="+sysid;
	String navName = "";
%>
...
<div class="e8_boxhead">
		...
		<div class="e8_ultab">
			...
			<div>
				<ul class="tab_menu">
					<li class='current'>
				    	<a href="/interface/AccountSettingFrame.jsp" target="tabcontentframe">
...
$(function(){
    $('.e8_box').Tabs({
        ...
        staticOnLoad:true,
        notRefreshIfrm:true,
        objName:"<%=SystemEnv.getHtmlLabelName(83325, user.getLanguage())%>"
    });
});

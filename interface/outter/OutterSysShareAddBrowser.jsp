	...
	<jsp:include page="/systeminfo/commonTabHead.jsp">
	   ...
	   <jsp:param name="navName" value="<%=SystemEnv.getHtmlLabelName(18645,user.getLanguage())%>"/>  
		...
		<div class="zDialog_div_content">
			...
			<FORM id=weaverA name=weaverA action="/interface/outter/OutterSysShareOperation.jsp"
				method="post">
				...
				<input type="hidden" value="<%=sysid %>" name="sysid" id="sysid" />
...
function check_by_permissiontype() {
    ...
    if (thisvalue == 1) {
        ...
        return check_form(weaverA, "jobtitle, jobtitlelevel, department, subcompany");
    }else {
        return false;
    }
}

...
<html>
	...
	<%
		...
		String titlename =SystemEnv.getHtmlLabelName(83790,user.getLanguage());
		String opera="save";
		String poolid="";
		String serdesc="";
		String regname="";
		if("1".equals(isNew))
		{
			titlename = SystemEnv.getHtmlLabelName(83792,user.getLanguage());
			opera="update";
			//查出默认值
...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value="<%=SystemEnv.getHtmlLabelName(30707,user.getLanguage())%>"/> 
</jsp:include>
...
<wea:layout type="2Col">
	...
	<wea:item><%=SystemEnv.getHtmlLabelName(81370,user.getLanguage()) %>WEBSERVICE<%=SystemEnv.getHtmlLabelName(18076,user.getLanguage()) %></wea:item>
    <wea:item>
	...
	<wea:item>WEBSERVICE<%=SystemEnv.getHtmlLabelName(30625,user.getLanguage()) %></wea:item>
    <wea:item>
...
<script type="text/javascript">
		...
		function doDelete(obj,id)
		{
			...
			{
				window.location.href="/integration/serviceReg/serviceReg_2Operation.jsp?isDialog=1&opera=delete&ids="+id+"&hpid=<%=hpid%>";
			}
		}

...
<html>
	...
	<%
		...
		tableString =   " <table instanceid=\"sendDocListTable\" tabletype=\"checkbox\" pagesize=\""+perpage+"\" >"+
                ...
                "       <head>"+
                "           <col width=\"20%\"  text=\""+ SystemEnv.getHtmlLabelName(30644,user.getLanguage()) +"\" column=\"regname\"  transmethod=\"com.weaver.integration.util.IntegratedMethod.getRegname\"  otherpara=\"column:id\" />"+
				"           <col width=\"30%\"  text=\""+ SystemEnv.getHtmlLabelName(30660,user.getLanguage()) +"\" column=\"sourcename\"   />"+
				"           <col width=\"20%\"  text=\""+ SystemEnv.getHtmlLabelName(30662,user.getLanguage()) +"\" column=\"opermode\"   transmethod=\"com.weaver.integration.util.IntegratedMethod.getOpermode\"  />"+
				"           <col width=\"30%\"  text=\""+ SystemEnv.getHtmlLabelName(30625,user.getLanguage()) +"\" column=\"serdesc\"   />"+
                "       </head>"+
                " </table>";
	%>
	<body>
...
<wea:layout type="4Col">
	...
	<wea:item><%=SystemEnv.getHtmlLabelName(30632,user.getLanguage())%></wea:item>
    <wea:item>
...
<TABLE width="100%">
	...
	<script type="text/javascript">
		...
		function doAdd()
		{
			var url="/integration/serviceReg/serviceReg_1New.jsp?hpid=<%=hpid%>";
			var title="<%=SystemEnv.getHtmlLabelName(30639,user.getLanguage())%>";
			showDialog(title,url,500,360,false);
		}
		function doUpdate(id)
		{
			var url="/integration/serviceReg/serviceReg_1New.jsp?isNew=1&id="+id;

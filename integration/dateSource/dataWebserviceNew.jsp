...
<wea:layout type="2Col">
    ...
    <wea:item >
        <wea:required id="wsdladdressspan" required="true" value='<%=wsdladdress%>'>
...
<script type="text/javascript">
		...
		function doDelete(obj,id)
		{
			...
			{
				window.location.href="/integration/dateSource/dataWebserviceOperation.jsp?isDialog=1&opera=delete&ids="+id+"&hpid=<%=hpid%>";
			}
		}

...
<form action="OfslogList.jsp" method="post" name="datalist" id="datalist" >
...
function doRefresh(){
	...
	window.location = "/integration/ofs/OfslogList.jsp?workflowname="+workflowname;
}

function doViewById(id){
	if(id=="") return ;
	var url = "/integration/ofs/OfsInfoWorkflowTab.jsp?urlType=3&isdialog=1&backto=&id="+encodeURI(encodeURI(id));

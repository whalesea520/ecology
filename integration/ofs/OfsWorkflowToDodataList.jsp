...
String backfields=" * " ;
String perpage="10";
String PageConstId = "OfsWorkflowToDodataList";
String fromSql=" Ofs_todo_data "; 
 tableString = "<table instanceid=\"Ofs_todo_dataTable\" tabletype=\"checkbox\" pagesize=\""+PageIdConst.getPageSize(PageConstId,user.getUID(),PageIdConst.Browser)+"\" >"+
				...
				"           <col width=\"25%\" text=\""+SystemEnv.getHtmlLabelName(229,user.getLanguage())+"\"  column=\"requestname\" orderkey=\"requestname\" otherpara=\"column:id\"  transmethod=\"weaver.ofs.util.OfsDataParse.getRequestnameLink\"/>"+
...
<form action="OfsWorkflowToDodataList.jsp" method="post" name="datalist" id="datalist" >
...
<%
String WFbrowserURL="/integration/ofs/OfsInfoWorkflowTab.jsp?sysid="+sysid+"&urlType=4";
%>
		...
		<wea:group context='<%= SystemEnv.getHtmlLabelName(20331,user.getLanguage())%>'>
			...
			<wea:item>
				<brow:browser viewType='0' name='workflowid' browserValue='<%=workflowid%>'
					browserOnClick='' browserUrl='<%=WFbrowserURL%>'
...
function doRefresh(){
	...
	//window.location = "/integration/ofs/OfsWorkflowToDodataList.jsp?requestname="+requestname;
	datalist.submit();
}
...
function doDelete(ids){
	...
	top.Dialog.confirm("<%=SystemEnv.getHtmlLabelName(15097,user.getLanguage())%>", function (){
		self.location.href="/integration/ofs/OfsToDodataOperation.jsp?isdialog=1&sysid=<%=sysid%>&backto=<%=typename%>&operation=delete&id="+ids;
	}, function () {}, 320, 90);	
}
function doDeleteById(id){
	if(id=="") return ;
	top.Dialog.confirm("<%=SystemEnv.getHtmlLabelName(15097,user.getLanguage())%>", function (){
		self.location.href="/integration/ofs/OfsToDodataOperation.jsp?isdialog=1&sysid=<%=sysid%>&backto=<%=typename%>&operation=delete&id="+id;
	}, function () {}, 320, 90);	
}

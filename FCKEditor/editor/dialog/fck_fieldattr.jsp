				...
				<tr valign="top">
					...
					<td align="left" valign="top">
						<table cellpadding="0" cellspacing="2" border="0" width="100%">
							...
							<tr valign="top">
								<td width="100%">
									<button id="currentdate" name="currentdate" title="<%=SystemEnv.getHtmlLabelName(15625,user.getLanguage())%>" class="btn" onclick="insertMark(' $currentdate$ ')" ><%=SystemEnv.getHtmlLabelName(15625,user.getLanguage())%></button>
								</td>
							</tr>
							<tr valign="top">
								<td width="100%">
									<button id="requestid" name="requestid" title="<%=SystemEnv.getHtmlLabelName(28610,user.getLanguage())%>" class="btn" onclick="insertMark(' $requestid$ ')" ><%=SystemEnv.getHtmlLabelName(28610,user.getLanguage())%></button>
								</td>
							</tr>
							<!-- 
							<tr valign="top">

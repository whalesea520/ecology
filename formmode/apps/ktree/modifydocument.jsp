...
RecordSet.executeSql("select * from uf_ktree_document where id="+documentid);
String subject="";
String content = "";
int versionid=0;
int functionid=0;
...
<html>
  ...
  <body>
  	<form action="operationKtreeDcoument.jsp" name="fm" method="post">
		...
		<table>
			<tr>
				<td>标题<input name="subject" id="subject" value="<%=subject%>"/><a href="javascript:onSubmitFrom()" name="btn">提交</a></td>
			</tr>
			<tr>
				<td>
...
<script type="text/javascript">
	...
	ue.addListener( 'ready', function( editor ) {
			ue.setContent($("#editorcontent").html());
	} );

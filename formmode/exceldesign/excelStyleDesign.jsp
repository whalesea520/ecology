		...
		jQuery(document).ready(function(){
			...
			$("input[target=_number").spinner({
	            ...
	            change:function(){
	            	...
	            	if(isNaN(vthis.val())){
	            		window.top.Dialog.alert("非法"+wringtype+"值！");
	            		vthis.val("");
	            	}else{
	            		if(parseInt(vthis.val()) <= 0){
		            		window.top.Dialog.alert(wringtype+"值不能为零或负数！");
		            		vthis.val("");
		            	}
	            	}
		...
		function saveAsVersion(){
			if(check_form(weaverform,"stylename,main_row_height,main_lable_width,main_field_width,detail_row_height,detail_col_width")){
				...
				if(canSave)
					...
					window.top.Dialog.alert(msg+"值不能大于100%，请重新设置！");
			}
		}
...
<style>
	...
	.colorpickContainer .sp-preview, .sp-alpha, .sp-thumb-el {
		background-image:url("/formmode/exceldesign/image/shortBtn/format/BackgroundColor_wev8.png");
...
<BODY>
	...
	<jsp:include page="/systeminfo/commonTabHead.jsp">
	   ...
	   <jsp:param name="navName" value="表单样式"/>
	</jsp:include> 
	...
	<form name="weaverform" action="/formmode/exceldesign/excelStyleOperation.jsp" method="post">
	...
	<div class="zDialog_div_content">
					...
					<wea:layout type="menu2col">
						<wea:group context='<%=SystemEnv.getHtmlLabelName(61,user.getLanguage()) %>'><!-- 基本 -->
							...
							<wea:item>
								...
								<span style="padding-left:5px;"><%=SystemEnv.getHtmlLabelName(218,user.getLanguage())%>  [默认值:30] </span>
							</wea:item>
							<wea:item>
			...
			<div class="rightShowContent" style="width:330px;position: absolute;top: 0px;right: 40px;">	
				...
				<div name="e_style_1" class="tylelement">
					<div name="_label1" style="width: 100px;height:31px;line-height:31px;float: left;border: 1px solid #f5e1c2;padding-left: 7px;background:#fcf6e8">字段名</div>
					<div name="_field1" style="border: 1px solid #f5e1c2;padding-left: 115px;height:31px;line-height:31px;">表单内容</div>
					<div name="_label1" style="float: left;width: 100px;height:31px;line-height:31px;border: 1px solid #f5e1c2;padding-left: 7px;margin-top: -1px;background:#fcf6e8;">字段名</div>
					<div name="_field1" style="border: 1px solid #f5e1c2;margin-top: -1px;padding-left: 115px;height:31px;line-height:31px;">表单内容</div>
					<div name="_label1" style="width: 155px;height:31px;line-height:31px;float: left;border: 1px solid #f5e1c2;padding-left: 10px;background:#fcf6e8;margin-top: -1px;">字段名</div>
					<div name="_label1" style="border: 1px solid #f5e1c2;padding-left: 175px;margin-top: -1px;background:#fcf6e8;height:31px;line-height:31px;">字段名</div>
					<div name="_field1" style="float: left;width: 155px;border: 1px solid #f5e1c2;padding-left: 10px;margin-top: -1px;height:31px;line-height:31px;">表单内容</div>
					<div name="_field1" style="border: 1px solid #f5e1c2;margin-top: -1px;padding-left: 175px;height:31px;line-height:31px;">表单内容</div>
				</div>
			</div>
		...
		<wea:layout needImportDefaultJsAndCss="false">
			<wea:group context=""  attributes="{groupDisplay:none}">
				<wea:item type="toolbar">
					<input type="button" value="关闭" id="zd_btn_cancle"  class="zd_btn_cancle" onclick="dialog.close();">			    	
				</wea:item>
			</wea:group>
		</wea:layout>      
	</div>

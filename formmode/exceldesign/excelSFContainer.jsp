...
<BODY>
	...
	<div class="e8_boxhead">
		...
		<div class="e8_ultab">
			...
			<div>
				<ul class="tab_menu">
					<li class="current" ><a target="number">数字</a></li>
					<%if(!isEditMoreContent){ %>
						<li class="" ><a target="align">对齐</a></li>
					<%} %>
					<li class="" ><a target="font">字体</a></li>
					<%if(!isEditMoreContent){ %>
						<li class="" ><a target="border">边框</a></li>
					<%} %>
					<li class="" ><a target="bgfill">填充</a></li>
				</ul>
	...
	<iframe src="/formmode/exceldesign/excelSetFormat.jsp?excelid=<%=excelid %>&bxsize=<%=bxsize %>" onload="update();" id="tabcontentframe" name="tabcontentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
</div> 
</BODY>
</HTML>

...
<jsp:useBean id="FormManager" class="weaver.formmode.form.FormManager" scope="session"/>
<jsp:useBean id="LabelComInfo" class="weaver.systeminfo.label.LabelComInfo" scope="page" />	
<jsp:useBean id="FormFieldMainManager" class="weaver.formmode.form.FormFieldMainManager" scope="page" />
<%FormFieldMainManager.resetParameter();%>
<jsp:useBean id="FormFieldlabelMainManager" class="weaver.formmode.form.FormFieldlabelMainManager" scope="page" />

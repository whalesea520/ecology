...
function checkWidth(vthis){
	var value = $(vthis).val();
	var name = $(vthis).closest("td").prev().text()+":宽度";
	if(isNaN(value) || value.indexOf(".")>-1 || parseInt(value)<0){
		window.top.Dialog.alert(name+"值只能为正整数！");
		$(vthis).val("");
	}
}
...
.colorpickContainer .sp-preview, .sp-alpha, .sp-thumb-el {
	background-image:url("/formmode/exceldesign/image/shortBtn/format/BackgroundColor_wev8.png"); background-repeat: no-repeat;
}
...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value="标签页样式"/>
</jsp:include> 
...
<form name="weaverform" action="/formmode/exceldesign/tabStyleOperation.jsp" type="post">
	...
	<div class="leftSetContent">
		...
		<div style="width:100%">
			<wea:layout type="menu2col" attributes="{'cw1':'23%','cw2':'77%'}">
				<!--选中状态 -->
				<wea:group context="选中状态">
					<wea:item>背景图-左</wea:item>
					<wea:item>	
						...
						宽度&nbsp;<input type="text" name="sel_bgleftwidth" value="<%=sel_bgleftwidth %>" onBlur="checkWidth(this)"
							r_id="t_sel_left" r_attr="width" max_width="50" style="width:30px !important"/>px&nbsp;
					</wea:item>
					<wea:item>背景图-中</wea:item>
					<wea:item>	
						...
						<span class="e8tips" title="根据标签页文字宽度平铺图片显示">
							<img src="/images/tooltip_wev8.png" align="absMiddle">
						</span>
					</wea:item>
					<wea:item>背景图-右</wea:item>
					<wea:item>	
						...
						宽度&nbsp;<input type="text" name="sel_bgrightwidth" value="<%=sel_bgrightwidth %>" onBlur="checkWidth(this)"
				...
				<wea:group context="未选中状态">
					...
					<wea:item>	
						...
						宽度&nbsp;<input type="text" name="unsel_bgleftwidth" value="<%=unsel_bgleftwidth %>" onBlur="checkWidth(this)"
					...
					<wea:item>	
						...
						宽度&nbsp;<input type="text" name="unsel_bgrightwidth" value="<%=unsel_bgrightwidth %>" onBlur="checkWidth(this)"
				...
				<wea:group context='<%=SystemEnv.getHtmlLabelNames("375",user.getLanguage()) %>'>
					...
					<wea:item>	
						...
						<span class="e8tips" title="根据标签页整体宽度平铺图片显示">
							<img src="/images/tooltip_wev8.png" align="absMiddle">
						</span>
					</wea:item>
					<wea:item>页签间分隔线</wea:item>
					<wea:item>	
						...
						宽度&nbsp;<input type="text" name="image_sepwidth" value="<%=image_sepwidth %>" onBlur="checkWidth(this)"

...
function setExcelBxValue(e,targetid,flag,txt,htmltype,type,dbtype)
{
	...
	if(flag === celltype.FCONTENT){
		...
		if(_controltype!=""){
			var imgsrc = "/formmode/exceldesign/image/controls/"+_controltype+targetstatus+"_wev8.png";//图的名称很重要
...
function initModuleTab(){
	...
	leftMenu.click(function(){
		if($(this).is("#import"))
		{
			...
			var url = "/formmode/exceldesign/excelImport.jsp?nodeid="+wfinfo.nodeid+"&wfid="+wfinfo.wfid+"&formid="+wfinfo.formid+"&isbill="+wfinfo.isbill+"&layouttype="+wfinfo.layouttype+"&modeid="+wfinfo.modeid+"&isform="+wfinfo.isform;
...
function clickModuleMenu(menuname){
	...
	var iframeurl = "/formmode/exceldesign/showModule.jsp?wfid="+wfinfo.wfid+"&formid="+wfinfo.formid+"&isbill="+wfinfo.isbill+"&isform="+wfinfo.isform+"&modeid="+wfinfo.modeid;
	if(menuname==="show"){		//模板

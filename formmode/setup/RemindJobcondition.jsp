...
String params = "id="+id+"&isbill="+isbill+"&formid="+formid+"&haspost="+haspost+"&isclear="+isclear+
                "&fromBillManagement="+fromBillManagement+"&fromself="+fromself+"&linkid="+linkid+"&checkcons="+checkcons +
                "&comefrom="+comefrom +"&operatortype="+operatortype +"&sqlwherePara="+sqlwherePara +"&sqlwherecnPara="+sqlwherecnPara+"&formtype="+formtype;
%>
 ...
 <script type="text/javascript">
		...
		$(function(){
		    $('.e8_box').Tabs({
		        ...
		        staticOnLoad:true,
		        objName:"<%=SystemEnv.getHtmlLabelName(81602, user.getLanguage()) %>"
		   	});
		}); 
	</script>
	<div class="e8_box demo2">
		  <div class="e8_boxhead">
		   ...
		   <div class="tab_box">
		        <div>
		            <iframe src="RemindJobconditionIframe.jsp?<%=params %>" onload="if(typeof(update)=='function'){update()}" id="tabcontentframe" name="tabcontentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
		        </div>
		   </div>
	</div> 

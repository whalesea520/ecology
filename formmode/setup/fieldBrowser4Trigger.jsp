...
<wea:layout type="4col" attributes="{'cw1':'20%','cw2':'30%','cw3':'20%','cw4':'30%'}">
	...
	<wea:group context="" attributes="{'groupDisplay':'none'}">
		<wea:item attributes="{'isTableList':'true','colspan':'full'}">
			...
			<%
				String tableString=""+
				   "<table datasource=\"weaver.formmode.browser.FormModeBrowserDataSource.getFormModeTableTriggerField\" sourceparams=\"htmltype:"+htmltype+"+type:"+type+"+modeId:"+modeId+"+fieldname:"+fieldname+"+tabletype:"+tabletype+"+sqlwhere:"+sqlwhere+"+isfrom:1\" instanceid=\"docMouldTable\" pagesize=\"10\" tabletype=\"none\">"+
				   ...
				   "<head>"+							 
						 ...
						 "<col width=\"40%\" transmethod=\"weaver.formmode.search.FormBrowserTransMethod.forHtml\" text=\""+SystemEnv.getHtmlLabelName(685,user.getLanguage())+"\" column=\"fieldname\"/>"+//字段名称
						 "<col width=\"30%\"  transmethod=\"weaver.formmode.search.FormBrowserTransMethod.forHtml\" column=\"tabletype\" text=\""+SystemEnv.getHtmlLabelName(26734,user.getLanguage())+"\"/>"+//所属表类型
						 "<col width=\"30%\"  text=\""+SystemEnv.getHtmlLabelName(687,user.getLanguage())+"\" column=\"htmltype\"  otherpara=\"column:type"+"+"+user.getLanguage()+"+"+"column:fieldid"+"\" transmethod=\"weaver.formmode.search.FormBrowserTransMethod.getFieldShowType\"  />"+
						 "<col width=\"0%\"  hide=\"true\" transmethod=\"weaver.formmode.search.FormBrowserTransMethod.forHtml\" text=\"\" column=\"detailindex\" name=\"detailindex\" />"+
						 "<col width=\"0%\" hide=\"true\"  transmethod=\"weaver.formmode.search.FormBrowserTransMethod.forHtml\" text=\"\" column=\"tempoption\" name=\"tempoption\"/>"+
				   "</head>"+
				   "</table>";
			%>
...
function afterDoWhenLoaded(){
	...
	jQuery(".ListStyle").children("tbody").find("tr[class!='Spacing']").bind("click",function(){
		...
		var returnjson = {
			...
			options:$(this).find("td[name='tempoption']").text(),
			isdetail:$(this).find("td[name='detailindex']").text(),
			tabletype:tabletype,
		};
		if(dialog){

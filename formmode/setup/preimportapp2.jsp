...
String importmodel = StringHelper.null2String(request.getParameter("importmodel"));
...
<div id="appPart3" class="appPart">
	<div class="elementPart">
		<div class="title">
		<%=StringHelper.isEmpty(importmodel)?SystemEnv.getHtmlLabelName(81994,user.getLanguage()):SystemEnv.getHtmlLabelName(81995,user.getLanguage())%><!-- "导入应用":"导入模块" -->
		</div>
		<div class="content">
			<div class="filecontent">
				<FORM style="MARGIN-TOP: 0px" name=frmMain method=post action="/formmode/import/ModeUploadOperation.jsp" enctype="multipart/form-data">
					...
					<input type="hidden" id="isAppImport" name="isAppImport" value="<%=StringHelper.isEmpty(importmodel)?"1":""%>"/>
				</FORM>
			</div>
			<div class="desc">
				<%if(operatelevel>0){%>

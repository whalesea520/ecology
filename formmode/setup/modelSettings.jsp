...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			var url = "";
			//if(currModelId != null){
				url = "/formmode/setup/modelInfo.jsp?id="+currModelId+"&appId="+<%=appId%>;	
			//}
			...
			currentDatas = datas;
			doSearchTextChange();
			changeRightFrameUrl(currModelId);
		});
		...
		function refreshModeOperationDel(){
			refreshData("delBack");
		}
...
<body>
	...
	<%
		if(operatelevel>0){
			RCMenu += "{"+SystemEnv.getHtmlLabelName(28349,user.getLanguage())+",javascript:createModel(),_top} " ;//新建模块

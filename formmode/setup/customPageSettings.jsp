	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			//if(customPageId != null){
				url = "/formmode/setup/customPageInfo.jsp?id="+customPageId+"&appid=<%=appId%>";	
			//}
		...
		function changeRightFrameUrl(id, AElement){
			...
			$("#rightFrame").attr("src", "/formmode/setup/customPageInfo.jsp?id="+id+"&appid=<%=appId%>");
		}
		...
		function refreshData(){
			var url = "/formmode/setup/customPageSettingsAction.jsp?operation=getCustomPageByModeIdWithJSON&appid=<%=appId%>&fmdetachable=<%=fmdetachable%>&subCompanyId=<%=currentSubCompanyId%>";
		...
		function onCreate() {
			...
			$("#rightFrame").attr("src","/formmode/setup/customPageInfo.jsp?appid=<%=appId%>");
		}

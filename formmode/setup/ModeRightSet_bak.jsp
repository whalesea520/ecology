...
<!--开始-->
  <table class="viewform">
    ...
    <COL width="20%">
	<COL width="80%">
    <TR class="Title"><Th colSpan=2><%=SystemEnv.getHtmlLabelName(68,user.getLanguage())%></Th></TR>
    ...
    <TR id=showlevel name=showlevel style="display:none;height: 1px">
...
function onShowRelated(inputname,spanname,type){
	...
	if(datas != undefined && datas != 'undefined'){
		var ids = "";
		var names = "";
		if(datas.id != ''){
			if(sharetype != '4'){

...
String expenddesc = InterfaceTransmethod.toHtmlForMode(request.getParameter("expenddesc"));
...
if (operation.equals("add")) {
	sql = "insert into mode_pageexpand(modeid,expendname,showtype,opentype,hreftype,hrefid,hreftarget,isshow,showorder,issystem,isbatch,expenddesc) ";
	sql += "values ("+modeid+",'"+expendname+"','"+showtype+"','"+opentype+"','"+hreftype+"','"+hrefid+"','"+hreftarget+"','"+isshow+"','"+showorder+"','"+issystem+"',1,'"+expenddesc+"')";
	rs.executeSql(sql);
	...
	response.sendRedirect("/formmode/batchoperate/ModeBatchEdit.jsp?id="+id);
	//response.sendRedirect("/formmode/batchoperate/ModeBatch.jsp?modeid="+modeid);
	...
	sb.append("expenddesc = '" + expenddesc+"',");

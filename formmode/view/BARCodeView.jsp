...
String url = "/formmode/view/BARCodeViewIframe.jsp?modeId="+modeId+"&formId="+formId+"&customId="+customid+"&billId="+billid;
...
$(function(){
    $('.e8_box').Tabs({
        ...
        staticOnLoad:true,
        objName:"<%=SystemEnv.getHtmlLabelName(1362 ,user.getLanguage()) %>" //二维码
    });

...
<%@page import="weaver.formmode.setup.ExpandBaseRightRuleBusiness"%><!DOCTYPE html>
...
var dialog = window.parent.parent.getDialog(parent);
    ...
    <body>
		...
		<input type="hidden" id="expandid" value="<%=expandId %>"/>

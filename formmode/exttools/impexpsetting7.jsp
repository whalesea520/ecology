...
function settingRight(id, typeid, type){
	if(type==0){
		document.all.contentframe.src = "impexp7.jsp?id="+id;
	}else{
		document.all.contentframe.src = "impexp7.jsp?appId="+id;
	}
}
</script>
</HEAD>
...
<IFRAME name=leftframe id=leftframe src="impexpleft7.jsp?treeFieldId=<%=treeFieldId%>&err=<%=err%>" width="100%" height="100%" frameborder=no scrolling=auto>

...
<html>
  ...
  RCMenu += "{"+SystemEnv.getHtmlLabelName(18016,user.getLanguage())+",javascript:onNormal(this),_self} " ;//普通模式
  RCMenuHeight += RCMenuHeightStep ;
	    ...
	    <TABLE class=ViewForm>
			...
			<TBODY>
				...
				<tr>
				  ...
				  <td class=Field>
					<input type="radio" name="customModule" value="1" onClick="onChangeModule(this);" checked><%=SystemEnv.getHtmlLabelName(58,user.getLanguage())%><!-- 文档 -->
					<input type="radio" name="customModule" value="2" onClick="onChangeModule(this);"><%=SystemEnv.getHtmlLabelName(18015,user.getLanguage())%><!-- 流程 -->
					<input type="radio" name="customModule" value="3" onClick="onChangeModule(this);"><%=SystemEnv.getHtmlLabelName(136,user.getLanguage())%><!-- 客户 -->
					<input type="radio" name="customModule" value="4" onClick="onChangeModule(this);"><%=SystemEnv.getHtmlLabelName(101,user.getLanguage())%><!-- 项目 -->
				  </td>
				</tr>
                <TR><TD class=Line colSpan=2></TD></TR>
			...
			<TBODY>
				<tr>
				  ...
				  <td class=Field>
					...
					<input type="radio" name="displayUsage_2" value="0" checked><%=SystemEnv.getHtmlLabelName(320,user.getLanguage())%><!-- 列表 -->
					<input type="radio" name="displayUsage_2" value="1" ><%=SystemEnv.getHtmlLabelName(19064,user.getLanguage())%><!-- 缩略图 -->
			...
			<TBODY>
				<tr>
				  ...
				  <td class=Field>
					...
					<input type="radio" name="displayUsage_3" value="0" checked><%=SystemEnv.getHtmlLabelName(320,user.getLanguage())%><!-- 列表 -->
					<input type="radio" name="displayUsage_3" value="1" ><%=SystemEnv.getHtmlLabelName(19064,user.getLanguage())%><!-- 缩略图 -->
			...
			<TBODY>
				<tr>
				  ...
				  <td class=Field>
					...
					<input type="radio" name="displayUsage_4" value="0" checked><%=SystemEnv.getHtmlLabelName(320,user.getLanguage())%><!-- 列表 -->
					<input type="radio" name="displayUsage_4" value="1" ><%=SystemEnv.getHtmlLabelName(19064,user.getLanguage())%><!-- 缩略图 -->
...
function onNormal(obj){
	location.href="LeftMenuMaintenanceAdd.jsp?id=<%=infoId%>&resourceId=<%=resourceId%>&resourceType=<%=resourceType%>";
	obj.disabled=true;
}

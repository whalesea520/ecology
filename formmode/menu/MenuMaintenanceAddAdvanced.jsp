	...
	<tr>
	    ...
	    <TABLE class=ViewForm>
			...
			<TBODY>
                ...
                <TR class=Title>
				  <TH><%=SystemEnv.getHtmlLabelName(1361,user.getLanguage())%></TH><!-- 基本信息 -->
				  <TH><%if(!"3".equals(resourceType)){%><div  align="right"><%=SystemEnv.getHtmlLabelName(20827,user.getLanguage())%><!-- 引用此菜单到下级分部 --><input type="checkbox" value="1" id="chkSynch" name="chkSynch"> &nbsp;</div><%}%></TH>
				</TR>
				...
				<tr>
				  <td><%=SystemEnv.getHtmlLabelName(20592,user.getLanguage())%></td><!-- 菜单图标 -->
				  <td class=Field>				  

...
<%
	...
	String url = "/formmode/cuspage/cpt/conf/cptdeprecationconftab.jsp?"+queryString;
	String title = SystemEnv.getHtmlLabelName(125865,user.getLanguage());
...
<script type="text/javascript">
	$(function(){
		setTabObjName("<%=SystemEnv.getHtmlLabelName(125865,user.getLanguage()) %>");
	});
</script>
</BODY>
</HTML>

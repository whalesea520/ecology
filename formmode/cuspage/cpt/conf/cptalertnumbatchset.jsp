...
<wea:layout>
	<wea:group context='<%=SystemEnv.getHtmlLabelName(1361,user.getLanguage())%>'>
		<wea:item><%=SystemEnv.getHtmlLabelName(125636,user.getLanguage())%></wea:item>
		<wea:item>
				<input class="InputStyle"  id=alarm_lownum  name=alarm_lownum size="8" onchange="checkFloat(this)"  >
		</wea:item>
		<wea:item><%=SystemEnv.getHtmlLabelName(125637,user.getLanguage())%></wea:item>
		<wea:item>
				<input class="InputStyle"  id=alarm_highnum  name=alarm_highnum size="8" onchange="checkFloat(this)"  >
		</wea:item>
		<wea:item><%=SystemEnv.getHtmlLabelName(125638,user.getLanguage())%></wea:item>
		<wea:item>
				<input class="InputStyle"  id=alarm_dulldays  name=alarm_dulldays size="8" onchange="checkFloat(this)"  >
		</wea:item>
	</wea:group>

...
String tempTitle="";
if(titleid.equals("1")){
	tempTitle = SystemEnv.getHtmlLabelNames("18214,28006",user.getLanguage());   //请选择数据来源
}else if(titleid.equals("2")){
	tempTitle = SystemEnv.getHtmlLabelNames("18214,30181",user.getLanguage());  //请选择链接目标
}else{
	tempTitle = SystemEnv.getHtmlLabelNames("18214,19049",user.getLanguage()); //请选择模块
}
String params = "modename="+modename+"&formid="+formid+"&othercallback="+othercallback;
%>
 ...
 <script type="text/javascript">
	...
	<div class="e8_box demo2">
		  <div class="e8_boxhead">
		   ...
		   <div class="tab_box">
		        <div>
		            <iframe src="ModeBrowserIframe.jsp?<%=params %>" onload="if(typeof(update)=='function'){update()}" id="tabcontentframe" name="tabcontentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
		        </div>
		   </div>
	</div> 

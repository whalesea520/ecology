...
String titlename = SystemEnv.getHtmlLabelName(30542,user.getLanguage()) + ":" + SystemEnv.getHtmlLabelName(30543,user.getLanguage());//自定义浏览按钮:新建查询
String needfav ="1";
String needhelp ="";
			...
			<TABLE class="viewform">
				...
				<TBODY>
					...
					<TR>
		          		...
		          		<TD class=Field>
		        			<INPUT type=text class=Inputstyle size=30 name="Customname" maxlength="50" onchange='checkinput("Customname","Customnameimage")' value="">
					...
					<TR>
						...
						<TD class=Field>
							<textarea rows="4" style="width:80%" name="Customdesc" onkeyup="this.value = this.value.substring(0, 200)" class=Inputstyle></textarea>
						</TD>
					</TR>
                	<TR class="Spacing" style="height: 1px">
...
function doback(){
    enableAllmenu();
    location.href="/formmode/browser/CustomBrowser.jsp?modeid=<%=modeid%>&customname=<%=customname%>";
}

...
Ext.ux.form.AttachpicEditField=Ext.extend(Ext.form.TriggerField,{
	...
	,onTriggerClick:function(a){
	    ...
	    diag.InnerHtml = "<DIV style='text-align: left;padding:8px 8px 8px 18px;color: #929393;'>"
	    	+"<div style='padding-bottom:5px;'><span style='display:inline-block;width:98px;text-align:right;'>每行显示图片数：</span><INPUT onblur=\"checkPlusnumber1(this)\" class=\"inputstyle\" onkeypress=\"ItemPlusCount_KeyPress()\" maxLength=\"3\" size=\"27\" id=\"strlength_"+theRowIndex+"\"></div>"
	    	+"<div style='padding-bottom:5px;'><span style='display:inline-block;width:98px;text-align:right;'>图片宽度：</span><INPUT onblur=\"checkPlusnumber1(this)\" class=\"inputstyle\" onkeypress=\"ItemPlusCount_KeyPress()\" maxLength=\"4\" size=\"27\" id=\"imgwidth_"+theRowIndex+"\"></div>"
	    	+"<div style='padding-bottom:5px;'><span style='display:inline-block;width:98px;text-align:right;'>图片高度：</span><INPUT onblur=\"checkPlusnumber1(this)\" class=\"inputstyle\" onkeypress=\"ItemPlusCount_KeyPress()\" maxLength=\"4\" size=\"27\" id=\"imgheight_"+theRowIndex+"\"></div>"
	    	+"</DIV>";
	    diag.show();

					...
					<td align="left" colspan="3">
						<div id="sapinfodiv" style="display:none">
							<table cellpadding="0" cellspacing="2" border="0">
								<tr>
									<td rowspan="2"><a href="javascript:insertSAPInfo(1)"><%=SystemEnv.getHtmlLabelName(33415, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(30686, user.getLanguage()) %></a>&nbsp;&nbsp;</td>
									
									<td><a href="javascript:insertSAPInfo(2)"><%=SystemEnv.getHtmlLabelName(33415, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(28245, user.getLanguage()) %></a>&nbsp;&nbsp;</td>
									<td><a href="javascript:insertSAPInfo(3)"><%=SystemEnv.getHtmlLabelName(33415, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(30712, user.getLanguage()) %></a>&nbsp;&nbsp;</td>
									<td><a href="javascript:insertSAPInfo(4)"><%=SystemEnv.getHtmlLabelName(33415, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(28251, user.getLanguage()) %></a>&nbsp;&nbsp;</td>
									<td><a href="javascript:insertSAPInfo(5)"><%=SystemEnv.getHtmlLabelName(33415, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(128050, user.getLanguage()) %></a>&nbsp;&nbsp;</td>
									<td><a href="javascript:insertSAPInfo(6)"><%=SystemEnv.getHtmlLabelName(33415, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(128051, user.getLanguage()) %></a>&nbsp;&nbsp;</td>
								</tr>
								<tr>
									<td><a href="javascript:insertSAPInfo(2.5)"><%=SystemEnv.getHtmlLabelName(33415, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(128052, user.getLanguage()) %></a>&nbsp;&nbsp;</td>
									<td><a href="javascript:insertSAPInfo(3.5)"><%=SystemEnv.getHtmlLabelName(33415, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(30712, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(83842, user.getLanguage()) %></a>&nbsp;&nbsp;</td>
									<td><a href="javascript:insertSAPInfo(4.5)"><%=SystemEnv.getHtmlLabelName(33415, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(554, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(31901, user.getLanguage()) %></a>&nbsp;&nbsp;</td>
									<td><a href="javascript:insertSAPInfo(5.5)"><%=SystemEnv.getHtmlLabelName(33415, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(83823, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(31149, user.getLanguage()) %></a>&nbsp;&nbsp;</td>
									<td><a href="javascript:insertSAPInfo(6.5)"><%=SystemEnv.getHtmlLabelName(33415, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(83823, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(31901, user.getLanguage()) %></a>&nbsp;&nbsp;</td>
								</tr>
							</table>
						</div>
...
function insertSAPInfo(type){
	...
	if(type == 2){
		if(fieldattr.indexOf('InputParams:') != -1){
			textval = ",{SAPParamName:'<%=SystemEnv.getHtmlLabelName(84095, user.getLanguage()) %>',FromOAField:'<%=SystemEnv.getHtmlLabelName(30607, user.getLanguage()) %>'} ";
		}else{
			textval = "InputParams:[{SAPParamName:'<%=SystemEnv.getHtmlLabelName(84095, user.getLanguage()) %>',FromOAField:'<%=SystemEnv.getHtmlLabelName(30607, user.getLanguage()) %>'} ], ";
		}
	}
	if(type == 2.5){
		if(fieldattr.indexOf('OutputParams:') != -1){
			textval = ",{SAPParamName:'<%=SystemEnv.getHtmlLabelName(128055, user.getLanguage()) %>',TOOAField:'<%=SystemEnv.getHtmlLabelName(128056, user.getLanguage()) %>'} ";
		}else{
			textval = "OutputParams:[{SAPParamName:'<%=SystemEnv.getHtmlLabelName(128055, user.getLanguage()) %>',TOOAField:'<%=SystemEnv.getHtmlLabelName(128056, user.getLanguage()) %>'} ], ";
		}
	}
	
	if(type == 3){
		if(fieldattr.indexOf('InputTables:') != -1){
			textval = ",{TableName:'<%=SystemEnv.getHtmlLabelName(128057, user.getLanguage()) %>',Fields:[{SAPFieldName:'<%=SystemEnv.getHtmlLabelName(128057, user.getLanguage()) %>',FromOAField:'<%=SystemEnv.getHtmlLabelName(30607, user.getLanguage()) %>'} ]} ";
		}else{
			textval = "InputTables:[{TableName:'<%=SystemEnv.getHtmlLabelName(128057, user.getLanguage()) %>',Fields:[{SAPFieldName:'<%=SystemEnv.getHtmlLabelName(128057, user.getLanguage()) %>',FromOAField:'<%=SystemEnv.getHtmlLabelName(30607, user.getLanguage()) %>'} ]} ], ";
		}
	}
	if(type == 3.5){
		textval = ",{SAPFieldName:'<%=SystemEnv.getHtmlLabelName(128057, user.getLanguage()) %>',FromOAField:'<%=SystemEnv.getHtmlLabelName(30607, user.getLanguage()) %>'} ";
	}
	
	
	if(type == 4){
		if(fieldattr.indexOf('InputStructs:') != -1){
			textval = ",{StructName:'<%=SystemEnv.getHtmlLabelName(128058, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(30668, user.getLanguage()) %>',Fields:[{SAPFieldName:'<%=SystemEnv.getHtmlLabelName(128058, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(31901, user.getLanguage()) %>',FromOAField:'<%=SystemEnv.getHtmlLabelName(30607, user.getLanguage()) %>'} ]} ";
		}else{
			textval = "InputStructs:[{StructName:'<%=SystemEnv.getHtmlLabelName(128058, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(30668, user.getLanguage()) %>',Fields:[{SAPFieldName:'<%=SystemEnv.getHtmlLabelName(128058, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(31901, user.getLanguage()) %>',FromOAField:'<%=SystemEnv.getHtmlLabelName(30607, user.getLanguage()) %>'} ]} ], ";
		}
	}
	if(type == 4.5){
		textval = ",{SAPFieldName:'<%=SystemEnv.getHtmlLabelName(128058, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(31901, user.getLanguage()) %>',FromOAField:'<%=SystemEnv.getHtmlLabelName(30607, user.getLanguage()) %>'} ";
	}
	
	
	if(type == 5){
		if(fieldattr.indexOf('OutputTables:') != -1){
			textval = ",{TableName:'SAP<%=SystemEnv.getHtmlLabelName(83823, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(30671, user.getLanguage()) %>',Fields:[{SAPFieldName:'SAP<%=SystemEnv.getHtmlLabelName(83823, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(31149, user.getLanguage()) %>',TOOAField:'<%=SystemEnv.getHtmlLabelName(128056, user.getLanguage()) %>'} ]} ";
		}else{
			textval = "OutputTables:[{TableName:'SAP<%=SystemEnv.getHtmlLabelName(83823, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(30671, user.getLanguage()) %>',Fields:[{SAPFieldName:'SAP<%=SystemEnv.getHtmlLabelName(83823, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(31149, user.getLanguage()) %>',TOOAField:'<%=SystemEnv.getHtmlLabelName(128056, user.getLanguage()) %>'} ]} ], ";
		}
	}
	if(type == 5.5){
		textval = ",{SAPFieldName:'SAP<%=SystemEnv.getHtmlLabelName(83823, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(31149, user.getLanguage()) %>',TOOAField:'<%=SystemEnv.getHtmlLabelName(128056, user.getLanguage()) %>'} ";
	}
	
	
	if(type == 6){
		if(fieldattr.indexOf('OutputStructs:') != -1){
			textval = ",{StructName:'SAP<%=SystemEnv.getHtmlLabelName(83823, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(30668, user.getLanguage()) %>',Fields:[{SAPFieldName:'SAP<%=SystemEnv.getHtmlLabelName(1290, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(31901, user.getLanguage()) %>',TOOAField:'<%=SystemEnv.getHtmlLabelName(128056, user.getLanguage()) %>'} ]} ";
		}else{
			textval = "OutputStructs:[{StructName:'SAP<%=SystemEnv.getHtmlLabelName(83823, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(30668, user.getLanguage()) %>',Fields:[{SAPFieldName:'SAP<%=SystemEnv.getHtmlLabelName(1290, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(31901, user.getLanguage()) %>',TOOAField:'<%=SystemEnv.getHtmlLabelName(128056, user.getLanguage()) %>'} ]} ], ";
		}
	}
	if(type == 6.5){
		textval = ",{SAPFieldName:'SAP<%=SystemEnv.getHtmlLabelName(83823, user.getLanguage()) %><%=SystemEnv.getHtmlLabelName(31901, user.getLanguage()) %>',TOOAField:'<%=SystemEnv.getHtmlLabelName(128056, user.getLanguage()) %>'} ";
	}
	insertIntoTextarea(textval);
}

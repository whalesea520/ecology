...
(function() {
            ...
            var a = {timestamp: 'B8DJ5M3',version: '3.6.2',revision: '7275',_: {},status: 'unloaded',basePath: (function() {
                    ...
                    if (!d) {
                        ...
                        for (var f = 0; f < e.length; f++) {
                            var g = e[f].src.match(/(^|.*[\\\/])ckeditor_wev8(?:_basic)?(?:_source)?.js(?:\?.*)?$/i);
                            if (g) {
                                d = g[1];
                                break;
                            }
    ...
    if (a.status == 'unloaded')
        (function() {
            ...
            a.loadFullCore = function() {
                ...
                e.src = a.basePath + 'ckeditor_wev8.js';
    ...
    e.extend(g.prototype, {appendStyleSheet: function(h) {
            if ((!jQuery.browser.msie || (jQuery.browser.msie && jQuery.browser.version > 8 && false)) && this.$.createStyleSheet)
    ...
    e.extend(h.prototype, {type: 1,addClass: function(i) {
            ...
            var l = this;
            var j = l.getName();
            if (l.isReadOnly() || l.getComputedStyle('display') == 'none' || l.getComputedStyle('visibility') == 'hidden' || f.$nonEditable[j])
                return false;
            if (i !== false) {
                var k = f[j] || f.span;
                return k && k['#'];
    ...
    a.ENTER_BR = 2;
    a.ENTER_DIV = 3;
    a.config = {customConfig: 'config_wev8.js',autoUpdateElement: true,baseHref: '',contentsCss: a.basePath + 'contents_wev8.css',contentsLangDirection: 'ui',contentsLanguage: '',language: '',defaultLanguage: 'en',enterMode: 1,forceEnterMode: false,shiftEnterMode: 2,corePlugins: '',docType: '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">',bodyId: '',bodyClass: '',fullPage: false,height: 200,plugins: 'about,a11yhelp,basicstyles,bidi,blockquote,button,clipboard,colorbutton,colordialog,contextmenu,dialogadvtab,div,elementspath,enterkey,entities,filebrowser,find,flash,font,format,forms,horizontalrule,htmldataprocessor,iframe,image,indent,justify,keystrokes,link,list,liststyle,maximize,newpage,pagebreak,pastefromword,pastetext,popup,preview,print,removeformat,resize,save,scayt,smiley,showblocks,showborders,sourcearea,stylescombo,table,tabletools,specialchar,tab,templates,toolbar,undo,wysiwygarea,wsc',extraPlugins: '',removePlugins: '',protectedSource: [],tabIndex: 0,theme: 'default',skin: 'kama',width: '',baseFloatZIndex: 10000};
    var i = a.config;
    ...
    (function() {
        ...
        a.lang = {languages: {af: 1,ar: 1,bg: 1,bn: 1,bs: 1,ca: 1,cs: 1,cy: 1,da: 1,de: 1,el: 1,'en-au': 1,'en-ca': 1,'en-gb': 1,en: 1,eo: 1,es: 1,et: 1,eu: 1,fa: 1,fi: 1,fo: 1,'fr-ca': 1,fr: 1,gl: 1,gu: 1,he: 1,hi: 1,hr: 1,hu: 1,is: 1,it: 1,ja: 1,ka: 1,km: 1,ko: 1,lt: 1,lv: 1,mn: 1,ms: 1,nb: 1,nl: 1,no: 1,pl: 1,'pt-br': 1,pt: 1,ro: 1,ru: 1,sk: 1,sl: 1,'sr-latn': 1,sr: 1,sv: 1,th: 1,tr: 1,uk: 1,vi: 1,'zh-cn': 1,zh: 1},load: function(k, l, m) {
                if (!k || !a.lang.languages[k])
                    k = this.detect(l, k);
                if (!this[k])
                    a.scriptLoader.load(a.getUrl('lang/' + k + '_wev8.js'), function() {
                        m(k, this[k]);
                    }, this);
                else
                    m(k, this[k]);
    ...
    a.plugins = new a.resourceManager('plugins/', 'plugin_wev8');
    var j = a.plugins;
    var _theE = e;
    ...
    a.skins = (function() {
        ...
        return {add: function(n, o) {
                ...
                if (k[q])
                    ...
                    l[q] = r;
                    a.scriptLoader.load(a.getUrl(r + 'skin_wev8.js'), function() {
                        m(n, q, o, p);
                    });
                }
            }};
                ...
                for (var H in D) {
                    ...
                    if (J) {
                        ...
                        if (!I.langEntries || !I.langEntries[L])
                            G.push(a.getUrl(K + 'lang/' + L + '_wev8.js'));
                        else {
            ...
            while (s) {
                if (s.type == 1) {
                    if (!u.lastElement)
                        u.lastElement = s;
                    var t = s.getName();
                    if (c && s.$.scopeName && s.$.scopeName != 'HTML')
    ...
    (function() {
        ...
        function o(t) {
            ...
            return function(w) {
                if (v(w))
                    return true;
                if (w.type == 3) {
                    if (w.hasAscendant('pre') || e.trim(w.getText()).length)
                        return false;
                } else if (w.type == 1)
                    if (!n[w.getName()])
        ...
        d.range.prototype = {clone: function() {
                    ...
                    while (u) {
                        if (u.type == 1)
                            if (u.getAttribute('contentEditable') == 'false' && !u.data('cke-editable'))
                                return 0;
                            else if (u.is('html') || u.getAttribute('contentEditable') == 'true' && (u.contains(v) || u.equals(v)))
                                break;
                        u = u.getParent();
                    }
                    return 1;
                ...
                function v(x, y) {
                    var z;
                    if (x.type == 1 && x.isEditable(false) && !f.$nonEditable[x.getName()])
                        z = x[u ? 'getLast' : 'getFirst'](s);
                    if (!y && !z)
                        z = x[u ? 'getPrevious' : 'getNext'](s);
                    return z;
                }
                ;
                var w = 0;
    ...
    a.skins.add('kama', (function() {
        var m = 'cke_ui_color';
        return {editor: {css: ['editor_wev8.css']},dialog: {css: ['dialog_wev8.css']},richcombo: {canGroup: false},templates: {css: ['templates_wev8.css']},margins: [0, 0, 0, 0],init: function(n) {
    ...
    j.add('about', {requires: ['dialog'],init: function(m) {
            ...
            a.dialog.add('about', this.path + 'dialogs/about_wev8.js');
        }});
    (function() {
        ...
        j.add(m, {availableLangs: {en: 1,he: 1},init: function(o) {
                ...
                o.addCommand(n, {exec: function() {
                        ...
                        a.scriptLoader.load(a.getUrl(p.path + 'lang/' + q + '_wev8.js'), function() {
                            e.extend(o.lang, p.langEntries[q]);
                            o.openDialog(n);
                        });
                    },modes: {wysiwyg: 1,source: 1},readOnly: 1,canUndo: false});
                a.dialog.add(n, this.path + 'dialogs/a11yhelp_wev8.js');
            }});
    })();
    ...
    (function() {
        ...
        j.add('clipboard', {requires: ['dialog', 'htmldataprocessor'],init: function(y) {
                ...
                z('Paste', 'paste', p, 8);
                a.dialog.add('paste', a.getUrl(this.path + 'dialogs/paste_wev8.js'));
                y.on('key', q, y);
                y.on('contentDom', function() {
                    ...
                    A.on(b.webkit ? 'paste' : 'beforepaste', function(B) {
                        ...
                        s.call(y, B, C.mode, function(D) {
                            if (!(D = e.trim(D.replace(/<span[^>]+data-cke-bookmark[^<]*?<\/span>/ig, ''))))
                                return;
                            var E = {};
                            E[C.mode] = D;
                            y.fire('paste', E);
    ...
    j.colordialog = {init: function(m) {
            ...
            a.dialog.add('colordialog', this.path + 'dialogs/colordialog_wev8.js');
        }};
    ...
    (function() {
        j.add('div', {requires: ['editingblock', 'domiterator', 'styles'],init: function(m) {
                ...
                a.dialog.add('creatediv', this.path + 'dialogs/div_wev8.js');
                a.dialog.add('editdiv', this.path + 'dialogs/div_wev8.js');
            }});
    })();
    (function() {
    ...
    j.add('find', {init: function(m) {
            ...
            p.canUndo = false;
            a.dialog.add('find', this.path + 'dialogs/find_wev8.js');
            a.dialog.add('replace', this.path + 'dialogs/find_wev8.js');
        },requires: ['styles']});
    ...
    (function() {
        ...
        j.add('flash', {init: function(p) {
                ...
                a.dialog.add('flash', this.path + 'dialogs/flash_wev8.js');
                p.addCss('img.cke_flash{background-image: url(' + a.getUrl(this.path + 'images/placeholder_wev8.png') + ');' + 'background-position: center center;' + 'background-repeat: no-repeat;' + 'border: 1px solid #a9a9a9;' + 'width: 80px;' + 'height: 80px;' + '}');
                if (p.addMenuItems)
    ...
    j.add('forms', {init: function(m) {
            ...
            m.addCss('img.cke_hidden{background-image: url(' + a.getUrl(this.path + 'images/hiddenfield_wev8.gif') + ');' + 'background-position: center center;' + 'background-repeat: no-repeat;' + 'border: 1px solid #a9a9a9;' + 'width: 16px !important;' + 'height: 16px !important;' + '}');
            ...
            o('Form', 'form', p + 'form_wev8.js');
            o('Checkbox', 'checkbox', p + 'checkbox_wev8.js');
            o('Radio', 'radio', p + 'radio_wev8.js');
            o('TextField', 'textfield', p + 'textfield_wev8.js');
            o('Textarea', 'textarea', p + 'textarea_wev8.js');
            o('Select', 'select', p + 'select_wev8.js');
            o('Button', 'button', p + 'button_wev8.js');
            o('ImageButton', 'imagebutton', j.getPath('image') + 'dialogs/image_wev8.js');
            o('HiddenField', 'hiddenfield', p + 'hiddenfield_wev8.js');
            if (m.addMenuItems)
                m.addMenuItems({form: {label: n.form.menu,command: 'form',group: 'form'},checkbox: {label: n.checkboxAndRadio.checkboxTitle,command: 'checkbox',group: 'checkbox'},radio: {label: n.checkboxAndRadio.radioTitle,command: 'radio',group: 'radio'},hiddenfield: {label: n.hidden.title,command: 'hiddenfield',group: 'hiddenfield'},imagebutton: {label: n.image.titleButton,command: 'imagebutton',group: 'imagebutton'},button: {label: n.button.title,command: 'button',group: 'button'},select: {label: n.select.title,command: 'select',group: 'select'},textarea: {label: n.textarea.title,command: 'textarea',group: 'textarea'}});
            if (m.contextMenu) {
    ...
    (function() {
        var m = {canUndo: false,exec: function(o) {
                ...
                var r = p.getNext();
                if (!r || r.type == 1 && !r.isEditable())
                    q.fixBlock(true, o.config.enterMode == 3 ? 'div' : 'p');
                q.select();
            }}, n = 'horizontalrule';
    ...
    (function() {
        j.add('iframe', {requires: ['dialog', 'fakeobjects'],init: function(m) {
                ...
                a.dialog.add(n, this.path + 'dialogs/iframe_wev8.js');
                m.addCommand(n, new a.dialogCommand(n));
                m.addCss('img.cke_iframe{background-image: url(' + a.getUrl(this.path + 'images/placeholder_wev8.png') + ');' + 'background-position: center center;' + 'background-repeat: no-repeat;' + 'border: 1px solid #a9a9a9;' + 'width: 80px;' + 'height: 80px;' + '}');
    ...
    j.add('link', {init: function(m) {
            ...
            a.dialog.add('link', this.path + 'dialogs/link_wev8.js');
            a.dialog.add('anchor', this.path + 'dialogs/anchor_wev8.js');
            var n = m.lang.dir == 'rtl' ? 'right' : 'left', o = 'background:url(' + a.getUrl(this.path + 'images/anchor_wev8.gif') + ') no-repeat ' + n + ' center;' + 'border:1px dotted #00f;';
    ...
    (function() {
        ...
        j.list = {listToArray: function(G, H, I, J, K) {
                ...
                for (var L = 0, M = G.getChildCount(); L < M; L++) {
                    var N = G.getChild(L);
                    if (N.type == 1 && N.getName() in f.$list)
                        j.list.listToArray(N, H, I, J + 1);
                    if (N.$.nodeName.toLowerCase() != 'li')
                        continue;
                    var O = {parent: G,indent: J,element: N,contents: []};
                    if (!K) {
                        O.grandparent = G.getParent();
                        if (O.grandparent && O.grandparent.$.nodeName.toLowerCase() == 'li')
                            O.grandparent = O.grandparent.getParent();
                    } else
                        O.grandparent = K;
                    if (H)
                        h.setMarker(H, N, 'listarray_index', I.length);
                    I.push(O);
                    for (var P = 0, Q = N.getChildCount(), R; P < Q; P++) {
                        R = N.getChild(P);
                        if (R.type == 1 && m[R.getName()])
                            j.list.listToArray(R, H, I, J + 1, O.grandparent);
                        else
                            O.contents.push(R);
                    }
                }
                ...
                while (1) {
                    ...
                    if (T.indent == P) {
                        ...
                        if (R != N.getDirection(1))
                            Q.setAttribute('dir', R);
                        for (var U = 0; U < T.contents.length; U++)
                            Q.append(T.contents[U].clone(1, 1));
                        O++;
                    } else if (T.indent == Math.max(P, 0) + 1) {
                        var V = G[O - 1].element.getDirection(1), W = j.list.arrayToList(G, null, O, J, V != R ? R : null);
                        if (!Q.getChildCount() && c && !(L.$.documentMode > 7))
                            Q.append(L.createText('\xa0'));
                        Q.append(W.listNode);
                        O = W.nextIndex;
                    } else if (T.indent == -1 && !I && T.grandparent) {
                        if (m[T.grandparent.getName()])
                            Q = T.element.clone(false, true);
                        else if (K || T.element.hasAttributes() || J != 2) {
                            Q = L.createElement(S);
                            T.element.copyAttributes(Q, {type: 1,value: 1});
                            if (!K && J == 2 && !Q.hasAttributes())
                                Q = new d.documentFragment(L);
                        } else
                            Q = new d.documentFragment(L);
                        if (Q.type == 1)
                            if (T.grandparent.getDirection(1) != R)
                                Q.setAttribute('dir', R);
                        for (U = 0; U < T.contents.length; U++)
                            Q.append(T.contents[U].clone(1, 1));
                        if (Q.type == 11 && O != G.length - 1) {
                            var X = Q.getLast();
                            if (X && X.type == 1 && X.getAttribute('type') == '_moz')
                                X.remove();
                            if (!(X = Q.getLast(q) && X.type == 1 && X.getName() in f.$block))
                                Q.append(L.createElement('br'));
                        }
                        ...
                        return null;
                    if (G.length <= O || Math.max(G[O].indent, 0) < P)
                        break;
                }
                if (H) {
        ...
        function t(G, H, I, J) {
            ...
            for (var M = 0; M < H.contents.length; M++) {
                ...
                if (!N || N.getCustomData('list_item_processed'))
                    continue;
                L.push(N);
        ...
        function v(G, H, I) {
            ...
            for (var O = 0; O < J.length; O++)
                N = N.getCommonAncestor(J[O].getParent());
        ...
        function w(G, H, I) {
            ...
            for (var L = 0; L < H.contents.length; L++) {
                ...
                if (!M || M.getCustomData('list_item_processed'))
                    continue;
                K.push(M);
            ...
            function V(W) {
                if ((T = S[W ? 'getFirst' : 'getLast']()) && !(T.is && T.isBlockBoundary()) && (U = H.root[W ? 'getPrevious' : 'getNext'](d.walker.whitespaces(true))) && !(U.is && U.isBlockBoundary({br: 1})))
        ...
        function y(G) {
            ...
            if (H) {
                for (var I = 0, J = G.getChildren(), K; K = J.getItem(I), I < J.count(); I++) {
                    if (K.type == 1 && K.is('li') && !K.getDirection())
        ...
        x.prototype = {exec: function(G) {
                ...
                while ((M = R.getNextRange()) && ++S) {
                    ...
                    if (U.type == 1 && U.getName() == 'td')
                        M.setStartAt(T.startNode, 1);
                    if (V.type == 1 && V.getName() == 'td')
                        M.setEndAt(T.endNode, 2);
                    var W = M.createIterator(), X;
                    W.forceBrBreak = this.state == 2;
                    while (X = W.getNextParagraph()) {
                        if (X.getCustomData('list_block'))
                            continue;
                        else
                            h.setMarker(Q, X, 'list_block', 1);
                        ...
                        if (ac)
                            continue;
                        var ah = ad;
                        if (ah.getCustomData('list_group_object_' + S))
                            ah.getCustomData('list_group_object_' + S).contents.push(X);
                        else {
                ...
                while (P.length > 0) {
                    ag = P.shift();
                    if (this.state == 2) {
                        if (m[ag.root.getName()])
                            t.call(this, G, ag, Q, ai);
                        else
                            v.call(this, G, ag, ai);
                    } else if (this.state == 1 && m[ag.root.getName()])
                        w.call(this, G, ag, Q);
                }
                for (af = 0; af < ai.length; af++) {
                    ...
                    (aj = function(al) {
                        ...
                        if (am && am.getName && am.getName() == ak.type) {
                            if (am.getDirection(1) != ab.getDirection(1))
                                y(ab.getDirection() ? ab : am);
                            am.remove();
        ...
        function C(G) {
            return function(H) {
                ...
                if (L && (L.name && L.name == 'br' || L.value && (M = L.value.match(A)))) {
                    var N = L;
                    if (!(M && M.index) && N == I[0])
                        I[0] = G || c ? new a.htmlParser.text('\xa0') : new a.htmlParser.element('br', {});
                    else if (N.name == 'br')
                        I.splice(J - 1, 1);
                    else
                        N.value = N.value.replace(A, '');
                }
            };
        }
        ;
        var D = {elements: {}};
        for (var E in z.$listItem)
            D.elements[E] = C();
        var F = {elements: {}};
        for (E in z.$listItem)
            F.elements[E] = C(true);
    ...
    (function() {
        j.liststyle = {requires: ['dialog'],init: function(m) {
                ...
                a.dialog.add('numberedListStyle', this.path + 'dialogs/liststyle_wev8.js');
                m.addCommand('bulletedListStyle', new a.dialogCommand('bulletedListStyle'));
                a.dialog.add('bulletedListStyle', this.path + 'dialogs/liststyle_wev8.js');
                if (m.addMenuItems) {
    ...
    j.add('pagebreak', {init: function(m) {
            ...
            var n = ['{', 'background: url(' + a.getUrl(this.path + 'images/pagebreak_wev8.gif') + ') no-repeat center center;', 'clear: both;', 'width:100%; _width:99.9%;', 'border-top: #999999 1px dotted;', 'border-bottom: #999999 1px dotted;', 'padding:0;', 'height: 5px;', 'cursor: default;', '}'].join('').replace(/;/g, ' !important;');
    ...
    (function() {
        ...
        j.add('pastefromword', {init: function(n) {
                ...
                if (o)
                    ...
                    var p = a.getUrl(i.pasteFromWordCleanupFile || this.path + 'filter/default_wev8.js');
    ...
    (function() {
        ...
        j.add('pastetext', {init: function(n) {
                ...
                a.dialog.add(o, a.getUrl(this.path + 'dialogs/pastetext_wev8.js'));
    ...
    (function() {
        ...
        j.scayt = {engineLoaded: false,instances: {},controlInfo: {},setControlInfo: function(t, u) {
                ...
                var v = 'svc.webspellchecker.net/scayt26/loader__base_wev8.js', w = t.config.scayt_srcUrl || u + '//' + v, x = q.parseUrl(w).path + '/';
        ...
        j.add('scayt', {requires: ['menubutton'],beforeInit: function(t) {
                ...
                a.dialog.add(m, a.getUrl(this.path + 'dialogs/options_wev8.js'));
    ...
    (function() {
        var m = '.%2 p,.%2 div,.%2 pre,.%2 address,.%2 blockquote,.%2 h1,.%2 h2,.%2 h3,.%2 h4,.%2 h5,.%2 h6{background-repeat: no-repeat;background-position: top %3;border: 1px dotted gray;padding-top: 8px;padding-%3: 8px;}.%2 p{%1p_wev8.png);}.%2 div{%1div_wev8.png);}.%2 pre{%1pre_wev8.png);}.%2 address{%1address_wev8.png);}.%2 blockquote{%1blockquote_wev8.png);}.%2 h1{%1h1_wev8.png);}.%2 h2{%1h2_wev8.png);}.%2 h3{%1h3_wev8.png);}.%2 h4{%1h4_wev8.png);}.%2 h5{%1h5_wev8.png);}.%2 h6{%1h6_wev8.png);}', n = /%1/g, o = /%2/g, p = /%3/g, q = {readOnly: 1,preserveState: true,editorFocus: false,exec: function(r) {
                this.toggleState();
                this.refresh(r);
            },refresh: function(r) {
                if (r.document) {
    ...
    j.add('table', {init: function(m) {
            ...
            a.dialog.add('table', this.path + 'dialogs/table_wev8.js');
            a.dialog.add('tableProperties', this.path + 'dialogs/table_wev8.js');
            if (m.addMenuItems)
    ...
    (function() {
        ...
        j.tabletools = {init: function(G) {
                ...
                a.dialog.add('cellProperties', this.path + 'dialogs/tableCell_wev8.js');
    ...
    j.add('specialchar', {availableLangs: {en: 1},init: function(m) {
            ...
            a.dialog.add(n, this.path + 'dialogs/specialchar_wev8.js');
            m.addCommand(n, {exec: function() {
                    var p = m.langCode;
                    p = o.availableLangs[p] ? p : 'en';
                    a.scriptLoader.load(a.getUrl(o.path + 'lang/' + p + '_wev8.js'), function() {
    ...
    (function() {
        j.add('templates', {requires: ['dialog'],init: function(o) {
                a.dialog.add('templates', a.getUrl(this.path + 'dialogs/templates_wev8.js'));
    ...
    i.templates_files = [a.getUrl('plugins/templates/templates/default_wev8.js')];
        ...
        j.add('toolbar', {init: function(o) {
                ...
                o.on('themeSpace', function(r) {
                    if (r.data.space == o.config.toolbarLocation) {
                        o.toolbox = new m();
                        var s = e.getNextId(), t = ['<div class="cke_toolbox" role="group" aria-labelledby="', s, '""'], u = o.config.toolbarStartupExpanded !== false, v;
    ...
    (function() {
        ...
        function q(C) {
            ...
            if (c) {
                ...
                M.document.$.execCommand('inserthtml', false, C);
            if (b.webkit) {
                D = M.getSelection();
                D.scrollIntoView();
            }
        ...
        function r(C) {
            ...
            G = G.replace(/\n/g, '<br>');
            if (!(F || c))
                G = G.replace(new RegExp('<br>(?=</' + H + '>)'), function(M) {
                    return e.repeat(M, 2);
                });
            if (b.gecko || b.webkit) {
                ...
                for (var K = 0; K < I.elements.length; K++) {
                    ...
                    if (L in f.$inline)
                        J.unshift(I.elements[K].getOuterHtml().match(/^<.*?>/));
                    else if (L in f.$block)
                        break;
                }
                G = J.join('') + G;
            }
        ...
        function B(C) {
            ...
            if (b.gecko) {
                ...
                if (K && K.isBlockBoundary() && !(L && L.type == 1 && L.isBlockBoundary()) && !K.is('pre') && !K.getBogus())
                    K.appendBogus();
            }
            ...
            if (!Q.blockLimit.is('body')) {
                var R;
                if (J != 2)
                    R = I.append(D.document.createElement(J == 1 ? 'p' : 'div'));
                else
                    R = I;
                if (!c)
                    R.appendBogus();
        ...
        j.add('wysiwygarea', {requires: ['editingblock'],init: function(C) {
                ...
                C.on('editingBlockReady', function() {
                    ...
                    function U(V) {
                        ...
                        if (c) {
                            ...
                            setTimeout(function() {
                                if (b.gecko && b.version >= 10900 || b.opera)
                                    W.$.body.contentEditable = Z;
                                else if (b.webkit)
                                    W.$.body.parentNode.contentEditable = Z;
                                else
                                    W.$.designMode = Z ? 'off' : 'on';
                            }, 0);
                        ...
                        if (!(c || b.opera))
                            W.on('mousedown', function(af) {
                                var ag = af.data.getTarget();
                                if (ag.is('img', 'hr', 'input', 'textarea', 'select'))
                                    C.getSelection().selectElement(ag);
                            });
                        if (b.gecko)
                        ...
                        if (c && C.config.enterMode != 1)
                            W.on('selectionchange', function() {
                                var af = W.getBody(), ag = C.getSelection().getRanges()[0];
                                if (af.getHtml().match(/^<p>&nbsp;<\/p>$/i) && ag.startContainer.equals(af))
                                    setTimeout(function() {
                        ...
                        if (C.contextMenu)
                            C.contextMenu.addTarget(W, C.config.browserContextMenuOnCtrl !== false);
                        setTimeout(function() {
                            C.fire('contentDom');
                            if (Q) {
                                C.mode = 'wysiwyg';
                    ...
                    C.addMode('wysiwyg', {load: function(V, W, X) {
                            ...
                            Q = true;
                            if (X)
                                this.loadSnapshotData(W);
                            else
                                this.loadData(W);
                        },loadData: function(V) {
                            N = true;
                            C._.dataStore = {id: 1};
                            var cssfiles = e.buildStyleHtml("/wui/theme/ecology8/skins/default/wui_wev8.css")+e.buildStyleHtml("/css/crmcss/lanlv_wev8.css");
                            var W = C.config, X = W.fullPage, Y = W.docType, Z = '<style type="text/css" data-cke-temp="1">' + C._.styles.join('\n') + '</style>';
                            !X && (Z = e.buildStyleHtml(C.config.contentsCss) + cssfiles + Z);
                            var aa = W.baseHref ? '<base href="' + W.baseHref + '" data-cke-temp="1" />' : '';
                            if (X)
                                V = V.replace(/<!DOCTYPE[^>]*>/i, function(ab) {
                                    C.docType = Y = ab;
                                    return '';
                            ...
                            if (X) {
                                ...
                                if (!/<html[\s|>]/.test(V))
                                    V = '<html>' + V + '</html>';
                                if (!/<head[\s|>]/.test(V))
                                    V = V.replace(/<html[^>]*>/, '$&<head><title></title></head>');
                                else if (!/<title[\s|>]/.test(V))
                                    V = V.replace(/<head[^>]*>/, '$&<title></title>');
                                aa && (V = V.replace(/<head>/, '$&' + aa));
                                V = V.replace(/<\/head\s*>/, Z + '$&');
                                V = Y + V;
                            } else
                                V = W.docType + '<html dir="' + W.contentsLangDirection + '"' + ' lang="' + (W.contentsLanguage || C.langCode) + '">' + '<head>' + '<title>' + E + '</title>' + aa + Z + '</head>' + '<body' + (W.bodyId ? ' id="' + W.bodyId + '"' : '') + (W.bodyClass ? ' class="' + W.bodyClass + '"' : '') + '>' + V + '</html>';
                            if (b.gecko)
                                V = V.replace(/<br \/>(?=\s*<\/(:?html|body)>)/, '$&<br type="_moz" />');
                            V += T;
                            this.onDispose();
                            S(V);
                        },getData: function() {
                            ...
                            if (b.gecko)
                                aa = aa.replace(/<br>(?=\s*(:?$|<\/body>))/, '');
                            if (C.dataProcessor)
                                aa = C.dataProcessor.toDataFormat(aa, D);
                            if (V.ignoreEmptyParagraph)
                                aa = aa.replace(m, function(ab, ac) {
                                    return ac;
                                });
                            if (Y)
                                aa = Y + '\n' + aa;
                ...
                if (a.document.$.documentMode >= 8) {
                    ...
                    var H = [];
                    for (var I in f.$removeEmpty)
                        H.push('html.CSS1Compat ' + I + '[contenteditable=false]');
    ...
    j.add('wsc', {requires: ['dialog'],init: function(m) {
            ...
            a.dialog.add(n, this.path + 'dialogs/wsc_wev8.js');
        }});
    ...
    (function() {
        ...
        function o() {
            ...
            for (var V = U - 1; V > U - T; V--) {
                if (n.call(W, W._.tabIdList[V % T]))
                    return W._.tabIdList[V % T];
            }
            return null;
        }
        ;
        ...
        function r(S, T) {
            ...
            if (U)
                S ? U.removeAttribute('aria-invalid') : U.setAttribute('aria-invalid', true);
            if (!S)
                if (V.select)
                    V.select();
                else
        ...
        a.dialog = function(S, T) {
            ...
            if (W == 'OS' && b.mac || W == 'rtl' && X == 'ltr' || W == 'ltr' && X == 'rtl')
                V.buttons.reverse();
            U = e.extend(U(S), V);
            U = e.clone(U);
            U = new y(this, U);
            ...
            if (U.onOk)
                this.on('ok', function(ar) {
                    ...
                    if (U.onOk.call(this, ar) === false)
                        ar.data.hide = false;
                });
            if (U.onCancel)
                this.on('cancel', function(ar) {
                    if (U.onCancel.call(this, ar) === false)
                        ar.data.hide = false;
                });
            ...
            this.on('cancel', function(ar) {
                ag(function(as) {
                    if (as.isChanged()) {
                        if (!confirm(S.lang.common.confirmCancel))
                            ar.data.hide = false;
                        return true;
                    }
                });
        ...
        function t(S, T, U) {
            ...
            T.on('keydown', function(V) {
                if (V.data.getKeystroke() in {32: 1,13: 1})
                    this.fire('click');
            });
            T.on('focus', function() {
                this.fire('mouseover');
        ...
        a.dialog.prototype = {destroy: function() {
                ...
                return function(S, T) {
                    var U = this;
                    if (U._.contentSize && U._.contentSize.width == S && U._.contentSize.height == T)
                        return;
                    ...
                    if (U._.editor.lang.dir == 'rtl' && U._.position)
                        U._.position.x = a.document.getWindow().getViewPaneSize().width - U._.contentSize.width - parseInt(U._.element.getFirst().getStyle('right'), 10);
                ...
                return function(T, U, V) {
                    ...
                    if (S && ac._.position && ac._.position.x == T && ac._.position.y == U)
                        return;
                ...
                if (!(S.getParent() && S.getParent().equals(a.document.getBody())))
                ...
                if (a.dialog._.currentTop === null) {
                    ...
                    for (var V in {keyup: 1,keydown: 1,keypress: 1})
                        S.on(V, R);
                } else {
                ...
                var S = arguments;
                this.foreach(function(T) {
                    if (c && this._.currentFocusIndex == T.focusIndex)
                        T.getInputElement().$.blur();
                    if (T.commit)
                        T.commit.apply(T, S);
                });
            },hide: function() {
                ...
                while (ac = ad.shift()) {
                    ab[ac.id] = ac;
                    if (typeof ac.getChild == 'function')
                        ad.push.apply(ad, ac.getChild());
                }
                ...
                if (this._.currentTabId == S)
                    return;
                if (this.fire('selectPage', {page: S,currentPage: this._.currentTabId}) === true)
                    return;
                ...
                if (!T || U._.pageCount == 1 || !T.isVisible())
                    return;
                else if (S == U._.currentTabId)
                    U.selectPage(o.call(U));
                T.hide();
                U._.pageCount--;
                U.updateStyle();
            },showPage: function(S) {
                ...
                if (typeof T == 'undefined') {
                    ...
                    for (var U = T + 1; U < V._.focusList.length; U++)
                        V._.focusList[U].focusIndex++;
                }
            }};
        e.extend(a.dialog, {add: function(S, T) {
                if (!this._.dialogDefinitions[S] || typeof T == 'function')
                    this._.dialogDefinitions[S] = T;
            },exists: function(S) {
                ...
                var S = function(T, U) {
                    ...
                    return e.extend({id: 'ok',type: 'button',label: T.lang.common.ok,'class': 'cke_dialog_ui_button_ok',onClick: function(V) {
                            var W = V.data.dialog;
                            if (W.fire('ok', {hide: true}).hide !== false)
                                W.hide();
                        }}, U, true);
                };
                S.type = 'button';
                ...
                var S = function(T, U) {
                    ...
                    return e.extend({id: 'cancel',type: 'button',label: T.lang.common.cancel,'class': 'cke_dialog_ui_button_cancel',onClick: function(V) {
                            var W = V.data.dialog;
                            if (W.fire('cancel', {hide: true}).hide !== false)
                                W.hide();
                        }}, U, true);
                };
                S.type = 'button';
        ...
        function A(S) {
            ...
            function Z(ab) {
                ...
                if (U.x + Y[3] < X)
                    ai = -Y[3];
                else if (U.x - Y[1] > ad.width - ac.width - X)
                    ai = ad.width - ac.width + (W.lang.dir == 'rtl' ? 0 : Y[1]);
                else
                    ai = U.x;
                if (U.y + Y[0] < X)
                    aj = -Y[0];
                else if (U.y - Y[2] > ad.height - ac.height - X)
                    aj = ad.height - ac.height + Y[2];
                else
                    aj = U.y;
                S.move(ai, aj, 1);
        ...
        function B(S) {
            ...
            S.on('load', function() {
                var af = '';
                if (U == 1)
                    af = ' cke_resizer_horizontal';
                else if (U == 2)
                    af = ' cke_resizer_vertical';
            ...
            function ad(af) {
                ...
                if (ap.y + am > Y.height)
                    am = Y.height - ap.y;
                if ((ag ? ao : ap.x) + al > Y.width)
                    al = Y.width - (ag ? ao : ap.x);
                if (U == 1 || U == 3)
                    aj = Math.max(T.minWidth || 0, al - W);
                if (U == 2 || U == 3)
                    ak = Math.max(T.minHeight || 0, am - X);
                S.resize(aj, ak);
                if (!S._.moved)
                    S.layout();
                af.data.preventDefault();
        ...
        var J = {}, K = function(S) {
            ...
            for (var T in J) {
                var U = J[T];
                for (var V = U.length - 1; V >= 0; V--) {
                    if (U[V].dialog == S || U[V].uiElement == S)
                        U.splice(V, 1);
                }
                if (U.length === 0)
                    delete J[T];
            ...
            if (S._.accessKeyMap[T])
                S.selectPage(S._.accessKeyMap[T]);
        }, P = function(S, T) {
        }, Q = {27: 1,13: 1}, R = function(S) {
            if (S.data.getKeystroke() in Q)
        ...
        (function() {
            k.dialog = {uiElement: function(S, T, U, V, W, X, Y) {
                    ...
                    for (ag in ab)
                        ak.push(ag + ':' + ab[ag]);
                    if (T.hidden)
                        ak.push('display:none');
                    for (ag = ak.length - 1; ag >= 0; ag--) {
                        if (ak[ag] === '')
                            ak.splice(ag, 1);
                    }
                    if (ak.length > 0)
                        ac.style = (ac.style ? ac.style + '; ' : '') + ak.join('; ');
                    for (ag in ac)
                        aa.push(ag + '="' + e.htmlEncode(ac[ag]) + '" ');
                    aa.push('>', ad, '</', Z, '>');
                    U.push(aa.join(''));
                    ...
                    if (typeof T.setValue == 'function')
                        this.setValue = e.override(this.setValue, function(an) {
                            return function(ao) {
                                an.call(this, T.setValue.call(this, ao));
                            };
                        });
                    if (typeof T.getValue == 'function')
                        this.getValue = e.override(this.getValue, function(an) {
                            return function() {
                    ...
                    if (this.accessKeyUp && this.accessKeyDown && T.accessKey)
                        M(this, S, 'CTRL+' + T.accessKey);
                    var am = this;
                    S.on('load', function() {
                    ...
                    var X = this._.children = T, Y = W && W.widths || null, Z = W && W.height || null, aa = {}, ab, ac = function() {
                        ...
                        for (ab = 0; ab < U.length; ab++) {
                            ...
                            if (ab === 0)
                                af = 'cke_dialog_ui_hbox_first';
                            if (ab == U.length - 1)
                                af = 'cke_dialog_ui_hbox_last';
                            ae.push('<td class="', af, '" role="presentation" ');
                            if (Y) {
                                if (Y[ab])
                                    ag.push('width:' + m(Y[ab]));
                            } else
                                ag.push('width:' + Math.floor(100 / U.length) + '%');
                            if (Z)
                                ag.push('height:' + m(Z));
                            if (W && W.padding != undefined)
                                ag.push('padding:' + m(W.padding));
                            if (c && b.quirks && X[ab].align)
                                ag.push('text-align:' + X[ab].align);
                            if (ag.length > 0)
                                ae.push('style="' + ag.join('; ') + '" ');
                            ae.push('>', U[ab], '</td>');
                        }
                        ae.push('</tr></tbody>');
                        return ae.join('');
                    ...
                    var X = this._.children = T, Y = W && W.width || null, Z = W && W.heights || null, aa = function() {
                        ...
                        for (var ac = 0; ac < U.length; ac++) {
                            ...
                            if (Y)
                                ad.push('width:' + m(Y || '100%'));
                            if (Z)
                                ad.push('height:' + m(Z[ac]));
                            else if (W && W.expand)
                                ad.push('height:' + Math.floor(100 / U.length) + '%');
                            if (W && W.padding != undefined)
                                ad.push('padding:' + m(W.padding));
                            if (c && b.quirks && X[ac].align)
                                ad.push('text-align:' + X[ac].align);
                            if (ad.length > 0)
        ...
        k.dialog.uiElement.prototype = {getElement: function() {
                ...
                if (V._.dialog._.currentTabId != U)
                ...
                for (var W in S) {
                    if (!(U = W.match(T)))
                        continue;
                    if (this.eventProcessors[W])
                        this.eventProcessors[W].call(this, this._.dialog, S[W]);
                    else
        ...
        (function() {
            ...
            a.dialog.validate = {functions: function() {
                    ...
                    return function() {
                        ...
                        if (ad < Y.length && typeof Y[ad] == 'number')
                            ab = Y[ad];
        ...
        e.extend(a.editor.prototype, {openDialog: function(S, T) {
                ...
                function aa(ac) {
                    ...
                    if (!ae._isLoaded || ab && typeof ac == 'undefined')
                        return;
                    if (typeof ad != 'function')
                        a.dialog._.dialogDefinitions[S] = 'failed';
                    Z.openDialog(S, T);
                }
                ;
                if (typeof V == 'string') {
        ...
        a.style.prototype = {apply: function(T) {
                ...
                if (aa) {
                    ...
                    for (var ab = 0; ab < W.length; ab++) {
                        ...
                        if (ac) {
                            var ad = W[ab][1];
                            if (ad === null || typeof ad == 'string' && ac == ad || ad.test(ac))
                                return true;
                        }
                    }
                }
    ...
    (function() {
        ...
        m.prototype = {getNextParagraph: function(s) {
                ...
                if (!S._.nextNode)
                    S._.nextNode = v || t.equals(B) ? null : r(t, 1, B);
                return t;
            }};
    ...
    (function() {
        ...
        k.floatPanel = e.createClass({$: function(p, q, r, s) {
                ...
                p.on('mode', function() {
                    ...
                    w.setStyles({top: C + 'px',left: B + 'px',display: ''});
                    w.setOpacity(0);
    ...
    (function() {
        ...
        var s = {modes: {wysiwyg: 1,source: 1},readOnly: c || b.webkit,exec: function(y) {
                switch (y.mode) {
                    ...
                    case 'source':
                        var z = y.textarea.$;
                        if (c)
                            z.createTextRange().execCommand('SelectAll');
                        else {
                            z.selectionStart = 0;
        ...
        function v(y) {
            var z = y && u(y);
            if (z)
                if (z.getCustomData('ready'))
                    w(y);
                else
                    z.setCustomData('ready', 1);
        }
        ;
        function w(y) {
                ...
                if (b.webkit) {
                    ...
                    function B() {
                        ...
                        if (E) {
                            ...
                            if (F.type == 'Caret' && F.anchorNode == E.$)
                                A = 1;
                            z = E.getText();
                ...
                y.on('contentDom', function() {
                    ...
                    if (c) {
                        ...
                        E.on('focusin', function(M) {
                            if (M.data.$.srcElement.nodeName != 'BODY')
                                return;
                            if (G) {
                                if (I) {
                                    try {
                        ...
                        if (c && (b.ie7Compat || b.version < 8 || b.quirks))
                            F.on('click', function(M) {
                                if (M.data.getTarget().getName() == 'html')
                                    y.getSelection().getRanges()[0].select();
                            });
                        var J;
                        ...
                        function L(M) {
                            if (H) {
                                ...
                                var Q;
                                if (P && P.type && P.type != 'Control' && (Q = P.createRange()) && (Q = Q.parentElement()) && (Q = Q.nodeName) && Q.toLowerCase() in {input: 1,textarea: 1})
                                    return;
                                G = P && O.getRanges()[0];
                                p.call(y);
                            }
        ...
        d.selection = function(y) {
            ...
            if (c) {
                ...
                if (!A || A.item && A.item(0).ownerDocument != B.document.$ || A.parentElement && A.parentElement().ownerDocument != B.document.$)
                    B.isInvalid = true;
            }
            return B;
        };
        ...
        d.selection.prototype = {getNative: c ? function() {
                ...
                try {
                    ...
                    if (B == 'Control')
                        z = 3;
                    if (A.createRange().parentElement)
                        z = 2;
                } catch (C) {
                }
                return y.type = z;
                ...
                if (!A)
                    ...
                    if (C == B.endContainer && C.nodeType == 1 && B.endOffset - B.startOffset == 1 && x[C.childNodes[B.startOffset].nodeName.toLowerCase()])
                        z = 3;
                }
                return y.type = z;
            },getRanges: (function() {
                var y = c ? (function() {
                    ...
                    var A = function(B, C) {
                        ...
                        if (L == -1 || L == F.length - 1 && M < 0) {
                            ...
                            if (!N) {
                                G = F[F.length - 1];
                                if (G.nodeType == 1)
                                    return {container: D,offset: F.length};
                                else
                                    return {container: G,offset: G.nodeValue.length};
                            }
                            var Q = F.length;
                            while (N > 0)
                                N -= F[--Q].nodeValue.length;
                            ...
                            N = I.text.replace(/(\r\n|\r)/g, '\n').length;
                            if (!N)
                                return {container: D,offset: z(G) + (M > 0 ? 0 : 1)};
                            while (N > 0)
                                try {
                    ...
                    return function() {
                        ...
                        if (D == 2) {
                            ...
                            if (E.endContainer.getPosition(E.startContainer) & 4 && E.endOffset <= E.startContainer.getIndex())
                                E.collapse();
                            return [E];
                        } else if (D == 3) {
                            var G = [];
                ...
                return function(z) {
                    ...
                    if (A.ranges && !z)
                        ...
                        A.ranges = new d.rangeList(y.call(this));
                    if (z) {
                        var B = A.ranges;
                        for (var C = 0; C < B.length; C++) {
                            ...
                            if (D.startContainer.isReadOnly()) {
                                ...
                                while (F) {
                                    if (F.is('body') || !F.isReadOnly())
                                        break;
                                    if (F.type == 1 && F.getAttribute('contentEditable') == 'false')
                                        D.setStartAfter(F);
                                    F = F.getParent();
                                }
                            }
                        ...
                        if (B) {
                            if (!B.collapsed) {
                                ...
                                while (1) {
                                    ...
                                    if (D == (C.getChildCount ? C.getChildCount() : C.getLength()) && !C.isBlockBoundary())
                                        B.setStartAfter(C);
                                    else
                                        break;
                                }
                ...
                var y = this._.cache;
                if (y.selectedElement !== undefined)
                    return y.selectedElement;
                var z = this, A = e.tryThese(function() {
                    ...
                    if (B) {
                        ...
                        var I = e.extend(F, f.$listItem, f.$tableContent), J = new d.walker(H), K = function(L, M) {
                            return function(N, O) {
                                if (N.type == 3 && (!e.trim(N.getText()) || N.getParent().data('cke-bookmark')))
                                    return true;
                                var P;
                                if (N.type == 1) {
                                    P = N.getName();
                                    if (P == 'br' && M && N.equals(N.getParent().getBogus()))
                                        return true;
                                    if (O && P in I || P in f.$removeEmpty)
                                        return true;
                                }
                                L.halted = 1;
                                return false;
                    ...
                    for (var E = 2; E && !((C = B.getEnclosedNode()) && C.type == 1 && x[C.getName()] && (D = C)); E--)
                        B.shrink(1);
                    return D.$;
                });
                ...
                var y = this._.cache;
                if (y.selectedText !== undefined)
                    return y.selectedText;
                var z = '', A = this.getNative();
                if (this.getType() == 2)
                    z = c ? A.createRange().text : A.toString();
                ...
                if (c) {
                    ...
                    for (var B = 0; B < y.length; B++) {
                        ...
                        if (H.collapsed && (b.opera || b.gecko && b.version < 10900) && J.type == 1 && !J.getChildCount())
                            J.appendText('');
    ...
    (function() {
        ...
        a.editor.prototype.createFakeElement = function(r, s, t, u) {
            var v = this.lang.fakeobjects, w = v[t] || v.unknown, x = {'class': s,src: a.getUrl('images/spacer_wev8.gif'),'data-cke-realelement': encodeURIComponent(r.getOuterHtml()),'data-cke-real-node-type': r.type,alt: w,title: w,align: r.getAttribute('align') || ''};
            if (t)
        ...
        a.editor.prototype.createFakeParserElement = function(r, s, t, u) {
            ...
            r.writeHtml(y);
            x = y.getHtml();
            var z = {'class': s,src: a.getUrl('images/spacer_wev8.gif'),'data-cke-realelement': encodeURIComponent(x),'data-cke-real-node-type': r.type,alt: w,title: w,align: r.attributes.align || ''};
            if (t)
        ...
        e.extend(k.dialog, {labeledElement: function(u, v, w, x) {
                ...
                var z = this._.children = [], A = function() {
                    ...
                    if (v.labelLayout != 'horizontal')
                        B.push('<label class="cke_dialog_ui_labeled_label' + C + '" ', ' id="' + y.labelId + '"', ' for="' + y.inputId + '"', (v.labelStyle ? ' style="' + v.labelStyle + '"' : '') + '>', v.label, '</label>', '<div class="cke_dialog_ui_labeled_content"' + (v.controlStyle ? ' style="' + v.controlStyle + '"' : '') + ' role="presentation">', x.call(this, u, v), '</div>');
                    else {

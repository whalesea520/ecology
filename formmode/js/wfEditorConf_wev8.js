...
FCKConfig.ContextMenu = ['Generic','FieldAttribute'];//,'Link','Anchor','Image','Flash','Select','Textarea','Checkbox','Radio','TextField','HiddenField','ImageButton','Button','BulletedList','NumberedList','Table','Form'] ;
FCKConfig.BrowserContextMenuOnCtrl = false ;

FCKConfig.FontColors = '000000,993300,333300,003300,003366,000080,333399,333333,800000,FF6600,808000,808080,008080,0000FF,666699,808080,FF0000,FF9900,99CC00,339966,33CCCC,3366FF,800080,999999,FF00FF,FFCC00,FFFF00,00FF00,00FFFF,00CCFF,993366,C0C0C0,FF99CC,FFCC99,FFFF99,CCFFCC,CCFFFF,99CCFF,CC99FF,FFFFFF' ;

FCKConfig.FontNames		= 'Arial;Tahoma;Verdana;宋体;新宋体;黑体;隶书;幼园;楷体_GB2312;仿宋_GB2312';
...
function FCKCustomImageCommand(){//自定义插入图片命令
	...
	this.Execute=function(){
		...
		if(FCK.EditorDocument.selection){
			 sel_ = FCK.EditorDocument.selection.createRange();
		}else{
			var sel=FCK.EditorDocument.getSelection();
			 sel_ = sel.getRangeAt(0);
		}
		//var sel=FCK.EditorDocument.getSelection();
		//var sel_ = sel.getRangeAt(0);//FCK.EditorDocument.selection.createRange();
		window.parent.FCKEditorExt.show(sel_);
	};
...
function FCKFieldShowAttr4(){
	this.name='FieldShowAttr4';
	this.Execute=function(){
		var fieldid = selectTag.id.substr(6);
		fieldid = fieldid.substr(0, fieldid.indexOf("$"));
				...
				if(canFieldEdit=="1" && index_eFieldids==-1){
					if ( tagName == 'INPUT' && ( tag.type == 'text' || tag.type == 'password' ) && tag.id.indexOf("$field")==0 && tag.id!="$field-4$"){
						...
						if(fieldShowAttr=="1"){
							...
							menu.AddItem( 'FieldShowAttr4', FCKLang.FieldShowAttr4, 1 ) ;
							...
							menu.AddItem( 'FieldShowAttr2', FCKLang.FieldShowAttr2, 1 ) ;
							menu.AddItem( 'FieldShowAttr3', FCKLang.FieldShowAttr3, 1 ) ;
							menu.AddItem( 'FieldShowAttr4', FCKLang.FieldShowAttr4, 49 ) ;
						}
					}
				}
			}catch(e){}
...
FCKCommands.RegisterCommand('FieldShowAttr4',new FCKFieldShowAttr4());
}

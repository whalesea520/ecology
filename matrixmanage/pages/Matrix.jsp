...
function attachUrl(){
	...
	$("a[target='tabcontentframe']").each(function(){
		var url = "MatrixList.jsp?"+requestParameters;
		/** if($(this).attr("status"))
...
<body scroll="no">
	...
	<div class="e8_boxhead">
		...
		<ul class="tab_menu" >
			<li class="current">
				<a href="" status='0' target="tabcontentframe"><%=SystemEnv.getHtmlLabelName(34066, user.getLanguage()) +SystemEnv.getHtmlLabelName(320, user.getLanguage())%></a>
			</li>
		</ul>

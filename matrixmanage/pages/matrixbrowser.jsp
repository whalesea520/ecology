...
if(!descr.equals("")){
	sqlwhere += " and descr like '%" + Util.fromScreen2(descr,7) +"%' ";
}

String sqlstr = "select id,name,descr "+
			    "from MatrixInfo " + sqlwhere ;
%>
<BODY>
...
<FORM NAME=SearchForm STYLE="margin-bottom:0" action="matrixbrowser.jsp" method=post>

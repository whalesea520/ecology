...
<body scroll="no">
	<div class="e8_box demo2" id="rightContent">
		...
		<div class="tab_box">
			<iframe src="CRMViewLogRp.jsp?datetype=1" onload="update()" id="tabcontentframe" name="tabcontentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
	    $('.e8_box').Tabs({
			...
			staticOnLoad:true,
			objName:"<%=SystemEnv.getHtmlLabelName(33780,user.getLanguage())%>"
		});
  	...
  	function attachUrl(){
		$("a[target='tabcontentframe']").each(function(){
			...
			$(this).attr("href","/CRM/report/CRMViewLogRp.jsp?datetype="+datetype+"&"+new Date().getTime());
		});

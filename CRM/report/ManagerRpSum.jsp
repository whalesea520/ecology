...
<%
	...
	String backfields = "t1.manager ,COUNT(distinct t1.id) AS resultcount";
	...
	if(!"".equals(searchName)){
		fromSql += ", HrmResource t3";
		sqlWhere += " and t3.id = t1.manager and t3.lastname like '%"+searchName+"%'";
	}
	
	String tableString =" <table instanceid=\"info\"  pageId=\""+PageIdConst.CRM_RPManager+"\"  pagesize=\""+PageIdConst.getPageSize(PageIdConst.CRM_RPManager,user.getUID(),PageIdConst.CRM)+"\"  tabletype=\"none\">"+ 
    ...
    "<head>"+
    "<col width=\"30%\"  text=\""+ SystemEnv.getHtmlLabelName(144,user.getLanguage()) +"\" column=\"manager\""+
	...
	"<col width=\"30%\"  text=\""+ SystemEnv.getHtmlLabelName(136,user.getLanguage())+SystemEnv.getHtmlLabelName(1331,user.getLanguage()) +"\" column=\"resultcount\""+
		" transmethod=\"weaver.crm.report.CRMReporttTransMethod.getCustomerInfo\" otherpara=\"manager+column:manager\"/>"+ 
...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value="<%=SystemEnv.getHtmlLabelName(1278,user.getLanguage()) %>"/>
</jsp:include>
...
<form action="ManagerRpSum.jsp" method="post" name="weaver">
	<input type="hidden" name="searchName" value="<%=searchName %>">
</form>

<input type="hidden" name="pageId" id="pageId" value="<%=PageIdConst.CRM_RPManager%>">

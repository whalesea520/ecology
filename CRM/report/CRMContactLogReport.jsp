...
<form id=weaver name=frmmain method=post action="/CRM/report/CRMContactLogReport.jsp">
...
<wea:layout type="4col">
	<wea:group context='<%=SystemEnv.getHtmlLabelName(15774,user.getLanguage()) %>'>
		...
		<%if(!user.getLogintype().equals("2")){%>
		  ...
		  <wea:item>
		  	<span style="margin-right: 10px;">
			  	<select id="userCustomer" style="width:100px;" name="userCustomer" onchange="changeType(this.value,'viewer','ownerid2');">
	  ...
	  <%}%>
		  ...
		  <wea:item>
		  <select class=InputStyle  size="1" name="finished" style="width: 100px;">
		  ...
		  <wea:item>
		  		<select  class=InputStyle size="1" name="contacttype" style="width: 100px;">
...
String tableString=""+
			  "<table  pageId=\""+PageIdConst.CRM_ContactPlanReport+"\"  pagesize=\""+PageIdConst.getPageSize(PageIdConst.CRM_ContactPlanReport,user.getUID(),PageIdConst.CRM)+"\" tabletype=\"none\" sqlwhere=\""+Util.toHtmlForSplitPage(whereclause)+"\">"+
...
%>
<input type="hidden" name="pageId" id="pageId" value="<%=PageIdConst.CRM_ContactPlanReport%>">

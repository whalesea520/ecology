...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value="<%=SystemEnv.getHtmlLabelName(16494,user.getLanguage()) %>"/>
</jsp:include>
...
<FORM id=weaver name="weaver" action="/CRM/Maint/CustomerDescOperation.jsp" method=post>

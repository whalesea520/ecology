...
String titlename = SystemEnv.getHtmlLabelName(82,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(136,user.getLanguage())+SystemEnv.getHtmlLabelName(603,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<BODY>
...
<%
RCMenu += "{"+SystemEnv.getHtmlLabelName(201,user.getLanguage())+",javascript:weaver.myfun1.click(),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<BUTTON class=btn accessKey=1 id=myfun1  onclick="location='/CRM/Maint/ListCustomerRating.jsp'"><U>1</U>-<%=SystemEnv.getHtmlLabelName(201,user.getLanguage())%></BUTTON>
</DIV>
  ...
  <TR>
    <TD vAlign=top>
  	...
  	<COL width="80%">
        ...
        <TR>
          <TD><%=SystemEnv.getHtmlLabelName(603,user.getLanguage())%><%=SystemEnv.getHtmlLabelName(433,user.getLanguage())%></TD>
        ...
        <TR>
          ...
          <TD class=Field><BUTTON class=Browser id=SelectWorkflow11 onclick="onShowWorkflow11()"></BUTTON> 
              <SPAN id=workflow11span><IMG src="/images/BacoError_wev8.gif" align=absMiddle></SPAN> 
              <INPUT id=Workflow11 type=hidden name=workflow11></TD>
         </TR><tr><td class=Line colspan=2></td></tr>   
        <TR>
          ...
          <TD class=Field><BUTTON class=Browser id=SelectWorkflow12 onclick="onShowWorkflow12()"></BUTTON> 
              <SPAN id=workflow12span><IMG src="/images/BacoError_wev8.gif" align=absMiddle></SPAN> 
              <INPUT id=Workflow12 type=hidden name=workflow12></TD>
         </TR><tr><td class=Line colspan=2></td></tr>  
        <TR>
          ...
          <TD class=Field><BUTTON class=Browser id=SelectWorkflow21 onclick="onShowWorkflow21()"></BUTTON> 
              <SPAN id=workflow21span><IMG src="/images/BacoError_wev8.gif" align=absMiddle></SPAN> 
              <INPUT id=Workflow21 type=hidden name=workflow21></TD>
         </TR><tr><td class=Line colspan=2></td></tr>  
        <TR>
          ...
          <TD class=Field><BUTTON class=Browser id=SelectWorkflow22 onclick="onShowWorkflow22()"></BUTTON> 
              <SPAN id=workflow22span><IMG src="/images/BacoError_wev8.gif" align=absMiddle></SPAN> 
              <INPUT id=Workflow22 type=hidden name=workflow22></TD>
         </TR><tr><td class=Line colspan=2></td></tr>  
        <TR>
          ...
          <TD class=Field><BUTTON class=Browser id=SelectWorkflow31 onclick="onShowWorkflow31()"></BUTTON> 
              <SPAN id=workflow31span><IMG src="/images/BacoError_wev8.gif" align=absMiddle></SPAN> 
              <INPUT id=Workflow31 type=hidden name=workflow31></TD>
         </TR><tr><td class=Line colspan=2></td></tr>  
        <TR>
          ...
          <TD class=Field><BUTTON class=Browser id=SelectWorkflow32 onclick="onShowWorkflow32()"></BUTTON> 
              <SPAN id=workflow32span><IMG src="/images/BacoError_wev8.gif" align=absMiddle></SPAN> 
              <INPUT id=Workflow32 type=hidden name=workflow32></TD>
         </TR><tr><td class=Line colspan=2></td></tr>  
        <TR>
          <TD>CanUpgrade</TD>
          <TD class=Field>

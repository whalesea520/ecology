...
<tr>
	...
	<td valign="top">
		...
		<tr>
		<td valign="top">
<FORM NAME=SearchForm STYLE="margin-bottom:0" action="AddressTypeBrowser.jsp" method=post>
...
<TR class=Spacing style="height:1px;"><TD class=Line1 colspan=4 style="padding:0;"></TD></TR>
</table>
...
</tr><TR class=Line style="height:1px;"><TH colSpan=3 style="padding:0;"></TH></TR>
<%
int i=0;
sqlwhere = "select * from CRM_AddressType "+sqlwhere;

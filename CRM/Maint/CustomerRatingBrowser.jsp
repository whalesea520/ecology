...
<tr>
	...
	<td valign="top">
		...
		<tr>
		<td valign="top">
<FORM NAME=SearchForm STYLE="margin-bottom:0" action="CustomerRatingBrowser.jsp" method=post>
...
</tr><TR class=Line><TH colSpan=3 style="padding:0;"></TH></TR>
<%
int i=0;
sqlwhere = "select * from CRM_CustomerRating "+sqlwhere;

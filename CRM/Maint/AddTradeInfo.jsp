	...
	<wea:group context='<%= SystemEnv.getHtmlLabelName(1361,user.getLanguage())%>'>
		...
		<wea:item>
			<wea:required id="lowamountimage" required="true" value="">
				<INPUT class=InputStyle maxLength=50 size=45 name="lowamount" 
		...
		<wea:item><%=SystemEnv.getHtmlLabelName(534,user.getLanguage())%><%=SystemEnv.getHtmlLabelName(594,user.getLanguage())%></wea:item>
		<wea:item>
			<INPUT class=InputStyle maxLength=50 size=45 name="highamount" onKeyPress="ItemCount_KeyPress()" onBlur='checknumber("highamount");'>
		</wea:item>
	</wea:group>
</wea:layout>
</FORM>

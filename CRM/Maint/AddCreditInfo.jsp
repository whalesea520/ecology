	...
	<wea:group context='<%= SystemEnv.getHtmlLabelName(1361,user.getLanguage())%>'>
		...
		<wea:item>
			<wea:required id="nameimage" required="true" value="">
				...
				temptitle="<%=SystemEnv.getHtmlLabelName(603,user.getLanguage())%><%=SystemEnv.getHtmlLabelName(195,user.getLanguage())%>">
			</wea:required>
		</wea:item>
		...
		<wea:item>
			<wea:required id="moneyimage" required="true" value="">
				<INPUT class=InputStyle maxLength=50 size=45 name="money" 

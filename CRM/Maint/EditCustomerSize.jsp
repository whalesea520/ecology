...
<%
boolean canedit = HrmUserVarify.checkUserRight("EditCustomerSize:Edit",user);
%>
...
<%
	...
	if(!isclose.equals("1"))
	{
		RecordSet.executeProc("CRM_CustomerSize_SelectByID",id);
...
if("<%=isclose%>"=="1"){
	parentWin.location = "ListCustomerSizeInner.jsp";
...
if (canedit)
	titlename = SystemEnv.getHtmlLabelName(93,user.getLanguage())+":&nbsp;"
			+SystemEnv.getHtmlLabelName(136,user.getLanguage())+SystemEnv.getHtmlLabelName(576,user.getLanguage());
else
...
<FORM id=weaver name="weaver" action="/CRM/Maint/CustomerSizeOperation.jsp" method=post onsubmit='return check_form(this,"name,desc")'>

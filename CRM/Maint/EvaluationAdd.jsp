    ...
    <TD vAlign=top>
  	...
  	<COL width="80%">
        ...
        <TR>
          ...
          <TD class=Field><INPUT class=InputStyle maxLength=3 size=10 name="proportion" onchange='checkinput("proportion","proportionimage")' onKeyPress="ItemCount_KeyPress()" onBlur='checknumber("proportion")'>%<SPAN id=proportionimage><IMG src="/images/BacoError_wev8.gif" align=absMiddle></SPAN></TD>
         </TR><tr><td class=Line colspan=2></td></tr>        
        </TBODY></TABLE></TD>
    </TR></TBODY></TABLE>
</FORM>

...
jQuery(function(){
	...
	checkinput("levelvalue","levelvalueimage");
});
</script>
</HEAD>
<%
...
if (canedit) 
	titlename = SystemEnv.getHtmlLabelName(93,user.getLanguage())
				+":"+SystemEnv.getHtmlLabelName(6070,user.getLanguage())+SystemEnv.getHtmlLabelName(324,user.getLanguage());
else
	...
	<wea:group context='<%= SystemEnv.getHtmlLabelName(1361,user.getLanguage())%>'>
		...
		<wea:item>
			<wea:required id="levelvalueimage" required="true" value="">
				<% if(canedit) {%><INPUT class=InputStyle maxLength=50 size=45 name="levelvalue" 
					onchange='checkinput("levelvalue","levelvalueimage")' 

...
String titlename = SystemEnv.getHtmlLabelName(82,user.getLanguage())+":&nbsp;"+SystemEnv.getHtmlLabelName(16500,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<BODY>
...
<FORM id=weaver action="/CRM/sellchance/CRMFactorOperation.jsp" method="post">

...
<%
	...
	if(!isclose.equals("1"))
	{
		RecordSet.execute("select * from CRM_SellTypes where id = '"+id+"'");
...
if("<%=isclose%>"=="1"){
	parentWin.location = "ListCRMTypesInner.jsp";
...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value="<%=SystemEnv.getHtmlLabelName(82538,user.getLanguage()) %>"/>
</jsp:include>
...
<FORM id=weaver name="weaver" action="/CRM/sellchance/CRMTypesOperation.jsp" method=post>

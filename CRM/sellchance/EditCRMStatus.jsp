...
if("<%=isclose%>"=="1"){
	parentWin.location = "ListCRMStatusInner.jsp";
...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value="<%=SystemEnv.getHtmlLabelName(16495,user.getLanguage()) %>"/>
</jsp:include>
...
<FORM id=weaver name="weaver" action="/CRM/sellchance/CRMStatusOperation.jsp" method=post>

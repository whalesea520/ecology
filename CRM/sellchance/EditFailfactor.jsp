...
<%
	...
	if(!isclose.equals("1"))
	{
		RecordSet.executeProc("CRM_Failfactor_SelectByID",id);
...
if("<%=isclose%>"=="1"){
	parentWin.location = "ListCRMFailfactorInner.jsp";
...
String titlename = "";
if (canedit)
	titlename = SystemEnv.getHtmlLabelName(93,user.getLanguage())+":&nbsp;"+SystemEnv.getHtmlLabelName(16500,user.getLanguage());
else
	titlename = SystemEnv.getHtmlLabelName(367,user.getLanguage())+":&nbsp;"+SystemEnv.getHtmlLabelName(16500,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<BODY>
...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value="<%=SystemEnv.getHtmlLabelName(16500,user.getLanguage()) %>"/>
</jsp:include>

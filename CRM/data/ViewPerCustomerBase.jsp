...
<%
    //申请->基础客户
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17290,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?isfromtab=true&CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->基础客户&method=apply&Status=2&Rating=1&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->潜在客户
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17291,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?isfromtab=true&CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->潜在客户&method=apply&Status=3&Rating=1&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->成功客户
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17292,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?isfromtab=true&CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->成功客户&method=apply&Status=4&Rating=1&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->试点客户
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17293,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?isfromtab=true&CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->试点客户&method=apply&Status=5&Rating="+RecordSet.getString("rating")+"&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
    //申请->典型客户
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17294,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?isfromtab=true&CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->典型客户&method=apply&Status=6&Rating="+RecordSet.getString("rating")+"&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->冻结
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(1232,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?isfromtab=true&CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->冻结&method=apply&Status=7&Rating="+RecordSet.getString("rating")+"&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->冻结
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(1232,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?isfromtab=true&CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->冻结&method=apply&Status=8&Rating="+RecordSet.getString("rating")+"&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->解冻
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(1233,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?isfromtab=true&CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->解冻&method=apply&Status=3&Rating="+RecordSet.getString("rating")+"&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->解冻
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(1233,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?isfromtab=true&CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->解冻&method=apply&Status=4&Rating="+RecordSet.getString("rating")+"&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->无效客户
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17295,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?isfromtab=true&CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->无效客户&method=apply&Status=1&Rating=1&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //门户申请
RCMenu += "{"+SystemEnv.getHtmlLabelName(1234,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?isfromtab=true&CustomerID="+CustomerID+"&approvedesc="+customerName+":门户申请&method=portal&PortalStatus=2&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->门户冻结
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(1236,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?isfromtab=true&CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->门户冻结&method=portal&PortalStatus=3&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->门户激活
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(1237,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?isfromtab=true&CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->门户激活&method=portal&PortalStatus=2&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
<%--退回菜单--%>
...
<%
    //申请->重设密码
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17289,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?isfromtab=true&CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->重设密码&method=portalPwd&PortalStatus=2&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
<%--退回菜单--%>
...
<%if(!isCustomerSelf){%>
    ...
    <tr>
      ...
      _url="/systeminfo/BrowserMain.jsp?url=/docs/docs/MutiDocBrowser.jsp" _param="documentids"

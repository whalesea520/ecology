    ...
    --%>
	   ...
	   <%--????--%>
		...
		<TR>
          ...
          <TD class=Field><INPUT class=InputStyle maxLength=50 name="Name" onchange='checkinput("Name","Nameimage")' STYLE="width:95%" value='<%=Util.toScreen(Util.null2String(RecordSet.getString("name")),user.getLanguage(),"0")%>' onkeydown="if(event.keyCode==222){return false;}">
		...
		<TR>
		  ...
		  <TD class="Field">
			<INPUT maxLength=150 class=InputStyle name="IDCardNo" STYLE="width:95%" onKeyPress="ItemCount_KeyPress()" <%--onchange='checkinput("IDCardNo","IDCardNoimage")'--%> value="<%=Util.null2String(RecordSet.getString("IDCardNo"))%>">

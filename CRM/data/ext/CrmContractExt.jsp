...
tableInfo.append("<TABLE id='customConnectionExt'class=\"ListStyle\" cellspacing=\"1\">");
...
tableInfo.append("<table class=ListStyle>");			
tableInfo.append("<COLGROUP>");					
tableInfo.append("<COL width=\"25%\">");						
tableInfo.append("<COL width=\"25%\">");
tableInfo.append("<COL width=\"25%\">");
...
if (m_createrType.equals("1")) {
	...
	tableInfo.append("</TD>");	
	tableInfo.append("</TR>");	
	tableInfo.append("<tr   style='height: 1px'><td class=Line colspan=4 style='padding:0px'></td></tr>");	

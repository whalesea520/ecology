...
%>
				<tr id="tr_<%=contacterid%>" class="DataLight">
					...
					<td class="info" title="姓名:<%=Util.toScreen(rs.getString("firstname"), user
						.getLanguage())%>">
						<input size="50" maxlength="50" style="width:110px" _fieldname="firstname" _contacterid="<%=contacterid %>"
	...
	if("edit_contacter_field".equals(operation)){
		...
		if(fieldname.equals("main")){
			...
			if(fieldtype.equals("attachment")){
				...
				if(newvalue == null || "".equals(newvalue))newvalue="0";
		...
		//更新缓存
		CustomerContacterComInfo.updateContacterInfoCache(contacterid);
	}	

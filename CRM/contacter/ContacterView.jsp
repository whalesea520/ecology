				...
				<div>
					<ul class="tab_menu">
						<li class="<%=tabid.equals("")?"current":""%>" >
							<a href="" target="tabcontentframe" _labelid="base"><%=SystemEnv.getHtmlLabelNames("572,87",user.getLanguage())%></a>
						</li>
						<li class="<%=tabid.equals("trail")?"current":""%>">
							<a href="" target="tabcontentframe" _labelid="trail"><%=SystemEnv.getHtmlLabelNames("84283",user.getLanguage())%></a>
						</li>
					</ul>

...
<HTML>
	...
	<%
		...
		String name = CustomerDeputizeBrandComInfo.getName("" + id);
		String desc = CustomerDeputizeBrandComInfo.getDesc("" + id);;

		int msgid = Util.getIntValue(request.getParameter("msgid"), -1);

		String imagefilename = "/images/hdSystem_wev8.gif";
		String titlename = SystemEnv.getHtmlLabelName(136, user.getLanguage())+SystemEnv.getHtmlLabelName(26796, user.getLanguage())+ ":" + name;
		String needfav = "1";
		String needhelp = "";
		...
		<%@ include file="/systeminfo/RightClickMenuConent_wev8.jsp" %>
			<%
				...
				if (HrmUserVarify.checkUserRight("CustomerChannelBaseMaint:Add",user)) {
					RCMenu += "{"+ SystemEnv.getHtmlLabelName(82, user.getLanguage())+ ",CustomerDeputizeBrandAdd.jsp,_self} ";
					RCMenuHeight += RCMenuHeightStep;
				}
				...
				RCMenu += "{"+ SystemEnv.getHtmlLabelName(1290, user.getLanguage())+ ",CustomerDeputizeBrandList.jsp,_self} ";
				RCMenuHeight += RCMenuHeightStep;
			%>
						...
						<TABLE class=Shadow>
							<tr>
								<td valign="top">
									...
									%>	
									<FORM id=weaver name=frmMain action="CustomerDeputizeBrandOperation.jsp" method=post>

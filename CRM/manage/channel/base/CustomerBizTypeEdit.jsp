...
<HTML>
	...
	<%
		...
		String name = CustomerBizTypeComInfo.getName("" + id);
		String desc = CustomerBizTypeComInfo.getDesc("" + id);;

		int msgid = Util.getIntValue(request.getParameter("msgid"), -1);

		String imagefilename = "/images/hdSystem_wev8.gif";
		String titlename = SystemEnv.getHtmlLabelName(136, user.getLanguage())+SystemEnv.getHtmlLabelName(26800, user.getLanguage())+ ":" + name;
		String needfav = "1";
		String needhelp = "";
		...
		<%@ include file="/systeminfo/RightClickMenuConent_wev8.jsp" %>
			<%
				...
				if (HrmUserVarify.checkUserRight("CustomerChannelBaseMaint:Add",user)) {
					RCMenu += "{"+ SystemEnv.getHtmlLabelName(82, user.getLanguage())+ ",CustomerBizTypeAdd.jsp,_self} ";
					RCMenuHeight += RCMenuHeightStep;
				}

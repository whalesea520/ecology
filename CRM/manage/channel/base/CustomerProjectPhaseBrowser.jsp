			...
			<tr>
				...
				<td valign="top">
					<TABLE class=Shadow>
						<tr>
							<td valign="top">
								<FORM NAME=SearchForm STYLE="margin-bottom: 0" action="CustomerProjectPhaseBrowser.jsp" method=post>
									...
									<TABLE ID=BrowseTable width="100%" class=BroswerStyle cellspacing=1>
										...
										<%
											int i = 0;
											sqlwhere = "select id,name,description from CRM_CustomerProjectPhase " + sqlwhere
													+ " order by id asc";

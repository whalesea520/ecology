...
<%
	...
	rs.executeSql("select id,name,level,status,remark,risk,difficulty,assist,tag,principalid,begindate,enddate,taskids,docids,wfids,meetingids,crmids,projectids,fileids,creater,createdate,createtime from TM_TaskInfo where id="+taskId+" and (deleted=0 or deleted is null)");

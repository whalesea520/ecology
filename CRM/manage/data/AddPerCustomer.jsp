     ...
     --%>        
	   ...
	   <%--????--%>
		...
		<TR>
          ...
          <TD class=Field><INPUT class=InputStyle maxLength=50 name="Name" onchange='checkinput("Name","Nameimage")' STYLE="width:95%" value="<%=Util.toScreen(name,user.getLanguage(),"0")%>">
		...
		<TR>
		  ...
		  <TD class="Field">
			<INPUT maxLength=150 class=InputStyle name="IDCardNo"  onKeyPress="" <%--onchange='checkinput("IDCardNo","IDCardNoimage")'--%> STYLE="width:95%"  >

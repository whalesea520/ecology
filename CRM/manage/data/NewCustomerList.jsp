...
<HTML>
	...
	<BODY style="overflow: hidden;">
		...
		<%
			...
			String fromSql = " CRM_CustomerInfo t1 ,CRM_ViewLog2 t2";
			String sqlWhere	= " where (t1.deleted=0 or t1.deleted is null) and t1.id=t2.customerid and t1.manager=" + user.getUID();	
			String orderby = " t2.movedate,t2.movetime ";
						...
						<tr>
							<td valign="top">
								...
								<%
									...
									xTableColumn_5.setColumn("movedate");
									xTableColumn_5.setDataIndex("movedate");
									xTableColumn_5.setHeader(SystemEnv.getHtmlLabelName(18901, user.getLanguage()));

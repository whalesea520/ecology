...
if(method.equals("delete"))
{
	...
	//快速删除
	if("1".equals(fu.getParameter("quickdel"))){
%>
	<script type="text/javascript">
		parent.quickcomplete2("<%=ContacterID%>");
	</script>
<%
		return;
	}
...
if(method.equals("add"))
{
	...
	RecordSet.executeSql("update CRM_CustomerContacter set remark = '" + Remark + "' , remarkDoc = " + RemarkDoc + ",contacterimageid="+resourceimageid+",creater="+user.getUID()+",createdate='"+CurrentDate+"',createtime='"+CurrentTime+"' where id = " + ContacterID);

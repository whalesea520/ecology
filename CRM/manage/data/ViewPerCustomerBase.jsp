...
<%
RCMenu += "{"+levelMenu+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=ApproveLevel&Status=2&Rating=1\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->基础客户
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17290,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->基础客户&method=apply&Status=2&Rating=1&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
RCMenu += "{"+levelMenu+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=ApproveLevel&Status=3&Rating=1\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->潜在客户
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17291,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->潜在客户&method=apply&Status=3&Rating=1&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
RCMenu += "{"+levelMenu+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=ApproveLevel&Status=4&Rating=1\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->成功客户
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17292,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->成功客户&method=apply&Status=4&Rating=1&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
RCMenu += "{"+levelMenu+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=ApproveLevel&Status=5&Rating="+RecordSet.getString("rating")+"\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
<%if(canApproveLevel && RecordSet.getInt("status")==4&&approvevalue.equals("6")){%>
<%
RCMenu += "{"+levelMenu+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=ApproveLevel&Status=6&Rating="+RecordSet.getString("rating")+"\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->试点客户
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17293,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->试点客户&method=apply&Status=5&Rating="+RecordSet.getString("rating")+"&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
    //申请->典型客户
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17294,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->典型客户&method=apply&Status=6&Rating="+RecordSet.getString("rating")+"&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
RCMenu += "{"+levelMenu+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=ApproveLevel&Status=7&Rating="+RecordSet.getString("rating")+"\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
<%if(canApply && RecordSet.getInt("status")==3){%>
<%
    //申请->冻结
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(1232,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->冻结&method=apply&Status=7&Rating="+RecordSet.getString("rating")+"&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
RCMenu += "{"+levelMenu+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=ApproveLevel&Status=8&Rating="+RecordSet.getString("rating")+"\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->冻结
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(1232,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->冻结&method=apply&Status=8&Rating="+RecordSet.getString("rating")+"&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
RCMenu += "{"+levelMenu+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=ApproveLevel&Status=3&Rating="+RecordSet.getString("rating")+"\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->解冻
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(1233,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->解冻&method=apply&Status=3&Rating="+RecordSet.getString("rating")+"&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
RCMenu += "{"+levelMenu+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=ApproveLevel&Status=4&Rating="+RecordSet.getString("rating")+"\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->解冻
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(1233,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->解冻&method=apply&Status=4&Rating="+RecordSet.getString("rating")+"&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
RCMenu += "{"+levelMenu+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=ApproveLevel&Status=1&Rating=1\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
<%if(canApply && RecordSet.getInt("status")==2){%>
<%
    //申请->无效客户
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17295,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->无效客户&method=apply&Status=1&Rating=1&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //退回->级别申请
RCMenu += "{"+SystemEnv.getHtmlLabelName(236,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17288,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=RejectLevel\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //门户批准
RCMenu += "{"+portalMenu+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=ApprovePortal&PortalStatus=2\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //门户申请
RCMenu += "{"+SystemEnv.getHtmlLabelName(1234,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&approvedesc="+customerName+":门户申请&method=portal&PortalStatus=2&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
RCMenu += "{"+portalMenu+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=ApprovePortal&PortalStatus=3\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->门户冻结
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(1236,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->门户冻结&method=portal&PortalStatus=3&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->门户激活
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(1237,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->门户激活&method=portal&PortalStatus=2&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
<%--退回菜单--%>
...
<%
    //退回->门户申请
RCMenu += "{"+SystemEnv.getHtmlLabelName(236,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(1234,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=RejectPortal\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
RCMenu += "{"+portalpwdMenu+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=ApprovePwd&PortalStatus=2\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
...
<%
    //申请->重设密码
RCMenu += "{"+SystemEnv.getHtmlLabelName(129,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17289,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&approvedesc="+customerName+":申请->重设密码&method=portalPwd&PortalStatus=2&isfromtab=true\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
<%--退回菜单--%>
...
<%
    //退回->重设密码
RCMenu += "{"+SystemEnv.getHtmlLabelName(236,user.getLanguage())+"->"+SystemEnv.getHtmlLabelName(17289,user.getLanguage())+",javascript:urlSubmit(this,\\\"/CRM/data/CustomerOperation.jsp?CustomerID="+CustomerID+"&requestid="+requestid+"&method=RejectPwd\\\"),_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<%}%>
<%}%><!--portal end-->
...
<!--一般信息 begin xwj for td1552 on 2005-03-22-->
<TABLE class=ViewForm>
  <COLGROUP>
  <COL width="49%">
  <COL width=10>
...
%>
        <TR class=header>
          <TD align=right colspan=3><a href="#" onclick="parent.setTabPanelActive('crmContract')">
...
%>
        <TR>
		  ...
		  <TD class=Field>
			<%if(canedit){%>
			<a href="/CRM/data/ShareOperation.jsp?method=delete&id=<%=RecordSetShare.getString("id")%>&CustomerID=<%=CustomerID%>" onclick="return isdel()"><%=SystemEnv.getHtmlLabelName(91,user.getLanguage())%></a>
			<%}%>
		  </TD>
        </TR><tr  style="height: 1px"><td class=Line colspan=3 style='padding:0'></td></tr>
...
<% if (nLogCount>=2) { %> </div> <%}%>
		...
		<COL width="30%">
          ...
          <tbody>
            ...
            <% if (nLogCount>=2) { %>
             <tr class=header>
            <td align=right colspan=3><SPAN id=WorkFlowspan><a href="#" onclick="parent.setTabPanelActive('crmExchange')"><%=SystemEnv.getHtmlLabelName(332,user.getLanguage())%></a></span></td>
            </tr>
            <%}%>

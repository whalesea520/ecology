...
<%
	...
	int currentpage =1;
	List labelList=CustomerLabelService.getLabelList(""+userid,"all");
%>
<html>
<head>
<title></title>
...
<form action="/CRM/customer/CrmLabelOperation.jsp"  id="labelForm" method="post">
...
<table id='list' class="ListStyle" cellspacing="1" style="margin:0px;width:100%;font-size: 12px;width: 98%;vertical-align: " align="center">
		...
		<col width="20%">
		   ...
		   <tr class="HeaderForXtalbe">
		      ...
		      <th>TAB<%=SystemEnv.getHtmlLabelName(31834,user.getLanguage())%></th><!-- 是否显示在Tab页 -->
...
<jsp:include page="/systeminfo/commonTabFoot.jsp"></jsp:include>
  ...
  function chooseColor(obj){
   ...
   function deleteLabel(labelid){
         ...
         $.post("/CRM/customer/CrmLabelOperation.jsp",{type:"deleteLabel",id:labelid},function(data){});
      });
    }
	...
	function addLabel(type,labelid){
	    ...
	    var title="<%=SystemEnv.getHtmlLabelNames("82,176",user.getLanguage())%>";
	    if(type=="edit"){
	    	title="<%=SystemEnv.getHtmlLabelNames("93,176",user.getLanguage())%>";
	    }	
	    diag=getDialog(title,400,300);
	    diag.URL = "/CRM/customer/CrmAddLabel.jsp";
	    if(type=="edit"){
	    	diag.URL="/CRM/customer/CrmAddLabel.jsp?type=editLabel&labelid="+labelid;
	    }	
		diag.show();
		document.body.click();
	}

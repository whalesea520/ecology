		...
		<tr>
			...
			<td class="rightSearchSpan" style="text-align:right;">
						<span style="width:30px;">
							<button title="<%=SystemEnv.getHtmlLabelName(15006, user.getLanguage())%>" type=button class="btn_top" style="background:url('/CRM/images/icon_add_wev8.png') no-repeat left;" _type="add" onmouseover="doMouseover(this)" onmouseout="doMouseout(this)" onclick="openFullWindowHaveBar('/CRM/data/AddCustomerFrame.jsp?tabtype=add')">
						...
						<span style="width:30px;">
							<button title="<%=SystemEnv.getHtmlLabelName(18038, user.getLanguage())%>"  type=button class="btn_top" style="background:url('/CRM/images/icon_import_wev8.png') no-repeat left;" _type="import" onmouseover="doMouseover(this)" onmouseout="doMouseout(this)" onclick="openFullWindowHaveBar('/CRM/data/AddCustomerFrame.jsp?tabtype=import')">
							 	<div class="btndiv"></div>
							 	<div style="clear:both;"></div>
							</button>
						</span>
						...
						<span style="width:30px;">
							<button title="<%=SystemEnv.getHtmlLabelName(136, user.getLanguage())+SystemEnv.getHtmlLabelName(17534, user.getLanguage())%>" type=button class="btn_top" style="background:url('/CRM/images/icon_birthday_wev8.png') no-repeat left;" _type="birthday" onmouseover="doMouseover(this)" onmouseout="doMouseout(this)" onclick="openFullWindowHaveBar('/CRM/CustomerContacterInfo.jsp')">
							 	<div class="btndiv"></div>
							 	<%if(birthdayCount>0){%>
							 		<div style="float:left;">(<%=birthdayCount%>)</div>
							 	<%} %>
							 	<div style="clear:both;"></div>
							</button>
						</span>
						...
						<span style="width:30px;">
							<button title="<%=SystemEnv.getHtmlLabelName(6061, user.getLanguage())%>" type=button class="btn_top" style="background:url('/CRM/images/icon_remind_wev8.png') no-repeat left;" _type="remind" onmouseover="doMouseover(this)" onmouseout="doMouseout(this)" onclick="openFullWindowHaveBar('/CRM/report/ContactFrame.jsp?tabtype=remind')">
							 	<div class="btndiv"></div>
							 	<%if(count>0){%>
	...
	<div style="position: relative;height:100%;width:100%" id="maindiv">
	 	<div id="leftdiv" class="northDiv left" style="border-right:1px solid #BDBDBD;height:100%;width:576px;">
	 		<div id="listoperate">
				...
				%>
				<div id="resource" _value="<%=userid%>"  class="main_btn menuitem1" style="text-align:left;width:60px;<%=isShowResource?"":"display:none"%>" onclick="showMenu(this,'resourceMenu',event)">
				...
				<div id="viewtype" _value="0" class="main_btn menuitem1" style="width:60px;<%=isShowResource?"":"display:none"%>" onclick="showMenu(this,'viewtypeMenu',event)">
				...
				<div id="status" _value="" class="main_btn menuitem1" style="width:65px;margin-right: 3px;" onclick="showMenu(this,'statusMenu',event)">
				...
				<div id="sector" _value="" class="main_btn menuitem1" style="width:65px;margin-right: 3px;" onclick="showMenu(this,'sectorMenu',event)">
					<div class="menuitem1-l menuName" style="white-space:nowrap;width:50px;overflow:hidden;text-overflow:ellipsis;">
				...
				<div id="operation"  class="main_btn menuitem1" style="width:110px;float: right;">
				...
				<div id="viewtypeMenu" class="drop_list" style="width:75px;overflow: auto;">
	...
	<%@ include file="/systeminfo/RightClickMenu_wev8.jsp" %>		
		...
		<script type="text/javascript">
			...
			function getData(){
				...
				$("#loadingdiv1").show();
			    $.post("/CRM/customer/CustomerListNew.jsp?"+params,{pageindex:pageindex,index:index,pagesize:pagesize},function(data){
			...
			function applyLabels(){
				...
				$("#listdiv").find("input[name='chkInTableTag']:checked").each(function(){
					customerids+=","+$(this).attr("checkboxid");
				});
			...
			function markAsImportant(obj){
				...
				$("#listdiv").find("input[name='chkInTableTag']:checked").each(function(){
					var customerid=$(this).attr("checkboxid");
					var $this=$(this);

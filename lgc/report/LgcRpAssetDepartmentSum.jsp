...
<tr>
	...
	<td valign="top">
		...
		<td valign="top">
<%
LgcRpSumManage.setOptional("department") ;
...
<TABLE class=ListStyle width="100%" cellspacing=1>
  ...
  while(LgcRpSumManage.next())  { 
	...
	%>
    <TD><%=Util.toScreen(DepartmentComInfo.getDepartmentname(resultid),user.getLanguage())%></TD>
    <TD> 
      <TABLE height="100%" cellSpacing=0 width="100%">
        <TBODY> 
        <TR> 
          <a href="/lgc/search/LgcSearchOperation.jsp?departmentid=<%=resultid%>&operation=search">

...
String sqlstr = "select * from LgcAssetType "+ sqlwhere ;
%>
<BODY>
...
<tr>
	...
	<td valign="top">
		...
		<tr>
		<td valign="top">
<FORM NAME=SearchForm STYLE="margin-bottom:0" action="LgcAssetTypeBrowser.jsp" method=post>
...
<TR class=DataHeader>
      ...
      <TH width=60% ><%=SystemEnv.getHtmlLabelName(85,user.getLanguage())%></TH></tr><TR class=Line><TH colSpan=4></TH></TR>
<%
int i=0;
RecordSet.executeSql(sqlstr);
while(RecordSet.next()){
	String ids = RecordSet.getString("id");
	String typemarks = Util.toScreen(RecordSet.getString("typemark"),user.getLanguage());

...
<HTML>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/workrelate/plan/css/table.css" />
		<link rel="stylesheet" type="text/css" href="/workrelate/plan/css/tab.css" />
		<style type="text/css">
			...
			.status1{background: url('/workrelate/plan/images/status1.png') center no-repeat;}
			.status2{background: url('/workrelate/plan/images/status2.png') center no-repeat;}
			.status3{background: url('/workrelate/plan/images/status3.png') center no-repeat;}
			.status4{background: url('/workrelate/plan/images/pstatus0.png') center no-repeat;}
			.status5{background: url('/workrelate/plan/images/status5.png') center no-repeat;}
			.status6{background: url('/workrelate/plan/images/status6.png') center no-repeat;}
			.status7{background: url('/workrelate/plan/images/status7.png') center no-repeat;}
			.status8{background: url('/workrelate/plan/images/status8.png') center no-repeat;}
			.status_txt{height: 24px;display:-moz-inline-box;display:inline-block;float: left;}
			.rescore{width: 14px;height: 22px;background: url('/workrelate/plan/images/rescore.png') center no-repeat;display:-moz-inline-box;display:inline-block;}
	...
	<body style="overflow: hidden;">
		...
		<form id="searchForm" name="searchForm" action="RList.jsp" method="post">
		...
		<script type="text/javascript" src="/workrelate/plan/js/tab.js"></script>  

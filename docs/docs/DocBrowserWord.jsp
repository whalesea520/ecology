...
RecordSet.executeSql("SELECT onlyCanAddWord FROM workflow_createdoc WHERE workFlowID = " + bdf_wfid);
if(RecordSet.next()){
    onlyCanAddWord = RecordSet.getString("onlyCanAddWord");
    if(!onlyCanAddWord.equals("1")){
    	onlyCanAddWord = "2";
    }
}
...
<script type="text/javascript">
    var js_onlyCanAddWord = "<%=onlyCanAddWord%>";

...
String navName=SystemEnv.getHtmlLabelName(16972,user.getLanguage());
if(!id.equals("")){
...
if("".equals(id) && "".equals(showOrder0)) {
	RecordSet.executeSql("SELECT MAX(showOrder)+1 FROM DocSecretLevel");
	if(RecordSet.next()){
...
<script type="text/javascript">
	...
	<%if(isClose.equals("1")){%>
		//parentWin.location.href = "docSecretLevel.jsp";
...
<%if(canedit){%>
<div id="formDiv">
<FORM id=weaverA name=weaverA action="docSecretLevelOperation.jsp" method=post  >
<%if(id.equals("")){%>

...
<script type="text/javascript">
	try{
		parent.setTabObjName("<%=SystemEnv.getHtmlLabelNames("16972",user.getLanguage())%>");
	}catch(e){
...
//the orginal source code is:sqlwhere = "select * from DocSecretLevel "+sqlwhere;
sqlwhere = "select * from DocSecretLevel "+sqlwhere + "order by showOrder asc";
//end

...
<script type="text/javascript">
	try{
		parent.setTabObjName("<%=SystemEnv.getHtmlLabelNames("16973",user.getLanguage())%>");
	}catch(e){
...
//the orginal source code is:sqlwhere = "select * from DocSendDocKind "+sqlwhere;
sqlwhere = "select * from DocSendDocKind "+sqlwhere + "order by showOrder asc";
//end

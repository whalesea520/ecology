...
if(!init.equals("")&&exist){
    ...
    WorkflowKeywordManager.getKeywordTreeList(envelope,"keywordSingle",selectedList,excludeId);
    ...
    envelope.addTreeNode(root);
    String rootId="0";
    WorkflowKeywordManager.getKeywordTreeList(envelope,rootId,0,3,"keywordSingle",excludeId,null,null);
}else{
    String rootId=keywordId;
    WorkflowKeywordManager.getKeywordTreeList(envelope,rootId,0,2,"keywordSingle",excludeId,null,null);
}

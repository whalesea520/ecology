...
String navName=SystemEnv.getHtmlLabelName(16980,user.getLanguage());
if(!id.equals("")){
...
if("".equals(id) && "".equals(showOrder0)) {
	RecordSet.executeSql("SELECT MAX(showOrder)+1 FROM DocSendDocNumber");
	if(RecordSet.next()){
...
<script type="text/javascript">
	...
	<%if(isClose.equals("1")){%>
		//parentWin.location.href = "docNumber.jsp";

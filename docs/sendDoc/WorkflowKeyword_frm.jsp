...
<table cellspacing="0" cellpadding="0" class="flowsTable" style="width:100%;"  >
	<tr>
		...
		<td rowspan="2">
			<iframe src="DocKeywordTab.jsp?keywordId=<%=keywordId %>" id="contentframe" name="contentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
		</td>
	</tr>
	<tr>
	...
	<script type="text/javascript">
		jQuery(document).ready(function(){
			e8_initTree("/docs/sendDoc/WorkflowKeywordLeft.jsp?keywordId=<%=keywordId%>");
		});
	</script>

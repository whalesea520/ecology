...
String navName=SystemEnv.getHtmlLabelName(15534,user.getLanguage());
...
if("".equals(id) && "".equals(showOrder0)) {
	RecordSet.executeSql("SELECT MAX(showOrder)+1 FROM DocInstancyLevel");
	if(RecordSet.next()){
...
<script type="text/javascript">
	...
	<%if(isClose.equals("1")){%>
		//parentWin.location.href = "docInstancyLevel.jsp";
...
<%if(canedit){%>
<div id="formDiv">
<FORM id=weaverA name=weaverA action="docInstancyLevelOperation.jsp" method=post  >
<%if(id.equals("")){%>

...
if("0".equals(docdetachable)){
    response.sendRedirect("/docs/mould/DocMouldTab.jsp?isDetach=1&_fromURL=3");
    return;
}
%>
<BODY scroll="no">
...
<table cellspacing="0" cellpadding="0" class="flowsTable" style="width:100%;height:100%;"  >
	<tr>
		...
		<td rowspan="2">
			<iframe src="/docs/mould/DocMouldTab.jsp?isDetach=1&_fromURL=3&isWorkflowDoc=<%=isWorkflowDoc%>" id="outcontentframe" name="outcontentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
		</td>
	</tr>
	<tr>
	...
	<script type="text/javascript">
		jQuery(document).ready(function(){
			e8_initTree("/docs/category/subcompany_left.jsp?rightStr=DocMould:all&isDetach=3&isWorkflowDoc=<%=isWorkflowDoc%>&url=/docs/mould/DocMouldTab.jsp?_fromURL=3");
		});
	</script>

...
$(function(){
    $('.e8_box').Tabs({
        ...
        staticOnLoad:true,
        objName:"<%=SystemEnv.getHtmlLabelName(16398,user.getLanguage()) %>"
    });
...
<%
	...
	String url = "/docs/transfer/MutilCategoryBrowserByAuth.jsp?isdialog=1&";
	
	String codeName = Util.null2String(request.getParameter("_fromURL"));
  if(codeName.startsWith("auth")) codeName=codeName.substring(4);
  
  if("T145".equals(codeName)||"C145".equals(codeName)||"D125".equals(codeName)){
  	url="/docs/transfer/TreeFieldBrowserMultiAuth.jsp?isdialog=1&";
  }

...
if(aboutdoc == '-1')
{
DEFAULT_URL = '/weaver/weaver.file.FileDownload?frompdfview=1&fileid=' + pdfimagefileid+'&requestid='+requestid+'&formmode_authorize='+formmode_authorize+'&authorizemodeId='+authorizemodeId+'&authorizeformmodebillId='+authorizeformmodebillId+'&authorizefieldid='+authorizefieldid+'&authorizeformModeReplyid='+authorizeformModeReplyid+'&authorizefMReplyFName='+authorizefMReplyFName;
}
else{
	DEFAULT_URL = '/weaver/weaver.homepage.HomepageCreateImage?aboutdoc='+aboutdoc+'&workplanid=' + workplanid+'&fileid=' + pdfimagefileid+'&requestid='+requestid;
}
;
var pdfjsWebLibs;
{
 ...
 (function () {
  ...
  (function (root, factory) {
   ...
   function getPDFFileNameFromURL(url) {
	   var defaultFilename = imagefilename;
    var reURI = /^(?:([^:]+:)?\/\/[^\/]+)?([^?#]*)(\?[^#]*)?(#.*)?$/;
  ...
  (function (root, factory) {
   ...
   function webViewerPrint() {
    var ua = navigator.userAgent.toLowerCase();
	   if((ua.indexOf('msie') > -1 && ua.indexOf('opera') == -1)||((ua.indexOf("trident/7.0")>-1||ua.indexOf("trident/8.0")>-1||ua.indexOf("rv:11")>-1) && ua.indexOf('opera') == -1)){
	   if(__printvar==""){
		  pagesetup_null();
		  window.print();
		  
	   }else{
		  openFullWindowForXtable(__printvar);

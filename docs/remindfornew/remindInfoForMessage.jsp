...
if("edit".equals(method)){
    String sql = "update remindfornewDoc set  bodymessage='"+bodymsg+"' where  secid= "+secid+" and urltype="+urlType;
	...
	if(RecordSet.next()){
		...
		bodymsg="您有新的待阅文档《$DOC_Subject》，请查阅";
		//return;
...
<form id="myForm" name="myForm" action="remindInfoForMessage.jsp" method="post">
	...
	<input name="method" type="hidden" value="edit">
 	<table cellspacing="0"  style="height:100%;background-color: rgb(248,248,248)">
 		<tr height="100%">
 		 <td width="70%" valign="top">
 		 	<wea:layout type="2col">
		 		<wea:group context='<%=SystemEnv.getHtmlLabelName(19480, user.getLanguage()) %>' attributes="{'groupSHBtnDisplay':'none'}">
					...
					<wea:item>
						<textarea rows="6" style="width:90%;height:300px;" id="bodymsg" name="bodymsg" value="<%=bodymsg %> " onfocus="changefoucus(this)"><%=bodymsg %> </textarea>
					</wea:item>
		 		</wea:group>
			</wea:layout>
 		 </td>

...
<%
	...
	if(showOrder==0){
		RecordSet.executeSql("select max(showOrder) from DocFTPConfig ");
		if(RecordSet.next()){
			showOrder = Util.getFloatValue(RecordSet.getString(1))+1;
		}
	}


String imagefilename = "/images/hdMaintenance_wev8.gif";
String titlename = SystemEnv.getHtmlLabelName(82,user.getLanguage())+"："+SystemEnv.getHtmlLabelName(20518,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<body>

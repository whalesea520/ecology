...
if("0".equals(docdetachable)){
    response.sendRedirect("DocMainCategory.jsp");
    return;
}
...
<table cellspacing="0" cellpadding="0" class="flowsTable" style="width:100%;height:100%;"  >
	<tr>
		...
		<td rowspan="2">
			<iframe src="DocMainCategory.jsp?isFromMonitor=<%=isFromMonitor%>" id="outcontentframe" name="outcontentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
		</td>
	</tr>
	<tr>
	...
	<script type="text/javascript">
		jQuery(document).ready(function(){
			e8_initTree("subcompany_left.jsp?rightStr=<%=rightStr%>&url=DocMainCategory.jsp?isFromMonitor=<%=isFromMonitor%>");
		});
	</script>

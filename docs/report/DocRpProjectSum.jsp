...
String titlename = SystemEnv.getHtmlLabelName(352,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(101,user.getLanguage());
String needfav ="1";
String needhelp ="";

String optional="project";
int total=0;
int linecolor=0;
%>
...
<TABLE class=ListStyle width="100%" cellspacing=1>
  ...
  <TR class=Header>
    <TH><nobr><%=SystemEnv.getHtmlLabelName(101,user.getLanguage())%></TH>
...
<TR class=Line><TD colSpan=9></TD></TR>
  ...
  <TR <%if(linecolor==0){%>class=datalight <%} else {%> class=datadark <%}%>>
    <TD><%=Util.toScreen(ProjectInfoComInfo.getProjectInfoname(resultid),user.getLanguage())%></TD>
    <TD>

...
String titlename = SystemEnv.getHtmlLabelName(352,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(147,user.getLanguage());
String needfav ="1";
String needhelp ="";
...
<TABLE class=ListStyle width="100%" cellspacing =1>
  ...
  <TR class=Header>
    <TH><nobr><%=SystemEnv.getHtmlLabelName(147,user.getLanguage())%></TH>

...
String titlename = SystemEnv.getHtmlLabelName(352,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(66,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<BODY>
...
<tr>
	...
	<td valign="top">
		...
		<td valign="top">
<%
String maincategoryid = Util.null2String(request.getParameter("id"));
DocRpSumManage.setID(maincategoryid) ;
DocRpSumManage.setOptional("subcategory") ;
...
<TABLE class=ListStyle width="100%" cellspacing=1>
  ...
  <TBODY>
  <TR class=Header>
    <TH><%=SystemEnv.getHtmlLabelName(66,user.getLanguage())%></TH>
...
<TR class=Line><TD colSpan=9></TD></TR>
  ...
  <TR class=datadark>
    <TD><A 
      href="DocRpSecCategorySum.jsp?id=<%=resultid%>"><%=Util.toScreen(SubCategoryComInfo.getSubCategoryname(resultid),user.getLanguage())%></A></TD>
    <TD>

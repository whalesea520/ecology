...
String titlename = SystemEnv.getHtmlLabelName(352,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(79,user.getLanguage());
String needfav ="1";
String needhelp ="";

String optional="doccreater";
int total=0;
int linecolor=0;
%>
...
<TABLE class=ListStyle width="100%" cellspacing=1>
  ...
  <TR class=Header>
    <TH><nobr><%=SystemEnv.getHtmlLabelName(79,user.getLanguage())%></TH>

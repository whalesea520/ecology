	...
	<FORM id=searchfrm name=searchfrm method=post>
		<wea:layout type="4col">
			...
			<%
				...
				String tableString=""+
					   "<table datasource=\"weaver.docs.docs.DocDataSource.getNoReadLog\" sourceparams=\"id:"+docid+"+operateuserid:"+creater+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.DOC_NOREADDOCLOG,user.getUID(),PageIdConst.DOC)+"\" tabletype=\"none\">"+
					   "<sql backfields=\"*\" sqlform=\"tmpTable\" sqlsortway=\"asc\" sqlorderby=\"id\" sqlprimarykey=\"id\" />"+
					   "<head>";
					   		tableString+=	 "<col width=\"30%\"  text=\""+SystemEnv.getHtmlLabelName(99,user.getLanguage())+"\" column=\"operateuserid\" />";
					   		tableString += "<col width=\"70%\" text=\""+SystemEnv.getHtmlLabelName(229,user.getLanguage())+"\" column=\"subject\" />"+
					   "</head>"+
					   "</table>";      
			  %>
			  <input type="hidden" name="pageId" id="pageId" value="<%= PageIdConst.DOC_NOREADDOCLOG %>"/>

...
if(true){
	...
	if(from.equals("shareMutiDoc")){
		response.sendRedirect("/docs/search/DocMain.jsp?urlType=13&"+request.getQueryString());
		return;
	}else{
		response.sendRedirect("/docs/search/DocMain.jsp?urlType=14&"+request.getQueryString());
		return;
	}
}
...
<script type="text/javascript">
	...
	jQuery(document).ready(function(){
		var url = "DocSearchContent.jsp?ishow=true";

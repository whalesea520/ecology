...
<%
	...
	hasRightSub=SubCompanyComInfo.getRightSubCompany(user.getUID(),"DocumentRecycle:All",-1);
...
<BODY scroll="no">
	<div class="e8_box demo2">
	    ...
	    <div class="tab_box">
			<iframe src="/docs/search/DocMain.jsp?urlType=23&isDetach=3&subcompanyId=<%=subcompanyId%>" onload="update()" id="tabcontentframe" name="tabcontentframe" class="flowFrame" frameborder="0" height="100%" width="100%;"></iframe>
	    </div>
	</div>     
</body>
</html>

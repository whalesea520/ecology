	...
	<FORM id=searchfrm name=searchfrm method=post>
		<wea:layout type="4col">
			...
			<%
				//设置好搜索条件				
				String tableString=""+
				 "<table datasource=\"weaver.docs.docs.DocDataSource.getReadedLog\" sourceparams=\"id:"+id+"+operateuserid:"+creater+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.DOC_DOCLOG,user.getUID(),PageIdConst.DOC)+"\" tabletype=\"none\">"+
				   "<sql backfields=\"*\" sqlform=\"tmpTable\" sqlsortway=\"desc\" sqlorderby=\"operatedate\" sqlprimarykey=\"id\" />"+
					   "<head>";
					   		...
					   		tableString += "<col width=\"15%\" transmethod=\"weaver.splitepage.transform.SptmForDoc.getName\"  text=\""+SystemEnv.getHtmlLabelName(99,user.getLanguage())+"\" otherpara=\""+user.getLogintype()+"\" column=\"operateuserid\" orderkey=\"operateuserid\"/>";
							tableString += "<col width=\"10%\" transmethod=\"weaver.docs.DocDetailLogTransMethod.getDocStatus\" otherpara=\""+user.getLanguage()+"\"  text=\""+SystemEnv.getHtmlLabelName(63,user.getLanguage())+"\" column=\"operatetype\" />";
							tableString +=	 "<col width=\"15%\" transmethod=\"weaver.docs.DocDetailLogTransMethod.getDocId\"  text=\""+SystemEnv.getHtmlLabelName(84,user.getLanguage())+"\" column=\"docid\"  />";
							tableString += "<col width=\"25%\" transmethod=\"weaver.splitepage.transform.SptmForDoc.getDocName\" text=\""+SystemEnv.getHtmlLabelName(229,user.getLanguage())+"\" column=\"docid\" />";
							tableString +=	 "<col width=\"15%\"  text=\""+SystemEnv.getHtmlLabelName(108,user.getLanguage())+SystemEnv.getHtmlLabelName(110,user.getLanguage())+"\" column=\"clientaddress\" />"+
					   "</head>"+
					   "</table>";      
			  %>

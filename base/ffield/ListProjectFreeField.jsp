...
<%
if(true){
	response.sendRedirect("/proj/ffield/prjFreefieldTab.jsp");
	return;
}
RecordSet.executeSql("select * from Base_FreeField where tablename = 'p1'");
RecordSet.first();
...
String titlename = SystemEnv.getHtmlLabelName(570,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(101,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<BODY>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=dff01"><%=SystemEnv.getHtmlLabelName(97,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>1</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=dff02"><%=SystemEnv.getHtmlLabelName(97,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>2</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=dff03"><%=SystemEnv.getHtmlLabelName(97,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>3</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=dff04"><%=SystemEnv.getHtmlLabelName(97,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>4</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=dff05"><%=SystemEnv.getHtmlLabelName(97,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>5</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=nff01"><%=SystemEnv.getHtmlLabelName(607,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>1</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=nff02"><%=SystemEnv.getHtmlLabelName(607,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>2</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=nff03"><%=SystemEnv.getHtmlLabelName(607,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>3</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=nff04"><%=SystemEnv.getHtmlLabelName(607,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>4</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=nff05"><%=SystemEnv.getHtmlLabelName(607,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>5</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=tff01"><%=SystemEnv.getHtmlLabelName(608,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>1</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=tff02"><%=SystemEnv.getHtmlLabelName(608,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>2</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=tff03"><%=SystemEnv.getHtmlLabelName(608,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>3</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=tff04"><%=SystemEnv.getHtmlLabelName(608,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>4</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=tff05"><%=SystemEnv.getHtmlLabelName(608,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>5</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=bff01"><%=SystemEnv.getHtmlLabelName(609,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>1</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=bff02"><%=SystemEnv.getHtmlLabelName(609,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>2</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=bff03"><%=SystemEnv.getHtmlLabelName(609,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>3</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=bff04"><%=SystemEnv.getHtmlLabelName(609,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>4</a></td>
...
<%	}else{%>
  <tr CLASS=DataLight>
<%	}%>
    <td><a href="/base/ffield/EditFreeField.jsp?tablename=p1&ffname=bff05"><%=SystemEnv.getHtmlLabelName(609,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>5</a></td>

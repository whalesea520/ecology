...
// (Minified)   - http://github.com/cowboy/jquery-hashchange/raw/master/jquery.ba-hashchange.min_wev8.js (0.8kb gzipped)
// 
// About: License
// 
		...
		for ( pos = 0, numli = li.length; pos < numli; pos++ ) {
			...
			if ( create || item[ 0 ].className.search( /\bui-li-static\b|\bui-li-divider\b/ ) < 0 ) {
				...
				if ( a.length && a[ 0 ].className.search( /\bui-btn\b/ ) < 0 && !isDivider ) {
					...
					// TODO: Remove in 1.5 together with links_wev8.js (links_wev8.js / .ui-link deprecated in 1.4)

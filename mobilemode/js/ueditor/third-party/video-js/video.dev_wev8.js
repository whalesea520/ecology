...
/**
 * An instance of the `vjs.Player` class is created when any of the Video_wev8.js setup methods are used to initialize a video.
 *
 * ```js
 * var myPlayer = videojs('example_video_1');
 * ```
 *
 * In the follwing example, the `data-setup` attribute tells the Video_wev8.js library to create a player instance when the library is ready.
 *
 * ```html
 ...
 * browser's default controls will be shown, and not the Video_wev8.js custom skin.
...
vjs.Player.prototype.requestFullScreen = function(){
  ...
  if (requestFullScreen) {
    ...
    // we can't take the video_wev8.js controls fullscreen but we can go fullscreen
 ...
 * source objects. Video_wev8.js will detect which version is supported and load that
 * file.
 *
 *     myPlayer.src([
 ...
 *
 *     // setting
 *     myPlayer.poster('http://example.com/myImage_wev8.jpg');
 *
...
vjs.Html5.prototype.setCurrentTime = function(seconds){
  try {
    ...
    vjs.log(e, 'Video is not ready. (Video_wev8.js)');
      ...
      if (vid && vid.getAttribute) {
        ...
        if (vid['player'] === undefined) {
          ...
          if (options !== null) {
            ...
            // Create new video_wev8.js instance.
...
vjs.autoSetupTimeout(1);
/**
 * the method for registering a video_wev8.js plugin
 *

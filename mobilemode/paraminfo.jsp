	...
	<table class="e8_tblForm">
		...
		<tr>
			...
			<td class="e8_tblForm_field">
				<input type="text" id="paramName" name="paramName" value="<%=paramName %>" class="textStyle" placeholder="<%=SystemEnv.getHtmlLabelName(127629,user.getLanguage())%>"/>  <!-- 一个英文的参数名称，如name -->
			</td>
		</tr>
		<tr>
			<td class="e8_tblForm_label"><%=SystemEnv.getHtmlLabelName(20969,user.getLanguage())%><!-- 参数值 --></td>
			<td class="e8_tblForm_field">
				<div>

...
Dialog.prototype.callback = function(datas){
	if(!this.browserConfig){
		//added by wcd 2015-10-21
		try{if(!!this._callBack) this._callBack(datas);}catch(e){if(window.console)console.log(e+"-->/wui/theme/ecology7/jquery/js/zDialog.js-->callback()");}
		if(window.console){
...
*/
Dialog.prototype.close = function(datas){
	try {

...
float:left;
	height: 27px;
	width: 11px;
	background: url(/wui/theme/ecology7/skins/<%=lskin%>/page/left/leftMenuItemLeft_wev8.png) no-repeat;
}
...
.leftMenuItemCenter {
	...
	height: 27px;
	line-height:27px;
	background: url(/wui/theme/ecology7/skins/<%=lskin%>/page/left/leftMenuItemCenter_wev8.png) repeat-x;
	text-indent:18px;
...
.leftMenuItemRight {
	...
	width: 5px;
	height: 27px;
	background: url(/wui/theme/ecology7/skins/<%=lskin%>/page/left/leftMenuItemRight_wev8.png) 0 0 no-repeat;
...
.leftMenuItemNavLeft {
	...
	height: 27px;
	width: 11px;
	background:url(/wui/theme/ecology7/skins/<%=lskin%>/page/left/leftMenuItemNavLeft_wev8.png) no-repeat;
...
.leftMenuItemNavCenter {
	...
	line-height:27px;
	text-indent:18px;
	background: url(/wui/theme/ecology7/skins/<%=lskin%>/page/left/leftMenuItemNavCenter_wev8.png) repeat-x;
	background-position:0 -28;
	z-index:-1;
	text-overflow:ellipsis;white-space:nowrap;overflow:hidden;
}
...
.leftMenuItemNavRight {
	...
	height: 27px;
	width: 10px;
	background: url(/wui/theme/ecology7/skins/<%=lskin%>/page/left/leftMenuNavRight_wev8.png) no-repeat;
	background-position:0 -28;
	z-index:-1;
}
...
.drillcrumbUrlLeft {
	background: url(/wui/theme/ecology7/skins/<%=lskin%>/page/left/leftMenuUrlLeft_wev8.png) no-repeat;
}
.drillcrumbUrlCenter {
	background: url(/wui/theme/ecology7/skins/<%=lskin%>/page/left/leftMenuUrlCenter_wev8.png) repeat-x;
}
.drillcrumbUrlRight {
	background: url(/wui/theme/ecology7/skins/<%=lskin%>/page/left/leftMenuUrlRight_wev8.png) no-repeat;
}
</STYLE>
...
jQuery(document).ready(function(event) {
    ...
    var myLftMenu = new drilldownmenu(
        {menuid: 'drillmenu',menuheight: 'auto',breadcrumbid: 'drillcrumb',persist: {enable: false, overrideselectedul: false},speed:0,homeDir:'<%=SystemEnv.getHtmlLabelName(31753,user.getLanguage())%>'}
    );
...
function lMNavEventRebind(fnavUrlName, isPortal) {
	...
	try{
		if(fnavUrlName == undefined || fnavUrlName == null || fnavUrlName== ""){
			fnavUrlName="<%=SystemEnv.getHtmlLabelName(31753,user.getLanguage())%>";
		}
	}catch(e){
	}

var Drag={
	...
	"drag":function(e){
		...
		if(currentLeft>jQuery(window).width()-_dialogDiv.width())currentLeft = jQuery(window).width()-_dialogDiv.width();
		if(currentTop>jQuery(window).height()-_dialogDiv.height())currentTop = jQuery(window).height()-_dialogDiv.height();

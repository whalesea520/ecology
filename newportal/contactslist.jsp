...
<link href="style/Contacts_wev8.css" rel="stylesheet" type="text/css" />
<link href="style/Public_wev8.css" rel="stylesheet" type="text/css" />
<LINK href="/css/Weaver_wev8.css" type=text/css rel=STYLESHEET>
<LINK href="/wui/theme/ecology7/skins/default/wui_wev8.css" type=text/css rel=STYLESHEET>
<link type='text/css' rel='stylesheet'  href='/wui/skins/default/wui_wev8.css'/>
...
<i class="Relative BoxW90 DisBox FL PL10" >
	<table>
			<tr>
				...
				<td><img  id="search"  onclick="doSearch()" src="images/Search_wev8.png" class="png Bgfff" style="padding:2px;cursor:hand;" /></td>
			</tr>
		</table>
</i>
</td>
...
<img src="/messager/images/dummyContact_wev8.png" class="ContactsAvatar Absolute" style="right:0" />
...
function doSearch(){
	...
	if (typeof(subid) == "undefined" ||subid == "undefined") { 
		subid = "";
	}
	if (typeof(departid) == "undefined"||departid == "undefined") { 
		departid = "";
	}
	var keyword = $("#keyword").val();
	$("#ContactsSearch").html("");
	//$("#ContactsSearch").load("contactssearch.jsp?subid="+returnValue+"&departid="+departid+"&keyword="+keyword);
...
function setSubCompony(name,id){
	...
	var obj = document.getElementById("departmentSel");
	//$(obj).load("departmentoptioninfo.jsp?subid="+id);
	var htmlobj = jQuery.ajax({url:"departmentoptioninfo.jsp?subid="+id,async:false});
	jQuery(obj).empty();
	jQuery(obj).selectbox("detach");
  	jQuery(obj).append(htmlobj.responseText);

...
<%
String carName = SystemEnv.getHtmlLabelName(19021,user.getLanguage());//车辆信息维护
String carDesc = SystemEnv.getHtmlLabelName(19021,user.getLanguage());//车辆信息维护
String tempquerystring = Util.null2String(request.getQueryString());
String subCompanyId = Util.null2String(request.getParameter("subCompanyId"));

String url = "/car/CarInfoMaintenanceIframe.jsp?subCompanyId="+subCompanyId+"&"+tempquerystring;
%>
<!DOCTYPE html><HEAD>

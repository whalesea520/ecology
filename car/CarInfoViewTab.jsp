...
<%
String carName = SystemEnv.getHtmlLabelName(20316,user.getLanguage());//车辆信息
String carDesc = SystemEnv.getHtmlLabelName(20316,user.getLanguage());//车辆信息
String tempquerystring = Util.null2String(request.getQueryString());

String url = "/car/CarInfoView.jsp?"+tempquerystring;
%>
<!DOCTYPE html><HEAD>

...
var hs = {
// Language strings 多语言设置
	
lang : langSetting,
// See http://highslide.com/ref for examples of settings  
graphicsDir : '/js/messagejs/highslide/graphics/',
...
marginTop : 15,
marginBottom : 15,
zIndexCounter : 3000, // adjust to other absolutely positioned elements
loadingOpacity : 0.75,
...
creditsHref : "javascript:openFullWindowHaveBar('http://www.weaver.com.cn')",
...
dim : function(exp) {
	...
	if (hs.geckoMac && hs.dimmingGeckoFix) 
		hs.dimmer.style.background = 'url('+ hs.graphicsDir + 'geckodimmer_wev8.png)';		
	else
...
updateAnchors : function() {
	...
	var  all = [], images = [], htmls = [],groups = {}, re;
	//在人员基本信息卡片使用中，不需要对所有页面元素进行处理
	if(document.getElementById("mainsupports")!=undefined){
...
preloadGraphic : function () {
	var src = hs.graphicsDir + (hs.outlinesDir || "outlines/")+ this.outlineType +"_wev8.png";

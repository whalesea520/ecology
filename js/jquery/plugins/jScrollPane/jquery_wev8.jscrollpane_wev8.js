		...
		function JScrollPane(elem, s)
		{
			...
			function resizeScrollbars()
			{
				...
				if (isScrollableV) {
					...
					//alert(verticalDragHeight)
					if(verticalDragHeight-25>0){
						//alert(11)
						$(".jspDragBottom").css("margin-top",verticalDragHeight-25);
					}
		...
		$.fn.jScrollPaneRemove = function()
		{
			$(this).each(function()
			{
				...
				if ($c.is('.jspContainer')) {
					...
					$this.attr('style', $this.data('padding'));
					$c.after($this).remove();
				}
			});
		}

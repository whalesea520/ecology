        ...
        this.each(function ()
        {
            ...
            if (p.auto || options == undefined)
            {
                ...
                }).bind('mouseout.tip', function (e)
                {
					...
					if(this==relatedTarget || relatedTarget.parentNode==this || relatedTarget.nodeName=="DIV"){
						return;
					}
    ...
    $.ligerui.controls.Tip.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            if (p.content)
            {
                ...
                tip.appendTo('body');
                tip.hover(function(){
                	$("[ligerTipId='"+$(this).attr("id")+"']").parent().addClass("Selected");
                },function(){
                	$("[ligerTipId='"+$(this).attr("id")+"']").parent().removeClass("Selected");
                	$(this).remove();
                });
            }
            else

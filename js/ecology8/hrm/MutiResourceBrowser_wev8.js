function showMultiDocDialog(selectids,virtualtype){
	var config = null;
  ...
  if(virtualtype){
  	config.srcurl = "/hrm/resource/MutiResourceVirtualBrowserAjax.jsp?src=src";
  	config.desturl = "/hrm/resource/MutiResourceVirtualBrowserAjax.jsp?src=dest";
  }else{
  	config.srcurl = "/hrm/resource/MutiResourceBrowserAjax.jsp?src=src";
  	config.desturl = "/hrm/resource/MutiResourceBrowserAjax.jsp?src=dest";
  }
  config.pagesize = 10;

function showMultiDocDialog(selectids){
    ...
    config.srchead=[SystemEnv.getHtmlNoteName(3534,readCookie("languageidweaver")),SystemEnv.getHtmlNoteName(3534,readCookie("languageidweaver")),SystemEnv.getHtmlNoteName(3536,readCookie("languageidweaver"))];
    config.container =$("#colShow");
    config.searchLabel="";
    config.hiddenfield="id";
    config.saveLazy = true;//取消实时保存
    config.saveurl= "/docs/docsubscribe/MutiDocByOwnerBrowserAjax.jsp?src=save";
    config.srcurl = "/docs/docsubscribe/MutiDocByOwnerBrowserAjax.jsp?src=src";
    config.desturl = "/docs/docsubscribe/MutiDocByOwnerBrowserAjax.jsp?src=dest";
    config.delteurl="/docs/docsubscribe/MutiDocByOwnerBrowserAjax.jsp?src=save";
    config.pagesize = 10;

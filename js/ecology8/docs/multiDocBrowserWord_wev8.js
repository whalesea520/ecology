function showMultiDocDialog(selectids){
    ...
    if(js_onlyCanAddWord == 1){
        config.srcurl = "/docs/docs/MutiDocBrowserAjax.jsp?src=src&f_weaver_belongto_usertype="+f_weaver_belongto_usertype+"&f_weaver_belongto_userid="+f_weaver_belongto_userid+"&isWord=1";
    }else if(js_onlyCanAddWord == 2){
        config.srcurl = "/docs/docs/MutiDocBrowserAjax.jsp?src=src&f_weaver_belongto_usertype="+f_weaver_belongto_usertype+"&f_weaver_belongto_userid="+f_weaver_belongto_userid+"&isWord=2";
    }else{

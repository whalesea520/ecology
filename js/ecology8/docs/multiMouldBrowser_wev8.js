function showMultiMouldDialog(selectids){
    ...
    config.saveurl= "/docs/mould/DocMouldMultiBrowserAjax.jsp?src=save";
    config.srcurl = "/docs/mould/DocMouldMultiBrowserAjax.jsp?src=src";
    config.desturl = "/docs/mould/DocMouldMultiBrowserAjax.jsp?src=dest";
    config.delteurl="/docs/mould/DocMouldMultiBrowserAjax.jsp?src=save";
    config.pagesize = 10;

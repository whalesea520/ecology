...
WebFXTree.prototype.toString = function() {
	var goalFlowStr = "<button class='Browser' id='SelectFlowID' onClick=\"onShowCatalog('0','"+this.action+"')\" style=''></button>";
...
WebFXTreeItem.prototype.toString = function (nItem, nItemCount) {
	...
	//var flowStr = "<button class='Browser' id='SelectFlowID' onClick=\"onShowCatalog('0')\" style='margin-right:200px;float:right'></button>";
	var goalFlowStr = "<button class='Browser' id='SelectFlowID' onClick=\"onShowCatalog('0','"+this.action+"')\" style=''></button>";

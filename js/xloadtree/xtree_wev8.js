...
WebFXTree.prototype.toString = function() {
	...
	str += "<img id=\"" + this.id + "-icon\" class=\"webfx-tree-icon\" src=\"" + ((webFXTreeHandler.behavior == 'classic' && this.open)?this.openIcon:this.icon) + "\" onclick=\"\"><span style=\"cursor:hand;border:1px solid #FFFFFF\" onclick=\""+this.action+"\" onmouseover=\"this.style.backgroundColor='#DDDDDD';this.style.border='1px solid #0099CC';\" onmouseout=\"this.style.backgroundColor='';this.style.border='1px solid #FFFFFF';\"> " + this.text + " </span></div>";

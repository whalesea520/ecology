...
WebFXTreeItem.prototype.setFolderId = function(){
	//alert(this.id + '-hidden');
	document.getElementById(this.id + '-hidden').innerHTML = this.folderId;
	//alert(document.getElementById(this.id + '-hidden').innerHTML);
}

WebFXTreeItem.prototype.setGroupId = function(){
	document.getElementById(this.id + '-hidden').innerHTML = this.groupId;
}
...
WebFXTreeItem.prototype.toString = function (nItem, nItemCount) {
	...
	var str = "<div id=\"" + this.id + "\" onmousemove=\"traceMouseDrag()\" ondblclick=\"webFXTreeHandler.toggle(this);\" class=\"webfx-tree-item\" onkeydown=\"return webFXTreeHandler.keydown(this, event)\">" +
		indent +
		"<img id=\"" + this.id + "-plus\" src=\"" + ((this.folder)?((this.open)?((this.parentNode._last)?webFXTreeConfig.lMinusIcon:webFXTreeConfig.tMinusIcon):((this.parentNode._last)?webFXTreeConfig.lPlusIcon:webFXTreeConfig.tPlusIcon)):((this.parentNode._last)?webFXTreeConfig.lIcon:webFXTreeConfig.tIcon)) + "\" onclick=\"webFXTreeHandler.toggle(this);\">" +
		
		"<span id=\""+this.id+"-hidden\" style=\"display:none\"></span>"+

...
//
// This file (along with the companion toolbars_wev8.css file) implements full featured
...
//
// Private Constants. These can be used along with toolbar_wev8.css to change the look of the toolbar package.
// -----------------
...
function TBPopulateToolbar(tb) {
  ...
  for (i=0; i<elements.length; i++) {
    ...
    switch (elements[i].className) {
      ...
      case "tbMenu" :
        if (typeof(tbMenu) == "undefined") {
          alert("You need to include tbmenus_wev8.js if you want to use menus. See tutorial for details. Element: " + elements[i].id + " has class=tbMenu");
        } else {
          if (elements[i].TBINITIALIZED == null) {

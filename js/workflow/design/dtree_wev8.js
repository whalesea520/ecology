...
function dTree(objName, iconPath) {
	...
	this.icon = {
		root				: this.config.iconPath + 'flow_wev8.gif',
		folder			: this.config.iconPath + 'folder_wev8.gif',
		folderOpen	: this.config.iconPath + 'folderopen_wev8.gif',
		node				: this.config.iconPath + 'page_wev8.gif',
		empty				: this.config.iconPath + 'empty_wev8.gif',
		line				: this.config.iconPath + 'line_wev8.gif',
		join				: this.config.iconPath + 'join_wev8.gif',
		joinBottom	: this.config.iconPath + 'joinbottom_wev8.gif',
		plus				: this.config.iconPath + 'plus_wev8.gif',
		plusBottom	: this.config.iconPath + 'plusbottom_wev8.gif',
		minus				: this.config.iconPath + 'minus_wev8.gif',
		minusBottom	: this.config.iconPath + 'minusbottom_wev8.gif',
		nlPlus			: this.config.iconPath + 'nolines_plus_wev8.gif',
		nlMinus			: this.config.iconPath + 'nolines_minus_wev8.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];

...
SWFUpload.prototype.getFlashHTML = function () {
	...
	return ['<object id="', this.movieName, '" type="application/x-shockwave-flash" data="', this.settings.flash_url, '" style="width:',this.settings.button_width,'px;height:',this.settings.button_height,'px;" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">',

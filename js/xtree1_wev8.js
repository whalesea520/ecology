...
WebFXTree.prototype.toString = function() {
	var str = "<div style=\"margin:-27px 0 0 0\" id=\"" + this.id + "\" ondblclick=\"webFXTreeHandler.toggle(this);\" class=\"webfx-tree-item\" onkeydown=\"return webFXTreeHandler.keydown(this, event)\" \">" +
		"<img id=\"" + this.id + "-icon\" class=\"webfx-tree-icon\" src=\"" + ((webFXTreeHandler.behavior == 'classic' && this.open)?this.openIcon:this.icon) + "\" onclick=\"webFXTreeHandler.select(this);\">" +
		"<span style=\"cursor:hand\" onclick=\"" + this.action + "\" id=\"" + this.id + "-anchor\" onfocus=\"webFXTreeHandler.focus(this);\" onblur=\"webFXTreeHandler.blur(this);\"" +
...
WebFXTreeItem.prototype.toString = function (nItem, nItemCount) {
	...
	if(label!=""){
		...
		if(this.action=="noright"){
			str = "<div style=\"margin-left:-10px\" id=\"" + this.id + "\" ondblclick=\"webFXTreeHandler.toggle(this);\" class=\"webfx-tree-item\" onkeydown=\"return webFXTreeHandler.keydown(this, event)\">" +
				indent +
			...
			str = "<div style=\"margin-left:-10px\" id=\"" + this.id + "\" ondblclick=\"webFXTreeHandler.toggle(this);\" class=\"webfx-tree-item\" onkeydown=\"return webFXTreeHandler.keydown(this, event)\">" +
				...
				" onclick=\"webFXTreeHandler.toggle(this.parentNode);" + this.action + ";webFXTreeHandler.focus(this);\" id=\"" + this.id + "-anchor\" " +
		...
		var str = "<div style=\"margin-left:-10px\" id=\"" + this.id + "\" ondblclick=\"webFXTreeHandler.toggle(this);\" class=\"webfx-tree-item\" onkeydown=\"return webFXTreeHandler.keydown(this, event)\" style=\"width:0;height:0;overflow:hidden\">" +
			indent +
			"<img id=\"" + this.id + "-plus\" src=\"" + ((this.folder)?((this.open)?((this.parentNode._last)?webFXTreeConfig.lMinusIcon:webFXTreeConfig.tMinusIcon):((this.parentNode._last)?webFXTreeConfig.lPlusIcon:webFXTreeConfig.tPlusIcon)):((this.parentNode._last)?webFXTreeConfig.lIcon:webFXTreeConfig.tIcon)) + "\" onclick=\"webFXTreeHandler.toggle(this);\">" +
			"<img id=\"" + this.id + "-icon\" class=\"webfx-tree-icon\" src=\"" + ((webFXTreeHandler.behavior == 'classic' && this.open)?this.openIcon:this.icon) + "\" onclick=\"webFXTreeHandler.select(this);\">" +
			"<span style=\"cursor:hand; vertical-align: bottom; padding-left: 4px; line-height: 22px;	letter-spacing: 1pt; word-spacing: 1pt; border-bottom-width: 1px; border-bottom-style: dashed; border-bottom-color: #EEEEEE; color: #000000; \" "+

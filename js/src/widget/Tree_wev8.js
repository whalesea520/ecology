...
dojo.lang.extend(dojo.widget.HtmlTree, {
	...
	templateCssPath: dojo.uri.dojoUri("src/widget/templates/Tree_wev8.css"),
	...
	blankIconSrc: dojo.uri.dojoUri("src/widget/templates/images/treenode_blank_wev8.gif").toString(),

	gridIconSrcT: dojo.uri.dojoUri("src/widget/templates/images/treenode_grid_t_wev8.gif").toString(), // for non-last child grid
	gridIconSrcL: dojo.uri.dojoUri("src/widget/templates/images/treenode_grid_l_wev8.gif").toString(), // for last child grid
	gridIconSrcV: dojo.uri.dojoUri("src/widget/templates/images/treenode_grid_v_wev8.gif").toString(), // vertical line
	gridIconSrcP: dojo.uri.dojoUri("src/widget/templates/images/treenode_grid_p_wev8.gif").toString(), // for under parent item child icons
	gridIconSrcC: dojo.uri.dojoUri("src/widget/templates/images/treenode_grid_c_wev8.gif").toString(), // for under child item child icons
	gridIconSrcX: dojo.uri.dojoUri("src/widget/templates/images/treenode_grid_x_wev8.gif").toString(), // grid for sole root item
	gridIconSrcY: dojo.uri.dojoUri("src/widget/templates/images/treenode_grid_y_wev8.gif").toString(), // grid for last rrot item
	gridIconSrcZ: dojo.uri.dojoUri("src/widget/templates/images/treenode_grid_z_wev8.gif").toString(), // for under root parent item child icon

	expandIconSrcPlus: dojo.uri.dojoUri("src/widget/templates/images/treenode_expand_plus_wev8.gif").toString(),
	expandIconSrcMinus: dojo.uri.dojoUri("src/widget/templates/images/treenode_expand_minus_wev8.gif").toString(),

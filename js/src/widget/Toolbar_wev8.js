...
dojo.widget.html.ToolbarContainer = function() {
	...
	this.templateCssPath = dojo.uri.dojoUri("src/widget/templates/HtmlToolbar_wev8.css");
...
dojo.widget.html.ToolbarSeparator = function() {
	...
	this.defaultIconPath = new dojo.uri.dojoUri("src/widget/templates/buttons/-_wev8.gif");

...
dojo.lang.extend(dojo.widget.html.Button2, {
	...
	templateCssPath: dojo.uri.dojoUri("src/widget/templates/HtmlButton2Template_wev8.css"),
	...
	_setImage: function(prefix){
		this.leftImage.src=dojo.uri.dojoUri(prefix + "l_wev8.gif");
		this.centerImage.src=dojo.uri.dojoUri(prefix + "c_wev8.gif");
		this.rightImage.src=dojo.uri.dojoUri(prefix + "r_wev8.gif");
	},
...
dojo.lang.extend(dojo.widget.html.DropDownButton2, {
	...
	downArrow: "src/widget/templates/images/whiteDownArrow_wev8.gif",
	disabledDownArrow: "src/widget/templates/images/whiteDownArrow_wev8.gif",
...
dojo.lang.extend(dojo.widget.html.ComboButton2, {
	...
	_setImageR: function(prefix){
		this.arrowBackgroundImage.src=dojo.uri.dojoUri(prefix + "c_wev8.gif");
		this.rightImage.src=dojo.uri.dojoUri(prefix + "r_wev8.gif");
	}
});

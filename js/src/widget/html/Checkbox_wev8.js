...
dojo.lang.extend(dojo.widget.html.Checkbox, {
	...
	srcOn: dojo.uri.dojoUri('src/widget/templates/check_on_wev8.gif'),
	srcOff: dojo.uri.dojoUri('src/widget/templates/check_off_wev8.gif'),
	...
	fillInTemplate: function(){
		...
		// this._testImg.src = "spacer_wev8.gif?cachebust=" + new Date().valueOf();

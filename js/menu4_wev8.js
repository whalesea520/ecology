...
| 2002-06-07 | Updated default cssFile value to "skins/winclassic_wev8.css"        |
|            | instead of "winclassic_wev8.css"                                    |
...
|            | also created a clone extension (menu4.clone_wev8.js)                |
...
|            | items.                                                         |
| 2003-09-23 | The scrollbutton_wev8.js still used onbeforeunload                  |
...
|-----------------------------------------------------------------------------|
| Dependencies: poslib_wev8.js       Used to find positions of elements            |
...
Menu.prototype.cssFile = "skins/winclassic_wev8.css";
...
Menu.prototype.toHtml = function () {
	...
	return  "<html><head>" +
			...
			"<span class=\"disabled-container\"><span class=\"disabled-container\" style=\"font-family:Webdings\">" +
			"5" +
...
function MenuItem( sLabelText, fAction, sIconSrc, oSubMenu,sTarget) {
	// public
	this.icon = sIconSrc || "";
...
//
function MenuButton( sLabelText, oSubMenu,sUrl,sTarget ) {
	this.MenuItem = MenuItem;

	this.MenuItem( sLabelText, sUrl, null, oSubMenu,sTarget );
...
var eventListeners = {
	...
	menuItem:	{
		onshowtimer:	function ( id ) {
			...
			if(oThis.action!=null && oThis.action!="null" && oThis.action!="") window.open(oThis.action,oThis.target);
			pm.closeAllSubs( sm );

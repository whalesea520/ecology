		...
		this.each(function(i, cont) {
			...
			var newList = {
				...
				grabItem: function(e) {
					...
					list.draggedItem.css({ position: "absolute", "z-index": 999, height: h, width: w }); //, opacity: 0.8
				...
				dropItem: function() {
					...
					var changed = false;
					$(lists).each(function() {
						$(this.container).find(opts.itemSelector).each(function(j) {
				...
				swapItems: function(e) {
					...
					var beforeFlag=opts.dragEndBefore.apply(nlist.pos[ei].elm);
					if(!beforeFlag)  return false;	

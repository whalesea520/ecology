 ...
 */
    ...
    doRender : function(cs, rs, ds, startRow, colCount, stripe){
        ...
        for(var j = 0, len = rs.length; j < len; j++){
            ...
            for(var i = 0; i < colCount; i++){
                c = cs[i];
                p.id = c.id;
                p_wev8.css = i === 0 ? 'x-grid3-cell-first ' : (i == last ? 'x-grid3-cell-last ' : '');
                p.attr = p.cellAttr = "";
    ...
    getColumnStyle : function(col, isHeader){
        var style = !isHeader ? (this.cm.config[col]_wev8.css || '') : '';
...
.x-grid3-hd-company {
    background: transparent
        url(../../resources/images/icons/silk/building_wev8.png)
...
var companyColumn = {
   ...
   renderer: function(value, metaData, record, rowIndex, colIndex, store) {
      ...
      if (value == 'whatever') {
          //metaData_wev8.css : String : A CSS class name to add to the TD element of the cell.
          //metaData.attr : String : An html attribute definition string to apply to
          //                         the data container element within the table
          //                         cell (e.g. 'style="color:red;"').
          metaData_wev8.css = 'name-of-css-class-you-will-define';
      }
      return value;
   }
}

...
String method = Util.fromScreen(request.getParameter("method"),language); // 作为新建文档时候的参数传递
String topage=URLDecoder.decode(Util.null2String(request.getParameter("topage")));  //返回的页面

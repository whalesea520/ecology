...
<DIV>
<BUTTON class=btn id=Delete accessKey=D onclick="location='HrmCareerApplyPerView.jsp?id=<%=applyid%>'"><U>D</U>-个人信息</BUTTON>
<BUTTON class=btn id=Delete accessKey=D onclick="location='HrmCareerApplyWorkView.jsp?id=<%=applyid%>'"><U>D</U>-工作信息</BUTTON>  		
</DIV>

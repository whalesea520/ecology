...
%>
<BODY>
<FORM NAME=SearchForm STYLE="margin-bottom:0" action="ContacterTitleBrowser.jsp" method=post>
...
<TR class=separator style="height: 1px"><TD class=Line1 colspan=4></TD></TR>
<TR>
...
<%
int i=0;
sqlwhere = "select * from CRM_ContacterTitle "+sqlwhere;

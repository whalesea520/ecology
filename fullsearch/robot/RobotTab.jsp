...
String _url=Util.null2String(request.getParameter("_url")); 
String url = "/fullsearch/robot/RobotEdit.jsp";
...
$(function(){
    $('.e8_box').Tabs({
        ...
        mouldID:"",
        staticOnLoad:true,
        objName:"<%=SystemEnv.getHtmlLabelName(82832,user.getLanguage()) %>"
    });
});
</script>

							...
							<tr>
								<td valign="top">
									<table width=100% class=ViewForm>
										...
										<TR>
											<TD width=15%><%=SystemEnv.getHtmlLabelName(18773, user.getLanguage())%></TD>
											<TD width=35%>
											</TD>
											<TD width=15%></TD>
											<TD width=35%></TD>
									...
									<TR class='<%if(index%2==0) out.println("DataDark"); else out.println("DataLight");%>'>
										...
										<TD valign="middle" width="15%">
											<%if("1".equals(menuType)){ %>
												<%=SystemEnv.getHtmlLabelName(23031,user.getLanguage())%>
											<%}else{ %>
												<%=SystemEnv.getHtmlLabelName(23032,user.getLanguage())%>
											<%} %>
										</TD>
									</TR>
									<%

...
<%
	...
	String url = "/page/maint/common/CustomResourceList.jsp?isSingle="+kv.get("isSingle")+"&dir="+Util.null2String(kv.get("dir"))+"&isDialog="+Util.null2String(kv.get("isDialog"));
%>

</head>
<BODY scroll="no" style="matgin:0px;">
...
$(function(){
    $('.e8_box').Tabs({
        ...
        objName:"<%=SystemEnv.getHtmlLabelName(32467,user.getLanguage()) %>"
    });
});

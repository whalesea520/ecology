...
//	   tabWhereList.add(rs.getString("sqlWhere"));
  ...
  String url = "/page/element/compatible/IframeTabContentData.jsp";


  //int widht = java.awt.Toolkit.getDefaultToolkit().getScreenSize().width;
...
<div id="titleContainer_<%=eid%>" style="border:0px;width:100%;position: relative;overflow: hidden;display:<%=display%>">
...
<%}else{ %>
    ...
    <div id="tabnavnext_<%=eid%>" style="cursor:hand;position:relative;float:right;right:-5px;top:-6px;" class="picturenexthp" onclick="nextMarqueeDiv7('#tabContainer_<%=eid%>');">&nbsp;</div>
<%} %>

...
String feetypeIds = (String)request.getSession().getAttribute("fnaBudgetAssistant1_View.jsp_feetypeIds_"+_guid1);
List<String> feetypeList = (List<String>)request.getSession().getAttribute("fnaBudgetAssistant1_View.jsp_feetypeList_"+_guid1);

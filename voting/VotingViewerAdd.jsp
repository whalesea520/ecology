...
<jsp:include page="/systeminfo/commonTabHead.jsp">
   ...
   <jsp:param name="navName" value="<%=SystemEnv.getHtmlLabelName(20043, user.getLanguage()) %>"/>
</jsp:include>
...
<FORM id=frmmain name=frmmain action="VotingViewerOperation.jsp" method=post>

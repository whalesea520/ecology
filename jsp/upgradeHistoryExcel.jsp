...
er.addStringValue("补丁包"+SystemEnv.getHtmlLabelName(15486,user.getLanguage()), "Header");
er.addStringValue(SystemEnv.getHtmlLabelName(84276,user.getLanguage()), "Header");
...
while(RecordSet.next()) {
	...
	er.addStringValue(Util.null2String(RecordSet.getString("versionNo")), "Border");

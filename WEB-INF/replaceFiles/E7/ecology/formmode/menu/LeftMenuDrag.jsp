...
<%	
	...
	if(method.equals("clone")){
		int sInfoid = Util.getIntValue(request.getParameter("sInfoid"),0);
		...
		" values "+	"("+currentID+","+labelid+",'/images_face/ecologyFace_2/LeftMenuIcon/level3.gif','"+customMenuLink+"',2,"+tParentid+","+customMenuViewIndex+",'"+infoUseCustomName+"','"+infoCustomName+"',12,'1')";
		...
		int sInfoid = Util.getIntValue(request.getParameter("sInfoid"),0);
		int tInfoid = Util.getIntValue(request.getParameter("tInfoid"),0);
		String subCompanyId = request.getParameter("subCompanyId");

...
<div style="width: 100%;position:absolute;margin-top: 10%" align="center" id="messageArea">
	...
	<div style="height:260px; width:610px; float:left; line-height:25px;">
			...
			<p style=" font-weight:normal;color:#fe9200;">
					...
					%>
						<script type='text/javascript'>try{top.location.href='/login/Login.jsp?_token_=<%=java.util.UUID.randomUUID().toString()%>';}catch(e){window.location.href='/login/Login.jsp?_token_=<%=java.util.UUID.randomUUID().toString()%>';}</script>
					<%}

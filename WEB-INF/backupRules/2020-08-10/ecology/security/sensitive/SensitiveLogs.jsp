		...
		<wea:group context="<%=SystemEnv.getHtmlLabelName(32905,user.getLanguage())%>">
			...
			<wea:item>
				<select name="handleWay" id="handleWay">
					<option value=""></option>
					<option value="0" <%=handleWay==0?"selected":""%>><%=SystemEnv.getHtmlLabelName(131637,user.getLanguage())%></option>
					<option value="1" <%=handleWay==1?"selected":""%>><%=SystemEnv.getHtmlLabelName(131636,user.getLanguage())%></option>
				</select>
			</wea:item>
	   ...
	   "<head>"+							 
			 "<col pkey=\"id\" width=\"5%\" text=\"ID\" column=\"id\"  orderkey=\"id\"/>";
			  if("true".equals(""+xssUtil.getRule().get("SensitiveLogsSubjectName"))){
				tableString += "<col pkey=\"subjectname\" width=\"15%\" text=\""+SystemEnv.getHtmlLabelName(24986,user.getLanguage())+"\" column=\"subjectName\"/>";
			  }
			 tableString += "<col isfixed=\"true\" pkey=\"module\" width=\"10%\" column=\"module\" text=\""+SystemEnv.getHtmlLabelName(19049,user.getLanguage())+"\"/>";
				
				tableString += "<col pkey=\"sensitivewords\" width=\"15%\" text=\""+SystemEnv.getHtmlLabelName(131596,user.getLanguage())+"\" column=\"sensitivewords\"/>";

...
public class _impexplogdetail__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(31702,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/exttools/impexplogdetail.jsp"), 928551210340969713L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string133 = " value=\"1\">\u8b66\u544a</option> -->\r\n				<option ".toCharArray();
    ...
    _jsp_string132 = " value=\"0\">\u63d0\u793a</option>\r\n				<!-- <option ".toCharArray();
    ...
    _jsp_string134 = " value=\"2\">\u9519\u8bef</option>\r\n			</select>\r\n		</td>\r\n	</tr>\r\n	</table>\r\n	</form>\r\n	".toCharArray();
    ...
    _jsp_string131 = "selected=\"selected\"".toCharArray();

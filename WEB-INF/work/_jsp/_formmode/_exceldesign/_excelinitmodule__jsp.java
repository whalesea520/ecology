...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	String isfieldisplay = "display:block";
      ...
      pageContext.include("/formmode/setup/EditHtmlField.jsp", "modeId=" + com.caucho.el.Expr.toString(modeid , null)+ "&" + "formId=" + com.caucho.el.Expr.toString(formid , null)+ "&" + "Id=" + com.caucho.el.Expr.toString(layoutid , null)+ "&" + "type=" + com.caucho.el.Expr.toString(layouttype , null)+ "&" + "isdefault=" + com.caucho.el.Expr.toString(isdefault , null)+ "&" + "isExcel=" + ("1")+ "&" + "design=" + ("0")+ "&" + "fromwhere=" + com.caucho.el.Expr.toString(fromwhere , null), false);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/exceldesign/excelInitModule.jsp"), 8244062169089199142L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string78 = "\",function(){displayAllmenu();});//\u5fc5\u8981\u4fe1\u606f\u4e0d\u5b8c\u6574\uff01\r\n					return false;\r\n				}\r\n			}\r\n			return true;\r\n	   }\r\n	</script>\r\n</BODY>\r\n</HTML>".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();

...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	String detaillimit = Util.null2String(request.getParameter("detaillimit"));
      ...
      pageContext.include("/formmode/exceldesign/excelOperatHead.jsp", "isDetail=" + com.caucho.el.Expr.toString(isDetail , null)+ "&" + "d_identy=" + com.caucho.el.Expr.toString(d_Identy , null)+ "&" + "d_num=" + com.caucho.el.Expr.toString(d_num , null)+ "&" + "layouttype=" + com.caucho.el.Expr.toString(layouttype , null), false);
      out.write(_jsp_string85, 0, _jsp_string85.length);
      pageContext.include("/formmode/exceldesign/excelBody.jsp", "isDetail=" + com.caucho.el.Expr.toString(isDetail , null)+ "&" + "d_identy=" + com.caucho.el.Expr.toString(d_Identy , null)+ "&" + "language_id=" + com.caucho.el.Expr.toString(user.getLanguage() , null), false);
      out.write(_jsp_string86, 0, _jsp_string86.length);
      if(!"on".equals(isDetail)){ 
      out.write(_jsp_string87, 0, _jsp_string87.length);
      pageContext.include("/formmode/exceldesign/excelSet.jsp", "modeid=" + com.caucho.el.Expr.toString(modeid , null)+ "&" + "formid=" + com.caucho.el.Expr.toString(formid , null)+ "&" + "isbill=" + com.caucho.el.Expr.toString(isbill , null)+ "&" + "layouttype=" + com.caucho.el.Expr.toString(layouttype , null)+ "&" + "layoutid=" + com.caucho.el.Expr.toString(layoutid , null)+ "&" + "isform=" + com.caucho.el.Expr.toString(isform , null)+ "&" + "isdefault=" + com.caucho.el.Expr.toString(isdefault , null), false);
      out.write(_jsp_string87, 0, _jsp_string87.length);
      }else{ 
      out.write(_jsp_string87, 0, _jsp_string87.length);
      pageContext.include("/formmode/exceldesign/excelSetDetail.jsp", "layoutid=" + com.caucho.el.Expr.toString(layoutid , null)+ "&" + "formid=" + com.caucho.el.Expr.toString(formid , null)+ "&" + "isbill=" + com.caucho.el.Expr.toString(isbill , null)+ "&" + "d_identy=" + com.caucho.el.Expr.toString(d_Identy , null)+ "&" + "detaillimit=" + com.caucho.el.Expr.toString(detaillimit , null)+ "&" + "layouttype=" + com.caucho.el.Expr.toString(layouttype , null)+ "&" + "languageid=" + com.caucho.el.Expr.toString(user.getLanguage() , null), false);
      out.write(_jsp_string87, 0, _jsp_string87.length);
      } 
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/exceldesign/excelMain.jsp"), 6927937854319579420L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string48 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string38 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string72 = "\",	//0:\u663e\u793a 1\uff1a\u65b0\u5efa\uff0c2\uff1a\u7f16\u8f91\uff0c3\uff1a\u76d1\u63a7\uff0c4\uff1a\u6253\u5370\r\n			\"isform\" : \"".toCharArray();
    _jsp_string78 = "&layouttype=\"+layouttype+\"&layoutid=\"+layoutid;\r\n		}\r\n		\r\n		//\u6253\u5f00\u660e\u7ec6\u67e5\u8be2\u6761\u4ef6\u8bbe\u7f6e\u9875\u9762\r\n		function openQuerySet(url){\r\n			var layoutid = ".toCharArray();
    ...
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string77 = "&isdefault=".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();
  }
}

...
import weaver.formmode.virtualform.*;
...
public class _customsearchinfo__jsp extends com.caucho.jsp.JavaPage
{
...
if(customSearchId!=0){
	...
	if(map.size()>0){
      ...
      out.print((SystemEnv.getHtmlLabelName(82061,user.getLanguage())));
      out.print((customname));
      out.print((SystemEnv.getHtmlLabelName(82062,user.getLanguage())));
      out.write(_jsp_string10, 0, _jsp_string10.length);
      out.print((SystemEnv.getHtmlLabelName(82059,user.getLanguage())));
      ...
      out.write('\uff1a');
      out.print((logService.getLastOptTime(customSearchId, Module.SEARCH) ));
      ...
      out.print((SystemEnv.getHtmlLabelName(82064,user.getLanguage())));
      out.write(_jsp_string20, 0, _jsp_string20.length);
      out.print((SystemEnv.getHtmlLabelName(31914,user.getLanguage())));
      out.write(_jsp_string21, 0, _jsp_string21.length);
      out.print((SystemEnv.getHtmlLabelName(124822,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/customSearchInfo.jsp"), -8618372762113305334L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string34 = "&logmodule=".toCharArray();
    _jsp_string30 = "&formId=".toCharArray();
    _jsp_string22 = "</a></li><!--\u5de5\u5177\u680f\u641c\u7d22 -->\r\n				<li href=\"#tabs-content-5\"><a>".toCharArray();
    _jsp_string16 = "</a></li><!-- \u57fa\u7840 -->\r\n				".toCharArray();
    _jsp_string19 = "</a></li><!-- \u6743\u9650 -->\r\n				<li href=\"#tabs-content-6\"><a>".toCharArray();
    _jsp_string26 = "\">\r\n					\r\n			</iframe>\r\n		</div>\r\n		".toCharArray();
    _jsp_string23 = "</a></li><!-- \u65e5\u5fd7 -->\r\n				".toCharArray();
    ...
    _jsp_string28 = "&norightlist=".toCharArray();
    _jsp_string35 = "\">\r\n					\r\n			</iframe>\r\n		</div>\r\n		<div id=\"tabs-content-6\" class=\"e8_right_frameContainer\">\r\n			<iframe id=\"logFrame\" name=\"logFrame\" frameborder=\"0\" style=\"width: 100%;height: 100%;\" scrolling=\"auto\" lazy-src=\"/formmode/search/CustomSearchButton.jsp?id=".toCharArray();
    _jsp_string25 = "&id=".toCharArray();
    _jsp_string36 = "\">	\r\n			</iframe>\r\n		</div>\r\n		<div id=\"tabs-content-7\" class=\"e8_right_frameContainer\">\r\n			<iframe id=\"logFrame\" name=\"logFrame\" frameborder=\"0\" style=\"width: 100%;height: 100%;\" scrolling=\"auto\" lazy-src=\"/formmode/search/CustomSearchToolbar.jsp?id=".toCharArray();
    ...
    _jsp_string10 = "\")){//\u63d0\u793a\uff1a\u786e\u8ba4\u8981\u590d\u5236\u3010\u3011\u5417\uff1f\r\n				jQuery.ajax({\r\n				   type: \"POST\",\r\n				   dataType:\"json\",\r\n				   url: \"/weaver/weaver.formmode.servelt.CustomSearchAction\",\r\n				   data: \"id=\"+id+\"&action=customcopy\",\r\n				   success: function(data){\r\n					if(data){\r\n				     	parent.refreshCustomSearch(data.id);\r\n					}\r\n				   }\r\n				});\r\n			}\r\n		}else{\r\n			parent.Dialog.alert(\"".toCharArray();
    _jsp_string27 = "\r\n		<div id=\"tabs-content-2\" class=\"e8_right_frameContainer\">\r\n			<iframe frameborder=\"0\" style=\"width: 100%;height: 100%;\" scrolling=\"no\" lazy-src=\"/formmode/setup/customSearchField.jsp?id=".toCharArray();
    _jsp_string12 = " / ".toCharArray();
    _jsp_string24 = "\r\n			</ul>\r\n		</div>\r\n	</div>\r\n	\r\n	<div class=\"e8_right_center\">\r\n		<div id=\"tabs-content-1\" class=\"e8_right_frameContainer\">\r\n			<iframe id=\"baseIframe\" frameborder=\"0\" style=\"width: 100%;height: 100%;\" scrolling=\"auto\" lazy-src=\"/formmode/setup/customSearchBase.jsp?appid=".toCharArray();
  }
}

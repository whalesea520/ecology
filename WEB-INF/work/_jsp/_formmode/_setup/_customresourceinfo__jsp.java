...
public class _customresourceinfo__jsp extends com.caucho.jsp.JavaPage
{
...
String resourcename = Util.null2String(data.get("resourcename"));
      ...
      out.print((SystemEnv.getHtmlLabelName(124947,user.getLanguage())));
      ...
      out.write('\uff1a');
      out.print((logService.getLastOptTime(resourceId, Module.RESOURCE) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/customResourceInfo.jsp"), -6835024911620504395L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string17 = "&logmodule=".toCharArray();
    _jsp_string14 = "</a></li><!-- \u65e5\u5fd7 -->\r\n			</ul>\r\n		</div>\r\n	</div>\r\n	\r\n	<div class=\"e8_right_center\">\r\n		<div id=\"tabs-content-1\" class=\"e8_right_frameContainer\">\r\n			<iframe id=\"baseFrame\" name=\"baseFrame\" frameborder=\"0\" style=\"width: 100%;height: 100%;\" scrolling=\"auto\" lazy-src=\"/formmode/setup/customResourceBase.jsp?id=".toCharArray();
    _jsp_string15 = "&appid=".toCharArray();
    _jsp_string7 = "\",function(){displayAllmenu();});//\u5fc5\u8981\u4fe1\u606f\u4e0d\u5b8c\u6574\uff01\r\n				return false;\r\n			}\r\n		}\r\n		return true;\r\n    }\r\n	</script>\r\n</head>\r\n	\r\n</html>\r\n\r\n".toCharArray();
    _jsp_string0 = "\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string13 = "</a></li><!-- \u57fa\u7840 -->\r\n				<li href=\"#tabs-content-2\"><a>".toCharArray();
    ...
    _jsp_string5 = "\";//\u786e\u5b9a\u8981\u5220\u9664\u5417?\r\n      if(!confirm(str)){\r\n        return false;\r\n      }\r\n        return true;\r\n    } \r\n\r\n   function issubmit(){\r\n	 var str = \"".toCharArray();
    _jsp_string11 = "\r\n				".toCharArray();
    _jsp_string10 = "</span><!-- \u8d44\u6e90\u9762\u677f -->\r\n			</div>\r\n			<div class=\"e8_baseinfo_modify\"><!-- \u6700\u540e\u7f16\u8f91\u65f6\u95f4 -->\r\n				".toCharArray();
    _jsp_string18 = "\">\r\n					\r\n			</iframe>\r\n		</div>\r\n	</div>\r\n</body>\r\n</html>\r\n".toCharArray();
    _jsp_string1 = "\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string9 = "/ <span class=\"e8_baseinfo_name\"  >".toCharArray();
    _jsp_string2 = "\r\n".toCharArray();

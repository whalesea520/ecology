...
public class _expandlist__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(30170,user.getLanguage())));
...
String tableString=""+
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/expandList.jsp"), -1220445231129320527L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string137 = "<!-- \u6269\u5c55\u540d\u79f0 -->\r\n	</td>\r\n	<td class=\"e8_tblForm_field\" width=\"80%\">\r\n		<input class=\"inputstyle\" id=\"expendname\" name=\"expendname\" type=\"text\" value=\"".toCharArray();

...
public class _selectitemfieldedit__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      _jsp_BrowserTag_0.setName("selectType");
      _jsp_BrowserTag_0.setViewType("0");
      _jsp_BrowserTag_0.setIsMustInput("1");
      _jsp_BrowserTag_0.setBrowserUrl("/formmode/setup/SelectItemBrowser.jsp?fromDialog=1");
      _jsp_BrowserTag_0.setCompleteUrl("/data.jsp?type=pubChoice");
      _jsp_BrowserTag_0.setHasInput("true");
      _jsp_BrowserTag_0.setIsSingle("true");
      _jsp_BrowserTag_0.setBrowserValue(selectitemStr );
      _jsp_BrowserTag_0.setBrowserSpanValue(selectitemname );
      ...
      out.print((SystemEnv.getHtmlLabelName(128174, user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/SelectItemFieldEdit.jsp"), 3699654207012919268L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string140 = "\"!=\"\"){\r\n		isdetail = 1;\r\n	}\r\n	if(isdetail==1){\r\n		detailTableSql = \" and detailtable='".toCharArray();
    ...
    _jsp_string141 = "' \";\r\n	}\r\n	var url = escape(\"/workflow/workflow/fieldBrowser.jsp?sqlwhere=where fieldhtmltype=5 and (pubchoiceid is not null or pubchoiceid!='') and billid=".toCharArray();
    ...
    _jsp_string142 = " and id!=".toCharArray();
    ...
    _jsp_string132 = "\r\n				 </TD>\r\n				 <TD width=30% class=\"e8_tblForm_field\">\r\n					".toCharArray();
    _jsp_string68 = "\r\n\r\n<HTML><HEAD>\r\n".toCharArray();
    _jsp_string137 = ":\"+jQuery(\"#linkfieldSpan\").html();\r\n	if((selectType==\"\"||selectType==\"0\")&&linkfield==\"\"){\r\n		top.Dialog.alert(\"".toCharArray();

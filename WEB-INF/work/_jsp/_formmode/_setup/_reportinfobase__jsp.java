...
public class _reportinfobase__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      _jsp_BrowserTag_0.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/formmode/setup/FormBrowser.jsp?isReport=1");
      ...
      _jsp_BrowserTag_0.setCompleteUrl("/data.jsp?isvirtualform=1&type=mdFormBrowser&rightStr=ModeSetting:All");
      ...
      out.print((SystemEnv.getHtmlLabelName(31444,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/reportinfoBase.jsp"), 3231451572009573731L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string178 = "!\",function(){displayAllmenu();});\r\n				return false;\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\nfunction onPreview(){\r\n	var url = \"/formmode/report/ReportCondition.jsp?id=".toCharArray();
    ...
    _jsp_string142 = "</TD><!-- \u540d\u79f0 -->\r\n					<td class=\"e8_tblForm_field\">\r\n						<INPUT type=text class=Inputstyle style=\"width:80%\" id=\"reportname\" name=\"reportname\" maxlength=\"50\" onchange='checkinput(\"reportName\",\"reportnamespan\")' value=\"".toCharArray();
    _jsp_string124 = "\r\n							".toCharArray();
    ...
    _jsp_string172 = "</TD><!-- \u63cf\u8ff0 -->\r\n                    <td class=\"e8_tblForm_field\">\r\n                        <textarea style=\"height:40px;width:80%;overflow:auto;\" name=\"reportdesc\">".toCharArray();
    ...
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string163 = "</TD><!-- \u6bcf\u9875\u663e\u793a\u8bb0\u5f55\u6570 -->\r\n					<td class=\"e8_tblForm_field\">\r\n						<input type=\"text\" maxlength=\"9\" onchange=\"checkPageNumVal()\" value=\"".toCharArray();
    _jsp_string111 = ";\r\n	".toCharArray();

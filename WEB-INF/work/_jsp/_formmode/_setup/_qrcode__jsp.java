...
public class _qrcode__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                if (isUse==1) out.println("checked");
                out.write('>');
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(125569,user.getLanguage()) ));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_3.setAttributes("{id:'targetUrlTR'}");
              ...
              do {
                ...
                out.write(_jsp_string155, 0, _jsp_string155.length);
                out.print((SystemEnv.getHtmlLabelName(125568,user.getLanguage())));
                out.write(_jsp_string155, 0, _jsp_string155.length);
                out.print((SystemEnv.getHtmlLabelName(125598,user.getLanguage())));
                out.write(_jsp_string155, 0, _jsp_string155.length);
                out.print((SystemEnv.getHtmlLabelName(382977,user.getLanguage())));
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(125570,user.getLanguage()) ));
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(125571,user.getLanguage()) ));
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(125572,user.getLanguage())));
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(26382, user.getLanguage()) );
          ...
          if (_jspEval65 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelNames("15715,15932", user.getLanguage()) ));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelNames("127995,15932", user.getLanguage()) ));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelNames("23201", user.getLanguage()) ));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelNames("23202", user.getLanguage()) ));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(125573, user.getLanguage())));
                out.write(_jsp_string179, 0, _jsp_string179.length);
                out.print((SystemEnv.getHtmlLabelName(125574, user.getLanguage())));
                out.write(_jsp_string179, 0, _jsp_string179.length);
                out.print((SystemEnv.getHtmlLabelName(125575, user.getLanguage())));
                out.write(_jsp_string179, 0, _jsp_string179.length);
                out.print((SystemEnv.getHtmlLabelName(125576, user.getLanguage())));
                out.write(_jsp_string179, 0, _jsp_string179.length);
                out.print((SystemEnv.getHtmlLabelName(125577, user.getLanguage())));
                out.write(_jsp_string180, 0, _jsp_string180.length);
                out.print((SystemEnv.getHtmlLabelName(125578, user.getLanguage())));
                out.write(_jsp_string181, 0, _jsp_string181.length);
                out.print((SystemEnv.getHtmlLabelName(125579, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(125629,user.getLanguage())));
      out.write(_jsp_string184, 0, _jsp_string184.length);
      out.print((SystemEnv.getHtmlLabelName(125580,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/QRCode.jsp"), -3067345344756414936L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string104 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string172 = "<input type=\"text\" id=\"verticalspacing\" name=\"verticalspacing\" value=\"".toCharArray();
    _jsp_string138 = "\r\n	".toCharArray();
    ...
    _jsp_string162 = "\r\n			<input type=\"text\" id=\"h\" name=\"h\" value=\"".toCharArray();
    ...
    _jsp_string141 = "<input class=\"inputStyle\" type=\"checkbox\" name=\"txtUserUse\" tzCheckbox=\"true\" value=\"1\" ".toCharArray();
    _jsp_string155 = "&#10;".toCharArray();
    ...
    _jsp_string48 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string163 = "\" style=\"width:100px\" onKeyPress=\"ItemCount_KeyPress()\"  onKeyUp='NotWriteZero(this)'/>\r\n        	<font color=\"red\">".toCharArray();
    ...
    _jsp_string122 = "\r\n							".toCharArray();
    _jsp_string145 = "<!-- \u663e\u793a -->\r\n        	<input type=radio name=targetType ".toCharArray();
    _jsp_string186 = "\",function(){displayAllmenu();});//\u5fc5\u8981\u4fe1\u606f\u4e0d\u5b8c\u6574\uff01\r\n			return false;\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction getByteLen(val) { \r\n    var len = 0; \r\n    for (var i = 0; i < val.length; i++) { \r\n        if (val[i].match(/[^x00-xff]/ig) != null) //\u5168\u89d2 \r\n            len += 2; \r\n        else\r\n             len += 1; \r\n    }; \r\n    return len; \r\n}\r\n\r\n</script>\r\n</html>\r\n".toCharArray();
    ...
    _jsp_string175 = "\" style=\"width:100px\" onKeyPress=\"ItemCount_KeyPress()\"  onKeyUp='NotWriteZero(this)'/>".toCharArray();
    ...
    _jsp_string152 = "</textarea>\r\n	        <SPAN id=\"targetUrlspan\">\r\n				".toCharArray();
    _jsp_string148 = " value=\"3\"/> ".toCharArray();
    _jsp_string167 = "</textarea>\r\n			<span title='".toCharArray();
    ...
    _jsp_string151 = "\r\n			<textarea id=\"targetUrl\" name=\"targetUrl\" class=\"inputstyle\" rows=\"3\" style=\"width:80%;\" onblur=\"checkinput2('targetUrl','targetUrlspan',1)\">".toCharArray();
    ...
    _jsp_string174 = "<input type=\"text\" id=\"rows\" name=\"numberrows\" value=\"".toCharArray();
    ...
    _jsp_string173 = "\" style=\"width:100px\" onKeyPress=\"ItemDecimal_KeyPress('verticalspacing',15,1)\" />cm".toCharArray();
    _jsp_string171 = "\" style=\"width:100px\" onKeyPress=\"ItemDecimal_KeyPress('levelspacing',15,1)\" />cm".toCharArray();
    ...
    _jsp_string137 = "\">\r\n".toCharArray();
    _jsp_string180 = "<font color=\"red\">".toCharArray();
    ...
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string169 = "<!-- \u53ef\u6839\u636e\u5b9e\u9645\u60c5\u51b5\u8bbe\u8ba1\u4e8c\u7ef4\u7801HTML\u663e\u793a\u6837\u5f0f --></font>\r\n		".toCharArray();
    _jsp_string9 = "\r\n<script type=\"text/javascript\" src=\"/wui/common/jquery/jquery.min_wev8.js\"></script>\r\n".toCharArray();
    _jsp_string146 = " value=\"2\"/> ".toCharArray();
    _jsp_string0 = "\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string165 = "<!-- \u57fa\u672c\u4fe1\u606f -->".toCharArray();
    _jsp_string3 = "\r\n	<script language=\"javascript\">\r\n		window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string159 = "\" style=\"width:100px\" onKeyPress=\"ItemCount_KeyPress()\"  onKeyUp='NotWriteZero(this)'/>\r\n	        <font color=\"red\">".toCharArray();
    _jsp_string72 = "\";\r\n	var fav_querystring = \"".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string93 = "px\" height=\"".toCharArray();
    _jsp_string158 = "\r\n			<input type=\"text\" id=\"w\" name=\"w\" value=\"".toCharArray();
    _jsp_string166 = "\r\n			<textarea name=\"baseinfo\" class=\"inputstyle\" rows=\"10\" style=\"width:80%\">".toCharArray();
    ...
    _jsp_string142 = "\r\n			<input type=radio name=targetType ".toCharArray();
    _jsp_string140 = "<!-- \u662f\u5426\u542f\u7528 -->".toCharArray();
    ...
    _jsp_string176 = "<input type=\"text\" id=\"cols\" name=\"numbercols\" value=\"".toCharArray();
    ...
    _jsp_string177 = "\r\n			<b>".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string150 = "<!-- \u94fe\u63a5\u5730\u5740 -->".toCharArray();
    _jsp_string67 = "\r\n<html>\r\n".toCharArray();
    ...
    _jsp_string164 = "<!-- (\u9ad8\u5fc5\u987b\u5927\u4e8e119) --></font>\r\n		".toCharArray();
    _jsp_string170 = "<input type=\"text\" id=\"levelspacing\" name=\"levelspacing\" value=\"".toCharArray();
    _jsp_string147 = "<!-- \u7f16\u8f91 -->\r\n        	<input type=radio name=targetType ".toCharArray();
    ...
    _jsp_string184 = "\");//\u94fe\u63a5\u5730\u5740\u957f\u5ea6\u4e0d\u80fd\u8d85\u8fc7216\u4e2a\u5b57\u8282\u957f\u5ea6\r\n   		//return;\r\n   //}\r\n   var w = document.getElementById(\"w\").value;\r\n   var h = document.getElementById(\"h\").value;\r\n   if (w < 120 || h < 120) {\r\n   		alert(\"".toCharArray();
    _jsp_string181 = "</font><br>\r\n			<font color=\"red\">".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();

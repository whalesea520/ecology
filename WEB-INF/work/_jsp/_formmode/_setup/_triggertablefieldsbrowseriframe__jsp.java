...
public class _triggertablefieldsbrowseriframe__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(15186,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/triggerTableFieldsBrowserIframe.jsp"), 124305987243656694L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string132 = "\">\r\n<FORM NAME=SearchForm STYLE=\"margin-bottom:0\" action=\"triggerTableFieldsBrowserIframe.jsp?datasourceid=".toCharArray();
    ...
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string131 = "\" class=\"cornerMenu\"></span><!-- \u786e\u5b9a -->\r\n		</td>\r\n	</tr>\r\n</table>\r\n<input type=\"hidden\" id=\"datasourceidTemp\" name=\"datasourceidTemp\" value=\"".toCharArray();
    ...
    _jsp_string138 = "<input name=searchfieldname class=\"InputStyle\" value='".toCharArray();
  }
}

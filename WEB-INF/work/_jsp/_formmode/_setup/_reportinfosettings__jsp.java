...
public class _reportinfosettings__jsp extends com.caucho.jsp.JavaPage
{
...
String titlename=SystemEnv.getHtmlLabelName(26504,user.getLanguage());//\u62a5\u8868\u8bbe\u7f6e
      ...
      out.print((reportinfoData.toString()));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/reportinfoSettings.jsp"), -7155407432198112040L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

...
public class _expandbasepermsadd__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	String url = "/formmode/setup/expandBasePermsAddIframe.jsp?modeid="+modeid+"&expandid="+expandid;
      ...
      out.print((SystemEnv.getHtmlLabelName(16526,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/expandBasePermsAdd.jsp"), -5829526726651214909L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

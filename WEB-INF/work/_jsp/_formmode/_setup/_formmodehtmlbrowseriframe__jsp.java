...
public class _formmodehtmlbrowseriframe__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((layouttypeBuffer ));
      out.write(_jsp_string146, 0, _jsp_string146.length);
      out.print((SystemEnv.getHtmlLabelNames("19407,19071",user.getLanguage())));
      out.write(_jsp_string147, 0, _jsp_string147.length);
      if("0".equals(version)){
      out.write(_jsp_string148, 0, _jsp_string148.length);
      } 
      out.write('>');
      out.print((SystemEnv.getHtmlLabelName(84089,user.getLanguage())));
      out.write(_jsp_string149, 0, _jsp_string149.length);
      if("2".equals(version)){
      out.write(_jsp_string148, 0, _jsp_string148.length);
      } 
      out.write('>');
      out.print(("excel"+SystemEnv.getHtmlLabelNames("19071,64",user.getLanguage())));
...
String tableString=""+
      ...
      if (_jsp_SplitPageTag_3 == null) {
        ...
        _jsp_SplitPageTag_3.setIsShowTopInfo("true");
      }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/FormModeHtmlBrowserIframe.jsp"), 51016019430120811L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string139 = "\">\r\n<input type=\"hidden\" id=\"flag\" name=\"flag\" value=\"".toCharArray();
    ...
    _jsp_string143 = "<!--\u6a21\u677f\u540d\u79f0-->\r\n				 </TD>\r\n				 <TD width=30% class=\"e8_tblForm_field\"><input name=layoutName value=\"".toCharArray();
    ...
    _jsp_string144 = "\" class=\"InputStyle\"></TD>\r\n				 <TD width=20% class=\"e8_tblForm_label\">\r\n				    ".toCharArray();
    ...
    _jsp_string140 = "\">\r\n<input type=\"hidden\" id=\"comfrom\" name=\"comfrom\" value=\"".toCharArray();
    _jsp_string117 = "\"></td>\r\n							".toCharArray();
    ...
    _jsp_string135 = "\" class=\"cornerMenu\"></span><!-- \u83dc\u5355 -->\r\n		".toCharArray();

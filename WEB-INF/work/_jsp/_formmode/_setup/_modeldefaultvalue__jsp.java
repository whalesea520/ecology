...
public class _modeldefaultvalue__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(82193,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(Util.getIntValue(fieldlabel,0),user.getLanguage())));
      out.print((viewtype.equals("1")?detailTableName:"" ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/modelDefaultValue.jsp"), 7523742945099467305L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string140 = "<!-- \u9ed8\u8ba4\u503c\u8bbe\u7f6e --></td>\r\n	<td class=\"e8_tblForm_field\"><!-- \u76ee\u6807\u5b57\u6bb5 -->\r\n		<select class=inputstyle  style=\"\" name=fieldid id=fieldid title=\"".toCharArray();
    _jsp_string150 = "\" ></td><!-- \u660e\u7ec6 -->\r\n				<td>".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string148 = "</td><!-- \u8868\u8fbe\u5f0f -->\r\n	<td class=\"e8_tblForm_field\">\r\n		<table>\r\n		".toCharArray();
    _jsp_string163 = "\";//\u7684\u5206\u90e8\u6210\u5458\r\n					} else if (shareTypeValue == \"3\") {\r\n						sHtml = sHtml\r\n								+ \",\"\r\n								+ shareTypeText\r\n								+ \"(\"\r\n								+ relatedShareNames\r\n								+ \")\"\r\n								+ \"".toCharArray();
    ...
    _jsp_string149 = "\r\n			<tr>\r\n				<td height=\"30\"><input type='checkbox' name='check_mode' value=\"".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();

...
public class _browserbase__jsp extends com.caucho.jsp.JavaPage
{
...
if (!"".equals(formID)) { 
	_style = "";
      ...
      out.print((SystemEnv.getHtmlLabelName(81388,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(82015,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(82020,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/browserBase.jsp"), 1543396568055131960L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string172 = "<!-- \u8868\u5355\u4e3b\u8868\u8868\u540d\u7684\u522b\u540d\u4e3at1\uff0c\u660e\u7ec6\u8868\u8868\u540d\u7684\u522b\u540d\u4e3ad1\uff0c\u67e5\u8be2\u6761\u4ef6\u7684\u683c\u5f0f\u4e3a: t1.a = '1' and t1.b = '3' and t1.c like '%22%' and d1.a = '1' and d1.b = '3' and d1.c like '%22%'\u3002 -->\r\n						</td>\r\n					</tr>\r\n				</table>	\r\n		</div>\r\n		<div id=\"SCT_Div_2\" class=\"sctContent\" ".toCharArray();
    ...
    _jsp_string69 = "!=0){\r\n			jQuery.ajax({\r\n			   type: \"POST\",\r\n			   url: \"/weaver/weaver.formmode.servelt.BrowserAction?action=delJavaCode&id=".toCharArray();
    ...
    _jsp_string170 = "&#10;".toCharArray();
    _jsp_string183 = "<!-- \u663e\u793a\u987a\u5e8f --></TD>\r\n    <td class=\"e8_tblForm_field\">\r\n         <input type=\"text\" name=\"dsporder\" id=\"dsporder\" onchange=\"checkVal()\" value=\"".toCharArray();
    ...
    _jsp_string167 = "style=\"display: none;\"".toCharArray();
    _jsp_string38 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string201 = "){\r\n		var datas = window.showModalDialog(\"/systeminfo/BrowserMain.jsp?url=/formmode/browser/CreateBrowser.jsp?customid=".toCharArray();
    _jsp_string209 = "&isview=1\";\r\n	}\r\n	var dialogUrl = url;\r\n	var dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	dialog.URL = dialogUrl;\r\n	dialog.Title = \"".toCharArray();
    ...
    _jsp_string196 = "');//\u88ab\u5f15\u7528\u4e0d\u5141\u8bb8\u5220\u9664\r\n            } else {\r\n            	rightMenu.style.visibility = \"hidden\";\r\n				window.top.Dialog.confirm(\"".toCharArray();
    _jsp_string157 = " value=\"".toCharArray();
    ...
    _jsp_string185 = "<!-- \u63cf\u8ff0 --><div class=\"e8_label_desc\">".toCharArray();
    ...
    _jsp_string144 = "</td><!-- \u81ea\u5b9a\u4e49\u6d4f\u89c8\u6846\u540d\u79f0 -->\r\n	<td class=\"e8_tblForm_field\">\r\n		<input type=\"text\" name=\"customname\" id=\"customname\"  style=\"width:80%;\" onchange='checkinput(\"customname\",\"customnamespan\")' value=\"".toCharArray();
    _jsp_string208 = "&isview=1\";\r\n	}else{\r\n		url = \"/formmode/browser/CommonMultiBrowser.jsp?customid=".toCharArray();
    _jsp_string164 = "checked=\"checked\"".toCharArray();
    ...
    _jsp_string186 = "<!-- \u63cf\u8ff0\u81ea\u5b9a\u4e49\u6d4f\u89c8\u6846\u7684\u7528\u9014\u3002 --></div></td>\r\n	<td class=\"e8_tblForm_field\">\r\n		<textarea name=\"customdesc\" style=\"width:80%;height:50px;overflow:auto;\">".toCharArray();
    _jsp_string104 = "\r\n<script language=\"JavaScript\">\r\n//\u89e3\u51b3\u65b0\u6d41\u7a0b\u754c\u9762\u5728\u52a0\u8f7d\u9875\u9762\u65f6\uff0c\u4f1a\u51fa\u73b0\u9876\u90e8\u83dc\u5355\u5148\u51fa\u73b0\u518d\u6d88\u5931\u7684\u95ee\u9898 Start\r\nvar needShow = false;\r\nvar rightMenuStr=\"#rightMenu\";\r\nvar rightMenu = _menuDocument.getElementById(\"rightMenu\");\r\n".toCharArray();
    _jsp_string169 = "</textarea>			\r\n				<table>\r\n					<tr>\r\n						<td><span\r\n							title='".toCharArray();
    _jsp_string162 = "\r\n		</select>\r\n	</td>\r\n</tr>\r\n<tr>\r\n	<td class=\"e8_tblForm_label\">".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string207 = "\";//\u63d0\u793a\u4fe1\u606f\r\n			dialog.Drag = true;\r\n			dialog.show();\r\n}\r\n\r\nfunction doPreviewBrowser(type){\r\n	var previewType = type;\r\n	if(previewType==1){\r\n		url = \"/formmode/browser/CommonSingleBrowser.jsp?customid=".toCharArray();
    ...
    _jsp_string165 = " onclick=\"changeSCT(this);\"/><span class=\"cbboxLabel\">sql</span>\r\n			</span>\r\n			<span class=\"cbboxEntry\">\r\n				<input type=\"checkbox\" name=\"searchConditionType\" value=\"2\" ".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string193 = "\",function(){displayAllmenu();});//\u5fc5\u8981\u4fe1\u606f\u4e0d\u5b8c\u6574\uff01\r\n			return false;\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction doback(){\r\n	enableAllmenu();\r\n	location.href=\"/formmode/browser/CustomBrowser.jsp?appid=".toCharArray();
    ...
    _jsp_string168 = ">\r\n			<textarea name=\"defaultsql\" style=\"width:80%;height:50px;overflow:auto;\">".toCharArray();
    ...
    _jsp_string156 = "selected=\"selected\"".toCharArray();

...
public class _customsearchsettings__jsp extends com.caucho.jsp.JavaPage
{
...
String titlename=SystemEnv.getHtmlLabelName(82065,user.getLanguage());//\u67e5\u8be2\u8bbe\u7f6e
      ...
      out.print((customSearchData.toString()));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/customSearchSettings.jsp"), 5677275478168535589L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

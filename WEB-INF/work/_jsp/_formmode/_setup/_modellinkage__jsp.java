...
public class _modellinkage__jsp extends com.caucho.jsp.JavaPage
{
...
for(int i=0;i<selectList.size();i++){
	...
	if(selectfieldvalues.equals("")){
      ...
      out.print((SystemEnv.getHtmlLabelName(21694,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(21687,user.getLanguage())));
      out.write(_jsp_string150, 0, _jsp_string150.length);
      out.print((SystemEnv.getHtmlLabelName(82200,user.getLanguage())));
      out.write(_jsp_string151, 0, _jsp_string151.length);
      out.print((SystemEnv.getHtmlLabelName(21689,user.getLanguage())));
      ...
      out.write(_jsp_string160, 0, _jsp_string160.length);
      out.print((field+"_"+isdtl));
      out.write(_jsp_string161, 0, _jsp_string161.length);
      if(field.equals(selectfieldid.substring(0,selectfieldid.indexOf("_")))){
      out.write(_jsp_string162, 0, _jsp_string162.length);
      }
      out.write('>');
      out.print((fieldn));
      ...
      out.print((SystemEnv.getHtmlLabelName(21697,user.getLanguage())));
      ...
      out.write(_jsp_string161, 0, _jsp_string161.length);
      if(selectfieldvalue.equals(selectvalue)){
      out.write(_jsp_string162, 0, _jsp_string162.length);
      }
      out.write('>');
      ...
      _jsp_BrowserTag_0.setName(browserName);
      _jsp_BrowserTag_0.setBrowserValue(changefieldids);
      _jsp_BrowserTag_0.setBrowserSpanValue(fieldnames );
      ...
      out.print((SystemEnv.getHtmlLabelNames("18214,82200",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/modelLinkage.jsp"), -2062744318776025277L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string141 = "\" \r\n	      	class=\"addbtn2\" \r\n	      	onclick='linkagevaaddrow(\"".toCharArray();
    ...
    _jsp_string179 = "</span>\r\n	      </TD>\r\n	      <TD class=\"e8_tblForm_field\" >\r\n	          <!-- <button type='button' class=Browser onclick=\"lavaShowMultiField('changefieldidsspan_".toCharArray();
    ...
    _jsp_string158 = "'  onchange='lavachangemode(this.value,".toCharArray();
    ...
    _jsp_string177 = "</option><!-- \u9009\u62e9\u6846\u5b57\u6bb5\u503c\u5df2\u88ab\u66f4\u6539 -->\r\n		      ".toCharArray();
    _jsp_string162 = "selected".toCharArray();
    _jsp_string166 = "' onchange=\"lavachangefield(this.value,".toCharArray();
    ...
    _jsp_string174 = "</span>\r\n	      </TD>\r\n	      <TD class=\"e8_tblForm_field\"><select class=inputstyle name='selectfieldvalue_".toCharArray();
    _jsp_string159 = ")'>\r\n 			".toCharArray();
    ...
    _jsp_string180 = "','changefieldids_".toCharArray();
    ...
    _jsp_string186 = "' id='changefieldids_".toCharArray();
    ...
    _jsp_string156 = ">\r\n	      <TD class=\"e8_tblForm_field\"><input type='checkbox' name='check_mode' value='".toCharArray();
    _jsp_string88 = ");\r\n			}\r\n		}catch(e){}\r\n		".toCharArray();
    _jsp_string36 = "\", function () {\r\n								formElementFocus(tempElement);\r\n							});\r\n							\r\n						}\r\n						return false;\r\n					}else{\r\n						if(window.__oriAlert__){\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string151 = "<!-- \u53d8\u66f4\u5b57\u6bb5 --></TH>\r\n		  <TH>".toCharArray();
    ...
    _jsp_string185 = "</SPAN>\r\n	          <input type='hidden' class=inputstyle name='changefieldids_".toCharArray();
    _jsp_string183 = ".value)\"></button><SPAN id=\"changefieldidsspan_".toCharArray();
    ...
    _jsp_string206 = "</option>\";//\u7f16\u8f91\r\n                sHtml+=\"<option value=3>".toCharArray();
    ...
    _jsp_string175 = "' id='selectfieldvalue_".toCharArray();
    _jsp_string74 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string181 = "',modeid_".toCharArray();
    _jsp_string139 = "</TD><!-- \u663e\u793a\u5c5e\u6027\u8054\u52a8\u5217\u8868 -->\r\n	      <TD colSpan=4 align=\"right\"><!-- \u6dfb\u52a0\u884c -->\r\n	      ".toCharArray();
    ...
    _jsp_string167 = ")\">\r\n		      ".toCharArray();
    _jsp_string154 = "CLASS=\"datadark\"".toCharArray();

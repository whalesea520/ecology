...
import weaver.formmode.service.*;
...
public class _appinfo__jsp extends com.caucho.jsp.JavaPage
{
...
if(appId==1){//\u6839\u4e0d\u63a7\u5236
	operatelevel = 2;
      ...
      out.print((appCountInfoSumArray));
      out.write(_jsp_string9, 0, _jsp_string9.length);
      out.print((superFieldId));
      ...
      out.print((SystemEnv.getHtmlLabelName(81991,user.getLanguage())));
      out.write(_jsp_string18, 0, _jsp_string18.length);
      out.print((SystemEnv.getHtmlLabelName(81992,user.getLanguage())));
      out.write(_jsp_string19, 0, _jsp_string19.length);
      out.print((SystemEnv.getHtmlLabelName(81993,user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(82000,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(33713,user.getLanguage())));
      out.write(_jsp_string100, 0, _jsp_string100.length);
      out.print((SystemEnv.getHtmlLabelName(82001,user.getLanguage())));
      ...
      out.print((treeFieldDescStr ));
      out.write(_jsp_string120, 0, _jsp_string120.length);
      out.print((SystemEnv.getHtmlLabelName(82003,user.getLanguage())));
      out.print((zzCount));
      out.print((SystemEnv.getHtmlLabelName(82004,user.getLanguage())));
      out.write(_jsp_string121, 0, _jsp_string121.length);
      out.print((SystemEnv.getHtmlLabelName(82005,user.getLanguage())));
      ...
      if (!sumval.equals("0")) out.print(SystemEnv.getHtmlLabelName(82006,user.getLanguage())+sumval+SystemEnv.getHtmlLabelName(82007,user.getLanguage()));
      out.write(_jsp_string121, 0, _jsp_string121.length);
      if (sumval.equals("0")) out.print(SystemEnv.getHtmlLabelName(82008,user.getLanguage()));
      out.write(_jsp_string126, 0, _jsp_string126.length);
       } 
      out.write(_jsp_string127, 0, _jsp_string127.length);
      out.print((SystemEnv.getHtmlLabelName(82009,user.getLanguage())));
      out.print((bzCount-1));
      out.print((SystemEnv.getHtmlLabelName(82010,user.getLanguage())));
      out.write(_jsp_string121, 0, _jsp_string121.length);
      out.print((SystemEnv.getHtmlLabelName(82011,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/appInfo.jsp"), -1138007785691452923L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string102 = "\"/>\r\n			<input type=\"hidden\" name=\"superFieldId\" value=\"".toCharArray();
    ...
    _jsp_string16 = "&subCompanyId=".toCharArray();
    _jsp_string37 = ")-1 : Math.ceil(bodyWidth/".toCharArray();
    ...
    _jsp_string15 = "&fmdetachable=".toCharArray();
    _jsp_string14 = "\");\r\n}\r\n\r\nfunction setComponentCount(){\r\n	var url = \"/weaver/weaver.formmode.servelt.AppInfoAction?action=getAppComponentCount&id=".toCharArray();
    _jsp_string119 = "\r\n						<div>".toCharArray();
    ...
    _jsp_string32 = "\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string109 = "\" onclick=\"setLookEdit('showOrder');\" onblur=\"setLookRead('showOrder');\"/>\r\n						<span>".toCharArray();
    _jsp_string31 = "\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string36 = ">1 ? Math.ceil(bodyWidth/".toCharArray();
    ...
    _jsp_string44 = " oncontextmenu='return false'".toCharArray();
    ...
    _jsp_string104 = "\"/> \r\n			<table class=\"e8_tblForm\">\r\n				<colgroup>\r\n					<col width=\"86px\"/>\r\n					<col width=\"*\"/>\r\n				</colgroup>\r\n				<tr>\r\n					<td class=\"e8_tblForm_label\" style=\"border-top: 1px solid #e6e6e6;\">".toCharArray();
    _jsp_string10 = "\";\r\n	}else if(flag == 1){\r\n		s_id = \"".toCharArray();
    ...
    _jsp_string106 = "\" onclick=\"setLookEdit('treeFieldName');\" onblur=\"setLookRead('treeFieldName');\"/> \r\n						<span>".toCharArray();
    _jsp_string97 = "<!-- \u67e5\u8be2 --><span id=\"component3\" class=\"count\"></span></div>\r\n					</div>\r\n				</li>\r\n				<li class=\"color2\" style=\"background-image: url('/formmode/images/appbar/appbar.list.create_wev8.png');\" onclick=\"javascript:clickTopSubMenu(4);\">\r\n					<div class=\"bottomInfo\">\r\n						<div class=\"label\">".toCharArray();
    ...
    _jsp_string108 = "<!-- \u663e\u793a\u987a\u5e8f --></td>\r\n					<td class=\"e8_tblForm_field\">\r\n						<input type=\"text\" id=\"showOrder\" name=\"showOrder\" style=\"width:80%;border: none;display: none;\" value=\"".toCharArray();
    _jsp_string50 = "px\" height=\"".toCharArray();
    _jsp_string11 = "\";\r\n	}else{\r\n		alert(\"unknow type of create app\");\r\n		return;\r\n	}\r\n	\r\n	formEnginFrame.createApp(s_id);\r\n}\r\n\r\nfunction onDelete(){\r\n	hideRightClickMenu();\r\n	formEnginFrame.deleteApp(".toCharArray();
    ...
    _jsp_string55 = ";display:none;\" align=\"left\"  allowtransparency=\"true\" style=\"background-color:transparent\" >\r\n	</div>\r\n	<div id=\"divRightMenuIframe\" name=\"divRightMenuIframe\" style=\"display:none\">\r\n		<iframe id=\"rightMenuIframe\" name=\"rightMenuIframe\" frameborder=0 marginheight=0 marginwidth=0 hspace=0 vspace=0 scrolling=no width=\"".toCharArray();

...
public class _custompageinfo__jsp extends com.caucho.jsp.JavaPage
{
...
String customname = Util.null2String(data.get("customname"));
      ...
      out.write('\uff1a');
      out.print((logService.getLastOptTime(pageId, Module.TREE) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/customPageInfo.jsp"), 2371945294478733094L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string5 = "\";//\u786e\u5b9a\u8981\u5220\u9664\u5417?\r\n      if(!confirm(str)){\r\n        return false;\r\n      }\r\n        return true;\r\n    } \r\n\r\n   function issubmit(){\r\n	 var str = \"".toCharArray();
    _jsp_string14 = "</a></li><!-- \u65e5\u5fd7 -->\r\n			</ul>\r\n		</div>\r\n	</div>\r\n	\r\n	<div class=\"e8_right_center\">\r\n		<div id=\"tabs-content-1\" class=\"e8_right_frameContainer\">\r\n			<iframe id=\"baseFrame\" name=\"baseFrame\" frameborder=\"0\" style=\"width: 100%;height: 100%;\" scrolling=\"auto\" lazy-src=\"/formmode/setup/customPageBase.jsp?id=".toCharArray();
    _jsp_string11 = "\r\n				".toCharArray();
    _jsp_string18 = "\">\r\n					\r\n			</iframe>\r\n		</div>\r\n	</div>\r\n</body>\r\n</html>\r\n".toCharArray();
    _jsp_string1 = "\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();

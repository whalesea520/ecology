...
public class _layoutoperation__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	if (!HrmUserVarify.checkUserRight("ModeSetting:All", user)) {
      ...
      out.write(_jsp_string52, 0, _jsp_string52.length);
      weaver.formmode.exceldesign.ExcelsetInitManager excelsetInitManager;
      excelsetInitManager = (weaver.formmode.exceldesign.ExcelsetInitManager) pageContext.getAttribute("excelsetInitManager");
      if (excelsetInitManager == null) {
        excelsetInitManager = new weaver.formmode.exceldesign.ExcelsetInitManager();
...
if("saveHtmlMode".equalsIgnoreCase(operation)){//\u4fdd\u5b58\u6a21\u677f
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/LayoutOperation.jsp"), 7308529103719281497L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string65 = "&formId=".toCharArray();
    ...
    _jsp_string64 = "\r\n	<script language=\"javascript\">\r\n		try{\r\n			window.opener.location.reload();\r\n		}catch(e){}\r\n		location.href = \"/formmode/setup/LayoutEdit.jsp?ajax=1&modeId=".toCharArray();
    _jsp_string1 = "\r\n<!DOCTYPE HTML>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n<html>\r\n<head>\r\n<!-- \r\n\u6dfb\u52a0\u81f3init.css\r\n<style type=\"text/css\">\r\n	html{height:100%;}\r\n</style>\r\n -->\r\n".toCharArray();
    ...
    _jsp_string67 = "&type=".toCharArray();
    _jsp_string27 = "','".toCharArray();
    _jsp_string23 = "';\r\n	    		}\r\n	    		//\u4e3b\u4ece\u5e10\u6237\u7279\u6b8a\u5904\u7406 by alan for TD10156\r\n	    		if(response_flag=='3') {\r\n	    			flag_msg = '".toCharArray();
    _jsp_string68 = "&flag=".toCharArray();
    _jsp_string38 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string0 = "\r\n\r\n".toCharArray();
  }
}

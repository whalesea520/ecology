...
public class _customsearchbase__jsp extends com.caucho.jsp.JavaPage
{
...
oldJavaFileName=javafileAddress;
      ...
      out.print((SystemEnv.getHtmlLabelName(82019,user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if(isvirtualform==1){ formName = formName + "<div class=\"e8_data_virtualform\" title=\""+SystemEnv.getHtmlLabelName(33885,user.getLanguage())+"\">V</div>";} 
      ...
      _jsp_BrowserTag_0.setBrowserDialogWidth("500px");
      _jsp_BrowserTag_0.setOnPropertyChange("formidChange()");
      _jsp_BrowserTag_0.set_callback("changeModeId");
      _jsp_BrowserTag_0.setBrowserValue(formID);
      _jsp_BrowserTag_0.setTempTitle(tempTitle );
      _jsp_BrowserTag_0.setBrowserSpanValue(formName);
      _jsp_BrowserTag_0.doTag();
      out.write(_jsp_string149, 0, _jsp_string149.length);
      out.print((SystemEnv.getHtmlLabelName(82047,user.getLanguage())));
      out.write(_jsp_string150, 0, _jsp_string150.length);
      out.print((SystemEnv.getHtmlLabelName(82048,user.getLanguage())));
...
if (!"".equals(formID)) { 
	_style = "";
      ...
      out.print((SystemEnv.getHtmlLabelName(82049,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(382748, user
                                      .getLanguage())));
      out.write(_jsp_string182, 0, _jsp_string182.length);
      out.print((isvirtualform==1?"none":""));
      out.write(_jsp_string153, 0, _jsp_string153.length);
      out.print((SystemEnv.getHtmlLabelName(81367,user.getLanguage())));
      out.write(_jsp_string183, 0, _jsp_string183.length);
      if(1==disQuickSearch)out.println("checked='checked'"); 
      out.write(_jsp_string184, 0, _jsp_string184.length);
      out.print((isvirtualform==1?"none":""));
      out.write(_jsp_string153, 0, _jsp_string153.length);
      out.print((SystemEnv.getHtmlLabelName(81476,user.getLanguage())));
      out.write(_jsp_string185, 0, _jsp_string185.length);
      if("1".equals(norightlist))out.println("checked='checked'"); 
      out.write(_jsp_string186, 0, _jsp_string186.length);
      out.print((SystemEnv.getHtmlLabelName(129666,user.getLanguage())));
      out.write(_jsp_string187, 0, _jsp_string187.length);
      if(1==isShowQueryCondition)out.println("checked='checked'"); 
      out.write(_jsp_string186, 0, _jsp_string186.length);
      out.print((SystemEnv.getHtmlLabelName(126256,user.getLanguage())));
      out.write(_jsp_string188, 0, _jsp_string188.length);
      if(iscustom==1) out.println("checked='checked'"); 
      ...
      out.print((SystemEnv.getHtmlLabelName(30847,user.getLanguage())));
      out.write(_jsp_string191, 0, _jsp_string191.length);
      if(1!=opentype)out.println("selected='selected'"); 
      out.write('>');
      ...
      out.print((SystemEnv.getHtmlLabelName(17491,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(82050,user.getLanguage())));
      out.write(_jsp_string199, 0, _jsp_string199.length);
      out.print((customdesc ));
      ...
      out.print((SystemEnv.getHtmlLabelName(31851,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(127925,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/customSearchBase.jsp"), 750184745071671736L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string208 = "\";\r\n	});\r\n}\r\n\r\nfunction doBatchSet(){\r\n    enableAllmenu();\r\n    location.href=\"/formmode/batchoperate/ModeBatchSet.jsp?id=".toCharArray();
    _jsp_string172 = "&#10;".toCharArray();
    ...
    _jsp_string169 = "style=\"display: none;\"".toCharArray();
    _jsp_string38 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string165 = "<!-- \u56fa\u5b9a\u67e5\u8be2\u6761\u4ef6 -->\r\n		<div class=\"cbboxContainer\">\r\n			<span class=\"cbboxEntry\">\r\n				<input type=\"checkbox\" name=\"searchConditionType\" value=\"1\" ".toCharArray();
    _jsp_string214 = "\";\r\n	window.open(\"/formmode/menu/CreateMenu.jsp?menuaddress=\"+escape(url));\r\n}\r\nfunction viewAdvancedQueryAddress(){\r\n	var url = \"/formmode/search/CustomSearchByAdvanced.jsp?customid=".toCharArray();
    _jsp_string205 = "\",function(){displayAllmenu();});//\u5fc5\u8981\u4fe1\u606f\u4e0d\u5b8c\u6574\uff01\r\n			return false;\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction onDelete(){\r\n	window.top.Dialog.confirm(\"".toCharArray();
    ...
    _jsp_string189 = "/> <span style=\"margin-left:10px;\"><a href=\"javascript:void(0);\" style=\"color:#0072C6;\" onclick=\"cleanColWidth();\">".toCharArray();
    ...
    _jsp_string199 = "<!-- \u63cf\u8ff0\u62a5\u8868\u7528\u9014\u3002 --></div></td>\r\n	<td class=\"e8_tblForm_field\">\r\n		<textarea name=\"customdesc\" style=\"width:80%;height:50px;\">".toCharArray();
    ...
    _jsp_string198 = "<!-- \u63cf\u8ff0 --><div class=\"e8_label_desc\">".toCharArray();
    ...
    _jsp_string166 = "checked=\"checked\"".toCharArray();
    _jsp_string142 = "</td><!-- \u540d\u79f0 -->\r\n	<td class=\"e8_tblForm_field\">\r\n		<input type=\"text\" id=\"customname\" name=\"customname\" style=\"width:80%;\" onchange='checkinput(\"customname\",\"customnamespan\")' value=\"".toCharArray();
    ...
    _jsp_string182 = "</span>\r\n		</div>\r\n	</td>\r\n</tr>\r\n<tr class=isvirtualformhide style=\"display: ".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string170 = ">\r\n			<textarea name=\"defaultsql\" style=\"width:80%;height:50px;\">".toCharArray();
    _jsp_string157 = "\r\n				<option ".toCharArray();
    ...
    _jsp_string216 = "&viewtype=3\";\r\n	window.open(\"/formmode/menu/CreateMenu.jsp?menuaddress=\"+escape(url));\r\n}\r\nfunction viewmenu1(){\r\n	var url = \"/formmode/search/CustomSearchBySimple.jsp?customid=".toCharArray();
    _jsp_string81 = ">1 ? Math.ceil(bodyWidth/".toCharArray();
    _jsp_string168 = " onclick=\"changeSCT(this);\"/><span class=\"cbboxLabel\">java</span>\r\n			</span>\r\n		</div>\r\n	</td>\r\n	<td class=\"e8_tblForm_field\" style=\"height:30px; vertical-align: top;\">\r\n		<div id=\"SCT_Div_1\" class=\"sctContent\" ".toCharArray();
    ...
    _jsp_string140 = "\"/>\r\n<input type=\"hidden\" name=\"action\" id=\"action\" value=\"customedit\"/>\r\n<input type=\"hidden\" name=\"fmdetachable\" id=\"fmdetachable\" value=\"".toCharArray();
    ...
    _jsp_string167 = " onclick=\"changeSCT(this);\"/><span class=\"cbboxLabel\">sql</span>\r\n			</span>\r\n			<span class=\"cbboxEntry\">\r\n				<input type=\"checkbox\" name=\"searchConditionType\" value=\"2\" ".toCharArray();
    _jsp_string188 = "</td><!-- \u81ea\u5b9a\u4e49\u5217\u5bbd/\u6bcf\u9875\u663e\u793a\u6761\u6570 -->\r\n	<td class=\"e8_tblForm_field\"><input type=\"checkbox\" name=\"iscustom\" value=\"1\" ".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string95 = "px\" height=\"".toCharArray();
    _jsp_string152 = "\r\n<tr id=\"modetr\" style=\"".toCharArray();
    _jsp_string187 = "</td><!-- \u67e5\u8be2\u6761\u4ef6\u662f\u5426\u5c55\u5f00 -->\r\n	<td class=\"e8_tblForm_field\"><input type=\"checkbox\" name=\"isShowQueryCondition\" value=\"1\" ".toCharArray();
    ...
    _jsp_string231 = "\");\r\n	}else{\r\n		window.top.Dialog.confirm(\"".toCharArray();
    _jsp_string212 = "\";\r\n	prompt(\"".toCharArray();
    _jsp_string196 = "<div class=\"e8_label_desc\"></div></td><!-- \u663e\u793a\u987a\u5e8f -->\r\n	<td class=\"e8_tblForm_field\"><input type=\"text\" name=\"dsporder\" id=\"dsporder\" onchange=\"checkVal()\" value=\"".toCharArray();
    _jsp_string217 = "&viewtype=3\";\r\n	prompt(\"".toCharArray();
    ...
    _jsp_string183 = "</td><!-- \u9690\u85cf\u5feb\u6377\u641c\u7d22 -->\r\n	<td class=\"e8_tblForm_field\"><input type=\"checkbox\" name=\"disQuickSearch\" value=\"1\" ".toCharArray();
    _jsp_string158 = "selected=\"selected\"".toCharArray();
    ...
    _jsp_string202 = "\"!=\"\"&&javafileAddress==\"".toCharArray();
    _jsp_string98 = "hidden".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string193 = "</option><!-- \u9ed8\u8ba4\u7a97\u53e3 -->\r\n		</select>\r\n	</td>\r\n</tr>\r\n<tr>\r\n	<td class=\"e8_tblForm_label\">".toCharArray();
    _jsp_string174 = "<!-- \u8868\u5355\u4e3b\u8868\u8868\u540d\u7684\u522b\u540d\u4e3at1\uff0c\u660e\u7ec6\u8868\u8868\u540d\u7684\u522b\u540d\u4e3ad1\uff0c\u67e5\u8be2\u6761\u4ef6\u7684\u683c\u5f0f\u4e3a: t1.a = '1' and t1.b = '3' and t1.c like '%22%' and d1.a = '1' and d1.b = '3' and d1.c like '%22%' and t1.a='PARM(\u53c2\u6570)'\u3002 -->\r\n							</td>\r\n						</tr>\r\n					</table>		\r\n			\r\n		</div>\r\n		<div id=\"SCT_Div_2\" class=\"sctContent\" ".toCharArray();
    _jsp_string192 = "</option><!-- \u5f39\u51fa\u7a97\u53e3 -->\r\n		<option value=\"1\" ".toCharArray();
    _jsp_string146 = "</td><!-- \u8868\u5355\u540d\u79f0 -->\r\n	<td class=\"e8_tblForm_field\">\r\n		".toCharArray();
    ...
    _jsp_string177 = "\"/>\r\n            ".toCharArray();
    _jsp_string111 = ";\r\n	".toCharArray();
    _jsp_string185 = "</td><!-- \u65e0\u6743\u9650\u5217\u8868 -->\r\n	<td class=\"e8_tblForm_field\"><input type=\"checkbox\" name=\"norightlist\" value=\"1\" ".toCharArray();

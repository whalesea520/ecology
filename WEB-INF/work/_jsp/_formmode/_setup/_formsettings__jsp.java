...
public class _formsettings__jsp extends com.caucho.jsp.JavaPage
{
...
String titlename=SystemEnv.getHtmlLabelName(33655,user.getLanguage());//\u8868\u5355\u8bbe\u7f6e
      ...
      out.print((SystemEnv.getHtmlLabelName(82140,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(82141,user.getLanguage())));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/formSettings.jsp"), 3551991318644219664L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string67 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string22 = "\");\r\n			return\r\n			formDlg = new Dialog();//\u5b9a\u4e49Dialog\u5bf9\u8c61\r\n			formDlg.Model = true;\r\n			formDlg.Width = 500;//\u5b9a\u4e49\u957f\u5ea6\r\n			formDlg.Height = 382;\r\n			formDlg.URL = \"/formmode/setup/formAdd.jsp?appId=".toCharArray();
    ...
    _jsp_string60 = "visible".toCharArray();
    ...
    _jsp_string25 = "&fmdetachable".toCharArray();
    ...
    _jsp_string20 = "&subCompanyId=".toCharArray();
    _jsp_string43 = ")-1 : Math.ceil(bodyWidth/".toCharArray();
    ...
    _jsp_string19 = "&fmdetachable=".toCharArray();
    ...
    _jsp_string42 = ">1 ? Math.ceil(bodyWidth/".toCharArray();
    ...
    _jsp_string35 = "\r\n\r\n\r\n	\r\n	".toCharArray();
    _jsp_string50 = " oncontextmenu='return false'".toCharArray();
    ...
    _jsp_string62 = "px\">\r\n		</iframe>\r\n	</div>\r\n".toCharArray();
    _jsp_string24 = "\";//\u65b0\u589e\u8868\u5355\r\n			formDlg.show();\r\n		}\r\n		\r\n		function closeFormDlg(){\r\n			if(formDlg){\r\n				formDlg.close();\r\n			}\r\n		}\r\n		function refreshFormDel(){\r\n			\r\n			jQuery.ajax({\r\n			   type: \"POST\",\r\n			   dataType:\"json\",\r\n			   url: \"formSettingsAction.jsp?action=getfirstid&appid=".toCharArray();
    _jsp_string17 = "\\\">\"+data[\"subtablecount\"]+\"</div>\";\r\n				virtualRightPosition = 20;\r\n			}\r\n			var virtualform = \"\";\r\n			if(data[\"isvirtualform\"]==1){\r\n				virtualform = \"<div class=\\\"e8_data_virtualform\\\" style=\\\"right:\"+virtualRightPosition+\"px;\\\" title=\\\"".toCharArray();
    _jsp_string32 = "\";\r\n	var fav_querystring = \"".toCharArray();
    _jsp_string5 = "\";//\u786e\u5b9a\u8981\u5220\u9664\u5417?\r\n      if(!confirm(str)){\r\n        return false;\r\n      }\r\n        return true;\r\n    } \r\n\r\n   function issubmit(){\r\n	 var str = \"".toCharArray();
    _jsp_string56 = "px\" height=\"".toCharArray();
    ...
    _jsp_string61 = ";display:none;\" align=\"left\"  allowtransparency=\"true\" style=\"background-color:transparent\" >\r\n	</div>\r\n	<div id=\"divRightMenuIframe\" name=\"divRightMenuIframe\" style=\"display:none\">\r\n		<iframe id=\"rightMenuIframe\" name=\"rightMenuIframe\" frameborder=0 marginheight=0 marginwidth=0 hspace=0 vspace=0 scrolling=no width=\"".toCharArray();
    _jsp_string1 = "\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();

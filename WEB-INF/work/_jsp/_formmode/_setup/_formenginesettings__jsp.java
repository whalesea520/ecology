...
public class _formenginesettings__jsp extends com.caucho.jsp.JavaPage
{
...
if(RecordSet.next()){
	...
	isEnFormModeReply = RecordSet.getString("isEnFormModeReply");
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + com.caucho.el.Expr.toString(modelId, null)+ "&" + "navName=" + com.caucho.el.Expr.toString(titlename, null), false);
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelNames("33640,68",user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(82603,user.getLanguage())));
                out.write(_jsp_string140, 0, _jsp_string140.length);
              ...
              do {
                ...
                out.print((isEnFormModeReply));
                out.write(_jsp_string143, 0, _jsp_string143.length);
                if(isEnFormModeReply.equals("1")){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/FormEngineSettings.jsp"), -8455944329979388539L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string142 = "\r\n				      	<input type=\"checkbox\" id=\"isEnFormModeReply\" name=\"isEnFormModeReply\" value=\"".toCharArray();
    ...
    _jsp_string143 = "\" tzCheckbox=\"true\" onClick=\"formCheckAll(this);\" ".toCharArray();

...
public class _expandbasepermsaddiframe__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(125969,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(82697,user.getLanguage())));
      out.write(_jsp_string161, 0, _jsp_string161.length);
      out.print((SystemEnv.getHtmlLabelName(82695,user.getLanguage())));
      out.write(_jsp_string162, 0, _jsp_string162.length);
      out.print((SystemEnv.getHtmlLabelName(82696,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(32382,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/setup/expandBasePermsAddIframe.jsp"), 712676482457683982L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string179 = "&isRoleLimited=1\";\r\n	return tempurl1;\r\n}\r\nfunction modefiledChange(){\r\n    var tmpval = $GetEle(\"modefieldtype\").value;\r\n	var tempurl1 = \"/systeminfo/BrowserMain.jsp?url=/formmode/setup/MultiFormmodeShareFieldBrowser.jsp?type=\"+tmpval+\"&selectedids=&modeId=".toCharArray();
    ...
    _jsp_string138 = "\">\r\n  <input type=\"hidden\" name=\"expandid\" value=\"".toCharArray();

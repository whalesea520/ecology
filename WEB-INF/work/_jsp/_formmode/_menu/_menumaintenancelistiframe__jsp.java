...
public class _menumaintenancelistiframe__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(20608,user.getLanguage())));
      out.write(_jsp_string200, 0, _jsp_string200.length);
      out.print((SystemEnv.getHtmlLabelName(33508,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/menu/MenuMaintenanceListIframe.jsp"), -1303033754368747399L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string167 = "/images/homepage/menu/link_2_wev8.png'\\\" onmouseout=\\\"this.src='".toCharArray();
    _jsp_string182 = ":\"+menuText; //\u7f16\u8f91\u83dc\u5355\r\n	 	showDialog(title,url,600,380,false);\r\n	}\r\n\r\n\r\n\r\n	function onAdd(parentMenuId,treeMenuId,parentMenuText){\r\n		if(typeof(parentMenuId)==\"undefined\"){\r\n			parentMenuId = 0;\r\n		}\r\n		if(typeof(parentMenuText)==\"undefined\"){\r\n			parentMenuText = \"".toCharArray();
    _jsp_string180 = "&edit=sub&sync=1\";\r\n		\r\n		if(menuId>0) url=\"/formmode/menu/CustomMenuName.jsp?menuflag=".toCharArray();
    _jsp_string149 = "/images/homepage/menu/del_2_wev8.png'\\\" onmouseout=\\\"this.src='".toCharArray();
    _jsp_string20 = "&f_weaver_belongto_usertype=".toCharArray();
    _jsp_string150 = "/images/homepage/menu/del_1_wev8.png'\\\"/>\":\"\";\r\n				oprateStr = \"<img style=\\\"margin-left:40px;\\\" z_tree=\\\"oprate_div_\"+treeNode.id+\"\\\" src='".toCharArray();
    _jsp_string160 = "/images/homepage/menu/setting_2_wev8.png'\\\" onmouseout=\\\"this.src='".toCharArray();
    _jsp_string109 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string155 = "/images/homepage/menu/edit_2_wev8.png'\\\" onmouseout=\\\"this.src='".toCharArray();
    ...
    _jsp_string156 = "/images/homepage/menu/edit_1_wev8.png'\\\"/>\"+\r\n					delStr;\r\n					\r\n			}else{\r\n				oprateStr = \"<img style=\\\"margin-left:40px;\\\" z_tree=\\\"oprate_div_\"+treeNode.id+\"\\\" src='".toCharArray();
    ...
    _jsp_string127 = "\r\n							".toCharArray();
    _jsp_string170 = "&resourceType=".toCharArray();
    ...
    _jsp_string74 = "\" class=\"e8_btn_top\"\r\n						onclick=\"onAdd('0','null','".toCharArray();
    _jsp_string78 = "\" class=\"cornerMenu\"></span><!-- \u83dc\u5355 -->\r\n				</td>\r\n			</tr>\r\n		</table>\r\n		<div class=\"advancedSearchDiv\" id=\"advancedSearchDiv\">\r\n		</div>\r\n		\r\n\r\n\r\n".toCharArray();
    _jsp_string183 = "\";\r\n		}\r\n		var url = \"/formmode/menu/MenuMaintenanceAdd.jsp?menuflag=".toCharArray();
    ...
    _jsp_string158 = "/images/homepage/menu/edit_1_wev8.png'\\\"/>\"+\r\n					delStr+\r\n					\"&nbsp;&nbsp;&nbsp;&nbsp;<img z_tree=\\\"oprate_div_\"+treeNode.id+\"\\\" src='".toCharArray();
    ...
    _jsp_string154 = "/images/homepage/menu/edit_1_wev8.png' onclick=\\\"onEdit('\"+treeNode.id+\"','\"+treeNode.tId+\"','\"+treeNode.name+\"');\\\" title='".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    _jsp_string186 = ":\"+parentMenuText; //\u6dfb\u52a0\u5b50\u83dc\u5355\r\n		showDialog(title,url,600,380,false);	\r\n	}\r\n	\r\n	function onLimitations(menuId,treeMenuId,menuText){\r\n		var url=\"/page/maint/menu/SystemMenuMaintLimit.jsp?type=".toCharArray();
    ...
    _jsp_string171 = "&edit=sub&sync=1&subCompanyId=".toCharArray();
    ...
    _jsp_string185 = "&sync=1&e=\" + new Date().getTime();;\r\n	 	var title = \"".toCharArray();
    _jsp_string162 = "/images/homepage/menu/add_1_wev8.png'\\\"/>\";\r\n					\"\";\r\n				if(\"".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string197 = "\";//\u663e\u793a\u987a\u5e8f\r\n		}\r\n  }\r\n\r\n   function  ExOrCo(obj){\r\n	   var objSpan=obj.lastChild;\r\n	   if(objSpan.stat==\"co\") {\r\n			objSpan.stat=\"ex\";\r\n		    var treeObj = $.fn.zTree.getZTreeObj(\"menutree\");\r\n			treeObj.expandAll(true);\r\n			objSpan.innerHTML=\"".toCharArray();
    _jsp_string98 = "px\" height=\"".toCharArray();
    _jsp_string192 = "&infoId=\"+menuId+\"&resourceId=".toCharArray();
    ...
    _jsp_string80 = "\r\n		\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string161 = "/images/homepage/menu/setting_1_wev8.png'\\\"/>\";\r\n				\r\n			}else{\r\n				\r\n				oprateStr += \"<img style=\\\"margin-left:40px;\\\" z_tree=\\\"oprate_div_\"+treeNode.id+\"\\\" src='".toCharArray();
    ...
    _jsp_string148 = "' onmouseover=\\\"this.src='".toCharArray();
    _jsp_string29 = "')) {\r\n				    lenck = false;\r\n				    break;\r\n			    }\r\n		    }\r\n		    if(lenck==false) return false;\r\n	    }\r\n	    catch(e) {}\r\n	    ".toCharArray();
    _jsp_string164 = "/images/homepage/menu/del_1_wev8.png'\\\"/>\":\"\";\r\n					oprateStr+=delStr\r\n				}\r\n\r\n				oprateStr +=\"&nbsp;&nbsp;&nbsp;&nbsp;<img z_tree=\\\"oprate_div_\"+treeNode.id+\"\\\" src='".toCharArray();
    _jsp_string159 = "/images/homepage/menu/setting_1_wev8.png' onclick=\\\"onShare('\"+treeNode.id+\"','\"+treeNode.tId+\"','\"+treeNode.name+\"');\\\" title='".toCharArray();
    ...
    _jsp_string176 = "&parentid=\"+treeNode.id+\"&mode=visible&e=\" + new Date().getTime();\r\n	    } else {\r\n	    	//\u521d\u59cb\u5316\u65f6\r\n	    	//alert(\"/page/maint/menu/SystemMenuMaintListJSON.jsp?type=".toCharArray();
    _jsp_string163 = "\"==treeNode.ownerid){\r\n					var delStr = treeNode.id<0?\"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img z_tree=\\\"oprate_div_\"+treeNode.id+\"\\\" src='".toCharArray();
    _jsp_string151 = "/images/homepage/menu/add_1_wev8.png' onclick=\\\"onAdd('\"+treeNode.id+\"','\"+treeNode.tId+\"','\"+treeNode.name+\"');\\\" title='".toCharArray();
    _jsp_string145 = "){\r\n			if(\"".toCharArray();
    _jsp_string76 = "\" class=\"e8_btn_top\"\r\n						onclick=\"onSave(this)\" /><!-- \u4fdd\u5b58 -->\r\n						".toCharArray();
    _jsp_string58 = "\r\n<meta http-equiv=\"".toCharArray();
    _jsp_string60 = ",transition=".toCharArray();
    _jsp_string59 = "\" content=\"revealTrans(duration=".toCharArray();
    _jsp_string179 = "&type=".toCharArray();

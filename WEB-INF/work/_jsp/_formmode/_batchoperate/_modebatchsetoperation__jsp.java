...
public class _modebatchsetoperation__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string52, 0, _jsp_string52.length);
      weaver.formmode.interfaces.action.WSActionManager wsActionManager;
      wsActionManager = (weaver.formmode.interfaces.action.WSActionManager) pageContext.getAttribute("wsActionManager");
      if (wsActionManager == null) {
        wsActionManager = new weaver.formmode.interfaces.action.WSActionManager();
        pageContext.setAttribute("wsActionManager", wsActionManager);
      }
      out.write(_jsp_string52, 0, _jsp_string52.length);
      weaver.formmode.interfaces.action.SapActionManager sapActionManager;
      sapActionManager = (weaver.formmode.interfaces.action.SapActionManager) pageContext.getAttribute("sapActionManager");
      if (sapActionManager == null) {
        sapActionManager = new weaver.formmode.interfaces.action.SapActionManager();
        pageContext.setAttribute("sapActionManager", sapActionManager);
      }
      out.write(_jsp_string52, 0, _jsp_string52.length);
      weaver.formmode.interfaces.action.BaseAction baseAction;
      baseAction = (weaver.formmode.interfaces.action.BaseAction) pageContext.getAttribute("baseAction");
      if (baseAction == null) {
        baseAction = new weaver.formmode.interfaces.action.BaseAction();
...
response.sendRedirect("/formmode/batchoperate/ModeBatchSet.jsp?id="+customsearchid);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/batchoperate/ModeBatchSetOperation.jsp"), 7668709521877548189L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

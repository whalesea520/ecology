...
public class _modepageexpandrelatedfieldsetiframe__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((InterfaceTransmethod.getHrefType(hreftype,String.valueOf(user.getLanguage()))));
      out.write(_jsp_string145, 0, _jsp_string145.length);
      out.print((SystemEnv.getHtmlLabelName(30181,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/interfaces/ModePageExpandRelatedFieldSetIframe.jsp"), -4016811925787283876L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string153 = "</td><!-- \u94fe\u63a5\u76ee\u6807\u5b57\u6bb5 -->\r\n                  			<td style=\"border-bottom: 2px solid #b7e0fe;\">".toCharArray();
    ...
    _jsp_string139 = "\" id=\"zd_btn_save\" class=\"e8_btn_top\" onclick=\"doSubmit()\">\r\n			<span title=\"".toCharArray();
    _jsp_string140 = "\" class=\"cornerMenu\"></span><!-- \u83dc\u5355 -->\r\n		".toCharArray();
    ...
    _jsp_string148 = "\">\r\n				<input type=\"hidden\" name=\"hreftype\" id=\"hreftype\" value=\"".toCharArray();
    ...
    _jsp_string157 = "\r\n	              						<input type=\"hidden\" id=\"hreffieldname\" name=\"hreffieldname\" value=\"".toCharArray();
    ...
    _jsp_string147 = "</span>\r\n				<input type=\"hidden\" name=\"hrefid\" id=\"hrefid\" value=\"".toCharArray();

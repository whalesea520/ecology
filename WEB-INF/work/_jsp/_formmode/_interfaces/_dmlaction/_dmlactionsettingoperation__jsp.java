...
public class _dmlactionsettingoperation__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      weaver.formmode.interfaces.dmlaction.services.DmlActionInfoService DmlActionInfoService;
      DmlActionInfoService = (weaver.formmode.interfaces.dmlaction.services.DmlActionInfoService) pageContext.getAttribute("DmlActionInfoService");
      if (DmlActionInfoService == null) {
        DmlActionInfoService = new weaver.formmode.interfaces.dmlaction.services.DmlActionInfoService();
        pageContext.setAttribute("DmlActionInfoService", DmlActionInfoService);
      }
      out.write(_jsp_string52, 0, _jsp_string52.length);
...
else if("delete".equals(operate))
{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/interfaces/dmlaction/DMLActionSettingOperation.jsp"), -4926177941182865404L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

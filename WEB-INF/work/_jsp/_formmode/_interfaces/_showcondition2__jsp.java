...
public class _showcondition2__jsp extends com.caucho.jsp.JavaPage
{
...
if(isSysadmin>0) {  //\u7528\u7cfb\u7edf\u7ba1\u7406\u5458sysadmin\u767b\u9646\u7cfb\u7edf\u53ef\u67e5\u770b\u9875\u9762\u5730\u5740
	...
	RCMenu += "{"+SystemEnv.getHtmlLabelName(15504,user.getLanguage())+",javascript:onClean(),_self} " ;//\u6e05\u7a7a
      ...
      out.print((SystemEnv.getHtmlLabelName(33881, user.getLanguage()) ));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                pageContext.include("/workflow/ruleDesign/ruleDesign.jsp", "pagetype=" + ("1")+ "&" + "formid=" + com.caucho.el.Expr.toString(formid , null)+ "&" + "isbill=" + com.caucho.el.Expr.toString(isbill , null)+ "&" + "linkid=" + com.caucho.el.Expr.toString(linkid , null)+ "&" + "rulesrc=" + com.caucho.el.Expr.toString(rulesrc , null)+ "&" + "ruleid=" + com.caucho.el.Expr.toString(ruleid , null)+ "&" + "isnew=" + com.caucho.el.Expr.toString(isnew , null)+ "&" + "wfid=" + com.caucho.el.Expr.toString(wfid , null), false);
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/interfaces/showcondition2.jsp"), 7787679374884036400L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string47 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string86 = "_con\")).val(ruleid);\r\n			jQuery(parentWin.$GetEle(\"por".toCharArray();
    ...
    _jsp_string74 = "\" class=\"e8_btn_top\"  onclick=\"javascript:onSave();\"/>\r\n			<!-- <input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string76 = "\" class=\"e8_btn_top\" id=\"cleanBtn\" onclick=\"javascript:onClean();\"/>\r\n			<span title=\"".toCharArray();
    _jsp_string33 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string77 = "\" class=\"cornerMenu\"></span><!-- \u83dc\u5355 -->\r\n		</td>\r\n	</tr>\r\n</table> \r\n".toCharArray();
    _jsp_string51 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    ...
    _jsp_string88 = "\",true,rulesrc,ruleids,rulecondits,maplistids);\r\n		}\r\n		closeDialog();\r\n	}\r\n</script>\r\n".toCharArray();

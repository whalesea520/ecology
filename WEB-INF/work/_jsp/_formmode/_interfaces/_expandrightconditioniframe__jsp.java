...
public class _expandrightconditioniframe__jsp extends com.caucho.jsp.JavaPage
{
...
if(isSysadmin>0) {  //\u7528\u7cfb\u7edf\u7ba1\u7406\u5458sysadmin\u767b\u9646\u7cfb\u7edf\u53ef\u67e5\u770b\u9875\u9762\u5730\u5740
	...
	RCMenu += "{"+SystemEnv.getHtmlLabelName(82691,user.getLanguage())+",javascript:onCheckSQL(),_self} " ;//\u68c0\u6d4bSQL
      ...
      out.print((SystemEnv.getHtmlLabelName(82691, user.getLanguage()) ));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                pageContext.include("/formmode/interfaces/ExpandRightConditiponDesign.jsp", "modeid=" + com.caucho.el.Expr.toString(modeid , null)+ "&" + "expandid=" + com.caucho.el.Expr.toString(expandid , null)+ "&" + "rightid=" + com.caucho.el.Expr.toString(rightid , null), false);
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/interfaces/ExpandRightConditionIframe.jsp"), 4653306635166424437L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string75 = "\" class=\"e8_btn_top\" id=\"cleanBtn\" onclick=\"javascript:onClean();\"/>\r\n			<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string76 = "\" class=\"e8_btn_top\" id=\"cleanBtn\" onclick=\"javascript:onCheckSQL();\"/>\r\n			<span title=\"".toCharArray();

...
public class _modeimporttemplateiframe__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((fieldlabelname+" ["+fieldname+"]"));
      out.write(_jsp_string155, 0, _jsp_string155.length);
      out.print((tablename1));
      ...
      if("1".equals(ischeck)&&"".equals(dsporder)){
      ...
      out.print((SystemEnv.getHtmlLabelNames("826,32757,19653",user.getLanguage())+"?"));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/interfaces/ModeImportTemplateIframe.jsp"), -4982915531873726L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string160 = "',8,2)\" \r\n										onchange=\"checkDsporder('".toCharArray();
    _jsp_string144 = "</th><!-- \u63d0\u793a\u4fe1\u606f -->\r\n						   <th>".toCharArray();
    ...
    _jsp_string73 = "\";\r\n        dialog.Width = 550 ;\r\n        dialog.Height = 600;\r\n        dialog.Drag = true;\r\n        dialog.show();\r\n    });\r\n\r\n}\r\n</script>\r\n		\r\n\r\n\r\n".toCharArray();
    _jsp_string152 = "\" class=\"check_node_".toCharArray();
    ...
    _jsp_string158 = "\" id=\"dsporder_".toCharArray();
    ...
    _jsp_string147 = "</td></tr>\r\n									".toCharArray();
    _jsp_string145 = "</th><!-- \u663e\u793a\u987a\u5e8f -->\r\n						</tr>\r\n						".toCharArray();
    ...
    _jsp_string146 = "\r\n									<tr class=\"tableTr\"><td colspan=\"4\"><span class=\"groupbg\"> </span>".toCharArray();
    ...
    _jsp_string163 = "image\">".toCharArray();
    ...
    _jsp_string151 = "')\" id=\"check_node\" name=\"check_node\" fieldid=\"".toCharArray();
    ...
    _jsp_string150 = " type=\"checkbox\" onclick=\"checkDsporder('".toCharArray();
    _jsp_string131 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result10\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string70 = "';\r\n    }\r\n    window.open(operationPage+\"?pathKey=\"+pathKey,\"_blank\",\"top=0,left=\"+(screenWidth-800)/2+\",height=\"+(screenHeight-90)+\",width=1000,status=no,scrollbars=yes,toolbar=yes,menubar=no,location=no\");\r\n}\r\nfunction openFavouriteBrowser()\r\n{  \r\n	\r\n	var BacoTitle = jQuery(\"#BacoTitle\");\r\n	var pagename = \"\";\r\n	var navName = \"\";\r\n	var fav_uri = \"".toCharArray();
    _jsp_string159 = "\" onKeyPress=\"ItemDecimal_KeyPress('dsporder_".toCharArray();
    ...
    _jsp_string157 = "\">\r\n									<INPUT class=inputstyle type=\"text\" style=\"width:120px\" maxLength=18 size=20 name=\"dsporder_".toCharArray();
  }
}

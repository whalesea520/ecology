...
public class _createtemplateiframe__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
          ...
          if (_jspEval17 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              if (_jsp_ItemTag_5 == null) {
                ...
                _jsp_ItemTag_5.setAttributes("{'customAttrs':'nowrap=true'}");
              }
              ...
              do {
                ...
                if (_jsp_RequiredTag_7 == null) {
                  ...
                  _jsp_RequiredTag_7.setParent((javax.servlet.jsp.tagext.Tag) _jsp_ItemTag_6);
                  _jsp_RequiredTag_7.setId("templatename_span");
              ...
              _jsp_ItemTag_5.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(19471,user.getLanguage()) ));
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(83139,user.getLanguage()) ));
      ...
      if (_jspEval50 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          int _jspEval53 = _jsp_GroupTag_8.doStartTag();
          if (_jspEval53 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval53 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_8.setBodyContent(_jsp_endTagHack51);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/template/CreateTemplateIframe.jsp"), -4615960413326554600L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string148 = "<!--\u6a21\u677f\u540d\u79f0-->".toCharArray();
    ...
    _jsp_string154 = "<!-- \u663e\u793a\u987a\u5e8f-->".toCharArray();
    ...
    _jsp_string141 = "\" style=\"font-size: 12px;cursor: pointer;\"><!-- \u4fdd\u5b58 -->\r\n				<input class=\"e8_btn_top middle\" onclick=\"javascript:submitData(this)\" type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string144 = "\r\n<FORM id=frmain name=frmain action=\"/formmode/template/SaveTemplateOperation.jsp?".toCharArray();

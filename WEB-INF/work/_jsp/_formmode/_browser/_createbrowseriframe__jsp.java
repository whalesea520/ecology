...
public class _createbrowseriframe__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.write('>');
      out.print((SystemEnv.getHtmlLabelName(28626,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(81940 , user.getLanguage())));
      out.write(_jsp_string148, 0, _jsp_string148.length);
      out.print((SystemEnv.getHtmlLabelName(81941 , user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/browser/CreateBrowserIframe.jsp"), -5680451028152264684L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string103 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string142 = "<IMG src=\"/images/BacoError_wev8.gif\" align=absMiddle>".toCharArray();
    _jsp_string141 = "\">\r\n		          			<SPAN id=browseridimage>".toCharArray();
    ...
    _jsp_string148 = "<br><!-- 1\uff09\u6807\u8bc6\u53ea\u80fd\u4e3a\u6570\u5b57\u3001\u5b57\u6bcd\u548c\u4e0b\u5212\u7ebf\uff0c\u6700\u5927\u957f\u5ea6\u4e3a40\u4e2a\u5b57\u7b26\u3002 -->\r\n					        ".toCharArray();
    ...
    _jsp_string140 = "</TD><!-- \u6807\u8bc6 -->\r\n		          		<TD class=Field>\r\n		        			<INPUT type=text class=Inputstyle size=30 maxlength=\"40\" name=\"browserid\" onchange='checkinput(\"browserid\",\"browseridimage\")' onBlur=\"checkBrowserId('browserid','browseridimage')\" value=\"".toCharArray();
    ...
    _jsp_string136 = "\" id=\"zd_btn_submit\" class=\"e8_btn_top\" onclick=\"submitData()\">\r\n				<span title=\"".toCharArray();
    _jsp_string88 = ");\r\n			}\r\n		}catch(e){}\r\n		".toCharArray();

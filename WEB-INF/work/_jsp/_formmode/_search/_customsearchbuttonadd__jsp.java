...
public class _customsearchbuttonadd__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(81968,user.getLanguage())));
      out.write(_jsp_string130, 0, _jsp_string130.length);
      out.print((SystemEnv.getHtmlLabelName(81969,user.getLanguage())));
      out.write(_jsp_string131, 0, _jsp_string131.length);
      out.print((SystemEnv.getHtmlLabelName(81970,user.getLanguage())));
      out.write(_jsp_string132, 0, _jsp_string132.length);
      out.print((SystemEnv.getHtmlLabelName(81971,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(81972,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(81967,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(81974,user.getLanguage())));
      out.write(_jsp_string148, 0, _jsp_string148.length);
      if(hreftargetOpenWay==1) out.println("selected");
      out.write('>');
      out.print((SystemEnv.getHtmlLabelName(22970,user.getLanguage())));
      out.write(_jsp_string149, 0, _jsp_string149.length);
      if(hreftargetOpenWay==2) out.println("selected");
      out.write('>');
      out.print((SystemEnv.getHtmlLabelName(81975,user.getLanguage())));
      out.write(_jsp_string150, 0, _jsp_string150.length);
      out.print((SystemEnv.getHtmlLabelName(81976,user.getLanguage())));
      out.write(_jsp_string151, 0, _jsp_string151.length);
      out.print((hreftargetParid));
      out.write(_jsp_string152, 0, _jsp_string152.length);
      out.print((SystemEnv.getHtmlLabelName(81976,user.getLanguage())));
      out.write(_jsp_string153, 0, _jsp_string153.length);
      out.print((hreftargetParval));
      out.write(_jsp_string154, 0, _jsp_string154.length);
      out.print((SystemEnv.getHtmlLabelName(81977,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/search/CustomSearchButtonAdd.jsp"), -8804847548497055304L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string132 = "\",function(){displayAllmenu();});//\u65b9\u6cd5\u540d\u4e0d\u80fd\u4e3a\u7a7a\uff01\r\n    		return false;\r\n    	}\r\n    	if($(\"#jsmethodbody\").val()==\"\"){\r\n    		top.Dialog.alert(\"javascript".toCharArray();
    ...
    _jsp_string160 = "\" style=\"width:80%;\" onchange=\"checkinput('jsmethodname','jsmethodnameImage');checkMethodName(this);\"/>\r\n				<span id=\"jsmethodnameImage\">".toCharArray();
    _jsp_string156 = "<!-- \u94fe\u63a5\u76ee\u6807\u5730\u5740--></td>\r\n			<td class=\"e8_tblForm_field\" valign=\"top\">\r\n				<textarea id=\"hreftarget\" name=\"hreftarget\" class=\"inputstyle\" rows=\"3\" style=\"width:80%\" onchange=\"checkinput('hreftarget','hreftargetImage')\">".toCharArray();
    _jsp_string157 = "</textarea>\r\n				<span id=\"hreftargetImage\">".toCharArray();
    ...
    _jsp_string171 = "<!-- \u662f\u5426\u663e\u793a	--></td>\r\n			<td class=\"e8_tblForm_field\">\r\n				<input class=\"inputstyle\" type=\"checkbox\" id=\"isshow\" name=\"isshow\" value=\"1\" ".toCharArray();
    ...
    _jsp_string61 = ")\">\r\n".toCharArray();
    _jsp_string158 = "</span>\r\n			</td>\r\n		</tr>\r\n		<tr id=\"jsmethodNameTr\">\r\n			<td class=\"e8_tblForm_label\">javascript".toCharArray();
    ...
    _jsp_string159 = "<!-- \u65b9\u6cd5\u540d --></td>\r\n			<td class=\"e8_tblForm_field\">\r\n				<input class=\"inputstyle\" type=\"text\" id=\"jsmethodname\" name=\"jsmethodname\" value=\"".toCharArray();
    _jsp_string147 = "<!-- \u94fe\u63a5 --></option>\r\n				</select>\r\n			</td>\r\n		</tr>\r\n		<tr id=\"hreftargetOpenWayTr\">\r\n			<td class=\"e8_tblForm_label\" width=\"20%\">".toCharArray();
    ...
    _jsp_string134 = "\",function(){\r\n       enableAllmenu();\r\n  	   document.WeaverForm.operation.value=\"delete\";\r\n  	   document.WeaverForm.submit();\r\n   });\r\n}\r\nfunction doBack(){\r\n	enableAllmenu();\r\n	window.location.href = \"/formmode/search/CustomSearchButton.jsp?id=".toCharArray();
    _jsp_string113 = "\r\n\r\n\r\n\r\n\r\n\r\n\r\n<script type=\"text/javascript\">\r\n//\u7528\u6237\u8bed\u8a00\r\nvar languageid = '".toCharArray();
    _jsp_string83 = "\r\n	    try{\r\n		setMenuBoxHeightSelf();\r\n	    }catch(e){}\r\n		".toCharArray();
    _jsp_string169 = "<!-- \u63a5\u53e3\u8def\u5f84 --></td>\r\n			<td class=\"e8_tblForm_field\">\r\n				<input class=\"inputstyle\" type=\"text\" id=\"interfacePath\" name=\"interfacePath\" value=\"".toCharArray();
    ...
    _jsp_string153 = "field<!-- \u94fe\u63a5\u76ee\u6807\u53c2\u6570 --></td>\r\n			<td class=\"e8_tblForm_field\">\r\n				<input class=\"inputstyle\" type=\"text\" id=\"hreftargetParval\" name=\"hreftargetParval\" value=\"".toCharArray();
    _jsp_string106 = "\r\n	_menuDocument.getElementById(\"rightMenu\").style.visibility=\"visible\";\r\n	if (!_menuWindow.ActiveXObject) {\r\n		_menuDocument.getElementById(\"rightMenu\").style.display=\"\";\r\n	}\r\n	".toCharArray();
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string166 = "<!-- \u65b9\u6cd5\u4f53 --></td>\r\n			<td class=\"e8_tblForm_field\">\r\n				<textarea id=\"jsmethodbody\" name=\"jsmethodbody\" style=\"width:80%;\" rows=\"10\" onchange=\"checkinput('jsmethodbody','jsmethodbodyImage')\">".toCharArray();
    _jsp_string162 = "<!-- \u65b9\u6cd5\u540d\u547d\u540d\u89c4\u8303 -->\uff1ajavascript:onUrl();</div>\r\n			</td>\r\n		</tr>\r\n		<tr id=\"jsParameterTr\">\r\n			<td class=\"e8_tblForm_label\">javascript".toCharArray();
    _jsp_string137 = "&methodName=\"+methodName,					\r\n		        success:function(msg){  \r\n		        	if(\"true\"==msg.trim()){		\r\n		        		$(\"#jsmethodname\").val(\"\");\r\n						$(\"#jsmethodnameImage\").html(\"<font color='red'>javascript".toCharArray();
    ...
    _jsp_string165 = "<!-- \u65b9\u6cd5\u53c2\u6570\u547d\u540d\u89c4\u8303 -->\uff1afield1,field2</div>\r\n			</td>\r\n		</tr>\r\n		<tr id=\"jsmethodBodyTr\">\r\n			<td class=\"e8_tblForm_label\">javascript".toCharArray();
    ...
    _jsp_string173 = "<!-- \u63cf\u8ff0 --><div class=\"e8_label_desc\"></div></td>\r\n			<td class=\"e8_tblForm_field\">\r\n				<textarea id=\"describe\" name=\"describe\" style=\"width:80%;\">".toCharArray();
    _jsp_string144 = "</span>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td class=\"e8_tblForm_label\" width=\"20%\">".toCharArray();
    _jsp_string142 = "\"  onchange=\"checkinput('buttonname','buttonnameImage')\"/>\r\n				<span id=\"buttonnameImage\">".toCharArray();
    _jsp_string146 = "<!-- \u624b\u52a8\u8f93\u5165 --></option>\r\n					<option value=\"2\" ".toCharArray();
    ...
    _jsp_string131 = "\",function(){displayAllmenu();});//\u94fe\u63a5\u76ee\u6807\u5730\u5740\u4e0d\u80fd\u4e3a\u7a7a\uff01\r\n    		return false;\r\n    	}\r\n    }else{\r\n    	if($(\"#jsmethodname\").val()==\"\"){\r\n    		top.Dialog.alert(\"javascript".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string163 = "<!-- \u65b9\u6cd5\u53c2\u6570 --></td>\r\n			<td class=\"e8_tblForm_field\">\r\n				<input class=\"inputstyle\" type=\"text\" id=\"jsParameter\" name=\"jsParameter\" value=\"".toCharArray();
    _jsp_string161 = "</span>\r\n				<div class=\"e8_label_desc\">".toCharArray();
    _jsp_string22 = "\";\r\n					//diag.InvokeElementId=\"pageOverlay\"\r\n					diag.URL = \"/wui/theme/ecology7/page/loginSmall.jsp?username=".toCharArray();
    _jsp_string141 = "</td><!-- \u540d\u79f0 -->\r\n			<td class=\"e8_tblForm_field\">\r\n				<input type=\"text\" name=\"buttonname\" id=\"buttonname\" style=\"width:80%;\" value=\"".toCharArray();
    _jsp_string128 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result4\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string29 = "')) {\r\n				    lenck = false;\r\n				    break;\r\n			    }\r\n		    }\r\n		    if(lenck==false) return false;\r\n	    }\r\n	    catch(e) {}\r\n	    ".toCharArray();
    _jsp_string155 = "<!-- \u94fe\u63a5\u76ee\u6807\u53c2\u6570field\u662f\u6307\u67e5\u8be2\u5217\u8868\u4e2d\u7684\u5b57\u6bb5 --></div>\r\n			</td>\r\n		</tr>\r\n		<tr id=\"hrefTargetTr\">\r\n			<td class=\"e8_tblForm_label\" width=\"20%\">".toCharArray();
    _jsp_string136 = "&objid=".toCharArray();
    _jsp_string58 = "\r\n<meta http-equiv=\"".toCharArray();
    _jsp_string133 = "\",function(){displayAllmenu();});//\u65b9\u6cd5\u4f53\u4e0d\u80fd\u4e3a\u7a7a\uff01\r\n    		return false;\r\n    	}\r\n    }\r\n    document.WeaverForm.submit();		\r\n}\r\nfunction doDel(){\r\n   //\u786e\u5b9a\u8981\u5220\u9664\u5417\uff1f\r\n   top.Dialog.confirm(\"".toCharArray();
    ...
    _jsp_string176 = "\" size=\"5\" onkeypress=\"ItemDecimal_KeyPress('showorder',15,2)\" onblur=\"checknumber1(this);\">\r\n			</td>\r\n		</tr>\r\n	</table>\r\n</form>\r\n</body>\r\n</html>\r\n".toCharArray();
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string143 = "<img src=\"/images/BacoError_wev8.gif\"/>".toCharArray();
    _jsp_string102 = ";\r\n	".toCharArray();
    _jsp_string151 = "id<!-- \u94fe\u63a5\u76ee\u6807\u53c2\u6570 --></td>\r\n			<td class=\"e8_tblForm_field\">\r\n				<input class=\"inputstyle\" type=\"text\" id=\"hreftargetParid\" name=\"hreftargetParid\" value=\"".toCharArray();

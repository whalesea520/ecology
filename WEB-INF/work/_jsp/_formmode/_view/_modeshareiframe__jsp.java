...
public class _modeshareiframe__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      _jsp_BrowserTag_0.setWidth("50%");
      _jsp_BrowserTag_0.setIsSingle("false");
      _jsp_BrowserTag_0.setCompleteUrl("/data.jsp?type=4");
      ...
      out.print((SystemEnv.getHtmlLabelName(26137,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(31248,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(82469,user.getLanguage())));
      out.write(_jsp_string232, 0, _jsp_string232.length);
      out.print((SystemEnv.getHtmlLabelName(31251,user.getLanguage())));
      out.write(_jsp_string233, 0, _jsp_string233.length);
      out.print((SystemEnv.getHtmlLabelName(31250,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/view/ModeShareIframe.jsp"), -6873662439887501321L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string145 = "\">\r\n  <input type=\"hidden\" name=\"relatedid\" id=\"relatedid\" value=\"\">\r\n  <input type=\"hidden\" name=\"token\" id=\"token\" value=\"".toCharArray();
    _jsp_string139 = "\r\n			".toCharArray();
    ...
    _jsp_string210 = "\r\n											<input class='inputStyle' type='checkbox' id='share_set_id' name='share_set_id' value='".toCharArray();
    _jsp_string204 = "</th><!-- \u5171\u4eab\u7c7b\u578b -->\r\n                 <th>".toCharArray();

...
public class _modeshareoperation__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.formmode.setup.ModeRightForPage ModeRightForPage;
      ModeRightForPage = (weaver.formmode.setup.ModeRightForPage) pageContext.getAttribute("ModeRightForPage");
      if (ModeRightForPage == null) {
        ModeRightForPage = new weaver.formmode.setup.ModeRightForPage();
        pageContext.setAttribute("ModeRightForPage", ModeRightForPage);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
if(method.equals("delShare")){//\u4fdd\u5b58\u9ed8\u8ba4\u6743\u9650(\u521b\u5efa\u4eba\u76f8\u5173)
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("formmode/view/ModeShareOperation.jsp"), -5424155664163544235L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

...
public class _workplantypeset__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(19773,user.getLanguage())));
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(33467,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(33468,user.getLanguage())));
          ...
          if (_jsp_GroupTag_3 == null) {
            ...
            _jsp_GroupTag_3.setAttributes("{'itemAreaDisplay':\"block\"}");
          }

          _jsp_GroupTag_3.setContext(SystemEnv.getHtmlLabelName(16094,user.getLanguage()));
          ...
          if (_jspEval13 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.write(_jsp_string141, 0, _jsp_string141.length);
                out.print((SystemEnv.getHtmlLabelName(19774,user.getLanguage())));
                out.write(_jsp_string142, 0, _jsp_string142.length);
                out.print((SystemEnv.getHtmlLabelName(495,user.getLanguage())));
                out.write(_jsp_string142, 0, _jsp_string142.length);
                out.print((SystemEnv.getHtmlLabelName(18095,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(21943,user.getLanguage())));
      out.write(_jsp_string152, 0, _jsp_string152.length);
      out.print((SystemEnv.getHtmlNoteName(14,user.getLanguage())));
      out.write(_jsp_string153, 0, _jsp_string153.length);
      out.print((SystemEnv.getHtmlLabelName(19778,user.getLanguage())));
      out.write(_jsp_string154, 0, _jsp_string154.length);
      out.print((SystemEnv.getHtmlLabelName(19777,user.getLanguage())));
      out.write(_jsp_string155, 0, _jsp_string155.length);
      out.print((SystemEnv.getHtmlLabelName(16217,user.getLanguage())));
      ...
      out.print(( checkRightCheckBox(used, attribute) ));
      ...
      out.print(( Util.toHtml(Util.null2String(recordSet.getString("workPlanTypeName")).replace("\\","\\\\"),false) ));
      out.write(_jsp_string169, 0, _jsp_string169.length);
      out.print(( checkRightInput(attribute,mutilLang) ));
      out.write(_jsp_string170, 0, _jsp_string170.length);
      out.print(( recordSet.getString("workPlanTypeColor") ));
      out.write(_jsp_string171, 0, _jsp_string171.length);
      out.print(( checkRightColorInput(attribute) ));
      out.write(_jsp_string172, 0, _jsp_string172.length);
      out.print(( checkRightColorpallette(attribute) ));
      out.write(_jsp_string173, 0, _jsp_string173.length);
      out.print(( recordSet.getString("workPlanTypeColor") ));
      out.write(_jsp_string174, 0, _jsp_string174.length);
      out.print(( checkRightValidCheckBox(attribute) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workplan/config/global/WorkPlanTypeSet.jsp"), -3932093962532964886L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string169 = "' onBlur='setworkPlanTypeName(this)' ".toCharArray();
    ...
    _jsp_string48 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string160 = "' onBlur='setMenubarBgColor(this)'/><SPAN></SPAN></TD><TD><IMG src='/images/ColorPicker_wev8.gif' class='colorPicker' onClick='getColorFromColorPicker(this);'></TD><TD id='menubarBgColor' style='height:4px;background-color:\"+getColor(".toCharArray();
    _jsp_string159 = "' readonly onBlur='setworkPlanTypeName(this)'><SPAN></SPAN>\";                        \r\n        oCell.appendChild(oDiv);\r\n        \r\n        /*============ \u989c\u8272 ============*/\r\n        oCell = oRow.insertCell(-1);\r\n        oDiv = document.createElement(\"div\");\r\n        oDiv.innerHTML=\"<TABLE class='colorPane'><colgroup><col width='0'><col width='16'><col width='60'></colgroup><TR><TD rowspan='2'><INPUT type='hidden' class='InputStyle' maxlength='7' size='10' id='wcolor' name='wcolor' value='".toCharArray();
    ...
    _jsp_string177 = "><INPUT type='hidden' name='available' value='".toCharArray();
    ...
    _jsp_string163 = "><INPUT type='hidden' name='wavailable' value='".toCharArray();
    ...
    _jsp_string173 = " ></TD><TD id='menubarBgColor' style='height:4px;background-color:\"+getColor(".toCharArray();
    _jsp_string145 = "\"></BUTTON>\r\n            						<BUTTON class=\"delbtn\" type=button accessKey=E onClick=\"removeRow()\" title=\"".toCharArray();
    ...
    _jsp_string136 = "\" class=\"e8_btn_top middle\" onclick=\"doSave(this)\"/>\r\n			<span title=\"".toCharArray();
    ...
    _jsp_string157 = "\r\n		var oRow = oTable1.insertRow(-1);\r\n        var oRowIndex = oRow.rowIndex;\r\n\r\n		oRow.className = \"DataDark\";\r\n		/*============ \u9009\u62e9 ============*/\r\n        var oCell = oRow.insertCell(-1);\r\n        var oDiv = document.createElement(\"div\");\r\n        oDiv.innerHTML=\"<INPUT type='checkbox' disabled='true' name='workPlanID'><INPUT type='hidden' name='workPlanIDs' value='".toCharArray();
    ...
    _jsp_string161 = ",0)+\" !important;'></TD></TR></TABLE>\";                 \r\n        oCell.appendChild(oDiv);\r\n        \r\n        /*============ \u542f\u7528 ============*/\r\n        oCell = oRow.insertCell(-1);\r\n        oDiv = document.createElement(\"div\");\r\n        oDiv.innerHTML=\"<INPUT type='checkbox' onClick='setAvailable(this)' ".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string172 = "/><SPAN></SPAN></TD><TD><IMG src='/images/ColorPicker_wev8.gif' class='colorPicker' ".toCharArray();
    _jsp_string146 = "\"></BUTTON>\r\n            					</TD>\r\n            				</TR>\r\n          				</TABLE>\r\n          	".toCharArray();
    _jsp_string9 = "\r\n<script type=\"text/javascript\" src=\"/wui/common/jquery/jquery.min_wev8.js\"></script>\r\n".toCharArray();
    _jsp_string170 = " ><SPAN></SPAN>\";                        \r\n	        oCell.appendChild(oDiv);\r\n	        \r\n	        /*============ \u989c\u8272 ============*/\r\n	        oCell = oRow.insertCell(-1);\r\n	        oDiv = document.createElement(\"div\");\r\n	        oDiv.innerHTML=\"<TABLE class='colorPane'><colgroup><col width='0'><col width='16'><col width='60'></colgroup><TR><TD rowspan='2'><INPUT type='hidden' class='InputStyle' maxlength='7' size='10' id='color' name='color' value='".toCharArray();
    ...
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string158 = "'>\";                        \r\n        oCell.appendChild(oDiv);\r\n        \r\n        /*============ \u540d\u79f0 ============*/\r\n        oCell = oRow.insertCell(-1);\r\n        oDiv = document.createElement(\"div\");\r\n        oDiv.innerHTML=\"<INPUT class='Inputstyle' type='text' name='workplanname' size='55' value='".toCharArray();
    _jsp_string92 = "px\" height=\"".toCharArray();
    _jsp_string144 = "\r\n				<TABLE width=100%>\r\n            				<TR>\r\n            					<TD align=right>\r\n            						<BUTTON class=\"addbtn\" type=button accessKey=A onClick=\"addRow()\" title=\"".toCharArray();
    ...
    _jsp_string162 = "checked='true'".toCharArray();
    ...
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string176 = " checked='true'".toCharArray();
    _jsp_string118 = "\r\n		<script type=\"text/javascript\">\r\n\r\n			jQuery(\"#divTopMenu\").hide();\r\n			jQuery(\"#rightMenu\",_menuDocument).hide();\r\n		\r\n		</script>\r\n		".toCharArray();
    _jsp_string95 = "hidden".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string167 = " ><INPUT type='hidden' name='workPlanTypeIDs' value='".toCharArray();
    ...
    _jsp_string171 = "' onBlur='setMenubarBgColor(this)' ".toCharArray();
    _jsp_string29 = "')) {\r\n				    lenck = false;\r\n				    break;\r\n			    }\r\n		    }\r\n		    if(lenck==false) return false;\r\n	    }\r\n	    catch(e) {}\r\n	    ".toCharArray();
    _jsp_string174 = ",0)+\" !important;'></TD></TR></TABLE>\";                 \r\n	        oCell.appendChild(oDiv);\r\n	        \r\n	        /*============ \u542f\u7528 ============*/\r\n	        oCell = oRow.insertCell(-1);\r\n	        oDiv = document.createElement(\"div\");\r\n	        oDiv.innerHTML=\"<INPUT type='checkbox' ".toCharArray();
    ...
    _jsp_string168 = "'>\";                        \r\n	        oCell.appendChild(oDiv);\r\n	        \r\n	        /*============ \u540d\u79f0 ============*/\r\n	        oCell = oRow.insertCell(-1);\r\n	        oDiv = document.createElement(\"div\");\r\n	        oDiv.innerHTML=\"<INPUT class='Inputstyle' maxlength='80' type='text' name='workPlanTypeName' size='55' value='".toCharArray();
    ...
    _jsp_string166 = "\r\n			var oRow = oTable.insertRow(-1);\r\n	        var oRowIndex = oRow.rowIndex;\r\n\r\n			oRow.className = \"DataDark\";\r\n			/*============ \u9009\u62e9 ============*/\r\n	        var oCell = oRow.insertCell(-1);\r\n	        var oDiv = document.createElement(\"div\");\r\n	        oDiv.innerHTML=\"<INPUT type='checkbox' name='workPlanTypeID' ".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();

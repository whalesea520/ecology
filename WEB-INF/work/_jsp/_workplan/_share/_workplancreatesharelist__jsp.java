...
public class _workplancreatesharelist__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(19792,user.getLanguage())));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                if(planType == Util.getIntValue(RecordSet.getString("workPlanTypeID"), -3)){ 
                out.write(_jsp_string145, 0, _jsp_string145.length);
                } 
                out.write('>');
              ...
              do {
                ...
                out.write('>');
                out.print((SystemEnv.getHtmlLabelNames("2211,15525",user.getLanguage())));
                out.write(_jsp_string156, 0, _jsp_string156.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
      ...
      out.print(( PageIdConst.WP_WorkPlanCreateShareSet));
      ...
      out.print((SystemEnv.getHtmlLabelName(611,user.getLanguage())+(user.getLanguage()==8?" ":"")+SystemEnv.getHtmlLabelName(20190,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workplan/share/WorkPlanCreateShareList.jsp"), 6793568949440791415L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string169 = "\" class=\"e8_btn_cancel\" onclick=\"resetCondtionAVS();\"/>\r\n				<input type=\"button\" value=\"".toCharArray();

...
public class _workplandiscuss__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/meeting/data/MeetingDiscussRd.jsp", "sortid=" + ("")+ "&" + "types=" + ("WP")+ "&" + "currentpage=" + com.caucho.el.Expr.toString(currentpage, null)+ "&" + "from=" + ("list")+ "&" + "sqlstr=" + com.caucho.el.Expr.toString(sqlstr, null), true);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workplan/search/WorkPlanDiscuss.jsp"), -714818009197411758L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string154 = "</option><!-- \u6307\u5b9a\u65e5\u671f\u8303\u56f4 -->\r\n                          	</select>\r\n                          </span>\r\n                          <span id=\"datespan\"  style=\"".toCharArray();

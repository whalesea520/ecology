...
public class _workplandetail__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	String tabType = request.getParameter("tabType"); 
      ...
      out.print(( MouldIDConst.getID("schedule")));
	...
	if(request.getQueryString() != null){
      ...
      out.print((!"2".equals(tabType)?"current":"" ));
      out.write(_jsp_string71, 0, _jsp_string71.length);
      out.print((SystemEnv.getHtmlLabelName(2121, user.getLanguage())));
      out.write(_jsp_string72, 0, _jsp_string72.length);
      out.print(("2".equals(tabType)?"current":"" ));
      out.write(_jsp_string73, 0, _jsp_string73.length);
      out.print((SystemEnv.getHtmlLabelName(15153, user.getLanguage())+(cnt > 0?"("+cnt+")":"")));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workplan/data/WorkPlanDetail.jsp"), -5244360098861697506L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string47 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string87 = "\";\r\n	document.frmmain.submit();\r\n}\r\n\r\n\r\nfunction onViewLog() {\r\n	document.frmmain.action = \"/workplan/log/WorkPlanViewLog.jsp?from=1&workid=".toCharArray();
    ...
    _jsp_string88 = "\";\r\n	document.frmmain.submit();\r\n}\r\n\r\nfunction onEditLog() {\r\n	document.frmmain.action = \"/workplan/log/WorkPlanEditLog.jsp?from=1&workid=".toCharArray();
    _jsp_string1 = "\r\n<!DOCTYPE HTML>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n<html>\r\n<head>\r\n<!-- \r\n\u6dfb\u52a0\u81f3init.css\r\n<style type=\"text/css\">\r\n	html{height:100%;}\r\n</style>\r\n -->\r\n".toCharArray();
    ...
    _jsp_string68 = "\");\r\n				if(\"".toCharArray();
    _jsp_string75 = "\" id=\"tabcontentframe\" name=\"tabcontentframe\" class=\"flowFrame\" frameborder=\"0\" height=\"100%\" width=\"100%;\" onload=\"update()\"></iframe>\r\n	        </div>\r\n	    </div>\r\n	</div> \r\n	<FORM name=\"frmmain\" action=\"/workplan/data/WorkPlanOperation.jsp\" method=\"post\">\r\n	<INPUT type=\"hidden\" name=\"method\" value=\"view\">\r\n	<INPUT type=\"hidden\" name=\"from\" value=\"".toCharArray();

...
public class _listversion__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelNames("19587",user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
          ...
          if (_jspEval9 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print(("T-"+SystemEnv.getHtmlLabelName(309,user.getLanguage())));
      ...
      out.print((Util.getIntValue(request.getParameter("docid"),0)));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/docs/listVersion.jsp"), -630333784817661636L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string48 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string142 = "\r\n			if(dialog){\r\n				openFullWindowForXtable('/docs/docs/DocDspExt.jsp?id=".toCharArray();
    ...
    _jsp_string135 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"onClose();\">\r\n			".toCharArray();
    ...
    _jsp_string143 = "&imagefileId='+fileImageId+'&isFromAccessory=true&versionId='+versionid);\r\n				try{\r\n				//	dialog.callback(returnjson);\r\n				}catch(e){}\r\n				try{\r\n				//	dialog.close(returnjson);\r\n				}catch(e){}\r\n			}else{\r\n			window.parent.returnValue = returnjson;\r\n		  	window.parent.close();\r\n			}\r\n		});\r\n});\r\n\r\n</script>\r\n".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();

...
public class _docsharegetnew__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print(( PageIdConst.DOC_DOCSHARE ));
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setAttributes(attrs );
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                int _jsp_end_20 = _jsp_SplitPageTag_4.doEndTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/docs/DocShareGetNew.jsp"), 8035678688453525029L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string48 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string162 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"parentdialog.closeByHand();\">\r\n				".toCharArray();
    _jsp_string126 = "\r\n	_menuDocument.getElementById(\"rightMenu\").style.visibility=\"hidden\";\r\n	if (!_menuWindow.ActiveXObject) {\r\n		_menuDocument.getElementById(\"rightMenu\").style.display=\"none\";\r\n	}\r\n	".toCharArray();
    _jsp_string158 = "\r\n			".toCharArray();
    _jsp_string76 = "\" onclick=\"javascript:onDelete();\"/>\r\n			".toCharArray();
    ...
    _jsp_string75 = "\" onclick=\"javascript:openDialog();\"/>\r\n			".toCharArray();
    _jsp_string136 = "\"></td>\r\n							".toCharArray();
    ...
    _jsp_string155 = "\" onclick=\"javascript:openDialog();\"/>\r\n							<input type=\"button\" class=\"delbtn\" title=\"".toCharArray();
    ...
    _jsp_string2 = "\r\n\r\n".toCharArray();
    _jsp_string156 = "\" onclick=\"javascript:onDelete();\"/>\r\n						".toCharArray();

...
public class _docbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelNames("30041",user.getLanguage())));
	...
	for(ConditionField conditionField: lsConditionField){
	    ...
	    if (!filedvalue.equals("")) path = CategoryUtil.getCategoryPath(Util.getIntValue(filedvalue));
              ...
              do {
                ...
                _jsp_BrowserTag_3.setName("secCategory");
                ...
                _jsp_BrowserTag_3.setCompleteUrl("/data.jsp?type=categoryBrowser&onlySec=true");
                ...
                _jsp_BrowserTag_3.setBrowserSpanValue(path);
              ...
              do {
                ...
                out.print((createdatname));
                out.write(_jsp_string84, 0, _jsp_string84.length);
                if(filedvalue.equals("6")){
                out.write(_jsp_string85, 0, _jsp_string85.length);
                out.print((searchdatefrom));
                out.write('-');
                out.print((searchdateto));
              ...
              do {
                ...
                _jsp_BrowserTag_5.setName("searchcreater");
                ...
                _jsp_BrowserTag_5.setTemptitle(SystemEnv.getHtmlLabelName(isgoveproj==0?36:20098,user.getLanguage()));
                _jsp_BrowserTag_5.setLanguage(""+user.getLanguage() );
                _jsp_BrowserTag_5.setBrowserSpanValue( Util.toScreen(ResourceComInfo.getResourcename(filedvalue),user.getLanguage())	 );
              ...
              do {
                ...
                _jsp_BrowserTag_6.setName("txtCrmId");
                ...
                _jsp_BrowserTag_6.setBrowserValue(filedvalue);
                _jsp_BrowserTag_6.setIsMustInput(isMustInput);
                _jsp_BrowserTag_6.setTemptitle(SystemEnv.getHtmlLabelName(136,user.getLanguage()));
                _jsp_BrowserTag_6.setLanguage(""+user.getLanguage() );
                _jsp_BrowserTag_6.setBrowserSpanValue( Util.toScreen(CustomerInfoComInfo.getCustomerInfoname(filedvalue),user.getLanguage())	 );
  	...
  	for(int i=0;i<date2duringTokens.length;i++)
  	{
  		...
  		if(tempdate2during>36||tempdate2during<1)
  		{
  			continue;
                ...
                if (Util.getIntValue(filedvalue,0)==tempdate2during) {
                ...
                if (Util.getIntValue(filedvalue,0)==38) {
                out.write(_jsp_string113, 0, _jsp_string113.length);
                }
                out.write('>');
...
//\u663e\u793a\u9690\u85cf\u57df
 ...
 for (Iterator<String> it = key.iterator(); it.hasNext();) {
  ...
  if(fieldname.equals("doccreatedateselect")){
      ...
      int _jspEval74 = _jsp_ViewTag_7.doStartTag();
      if (_jspEval74 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval74 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_7.setBodyContent(_jsp_endTagHack72);
        ...
        do {
          ...
          int _jspEval77 = _jsp_GroupTag_8.doStartTag();
          if (_jspEval77 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval77 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_8.setBodyContent(_jsp_endTagHack75);
      ...
      int _jspEval86 = _jsp_ViewTag_0.doStartTag();
      if (_jspEval86 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval86 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_0.setBodyContent(_jsp_endTagHack84);
          _jsp_ViewTag_0.doInitBody();
        }
        do {
          out.write(_jsp_string53, 0, _jsp_string53.length);
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(15774,user.getLanguage()));
          int _jspEval89 = _jsp_GroupTag_1.doStartTag();
          if (_jspEval89 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval89 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_1.setBodyContent(_jsp_endTagHack87);
              _jsp_GroupTag_1.doInitBody();
            }
            do {
              out.write(_jsp_string75, 0, _jsp_string75.length);
              ...
              do {
                ...
                _jsp_BrowserTag_3.setLinkUrl("#");
                _jsp_BrowserTag_3.setWidth("80%");
                _jsp_BrowserTag_3.setBrowserValue(secCategory);
              ...
              do {
                ...
                _jsp_BrowserTag_5.setCompleteUrl("/data.jsp");
                _jsp_BrowserTag_5.setWidth("80%");
                _jsp_BrowserTag_5.setBrowserValue(searchcreater);
                _jsp_BrowserTag_5.setIsMustInput("1");
                _jsp_BrowserTag_5.setLinkUrl("javascript:openhrm($id$);");
                _jsp_BrowserTag_5.setTemptitle(SystemEnv.getHtmlLabelName(isgoveproj==0?36:20098,user.getLanguage()));
                _jsp_BrowserTag_5.setLanguage(""+user.getLanguage() );
                _jsp_BrowserTag_5.setBrowserSpanValue( Util.toScreen(ResourceComInfo.getResourcename(searchcreater),user.getLanguage())	 );
                _jsp_BrowserTag_5.doTag();
              ...
              do {
                ...
                _jsp_BrowserTag_6.setCompleteUrl("/data.jsp?type=7");
                _jsp_BrowserTag_6.setLinkUrl("#");
                _jsp_BrowserTag_6.setBrowserValue(crmId);
                _jsp_BrowserTag_6.setIsMustInput("1");
                _jsp_BrowserTag_6.setTemptitle(SystemEnv.getHtmlLabelName(136,user.getLanguage()));
                _jsp_BrowserTag_6.setLanguage(""+user.getLanguage() );
                _jsp_BrowserTag_6.setBrowserSpanValue( Util.toScreen(CustomerInfoComInfo.getCustomerInfoname(crmId),user.getLanguage())	 );
                _jsp_BrowserTag_6.doTag();
                out.write(_jsp_string104, 0, _jsp_string104.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
      ...
      int _jspEval154 = _jsp_ViewTag_7.doStartTag();
      if (_jspEval154 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval154 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_7.setBodyContent(_jsp_endTagHack152);
          _jsp_ViewTag_7.doInitBody();
        }
        do {
          out.write(_jsp_string75, 0, _jsp_string75.length);
          ...
          int _jspEval157 = _jsp_GroupTag_8.doStartTag();
          if (_jspEval157 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval157 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_8.setBodyContent(_jsp_endTagHack155);
              _jsp_GroupTag_8.doInitBody();
            }
            do {
              out.write(_jsp_string84, 0, _jsp_string84.length);
              ...
              _jsp_ItemTag_9.setBodyContent(_jsp_endTagHack158);
              _jsp_ItemTag_9.doInitBody();
              do {
                out.write(_jsp_string130, 0, _jsp_string130.length);
                out.print((SystemEnv.getHtmlLabelName(311,user.getLanguage())));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/docs/DocBrowser.jsp"), 7753719123723620837L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string141 = "' onKeyPress=\"ItemNum_KeyPress()\" onBlur='checkcount1(this)'>".toCharArray();
    _jsp_string96 = "\r\n	\r\n\r\n".toCharArray();
    _jsp_string171 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string75 = "\r\n	".toCharArray();
    ...
    _jsp_string92 = "\r\n\r\n		<span class=\"wuiDateSpan\" selectId=\"doccreatedateselect\" selectValue=\"".toCharArray();
    _jsp_string79 = "\r\n	    <span>\r\n	           ".toCharArray();
    ...
    _jsp_string122 = "\">\r\n		    <input   type=\"hidden\" name=\"searchdateto\" value=\"".toCharArray();
    ...
    _jsp_string107 = "\r\n				<input type=\"hidden\" id=date2during name=date2during value=\"".toCharArray();
    ...
    _jsp_string93 = "\" >\r\n		    <input class=wuiDateSel type=\"hidden\" name=\"searchdatefrom\" value=\"".toCharArray();
    _jsp_string81 = "\r\n	\r\n	".toCharArray();
    ...
    _jsp_string83 = "\r\n	   ".toCharArray();
    _jsp_string109 = "\r\n  <select class=inputstyle  size=1 id=date2during name=date2during  ".toCharArray();
    _jsp_string113 = "selected".toCharArray();
    _jsp_string77 = " value='".toCharArray();
    _jsp_string204 = "\");\r\n});\r\n\r\n\r\n</SCRIPT>\r\n</BODY>\r\n</HTML>\r\n".toCharArray();
    ...
    _jsp_string121 = "\r\n\r\n		\r\n		    <input  type=\"hidden\" name=\"searchdatefrom\" value=\"".toCharArray();
    _jsp_string126 = "' >\r\n".toCharArray();
    ...
    _jsp_string94 = "\">\r\n		    <input class=wuiDateSel  type=\"hidden\" name=\"searchdateto\" value=\"".toCharArray();
    ...
    _jsp_string15 = "\\r\\n\\r\\n".toCharArray();
    _jsp_string119 = " onBlur='checkcount1(this)'>".toCharArray();
    ...
    _jsp_string118 = "' onKeyPress=\"ItemNum_KeyPress()\" ".toCharArray();
    _jsp_string127 = "\r\n<!--#################Search Table END//###################### BroswerStyle-->\r\n</div>\r\n<div id=\"dialog\">\r\n	<div id='colShow' ></div>\r\n</div>\r\n\r\n\r\n\r\n<div style=\"width:0px;height:0px;overflow:hidden;\">\r\n	<button accessKey=T id=myfun1   type=button onclick=\"resetCondtion();\"><U>T</U>-".toCharArray();
    ...
    _jsp_string133 = "<input  class=InputStyle  name=searchsubject value='".toCharArray();
    ...
    _jsp_string87 = "\r\n		\r\n	   <input  type=\"hidden\" id=doccreatedateselect name=doccreatedateselect value=\"".toCharArray();
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    ...
    _jsp_string117 = "<input class=InputStyle id=searchid name=searchid value='".toCharArray();
    ...
    _jsp_string125 = "' value='".toCharArray();
    _jsp_string89 = "\">\r\n	   <input class=wuiDateSel  type=\"hidden\" name=\"searchdateto\" value=\"".toCharArray();
    ...
    _jsp_string85 = "\r\n		&nbsp;&nbsp;&nbsp;".toCharArray();
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string76 = "<input  class=InputStyle  name=searchsubject  ".toCharArray();
    _jsp_string176 = ";\r\n	".toCharArray();
    _jsp_string137 = "\r\n	   \r\n	    <span>\r\n           ".toCharArray();
    _jsp_string0 = "\r\n \r\n\r\n\r\n\r\n\r\n".toCharArray();

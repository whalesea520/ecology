...
public class _docadd__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.caucho.jsp.PageContextImpl pageContext = _jsp_application.getJspApplicationContext().allocatePageContext(this, _jsp_application, request, response, "/notice/error.jsp", session, 16384, true, false);
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("doc")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelNames("82,30041",user.getLanguage()) , null)+ "&" + "exceptHeight=" + ("true")+ "&" + "isPersonalDoc=" + com.caucho.el.Expr.toString(isPersonalDoc , null)+ "&" + "docsubject=" + com.caucho.el.Expr.toString(URLEncoder.encode(docsubject,"UTF-8") , null)+ "&" + "_fromURL=" + ("doc")+ "&" + "limitSec=" + com.caucho.el.Expr.toString(Util.null2String(request.getParameter("limitSec")) , null), false);
...
if (isIE_uploader == null || "".equals(isIE_uploader)) {
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/docs/DocAdd.jsp"), -9193591254993655382L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
    ...
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/docs/DocAddScript.jsp"), -6178465111852531302L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
  ...
  static {
    ...
    _jsp_string221 = "&invalidationdate=".toCharArray();
    ...
    _jsp_string208 = ",null,{invalidationdate:\"".toCharArray();
    _jsp_string161 = "\">\r\n<input type=\"hidden\" name=\"doclangurage\" value=".toCharArray();
    _jsp_string71 = "';\r\n   var crmid='".toCharArray();
    _jsp_string216 = "&coworkid=".toCharArray();
    _jsp_string215 = "&prjid=".toCharArray();
    ...
    _jsp_string219 = "&docType=\"+docType+\"&docsubject=\"+encodeURIComponent(encodeURIComponent(weaver.docsubject.value))+\"&from=".toCharArray();
    _jsp_string209 = "\"});\r\n					".toCharArray();
    ...
    _jsp_string218 = "&hrmid=".toCharArray();
    _jsp_string44 = "\r\n<script language=javascript>\r\nubsfirmcode0 = ".toCharArray();
    _jsp_string6 = "\r\n\r\n\r\n<script language=javascript>;\r\ntop.Dialog.alert(\"".toCharArray();
    _jsp_string74 = "';\r\n   var f_weaver_belongto_usertype='".toCharArray();
    _jsp_string158 = "\" name=\"seccategory\" id=\"seccategory\" value=\"".toCharArray();
    ...
    _jsp_string169 = "\" class=\"cornerMenu\"></span>\r\n		</td>\r\n	</tr>\r\n</table>\r\n	".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    ...
    _jsp_string220 = "&userCategory=".toCharArray();
    ...
    _jsp_string205 = "','',divContentHeight-28,\"".toCharArray();
    ...
    _jsp_string214 = "&showsubmit=".toCharArray();
    _jsp_string236 = "){\r\n		checkDocSubject($GetEle(\"docsubject\"),function(){\r\n			if($GetEle(\"namerepeated\").value==1){\r\n				try{\r\n					enableTabBtn();\r\n				}catch(e){alert(e);}\r\n				return;\r\n			}\r\n			afterSaveValidate();\r\n		});\r\n	}else{\r\n		afterSaveValidate();\r\n	}\r\n}\r\n\r\nfunction afterDraftValidate(){\r\n	if(!check_form(document.weaver,getNeedinputitems())){\r\n		onExpandOrCollapse(true);\r\n		onActiveTab(\"divProp\");\r\n		try{\r\n			enableTabBtn();\r\n		}catch(e){}\r\n		return false;\r\n	}\r\n	if(checkSubjectRepeated()&&checkDocMain()){\r\n		var editor_data = ue.getContent();\r\n	    jQuery(\"#doccontent\").val(editor_data);\r\n		document.weaver.docstatus.value=0;\r\n		document.weaver.operation.value='adddraft';\r\n\r\n		try{\r\n			var objSubmit=obj.parentNode.parentNode.parentNode.firstChild.firstChild.firstChild;\r\n			objSubmit.disabled = true ;\r\n\r\n		    var objPreview=obj.parentNode.parentNode.parentNode.firstChild.nextSibling.nextSibling.firstChild.firstChild;\r\n			objPreview.disabled = true ;\r\n		}catch(e){}\r\n		 try{\r\n        	Ext.getCmp(\"divContentTab\").getBottomToolbar().disable();\r\n        }catch(e){}\r\n        obj.disabled = true ;\r\n\r\n        //TD4213 \u589e\u52a0\u63d0\u793a\u4fe1\u606f  \u5f00\u59cb\r\n		var content=\"".toCharArray();
    _jsp_string252 = "\"+fileLenthName+\",".toCharArray();
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    ...
    _jsp_string251 = "M\u7684\u6587\u4ef6,\u5982\u679c\u9700\u8981\u4f20\u9001\u5927\u6587\u4ef6,\u8bf7\u4e0e\u7ba1\u7406\u5458\u8054\u7cfb!\");\r\n        alert(\"".toCharArray();

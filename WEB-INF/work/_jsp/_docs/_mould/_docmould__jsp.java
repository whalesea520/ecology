...
String isEnableExtranetHelp = KtreeHelp.getInstance().isEnableExtranetHelp;
      ...
      out.print((SystemEnv.getHtmlLabelNames("82,16450",user.getLanguage())));
      out.write(_jsp_string76, 0, _jsp_string76.length);
      out.print((SystemEnv.getHtmlLabelNames("93,16450",user.getLanguage())));
      ...
      out.print((xssUtil.put("where operateitem =5")));
      ...
      out.print((xssUtil.put("where int(operateitem) =5")));
      out.write(_jsp_string79, 0, _jsp_string79.length);
      }
...
if(userightmenu!=1){
    ...
    String tableString=""+
      ...
      out.print(( PageIdConst.DOC_VIEWMOULDLIST ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/mould/DocMould.jsp"), -294060579980461499L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string96 = "\" class=\"cornerMenu\"></span>\r\n		</td>\r\n	</tr>\r\n</table>\r\n</form>\r\n\r\n".toCharArray();
    ...
    _jsp_string6 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    _jsp_string93 = "\" class=\"e8_btn_top\" onclick=\"onDelete();\"/>\r\n			".toCharArray();
    ...
    _jsp_string91 = "\" onclick=\"javascript:openDialog()\"/>\r\n			".toCharArray();
    ...
    _jsp_string85 = "\r\n		dialog.Width =jQuery(top.window).width()*0.95;\r\n		dialog.Height = jQuery(top.window).height()*0.95;\r\n		dialog.Drag = true;\r\n		dialog.URL = url;\r\n		dialog.checkDataChange = false;\r\n		dialog.maxiumnable = true;\r\n		dialog.show();\r\n	}\r\n	\r\n	/*\u6807\u7b7e\u6392\u5e8f*/\r\n	function labelOrderDialog(id){\r\n		dialog = new window.top.Dialog();\r\n		dialog.currentWindow = window; \r\n		url = \"/docs/tabs/DocCommonTab.jsp?_fromURL=47&isdialog=1&isWorkflowDoc=".toCharArray();
    _jsp_string4 = "\r\n	<script language=\"javascript\">\r\n		window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string74 = "\",function() {\r\n			var ajaxNum=0;\r\n		   for(var i=0;i<idArr.length;i++){\r\n			   ajaxNum++;\r\n				//\u4ee5ajax\u65b9\u5f0f\u63d0\u4ea4\r\n				jQuery.ajax({\r\n					url:\"UploadDoc.jsp\",\r\n					type:\"post\",\r\n					data:{\r\n						operation:\"delete\",\r\n						id:idArr[i]\r\n					},\r\n					complete:function(xhr,status){\r\n							ajaxNum--;\r\n						if(ajaxNum==0)\r\n							_table.reLoad();\r\n					}\r\n				});\r\n			}\r\n		});\r\n	}\r\n	\r\n	var dialog = null;\r\n	\r\n	function closeDialog(){\r\n		if(dialog)\r\n			dialog.close();\r\n	}\r\n	\r\n	function openDialog(id,doctype){\r\n\r\n\r\n		dialog = new window.top.Dialog();\r\n		dialog.currentWindow = window; \r\n		var url = \"/docs/tabs/DocCommonTab.jsp?_fromURL=20&isdialog=1&isWorkflowDoc=".toCharArray();

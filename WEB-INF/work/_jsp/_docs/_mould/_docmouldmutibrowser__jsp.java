...
public class _docmouldmutibrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(mouldType.equals("3")){
      ...
      out.print((SystemEnv.getHtmlLabelNames(mouldType.equals("3")?"16369":"19369",user.getLanguage())));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/mould/DocMouldMutiBrowser.jsp"), 4732252929798159005L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string138 = "<input class=Inputstyle  name=mouldname value='".toCharArray();

...
public class _docsysdefaults__jsp extends com.caucho.jsp.JavaPage
{
...
String  saved=Util.null2String(request.getParameter("saved"));
      ...
      out.print(((saved.equals("true")?"true":"false")));
...
String docapprovewfid=RecordSet.getString("docapprovewfid");
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(70,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(74,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(209,user.getLanguage())));
              ...
              do {
                ...
                if (fgpicfixtype.equals("1")){
                out.write(_jsp_string144, 0, _jsp_string144.length);
                }
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(33607,user.getLanguage())));
                out.write(_jsp_string145, 0, _jsp_string145.length);
                if (fgpicfixtype.equals("2")){
                out.write(_jsp_string144, 0, _jsp_string144.length);
                }
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(33608,user.getLanguage())));
                out.write(_jsp_string146, 0, _jsp_string146.length);
                if (fgpicfixtype.equals("3")){
                out.write(_jsp_string144, 0, _jsp_string144.length);
                }
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(33609,user.getLanguage())));
                out.write(_jsp_string147, 0, _jsp_string147.length);
                if (fgpicfixtype.equals("4")){
                out.write(_jsp_string144, 0, _jsp_string144.length);
                }
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(33610,user.getLanguage())));
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(33606,user.getLanguage())));
              ...
              do {
                ...
                out.print((Util.toScreenToEdit(fgpicwidth,user.getLanguage())));
                out.write(_jsp_string151, 0, _jsp_string151.length);
                out.print((SystemEnv.getHtmlLabelName(218,user.getLanguage())));
                out.write(_jsp_string149, 0, _jsp_string149.length);
                 }else {
                out.write(_jsp_string152, 0, _jsp_string152.length);
                out.print((Util.toScreen(fgpicwidth,user.getLanguage())));
                out.print((SystemEnv.getHtmlLabelName(218,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/tools/DocSysDefaults.jsp"), 1181068435950270429L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

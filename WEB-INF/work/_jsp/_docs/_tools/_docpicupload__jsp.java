...
public class _docpicupload__jsp extends com.caucho.jsp.JavaPage
{
...
if(HrmUserVarify.checkUserRight("DocPicUploadEdit:Edit", user)){
	canEdit=true;
      ...
      out.print((SystemEnv.getHtmlLabelNames("93,74",user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      }else{
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelNames("367,74",user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      }
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((SystemEnv.getHtmlLabelNames("82,74",user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(33442,user.getLanguage())));
      out.write(_jsp_string73, 0, _jsp_string73.length);
      out.print((xssUtil.put("where operateitem =8")));
...
if(canDelete){
      ...
      out.print(( PageIdConst.DOC_NEWSPICLIST ));
      ...
      if (_jsp_SplitPageTag_0 == null) {
        ...
        _jsp_SplitPageTag_0.setIsShowThumbnail("true");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/tools/DocPicUpload.jsp"), 7981290898908350070L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string148 = "\" onclick=\"javascript:onDelete()\"/>\r\n			".toCharArray();
    ...
    _jsp_string81 = "\";\r\n        dialog.Width = 550 ;\r\n        dialog.Height = 600;\r\n        dialog.Drag = true;\r\n        dialog.show();\r\n    });\r\n\r\n}\r\n</script>\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string146 = "\" onclick=\"javascript:onNew()\"/>\r\n			".toCharArray();
    ...
    _jsp_string149 = "\r\n			<input type=\"hidden\" name=\"imagetype\" id=\"imagetype\" value=\"".toCharArray();

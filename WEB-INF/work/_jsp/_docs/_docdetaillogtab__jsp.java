...
public class _docdetaillogtab__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	if(_fromURL.equals("1")){//\u672a\u9605
      ...
      out.print(( _fromURL.equals("0") ? "current" : "" ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/DocDetailLogTab.jsp"), 4807652641258853759L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string85 = "\" onload=\"update();\" id=\"tabcontentframe\" name=\"tabcontentframe\" class=\"flowFrame\" frameborder=\"0\" height=\"100%\" width=\"100%;\"></iframe>\r\n	        </div>\r\n	    </div>\r\n	</div>     \r\n</body>\r\n</html>\r\n\r\n".toCharArray();
    _jsp_string20 = "\";\r\n	    xmlhttp.open(\"GET\",URL, false);\r\n	    xmlhttp.send(null);\r\n	    var result = xmlhttp.status;\r\n	    if(result==200) {\r\n		    isconn = true;\r\n	    	var response_flag = xmlhttp.responseText;\r\n	    	if(response_flag!='0') {\r\n	    		var flag_msg = '';\r\n	    		if(response_flag=='1') {\r\n	    			var diag = new Dialog();\r\n					diag.Width = 300;\r\n					diag.Height = 180;\r\n					diag.ShowCloseButton=false;\r\n					diag.Title = \"".toCharArray();
    _jsp_string78 = "\r\n			        <li>\r\n			        	<a href=\"/docs/DocDetailLogNoReadNew.jsp?isdialog=".toCharArray();
    ...
    _jsp_string72 = "\">\r\n			        	<a href=\"/docs/DocDetailLogNew.jsp?isdialog=".toCharArray();
    ...
    _jsp_string81 = "\r\n			        	</a>\r\n			        </li>\r\n			         <li>\r\n			        	<a href=\"/docs/DocDetailLogDownloadNew.jsp?isdialog=".toCharArray();
    ...
    _jsp_string38 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string0 = "\r\n\r\n".toCharArray();
    _jsp_string74 = "\" target=\"tabcontentframe\">\r\n			        		".toCharArray();
  }
}

...
import java.net.*;
import com.converter.main.MainConverter;
import com.converter.system.WebappContext;
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	if(fileName.endsWith(".html")||fileName.endsWith(".htm")){
      ...
      out.print(("/weaver/weaver.file.FileDownload?fileid="+imageFileId+"&nolog=1&requestid="+requestid+"&workplanid="+workplanid+"&desrequestid="+desrequestid));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/docpreview/main.jsp"), -3374202422694208746L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string49 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string73 = "\" onload=\"hideLoading();displayRightMenu(this);\"></iframe>\r\n		</body></html>\r\n	\r\n	".toCharArray();
    _jsp_string39 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string44 = "\";\r\n\r\n  if(companyname.length >0 ){\r\n  	window.status = str1+companyname;\r\n  }\r\n</script>\r\n<!-- \u5220\u9664 -->\r\n</head></html>\r\n\r\n<!--USB \u9a8c\u8bc1 -->\r\n".toCharArray();
    _jsp_string69 = "&requestid=".toCharArray();
    ...
    _jsp_string70 = "&desrequestid=".toCharArray();
    _jsp_string6 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    ...
    _jsp_string68 = "&nolog=1&workplanid=".toCharArray();
    _jsp_string26 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string50 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string41 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string67 = "\r\n		 <link rel=\"stylesheet\" href=\"/docs/pdfview/web/viewer.css\"/>\r\n		</head><body style=\"overflow:hidden\">\r\n		<div id=\"imageShow\" class=\"pdfViewer\">\r\n			<div class=\"page\" style=\"width:816px;overflow:auto\">\r\n				<div style=\"padding:80px;\">\r\n					<img style=\"margin:auto;display:block;max-width:100%;cursor:pointer\" src=\"/weaver/weaver.file.FileDownload?fileid=".toCharArray();

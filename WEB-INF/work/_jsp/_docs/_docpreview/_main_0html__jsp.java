...
package _jsp._docs._docpreview;
...
public class _main_0html__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      weaver.docs.docpreview.DocPreviewHtmlManager DocPreviewHtmlManager;
      DocPreviewHtmlManager = (weaver.docs.docpreview.DocPreviewHtmlManager) pageContext.getAttribute("DocPreviewHtmlManager");
      if (DocPreviewHtmlManager == null) {
        DocPreviewHtmlManager = new weaver.docs.docpreview.DocPreviewHtmlManager();
        pageContext.setAttribute("DocPreviewHtmlManager", DocPreviewHtmlManager);
      }
...
try{
	...
	try{
      ...
      out.print(("/docs/pdfview/web/pdfPrintViewer.jsp?imagefilename="+URLEncoder.encode(imagefilename,"utf-8")+"&canPrint="+canPrint+"&canDownload="+canDownload+"&pdfimagefileid="+htmlFileId +"&requestid="+requestid+formmodeparamsStr));
      out.write(_jsp_string72, 0, _jsp_string72.length);
      out.print(("/docs/pdfview/web/pdfViewer.jsp?imagefilename="+URLEncoder.encode(imagefilename,"utf-8")+"&canPrint="+canPrint+"&canDownload="+canDownload+"&pdfimagefileid="+htmlFileId +"&requestid="+requestid+formmodeparamsStr));
      ...
      out.print(("/weaver/weaver.file.FileDownload?fileid="+htmlFileId+"&requestid="+requestid+"&desrequestid="+desrequestid+formmodeparamsStr));
      ...
      out.print(("&requestid="+requestid+"&desrequestid="+desrequestid));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/docpreview/main_html.jsp"), -8099593067349151607L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string76 = "\r\n				<iframe id=\"htmlShowContent\" frameborder=\"0\" style=\"width:100%;height:100%;\" src=\"".toCharArray();
    _jsp_string75 = "\r\n		\"></iframe>	\r\n		".toCharArray();
    _jsp_string26 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string77 = "\" onload=\"hideLoading();displayRightMenu(this);\r\n				 ".toCharArray();
    _jsp_string3 = "\r\n<!DOCTYPE HTML>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n<html>\r\n<head>\r\n<!-- \r\n\u6dfb\u52a0\u81f3init.css\r\n<style type=\"text/css\">\r\n	html{height:100%;}\r\n</style>\r\n -->\r\n".toCharArray();
    ...
    _jsp_string73 = "\" onload=\"hideLoading();displayRightMenu(this);\r\n			".toCharArray();
    ...
    _jsp_string50 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string41 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string72 = "\");\r\n			</script>\r\n			<iframe id=\"htmlShowContent\" frameborder=\"0\" onselectstart=\"return false;\" unselectable=\"on\" style=\"width:100%;height:100%;\" src=\"".toCharArray();
    ...
    _jsp_string71 = "\r\n			<script type=\"text/javascript\">\r\n				window.__printvar=encodeURI(\"".toCharArray();
    _jsp_string40 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();
  }
}

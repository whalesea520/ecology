...
public class _docmoulddspext__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	boolean  RMMode=("true".equals(BaseBean.getPropValue("weaver_obj","RMMode")))?true:false;
      ...
      out.print((Util.null2String(request.getParameter("state"))));
      out.write(_jsp_string67, 0, _jsp_string67.length);
      out.print((SystemEnv.getHtmlLabelName(21799,user.getLanguage())));
...
if(isSysadmin>0) {  //\u7528\u7cfb\u7edf\u7ba1\u7406\u5458sysadmin\u767b\u9646\u7cfb\u7edf\u53ef\u67e5\u770b\u9875\u9762\u5730\u5740
	...
	defaultMenuCount++;
      ...
      out.print((SystemEnv.getErrorMsgName(messageid,user.getLanguage())));
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jsp_ItemTag_3.setAttributes("{'colspan':'full','samePair':'imgfield','display':'none'}");
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(18693,user.getLanguage())));
                out.write(_jsp_string101, 0, _jsp_string101.length);
              } while (_jsp_ItemTag_3.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_3.doEndTag();
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((canNotDelete));
      out.write(_jsp_string181, 0, _jsp_string181.length);
      out.print((SystemEnv.getHtmlLabelName(23134,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/mouldfile/DocMouldDspExt.jsp"), 2166402196336161478L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string159 = "\r\n							".toCharArray();
    _jsp_string134 = "visible".toCharArray();
    ...
    _jsp_string67 = "\";\r\nif(canDelete==\"nodelete\")top.Dialog.alert(\"".toCharArray();
    _jsp_string102 = "\r\n		\r\n		".toCharArray();
    _jsp_string112 = "</textarea>\r\n</FORM>\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string177 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.close();\">\r\n				".toCharArray();
    ...
    _jsp_string65 = "\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string116 = ">1 ? Math.ceil(bodyWidth/".toCharArray();
    ...
    _jsp_string97 = "\">\r\n".toCharArray();
    _jsp_string124 = " oncontextmenu='return false'".toCharArray();
    ...
    _jsp_string107 = "\" codebase=\"".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string130 = "px\" height=\"".toCharArray();
    ...
    _jsp_string135 = ";display:none;\" align=\"left\"  allowtransparency=\"true\" style=\"background-color:transparent\" >\r\n	</div>\r\n	<div id=\"divRightMenuIframe\" name=\"divRightMenuIframe\" style=\"display:none\">\r\n		<iframe id=\"rightMenuIframe\" name=\"rightMenuIframe\" frameborder=0 marginheight=0 marginwidth=0 hspace=0 vspace=0 scrolling=no width=\"".toCharArray();
    ...
    _jsp_string133 = "hidden".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    ...
    _jsp_string111 = "\">\r\n<textarea id=\"mouldtext\" name=mouldtext style=\"display:none;width:100%;height=500px\">##".toCharArray();
    ...
    _jsp_string110 = "\">\r\n<input type=hidden name=mouldname value=\"".toCharArray();

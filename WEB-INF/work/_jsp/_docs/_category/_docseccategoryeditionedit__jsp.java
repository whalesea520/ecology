...
public class _docseccategoryeditionedit__jsp extends com.caucho.jsp.JavaPage
{
...
if(RecordSet.next()){
	...
	isNotDelHisAtt = Util.getIntValue(Util.null2String(RecordSet.getString("isNotDelHisAtt")),0);
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(33114,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(19450,user.getLanguage())));
              ...
              do {
                ...
                out.print(((currEditionIsOpen==1)?"checked":""));
                out.write(' ');
                if(!canEdit){
			...
			String attrs = "{'isTableList':'true','samePair':'setting','display':'"+(currEditionIsOpen==1?"":"none")+"'}";
              ...
              _jsp_ItemTag_3.setAttributes(attrs );
                    ...
                    if (_jspEval22 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      ...
                      do {
                        ...
                        do {
                          ...
                          out.print((SystemEnv.getHtmlLabelName(583,user.getLanguage())));
                        ...
                        _jsp_ItemTag_6.doInitBody();
                        do {
                          out.print((SystemEnv.getHtmlLabelName(19528,user.getLanguage())));
                        } while (_jsp_ItemTag_6.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
                        out = pageContext.popBody();
                        _jsp_ItemTag_6.doEndTag();
                        ...
                        do {
                          ...
                          out.print(((currReaderCanViewHistoryEdition==1)?"checked":""));
                          out.write(' ');
                          if(!canEdit){
                          out.write(_jsp_string145, 0, _jsp_string145.length);
                          }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/category/DocSecCategoryEditionEdit.jsp"), 1260977289357848078L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string145 = "disabled".toCharArray();
    ...
    _jsp_string151 = "<input class=InputStyle tzCheckbox=\"true\" type=checkbox value=1 name=\"readerCanViewHistoryEdition\" ".toCharArray();
    ...
    _jsp_string144 = "<input onclick=\"toggleSetting(this);\" class=InputStyle tzCheckbox=\"true\" type=checkbox value=1 name=editionIsOpen ".toCharArray();
    ...
    _jsp_string72 = "\";\r\n        dialog.Width = 550 ;\r\n        dialog.Height = 600;\r\n        dialog.Drag = true;\r\n        dialog.show();\r\n    });\r\n\r\n}\r\n</script>\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string150 = "' name=\"editionPrefix\" ".toCharArray();
    _jsp_string48 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string118 = "\r\n		<script type=\"text/javascript\">\r\n\r\n			jQuery(\"#divTopMenu\").hide();\r\n			jQuery(\"#rightMenu\",_menuDocument).hide();\r\n		\r\n		</script>\r\n		".toCharArray();
    _jsp_string95 = "hidden".toCharArray();
    _jsp_string39 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string149 = "<input class=InputStyle type=\"text\" value='".toCharArray();

...
public class _doctreedocfieldleft__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print(("field_"+DocTreeDocFieldConstant.TREE_DOC_FIELD_ROOT_ID));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/category/DocTreeDocFieldLeft.jsp"), -8220538180298381161L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string51 = "\r\n							".toCharArray();
    _jsp_string25 = "visible".toCharArray();
    ...
    _jsp_string7 = ">1 ? Math.ceil(bodyWidth/".toCharArray();
    ...
    _jsp_string15 = " oncontextmenu='return false'".toCharArray();
    ...
    _jsp_string27 = "px\">\r\n		</iframe>\r\n	</div>\r\n".toCharArray();
    _jsp_string21 = "px\" height=\"".toCharArray();
    ...
    _jsp_string26 = ";display:none;\" align=\"left\"  allowtransparency=\"true\" style=\"background-color:transparent\" >\r\n	</div>\r\n	<div id=\"divRightMenuIframe\" name=\"divRightMenuIframe\" style=\"display:none\">\r\n		<iframe id=\"rightMenuIframe\" name=\"rightMenuIframe\" frameborder=0 marginheight=0 marginwidth=0 hspace=0 vspace=0 scrolling=no width=\"".toCharArray();
    ...
    _jsp_string24 = "hidden".toCharArray();

...
public class _docmaincategorylist__jsp extends com.caucho.jsp.JavaPage
{
...
boolean isUseDocManageDetach=ManageDetachComInfo.isUseDocManageDetach();
      ...
      out.print((SystemEnv.getHtmlLabelNames("26473,32452",user.getLanguage())));
      out.write(_jsp_string75, 0, _jsp_string75.length);
      out.print((SystemEnv.getHtmlLabelNames("82,32452",user.getLanguage())));
      ...
      out.print((xssUtil.put("where operateitem=3 and relatedid=")));
...
if(userightmenu!=1){
	...
	String tableString=""+
      ...
      out.print(( PageIdConst.DOC_MAINCATEGORYLIST ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/category/DocMainCategoryList.jsp"), 3228401230368170998L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string158 = "\"></input>\r\n				<input type=button class=\"e8_btn_top\" onclick=\"onExportExcel();\" value=\"".toCharArray();
    ...
    _jsp_string157 = "\r\n				<input type=button class=\"e8_btn_top\" onclick=\"onImportExcel();\" value=\"Excel".toCharArray();
    _jsp_string0 = "\r\n \r\n\r\n".toCharArray();
    ...
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string80 = "\";\r\n	dialog.Width = jQuery(window).width();\r\n	dialog.Height = 472;\r\n	dialog.Drag = true;\r\n	dialog.maxiumnable = true;\r\n	dialog.checkDataChange = false;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n}\r\n\r\nfunction onLog(id){\r\n	dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	var url = \"/docs/tabs/DocCommonTab.jsp?_fromURL=3&isdialog=1&secid=65&sqlwhere=".toCharArray();
    ...
    _jsp_string163 = " \r\n<script type=\"text/javascript\">\r\nfunction onImportExcel(){\r\n	var url = \"/docs/tabs/DocCommonTab.jsp?_fromURL=100&isdialog=1&subcompanyid=".toCharArray();

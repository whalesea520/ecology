...
public class _multicategorymbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
   ...
   // out.println(tree.treeCategories);
      ...
      out.print((SystemEnv.getHtmlLabelNames("16398",user.getLanguage())));
	...
	defaultMenuCount++;
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(32452,user.getLanguage()) );
      ...
      out.print(( tree.getTreeCategories().toString()));
      out.write(_jsp_string84, 0, _jsp_string84.length);
      out.print((categoryname.equals("")?false:true));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      int _jspEval30 = _jsp_ViewTag_5.doStartTag();
      if (_jspEval30 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval30 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_5.setBodyContent(_jsp_endTagHack28);
        ...
        do {
          ...
          int _jspEval33 = _jsp_GroupTag_6.doStartTag();
          if (_jspEval33 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval33 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_6.setBodyContent(_jsp_endTagHack31);
            ...
            do {
              ...
              _jsp_ItemTag_7.setBodyContent(_jsp_endTagHack34);
              _jsp_ItemTag_7.doInitBody();
              do {
                out.write(_jsp_string152, 0, _jsp_string152.length);
                out.print(("2-"+SystemEnv.getHtmlLabelName(826,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/category/MultiCategoryMBrowser.jsp"), -3261479311324326693L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string89 = "\r\n<BUTTON type=\"button\" class=btn accessKey=2 onclick=\"clearCategory()\" id=btnclear><U></U>".toCharArray();
    ...
    _jsp_string77 = "<input type=\"text\" class=\"InputStyle\" name=\"categoryname\" id=\"categoryname\" value='".toCharArray();
    ...
    _jsp_string87 = "\r\n<BUTTON type=\"button\" class=btn accessKey=1 onclick=\"onClose()\"><U>1</U>-".toCharArray();
    ...
    _jsp_string84 = ";\r\n	var expandAllFlag = ".toCharArray();
    _jsp_string152 = "\r\n				<input type=\"button\" accessKey=0  id=btnclear value=\"".toCharArray();
    ...
    _jsp_string79 = "\r\n				<button _show=\"true\" type=\"button\" class=\"e8_btn_top\" id=\"allcheckbtn\" name=\"allcheckbtn\" onclick=\"setZtreeCheckbox(this);\">".toCharArray();
    _jsp_string153 = "\" id=\"zd_btn_submit\" class=\"zd_btn_submit\" onclick=\"onOk();\">\r\n		    	<input type=\"button\" accessKey=2  id=btnclear value=\"".toCharArray();
    ...
    _jsp_string154 = "\" id=\"zd_btn_submit\" class=\"zd_btn_submit\" onclick=\"clearCategory();\">\r\n		    	<input type=\"button\" accessKey=T  id=btncancel value=\"".toCharArray();

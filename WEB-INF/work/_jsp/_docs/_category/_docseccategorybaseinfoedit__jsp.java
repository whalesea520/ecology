...
public class _docseccategorybaseinfoedit__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.general.KnowledgeTransMethod km;
      km = (weaver.general.KnowledgeTransMethod) pageContext.getAttribute("km");
      if (km == null) {
        km = new weaver.general.KnowledgeTransMethod();
        pageContext.setAttribute("km", km);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
	...
	subcompanyid = Util.getIntValue(RecordSet.getString("subcompanyid"));
      ...
      out.print((Util.getIntValue(parentId,0)));
      out.write(',');
      out.print((Util.getIntValue(parentId,0)));
      ...
      out.print((SystemEnv.getHtmlLabelName(19468,user.getLanguage())));
...
if(isSysadmin>0) {  //\u7528\u7cfb\u7edf\u7ba1\u7406\u5458sysadmin\u767b\u9646\u7cfb\u7edf\u53ef\u67e5\u770b\u9875\u9762\u5730\u5740
	...
	defaultMenuCount++;
      ...
      out.print((SystemEnv.getHtmlLabelName(61,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(2112,user.getLanguage()) ));
      out.write(_jsp_string101, 0, _jsp_string101.length);
      out.print((SystemEnv.getHtmlLabelName(32384,user.getLanguage()) ));
      ...
      out.print((SystemEnv.getHtmlLabelName(20518,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(34243, user.getLanguage())));
      out.write(_jsp_string113, 0, _jsp_string113.length);
      } 
...
if(messageid !=0) {
 if(messageid==87){
      ...
      out.print((SystemEnv.getHtmlLabelName(21536,user.getLanguage())));
...
RCMenuHeight += RCMenuHeightStep ;
	...
	RCMenuHeight += RCMenuHeightStep ;
      ...
      pageContext.include("DocSecCategoryBaseInfoEdit_inner.jsp", "canEdit_str=" + com.caucho.el.Expr.toString(canEdit , null)+ "&" + "id=" + com.caucho.el.Expr.toString(id , null)+ "&" + "hasSecManageRight_str=" + com.caucho.el.Expr.toString(hasSecManageRight , null)+ "&" + "parentId=" + com.caucho.el.Expr.toString(parentId , null)+ "&" + "parentName=" + com.caucho.el.Expr.toString(java.net.URLEncoder.encode(parentName, "UTF-8") , null)+ "&" + "dirid=" + com.caucho.el.Expr.toString(dirid , null)+ "&" + "dirtype=" + com.caucho.el.Expr.toString(dirtype , null)+ "&" + "subcategoryid=" + com.caucho.el.Expr.toString(subcategoryid , null)+ "&" + "categoryname=" + com.caucho.el.Expr.toString(java.net.URLEncoder.encode(categoryname, "UTF-8") , null)+ "&" + "uploadExt=" + com.caucho.el.Expr.toString(uploadExt , null)+ "&" + "coder=" + com.caucho.el.Expr.toString(coder , null)+ "&" + "noRepeatedName=" + com.caucho.el.Expr.toString(noRepeatedName , null)+ "&" + "detachable=" + com.caucho.el.Expr.toString(detachable , null)+ "&" + "isDialog=" + com.caucho.el.Expr.toString(isDialog , null)+ "&" + "isControledByDir=" + com.caucho.el.Expr.toString(isControledByDir , null)+ "&" + "secorder=" + com.caucho.el.Expr.toString(secorder+"" , null)+ "&" + "publishable=" + com.caucho.el.Expr.toString(publishable , null)+ "&" + "defaultDummyCata=" + com.caucho.el.Expr.toString(defaultDummyCata , null)+ "&" + "ischeck=" + com.caucho.el.Expr.toString(ischeck , null)+ "&" + "PCreaterManager=" + com.caucho.el.Expr.toString(PCreaterManager , null)+ "&" + "PCreaterSubCompLS=" + com.caucho.el.Expr.toString(PCreaterSubCompLS , null)+ "&" + "isSetShare=" + com.caucho.el.Expr.toString(isSetShare , null)+ "&" + "defaultLockedDoc=" + com.caucho.el.Expr.toString(defaultLockedDoc , null)+ "&" + "noDownload=" + com.caucho.el.Expr.toString(noDownload , null)+ "&" + "maxOfficeDocFileSize=" + com.caucho.el.Expr.toString(maxOfficeDocFileSize , null)+ "&" + "maxUploadFileSize=" + com.caucho.el.Expr.toString(maxUploadFileSize , null)+ "&" + "pubOperation=" + com.caucho.el.Expr.toString(pubOperation , null)+ "&" + "pushOperation=" + com.caucho.el.Expr.toString(pushOperation , null)+ "&" + "pushways=" + com.caucho.el.Expr.toString(pushways , null)+ "&" + "orderable=" + com.caucho.el.Expr.toString(orderable , null)+ "&" + "markable=" + com.caucho.el.Expr.toString(markable , null)+ "&" + "markAnonymity=" + com.caucho.el.Expr.toString(markAnonymity , null)+ "&" + "childDocReadRemind=" + com.caucho.el.Expr.toString(childDocReadRemind , null)+ "&" + "relationable=" + com.caucho.el.Expr.toString(relationable , null)+ "&" + "hashrmres=" + com.caucho.el.Expr.toString(hashrmres , null)+ "&" + "hascrm=" + com.caucho.el.Expr.toString(hascrm , null)+ "&" + "readOpterCanPrint=" + com.caucho.el.Expr.toString(readOpterCanPrint , null)+ "&" + "replyable=" + com.caucho.el.Expr.toString(replyable , null)+ "&" + "appointedWorkflowId=" + com.caucho.el.Expr.toString(appointedWorkflowId , null)+ "&" + "allownModiMShareL=" + com.caucho.el.Expr.toString(allownModiMShareL , null)+ "&" + "shareable=" + com.caucho.el.Expr.toString(shareable , null)+ "&" + "bacthDownload=" + com.caucho.el.Expr.toString(bacthDownload , null)+ "&" + "isOpenAttachment=" + com.caucho.el.Expr.toString(isOpenAttachment , null)+ "&" + "isAutoExtendInfo=" + com.caucho.el.Expr.toString(isAutoExtendInfo , null)+ "&" + "isPrintControl=" + com.caucho.el.Expr.toString(isPrintControl , null)+ "&" + "printApplyWorkflowId=" + com.caucho.el.Expr.toString(printApplyWorkflowId , null)+ "&" + "logviewtype=" + com.caucho.el.Expr.toString(logviewtype , null)+ "&" + "isLogControl=" + com.caucho.el.Expr.toString(isLogControl , null)+ "&" + "isUseFTPOfSystem=" + com.caucho.el.Expr.toString(isUseFTPOfSystem , null)+ "&" + "hasasset=" + com.caucho.el.Expr.toString(hasasset , null)+ "&" + "assetlabel=" + com.caucho.el.Expr.toString(assetlabel , null)+ "&" + "hrmreslabel=" + com.caucho.el.Expr.toString(hrmreslabel , null)+ "&" + "hasproject=" + com.caucho.el.Expr.toString(hasproject , null)+ "&" + "crmlabel=" + com.caucho.el.Expr.toString(crmlabel , null)+ "&" + "projectlabel=" + com.caucho.el.Expr.toString(projectlabel , null)+ "&" + "approvewfid=" + com.caucho.el.Expr.toString(approvewfid , null)+ "&" + "PCreater=" + com.caucho.el.Expr.toString(PCreater , null)+ "&" + "PCreaterSubComp=" + com.caucho.el.Expr.toString(PCreaterSubComp , null)+ "&" + "PCreaterDepart=" + com.caucho.el.Expr.toString(PCreaterDepart , null)+ "&" + "PCreaterDepartLS=" + com.caucho.el.Expr.toString(PCreaterDepartLS , null)+ "&" + "PCreaterW=" + com.caucho.el.Expr.toString(PCreaterW , null)+ "&" + "PCreaterManagerW=" + com.caucho.el.Expr.toString(PCreaterManagerW , null)+ "&" + "subcompanyid=" + com.caucho.el.Expr.toString(subcompanyid , null)+ "&" + "appliedTemplateName=" + com.caucho.el.Expr.toString(appliedTemplateName , null)+ "&" + "operatelevel=" + com.caucho.el.Expr.toString(operatelevel , null)+ "&" + "appliedTemplateId=" + com.caucho.el.Expr.toString(appliedTemplateId , null)+ "&" + "software=" + com.caucho.el.Expr.toString(software , null), false);
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelNames("82,32520",user.getLanguage())));
      ...
      out.print((Util.getIntValue(parentId,0)));
      out.write(',');
      out.print((reftree.equals("1")?true:false));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/category/DocSecCategoryBaseInfoEdit.jsp"), -7033914262576845283L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string201 = "\";\r\n	dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window; \r\n	dialog.Title = \"Excel".toCharArray();
    _jsp_string162 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string230 = "\r\n	".toCharArray();
    ...
    _jsp_string203 = "\";\r\n	dialog.Width = 360;\r\n	dialog.Height = 120;\r\n	dialog.normalDialog=false;\r\n	dialog.Drag = true;\r\n	dialog.OKEvent = function(){\r\n		if(dialog.innerFrame.contentWindow.document.getElementById('isinclude').checked){\r\n			window.location.href=\"/docs/category/SecCategoryExportProcess.jsp?ids=\"+".toCharArray();
    _jsp_string111 = "\r\n				<input type=button class=\"e8_btn_top\" onclick=\"onSave(".toCharArray();
    _jsp_string116 = "\r\n					<input type=button class=\"e8_btn_top\" onclick=\"onImport();\" value=\"".toCharArray();
    ...
    _jsp_string115 = "\" class=\"e8_btn_top\" onclick=\"onSave(1);\">\r\n				".toCharArray();
    ...
    _jsp_string121 = "\" class=\"cornerMenu\"></span>\r\n		</td>\r\n	</tr>\r\n</table>\r\n</form>\r\n\r\n<script type=\"text/javascript\">\r\n".toCharArray();
    ...
    _jsp_string86 = "\");\r\n		parent.jQuery(\"#objName\").size() > 0 ? parent.jQuery(\"#objName\").html(\"".toCharArray();
    ...
    _jsp_string180 = "\r\n							".toCharArray();
    _jsp_string232 = "\r\n</BODY></HTML>\r\n".toCharArray();
    _jsp_string155 = "visible".toCharArray();
    ...
    _jsp_string77 = "\r\n		//parentWin.location.href=\"/docs/category/DocSecCategoryBaseInfoEdit.jsp?refresh=1&id=".toCharArray();
    ...
    _jsp_string229 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"parentDialog.closeByHand();\">\r\n			".toCharArray();
    ...
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    _jsp_string83 = "&from=secedit&isdialog=1&id=\"+id;\r\n	dialog.Title = \"".toCharArray();
    ...
    _jsp_string124 = "\r\ntop.Dialog.alert(\"".toCharArray();
    _jsp_string196 = "\",function(){\r\n				window.location=\"/docs/category/DocSecCategorySaveAsTmplOperation.jsp?isdialog=".toCharArray();
    ...
    _jsp_string131 = "\">\r\n".toCharArray();
    _jsp_string145 = " oncontextmenu='return false'".toCharArray();
    ...
    _jsp_string79 = "\";\r\n	".toCharArray();
    _jsp_string214 = "\";\r\n	dialog.Width = 650;\r\n	dialog.Height = 360;\r\n	dialog.Drag = true;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n}\r\nfunction onLog(){\r\n	dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	var url = \"/docs/tabs/DocCommonTab.jsp?_fromURL=3&secid=66&sqlwhere=".toCharArray();
    _jsp_string97 = "\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string157 = "px\">\r\n		</iframe>\r\n	</div>\r\n".toCharArray();
    _jsp_string87 = "\") : parent.setTabObjName(\"".toCharArray();
    _jsp_string31 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string94 = "\";\r\n	var fav_querystring = \"".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string151 = "px\" height=\"".toCharArray();
    _jsp_string197 = "&secCategoryId=".toCharArray();
    ...
    _jsp_string198 = "&tmplId=\"+data.id+\"&method=getsettingfromtmpl\"\r\n			});\r\n		\r\n		}else{\r\n			$GetEle(\"dirmouldid\").value=\"\";\r\n			$GetEle(\"dirmouldidspan\").innerHTML=\"\";\r\n		}\r\n	}\r\n}\r\nfunction onSaveAsTmpl(obj){\r\n	//window.parent.location=\"DocSecCategorySaveAsTmpl.jsp?id=".toCharArray();
    _jsp_string210 = "&mainid=".toCharArray();
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    _jsp_string47 = "\";\r\nusblanguage = \"".toCharArray();
    _jsp_string212 = "&isdialog=1&id=".toCharArray();
    ...
    _jsp_string118 = "\r\n				<input type=button class=\"e8_btn_top\" onclick=\"openDialog2(".toCharArray();
    ...
    _jsp_string78 = "\";\r\n		parentWin.parent.location.href=\"/docs/category/DocCategoryTab.jsp?_fromURL=3&refresh=1&reftree=1&id=".toCharArray();
    _jsp_string75 = ",true);\r\n		//parentWin.location.href=\"/docs/category/DocSubCategoryBaseInfoEdit.jsp?id=".toCharArray();
    _jsp_string228 = "\r\n		    	\r\n		    	<input type=\"button\" value=\"".toCharArray();
    _jsp_string126 = "\r\n	top.Dialog.alert(\"".toCharArray();
    _jsp_string208 = "\r\n			}else{\r\n				try{\r\n					parent.enableTabBtn();\r\n				}catch(e){}\r\n			}\r\n		".toCharArray();
    _jsp_string224 = "\r\n     if(window.top.Dialog){\r\n         diag_vote = new window.top.Dialog();\r\n     } else {\r\n         diag_vote = new Dialog();\r\n     }\r\n     diag_vote.currentWindow = window;\r\n     diag_vote.Width = 800;\r\n     diag_vote.Height = 500;\r\n     diag_vote.Modal = true;\r\n     diag_vote.Title = \"\u8bbe\u7f6e\";\r\n     diag_vote.URL = \"/docs/remindfornew/commonTab.jsp?urlType=1&secid=".toCharArray();
    ...
    _jsp_string154 = "hidden".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    ...
    _jsp_string73 = ",true);\r\n		parentWin._table.reLoad();\r\n	".toCharArray();
    _jsp_string112 = ");\" value=\"".toCharArray();
    _jsp_string58 = "\r\n<meta http-equiv=\"".toCharArray();
    _jsp_string200 = ");\r\n}\r\nfunction onImportExcel(){\r\n	var url = \"/docs/tabs/DocCommonTab.jsp?_fromURL=100&isdialog=1&categoryid=".toCharArray();
    ...
    _jsp_string211 = "\";\r\n	dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	var url = \"/docs/tabs/DocCommonTab.jsp?_fromURL=8&from=subedit&OriSubId=".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();

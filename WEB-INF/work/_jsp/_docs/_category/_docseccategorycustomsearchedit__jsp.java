...
public class _docseccategorycustomsearchedit__jsp extends com.caucho.jsp.JavaPage
{
	...
	if(RecordSet.next()){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print(((useCustomSearch==1)?"checked":""));
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(20237,user.getLanguage())+SystemEnv.getHtmlLabelName(68, user.getLanguage()));
      ...
      out.print((SystemEnv.getHtmlLabelName(83400,user.getLanguage())));
      out.write(_jsp_string89, 0, _jsp_string89.length);
      out.print((SystemEnv.getHtmlLabelName(83401,user.getLanguage())));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/category/DocSecCategoryCustomSearchEdit.jsp"), 3913792275722691470L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string83 = "<input class=InputStyle type=checkbox value=1 name=useCustomSearch ".toCharArray();

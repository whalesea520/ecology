...
public class _docseccategorydirrightedit__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      weaver.docs.category.MainCategoryManager MainCategoryManager;
      MainCategoryManager = (weaver.docs.category.MainCategoryManager) pageContext.getAttribute("MainCategoryManager");
      if (MainCategoryManager == null) {
        MainCategoryManager = new weaver.docs.category.MainCategoryManager();
        pageContext.setAttribute("MainCategoryManager", MainCategoryManager);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.docs.category.SubCategoryManager SubCategoryManager;
      SubCategoryManager = (weaver.docs.category.SubCategoryManager) pageContext.getAttribute("SubCategoryManager");
      if (SubCategoryManager == null) {
        SubCategoryManager = new weaver.docs.category.SubCategoryManager();
        pageContext.setAttribute("SubCategoryManager", SubCategoryManager);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
if(canEdit){
	...
	RCMenuHeight += RCMenuHeightStep ;
      ...
      out.print(( PageIdConst.DOC_MAINCATEGORRIGHT ));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/category/DocSecCategoryDirRightEdit.jsp"), -8717661265598463080L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string80 = "\r\n<table id=\"topTitle\" cellpadding=\"0\" cellspacing=\"0\">\r\n	<tr>\r\n		<td>\r\n		</td>\r\n		<td class=\"rightSearchSpan\" style=\"text-align:right;\">\r\n			<input type=button class=\"e8_btn_top\"  id=\"newRight\" onclick=\"openDialog();\" value=\"".toCharArray();
    ...
    _jsp_string101 = "&method=delete&mainids=\"+mainids+\"&categoryid=".toCharArray();
    _jsp_string91 = "\r\n<FORM id=weaver name=frmMain action=\"UploadFile.jsp\" method=post enctype=\"multipart/form-data\">\r\n<DIV>\r\n\r\n		\r\n<!--\r\n\u4f20\u5165\u53c2\u6570\uff1a\r\nlabels \u8981\u663e\u793a\u7684\u63d0\u793a\r\nuser \u7528\u6237\r\nid \u76ee\u5f55id\r\ncategoryname \u76ee\u5f55\u540d\u79f0\r\ncategorytype \u76ee\u5f55\u7c7b\u578b\r\noperationcode \u64cd\u4f5c\u7c7b\u578b\r\ncanEdit \u662f\u5426\u53ef\u4ee5\u7f16\u8f91\r\nam \u5b89\u5168\u7ba1\u7406\u5668\r\nRecordSet\r\nDepartmentComInfo\r\nResourceComInfo\r\nCustomerTypeComInfo\r\nRolesComInfo\r\n-->\r\n\r\n".toCharArray();
    _jsp_string100 = "&operationcode=".toCharArray();
    ...
    _jsp_string172 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"parentWin.closeDialog();\">\r\n				".toCharArray();
    ...
    _jsp_string103 = "&\";\r\n    });\r\n}\r\n</script>\r\n\r\n\r\n<input type=hidden name=\"operation\">\r\n</DIV>\r\n\r\n<script>\r\nfunction onSave(){\r\n	window.location = \"DocSecCategoryEdit.jsp?id=".toCharArray();
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    ...
    _jsp_string53 = "\r\n".toCharArray();
    _jsp_string102 = "&categorytype=".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string81 = "\"></input>\r\n			<input type=button class=\"e8_btn_top\" id=\"delRight\" onclick=\"onPermissionDelShare".toCharArray();

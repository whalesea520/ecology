...
public class _doctreedocfieldright__jsp extends com.caucho.jsp.JavaPage
{
...
String optype = Util.null2String(request.getParameter("optype"));
      ...
      out.print(( !treeDocFieldName.equals("")?treeDocFieldName:SystemEnv.getHtmlLabelName(20482,user.getLanguage()) ));
      ...
      out.print((treeDocFieldId));
      out.write(_jsp_string71, 0, _jsp_string71.length);
      out.print((SystemEnv.getHtmlLabelNames("93,32520",user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((DocTreeDocFieldConstant.TREE_DOC_FIELD_ROOT_ID ));
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
            ...
            do {
              ...
              do {
                ...
                if (_jsp_RequiredTag_3 == null) {
                  ...
                  _jsp_RequiredTag_3.setId("treeDocFieldNameImage");
                  _jsp_RequiredTag_3.setRequired(new java.lang.Boolean(true));
                }

                _jsp_RequiredTag_3.setValue(treeDocFieldName);
          ...
          _jsp_GroupTag_4.setContext(SystemEnv.getHtmlLabelName(32866,user.getLanguage()));
          ...
          if (_jspEval21 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                int _jsp_end_28 = _jsp_SplitPageTag_6.doEndTag();
      ...
      out.print(( PageIdConst.DOC_TREECATEGORROOTLIST ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/category/DocTreeDocFieldRight.jsp"), 2172377772775972542L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string160 = "\" onchange='checkinput(\"treeDocFieldName\",\"treeDocFieldNameImage\")'>\r\n					".toCharArray();
    ...
    _jsp_string159 = "\r\n						<INPUT class=InputStyle  name=treeDocFieldName value=\"".toCharArray();
    ...
    _jsp_string152 = "\r\n					<input type=button class=\"e8_btn_top\" onclick=\"openDialog3(".toCharArray();
    ...
    _jsp_string153 = ");\" value=\"".toCharArray();
    _jsp_string77 = ",null);\r\n	".toCharArray();

...
public class _multidocmaint__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_3.setTemptitle(SystemEnv.getHtmlLabelName(15046,user.getLanguage()));
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?mouldID=doc&url=/docs/category/MultiCategorySingleBrowser.jsp?operationcode="+MultiAclManager.OPERATION_CREATEDOC );
                _jsp_BrowserTag_3.setCompleteUrl("/data.jsp?type=categoryBrowser&onlySec=true&operationcode="+MultiAclManager.OPERATION_CREATEDOC);
                _jsp_BrowserTag_3.doTag();
                out.write(_jsp_string143, 0, _jsp_string143.length);
                out.print((request.getSession().getAttribute("msg_str")==null?"":request.getSession().getAttribute("msg_str") ));
              ...
              _jsp_ItemTag_4.setAttributes("{'colspan':'full','isTableList':'true','id':'divProp','samePair':'divProp','display':'none'}");
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(33444,user.getLanguage()));
      ...
      out.print((SystemEnv.getHtmlLabelName(21408,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(83433,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/docupload/MultiDocMaint.jsp"), -2949553034559763039L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string104 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string146 = "</font><!--\u6e05\u9664\u6240\u6709\u9009\u62e9--></span>\r\n								</span>\r\n\r\n								</div>\r\n						".toCharArray();

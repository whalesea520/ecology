...
public class _dockind__jsp extends com.caucho.jsp.JavaPage
{
...
String qname = Util.null2String(request.getParameter("flowTitle"));
      ...
      out.print((SystemEnv.getHtmlLabelNames("93,16973",user.getLanguage())));
      out.write(_jsp_string67, 0, _jsp_string67.length);
      out.print((SystemEnv.getHtmlLabelNames("82,16973",user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((Util.convertInput2DB(name)));
	...
	String tableString=""+
      ...
      out.print(( PageIdConst.DOC_DOCKINDLIST ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/sendDoc/docKind.jsp"), -8215075972583254340L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string152 = "\" onchange='checkinput(\"name\",\"nameimage\")'><SPAN id=nameimage>".toCharArray();
    ...
    _jsp_string139 = "\r\n					<input type=\"button\" name=\"newBtn\" onclick=\"openDialog();\" class=\"e8_btn_top\" value=\"".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    ...
    _jsp_string151 = "</TD>\r\n          <TD class=Field>\r\n              <input name=name class=inputstyle style=\"width:60%\" value=\"".toCharArray();
    _jsp_string155 = "</TD>\r\n          <TD class=Field>\r\n              <input class=inputstyle name=desc  style=\"width:60%\" value=\"".toCharArray();

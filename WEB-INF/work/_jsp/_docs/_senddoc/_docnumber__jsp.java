...
public class _docnumber__jsp extends com.caucho.jsp.JavaPage
{
...
String qname = Util.null2String(request.getParameter("flowTitle"));
      ...
      out.print((SystemEnv.getHtmlLabelNames("93,16980",user.getLanguage())));
      out.write(_jsp_string66, 0, _jsp_string66.length);
      out.print((SystemEnv.getHtmlLabelNames("82,16980",user.getLanguage())));
...
if(userightmenu!=1){
	...
	String tableString=""+
      ...
      out.print(( PageIdConst.DOC_DOCNUMBERLIST ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/sendDoc/docNumber.jsp"), 8419094939443873604L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

...
public class _docprop__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(31813,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jsp_ItemTag_3.setAttributes( attributes);
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(31814,user.getLanguage())));
                out.write(_jsp_string145, 0, _jsp_string145.length);
                out.print((SystemEnv.getHtmlLabelName(31815,user.getLanguage())));
              ...
              do {
                ...
                out.print((prop.getPropValue("isSynchronous" , "fromtime_"+i)));
                out.write('-');
                out.print((prop.getPropValue("isSynchronous" , "totime_"+i)));
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(130650,user.getLanguage()));
          ...
          if (_jspEval33 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
			...
			String recycleattrs = "{'isTableList':'true','samePair':'setting','display':'"+(_docsrecycleIsOpen==1?"":"none")+"'}";
              ...
              _jsp_ItemTag_3.setAttributes("{'display':''}");
              _jsp_ItemTag_3.doStartTag();
              out = pageContext.pushBody();
              ...
              do {
                ...
                out.print((_docsrecycleIsOpen));
                out.write(_jsp_string141, 0, _jsp_string141.length);
                if(_docsrecycleIsOpen==1){
              ...
              _jsp_ItemTag_3.setAttributes(recycleattrs );
              _jsp_ItemTag_3.doStartTag();
              out = pageContext.pushBody();
                  ...
                  do {
                    ...
                    if (_jspEval50 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      ...
                      do {
                        ...
                        do {
                          out.print((SystemEnv.getHtmlLabelName(130672,user.getLanguage())));
                        ...
                        do {
                          ...
                          out.print((SystemEnv.getHtmlLabelName(130674,user.getLanguage())));
                          out.write(_jsp_string170, 0, _jsp_string170.length);
                          out.print((_deletedays));
                          out.write(_jsp_string171, 0, _jsp_string171.length);
                          out.print((_deletedays));
                          out.write(_jsp_string172, 0, _jsp_string172.length);
                          out.print((SystemEnv.getHtmlLabelName(130673,user.getLanguage())));
                          out.write(_jsp_string173, 0, _jsp_string173.length);
                          out.print((SystemEnv.getHtmlLabelName(130675,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(24475,user.getLanguage())));
      out.write(_jsp_string177, 0, _jsp_string177.length);
      out.print((SystemEnv.getHtmlLabelName(31833,user.getLanguage())));
      out.write(_jsp_string178, 0, _jsp_string178.length);
      out.print((SystemEnv.getHtmlLabelName(743,user.getLanguage())));
      out.print((SystemEnv.getHtmlLabelName(18622,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(31832,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/search/DocProp.jsp"), 200678509468507244L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string143 = "onclick=\"setCheck(this)\" />\r\n			".toCharArray();
    _jsp_string164 = "\r\n					".toCharArray();
    _jsp_string173 = "',this)\" id=\"autodeletedays\" name=\"autodeletedays\" >&nbsp;".toCharArray();
    _jsp_string152 = "\r\n					<span style=\"margin-right:10px\">".toCharArray();
    ...
    _jsp_string140 = "\r\n				<input class=InputStyle tzCheckbox=\"true\" name=\"isSynchronous\" type=\"checkbox\" value=\"".toCharArray();
    ...
    _jsp_string156 = "\" name=\"fromtime_".toCharArray();
    ...
    _jsp_string172 = " onchange=\"checkPositiveNumber('".toCharArray();
    _jsp_string180 = "\");\r\n	return false ;\r\n	}\r\n\r\n	if(iend<=istart){\r\n		top.Dialog.alert(\"".toCharArray();
    _jsp_string155 = "</a></br>\r\n				<input type=\"hidden\" id=\"fromtime_".toCharArray();
    ...
    _jsp_string167 = " id=\"docsautoclean\" name=\"docsautoclean\" onclick=\"ondocsautocleanClick(this)\">\r\n							<span  id=\"cleandayspan\" ".toCharArray();
    ...
    _jsp_string153 = "</span><a href=\"#\" onclick=\"dodelete(".toCharArray();
    _jsp_string128 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result6\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    _jsp_string163 = " id=\"docsrecycle\" name=\"docsrecycle\" onclick=\"ondocsrecycleClick(this)\">\r\n			".toCharArray();
    ...
    _jsp_string159 = "\" name=\"totime_".toCharArray();
    ...
    _jsp_string158 = "\">\r\n				<input type=\"hidden\" id=\"totime_".toCharArray();
    ...
    _jsp_string150 = "\r\n				<input type=\"hidden\" id=\"panum\" name=\"panum\" value=\"".toCharArray();
    _jsp_string65 = "\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string15 = "\\r\\n\\r\\n".toCharArray();
    _jsp_string154 = ");return false;\">".toCharArray();
    _jsp_string62 = "\r\n<!-- \u9875\u9762\u5207\u6362\u6548\u679cEnd -->\r\n\r\n\r\n<script language=\"javascript\">\r\n\r\n//------------------------------\r\n// the folder of current skins \r\n//------------------------------\r\n//\u5f53\u524d\u4f7f\u7528\u7684\u4e3b\u9898\r\nvar GLOBAL_CURRENT_THEME = \"".toCharArray();
    _jsp_string170 = "&nbsp;<INPUT class=InputStyle style=\"width:30px;text-align:center;\"  onkeyup=\"this.value=this.value.replace(/\\D/g,'')\" onafterpaste=\"this.value=this.value.replace(/\\D/g,'')\" defValue=\"".toCharArray();
    ...
    _jsp_string142 = " checked ".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string161 = "\r\n			<INPUT class=InputStyle  tzCheckbox=\"true\" type=checkbox value=\"".toCharArray();
    ...
    _jsp_string168 = "style=\"display:none\"".toCharArray();
  }
}

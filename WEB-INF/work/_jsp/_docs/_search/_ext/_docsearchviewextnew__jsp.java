...
public class _docsearchviewextnew__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	if(method.equals(""))method="add";
      ...
      out.write(_jsp_string52, 0, _jsp_string52.length);
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("doc")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(20482,user.getLanguage()) , null), false);
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jsp_ViewTag_0 == null) {
        ...
        _jsp_ViewTag_0.setAttributes("{'layoutTableId':'tblSetting'}");
      }
      ...
      if (_jspEval3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(20484,user.getLanguage()));
          ...
          if (_jspEval6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/docs/category/DocTreeDocFieldBrowserMulti.jsp?para=#id#_1");
                ...
                _jsp_BrowserTag_3.setLinkUrl("/docs/docdummy/DocDummyList.jsp?id=#id#&dummyId=#id#");
                _jsp_BrowserTag_3.setWidth("80%");
                _jsp_BrowserTag_3.setName(method.equalsIgnoreCase("add")?"txtDummy":"tdummy" );
                _jsp_BrowserTag_3.setTemptitle( SystemEnv.getHtmlLabelName(20482,user.getLanguage()));
      ...
      out.print((method.equals("add")?"txtDummy":"tdummy"));
      ...
      out.print((SystemEnv.getHtmlLabelName(28450,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/search/ext/DocSearchViewExtNew.jsp"), 6757282681733173343L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string47 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string141 = "\">\r\n<input type=\"hidden\" id=\"txtStatus\"  name=\"txtStatus\" value=\"".toCharArray();
    _jsp_string106 = "\r\n	_menuDocument.getElementById(\"rightMenu\").style.visibility=\"hidden\";\r\n	if (!_menuWindow.ActiveXObject) {\r\n		_menuDocument.getElementById(\"rightMenu\").style.display=\"none\";\r\n	}\r\n	".toCharArray();
    _jsp_string136 = "\r\n			".toCharArray();
    _jsp_string138 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.close()\">\r\n			".toCharArray();
    ...
    _jsp_string142 = "\">\r\n\r\n<script language=\"javaScript\">\r\n	\r\n   function onImporting(){\r\n   		var txtDummy = jQuery(\"#".toCharArray();
    ...
    _jsp_string129 = "\" id=\"zd_btn_submit_0\" class=\"e8_btn_top\" onclick=\"onImporting();\">\r\n			<span title=\"".toCharArray();
    ...
    _jsp_string146 = "&txtDummy=\"+jQuery(\"#txtDummy\").val()+\"&txtSql=\"+txtSql.value+\"&txtDocs=\"+txtDocs.value+\"&txtStatus=\"+txtStatus.value;\r\n		".toCharArray();
    ...
    _jsp_string148 = "&method=".toCharArray();
    ...
    _jsp_string145 = "\");\r\n   			return false;\r\n   		}\r\n	  	var actionUrl=\"/docs/search/DocUpToDummy.jsp?method=".toCharArray();
    ...
    _jsp_string139 = "\r\n</div>\r\n\r\n<input type=\"hidden\" id=\"txtSql\"  name=\"txtSql\" value=\"".toCharArray();
    ...
    _jsp_string48 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string147 = "\r\n			actionUrl=\"/docs/search/DocUpToDummy.jsp?txtDummy=".toCharArray();
    ...
    _jsp_string149 = "&tdummy=\"+jQuery(\"#tdummy\").val()+\"&txtDocs=\"+txtDocs.value;\r\n		".toCharArray();
    _jsp_string65 = "\r\n<div class=\"zDialog_div_content\">\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string140 = "\">\r\n<input type=\"hidden\" id=\"txtDocs\"  name=\"txtDocs\" value=\"".toCharArray();
    _jsp_string153 = "\r\n					top.Dialog.alert(\"".toCharArray();

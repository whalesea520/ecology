...
public class _newstypelist__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	if(!HrmUserVarify.checkUserRight("newstype:maint", user)){
      ...
      out.print((SystemEnv.getHtmlLabelNames("93,19789",user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelNames("82,19789",user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((xssUtil.put("where operateitem =100")));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print(( PageIdConst.DOC_NEWSTYPELIST ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/news/type/newstypeList.jsp"), 3711083548168317966L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string143 = "\" onclick=\"javascript:openDialog();\"/>\r\n					<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string48 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string144 = "\" class=\"e8_btn_top\" onclick=\"doDel();\"/>\r\n				".toCharArray();

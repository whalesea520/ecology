...
package _jsp._docs._news._type;
...
public class _newstypeadd__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
            ...
            do {
              ...
              do {
                ...
                if (_jsp_RequiredTag_3 == null) {
                  ...
                  _jsp_RequiredTag_3.setId("spanName");
                }

                _jsp_RequiredTag_3.setRequired(!(editable && ! Util.null2String(rs.getString("typename")).equals("")));
                ...
                if (_jspEval15 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  do {
                    ...
                    out.print((Util.forHtml(typename)));
              ...
              do {
                ...
                out.print((Util.forHtml(typedesc) ));
              ...
              do {
                ...
                if(editable) out.println("value='"+Util.null2String(rs.getString("dspnum"))+"'");
      ...
      out.print((Util.forHtml(Delname)));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("docs/news/type/newstypeAdd.jsp"), 915536080142517480L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string164 = "\")) {\r\n		window.location=\"newstypeOperation.jsp?isdialog=".toCharArray();
    ...
    _jsp_string154 = "  name=\"txtDspNum\" value=\"0\" size=\"4\" onKeyPress=\"ItemCount_KeyPress()\">\r\n		".toCharArray();
    ...
    _jsp_string148 = " value=\"".toCharArray();
    _jsp_string149 = "\") onChange=\"checkinput('txtName','spanName')\" >\r\n			".toCharArray();
    _jsp_string151 = " value='".toCharArray();
    ...
    _jsp_string152 = "'  name=\"txtDesc\">".toCharArray();
    _jsp_string125 = "\"></td>\r\n							".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string166 = "&DocTypeName=".toCharArray();
    ...
    _jsp_string0 = "\r\n \r\n".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string153 = "\r\n			<input style=\"width:30px;\" type=\"text\" class=\"inputstyle\" ".toCharArray();
    ...
    _jsp_string150 = "<input type=\"text\" class=\"inputstyle\"  ".toCharArray();
    ...
    _jsp_string147 = "\" type=\"text\" class=\"inputstyle\" name=\"txtName\" ".toCharArray();
    _jsp_string15 = "\\r\\n\\r\\n".toCharArray();
    _jsp_string58 = "\r\n    <meta http-equiv=\"".toCharArray();
    _jsp_string165 = "&txtMethod=del&id=".toCharArray();

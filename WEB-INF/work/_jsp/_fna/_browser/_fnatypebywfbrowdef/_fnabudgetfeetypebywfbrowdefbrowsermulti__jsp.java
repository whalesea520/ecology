...
public class _fnabudgetfeetypebywfbrowdefbrowsermulti__jsp extends com.caucho.jsp.JavaPage
{
...
if(tabId == 1){
	...
	tabId2Class = "current";
      ...
      out.print((tabId1Class ));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelName(33143,user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((tabId2Class ));
      ...
      out.print((ysxxUrl+"?tabId="+tabId+"&selectids="+selectids ));
      ...
      out.print((JSONObject.quote(SystemEnv.getHtmlLabelName(27766, user.getLanguage())) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("fna/browser/fnaTypeByWfBrowdef/FnaBudgetfeeTypeByWfBrowdefBrowserMulti.jsp"), -4681727921305780970L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

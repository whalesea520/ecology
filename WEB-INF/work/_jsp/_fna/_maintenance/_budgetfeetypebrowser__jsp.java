...
public class _budgetfeetypebrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(filterfeetype>0&&filterlevel==0) filterlevel=3;
      ...
      out.print((subjectBrowseDefExpanded ));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("fna")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(27766, user.getLanguage()) , null), false);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("fna/maintenance/BudgetfeeTypeBrowser.jsp"), -5252634933194685834L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string97 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string134 = "\r\n	    ".toCharArray();
    _jsp_string65 = "\r\n\r\n<HTML>\r\n<HEAD>\r\n<script type=\"text/javascript\">\r\nvar _fna_subjectBrowseDefExpanded = \"".toCharArray();
    ...
    _jsp_string39 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string155 = "&billid=".toCharArray();
    ...
    _jsp_string149 = "&fromWfFnaBudgetChgApply=".toCharArray();
    _jsp_string152 = "&fromFnaRequest=".toCharArray();
    ...
    _jsp_string153 = "&workflowid=".toCharArray();
    ...
    _jsp_string61 = ")\">\r\n".toCharArray();
    _jsp_string146 = "&feetype=".toCharArray();
    ...
    _jsp_string151 = "&orgId=".toCharArray();
    ...
    _jsp_string147 = "\");\r\n//added by cyril on 2008-07-31 for td:9109\r\n//\u8bbe\u7f6e\u9009\u4e2d\u7684ID\r\ncxtree_id = '';\r\nCXLoadTreeItem(\"\", \"/fna/maintenance/SubjectSingleXML.jsp?init=true&type=L0&level=".toCharArray();
    ...
    _jsp_string148 = "&displayarchive=".toCharArray();
    _jsp_string67 = "\r\n\r\n\r\n    ".toCharArray();
    ...
    _jsp_string150 = "&orgType=".toCharArray();

...
package _jsp._fna._report._budgetdetailed;
...
public class _budgetdetailed__jsp extends com.caucho.jsp.JavaPage
{
...
if(!canview) {
	...
	return ; 
      ...
      out.print((JSONObject.quote(SystemEnv.getHtmlLabelName(82629, user.getLanguage())) ));
...
if("history".equals(type)){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("fna/report/budgetDetailed/budgetDetailed.jsp"), -1019059638131222236L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

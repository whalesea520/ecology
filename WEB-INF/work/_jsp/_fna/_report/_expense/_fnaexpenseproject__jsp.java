...
public class _fnaexpenseproject__jsp extends com.caucho.jsp.JavaPage
{
...
boolean canview = HrmUserVarify.checkUserRight("FnaBudget:All",user) ;
      ...
      out.print((JSONObject.quote(SystemEnv.getHtmlLabelName(15406, user.getLanguage())) ));
...
String ysxxUrl = _ysxxUrl;
      ...
      out.print((_ysxxUrl+"?fnayear="+fnayear ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("fna/report/expense/FnaExpenseProject.jsp"), -3574499175555397615L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();
    _jsp_string73 = "\" target=\"tabcontentframe\">\r\n			        		".toCharArray();
  }
}

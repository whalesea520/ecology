...
public class _fnaexpenseresourcedetail__jsp extends com.caucho.jsp.JavaPage
{
...
String ysxxUrl = "/fna/report/expense/FnaExpenseResourceDetailInner.jsp?resourceid="+resourceid+"&fnayear="+fnayear;
      ...
      out.print((JSONObject.quote(SystemEnv.getHtmlLabelName(179,user.getLanguage())+":"+Util.toScreen(ResourceComInfo.getResourcename(resourceid),user.getLanguage())) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("fna/report/expense/FnaExpenseResourceDetail.jsp"), 4028727400432013354L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

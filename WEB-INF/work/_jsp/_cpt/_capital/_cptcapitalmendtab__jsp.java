...
public class _cptcapitalmendtab__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((CptDetailColumnUtil.getDetailColumnConf("CptMend", user) ));
      out.write(_jsp_string144, 0, _jsp_string144.length);
      out.print((SystemEnv.getHtmlLabelNames("83605",user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlNoteName(60,user.getLanguage())));
...
if("1".equals(isDialog)){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CptCapitalMendTab.jsp"), 9121562964563784469L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

...
public class _cptcapitalflowview__jsp extends com.caucho.jsp.JavaPage
{
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_3.setIsSingle("true");
                _jsp_BrowserTag_3.setHasBrowser("true");
                _jsp_BrowserTag_3.setName("stateid");
                _jsp_BrowserTag_3.setBrowserValue(stateid);
                _jsp_BrowserTag_3.setBrowserSpanValue(Util.toScreen(CapitalStateComInfo.getCapitalStatename(stateid),user.getLanguage()));
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/cpt/maintenance/CapitalStateBrowser.jsp?from=flowview");
                _jsp_BrowserTag_3.setCompleteUrl("/data.jsp?type=?");
                _jsp_BrowserTag_3.doTag();
                out.write(_jsp_string145, 0, _jsp_string145.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(1394,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
...
tableString =   " <table  pageId=\""+pageId+"\"  instanceid=\"CptCapitalAssortmentTable\" tabletype=\"none\"  pagesize=\""+PageIdConst.getPageSize(pageId,user.getUID(),"cpt")+"\"  >"+
      ...
      int _jsp_end_51 = _jsp_SplitPageTag_5.doEndTag();
      if (_jsp_end_51 == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
        return;
      out.write(_jsp_string157, 0, _jsp_string157.length);
      out.print((SystemEnv.getHtmlLabelName(1293,user.getLanguage()) ));
...
if("1".equals(isDialog)){
      ...
      int _jspEval54 = _jsp_ViewTag_6.doStartTag();
      if (_jspEval54 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval54 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_6.setBodyContent(_jsp_endTagHack52);
        ...
        do {
          ...
          int _jspEval57 = _jsp_GroupTag_7.doStartTag();
          if (_jspEval57 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval57 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_7.setBodyContent(_jsp_endTagHack55);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CptCapitalFlowView.jsp"), 7945924278860414080L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    _jsp_string139 = "\">\r\n<input type=\"hidden\" id=capitalid name=\"capitalid\" value=\"".toCharArray();
    _jsp_string149 = "\">\r\n				</span>\r\n	    	".toCharArray();
    ...
    _jsp_string15 = "\\r\\n\\r\\n".toCharArray();
    _jsp_string162 = "\r\n    		<input class=\"zd_btn_cancle\" type=\"button\" name=\"cancel\" onclick=\"onclose()\"  value=\"".toCharArray();
    ...
    _jsp_string138 = "\" />\r\n<input type=\"hidden\" id=sqlwhere1 name=\"sqlwhere1\" value=\"".toCharArray();

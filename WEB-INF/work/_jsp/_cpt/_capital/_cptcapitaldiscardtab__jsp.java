...
public class _cptcapitaldiscardtab__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((CptDetailColumnUtil.getDetailColumnConf("CptDiscard", user) ));
      out.write(_jsp_string142, 0, _jsp_string142.length);
      out.print((SystemEnv.getHtmlLabelNames("83567",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CptCapitalDiscardTab.jsp"), 3446106898129634188L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

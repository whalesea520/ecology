...
public class _cptcapitalmaintenance__jsp extends com.caucho.jsp.JavaPage
{
...
String tableString = "";
    tableString =" <table  pageId=\""+pageId+"\"  instanceid=\"cptcapitalDetailTable\" tabletype=\"checkbox\"  pagesize=\""+PageIdConst.getPageSize(pageId,user.getUID(),"cpt")+"\"  >"+
      ...
      out.print((SystemEnv.getHtmlLabelName(19320,user.getLanguage())));
      ...
      out.print((CapitalAssortmentComInfo.getAssortmentName( paraid) ));
      out.write(_jsp_string172, 0, _jsp_string172.length);
      out.print((SystemEnv.getHtmlLabelName(22315,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CptCapitalMaintenance.jsp"), -6256756854274152713L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string139 = "\" class=\"e8_btn_top\"  onclick=\"addSub(".toCharArray();
    ...
    _jsp_string151 = "<input type=text name=capitalspec class=InputStyle value='".toCharArray();
    ...
    _jsp_string155 = "\"  />\r\n			    	".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string162 = " != 1) {\r\n		retValue = window\r\n				.showModalDialog(\r\n						\"/systeminfo/BrowserMain.jsp?url=/hrm/company/DepartmentBrowser.jsp?selectedids=\"\r\n								+ $GetEle(inputname).value, \"\",\r\n								\"dialogWidth:550px;dialogHeight:550px;center:1;addressbar=no;status=0;resizable=0;\");\r\n	} else {\r\n		retValue = window\r\n				.showModalDialog(\r\n						\"/systeminfo/BrowserMain.jsp?url=/hrm/company/DepartmentBrowser2.jsp?rightStr=".toCharArray();
    _jsp_string92 = "px\" height=\"".toCharArray();
    _jsp_string137 = "\">\r\n<input type=\"hidden\" name=\"paraid\" id=\"paraid\" value=\"".toCharArray();

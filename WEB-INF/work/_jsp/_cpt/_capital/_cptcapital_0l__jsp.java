...
public class _cptcapital_0l__jsp extends com.caucho.jsp.JavaPage
{
...
if(!"1".equals(isfromCapitalTab)){
	...
	return;
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.cpt.util.CptCardGroupComInfo CptCardGroupComInfo;
      CptCardGroupComInfo = (weaver.cpt.util.CptCardGroupComInfo) pageContext.getAttribute("CptCardGroupComInfo");
      if (CptCardGroupComInfo == null) {
        CptCardGroupComInfo = new weaver.cpt.util.CptCardGroupComInfo();
        pageContext.setAttribute("CptCardGroupComInfo", CptCardGroupComInfo);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
if(!openfieldMap.isEmpty()){
	...
	while(it.hasNext()){
		...
		fieldcount++;
              ...
              _jsp_ItemTag_2.setAttributes(hideField );
	...
	if(!dataornot&&"startprice".equalsIgnoreCase(fieldName)){
        ...
        //\u51bb\u7ed3\u6570\u91cf
              ...
              _jsp_ItemTag_3.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelNames("1232,1331", user.getLanguage()) ));
              } while (_jsp_ItemTag_3.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_3.doEndTag();
      ...
      out.print((SystemEnv.getHtmlLabelNames("23271",user.getLanguage())));
...
if("1".equals(isdialog)){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CptCapital_l.jsp"), -3665553470302824977L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string157 = "<span id=\"frozenhelpspan\" title=\"".toCharArray();
    ...
    _jsp_string154 = "\r\n	\r\n	".toCharArray();
    _jsp_string149 = "\" class=\"highslide\"  onclick=\"return hs.expand(this)\" style=\"width:300px;height:215px;\">\r\n				<img style=\"width:300px;height:215px;\" src=\"/weaver/weaver.file.FileDownload?fileid=".toCharArray();
    ...
    _jsp_string150 = "\" alt=\"".toCharArray();
    ...
    _jsp_string159 = "&nbsp;&nbsp;<img src=\"/images/tooltip_wev8.png\" align=\"absMiddle\"/></span>".toCharArray();
    _jsp_string169 = "\r\n    		<input class=\"zd_btn_cancle\" type=\"button\" name=\"cancel\" onclick=\"parentDialog.close();\"  value=\"".toCharArray();
    _jsp_string170 = "\"/>\r\n    	".toCharArray();
    ...
    _jsp_string151 = "\" title=\"".toCharArray();

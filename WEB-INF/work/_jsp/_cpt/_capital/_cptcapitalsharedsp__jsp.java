...
public class _cptcapitalsharedsp__jsp extends com.caucho.jsp.JavaPage
{
...
tableString =   " <table pageId=\""+pageId+"\"  instanceid=\"CptCapitalAssortmentTable\" tabletype=\"checkbox\"  pagesize=\""+PageIdConst.getPageSize(pageId,user.getUID(),"cpt")+"\"  >"+
      ...
      out.print((SystemEnv.getHtmlLabelNames("83614",user.getLanguage())));
      out.write(_jsp_string148, 0, _jsp_string148.length);
      out.print((SystemEnv.getHtmlLabelNames("83616",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CptCapitalShareDsp.jsp"), 5339808602686033250L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string146 = "\" class=\"e8_btn_cancel\" id=\"cancel\"/>\r\n		</td> \r\n		</tr>\r\n	</table>\r\n</div>	\r\n\r\n".toCharArray();
    ...
    _jsp_string149 = "',function(){\r\n			jQuery.post(\r\n				\"/cpt/capital/ShareOperation.jsp\",\r\n				{\"method\":\"delete\",\"id\":id,\"capitalid\":\"".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    ...
    _jsp_string145 = "\" class=\"e8_btn_submit\"/>\r\n			<input type=\"button\" value=\"".toCharArray();

...
public class _cptcapitaltab__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.cpt.util.CptCardTabComInfo CptCardTabComInfo;
      CptCardTabComInfo = (weaver.cpt.util.CptCardTabComInfo) pageContext.getAttribute("CptCardTabComInfo");
      if (CptCardTabComInfo == null) {
        CptCardTabComInfo = new weaver.cpt.util.CptCardTabComInfo();
        pageContext.setAttribute("CptCardTabComInfo", CptCardTabComInfo);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
	...
	/*\u6743\u9650\u5224\u65ad\u7ed3\u675f*/	
      ...
      out.print((count==1?"current":"" ));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((linkurl ));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((SystemEnv.getHtmlLabelName(Util.getIntValue( CptCardTabComInfo.getLabel(),0),user.getLanguage()) ));
      ...
      out.print(("1".equals(isdata)?"class='defaultTab' onclick='return false' ":"" ));
      out.write(_jsp_string73, 0, _jsp_string73.length);
      out.print((url ));
      out.write(_jsp_string74, 0, _jsp_string74.length);
      out.print(("1".equals(isdata)?"":""+SystemEnv.getHtmlLabelNames("15806",user.getLanguage()) ));
      ...
      out.print((CapitalComInfo.getCapitalname(""+capitalid) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CptCapitalTab.jsp"), 5400843465475421059L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string73 = " href=\"".toCharArray();

...
public class _cptcapitalbackoperation__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.cpt.capital.CptShare CptShare;
      CptShare = (weaver.cpt.capital.CptShare) pageContext.getAttribute("CptShare");
      if (CptShare == null) {
        CptShare = new weaver.cpt.capital.CptShare();
        pageContext.setAttribute("CptShare", CptShare);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
response.sendRedirect("CptCapitalBackTab.jsp");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CptCapitalBackOperation.jsp"), 7191089182212088532L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

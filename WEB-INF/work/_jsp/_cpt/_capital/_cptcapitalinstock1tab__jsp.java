...
public class _cptcapitalinstock1tab__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.cpt.util.CptDetailColumnUtil CptDetailColumnUtil;
      CptDetailColumnUtil = (weaver.cpt.util.CptDetailColumnUtil) pageContext.getAttribute("CptDetailColumnUtil");
      if (CptDetailColumnUtil == null) {
        CptDetailColumnUtil = new weaver.cpt.util.CptDetailColumnUtil();
        pageContext.setAttribute("CptDetailColumnUtil", CptDetailColumnUtil);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(913,user.getLanguage())));
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(901,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                _jsp_BrowserTag_3.setBrowserSpanValue(ResourceComInfo.getResourcename(CheckerID) );
			...
			String customerbrowurl="/systeminfo/BrowserMain.jsp?url=/CRM/data/CustomerBrowser.jsp?sqlwhere="+new XssUtil().put("where t1.type=2");
                ...
                _jsp_BrowserTag_4.setName("customerid");
                ...
                _jsp_BrowserTag_4.setBrowserValue(customerid );
                _jsp_BrowserTag_4.setBrowserSpanValue(CustomerInfoComInfo.getCustomerInfoname(customerid) );
                _jsp_BrowserTag_4.setBrowserUrl(customerbrowurl );
      ...
      out.print((CptDetailColumnUtil.getDetailColumnConf("CptStockInDetail", user) ));
      out.write(_jsp_string158, 0, _jsp_string158.length);
      out.print((SystemEnv.getHtmlLabelNames("83579",user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelNames("83582",user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(33027,user.getLanguage()) ));
      ...
      int _jspEval58 = _jsp_ViewTag_5.doStartTag();
      if (_jspEval58 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval58 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_5.setBodyContent(_jsp_endTagHack56);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CptCapitalInstock1tab.jsp"), -3853532630655541299L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string161 = "\",\"applyid\":\"".toCharArray();
    ...
    _jsp_string160 = "\",\"from\":\"".toCharArray();
    ...
    _jsp_string162 = "\",\"type\":\"".toCharArray();
    ...
    _jsp_string169 = "\"!=\"cptalertsearch\" ){\r\n		setTimeout(\"group1.addRow();\",100);\r\n	}\r\n});\r\n\r\n</script>\r\n\r\n<!-- \u5bf9\u8bdd\u6846\u5e95\u4e0b\u7684\u6309\u94ae -->\r\n".toCharArray();
    _jsp_string140 = "\">\r\n<INPUT  type=hidden name=\"reapplyflag\" value=\"".toCharArray();
    ...
    _jsp_string155 = "\r\n    		<input class=\"InputStyle\" style=\"width:160px;\" type=text name=\"contactno\" id=\"contactno\" value=\"".toCharArray();
    ...
    _jsp_string150 = "</SPAN>\r\n						  <input type=\"hidden\" name=\"StockInDate_gz\" value=".toCharArray();

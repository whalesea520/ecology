...
public class _capitalexceltodb__jsp extends com.caucho.jsp.JavaPage
{
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(19320,user.getLanguage()) );
...
if("success".equals(msg)||msgsize>0){
              ...
              if (_jsp_ItemTag_3 == null) {
                ...
                _jsp_ItemTag_3.setAttributes("{'id':'msg','colspan':'full'}");
              }
...
if(session.getAttribute("cptexceltodb_totalCount")!=null&&session.getAttribute("cptexceltodb_successCount")!=null){
    ...
    if(totalcount>0){
        ...
        out.println(s);
          ...
          _jsp_GroupTag_4.setContext(SystemEnv.getHtmlLabelName(19010,user.getLanguage()));
          int _jspEval21 = _jsp_GroupTag_4.doStartTag();
          if (_jspEval21 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval21 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_4.setBodyContent(_jsp_endTagHack19);
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(32986,user.getLanguage())));
                out.write(_jsp_string152, 0, _jsp_string152.length);
                out.print((SystemEnv.getHtmlLabelName(32987,user.getLanguage())));
                out.write(_jsp_string152, 0, _jsp_string152.length);
                out.print((SystemEnv.getHtmlLabelName(32988,user.getLanguage())));
          ...
          _jsp_GroupTag_4.setContext(SystemEnv.getHtmlLabelNames("24962",user.getLanguage()));
          ...
          if (_jspEval29 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.write(_jsp_string157, 0, _jsp_string157.length);
                out.print((SystemEnv.getHtmlLabelName(26451,user.getLanguage())));
                ...
                out.write(_jsp_string160, 0, _jsp_string160.length);
                out.print((SystemEnv.getHtmlLabelNames("191,726",user.getLanguage())));
                out.write(_jsp_string158, 0, _jsp_string158.length);
...
if(openfieldMap!=null && openfieldMap.size()>0&&mandfieldMap!=null&&openfieldMap.size()>mandfieldMap.size()){
	...
	while(it.hasNext()){
      ...
      out.print((SystemEnv.getHtmlLabelName(19364,user.getLanguage())));
...
if("1".equals( isDialog)){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CapitalExcelToDB.jsp"), 9152206541062207973L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string48 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string149 = "<a style=\"color: #1d98f8;cursor: pointer;\" href=\"CapitalExcelToDBnew.xls?V=".toCharArray();

...
public class _cptcapitallendtab__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((CptDetailColumnUtil.getDetailColumnConf("CptLend", user) ));
      out.write(_jsp_string142, 0, _jsp_string142.length);
      out.print((SystemEnv.getHtmlLabelNames("83592",user.getLanguage())));
      ...
      out.print((borrowedCptId));
      out.write(_jsp_string146, 0, _jsp_string146.length);
      out.print((SystemEnv.getErrorMsgName(36,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CptCapitalLendTab.jsp"), -3428874198032036877L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

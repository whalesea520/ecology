...
public class _capitaluseoperation__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.cpt.util.CptDwrUtil CptDwrUtil;
      CptDwrUtil = (weaver.cpt.util.CptDwrUtil) pageContext.getAttribute("CptDwrUtil");
      if (CptDwrUtil == null) {
        CptDwrUtil = new weaver.cpt.util.CptDwrUtil();
        pageContext.setAttribute("CptDwrUtil", CptDwrUtil);
      }
      out.write(_jsp_string2, 0, _jsp_string2.length);
...
response.sendRedirect("CptCapitalUseTab.jsp");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CapitalUseOperation.jsp"), 6722173129014766080L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

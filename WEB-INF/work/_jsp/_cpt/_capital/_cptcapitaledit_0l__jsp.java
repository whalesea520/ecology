...
public class _cptcapitaledit_0l__jsp extends com.caucho.jsp.JavaPage
{
...
if(!openfieldMap.isEmpty()){
	...
	while(it.hasNext()){
		...
		if("capitalgroupid".equals(fieldName)){
                ...
                out.write(_jsp_string155, 0, _jsp_string155.length);
                out.print((((HtmlElement)Class.forName(v.getString("eleclazzname")).newInstance()).getHtmlElementString(fieldValue, v, user) ));
                out.write(_jsp_string155, 0, _jsp_string155.length);
	...
	if(fieldcount==1 ){
      ...
      out.print((SystemEnv.getHtmlLabelNames("714",user.getLanguage())));
      out.write(_jsp_string178, 0, _jsp_string178.length);
      out.print((SystemEnv.getHtmlLabelNames("18082",user.getLanguage())));
...
if("1".equals(isDialog)){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CptCapitalEdit_l.jsp"), 6124051709555575590L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string175 = "',\"isdata\":'".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string176 = "',\"codeuse\":\"".toCharArray();

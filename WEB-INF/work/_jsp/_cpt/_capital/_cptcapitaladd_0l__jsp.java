...
public class _cptcapitaladd_0l__jsp extends com.caucho.jsp.JavaPage
{
...
String lme = Util.null2String(request.getParameter("lme"));
      ...
      out.print((SystemEnv.getHtmlLabelNames("81855",user.getLanguage())));
      out.print((SystemEnv.getHtmlLabelNames("1321",user.getLanguage())));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((SystemEnv.getHtmlLabelNames("23181",user.getLanguage())));
      out.print((SystemEnv.getHtmlLabelNames("27515",user.getLanguage())));
      out.print((SystemEnv.getHtmlLabelNames("33466",user.getLanguage())));
      out.write(_jsp_string71, 0, _jsp_string71.length);
      out.print((SystemEnv.getHtmlLabelNames("83638",user.getLanguage())));
      out.print((SystemEnv.getHtmlLabelNames("199",user.getLanguage())));
      out.print((SystemEnv.getHtmlLabelNames("19381",user.getLanguage())));
...
if("1".equals(isDialog)){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CptCapitalAdd_l.jsp"), -2940298770169124231L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

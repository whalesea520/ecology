...
public class _capitalexceltodb1__jsp extends com.caucho.jsp.JavaPage
{
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(19314,user.getLanguage()) );
...
if("1".equals(CodeUtil.getCptData2CodeUse())){
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(22396,user.getLanguage())));
              ...
              do {
                ...
                _jsp_BrowserTag_3.setName("cptdata1ids");
                _jsp_BrowserTag_3.setBrowserValue("");
                _jsp_BrowserTag_3.setBrowserSpanValue("");
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/cpt/brow/MultiCapitalBrowser.jsp?from=cptimp&resourceids=#id#");
                ...
                _jsp_BrowserTag_3.setCompleteUrl("/data.jsp?type=179&from=cptimp");
                _jsp_BrowserTag_3.set_callback("");
                _jsp_BrowserTag_3.doTag();
                out.write(_jsp_string144, 0, _jsp_string144.length);
                out.print((SystemEnv.getHtmlLabelNames("83555",user.getLanguage())));
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(19971,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelNames("28446",user.getLanguage())));
...
if("success".equals(msg)||msgsize>0){
              ...
              if (_jsp_ItemTag_4 == null) {
                ...
                _jsp_ItemTag_4.setAttributes("{'id':'msg','colspan':'full'}");
              }
...
if(session.getAttribute("cptexceltodb_totalCount")!=null&&session.getAttribute("cptexceltodb_successCount")!=null){
    ...
    if(totalcount>0){
        ...
        out.println(s);
          ...
          _jsp_GroupTag_5.setContext(SystemEnv.getHtmlLabelName(19010,user.getLanguage()));
          int _jspEval45 = _jsp_GroupTag_5.doStartTag();
          if (_jspEval45 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval45 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_5.setBodyContent(_jsp_endTagHack43);
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(128225,user.getLanguage())));
                out.write(_jsp_string156, 0, _jsp_string156.length);
                out.print((SystemEnv.getHtmlLabelName(128226,user.getLanguage())));
                out.write(_jsp_string157, 0, _jsp_string157.length);
                out.print((System.currentTimeMillis()));
                out.write(_jsp_string147, 0, _jsp_string147.length);
                out.print((SystemEnv.getHtmlLabelNames("28446",user.getLanguage())));
                out.write(_jsp_string158, 0, _jsp_string158.length);
                out.print((SystemEnv.getHtmlLabelName(128227,user.getLanguage()) ));
                out.write(_jsp_string156, 0, _jsp_string156.length);
                out.print((SystemEnv.getHtmlLabelName(128228,user.getLanguage())));
                out.write(_jsp_string156, 0, _jsp_string156.length);
                out.print((SystemEnv.getHtmlLabelName(128229,user.getLanguage())));
          ...
          _jsp_GroupTag_5.setContext(SystemEnv.getHtmlLabelNames("24962",user.getLanguage()));
          ...
          if (_jspEval53 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(18617,user.getLanguage())));
                ...
                out.print((SystemEnv.getHtmlLabelName(19322,user.getLanguage())));
                out.write(_jsp_string163, 0, _jsp_string163.length);
                out.print((SystemEnv.getHtmlLabelName(15302,user.getLanguage())));
                ...
                out.print((SystemEnv.getHtmlLabelName(17342,user.getLanguage())));
                out.write(_jsp_string164, 0, _jsp_string164.length);
                ...
                out.write(_jsp_string166, 0, _jsp_string166.length);
                out.print((SystemEnv.getHtmlLabelName(830,user.getLanguage())));
                out.write(_jsp_string164, 0, _jsp_string164.length);
...
if(mandfieldMap!=null && mandfieldMap.size()>0){
	...
	while(it.hasNext()){
		...
		JSONObject v= entry.getValue();
                ...
                out.print((SystemEnv.getHtmlLabelName(21029,user.getLanguage())));
                out.write(_jsp_string163, 0, _jsp_string163.length);
                out.print((SystemEnv.getHtmlLabelName(21030,user.getLanguage())));
                out.write(_jsp_string163, 0, _jsp_string163.length);
                out.print((SystemEnv.getHtmlLabelName(21031,user.getLanguage())));
                out.write(_jsp_string164, 0, _jsp_string164.length);
                out.print((SystemEnv.getHtmlLabelName(903,user.getLanguage())));
                out.write(_jsp_string165, 0, _jsp_string165.length);
...
if(openfieldMap!=null && openfieldMap.size()>0&&mandfieldMap!=null&&openfieldMap.size()>mandfieldMap.size()){
	...
	while(it.hasNext()){
      ...
      out.print((SystemEnv.getHtmlLabelName(19316,user.getLanguage())));
...
String regenTemplateMsg3=SystemEnv.getHtmlLabelName(128232,user.getLanguage());
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CapitalExcelToDB1.jsp"), 3724381741892057774L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string160 = "\r\n			<div>\r\n				<br>\r\n				<strong>".toCharArray();
    _jsp_string161 = "</strong>\r\n				<br><br>\r\n				<span style=\"color:#FF0000;\">\r\n					".toCharArray();
    _jsp_string145 = "\" class=\"middle e8_btn_top\" onclick=\"regenTemplate();\">\r\n		".toCharArray();
    ...
    _jsp_string157 = "<a style=\"color: #1d98f8;cursor: pointer;\" href=\"CapitalExcelToDB1new.xls?V=".toCharArray();
    ...
    _jsp_string168 = "\r\n\r\n				</span>	\r\n					\r\n					\r\n".toCharArray();
    _jsp_string146 = "\r\n			<a style=\"color: #1d98f8;cursor: pointer;\" href=\"CapitalExcelToDB1new.xls?V=".toCharArray();
    _jsp_string177 = "	\r\n				<span >	\r\n					".toCharArray();

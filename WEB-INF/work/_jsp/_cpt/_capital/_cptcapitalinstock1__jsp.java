...
public class _cptcapitalinstock1__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	String url2 = "/cpt/capital/CptCapitalInstock1tab_his.jsp";
      ...
      out.print((SystemEnv.getHtmlLabelNames("83688",user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((url2 ));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelNames("84363",user.getLanguage())));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((url ));
      out.write(_jsp_string71, 0, _jsp_string71.length);
      out.print((SystemEnv.getHtmlLabelName(15306,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/capital/CptCapitalInstock1.jsp"), -3185087018535047808L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string69 = "<span id=\"allNum_span\"></span></a>\r\n				</li>\r\n		       	<li class=\"\">\r\n					<a target=\"tabcontentframe\" href=\"".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();

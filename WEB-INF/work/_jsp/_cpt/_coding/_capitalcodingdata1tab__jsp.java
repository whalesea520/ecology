...
public class _capitalcodingdata1tab__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/coding/CapitalCodingData1Tab.jsp"), 560656728867330930L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string150 = "\" customer1=\"member\" onmouseover=\"$(this).find('img[moveimg]').attr('src','/proj/img/move-hot_wev8.png');\" onmouseout=\"$(this).find('img[moveimg]').attr('src','/proj/img/move_wev8.png');\">\r\n              <TD codevalue=\"".toCharArray();
    ...
    _jsp_string169 = "\" onKeyPress=\"ItemCount_KeyPress()\" onBlur='checknumber(\"startcodenum\")' >\r\n		".toCharArray();
    ...
    _jsp_string176 = "\") codeTitle=\"".toCharArray();
    ...
    _jsp_string159 = " class=InputStyle   value=\"".toCharArray();
    _jsp_string158 = "onchange=proView()".toCharArray();
    ...
    _jsp_string156 = " style=\"width:50px!important\" onchange='checkint(\"inputt".toCharArray();

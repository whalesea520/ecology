...
public class _moduleedit__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelNames("126575",user.getLanguage())));
      out.write(_jsp_string153, 0, _jsp_string153.length);
      out.print((SystemEnv.getHtmlLabelNames("126575",user.getLanguage())));
      out.write(_jsp_string154, 0, _jsp_string154.length);
      out.print((SystemEnv.getHtmlLabelNames("126576",user.getLanguage())));
      out.write(_jsp_string153, 0, _jsp_string153.length);
      out.print((SystemEnv.getHtmlLabelNames("126576", user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/print/moduleedit.jsp"), 4190688592552512361L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string154 = "</li>\r\n					<li _value=\"#[2d-barcode]\" title=\"".toCharArray();
    ...
    _jsp_string156 = "\r\n                        <li  title=\"\" style=\"font-weight: bold;\">".toCharArray();
    ...
    _jsp_string169 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.closeByHand();\">\r\n				".toCharArray();
    _jsp_string163 = "\" id=\"id\">\r\n<input type=\"hidden\" name=\"isdialog\" value=\"".toCharArray();
    ...
    _jsp_string152 = "</li>\r\n					<li _value=\"#[1d-barcode]\" title=\"".toCharArray();
    ...
    _jsp_string159 = "\" title=\"".toCharArray();
    _jsp_string100 = "px\">\r\n</iframe>\r\n</div>\r\n".toCharArray();

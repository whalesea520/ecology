...
public class _cptlisttab__jsp extends com.caucho.jsp.JavaPage
{
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_3.setBrowserSpanValue(CapitalAssortmentComInfo.getAssortmentName(capitalgroupid ) );
              ...
              do {
                ...
                _jsp_BrowserTag_3.setBrowserSpanValue(CapitalTypeComInfo.getCapitalTypename(capitaltypeid ) );
              ...
              do {
                ...
                _jsp_BrowserTag_3.setHasBrowser("true");
                _jsp_BrowserTag_3.setIsMustInput("1");
                _jsp_BrowserTag_3.setName("blongsubcompany");
                _jsp_BrowserTag_3.setBrowserValue(blongsubcompany );
                _jsp_BrowserTag_3.setBrowserSpanValue(SubCompanyComInfo.getSubCompanyname(blongsubcompany ) );
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(1508,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                _jsp_BrowserTag_3.setBrowserSpanValue(ResourceComInfo.getResourcename(resourceid));
...
//         				"		<operate href=\"javascript:onModifyLog();\" text=\""+SystemEnv.getHtmlLabelNames("19765",user.getLanguage())+"\" target=\"_self\" index=\"1\"/>"+
      ...
      int _jsp_end_83 = _jsp_SplitPageTag_5.doEndTag();
      ...
      out.print((SubCompanyComInfo.getSubCompanyname(""+subcompanyid1) ));
      out.write(_jsp_string167, 0, _jsp_string167.length);
      out.print((SystemEnv.getHtmlLabelName(126637,user.getLanguage()) ));
      out.write(_jsp_string168, 0, _jsp_string168.length);
      out.print((SystemEnv.getHtmlLabelNames("16367",user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelNames("26382",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/print/cptlisttab.jsp"), -6869109505122118345L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string147 = "<input type=text name=mark class=InputStyle value='".toCharArray();
    ...
    _jsp_string148 = "<input type=text name=capitalspec class=InputStyle value='".toCharArray();
    ...
    _jsp_string145 = "<input type=text  name=flowTitle class=InputStyle value='".toCharArray();
    _jsp_string138 = "\" class=\"e8_btn_top\" onclick=\"onEdit()\"/>\r\n			<span id=\"advancedSearch\" class=\"advancedSearch\">".toCharArray();
    ...
    _jsp_string137 = "\" class=\"e8_btn_top\" onclick=\"onPrint()\"/>\r\n            <input type=\"button\" value=\"".toCharArray();

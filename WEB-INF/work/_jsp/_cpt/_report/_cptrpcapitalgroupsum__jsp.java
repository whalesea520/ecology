...
public class _cptrpcapitalgroupsum__jsp extends com.caucho.jsp.JavaPage
{
...
if(subcompanyid1.equals("") && detachable==1)
{
   String s="<TABLE class=viewform><colgroup><col width='10'><col width=''><TR class=Title><TH colspan='2'>"+SystemEnv.getHtmlLabelName(19010,user.getLanguage())+"</TH></TR><TR class=spacing><TD class=line1 colspan='2'></TD></TR><TR><TD></TD><TD><li>";
    ...
    return;
      ...
      out.print((SystemEnv.getHtmlLabelName(16597,user.getLanguage()) ));
          ...
          if (_jspEval6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_3.setName("assortmentid");
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/cpt/maintenance/CptAssortmentBrowser.jsp?resourceids=");
                ...
                _jsp_BrowserTag_3.setBrowserValue( ""+assortmentid );
                _jsp_BrowserTag_3.setBrowserSpanValue(CapitalAssortmentComInfo .getAssortmentName (assortmentid) );
...
String tableString=""+
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/report/CptRpCapitalGroupSum.jsp"), 6867090039627607916L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string150 = "\" class=\"e8_btn_submit\" onclick=\"onBtnSearchClick()\"/>\r\n			<input type=\"reset\" value=\"".toCharArray();

...
public class _cptcapitalchangetab__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((CptDetailColumnUtil.getDetailColumnConf("CptChange", user) ));
      out.write(_jsp_string143, 0, _jsp_string143.length);
      out.print((SystemEnv.getHtmlLabelName(129974,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelNames("15323",user.getLanguage())));
      out.write(_jsp_string146, 0, _jsp_string146.length);
      out.print((SystemEnv.getHtmlLabelNames("18620",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/manage/CptCapitalChangeTab.jsp"), -4520182466928541600L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string137 = "\" class=\"e8_btn_top\"  onclick=\"group1.addRow()\"/>\r\n			<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string146 = "\"+(i+1)+\"".toCharArray();
    ...
    _jsp_string138 = "\" class=\"e8_btn_top\"  onclick=\"group1.deleteRows()\"/>\r\n			<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string139 = "\" class=\"e8_btn_top\"  onclick=\"group1.copyRows()\"/>\r\n			<input type=\"button\" value=\"".toCharArray();

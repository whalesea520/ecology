...
public class _cptalertnumconftab__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(33511,user.getLanguage()) ));
...
tableString =   " <table  pageId=\""+pageId+"\"  instanceid=\"CptCapitalAssortmentTable\" tabletype=\"checkbox\"  pagesize=\""+PageIdConst.getPageSize(pageId,user.getUID(),"cpt")+"\"  >"+
      ...
      int _jsp_end_75 = _jsp_SplitPageTag_5.doEndTag();
      ...
      out.print((SystemEnv.getHtmlLabelName(82855,user.getLanguage()) ));
      out.write(_jsp_string162, 0, _jsp_string162.length);
      out.print((SystemEnv.getHtmlLabelName(82891,user.getLanguage()) ));
      out.write(_jsp_string163, 0, _jsp_string163.length);
      out.print((SystemEnv.getHtmlLabelName(33511,user.getLanguage()) ));
      out.write(_jsp_string164, 0, _jsp_string164.length);
      out.print((SystemEnv.getHtmlLabelNames("82933",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/conf/cptalertnumconftab.jsp"), -859588279610740105L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string149 = "<input type=text name=fnamark class=InputStyle value='".toCharArray();
    ...
    _jsp_string145 = "<input type=text name=flowTitle1 class=InputStyle value='".toCharArray();
    ...
    _jsp_string137 = "\" class=\"e8_btn_top\"  onclick=\"doSave()\"/>\r\n			<input type=\"button\" value=\"".toCharArray();
    _jsp_string88 = ");\r\n			}\r\n		}catch(e){}\r\n		".toCharArray();

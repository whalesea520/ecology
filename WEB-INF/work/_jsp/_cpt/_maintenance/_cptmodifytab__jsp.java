...
public class _cptmodifytab__jsp extends com.caucho.jsp.JavaPage
{
...
//                "           <col width=\"5%\"  text=\""+SystemEnv.getHtmlLabelName( 195 ,user.getLanguage())+"\" column=\"name\" linkvaluecolumn=\"id\"  linkkey=\"id\" href=\"/cpt/capital/CptCapital.jsp\" target=\"_fullwindow\" />"+
      ...
      out.print((SystemEnv.getHtmlLabelName(82856,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/maintenance/cptmodifytab.jsp"), 4717026817752150953L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string148 = "<input type=text name=fnamark class=InputStyle value='".toCharArray();
    ...
    _jsp_string136 = "\" />\r\n<input type=\"hidden\" name=\"submittype\" id=\"submittype\" value=\"0\" />\r\n<input type=\"hidden\" id=\"flowTitleTemp\" name=\"flowTitleTemp\" value=\"".toCharArray();
    ...
    _jsp_string146 = "<input type=text name=mark class=InputStyle value='".toCharArray();
    ...
    _jsp_string147 = "<input type=text name=capitalspec class=InputStyle value='".toCharArray();
    ...
    _jsp_string144 = "<input type=text name=cptname class=InputStyle value='".toCharArray();
    _jsp_string151 = "\r\n	    		<input class=\"zd_btn_submit\" type=\"submit\" name=\"submit1\" onclick=\"setFlowTitle(parent)\" value=\"".toCharArray();

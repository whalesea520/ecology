...
public class _cptassortmentedit__jsp extends com.caucho.jsp.JavaPage
{
...
String needhelp ="";
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("assest")+ "&" + "navName=" + com.caucho.el.Expr.toString(CapitalAssortmentComInfo.getAssortmentName(paraid) , null), false);
...
if(subcompanyid1>0){
              ...
              do {
                ...
                _jsp_BrowserTag_3.setIsMustInput("0");
                _jsp_BrowserTag_3.setCompleteUrl("/data.jsp?type=164");
                _jsp_BrowserTag_3.setBrowserValue(subcompanyid1>0?""+subcompanyid1:"");
                _jsp_BrowserTag_3.setBrowserSpanValue(subcompanyid1>0? SubCompanyComInfo.getSubCompanyname(String.valueOf(subcompanyid1)):"");
...
if(Util.getIntValue( supassortmentid,0)>0){
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelNames("596,831",user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                out.print((CapitalAssortmentComInfo.getAssortmentName(supassortmentid) ));
              ...
              do {
                ...
                _jsp_RequiredTag_4.setId("assortmentname_span");
                _jsp_RequiredTag_4.setValue(Util.toScreenToEdit(assortmentname,user.getLanguage()));
              ...
              do {
                ...
                _jsp_RequiredTag_4.setId("assortmentmark_span");
                _jsp_RequiredTag_4.setValue(Util.toScreenToEdit(assortmentmark,user.getLanguage()));
      ...
      out.print((SystemEnv.getHtmlLabelNames("83665",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/maintenance/CptAssortmentEdit.jsp"), -1047923498751550110L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string139 = "\" class=\"e8_btn_top\" onclick=\"onEdit();\">\r\n	".toCharArray();
    ...
    _jsp_string166 = "\r\n	\r\n\r\n\r\n<script language=javascript>\r\n function onEdit(){\r\n 	if(check_form(document.frmMain,'assortmentmark,assortmentname')){\r\n 		document.frmMain.operation.value=\"editassortment\";\r\n		//document.frmMain.submit();\r\n		var supassortmentid='".toCharArray();
    _jsp_string162 = "\r\n    		<input class=\"zd_btn_cancle\" type=\"button\" name=\"cancel\" onclick=\"parentWin.closeDialog();\"  value=\"".toCharArray();
    ...
    _jsp_string157 = "\r\n			<TEXTAREA  style=\"WIDTH:95%;overflow-x:visible;overflow-y:visible;\" name=Remark rows=8>".toCharArray();
    _jsp_string163 = "\"/>\r\n    	".toCharArray();

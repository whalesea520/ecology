...
public class _cptassortmentsharedsp__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelNames("611",user.getLanguage())));
...
tableString =   " <table  pageId=\""+pageId+"\"  instanceid=\"CptCapitalAssortmentTable\" tabletype=\"checkbox\"  pagesize=\""+PageIdConst.getPageSize(pageId,user.getUID(),"cpt")+"\"  >"+
      ...
      out.print((SystemEnv.getHtmlLabelNames("83671",user.getLanguage())));
      out.write(_jsp_string148, 0, _jsp_string148.length);
      out.print((SystemEnv.getHtmlLabelNames("83672",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/maintenance/CptAssortmentShareDsp.jsp"), 921211067367970351L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string144 = "\" class=\"e8_btn_submit\"/>\r\n			<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string140 = ");\"/>\r\n			<input type=\"button\" value=\"".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string150 = "<br><img style='margin-top:-20px;' src='/images/ecology8/loadingSearch_wev8.gif' /></div>\";\r\n			diag_tooltip.show();\r\n			\r\n			jQuery.post(\r\n				\"/cpt/maintenance/AssortShareOperation.jsp\",\r\n				{\"method\":\"delete\",\"id\":id,\"assortid\":'".toCharArray();
    ...
    _jsp_string65 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string154 = "<br><img style='margin-top:-20px;' src='/images/ecology8/loadingSearch_wev8.gif' /></div>\";\r\n		diag_tooltip.show();\r\n		jQuery.post(\r\n			\"/cpt/maintenance/AssortShareOperation.jsp\",\r\n			{\"method\":\"batchdelete\",\"id\":typeids,\"assortid\":'".toCharArray();

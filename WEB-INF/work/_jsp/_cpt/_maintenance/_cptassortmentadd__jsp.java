...
public class _cptassortmentadd__jsp extends com.caucho.jsp.JavaPage
{
...
String needhelp ="";
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("assest")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelNames("831",user.getLanguage()) , null), false);
...
if(Util.getIntValue(supassortmentid)>0){
                ...
                out.write(_jsp_string143, 0, _jsp_string143.length);
                out.print((subcompanyid1>0? SubCompanyComInfo.getSubCompanyname(String.valueOf(subcompanyid1)):""));
                out.write(_jsp_string145, 0, _jsp_string145.length);
                out.print((subcompanyid1>0?""+subcompanyid1:""));
...
if(Util.getIntValue( supassortmentid,0)>0){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/maintenance/CptAssortmentAdd.jsp"), -1650964385167769793L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string76 = "\" class=\"e8_btn_top\" onclick=\"submitData();\">\r\n			<span title=\"".toCharArray();

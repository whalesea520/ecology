...
public class _cptcapitaltypetab__jsp extends com.caucho.jsp.JavaPage
{
...
tableString =   " <table pageId=\""+pageId+"\" instanceid=\"CptCapitalAssortmentTable\" tabletype=\"checkbox\"  pagesize=\""+PageIdConst.getPageSize(pageId,user.getUID(),"cpt")+"\"  >"+
      ...
      out.print((SystemEnv.getHtmlLabelNames("83681",user.getLanguage())));
      out.write(_jsp_string159, 0, _jsp_string159.length);
      out.print((SystemEnv.getHtmlLabelNames("83683",user.getLanguage())));
      out.write(_jsp_string160, 0, _jsp_string160.length);
      out.print((SystemEnv.getHtmlLabelNames("83685",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/maintenance/CptCapitalTypeTab.jsp"), 4277175381451696178L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string150 = "<input  name=typedesc class=InputStyle value='".toCharArray();
    ...
    _jsp_string140 = "\" class=\"e8_btn_top\" onclick=\"batchDel()\"/>\r\n			".toCharArray();
    ...
    _jsp_string138 = "\" class=\"e8_btn_top\"  onclick=\"addSub()\"/>\r\n			".toCharArray();
    _jsp_string154 = "\"  />\r\n			    	".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    ...
    _jsp_string148 = "<input  name=nameQuery class=InputStyle value='".toCharArray();
    _jsp_string15 = "\\r\\n\\r\\n".toCharArray();

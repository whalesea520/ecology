...
public class _cptcapitaltypeadd__jsp extends com.caucho.jsp.JavaPage
{
...
if(HrmUserVarify.checkUserRight("CptCapitalTypeAdd:Add", user)){
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(21942,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
      ...
      out.print((SystemEnv.getHtmlLabelNames("83676",user.getLanguage())));
      out.write(_jsp_string157, 0, _jsp_string157.length);
      out.print((SystemEnv.getHtmlLabelNames("83677",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("cpt/maintenance/CptCapitalTypeAdd.jsp"), -1330053733456120871L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string147 = "<INPUT type=text size=60 maxlength=100 name=\"typecode\" class=\"InputStyle\">".toCharArray();
  }
}

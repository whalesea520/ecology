...
public class _citybrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelNames("493",user.getLanguage())));
...
RCMenuHeight += RCMenuHeightStep ;
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((curcountryid));
                out.write(_jsp_string88, 0, _jsp_string88.length);
                out.print((selected));
                out.write('>');
                out.print((Util.toScreen(curcountryname,user.getLanguage())));
     ...
     while(rs.next()) {
     	...
     	if(curprovinceid.equals(provinceid+""))	selected="selected";
                ...
                out.print((curprovinceid));
                out.write(_jsp_string88, 0, _jsp_string88.length);
                out.print((selected));
                out.write('>');
                out.print((Util.toScreen(curprovincename,user.getLanguage())));
...
do{
	if(i==0){
      ...
      out.print((Util.toScreen(ProvinceComInfo.getProvincename(rs.getString(5)),user.getLanguage())));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("web/broswer/CityBrowser.jsp"), -4688722610282230252L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string95 = "<input class=inputstyle name=cityname value='".toCharArray();
    ...
    _jsp_string94 = "\r\n     </select>\r\n		".toCharArray();
    _jsp_string82 = "	\r\n<BUTTON type=\"button\" class=btn accessKey=2 id=btnclear onblur=\"submitClear()\"><U>2</U>-".toCharArray();
    ...
    _jsp_string81 = "\r\n<BUTTON class=btn accessKey=1 onclick=\"window.parent.close()\"><U>1</U>-".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string172 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.close();\">\r\n				<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string104 = "</TD>	<TD>".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string175 = "  == 1 ? true : false ;\r\n	var curr = ".toCharArray();
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();

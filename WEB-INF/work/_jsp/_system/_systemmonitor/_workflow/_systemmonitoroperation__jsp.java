...
public class _systemmonitoroperation__jsp extends com.caucho.jsp.JavaPage
{
...
else if("upallcontrol".equals(actionKey))
{
 ...
 response.sendRedirect("/system/systemmonitor/workflow/systemMonitorDetail.jsp?infoid="+infoid+"&typeid="+temptypeid+"&subcompanyid="+subcompanyid);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("system/systemmonitor/workflow/systemMonitorOperation.jsp"), 3706254154254950769L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

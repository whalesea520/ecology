...
package _jsp._system._systemmonitor;
...
public class _monitoroperation__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
  ...
  // String wheresql=sharemanager.getShareDetailWhere("doc",user);
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.conn.RecordSet RecordSetDelRq;
      RecordSetDelRq = (weaver.conn.RecordSet) pageContext.getAttribute("RecordSetDelRq");
      if (RecordSetDelRq == null) {
        RecordSetDelRq = new weaver.conn.RecordSet();
        pageContext.setAttribute("RecordSetDelRq", RecordSetDelRq);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.conn.RecordSet RecordSetDelDoc;
      RecordSetDelDoc = (weaver.conn.RecordSet) pageContext.getAttribute("RecordSetDelDoc");
      if (RecordSetDelDoc == null) {
        RecordSetDelDoc = new weaver.conn.RecordSet();
        pageContext.setAttribute("RecordSetDelDoc", RecordSetDelDoc);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.conn.RecordSet RecordSetDelCheck;
      RecordSetDelCheck = (weaver.conn.RecordSet) pageContext.getAttribute("RecordSetDelCheck");
      if (RecordSetDelCheck == null) {
        RecordSetDelCheck = new weaver.conn.RecordSet();
        pageContext.setAttribute("RecordSetDelCheck", RecordSetDelCheck);
      }
      out.write(_jsp_string2, 0, _jsp_string2.length);
      weaver.system.SysWFLMonitor wflm;
      wflm = (weaver.system.SysWFLMonitor) pageContext.getAttribute("wflm");
      if (wflm == null) {
        wflm = new weaver.system.SysWFLMonitor();
        pageContext.setAttribute("wflm", wflm);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.proj.Maint.ProjectInfoComInfo prjComInfo;
      prjComInfo = (weaver.proj.Maint.ProjectInfoComInfo) pageContext.getAttribute("prjComInfo");
      if (prjComInfo == null) {
        prjComInfo = new weaver.proj.Maint.ProjectInfoComInfo();
        pageContext.setAttribute("prjComInfo", prjComInfo);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
if(operation.equals("deleteproj")){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("system/systemmonitor/MonitorOperation.jsp"), 9138325616176765137L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

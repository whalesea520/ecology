...
public class _effectmanageempoweradd__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("resource")+ "&" + "navName=" + com.caucho.el.Expr.toString(titlename , null), false);
        ...
        do {
          ...
          if (_jspEval11 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelNames("33381,1507", user.getLanguage())));
			...
			if("".equals(pkcol)){
                ...
                _jsp_BrowserTag_3.setWidth("74%");
                _jsp_BrowserTag_3.setName("roleIds");
                _jsp_BrowserTag_3.setBrowserValue(browserRoleIds );
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/hrm/roles/HrmRolesBrowser.jsp?selectedids=#id#");
                _jsp_BrowserTag_3.setCompleteUrl("/data.jsp?type=65");
                _jsp_BrowserTag_3.setTemptitle( SystemEnv.getHtmlLabelName(122,user.getLanguage()));
                _jsp_BrowserTag_3.setBrowserSpanValue(shownameRoles );
                ...
                _jsp_BrowserTag_3.setBrowserValue(browserHrmIds );
                _jsp_BrowserTag_3.setBrowserUrl(new BrowserComInfo().getBrowserurl("1") );
                _jsp_BrowserTag_3.setCompleteUrl("/data.jsp?type=17");
                _jsp_BrowserTag_3.setTemptitle( SystemEnv.getHtmlLabelName(6087,user.getLanguage()));
                _jsp_BrowserTag_3.setBrowserSpanValue(shownameHrms );
          ...
          if (_jsp_GroupTag_4 == null) {
            ...
            _jsp_GroupTag_4.setAttributes("{'itemAreaDisplay':'display'}");
          }

          _jsp_GroupTag_4.setContext(SystemEnv.getHtmlLabelNames("33378",user.getLanguage()));
          ...
          if (_jspEval23 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelNames("15433", user.getLanguage())));
              ...
              do {
                ...
                _jsp_BrowserTag_6.setWidth("89%");
                _jsp_BrowserTag_6.setName("workflowids");
                _jsp_BrowserTag_6.setBrowserValue(Workflowids );
                _jsp_BrowserTag_6.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/workflow/workflow/WorkflowMutiBrowser.jsp?wfids=" );
                _jsp_BrowserTag_6.setCompleteUrl("/data.jsp?type=workflowBrowser");
                _jsp_BrowserTag_6.setTemptitle( SystemEnv.getHtmlLabelNames("15433",user.getLanguage()));
                _jsp_BrowserTag_6.setBrowserSpanValue((Workflownames) );
              ...
              _jsp_ItemTag_5.setBodyContent(_jsp_endTagHack32);
              _jsp_ItemTag_5.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelNames("26268,92", user.getLanguage())));
              } while (_jsp_ItemTag_5.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_5.doEndTag();
              ...
              do {
                ...
                _jsp_BrowserTag_6.setBrowserValue(Docids );
                _jsp_BrowserTag_6.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/docs/category/DocMainCategoryMutiBrowser.jsp?mainCategoryIds=" );
                _jsp_BrowserTag_6.setCompleteUrl("/data.jsp?type=categoryBrowser&onlySec=true");
                _jsp_BrowserTag_6.setTemptitle( SystemEnv.getHtmlLabelNames("26268,92",user.getLanguage()));
                _jsp_BrowserTag_6.setBrowserSpanValue((Docnames) );
              ...
              _jsp_ItemTag_5.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelNames("582", user.getLanguage())));
              } while (_jsp_ItemTag_5.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_5.doEndTag();
              ...
              _jsp_ItemTag_5.setBodyContent(_jsp_endTagHack44);
              _jsp_ItemTag_5.doInitBody();
              do {
                out.write(_jsp_string159, 0, _jsp_string159.length);
                _jsp_BrowserTag_6 = new weaver.common.util.taglib.BrowserTag();
                ...
                _jsp_BrowserTag_6.setIsMustInput("1");
                _jsp_BrowserTag_6.setWidth("89%");
                _jsp_BrowserTag_6.setName("portalids");
                _jsp_BrowserTag_6.setBrowserValue(Portalids );
                _jsp_BrowserTag_6.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/portal/HpinfoMutiBrowser.jsp?hpinfoIds=" );
                _jsp_BrowserTag_6.setCompleteUrl("/data.jsp?type=HpinfoMutiBrowser");
                _jsp_BrowserTag_6.setTemptitle( SystemEnv.getHtmlLabelNames("582",user.getLanguage()));
                _jsp_BrowserTag_6.setBrowserSpanValue((Portalnames) );
              ...
              _jsp_ItemTag_5.setBodyContent(_jsp_endTagHack48);
              _jsp_ItemTag_5.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelNames("17855,34242", user.getLanguage())));
              } while (_jsp_ItemTag_5.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_5.doEndTag();
              ...
              do {
                ...
                _jsp_BrowserTag_6.setIsMustInput("1");
                _jsp_BrowserTag_6.setWidth("89%");
                _jsp_BrowserTag_6.setName("coworkids");
                _jsp_BrowserTag_6.setBrowserValue(Coworkids );
                _jsp_BrowserTag_6.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/cowork/MutiCoworkTypeBrowser.jsp?coworkTypeIds=" );
                _jsp_BrowserTag_6.setCompleteUrl("/data.jsp?type=coworktype");
                _jsp_BrowserTag_6.setTemptitle(SystemEnv.getHtmlLabelNames("17855,34242", user.getLanguage()));
                _jsp_BrowserTag_6.setBrowserSpanValue((Coworknames) );
      ...
      int _jspEval60 = _jsp_ViewTag_7.doStartTag();
      if (_jspEval60 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval60 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_7.setBodyContent(_jsp_endTagHack58);
        ...
        do {
          ...
          int _jspEval63 = _jsp_GroupTag_8.doStartTag();
          if (_jspEval63 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval63 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_8.setBodyContent(_jsp_endTagHack61);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("system/EffectManageEmpowerAdd.jsp"), -4201915588786620066L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string152 = "<input id=\"roleIds\" name=\"roleIds\" value=\"".toCharArray();
    ...
    _jsp_string154 = "\" type=\"hidden\" />".toCharArray();
    _jsp_string149 = "<span style=\"width: 40px;float: left;\">".toCharArray();
    _jsp_string73 = "\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string151 = "</span>\r\n					<input id=\"roleIdType\" name=\"roleIdType\" value=\"2\" type=\"hidden\" />".toCharArray();
    ...
    _jsp_string137 = "\" id=\"zd_btn_submit\" class=\"e8_btn_top\" onclick=\"onAdd();\">\r\n			<span title=\"".toCharArray();
    ...
    _jsp_string167 = "\"/><!-- \u53d6\u6d88 -->\r\n		    	".toCharArray();
    _jsp_string150 = "</span>\r\n					<input id=\"roleIdType\" name=\"roleIdType\" value=\"1\" type=\"hidden\" />".toCharArray();
    _jsp_string145 = "</option>\r\n				</select>\r\n				\r\n	            <span id=\"spanRoleId\" style=\"display: ".toCharArray();
    ...
    _jsp_string153 = "\" type=\"hidden\" />\r\n				<input id=\"hrmIds\" name=\"hrmIds\" value=\"".toCharArray();
    _jsp_string29 = "')) {\r\n				    lenck = false;\r\n				    break;\r\n			    }\r\n		    }\r\n		    if(lenck==false) return false;\r\n	    }\r\n	    catch(e) {}\r\n	    ".toCharArray();
    _jsp_string58 = "\r\n<meta http-equiv=\"".toCharArray();
    _jsp_string147 = "\r\n			    </span>\r\n	            <span id=\"spanHrmId\" style=\"display: ".toCharArray();
    _jsp_string158 = "<!-- \u5de5\u4f5c\u6d41\u7c7b\u578b -->\r\n		".toCharArray();

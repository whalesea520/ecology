...
public class _sysremindworkflowsetting__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("workflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelNames("23042,33234",user.getLanguage()) , null), false);
      out.write(_jsp_string139, 0, _jsp_string139.length);
      out.print(($label(81804,user.getLanguage()) ));
      ...
      out.print(($label(31524,user.getLanguage())));
      out.write(_jsp_string143, 0, _jsp_string143.length);
      if(module==1){ 
      out.write(_jsp_string141, 0, _jsp_string141.length);
      } 
      out.write(_jsp_string142, 0, _jsp_string142.length);
      out.print(($label(31525,user.getLanguage())));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print(($label(826,user.getLanguage()) ));
                out.write(_jsp_string148, 0, _jsp_string148.length);
                out.print(($label(311,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("system/sysremind/SysRemindWorkflowSetting.jsp"), 5029230548566838333L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string150 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"doClose()\"/>\r\n				".toCharArray();
    ...
    _jsp_string149 = "\" id=\"btnClean\"  class=\"zd_btn_cancle\" onclick=\"doCleanAll()\"/>	\r\n			    	<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string148 = "\" id=\"btnOk\"  class=\"zd_btn_cancle\" onclick=\"doOk(this)\"/>\r\n					<input type=\"button\" value=\"".toCharArray();

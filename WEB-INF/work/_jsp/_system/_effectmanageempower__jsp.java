...
public class _effectmanageempower__jsp extends com.caucho.jsp.JavaPage
{
...
if(HrmUserVarify.checkUserRight("FnaYearsPeriods:Log",user)) {
	...
	RCMenuHeight += RCMenuHeightStep ;	
      ...
      out.print((SystemEnv.getHtmlLabelNames("365,18361,33378", user.getLanguage()) ));
      out.write(_jsp_string74, 0, _jsp_string74.length);
      out.print((SystemEnv.getHtmlLabelNames("93,18361,33378", user.getLanguage()) ));
...
if(userightmenu!=1){
          ...
          if (_jspEval7 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_3.setBrowserSpanValue(rolesComInfo.getRolesRemark(roleids) );
              ...
              do {
                ...
                _jsp_BrowserTag_3.setIsMustInput("1");
                _jsp_BrowserTag_3.setWidth("74%");
                _jsp_BrowserTag_3.setName("resourceids");
                _jsp_BrowserTag_3.setBrowserValue(resourceids );
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/hrm/resource/ResourceBrowser.jsp?selectedids=#id#");
                ...
                _jsp_BrowserTag_3.setBrowserSpanValue(resourceComInfo.getLastname(resourceids) );
	...
	tableString = "<table instanceid=\""+PageIdConst.Hrm_EffectManageEmpower+"\" tabletype=\"checkbox\"   pagesize=\""+PageIdConst.getPageSize(PageIdConst.Hrm_EffectManageEmpower,user.getUID(),PageIdConst.HRM)+"\" >"+
      ...
      out.print(( PageIdConst.Hrm_EffectManageEmpower ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("system/EffectManageEmpower.jsp"), 7008796737727719341L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string144 = "</span><span title=\"".toCharArray();
    _jsp_string148 = "\r\n					".toCharArray();
    ...
    _jsp_string150 = "\" class=\"e8_btn_submit\" onclick=\"onBtnSearchClick(1);\"/>\r\n					<input type=\"button\" value=\"".toCharArray();

...
public class _attentionreport__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((!"other".equals(from)?"block":"none"));
	...
	out.println("<div class='norecord'>"+SystemEnv.getHtmlLabelName(26963 ,user.getLanguage())+"</div>");	//\u5f53\u524d\u6ca1\u6709\u88ab\u5173\u6ce8\u7684\u4eba
      ...
      out.print((SystemEnv.getHtmlLabelName(25763 ,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("blog/attentionReport.jsp"), -5740519609300713479L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string157 = "\"<font color=\"red\">".toCharArray();
    _jsp_string137 = "\r\n\r\n<div style=\"width:100%;\">\r\n  <div align=\"center\" id=\"reportTitle\" class=\"reportTitle\" style=\"display: ".toCharArray();
    ...
    _jsp_string150 = "\uff1a\r\n		  <a href=\"javascript:void())\" onclick=\"changeReport(this,'blog')\" style=\"margin-right: 8px;\" class=\"items\">".toCharArray();
    ...
    _jsp_string164 = ">0) {  \r\n	     window.parent.displayLoading(1,\"data\");\r\n	     jQuery(\"#reportDiv\").load(\"attentionReportRecord.jsp?year=".toCharArray();
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    ...
    _jsp_string165 = "&month=".toCharArray();
    ...
    _jsp_string158 = "</font>/".toCharArray();
    _jsp_string141 = "><a href=\"javascript:changeMonth(".toCharArray();

...
public class _blogremind__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("blog")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(15148,user.getLanguage()) , null), false);
    ...
    List remindList=blogDao.getMsgRemidList(user,"remind",""); 
     ...
     for(int i=0;i<remindList.size();i++){ 
      ...
      out.print((SystemEnv.getHtmlLabelName(25659,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(18186,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(16631,user.getLanguage())+SystemEnv.getHtmlLabelName(25659,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(16631,user.getLanguage())+SystemEnv.getHtmlLabelName(18186,user.getLanguage())));
      out.write(_jsp_string163, 0, _jsp_string163.length);
      out.print((SystemEnv.getHtmlLabelName(129,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("blog/blogRemind.jsp"), 8092205726708721710L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string172 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"parent.getDialog(window).close();\">\r\n			".toCharArray();
    _jsp_string160 = "\r\n         <!-- \u5fae\u535a\u672a\u63d0\u4ea4\u63d0\u4ea4\u63d0\u9192 -->\r\n         <div><a href=\"viewBlog.jsp?blogid=".toCharArray();
    _jsp_string19 = "&time=\"+new Date()+\"&f_weaver_belongto_userid=".toCharArray();
    _jsp_string145 = "',-1)\">".toCharArray();
    ...
    _jsp_string163 = "\\\u201c\"+name+\"\\\u201d".toCharArray();
    _jsp_string121 = "\r\n							".toCharArray();
    ...
    _jsp_string61 = ")\">\r\n".toCharArray();
    _jsp_string146 = "</a> <!-- \u62d2\u7edd -->\r\n		       <a style=\"margin-right: 8px;color: #1d76a4;text-decoration: none;\" href=\"javascript:dealRequest(".toCharArray();
    ...
    _jsp_string167 = "</div>\");\r\n	    } \r\n	 }\r\n  }\r\n</script>\r\n ".toCharArray();
    _jsp_string139 = "\" class=\"msg\" style=\"width: 95%;border-bottom: #e3eef8 1px solid;margin-bottom: 8px;clear: both;height: 22px;background: url('/blog/images/remind_wev8.gif') no-repeat;padding-left: 20px;\">\r\n     <div style=\"text-align: left; float: left; padding-left: 5px;width:100%\">\r\n      ".toCharArray();
    ...
    _jsp_string141 = "\" target=\"_blank\" style=\"margin-right: 3px\">".toCharArray();
    _jsp_string143 = "</FONT></FONT><!-- \u5411\u4f60\u7533\u8bf7\u5173\u6ce8 -->\r\n		   </div>\r\n		   <div style=\"float: right;\">\r\n		       <a style=\"margin-right: 8px;color: #1d76a4;text-decoration: none;\" href=\"javascript:dealRequest(".toCharArray();
    ...
    _jsp_string138 = "\r\n   <div id=\"msg_".toCharArray();
    _jsp_string150 = "</div><!-- \u63a5\u53d7\u4e86\u4f60\u7684\u5173\u6ce8\u8bf7\u6c42 -->\r\n       ".toCharArray();
    _jsp_string55 = "/skins/".toCharArray();
    _jsp_string140 = "\r\n           <div style=\"text-decoration: none;float: left;\">\r\n			  <FONT class=font><FONT class=font><a href=\"viewBlog.jsp?blogid=".toCharArray();
    _jsp_string88 = ");\r\n			}\r\n		}catch(e){}\r\n		".toCharArray();

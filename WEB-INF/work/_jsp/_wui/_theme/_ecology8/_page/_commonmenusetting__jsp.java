...
public class _commonmenusetting__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	if ("1".equals(resourceType)) {/*\u603b\u90e8 z* \u5206\u90e8 s*  \u4e2a\u4eba r*  */
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("portal")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(32127, user.getLanguage()) , null), false);
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("wui/theme/ecology8/page/commonmenuSetting.jsp"), 1297067762012974349L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string167 = "&parentid=0&mode=visible&e=\" + new Date().getTime())\r\n	    	return \"/page/maint/menu/CommonMenuSettingListJSON.jsp?type=".toCharArray();
    ...
    _jsp_string125 = "\r\n							".toCharArray();
    _jsp_string164 = "&resourceType=".toCharArray();
    ...
    _jsp_string176 = ":\"+menuText; \r\n	 	showDialog(title,url,600,380,false);\r\n	}\r\n\r\n\r\n	function onAdd(parentMenuId,treeMenuId,parentMenuText){\r\n		var url = \"/systeminfo/menuconfig/MenuMaintenanceAdd.jsp?type=".toCharArray();
    _jsp_string144 = "\r\n</div>	\r\n".toCharArray();
    _jsp_string127 = "\"></td>\r\n							".toCharArray();
    _jsp_string46 = ";\r\nusbserial0 = \"".toCharArray();
    _jsp_string172 = "&sync=1&&subCompanyId=".toCharArray();
    ...
    _jsp_string182 = "\";\r\n	 	var title = \"".toCharArray();
    _jsp_string166 = "&parentid=\"+treeNode.id+\"&mode=visible&e=\" + new Date().getTime();\r\n	    } else {\r\n	    	//\u521d\u59cb\u5316\u65f6\r\n	    	//alert(\"/page/maint/menu/CommonMenuSettingListJSON.jsp?type=".toCharArray();
    ...
    _jsp_string179 = "&e=\" + new Date().getTime();;\r\n	 	var title = \"".toCharArray();
    _jsp_string170 = "&edit=sub&sync=1&subCompanyId=".toCharArray();
    _jsp_string116 = "\r\n	_menuDocument.getElementById(\"rightMenu\").style.visibility=\"visible\";\r\n	if (!_menuWindow.ActiveXObject) {\r\n		_menuDocument.getElementById(\"rightMenu\").style.display=\"\";\r\n	}\r\n	".toCharArray();
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string160 = "/images/homepage/setting_2_wev8.png'\\\" onmouseout=\\\"this.src='".toCharArray();
    ...
    _jsp_string173 = "e=\" + new Date().getTime();\r\n	 	\r\n	 	var title = \"".toCharArray();
    ...
    _jsp_string178 = "&sync=1&subCompanyId=".toCharArray();
    _jsp_string77 = "\r\n\r\n\r\n\r\n		".toCharArray();
    ...
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string153 = "/images/homepage/add_1_wev8.png' onclick=\\\"onAdd('\"+treeNode.id+\"','\"+treeNode.tId+\"','\"+treeNode.name+\"');\\\" title='".toCharArray();
    ...
    _jsp_string158 = "/images/homepage/edit_1_wev8.png'\\\"/>\"+\r\n				delStr+\r\n				\"&nbsp;&nbsp;&nbsp;&nbsp;<img z_tree=\\\"oprate_div_\"+treeNode.id+\"\\\" src='".toCharArray();
    ...
    _jsp_string156 = "/images/homepage/edit_1_wev8.png' onclick=\\\"onEdit('\"+treeNode.id+\"','\"+treeNode.tId+\"','\"+treeNode.name+\"');\\\" title='".toCharArray();
    _jsp_string181 = "&menuId=\"+menuId+\"&resourceId=".toCharArray();
    _jsp_string159 = "/images/homepage/setting_1_wev8.png' onclick=\\\"onShare('\"+treeNode.id+\"','\"+treeNode.tId+\"','\"+treeNode.name+\"');\\\" title='".toCharArray();
    ...
    _jsp_string97 = "px\">\r\n</iframe>\r\n</div>\r\n".toCharArray();
    _jsp_string161 = "/images/homepage/setting_1_wev8.png'\\\"/>\";\r\n			jQuery(aObj).append(oprateStr);\r\n		}else{\r\n			var	oprateStr = \"<img style=\\\"margin-left:40px;\\\" z_tree=\\\"oprate_div_\"+treeNode.id+\"\\\" src='".toCharArray();
    _jsp_string151 = "/images/homepage/del_2_wev8.png'\\\" onmouseout=\\\"this.src='".toCharArray();

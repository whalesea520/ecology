...
public class _matrixmaint__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("resource")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(19909, user.getLanguage())+SystemEnv.getHtmlLabelName(33508, user.getLanguage()) , null), false);
      ...
      out.print((SystemEnv.getHtmlLabelName(33940, user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("matrixmanage/pages/MatrixMaint.jsp"), 4564091955830935910L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string139 = "\" style=\"font-size: 12px;cursor: pointer;\">\r\n					<input class=\"e8_btn_top middle\" onclick=\"doDel()\" type=\"button\" jQuery1392950000546=\"32\" value=\"".toCharArray();
    ...
    _jsp_string145 = "\uff1f\",function(){\r\n	        $.post(\"/matrixmanage/pages/MatrixMaintOperation.jsp?method=delete&delids=\"+ids+\"&matrixid=".toCharArray();
    ...
    _jsp_string137 = ")\" type=\"button\" jQuery1392950000546=\"32\" value=\"".toCharArray();
    _jsp_string70 = "\";\r\n	var fav_querystring = \"".toCharArray();
    _jsp_string37 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string136 = "\" style=\"font-size: 12px;cursor: pointer;\">\r\n					<input class=\"e8_btn_top middle\" onclick=\"doAdd(".toCharArray();

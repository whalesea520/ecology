...
public class _massmaint__jsp extends com.caucho.jsp.JavaPage
{
...
if (!canmaint) {
	...
	return;
      ...
      out.print((SystemEnv.getHtmlLabelName(83065, user.getLanguage()) ));
      out.write(_jsp_string67, 0, _jsp_string67.length);
      out.print((SystemEnv.getHtmlLabelName(83066, user.getLanguage()) ));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelName(83067, user.getLanguage()) ));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((SystemEnv.getHtmlLabelName(83068, user.getLanguage()) ));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((SystemEnv.getHtmlLabelName(83069, user.getLanguage()) ));
      out.write(_jsp_string71, 0, _jsp_string71.length);
      out.print((SystemEnv.getHtmlLabelName(83070, user.getLanguage()) ));
      out.write(_jsp_string72, 0, _jsp_string72.length);
      out.print((SystemEnv.getHtmlLabelName(83071, user.getLanguage()) ));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(83935,user.getLanguage())));
      out.write(_jsp_string144, 0, _jsp_string144.length);
      out.print((SystemEnv.getHtmlLabelName(83936 ,user.getLanguage())));
      ...
      _jsp_BrowserTag_0.setName("objid");
      ...
      _jsp_BrowserTag_0.set_callback("afterCallBack");
      ...
      out.print((SystemEnv.getHtmlLabelName(83020, user.getLanguage()) ));
      ...
      _jsp_BrowserTag_1.setName("newobjid");
      _jsp_BrowserTag_1.setBrowserValue("");
      _jsp_BrowserTag_1.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/hrm/resource/ResourceBrowser.jsp");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("matrixmanage/pages/MassMaint.jsp"), 484062888839764858L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string81 = "\r\n\r\n\r\n		".toCharArray();
    _jsp_string144 = "\" style=\"float:left;width:77px;height:77px;background:url('/images/ecology8/workflow/permission1_wev8.png');text-align: center;line-height:77px;color:#fff;font-size:22px;margin:0 auto;margin-top:12px;margin-left:20px;\">\r\n					0\r\n				</div>\r\n				<div style=\"float:left;width:129px;height:62px;margin-top:21px;margin-left:39px;\">\r\n					<div style=\"margin:0 auto;\">\r\n						<select id=\"objtype\" name=\"objtype\" title=\"".toCharArray();
    _jsp_string69 = "\");\r\n	        			return;\r\n	        		}\r\n	        		if ($(\"#count\").html() == 0) {\r\n	        			window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string145 = "\" style=\"height:28px;width:101px;\">\r\n							 ".toCharArray();

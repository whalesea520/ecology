...
public class _matrixtable__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(83989,user.getLanguage())));
      out.write(_jsp_string149, 0, _jsp_string149.length);
      out.print((SystemEnv.getHtmlLabelName("".equals(issystem)?84459:84614,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(84015, user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("matrixmanage/pages/matrixtable.jsp"), 103370512166630232L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string156 = "&issystem=".toCharArray();
    ...
    _jsp_string141 = "\" id=\"zd_btn_submit\" class=\"e8_btn_top\" onclick=\"matrixtable.saveTableData()\">\r\n	   			<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string152 = "';\r\n        	var isoutusermatrix='".toCharArray();
    _jsp_string137 = "\r\n	   			<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string143 = "\" id=\"zd_btn_submit\" class=\"e8_btn_top\" onclick=\"exportData()\">\r\n		      	<a id=\"exportData1\" href='' style=\"color:blue;display: none;\"></a>  					\r\n			".toCharArray();
    ...
    _jsp_string138 = "\" id=\"zd_btn_submit\" class=\"e8_btn_top\" onclick=\"matrixtable.insertARow()\">	\r\n	   			<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string145 = "\" class=\"cornerMenu\"></span>\r\n		</td>\r\n	</tr>\r\n</table>  \r\n\r\n       <div>\r\n	       \r\n	       <!--\u5206\u9875\u6570\u636e\u5bb9\u5668-->\r\n			<div class='pagewrapper' style=\"margin-bottom: -10px;\" title='".toCharArray();
    _jsp_string35 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string157 = "\";\r\n				dialog.Title = \"".toCharArray();
    _jsp_string142 = "\" id=\"zd_btn_submit\" class=\"e8_btn_top\" onclick=\"os()\">\r\n	   			<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string158 = "\";\r\n				dialog.Width = 800;\r\n				dialog.Height = 470;\r\n				dialog.Drag = true;\r\n				dialog.URL = url;\r\n				dialog.show();\r\n				\r\n				return dialog;\r\n			} \r\n			function os(){\r\n			   var v = openDialog();\r\n			}\r\n			function exportData(){\r\n				var	matrixUrl = \"/matrixmanage/pages/MatrixExportToFile.jsp?method=exportDataNoSQ&matrixid=".toCharArray();
    ...
    _jsp_string139 = "\" id=\"zd_btn_submit\" class=\"e8_btn_top\" onclick=\"matrixtable.removeItems()\">\r\n	   			".toCharArray();

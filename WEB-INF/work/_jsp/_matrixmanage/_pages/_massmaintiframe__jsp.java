...
public class _massmaintiframe__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      weaver.conn.RecordSet FieldRecord;
      FieldRecord = (weaver.conn.RecordSet) pageContext.getAttribute("FieldRecord");
      if (FieldRecord == null) {
        FieldRecord = new weaver.conn.RecordSet();
        pageContext.setAttribute("FieldRecord", FieldRecord);
      }
      out.write(_jsp_string1, 0, _jsp_string1.length);
      weaver.conn.RecordSet DataRecord;
      DataRecord = (weaver.conn.RecordSet) pageContext.getAttribute("DataRecord");
      if (DataRecord == null) {
        DataRecord = new weaver.conn.RecordSet();
        pageContext.setAttribute("DataRecord", DataRecord);
      }
      out.write(_jsp_string1, 0, _jsp_string1.length);
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((prop.getProperty("colwidth") ));
      out.write(_jsp_string143, 0, _jsp_string143.length);
      out.print((prop.getProperty("displayname") ));
      ...
      out.print((GetShowCondition.getShowCN("3",prop.getProperty("browsertypeid"),DataRecord.getString(prop.getProperty("fieldname")),"0",fielddbtype) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("matrixmanage/pages/MassMaintIframe.jsp"), 83077918684064568L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string70 = "\");\r\n					\r\n					if(bindex!=-1){\r\n						searchStr=text.substr(bindex,searchLength);\r\n						innerHtml=\"<label class='search_view'><font color='#39ae1f'>".toCharArray();

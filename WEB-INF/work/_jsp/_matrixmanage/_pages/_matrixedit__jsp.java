...
public class _matrixedit__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("resource")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(33926,user.getLanguage()) , null), false);
      out.write(_jsp_string2, 0, _jsp_string2.length);
      ...
      out.print((SystemEnv.getHtmlLabelName(84607,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("matrixmanage/pages/MatrixEdit.jsp"), -3218352565321148000L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string148 = "<nobr> \r\n	        <textarea name=\"descr\" class=inputstyle rows=\"5\" cols=\"12\" maxLength=\"50\">".toCharArray();
    _jsp_string103 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string136 = "\r\n	".toCharArray();
    ...
    _jsp_string146 = "\" size=25 name=name id=name onchange='checkinput(\"name\",\"nameimage\")'>\r\n			".toCharArray();
    _jsp_string61 = ")\">\r\n".toCharArray();
    ...
    _jsp_string145 = "\r\n				<INPUT class=inputstyle type=text maxLength=20 value=\"".toCharArray();
    ...
    _jsp_string152 = " \r\n<script language=javascript>\r\nvar dialog = parent.getDialog(window); \r\nvar parentWin = parent.getParentWindow(window);	\r\nfunction doSubmit() {\r\n	var name = $(\"#name\").val();\r\n  if(check_form(frmMain,\"name\")){\r\n	$.ajax({\r\n		 data:{\"nameStr\":name,\"method\":\"edit\",\"matrixid\":\"".toCharArray();

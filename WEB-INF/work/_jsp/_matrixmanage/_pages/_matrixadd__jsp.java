...
public class _matrixadd__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(83937,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(83938,user.getLanguage())));
      out.write(_jsp_string152, 0, _jsp_string152.length);
      out.print((SystemEnv.getHtmlLabelName(83938,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("matrixmanage/pages/MatrixAdd.jsp"), -2633017452051661634L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string139 = "\" style=\"font-size: 12px;cursor: pointer;\">\r\n				<input class=\"e8_btn_top middle\" id=\"dosubmit\" onclick=\"doSubmit()\" type=\"button\" jQuery1392950000546=\"32\" value=\"".toCharArray();
    _jsp_string123 = "\"></td>\r\n							".toCharArray();

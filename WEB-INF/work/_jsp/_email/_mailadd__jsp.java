...
String needhelp ="";
      ...
      out.print((SystemEnv.getHtmlLabelName(19943, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(19940,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(19965, user.getLanguage())));
      out.write(_jsp_string88, 0, _jsp_string88.length);
      out.print((SystemEnv.getHtmlLabelName(19944, user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(571, user.getLanguage())));
      ...
      out.print((rs.getString("accountName")));
      ...
      out.print(((!"".equals(_sendcc) && (flag==2 || flag==4))?"none":"inline" ));
      ...
      out.print(((!"".equals(_sendbcc) && flag==4)?"none":"inline" ));
      out.write(_jsp_string173, 0, _jsp_string173.length);
      ...
      out.print((rs.getString("mouldname")));
      ...
      out.print((rs.getString("templateName")));
      out.write(_jsp_string193, 0, _jsp_string193.length);
      }
      ...
      out.print((SystemEnv.getHtmlLabelName(24268, user.getLanguage())));
      ...
      out.print((rs.getString("signName")));
	...
	if(flag==3 || flag==4){
      ...
      out.print((wmc.getCurrentFilenum()));
      out.write(_jsp_string216, 0, _jsp_string216.length);
      out.print((linkstr));
      out.write(_jsp_string173, 0, _jsp_string173.length);
      out.print((wmc.getCurrentFilename()));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("email/MailAdd.jsp"), -8482709730302542236L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string164 = "</td>\r\n				</tr>\r\n			</table>\r\n		</td>\r\n	</tr>\r\n	".toCharArray();
    _jsp_string128 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string183 = "\"><td class=\"Line\" colspan=\"2\"></td></tr>\r\n<tr id=\"tdBCC\" style=\"display:none\" height=\"20\">\r\n	<td valign=\"top\">\r\n	<div id=\"receiverSelectorBCC\" name=\"receiverSelectorBCC\" class=\"receiverSelector\">".toCharArray();
    _jsp_string22 = "\";\r\n	    xmlhttp.open(\"GET\",URL, false);\r\n	    xmlhttp.send(null);\r\n	    var result = xmlhttp.status;\r\n	    if(result==200) {\r\n		    isconn = true;\r\n	    	var response_flag = xmlhttp.responseText;\r\n	    	if(response_flag!='0') {\r\n	    		var flag_msg = '';\r\n	    		if(response_flag=='1') {\r\n	    			var diag = new Dialog();\r\n					diag.Width = 300;\r\n					diag.Height = 180;\r\n					diag.ShowCloseButton=false;\r\n					diag.Title = \"".toCharArray();
    _jsp_string132 = "\";\r\nvar __closeRightMenu__ = ".toCharArray();
    _jsp_string88 = "\";});\r\n	}else{//minimize\r\n		toggleSelect(\"\");\r\n		o.position = \"relative\";\r\n		o.top = \"\";\r\n		o.height = \"100%\";\r\n		btn.innerHTML = btn.innerHTML.replace(/(<.*>)(.*)/ig, function(){return arguments[1]+\" ".toCharArray();
    ...
    _jsp_string184 = "\u3000 <img src=\"/images/menuArrowDown_wev8.gif\" align=\"absmiddle\" /></div>\r\n	</td>\r\n	<td class=\"Field\">\r\n		<textarea id=\"receiverBCC\" name=\"receiverBCC\" class=\"inputstyle\">".toCharArray();
    ...
    _jsp_string180 = "\" height=\"20\">\r\n	<td valign=\"top\">\r\n	<div id=\"receiverSelectorCC\" class=\"receiverSelector\">".toCharArray();
    ...
    _jsp_string207 = "</td>\r\n	<td class=\"Field\">\r\n		<input type=\"text\" id=\"mailSubject\" name=\"mailSubject\" class=\"inputstyle\" value=\"".toCharArray();
    _jsp_string83 = "</button></div>\";\r\n	new Insertion.Before(e, inputFileHTML);\r\n	\r\n}\r\nfunction removeAttachment(o){\r\n	Element.remove(o.parentNode);\r\n	$(\"attachmentCount\").value = parseInt($F(\"attachmentCount\")) - 1;\r\n}\r\nfunction deleteAttachment(fileId){\r\n	location.href = \"MailOperation.jsp?operation=deleteAttachment&flag=3&mailIds=".toCharArray();
    ...
    _jsp_string146 = "\r\n							".toCharArray();
    _jsp_string121 = "visible".toCharArray();
    ...
    _jsp_string209 = "</span>\r\n	</td>\r\n</tr>\r\n\r\n<tr style=\"height:1px\"><td class=\"Line\" colspan=\"2\"></td></tr>\r\n<tr>\r\n	<td colspan=\"2\">\r\n	<textarea name=\"mouldtext\" id=\"mouldtext\" style=\"display:none;width:100%;height:250\">".toCharArray();
    _jsp_string172 = " <img src=\"/images/menuArrowDown_wev8.gif\" align=\"absmiddle\" /></div>\r\n	<div style=\"margin-top:2px\">\r\n	<span id=\"btnAddCC\" class=\"href\" style=\"display:".toCharArray();
    ...
    _jsp_string69 = "\r\n		setTimeout(\"loadTemplate(".toCharArray();
    _jsp_string226 = "</option>\r\n		<option value=\"2\" ".toCharArray();
    _jsp_string178 = "</span>\r\n		<!-- <input type=\"text\" id=\"receiver\" name=\"receiver\" class=\"inputstyle\" value=\"".toCharArray();
    ...
    _jsp_string174 = "</span> <span id=\"btnAddBCC\" class=\"href\" style=\"display:".toCharArray();
    _jsp_string148 = "\"></td>\r\n							".toCharArray();
    _jsp_string214 = "</td>\r\n	<td class=\"field\">\r\n	".toCharArray();
    _jsp_string169 = ">\r\n			".toCharArray();
    ...
    _jsp_string217 = "</a>\r\n	</td>\r\n	<td style=\"text-align:right\">\r\n		<button class=\"btnDelete\" onClick=\"deleteAttachment(".toCharArray();
    _jsp_string153 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result6\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string181 = "\u3000 <img src=\"/images/menuArrowDown_wev8.gif\" align=\"absmiddle\" /></div>\r\n	</td>\r\n	<td class=\"Field\">\r\n		<textarea id=\"receiverCC\" name=\"receiverCC\" class=\"inputstyle\">".toCharArray();
    _jsp_string6 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    ...
    _jsp_string210 = "</textarea>\r\n\r\n	<textarea name=\"mouldtext_temp\" id=\"mouldtext_temp\" style=\"display:none;width:100%;height:250\">".toCharArray();
    _jsp_string15 = "\";\r\nfunction check_conn() {\r\n	return confirm('".toCharArray();
    _jsp_string228 = "</option>\r\n		</select>\r\n</tr>\r\n	</td>\r\n</tr>\r\n<tr style=\"height:1px\"><td class=\"Line\" colspan=\"2\"></td></tr>\r\n<input type=\"hidden\" name=\"hasfile\" id=\"hasfile\" value=\"".toCharArray();
    ...
    _jsp_string203 = "\r\n					<div id=\"signContent_".toCharArray();
    ...
    _jsp_string204 = "\" style=\"display:none;\">".toCharArray();
    _jsp_string12 = "\r\n<!-- IE\u4e0b\u4e13\u7528vbs\uff08\u4e34\u65f6\uff09 -->\r\n<script language=\"vbs\" src=\"/js/string2VbArray.vbs\"></script>        \r\n        ".toCharArray();
    _jsp_string219 = "\r\n		</button>\r\n		<button class=\"btnSave\" onClick=\"parent.location.href='".toCharArray();
    _jsp_string2 = "\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string188 = "</option>\r\n		</select>\r\n		</td>\r\n		<!-- \u6a21\u677f============================================= -->\r\n		<td style=\"background-color:#FFF\">&nbsp;".toCharArray();
    _jsp_string82 = "</button></div>\";\r\n	jQuery(\"#btnAddAttachment\").before(inputFileHTML);\r\n    */\r\n    \r\n    $(\"attachmentCount\").value = parseInt($F(\"attachmentCount\")) + 1;\r\n	var inputFileHTML = \"<div><input type='file' ".toCharArray();
    _jsp_string103 = ">1 ? Math.ceil(bodyWidth/".toCharArray();
    ...
    _jsp_string111 = " oncontextmenu='return false'".toCharArray();
    ...
    _jsp_string26 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string91 = " STYLE=\"margin:0px;padding:0px;width:0px;height:0px;overflow:hidden;\"></object>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string37 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string117 = "px\" height=\"".toCharArray();
    _jsp_string201 = "\r\n						</option>\r\n						".toCharArray();
    _jsp_string177 = "<img src='/images/BacoError_wev8.gif' align=\"absMiddle\">".toCharArray();
    ...
    _jsp_string122 = ";display:none;\" align=\"left\"  allowtransparency=\"true\" style=\"background-color:transparent\" >\r\n	</div>\r\n	<div id=\"divRightMenuIframe\" name=\"divRightMenuIframe\" style=\"display:none\">\r\n		<iframe id=\"rightMenuIframe\" name=\"rightMenuIframe\" frameborder=0 marginheight=0 marginwidth=0 hspace=0 vspace=0 scrolling=no width=\"".toCharArray();
    _jsp_string220 = "&download=1'\">\r\n			-".toCharArray();
    _jsp_string193 = "\r\n			</option>\r\n			".toCharArray();
    ...
    _jsp_string234 = "\"+fileLenthName+\",".toCharArray();
    ...
    _jsp_string78 = " name='attachfile\"+$F(\"attachmentCount\")+\"' class='inputstyle' style='width: 70%' />".toCharArray();
    _jsp_string120 = "hidden".toCharArray();
    _jsp_string41 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string216 = "\" cellpadding=\"0\" cellspacing=\"0\" style=\"width:100%;border:1px solid #FFF\">\r\n	<tr>\r\n	<td>\r\n		<a href=\"".toCharArray();
    _jsp_string163 = "\r\n	<tr height=\"22\">\r\n		<td class=\"popupMenuRow\" \r\n			id=\"receiverCRM\"\r\n			onmouseover=\"this.className='popupMenuRowHover'\"\r\n			onmouseout=\"this.className='popupMenuRow'\">\r\n			<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" width=\"100%\" height=\"100%\">\r\n				<tr>\r\n					<td width=\"28\"><img src=\"/images/BacoBrowser_wev8.gif\" /></td>\r\n					<td onClick=\"\">".toCharArray();
    _jsp_string170 = "\r\n		</option>\r\n		".toCharArray();
    ...
    _jsp_string176 = "</textarea>\r\n		<span id=\"receiverSpan\">".toCharArray();
    _jsp_string223 = "</span>\r\n	</td>\r\n</tr>\r\n<tr style=\"height:1px\"><td class=\"Line\" colspan=\"2\"></td></tr>\r\n<tr height=\"20\">\r\n	<td>".toCharArray();
    ...
    _jsp_string215 = "\r\n	<table id=\"attachmentTable_".toCharArray();
    ...
    _jsp_string85 = "\");//\u90ae\u4ef6\u5730\u5740\u683c\u5f0f\u9519\u8bef\r\n			return false;\r\n		}\r\n	}\r\n	return false;\r\n}\r\nfunction doSend(obj){\r\n	if(!validateForm()) return false;\r\n	hideRightClickMenu();\r\n	showMsgBox($(\"msgBox\"), \"<img src='/images/loading2_wev8.gif'> ".toCharArray();
    _jsp_string231 = "\r\n			document.all(\"btnAddBCC\").click();\r\n	".toCharArray();
    _jsp_string90 = " \r\n<object ID=\"File\" ".toCharArray();
  }
}

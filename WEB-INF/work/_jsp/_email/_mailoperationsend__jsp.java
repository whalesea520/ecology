...
public class _mailoperationsend__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      weaver.email.MailSend mailSend;
      mailSend = (weaver.email.MailSend) pageContext.getAttribute("mailSend");
      if (mailSend == null) {
        mailSend = new weaver.email.MailSend();
        pageContext.setAttribute("mailSend", mailSend);
      }
...
if("false".equals(isSent)){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("email/MailOperationSend.jsp"), 7515048736990639661L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

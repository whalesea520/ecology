...
public class _mailremindedit__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("mail")+ "&" + "navName=" + ("\u90ae\u4ef6\u5f85\u529e\u8bbe\u7f6e"), false);
      out.write(_jsp_string2, 0, _jsp_string2.length);
      ...
      _jsp_ViewTag_0.setAttributes("{'expandAllGroup':'true', cols:3}");
      ...
      if (_jspEval14 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext("\u5f85\u529e\u90ae\u4ef6\u63d0\u9192");
          ...
          if (_jspEval17 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                if((mri.getId()+"").equals(rid))out.print("selected='selected'"); 
                out.write('>');
                out.print((mri.getName() ));
              ...
              do {
                ...
                if("1".equals(enable))out.println("checked=checked");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("email/maint/MailRemindEdit.jsp"), 6754464239478023074L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string153 = "\u63d0\u9192\u5185\u5bb9".toCharArray();
    ...
    _jsp_string154 = "\r\n							<div style=\"float:left\">\r\n								<textarea type=\"textarea\" id='content' name=\"content\" wrap=\"virtual\" style=\"resize: none;line-height:17px; height:107px;width:350px\" >".toCharArray();
    _jsp_string152 = " />\r\n						".toCharArray();
    _jsp_string142 = "\r\n					".toCharArray();
    ...
    _jsp_string151 = "\r\n								<input type=\"checkbox\" tzCheckbox=\"true\" name=\"enable\" id=\"enable\" value=\"1\" class=\"inputstyle\" ".toCharArray();
    ...
    _jsp_string41 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string144 = "\u63d0\u9192\u65b9\u5f0f".toCharArray();

...
import weaver.email.service.MailGuideService;
import java.util.*;
import java.net.*;
import weaver.hrm.*;
...
public class _mailinbox__jsp extends com.caucho.jsp.JavaPage
{
...
if(userLayout==1){
 ...
 if(folderid.equals("")&&opNewEmail.equals("1")){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("email/new/MailInBox.jsp"), -2532558359582252741L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string74 = "',html:jcTabs[0],closable: false}\r\n        ]\r\n    });\r\n	".toCharArray();
    ...
    _jsp_string75 = "\r\n			addTab(\"1\",\"/email/new/MailAdd.jsp?internalto=".toCharArray();
    ...
    _jsp_string78 = "&fileid=".toCharArray();
    _jsp_string61 = ")\">\r\n".toCharArray();
    _jsp_string72 = "\" width=\"100%\" height=\"100%\" frameborder=\"0\" id=\"mainConEmail\" ></iframe>'\r\n];\r\nvar tempid=1;\r\n\r\n\r\n$(document).ready(function(){  \r\n	\r\n	//alert($(\"body\").height());\r\n	$(\"#tab\").height($(\"body\").height()-30);\r\n	var tabHeight=$(\"body\").height()-30;\r\n	var maxLength=($(\"#tab\").width()-86)/104;\r\n    tabpanel = new TabPanel({  \r\n        renderTo:'tab',  \r\n        //border:'none',  \r\n        height:tabHeight,\r\n        active : 0,\r\n        autoResizable:true,\r\n        maxLength : maxLength,  \r\n        items : [\r\n          		  {id:'".toCharArray();
    ...
    _jsp_string37 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string77 = "&isInternal=".toCharArray();
    _jsp_string80 = "\");\r\n			\r\n	".toCharArray();

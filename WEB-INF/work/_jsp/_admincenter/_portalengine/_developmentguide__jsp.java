...
public class _developmentguide__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(124798,user.getLanguage())));
      out.write(_jsp_string136, 0, _jsp_string136.length);
      out.print((SystemEnv.getHtmlLabelName(33464,user.getLanguage())));
      out.write(_jsp_string137, 0, _jsp_string137.length);
      out.print((SystemEnv.getHtmlLabelName(124800,user.getLanguage())));
      out.write(_jsp_string138, 0, _jsp_string138.length);
      out.print((SystemEnv.getHtmlLabelName(33465,user.getLanguage())));
      out.write(_jsp_string139, 0, _jsp_string139.length);
      out.print((SystemEnv.getHtmlLabelName(124801,user.getLanguage())));
      out.write(_jsp_string140, 0, _jsp_string140.length);
      out.print((SystemEnv.getHtmlLabelName(124802,user.getLanguage())));
      out.write(_jsp_string141, 0, _jsp_string141.length);
      out.print((SystemEnv.getHtmlLabelName(124805,user.getLanguage())));
      out.write(_jsp_string142, 0, _jsp_string142.length);
      out.print((SystemEnv.getHtmlLabelName(124823,user.getLanguage())));
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(33668,user.getLanguage())+" Q&A");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("admincenter/portalEngine/DevelopmentGuide.jsp"), 2109213617443160131L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string137 = "</p><!--\u5143\u7d20\u5f00\u53d1-->\r\n				<p style=\"color: #9BA6CC;margin-top: 15px;font-weight: bold;margin-bottom: 30px;\">".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string138 = "</p><!--\u6309\u7167\u5f00\u53d1\u6307\u5357\u8fdb\u884c\u5177\u4f53\u9875\u9762\u7684\u5f00\u53d1-->\r\n			</td>\r\n			<td style=\"vertical-align: middle;;\" align=\"center\">\r\n				<p style=\"color: #324263;margin-top: 15px;font-weight: bold;\">".toCharArray();
    ...
    _jsp_string139 = "</p><!--\u5143\u7d20\u6ce8\u518c-->\r\n				<p style=\"color: #9BA6CC;margin-top: 15px;font-weight: bold;margin-bottom: 30px;cursor: pointer;\" \r\n					onclick=\"parent.document.location.href='/homepage/maint/HomepageTabs.jsp?_fromURL=ElementRegister'\">".toCharArray();
    _jsp_string136 = "</p><!--\u70b9\u51fb\u4e0b\u8f7d\u6a21\u677f-->\r\n			</td>\r\n			<td style=\"vertical-align: middle;\" align=\"center\">\r\n				<p style=\"color: #324263;margin-top: 15px;font-weight: bold;\">".toCharArray();
  }
}

...
public class _elementregister__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(33833,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(33837,user.getLanguage())));
          ...
          if (_jsp_GroupTag_3 == null) {
            ...
            _jsp_GroupTag_3.setAttributes("{'itemAreaDisplay':'display'}");
          }

          _jsp_GroupTag_3.setContext(SystemEnv.getHtmlLabelName(15736,user.getLanguage()));
          ...
          if (_jspEval17 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(33834,user.getLanguage())));
                out.write(_jsp_string144, 0, _jsp_string144.length);
                out.print((SystemEnv.getHtmlLabelName(33835,user.getLanguage())));
                out.write(_jsp_string145, 0, _jsp_string145.length);
                out.print((SystemEnv.getHtmlLabelName(33836,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelNames("33837,18019", user.getLanguage())));
      out.write(_jsp_string149, 0, _jsp_string149.length);
      out.print((SystemEnv.getHtmlLabelNames("33834", user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("admincenter/portalEngine/ElementRegister.jsp"), -8912889389921715682L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string61 = ")\">\r\n".toCharArray();
    _jsp_string144 = "</p><!-- \u4e0a\u4f20\u7684\u5143\u7d20\u6587\u4ef6\u5305\u6269\u5c55\u540d\u5fc5\u987b\u4e3a.zip -->\r\n				<p>2\u3001".toCharArray();
    ...
    _jsp_string145 = "</p><!-- \u5143\u7d20\u540d\u79f0\u4e0d\u5f97\u4e0e\u5143\u7d20\u5e93\u4e2d\u5df2\u6709\u5143\u7d20\u540d\u79f0\u76f8\u540c -->\r\n				<p>3\u3001".toCharArray();
    _jsp_string72 = "\r\n\r\n\r\n	".toCharArray();

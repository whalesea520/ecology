...
public class _portalelements__jsp extends com.caucho.jsp.JavaPage
{
...
String isEnableExtranetHelp = KtreeHelp.getInstance().isEnableExtranetHelp;
      ...
      out.print((SystemEnv.getHtmlLabelName(33619,user.getLanguage())));
      out.write(_jsp_string73, 0, _jsp_string73.length);
      out.print((SystemEnv.getHtmlLabelName(33620,user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print(( PageIdConst.HP_ELEMENTS ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("admincenter/portalEngine/PortalElements.jsp"), 4312984693851243547L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string75 = "\" class=\"advancedSearch\" onclick=\"jQuery('#advancedSearchDiv').toggle('fast');return false;\"/>\r\n				<span title=\"".toCharArray();

...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(19652,user.getLanguage()) ));
      out.print((SystemEnv.getHtmlLabelName(17871,user.getLanguage()) ));
        ...
        do {
          ...
          if (_jspEval6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(32865, user.getLanguage())));
              ...
              do {
                ...
                if(!subjects.equals("")){
                out.print((Util.forHtml(subjects)));
                }
              ...
              do {
                ...
                _jsp_BrowserTag_3.setName("hrmid01s");
                _jsp_BrowserTag_3.setBrowserValue(hrmid01s);
                ...
                _jsp_BrowserTag_3.setBrowserSpanValue(ResourceComInfo.getResourcename(""+hrmid01s));
              ...
              do {
                ...
                _jsp_BrowserTag_3.setCompleteUrl("/data.jsp");
                _jsp_BrowserTag_3.setLinkUrl("javascript:openhrm($id$)");
                _jsp_BrowserTag_3.setName("hrmid02s");
                _jsp_BrowserTag_3.setBrowserValue(hrmid02s);
                ...
                _jsp_BrowserTag_3.setBrowserSpanValue( hrmid02span );
                _jsp_BrowserTag_3.doTag();
              ...
              do {
                ...
                if(!mtnames.equals("")){
                out.print((Util.forHtml(mtnames)));
                }
                out.write(_jsp_string145, 0, _jsp_string145.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
		    ...
		    if(!"".equals(meetingtypes)){
                ...
                _jsp_BrowserTag_4.setName("meetingtypes");
                _jsp_BrowserTag_4.setBrowserOnClick("");
                _jsp_BrowserTag_4.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/meeting/Maint/MutiMeetingTypeBrowser.jsp?forall=1");
                _jsp_BrowserTag_4.setIsSingle("true");
                _jsp_BrowserTag_4.setHasBrowser("true");
                _jsp_BrowserTag_4.setIsMustInput("1");
                _jsp_BrowserTag_4.setCompleteUrl("/data.jsp?type=89&forall=1");
                _jsp_BrowserTag_4.setWidth("200px");
                _jsp_BrowserTag_4.setHasInput("true");
                _jsp_BrowserTag_4.setBrowserValue( ""+meetingtypes );
                _jsp_BrowserTag_4.setBrowserSpanValue(meetingTypename );
              ...
              do {
                ...
                _jsp_BrowserTag_3.setBrowserValue(callers);
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/hrm/resource/MutiResourceBrowser.jsp?resourceids=");
                _jsp_BrowserTag_3.setIsSingle("false");
                _jsp_BrowserTag_3.setBrowserSpanValue( callerspan );
                _jsp_BrowserTag_3.doTag();
                out.write(_jsp_string152, 0, _jsp_string152.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(22074, user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(1332,user.getLanguage())+(user.getLanguage() == 8?" ":"")+SystemEnv.getHtmlLabelName(277,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                out.print(((timeSag==0||"".equals(timeSag))?"selected":"" ));
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(332,user.getLanguage())));
          ...
          int _jspEval74 = _jsp_GroupTag_1.doStartTag();
          if (_jspEval74 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval74 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_1.setBodyContent(_jsp_endTagHack72);
              _jsp_GroupTag_1.doInitBody();
            }
            do {
              out.write(_jsp_string143, 0, _jsp_string143.length);
      ...
      out.print(( PageIdConst.MT_MeetingDecision));
...
tableString =   " <table instanceid=\"\" tabletype=\"none\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.MT_MeetingDecision,user.getUID())+"\" >"+
      ...
      int _jsp_end_84 = _jsp_SplitPageTag_6.doEndTag();
      ...
      out.print((SystemEnv.getHtmlLabelName(131724,user.getLanguage())));
      out.write(_jsp_string188, 0, _jsp_string188.length);
      out.print((SystemEnv.getHtmlLabelName(131713,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("meeting/search/MeetingDecision.jsp"), 2232691901611478761L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string173 = "</option><!-- \u6307\u5b9a\u65e5\u671f\u8303\u56f4 -->\r\n					</select>\r\n				</span>\r\n				<span id=\"decisionDate\"  style=\"".toCharArray();
    ...
    _jsp_string144 = "\r\n				<input type=\"text\" class=inputstyle id=\"subjects\" name=\"subjects\"  style=\"width:60%\" value=\"".toCharArray();
    ...
    _jsp_string168 = "</option><!-- \u4eca\u5929 -->\r\n						<option value=\"2\" ".toCharArray();
    _jsp_string14 = "\";\r\nfunction check_conn() {\r\n	return confirm('".toCharArray();
    _jsp_string164 = "</option>\r\n				</select>\r\n			".toCharArray();
    _jsp_string153 = "\r\n			<!-- \u76f8\u5173\u4f1a\u8bae -->\r\n			".toCharArray();
    _jsp_string138 = "\" class=\"cornerMenu middle\"></span>\r\n		</td>\r\n	</tr>\r\n</table>\r\n<div id=\"tabDiv\" >\r\n	<span class=\"toggleLeft\" id=\"toggleLeft\" onclick=\"toggleLeft()\" title=\"".toCharArray();
    ...
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string176 = "</span>\r\n					<input type=\"hidden\" name=\"begindate1\" id=\"begindate1\" value=\"".toCharArray();
    ...
    _jsp_string154 = "\r\n				<input type=\"text\" class=inputstyle id=\"mtnames\" name=\"mtnames\"  style=\"width:60%\" value=\"".toCharArray();
    ...
    _jsp_string181 = "\" class=\"e8_btn_cancel\" onclick=\"resetCondition();\"/>\r\n				<input type=\"button\" value=\"".toCharArray();
    _jsp_string148 = "\r\n				".toCharArray();
    _jsp_string142 = "\r\n			<!-- \u4efb\u52a1\u6807\u9898 -->\r\n			".toCharArray();
    ...
    _jsp_string177 = "\">\r\n					<input type=\"hidden\" name=\"enddate1\" id=\"enddate1\" value=\"".toCharArray();
    _jsp_string75 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string182 = "\" class=\"e8_btn_cancel\" id=\"cancel\"/>\r\n			".toCharArray();

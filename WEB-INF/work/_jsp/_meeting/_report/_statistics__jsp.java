...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.meeting.search.StatisticComInfo StatisticComInfo;
      StatisticComInfo = (weaver.meeting.search.StatisticComInfo) pageContext.getAttribute("StatisticComInfo");
      if (StatisticComInfo == null) {
        StatisticComInfo = new weaver.meeting.search.StatisticComInfo();
        pageContext.setAttribute("StatisticComInfo", StatisticComInfo);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      {
        ...
        if (_jspParam != null && ! _jspParam.equals(""))
          StatisticComInfo.setTimeSag(java.lang.Integer.parseInt(_jspParam));
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      {
        java.lang.String _jspParam;
        _jspParam = request.getParameter("subIds");
        if (_jspParam != null && ! _jspParam.equals(""))
          StatisticComInfo.setSubIds(_jspParam);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      {
        java.lang.String _jspParam;
        _jspParam = request.getParameter("depIds");
        if (_jspParam != null && ! _jspParam.equals(""))
          StatisticComInfo.setDepIds(_jspParam);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      {
        java.lang.String _jspParam;
        _jspParam = request.getParameter("selectType");
        if (_jspParam != null && ! _jspParam.equals(""))
          StatisticComInfo.setSelectType(java.lang.Integer.parseInt(_jspParam));
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      {
        java.lang.String _jspParam;
        ...
        if (_jspParam != null && ! _jspParam.equals(""))
          StatisticComInfo.setBegindate(_jspParam);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      {
        java.lang.String _jspParam;
        ...
        if (_jspParam != null && ! _jspParam.equals(""))
          StatisticComInfo.setEnddate(_jspParam);
      }
      out.write(_jsp_string2, 0, _jsp_string2.length);
...
if(userightmenu!=1){
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_3.setWidth("140px");
                _jsp_BrowserTag_3.setName("subIds");
                _jsp_BrowserTag_3.setBrowserValue(userSub );
                ...
                _jsp_BrowserTag_3.setBrowserSpanValue(SubCompanyComInfo.getSubCompanyname(""+userSub) );
                ...
                _jsp_BrowserTag_3.setIsMustInput("1");
                _jsp_BrowserTag_3.setWidth("140px");
                _jsp_BrowserTag_3.setName("depIds");
                _jsp_BrowserTag_3.setBrowserValue(userdept );
                ...
                _jsp_BrowserTag_3.setBrowserSpanValue(DepartmentComInfo.getDepartmentname(""+userdept) );
                _jsp_BrowserTag_3.doTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("meeting/report/Statistics.jsp"), -2759018938455876556L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string153 = "</option><!-- \u672c\u5468 -->\r\n							<option value=\"3\" ".toCharArray();
    _jsp_string135 = "\" class=\"e8_btn_top middle\" onclick=\"doSearchsubmit()\"/>\r\n				<span id=\"advancedSearch\" class=\"advancedSearch\">".toCharArray();
    ...
    _jsp_string146 = "</option><!-- \u603b\u90e8 -->\r\n					</select> \r\n					<!-- \u5206\u90e8 -->\r\n					<span id=\"subIdsSP\" style=\"float:left;margin-left:4px;\">\r\n					".toCharArray();
    _jsp_string29 = "')) {\r\n				    lenck = false;\r\n				    break;\r\n			    }\r\n		    }\r\n		    if(lenck==false) return false;\r\n	    }\r\n	    catch(e) {}\r\n	    ".toCharArray();
    _jsp_string165 = "\" class=\"e8_btn_cancel\" onclick=\"resetCondtionAVS();\"/>\r\n					<input type=\"button\" value=\"".toCharArray();
    _jsp_string72 = "\r\n\r\n\r\n	".toCharArray();

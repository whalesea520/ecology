...
public class _viewmeetingtab__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	if(!canview){
      ...
      out.print((SystemEnv.getHtmlLabelName(33148, user.getLanguage())));
      out.write(_jsp_string73, 0, _jsp_string73.length);
      out.print((SystemEnv.getHtmlLabelNames("2103,20032",user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelNames("26473,34076",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("meeting/data/ViewMeetingTab.jsp"), -3129128485589234229L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string78 = "', \"/meeting/data/EditMeetingTab.jsp?meetingid=\"+meetingid,parentWin.diag_vote,parentWin);\r\n   //location.href=\"/meeting/data/EditMeetingTab.jsp?meetingid=\"+meetingid;\r\n}\r\n\r\nfunction doCopyEdit(meetingid){\r\n	var parentWin = parent.getParentWindow(window);\r\n	//parentWin.diag_vote.close();\r\n	parentWin.showDlg('".toCharArray();
    ...
    _jsp_string77 = "\" id=\"tabcontentframe\" name=\"tabcontentframe\" class=\"flowFrame\" frameborder=\"0\" height=\"100%\" width=\"100%;\" onload=\"update()\"></iframe>\r\n	        </div>\r\n	    </div>\r\n	</div>\r\n	   \r\n</body>\r\n</html>\r\n<script type=\"text/javascript\">\r\nfunction doEdit(meetingid){\r\n	var parentWin = parent.getParentWindow(window);\r\n	//parentWin.diag_vote.close();\r\n	parentWin.showDlg('".toCharArray();

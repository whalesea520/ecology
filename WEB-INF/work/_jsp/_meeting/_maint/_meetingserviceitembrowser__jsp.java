...
public class _meetingserviceitembrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("meeting")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(2157,user.getLanguage()), null), false);
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(1353,user.getLanguage())));
              ...
              do {
                ...
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/meeting/Maint/MeetingServiceTypeBrowser.jsp");
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(320,user.getLanguage()));
      ...
      out.print((SystemEnv.getHtmlLabelName(2157,user.getLanguage())));
      out.write(_jsp_string154, 0, _jsp_string154.length);
      out.print((SystemEnv.getHtmlLabelName(2155,user.getLanguage())));
      out.write(_jsp_string154, 0, _jsp_string154.length);
      out.print((SystemEnv.getHtmlLabelName(141,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("meeting/Maint/MeetingServiceItemBrowser.jsp"), 175567943528865932L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string139 = "\r\n            ".toCharArray();
    _jsp_string132 = "\" class=\"cornerMenu middle\"></span>\r\n		</td>\r\n	</tr>\r\n</table>\r\n<div id=\"tabDiv\" >\r\n	<span id=\"hoverBtnSpan\" class=\"hoverBtnSpan\">\r\n			<span>".toCharArray();
    ...
    _jsp_string140 = "\r\n            	".toCharArray();
    _jsp_string131 = "\" class=\"e8_btn_top middle\" onclick=\"btnOnSearch();\"/>\r\n			<span title=\"".toCharArray();
    _jsp_string68 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();

...
import weaver.meeting.MeetingServiceUtil;

public class _meetingservicetab__jsp extends com.caucho.jsp.JavaPage
{
...
if(RecordSet.next()){
	...
	if(newType==0){
      ...
      out.print((SystemEnv.getHtmlLabelName(81892,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("meeting/Maint/meetingServiceTab.jsp"), 7757688663501807465L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

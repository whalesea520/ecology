...
public class _meetingroombrowserchld__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_3.setBrowserSpanValue(""+SubCompanyComInfo.getSubCompanyname(""+SelectSubCompany));
          ...
          if (_jspEval41 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                int _jsp_end_48 = _jsp_SplitPageTag_5.doEndTag();
      ...
      if(!"".equals(callbkfun)){
      out.write(_jsp_string148, 0, _jsp_string148.length);
      out.print(("parentWin."+callbkfun+"(returnjson);"));
      out.write(_jsp_string147, 0, _jsp_string147.length);
      }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("meeting/Maint/MeetingRoomBrowserChld.jsp"), 5407222973981928757L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string149 = "\r\n			<input class=inputstyle type=\"text\" name=fullname value=\"".toCharArray();
    ...
    _jsp_string144 = "'>\r\n<input type=\"hidden\" name=\"callbkfun\" id=\"callbkfun\" value='".toCharArray();
    ...
    _jsp_string152 = "\r\n			<input class=inputstyle type=\"text\" name=equipment value=\"".toCharArray();
    ...
    _jsp_string143 = "'>\r\n<input type=\"hidden\" name=\"forall\" id=\"forall\" value='".toCharArray();
    _jsp_string3 = "\r\n	<script language=\"javascript\">\r\n		window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string153 = "\r\n				".toCharArray();
    _jsp_string139 = "\" class=\"e8_btn_top middle\" onclick=\"javascript:document.SearchForm.submit();\"/>\r\n			<span title=\"".toCharArray();
    ...
    _jsp_string151 = "\r\n			<input class=inputstyle type=\"text\" name=description value=\"".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();

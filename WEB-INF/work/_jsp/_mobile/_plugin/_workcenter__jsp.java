...
public class _workcenter__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      weaver.mobile.plugin.ecology.service.WorkCenterService wcs;
      wcs = (weaver.mobile.plugin.ecology.service.WorkCenterService) pageContext.getAttribute("wcs");
      if (wcs == null) {
        wcs = new weaver.mobile.plugin.ecology.service.WorkCenterService();
        pageContext.setAttribute("wcs", wcs);
      }
...
out.println(jo);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("mobile/plugin/WorkCenter.jsp"), 5362825044256553534L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }

...
if(!"".equals(rs.getString("moduleName")) && null != rs.getString("moduleName")){
	...
	if(rsQiyuesuo.getCounts()>0){
      ...
      out.print((SystemEnv.getHtmlLabelName(1201,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      } else if(currenthour.compareTo("12") < 0 ) {
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((SystemEnv.getHtmlLabelName(1202,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      } else if(currenthour.compareTo("14") <= 0 ) {
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((SystemEnv.getHtmlLabelName(1203,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      } else if(currenthour.compareTo("18") < 0 ) {
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((SystemEnv.getHtmlLabelName(1204,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      }
      out.write(_jsp_string71, 0, _jsp_string71.length);
      out.print((SystemEnv.getHtmlLabelName(16645,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("portal/top.jsp"), 6708853700042055254L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string38 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string82 = "\r\n			</td>\r\n	        <td width=\"68\" align=\"left\" >\r\n	          <input name=\"searchtype\" id=\"searchtype\"  type=\"text\" value=\"5\" style=\"display:none\">\r\n	              <div class=\"searchtype\">\r\n	                   <div id=\"sample\" class=\"dropdown\" style=\"float:left;position:absolute;width:100%;\">\r\n                            <div class=\"selectTile\">\r\n                                <a href=\"#\" class=\"selectTileBefo\">\r\n                                    <span style=\"height:35px;line-height:35px;float:left;text-align:center;width:40px;display:block;overflow:hidden;text-overflow:ellipsis;color:#fff;padding:0;\" class=\"searchTxt\">".toCharArray();
    _jsp_string43 = "\";\r\n\r\n  if(companyname.length >0 ){\r\n  	window.status = str1+companyname;\r\n  }\r\n</script>\r\n<!-- \u5220\u9664 -->\r\n</head></html>\r\n\r\n<!--USB \u9a8c\u8bc1 -->\r\n".toCharArray();
    _jsp_string95 = "\r\n             </td>\r\n             <td width=\"10\"></td>\r\n		  <!-- \u5bc6\u7801 -->\r\n          <td  width=\"30\" align=\"right\" nowrap><a class=zlm1 style=\"cursor: pointer;\" onclick=\"editPassword()\" target=\"_top\" title=\"".toCharArray();
    ...
    _jsp_string96 = "\"><img style=\"padding-top:16px;\" src=\"/portal/images/psd.png\"/></a></td><!-- <i  class=\"iconfont icon_button\">&#xe63d;</i> -->\r\n          <!-- \u9000\u51fa -->\r\n          <td  width=\"50\" align=\"center\" nowrap><a class=zlm1 href=\"/login/Logout.jsp\" title=\"".toCharArray();
    ...
    _jsp_string89 = "</span></a></li>  \r\n				                    ".toCharArray();
    _jsp_string66 = "\r\n<script language=\"javascript\">\r\nfunction clearVal(obj){\r\n    if(obj.value=='\u8bf7\u8f93\u5165\u5173\u952e\u8bcd\u641c\u7d22'){\r\n        obj.value=\"\";\r\n    }\r\n}\r\n\r\nfunction recoverVal(obj){\r\n    if(obj.value==''||obj.value==null){\r\n        obj.value=\"\u8bf7\u8f93\u5165\u5173\u952e\u8bcd\u641c\u7d22\";\r\n    }\r\n}\r\n\r\nfunction goUrl(url){\r\n	parent.document.getElementById(\"mainFrame\").src = url;\r\n}\r\n\r\n//\u4fee\u6539\u5ba2\u6237\u5bc6\u7801\r\nfunction editPassword(){\r\n	main_div_warp.mainFrame.location.href=\"/CRM/data/ManagerUpdatePassword.jsp?crmid=".toCharArray();
    _jsp_string86 = "</span></a></li>           \r\n				                    ".toCharArray();
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    ...
    _jsp_string0 = "\r\n\r\n \r\n \r\n".toCharArray();
    _jsp_string80 = "\r\n				".toCharArray();
    _jsp_string90 = " \r\n				                     <li><a href=\"#\"><img src=\"/wui/theme/ecology8/page/images/toolbar/docs_wev8.png\"><span searchtype=\"4\">".toCharArray();
    _jsp_string1 = "\r\n<!DOCTYPE HTML>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n<html>\r\n<head>\r\n<!-- \r\n\u6dfb\u52a0\u81f3init.css\r\n<style type=\"text/css\">\r\n	html{height:100%;}\r\n</style>\r\n -->\r\n".toCharArray();

...
public class _left_0workflow__jsp extends com.caucho.jsp.JavaPage
{
...
String Customertype = Util.null2String(""+user.getType()) ;
      ...
      out.print((SystemEnv.getHtmlLabelName(16393,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("portal/left_workFlow.jsp"), 4785180206807821849L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string72 = "</a></td>\r\n          \r\n          <td ><a href=\"/workflow/search/WFSearch.jsp\"  target=\"mainFrame\" title=\"".toCharArray();
    ...
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string71 = "\" src=\"/images_frame/icon_request1_wev8.gif\" border=\"0\"> -->\r\n          <td width=\"80\" align=\"center\"><a href=\"/workflow/request/MyRequestView.jsp\" class=\"zlm\"  target=\"mainFrame\">".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();
  }
}

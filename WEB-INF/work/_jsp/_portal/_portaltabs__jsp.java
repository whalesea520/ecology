...
public class _portaltabs__jsp extends com.caucho.jsp.JavaPage
{
...
if("soft".equals(_fromURL)){//\u8f6f\u4ef6
	...
	url = "/page/maint/template/login/List.jsp";
      ...
      out.print(("/portal/plugin/homepage/ecology7theme/PortalList.jsp?theme=ecology8" ));
      out.write(_jsp_string65, 0, _jsp_string65.length);
      out.print(("ECOLOGY8"+SystemEnv.getHtmlLabelName(344,user.getLanguage()) ));
      out.write(_jsp_string66, 0, _jsp_string66.length);
      out.print(("/portal/plugin/homepage/ecology7theme/PortalList.jsp?theme=ecology7" ));
      out.write(_jsp_string65, 0, _jsp_string65.length);
      out.print(("ECOLOGY7"+SystemEnv.getHtmlLabelName(344,user.getLanguage()) ));
      out.write(_jsp_string67, 0, _jsp_string67.length);
      if(isOpenSoftAndSiteTempate){
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print(("/portal/plugin/homepage/ecology7theme/PortalList.jsp?theme=soft" ));
      out.write(_jsp_string65, 0, _jsp_string65.length);
      out.print((SystemEnv.getHtmlLabelName(20621,user.getLanguage()) ));
      out.write(_jsp_string66, 0, _jsp_string66.length);
      out.print(("/portal/plugin/homepage/ecology7theme/PortalList.jsp?theme=web" ));
      out.write(_jsp_string65, 0, _jsp_string65.length);
      out.print((SystemEnv.getHtmlLabelName(27890,user.getLanguage()) ));
      ...
      out.print((SystemEnv.getHtmlLabelName(32462,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("portal/PortalTabs.jsp"), -6556544431219948765L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string65 = "\" target=\"tabcontentframe\">\r\n        		".toCharArray();
    _jsp_string35 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string69 = "\r\n        	</a>\r\n        </li> -->\r\n        ".toCharArray();
    ...
    _jsp_string73 = "\" id=\"tabcontentframe\" name=\"tabcontentframe\" class=\"flowFrame\" frameborder=\"0\" height=\"100%\" width=\"100%;\" onload=\"update()\"></iframe>\r\n        </div>\r\n    </div>\r\n</div>\r\n</body>\r\n</html>\r\n\r\n<script language=\"javascript\">\r\njQuery(function(){\r\n    jQuery('.e8_box').Tabs({\r\n        getLine:1,\r\n        iframe:\"tabcontentframe\",\r\n        staticOnLoad:true,\r\n        mouldID:\"".toCharArray();
    _jsp_string48 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string39 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();

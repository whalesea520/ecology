...
public class _portalsetting__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	String showlasthp = Util.null2String(RecordSet.getString("showlasthp"));
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("portal")+ "&" + "navName=" + com.caucho.el.Expr.toString($label(33672,user.getLanguage()), null), false);
      ...
      out.print(($label(83721,user.getLanguage())));
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext($label(33393,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(33394,user.getLanguage())));
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(33395,user.getLanguage())));
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(21822,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(83200,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("page/PortalSetting.jsp"), 5407148855885400746L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string144 = "\r\n				\r\n						<INPUT class=InputStyle style=\"width: 40px;\" maxLength=2 size=10 name=\"refreshTime\" onKeyPress=\"ItemCount_KeyPress()\" onBlur='checknumber(\"refreshTime\")' value = \"".toCharArray();
    ...
    _jsp_string137 = "\" class=\"e8_btn_top\" onclick=\"pager.doSave()\" />\r\n					<span title=\"".toCharArray();
    _jsp_string97 = "px\">\r\n		</iframe>\r\n	</div>\r\n".toCharArray();
    ...
    _jsp_string139 = "\r\n				".toCharArray();
    _jsp_string141 = "\r\n					 <input type=\"checkbox\"  tzCheckbox=\"true\" name=needRefresh  value=\"1\" ".toCharArray();
    ...
    _jsp_string150 = "\r\n					 <input type=\"checkbox\"  tzCheckbox=\"true\" name=showlasthp  value=\"1\" ".toCharArray();

...
public class _elementstylelist__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string52, 0, _jsp_string52.length);
      weaver.page.style.MenuVStyleCominfo mvsc;
      mvsc = (weaver.page.style.MenuVStyleCominfo) pageContext.getAttribute("mvsc");
      if (mvsc == null) {
        mvsc = new weaver.page.style.MenuVStyleCominfo();
        pageContext.setAttribute("mvsc", mvsc);
      }
      out.write(_jsp_string52, 0, _jsp_string52.length);
...
if(userightmenu!=1){
	...
	out.print(estyleStr.toString());
      ...
      out.print((pageIndex==1?1:pageIndex-1 ));
      ...
      out.print((i==pageIndex?"class=\"weaverTableCurrentPageBg\"":""));
      out.write('>');
      out.print((i ));
      out.write(_jsp_string147, 0, _jsp_string147.length);
      } 
      out.write(_jsp_string148, 0, _jsp_string148.length);
      out.print((pageIndex==max?pageIndex:pageIndex+1 ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("page/maint/style/ElementStyleList.jsp"), 6495967503929508358L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string142 = "&nbsp;&nbsp;&nbsp;\r\n".toCharArray();
    _jsp_string148 = "\r\n<span class=\"weaverTableNextPageOfDisabled\" onclick=\"goPage(".toCharArray();
    ...
    _jsp_string144 = ");\" style=\"display:inline-block;cursor:pointer;TEXT-DECORATION:none;height:21px;margin-right:5px;width:21px;\">&nbsp;</span>\r\n".toCharArray();
    ...
    _jsp_string140 = "\r\n<form name=\"splitPageForm\" action=\"ElementStyleList.jsp\">\r\n<input type=\"hidden\" name=\"pageIndex\" id=\"pageIndex\" value=\"".toCharArray();
    ...
    _jsp_string143 = "\r\n</span>\r\n<span class=\"weaverTablePrevPageOfDisabled\" onclick=\"goPage(".toCharArray();
    _jsp_string64 = "\r\n\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string150 = "&nbsp;</span>\r\n<input id=\"-weaverTable-0_XTABLE_GOPAGE_buttom\" type=\"text\" value=\"".toCharArray();
    _jsp_string35 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    ...
    _jsp_string136 = "\" class=\"e8_btn_top\" onclick=\"onAdd();\" />\r\n				<input type=\"button\" value=\"".toCharArray();
    _jsp_string51 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    ...
    _jsp_string149 = ");\" style=\"display:inline-block;cursor:pointer;TEXT-DECORATION:none;height:21px;margin-right:5px;width:21px;\">&nbsp;</span>\r\n<span style=\"TEXT-DECORATION:none;height:21px;line-height:21px;\">\r\n".toCharArray();
    ...
    _jsp_string138 = "\" class=\"advancedSearch\" onclick=\"jQuery('#advancedSearchDiv').toggle('fast');return false;\"/>\r\n				<span title=\"".toCharArray();
    ...
    _jsp_string145 = "\r\n<span style=\"display:inline-block;cursor:pointer;TEXT-DECORATION:none;height:19px;border:1px solid #BCBCBC;margin-right:5px;padding:0 5px 0 5px;\" onclick=\"goPage(".toCharArray();
    _jsp_string72 = "\";\r\n        dialog.Width = 550 ;\r\n        dialog.Height = 600;\r\n        dialog.Drag = true;\r\n        dialog.show();\r\n    });\r\n\r\n}\r\n</script>\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string48 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    ...
    _jsp_string151 = "\" size=\"3\" class=\"text\" onmouseover=\"this.select()\" style=\"text-align:right;line-height:20px;height:20px;widht:30px;border:1px solid #BCBCBC;background:none;margin-right:5px;padding-right:2px;\">\r\n<span style=\"TEXT-DECORATION:none;height:21px;line-height:21px;\">\r\n".toCharArray();

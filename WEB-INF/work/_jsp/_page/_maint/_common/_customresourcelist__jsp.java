...
public class _customresourcelist__jsp extends com.caucho.jsp.JavaPage
{
...
String tableString="<table datasource=\"weaver.admincenter.homepage.PortalDataSource.getImageLib\" sourceparams=\"dir:"+dir+"\" pagesize=\"10\" tabletype=\"thumbnail\">"+
	...
	tableString+= "</operates>"
      ...
      if (_jsp_SplitPageTag_0 == null) {
        ...
        _jsp_SplitPageTag_0.setIsShowThumbnail("1");
        _jsp_SplitPageTag_0.setImageNumberPerRow("5");
      }
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(84083,user.getLanguage())));
      ...
      out.print((dir+"&"+request.getQueryString()));
      out.write(_jsp_string172, 0, _jsp_string172.length);
      out.print((SystemEnv.getHtmlLabelName(84081,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("page/maint/common/CustomResourceList.jsp"), 9130263760363971232L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string158 = "&isDialog=".toCharArray();
    ...
    _jsp_string48 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string80 = "\" class=\"e8_btn_top\" onclick=\"onClear();\" />\r\n					".toCharArray();
    ...
    _jsp_string87 = "</td>\r\n		<td width=\"50%\" style=\"padding-right:22px;\" align=\"right\">".toCharArray();
    ...
    _jsp_string171 = "\"},\r\n		function(data){\r\n			if(data.indexOf(\"SUCCESS\")!=-1)location.href=\"/page/maint/common/CustomResourceList.jsp?dir=".toCharArray();
    _jsp_string81 = "\r\n					".toCharArray();
    ...
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    _jsp_string88 = "<span id=\"spanUpload\"></span>".toCharArray();
    _jsp_string97 = ")-1 : Math.ceil(bodyWidth/".toCharArray();
    _jsp_string176 = "\";\r\n				else if(data.indexOf(\"ERROR\")!=-1) jQuery(\"#img_msg\").html(\"".toCharArray();
    ...
    _jsp_string170 = "\",function(){\r\n		jQuery.post(\"/weaver/weaver.page.maint.common.CustomResourceServlet\",\r\n		{\"method\":\"deleteFile\",\"filepath\":imgname,\"dir\":\"".toCharArray();
    ...
    _jsp_string79 = "\" class=\"e8_btn_top\" onclick=\"onSure();\" />\r\n					<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string82 = "\" class=\"e8_btn_top\" onclick=\"delAllImg();\" />\r\n					".toCharArray();

...
public class _customresourceleft__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(84074,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(84075,user.getLanguage())));
      out.write(_jsp_string139, 0, _jsp_string139.length);
      out.print((SystemEnv.getHtmlLabelName(84076,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(84077,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("page/maint/common/CustomResourceLeft.jsp"), 8427618853985942778L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string133 = "\">\r\n  <input class=inputstyle type=\"hidden\" id=\"isSingle\" name=\"isSingle\" value=\"".toCharArray();
    _jsp_string132 = "\">\r\n  <input class=inputstyle type=\"hidden\" id=\"isDialog\" name=\"isDialog\" value=\"".toCharArray();
    ...
    _jsp_string137 = "' onmouseover=\\\"this.src='/images/homepage/edit_2_wev8.png'\\\" onmouseout=\\\"this.src='/images/homepage/edit_1_wev8.png'\\\"/>\"+\r\n			\"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img z_tree=\\\"oprate_div_\"+treeNode.id+\"\\\" src='/images/homepage/del_1_wev8.png' onclick=\\\"deleteDir('\"+treeNode.name+\"','\"+treeNode.id+\"','\"+treeNode.dirtype+\"','\"+treeNode.dirrealpath+\"');\\\" title='".toCharArray();
    ...
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string136 = "' onmouseover=\\\"this.src='/images/homepage/add_2_wev8.png'\\\" onmouseout=\\\"this.src='/images/homepage/add_1_wev8.png'\\\"/>\"+\r\n			\"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img z_tree=\\\"oprate_div_\"+treeNode.id+\"\\\" src='/images/homepage/edit_1_wev8.png' onclick=\\\"renameDir('\"+treeNode.name+\"','\"+treeNode.id+\"','\"+treeNode.dirtype+\"','\"+treeNode.dirrealpath+\"');\\\" title='".toCharArray();
    ...
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    _jsp_string131 = "\">\r\n  <input class=inputstyle type=\"hidden\" id=\"dir\" name=\"dir\" value=\"".toCharArray();
    ...
    _jsp_string135 = "){\r\n		var	oprateStr = \"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img z_tree=\\\"oprate_div_\"+treeNode.id+\"\\\" src='/images/homepage/add_1_wev8.png' onclick=\\\"createDir('\"+treeNode.name+\"','\"+treeNode.id+\"','\"+treeNode.dirrealpath+\"');\\\" title='".toCharArray();

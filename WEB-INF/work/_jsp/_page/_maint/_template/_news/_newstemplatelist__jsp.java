...
package _jsp._page._maint._template._news;
...
public class _newstemplatelist__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(64,user.getLanguage())+SystemEnv.getHtmlLabelName(18596,user.getLanguage())));
...
String tableString=""+
	...
	+ "<operates><popedom otherpara=\"column:id\" transmethod=\"weaver.splitepage.transform.SptmForNewsThumbnail.getOperate\"></popedom> "
	 ...
	 + "</operates></table>";
      ...
      out.print((SystemEnv.getHtmlLabelName(365,user.getLanguage())+SystemEnv.getHtmlLabelName(18596,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("page/maint/template/news/NewsTemplateList.jsp"), 2255137824797522660L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string38 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string146 = "\"; \r\n	 	var url = \"/page/maint/template/news/NewsTemplateImport.jsp?pageUrl=list&newstemptype=".toCharArray();
    ...
    _jsp_string143 = "\"; \r\n	 	var url = \"/page/maint/template/news/NewsTemplateEdit.jsp?pageUrl=list&newstemptype=".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string137 = "\" id=\"zd_btn_submit\" class=\"e8_btn_top\" onclick=\"onImportLayout()\">\r\n					<input type=\"text\" class=\"searchInput\" name=\"templateName\"/>\r\n					&nbsp;&nbsp;&nbsp;\r\n					<input type=\"hidden\" value=\"".toCharArray();

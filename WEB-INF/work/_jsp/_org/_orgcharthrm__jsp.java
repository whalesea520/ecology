...
import weaver.hrm.chart.domain.*;
...
public class _orgcharthrm__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.hrm.chart.manager.OrgChartManager OrgChartManager;
      OrgChartManager = (weaver.hrm.chart.manager.OrgChartManager) pageContext.getAttribute("OrgChartManager");
      if (OrgChartManager == null) {
        OrgChartManager = new weaver.hrm.chart.manager.OrgChartManager();
        pageContext.setAttribute("OrgChartManager", OrgChartManager);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.hrm.chart.manager.HrmChartSetManager HrmChartSetManager;
      HrmChartSetManager = (weaver.hrm.chart.manager.HrmChartSetManager) pageContext.getAttribute("HrmChartSetManager");
      if (HrmChartSetManager == null) {
        HrmChartSetManager = new weaver.hrm.chart.manager.HrmChartSetManager();
        pageContext.setAttribute("HrmChartSetManager", HrmChartSetManager);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.hrm.chart.manager.HrmCompanyVirtualManager HrmCompanyVirtualManager;
      HrmCompanyVirtualManager = (weaver.hrm.chart.manager.HrmCompanyVirtualManager) pageContext.getAttribute("HrmCompanyVirtualManager");
      if (HrmCompanyVirtualManager == null) {
        HrmCompanyVirtualManager = new weaver.hrm.chart.manager.HrmCompanyVirtualManager();
        pageContext.setAttribute("HrmCompanyVirtualManager", HrmCompanyVirtualManager);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
	...
	String projectStatus = Util.null2String(request.getParameter("projectStatus"));
      ...
      out.print((isPOrg ? "HrmSubCompanyDsp" : "HrmSubCompanyDspVirtual"));
      out.write(_jsp_string75, 0, _jsp_string75.length);
      out.print((isPOrg ? "HrmDepartmentDsp" : "HrmDepartmentDspVirtual"));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.write(_jsp_string152, 0, _jsp_string152.length);
                out.print((workType.equals(WorkTypeComInfo.getWorkTypeid())?"selected":""));
                out.write('>');
              ...
              do {
                ...
                out.write(_jsp_string178, 0, _jsp_string178.length);
                out.print((ProjectStatusComInfo.getProjectStatusid()));
                out.write(_jsp_string152, 0, _jsp_string152.length);
                out.print((projectStatus.equals(ProjectStatusComInfo.getProjectStatusid())?"selected":""));
                out.write('>');
                out.print((ProjectStatusComInfo.getProjectStatusdesc()));
                out.write(_jsp_string151, 0, _jsp_string151.length);
                }
                out.write(_jsp_string175, 0, _jsp_string175.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
      ...
      out.print((String.valueOf(isPOrg)));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("org/OrgChartHRM.jsp"), -4992215422071553487L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string70 = "\");\r\n				obj = $GetEle(\"customerStatus\");\r\n				if(obj)changeSelectValue(obj.id,\"".toCharArray();
    ...
    _jsp_string75 = "&id=\"+id);\r\n					} else {\r\n						window.open(\"/hrm/HrmTab.jsp?_fromURL=".toCharArray();
    ...
    _jsp_string188 = "\";\r\n			var shownum = \"".toCharArray();
    _jsp_string145 = "\">\r\n			<input type=\"hidden\" name=\"showmode\" value=\"".toCharArray();
    ...
    _jsp_string76 = "&id=\"+id.substr(1)+\"&hasTree=false\");\r\n					}\r\n				}catch(e){}\r\n			}\r\n		</script>\r\n	</head>\r\n	<body>\r\n		\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string61 = ")\">\r\n".toCharArray();
    ...
    _jsp_string193 = "\";\r\n			var docStatus = \"".toCharArray();
    _jsp_string190 = "\";\r\n			var showtype = \"".toCharArray();
    _jsp_string194 = "\";\r\n			var customerType = \"".toCharArray();
    ...
    _jsp_string73 = "\");	\r\n			}\r\n			\r\n			function doDel(id){\r\n				CO.NodeObject.deleteNodeWithData(id);\r\n			}\r\n			\r\n			function showOrg(obj){\r\n				window.parent.location.href = \"/hrm/HrmTab.jsp?_fromURL=OrgChartHRM&sorgid=".toCharArray();
    ...
    _jsp_string195 = "\";\r\n			var customerStatus = \"".toCharArray();
    _jsp_string74 = "&cmd=\"+$(obj).attr(\"id\");\r\n			}\r\n			\r\n			function changeOrg(id){\r\n				window.parent.location.href = \"/hrm/HrmTab.jsp?_fromURL=OrgChartHRM&sorgid=\"+id;\r\n			}\r\n			\r\n			function openWin(type, id){\r\n				try{\r\n					if(type == \"subcompany\"){\r\n						window.open(\"/hrm/HrmTab.jsp?_fromURL=".toCharArray();
    _jsp_string181 = "\" class=\"e8_btn_submit\" onclick=\"onBtnSearchClick()\"/>\r\n							<input type=\"button\" value=\"".toCharArray();
    _jsp_string3 = "\r\n	<script language=\"javascript\">\r\n		window.top.Dialog.alert(\"".toCharArray();
    _jsp_string182 = "\" class=\"e8_btn_cancel\" onclick=\"resetCondtion();resetSelect()\"/>\r\n							<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string199 = "&arg4=\"+status+\"&arg5=\"+docStatus+\"&arg6=\"+customerType+\"&arg7=\"+customerStatus+\"&arg8=\"+workType+\"&arg9=\"+projectStatus+\"&arg10=\"+cmd+\"&arg11=;;P\"));\r\n				ajax.onreadystatechange = function() {\r\n					if (ajax.readyState == 4 && ajax.status == 200) {\r\n						try{\r\n							var result = ajax.responseText;\r\n							if(result && result != \"\"){\r\n								data = jQuery.parseJSON(result);\r\n								showChart();\r\n							}\r\n						}catch(e){\r\n							return false;\r\n						}\r\n					}\r\n				}\r\n			}\r\n			\r\n			_jQuery(function(){\r\n				initData();\r\n			});\r\n		</script>\r\n	</body>\r\n</html>".toCharArray();
    _jsp_string29 = "')) {\r\n				    lenck = false;\r\n				    break;\r\n			    }\r\n		    }\r\n		    if(lenck==false) return false;\r\n	    }\r\n	    catch(e) {}\r\n	    ".toCharArray();
    _jsp_string66 = "\r\n\r\n<html>\r\n	<head>\r\n		<title>".toCharArray();
    _jsp_string58 = "\r\n<meta http-equiv=\"".toCharArray();
    _jsp_string189 = "\";\r\n			var showName = \"".toCharArray();

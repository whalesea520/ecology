...
public class _lgcproductreportlist__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      weaver.lgc.maintenance.LgcAssortmentComInfo LgcAssortmentComInfo;
      LgcAssortmentComInfo = (weaver.lgc.maintenance.LgcAssortmentComInfo) pageContext.getAttribute("LgcAssortmentComInfo");
      if (LgcAssortmentComInfo == null) {
        LgcAssortmentComInfo = new weaver.lgc.maintenance.LgcAssortmentComInfo();
        pageContext.setAttribute("LgcAssortmentComInfo", LgcAssortmentComInfo);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
if(userightmenu!=1){
	...
	tableString += " </head></table>";
          ...
          if (_jspEval6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/lgc/maintenance/LgcAssortmentBrowser.jsp?newtype=product");
                _jsp_BrowserTag_3.setCompleteUrl("/data.jsp?type=-99994");
                _jsp_BrowserTag_3.setWidth("267px");
                _jsp_BrowserTag_3.setBrowserSpanValue(Util.toScreen(LgcAssortmentComInfo.getAssortmentFullName(assortmentid),user.getLanguage()) );
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(15129,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
      ...
      out.print((PageIdConst.CRM_ProductReport));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("lgc/search/LgcProductReportList.jsp"), -7968375563772875885L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string143 = "\r\n				<input type=\"text\" class=InputStyle  name=assetname id=\"assetname\" value=\"".toCharArray();
    ...
    _jsp_string144 = "\" style=\"width: 180px;\">\r\n			".toCharArray();

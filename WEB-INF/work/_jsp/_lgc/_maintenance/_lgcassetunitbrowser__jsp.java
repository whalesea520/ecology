...
package _jsp._lgc._maintenance;
...
public class _lgcassetunitbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelNames("705",user.getLanguage())));
...
RCMenuHeight += RCMenuHeightStep ;
      ...
      out.print((SystemEnv.getHtmlLabelName(16511,user.getLanguage()) ));
...
while(RecordSet.next()){
	if(i==0){
      ...
      out.print((RecordSet.getString(4)));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("lgc/maintenance/LgcAssetUnitBrowser.jsp"), 227590405028031772L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string86 = "<input class=inputstyle name=unitname value='".toCharArray();
    ...
    _jsp_string88 = "<input class=inputstyle name=unitdesc value='".toCharArray();
    _jsp_string61 = ")\">\r\n".toCharArray();
    ...
    _jsp_string162 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"submitClear();\">\r\n		    	<input type=\"button\" accessKey=T  id=btncancel value=\"".toCharArray();
    _jsp_string158 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result4\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string97 = "</TD>\r\n	\r\n</TR>\r\n".toCharArray();
    _jsp_string29 = "')) {\r\n				    lenck = false;\r\n				    break;\r\n			    }\r\n		    }\r\n		    if(lenck==false) return false;\r\n	    }\r\n	    catch(e) {}\r\n	    ".toCharArray();
    _jsp_string163 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.close();\">\r\n			".toCharArray();

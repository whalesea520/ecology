...
public class _imsynlist__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print(( SystemEnv.getHtmlLabelName(125929,user.getLanguage())));
              ...
              do {
                ...
                if(opertype.equals("")) out.println("selected"); 
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(332 ,user.getLanguage()) ));
                out.write(_jsp_string142, 0, _jsp_string142.length);
                if(opertype.equals("0")) out.println("selected"); 
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(1421 ,user.getLanguage()) ));
                out.write(_jsp_string143, 0, _jsp_string143.length);
                if(opertype.equals("1")) out.println("selected"); 
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(103 ,user.getLanguage()) ));
                out.write(_jsp_string144, 0, _jsp_string144.length);
                if(opertype.equals("2")) out.println("selected"); 
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(91 ,user.getLanguage()) ));
                out.write(_jsp_string147, 0, _jsp_string147.length);
                if(opertype.equals("3")) out.println("selected"); 
                out.write('>');
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(81420,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                if(operresult.equals("")) out.println("selected"); 
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(332 ,user.getLanguage()) ));
                out.write(_jsp_string142, 0, _jsp_string142.length);
                if(operresult.equals("0")) out.println("selected"); 
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(15242 ,user.getLanguage()) ));
                out.write(_jsp_string143, 0, _jsp_string143.length);
                if(operresult.equals("1")) out.println("selected"); 
                out.write('>');
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(83,user.getLanguage())+SystemEnv.getHtmlLabelName(277,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                out.print((dateselect.equals("7")?"selected":"" ));
                out.write('>');
                ...
                out.print((dateselect.equals("8")?"selected":"" ));
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(81716,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("integration/imSynList.jsp"), -723770450087888136L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

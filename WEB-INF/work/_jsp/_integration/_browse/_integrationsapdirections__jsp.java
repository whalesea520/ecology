...
public class _integrationsapdirections__jsp extends com.caucho.jsp.JavaPage
{
...
if(!HrmUserVarify.checkUserRight("intergration:SAPsetting",user)) {
	...
	return ;
      ...
      out.print((SystemEnv.getHtmlLabelName(30627 ,user.getLanguage())));
      out.write('\u3010');
      out.print((SystemEnv.getHtmlLabelName(30657 ,user.getLanguage())));
      out.write(_jsp_string67, 0, _jsp_string67.length);
      out.print((SystemEnv.getHtmlLabelName(30629 ,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      
		if("0".equals(w_type)){
	
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((SystemEnv.getHtmlLabelName(30630 ,user.getLanguage())));
      out.write('\u3011');
      out.print((SystemEnv.getHtmlLabelName(30631 ,user.getLanguage())));
      out.write('\uff0c');
      out.print((SystemEnv.getHtmlLabelName(30634 ,user.getLanguage())));
      out.write('\uff0c');
      out.print((SystemEnv.getHtmlLabelName(30637 ,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      ...
      out.print((SystemEnv.getHtmlLabelName(30631 ,user.getLanguage())));
      out.write('\uff0c');
      out.print((SystemEnv.getHtmlLabelName(30633 ,user.getLanguage())));
      out.write('\uff0c');
      out.print((SystemEnv.getHtmlLabelName(30635 ,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("integration/browse/integrationSapDirections.jsp"), 8620485383435402735L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

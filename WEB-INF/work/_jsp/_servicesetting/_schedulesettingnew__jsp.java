...
public class _schedulesettingnew__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(16539,user.getLanguage())));
              ...
              do {
                ...
                if (_jsp_RequiredTag_3 == null) {
                  ...
                  _jsp_RequiredTag_3.setId("scheduleidspan");
                  _jsp_RequiredTag_3.setRequired(new java.lang.Boolean(true));
                  _jsp_RequiredTag_3.setValue("");
                }
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(23673,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(23674,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
          ...
          if (_jspEval41 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(23970,user.getLanguage())));
                out.write(_jsp_string151, 0, _jsp_string151.length);
                out.print((SystemEnv.getHtmlLabelName(382355,user.getLanguage())));
                out.write(_jsp_string152, 0, _jsp_string152.length);
                out.print((SystemEnv.getHtmlLabelName(23972,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelNames("16539,128458",user.getLanguage())));
      out.write(_jsp_string163, 0, _jsp_string163.length);
      out.print((SystemEnv.getHtmlLabelNames("16539,128458",user.getLanguage())));
      out.write(_jsp_string164, 0, _jsp_string164.length);
      out.print((SystemEnv.getHtmlLabelNames("16539,128459",user.getLanguage())));
      out.write(_jsp_string163, 0, _jsp_string163.length);
      out.print((SystemEnv.getHtmlLabelNames("16539,128459",user.getLanguage())));
      out.write(_jsp_string165, 0, _jsp_string165.length);
      out.print((SystemEnv.getHtmlLabelNames("16539,128460",user.getLanguage())));
      out.write(_jsp_string163, 0, _jsp_string163.length);
      out.print((SystemEnv.getHtmlLabelNames("16539,128460",user.getLanguage())));
      out.write(_jsp_string166, 0, _jsp_string166.length);
      out.print((pointids));
      out.write(_jsp_string167, 0, _jsp_string167.length);
      out.print((SystemEnv.getHtmlLabelName(23994,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("servicesetting/schedulesettingnew.jsp"), 3964962710144595190L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string164 = "\");\r\n		document.getElementById(\"scheduleid\").value = \"\";\r\n		checkinput('scheduleid','scheduleidspan');\r\n		\r\n		return false;\r\n	}\r\n	if(isChineseChar(newvalue)){\r\n		//\u8ba1\u5212\u4efb\u52a1\u540d\u79f0\u5305\u542b\u4e2d\u6587\uff0c\u8bf7\u91cd\u65b0\u8f93\u5165\uff01\r\n		//top.Dialog.alert(newvalue+\"".toCharArray();
    ...
    _jsp_string160 = "\" onclick='onBack();'></input>\r\n				".toCharArray();

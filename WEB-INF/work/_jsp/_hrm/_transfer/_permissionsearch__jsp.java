...
public class _permissionsearch__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_3.set_callback("doProcFrom");
                _jsp_BrowserTag_3.setAfterDelCallback("delFromCall");
                _jsp_BrowserTag_3.setBrowserValue(fromid );
                _jsp_BrowserTag_3.setBrowserSpanValue(fromname );
      ...
      out.print(((cmd.equals("showContent") || fromid.length() > 0) ? "" : "display:none"));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/transfer/PermissionSearch.jsp"), -4174085562572470383L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string150 = "\">\r\n				<div class=\"xTable_message\" style=\"top:30%;left:40%\">".toCharArray();
    ...
    _jsp_string149 = "\r\n			</div>\r\n			<div id=\"contentDiv\" style=\"position:absolute!important;top:70px!important;height:auto!important;position:relative;height:100%;bottom:4px;width:100%;overflow:auto;".toCharArray();

...
public class _workflownodegroup__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((WorkTypeComInfo.getWorkTypeid()));
                out.write(_jsp_string162, 0, _jsp_string162.length);
                out.print((workflowType.equals(WorkTypeComInfo.getWorkTypeid())?"selected":""));
                out.write('>');
                out.print((WorkTypeComInfo.getWorkTypename()));
                out.write(_jsp_string160, 0, _jsp_string160.length);
                }
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(33476,user.getLanguage())));
      ...
      _jsp_SplitPageTag_4.setSelectedstrs(selectedstrs);
      _jsp_SplitPageTag_4.doStartTag();
      int _jsp_end_51 = _jsp_SplitPageTag_4.doEndTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/transfer/WorkflowNodeGroup.jsp"), -1440587302304174201L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string105 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string168 = "\" class=\"e8_btn_cancel\" id=\"cancel\"/>\r\n						".toCharArray();
    ...
    _jsp_string166 = "\" class=\"e8_btn_submit\" onclick=\"doAdvancedSearch();\"/>\r\n							<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string74 = "\";\r\n        dialog.Width = 550 ;\r\n        dialog.Height = 600;\r\n        dialog.Drag = true;\r\n        dialog.show();\r\n    });\r\n\r\n}\r\n</script>\r\n		\r\n\r\n\r\n".toCharArray();
    _jsp_string152 = "</span><span title=\"".toCharArray();
    _jsp_string154 = "\r\n					".toCharArray();
    ...
    _jsp_string167 = "\" class=\"e8_btn_cancel\" onclick=\"doReset();\"/>\r\n							<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string156 = "<input type=\"text\" class=InputStyle maxLength=50 size=30 name=\"groupname\" value='".toCharArray();
    ...
    _jsp_string164 = "<input type=\"text\" class=InputStyle maxLength=50 size=30 name=\"workflowName\" value='".toCharArray();
    ...
    _jsp_string169 = "\r\n				".toCharArray();
    _jsp_string158 = "<input type=\"text\" class=InputStyle maxLength=50 size=30 name=\"nodename\" value='".toCharArray();
    _jsp_string185 = "'\r\n				};\r\n				parentDialog.callback(data);\r\n				doCloseDialog();\r\n			}\r\n		}\r\n\r\n		function selectAll(){\r\n			if (parentDialog) {\r\n				var data = {\r\n					type: '".toCharArray();
    ...
    _jsp_string178 = "\" class=\"e8_btn_cancel\" onclick=\"parentDialog.close();\">\r\n		    	".toCharArray();

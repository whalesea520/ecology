...
public class _workflowhandledmatters__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/transfer/WorkflowHandledMatters.jsp"), -2730114560208284572L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string156 = " <input type=\"text\" class=InputStyle maxLength=50 size=30 name=\"eventName\" value='".toCharArray();
    _jsp_string154 = "\r\n					".toCharArray();
    ...
    _jsp_string158 = " <input type=\"text\" class=InputStyle maxLength=50 size=30 name=\"eventCode\" value='".toCharArray();
    ...
    _jsp_string164 = " <input type=\"text\" class=InputStyle maxLength=50 size=30 name=\"eventWorkFlowName\" value='".toCharArray();

...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/jobactivities/indexTreeLeft.jsp"), -5532320971551802270L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string67 = "&selectedids=&id=\" + treeNode.id + \"&type=\"+treeNode.type+\"&\" + treeNode.ajaxParam + \"&\" + new Date().getTime() + \"=\" + new Date().getTime();\r\n	    } else {\r\n	    	//\u521d\u59cb\u5316\u65f6\r\n	    	return \"/hrm/jobactivities/indexTreeLeftXML.jsp?searchStr=".toCharArray();
    ...
    _jsp_string68 = "&init=true&id=".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();

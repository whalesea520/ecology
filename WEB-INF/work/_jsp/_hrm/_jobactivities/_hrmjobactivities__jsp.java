...
public class _hrmjobactivities__jsp extends com.caucho.jsp.JavaPage
{
...
String qname = Util.null2String(request.getParameter("flowTitle"));
      ...
      out.print((SystemEnv.getHtmlLabelName(26473,user.getLanguage())+SystemEnv.getHtmlLabelName(1915,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(1915,user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((jobgroup));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((SystemEnv.getHtmlLabelName(26473,user.getLanguage())+SystemEnv.getHtmlLabelName(805,user.getLanguage())));
      out.write(_jsp_string71, 0, _jsp_string71.length);
      out.print((SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(805,user.getLanguage())));
      out.write(_jsp_string72, 0, _jsp_string72.length);
      out.print((xssUtil.put("where operateitem=25 and relatedid=")));
      out.write(_jsp_string73, 0, _jsp_string73.length);
      out.print((xssUtil.put("where operateitem=25")));
      ...
      out.print((JobGroupsComInfo.getJobGroupsname(jobgroup)));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelNames("82,805",user.getLanguage())));
      out.write(_jsp_string149, 0, _jsp_string149.length);
      out.print((SystemEnv.getHtmlLabelNames("82,1915",user.getLanguage())));
...
tableString =" <table pageId=\""+PageIdConst.HRM_JobActivities+"\" tabletype=\""+tabletype+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.HRM_JobActivities,user.getUID(),PageIdConst.HRM)+"\" >"+
    ...
    " </table>";
      ...
      out.print(( PageIdConst.HRM_JobActivities ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/jobactivities/HrmJobActivities.jsp"), -6291484210435217916L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string160 = "<input type=\"text\" id=\"jobactivityname\" name=\"jobactivityname\" class=\"inputStyle\" value=".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string158 = "<input type=\"text\" id=\"jobactivitymark\" name=\"jobactivitymark\" class=\"inputStyle\" value='".toCharArray();
    ...
    _jsp_string148 = "\r\n				<input type=button class=\"e8_btn_top\" onclick=\"openDialogJobGroup();\" value=\"".toCharArray();
    _jsp_string104 = "px\">\r\n</iframe>\r\n</div>\r\n".toCharArray();

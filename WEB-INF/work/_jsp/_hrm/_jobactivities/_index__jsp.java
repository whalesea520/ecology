...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	String cid = Util.null2String(request.getParameter("cid"));
      ...
      out.print((SystemEnv.getHtmlLabelNames("357",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/jobactivities/index.jsp"), -1757382015173586576L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string67 = "&searchStr=\"+$(\"#leftSearch\").val());\r\n			            }\r\n			        }; \r\n					$(\".searchImg\").click(function(){ \r\n						//if($(\"#leftSearch\").val() != ''){\r\n							$(\"#contentframe1\").attr(\"src\",\"indexTreeLeft.jsp?cid=".toCharArray();
    ...
    _jsp_string68 = "&searchStr=\"+$(\"#leftSearch\").val());\r\n						//}\r\n					 });\r\n				},1000);\r\n			});\r\n			function onfouc(){\r\n				jQuery(\"#leftSearch\").focus();\r\n			}\r\n		</script>\r\n	</body>\r\n</html>\r\n".toCharArray();

...
public class _hrmorggrouplist__jsp extends com.caucho.jsp.JavaPage
{
...
if(!HrmUserVarify.checkUserRight("GroupsSet:Maintenance", user)){
	...
	return;
      ...
      out.print((SystemEnv.getHtmlLabelNames("82,24002", user.getLanguage())));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((SystemEnv.getHtmlLabelNames("33534", user.getLanguage())));
      out.write(_jsp_string71, 0, _jsp_string71.length);
      out.print((SystemEnv.getHtmlLabelNames("24662", user.getLanguage())));
...
String tableString =" <table pageId=\""+PageIdConst.HRM_OrgGroupList+"\" tabletype=\""+tabletype+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.HRM_OrgGroupList,user.getUID(),PageIdConst.HRM)+"\" >"+
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(24679,user.getLanguage())));
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(24680,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
      ...
      out.print(( PageIdConst.HRM_OrgGroupList ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/orggroup/HrmOrgGroupList.jsp"), 3934295931022661833L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string155 = "\r\n				<input type=\"text\" name=\"orgGroupName\" class=\"inputStyle\" value=".toCharArray();
    _jsp_string0 = "\r\n \r\n\r\n".toCharArray();
    ...
    _jsp_string147 = "\r\n					<input type=button class=\"e8_btn_top\" onclick=\"hrmOrgGroupAdd();\" value=\"".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    ...
    _jsp_string157 = "\r\n				<input type=\"text\" name=\"orgGroupDesc\" class=\"inputStyle\" value=".toCharArray();
    ...
    _jsp_string159 = "\" class=\"e8_btn_submit\" onclick=\"onBtnSearchClick();\"/>\r\n			<input type=\"button\" value=\"".toCharArray();

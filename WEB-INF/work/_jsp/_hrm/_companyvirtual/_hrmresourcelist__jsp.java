...
public class _hrmresourcelist__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(34078,user.getLanguage())));
      out.write(_jsp_string136, 0, _jsp_string136.length);
      out.print((SystemEnv.getHtmlLabelName(34095,user.getLanguage())));
      out.write(_jsp_string137, 0, _jsp_string137.length);
      out.print((id));
      out.write(_jsp_string135, 0, _jsp_string135.length);
      out.print((SystemEnv.getHtmlLabelName(34078,user.getLanguage())));
      out.write(_jsp_string138, 0, _jsp_string138.length);
      out.print((xssUtil.put("where operateitem=415 and relatedid=")));
      out.write(_jsp_string139, 0, _jsp_string139.length);
      out.print((xssUtil.put("where operateitem=415")));
      ...
      out.print((SystemEnv.getHtmlLabelName(83474,user.getLanguage())));
      ...
      out.print((DepartmentVirtualComInfo.getVirtualtype(""+id) ));
      ...
      _jsp_BrowserTag_0.setName("resourceids");
      _jsp_BrowserTag_0.setBrowserValue("");
      _jsp_BrowserTag_0.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/hrm/resource/MutiResourceBrowser.jsp");
      ...
      _jsp_BrowserTag_0.setBrowserBtnID("resourceBtn");
      _jsp_BrowserTag_0.setCompleteUrl("/data.jsp");
      _jsp_BrowserTag_0.setWidth("200px");
      _jsp_BrowserTag_0.set_callback("saveHrmResource");
      ...
      out.print((SystemEnv.getHtmlLabelNames("611,30042",user.getLanguage())));
      out.write(_jsp_string154, 0, _jsp_string154.length);
      out.print((SystemEnv.getHtmlLabelNames("34078",user.getLanguage())));
...
tableString =" <table pageId=\""+PageIdConst.HRM_ResourceListVirtual+"\" tabletype=\""+tabletype+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.HRM_ResourceListVirtual,user.getUID(),PageIdConst.HRM)+"\" >"+
    ...
    " </table>";
      ...
      out.print(( PageIdConst.HRM_ResourceListVirtual ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/companyvirtual/HrmResourceList.jsp"), 5148682706012283340L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string153 = "\r\n			<input type=button class=\"e8_btn_top\" onclick=\"addHrmResource();\"  value=\"".toCharArray();
    ...
    _jsp_string146 = "\",\r\n							type:\"post\",\r\n							async:true,\r\n							complete:function(xhr,status){\r\n								frmMain.submit();\r\n							}\r\n						});\r\n					}else{\r\n						//\u6570\u636e\u5f02\u5e38\u63d0\u793a\r\n						window.top.Dialog.alert(errInfo);\r\n						//window.top.Dialog.confirm(errInfo,function(){\r\n							//jQuery.ajax({\r\n							//	url:\"ResourceOperation.jsp?isdialog=1&operation=setDepartmentVirtual&resourceids=\"+resourceids+\"&departmentid=".toCharArray();
    _jsp_string150 = "\">\r\n<input name=\"virtualtype\" id=\"virtualtype\" type=\"hidden\" value=\"".toCharArray();
    _jsp_string139 = "&relatedid=\"+id;\r\n	}else{\r\n		url = \"/docs/tabs/DocCommonTab.jsp?_fromURL=3&isdialog=1&secid=65&sqlwhere=".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string137 = "\");\r\n		return;\r\n	}\r\n	if(id.match(/,$/)){\r\n		id = id.substring(0,id.length-1);\r\n	}\r\n	dialog.Width = 400;\r\n	dialog.Height = 200;\r\n	var url = \"/hrm/HrmDialogTab.jsp?_fromURL=HrmResourceVirtualManagerSets&isdialog=1&ids=\"+id+\"&departmentid=".toCharArray();
    ...
    _jsp_string143 = "\r\n						errInfo += dataitem[\"lastname\"]+\"".toCharArray();
    ...
    _jsp_string154 = "\"></input>\r\n			<input type=button class=\"e8_btn_top\" onclick=\"setHrmManagers()\"  value=\"".toCharArray();
    ...
    _jsp_string145 = "\r\n					}\r\n					if(i==0){\r\n						//\u4fdd\u5b58\u6570\u636e\r\n						jQuery.ajax({\r\n							url:\"ResourceOperation.jsp?isdialog=1&operation=setDepartmentVirtual&resourceids=\"+resourceids+\"&departmentid=".toCharArray();
    _jsp_string144 = "\"+dataitem[\"virtualtypename\"];\r\n						".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();

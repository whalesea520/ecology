...
String needhelp ="";
      ...
      out.print((id));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((SystemEnv.getHtmlLabelNames("93,34069", user.getLanguage())));
      ...
      out.print((xssUtil.put("where operateitem=412 and relatedid=")));
      out.write(_jsp_string78, 0, _jsp_string78.length);
      out.print((xssUtil.put("where operateitem=412")));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/companyvirtual/HrmCompanyDsp.jsp"), 7385015363582740682L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string72 = "\";\r\n	}else if(cmd==\"addSubCompany\"){\r\n		url = \"/hrm/HrmDialogTab.jsp?_fromURL=HrmSubCompanyAddVirtual&companyid=".toCharArray();
    ...
    _jsp_string152 = "\r\n				<input type=button class=\"e8_btn_top\" onclick=\"addCompany();\" value=\"".toCharArray();
    ...
    _jsp_string70 = "\";\r\n	}else if(cmd==\"edit\"){\r\n		url = \"/hrm/HrmDialogTab.jsp?_fromURL=HrmCompanyEditVirtual&id=".toCharArray();
    ...
    _jsp_string68 = "')\r\n});\r\n\r\nfunction setID(id){\r\n	jQuery(\"#id\").val(id);\r\n}\r\n\r\nfunction onBtnSearchClick(){\r\n	parent.parent.jsReloadTree();\r\n	jQuery(\"#searchfrm\").submit();\r\n}\r\n\r\nvar dialog = null;\r\nfunction closeDialog(){\r\n	if(dialog)\r\n		dialog.close();\r\n}\r\n\r\nfunction openDialog(cmd,id){\r\n	dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	\r\n	if(id==null)id=\"\";\r\n	var url = \"\";\r\n	if(cmd==\"add\"){\r\n		url = \"/hrm/HrmDialogTab.jsp?_fromURL=HrmCompanyAddVirtual&virtualtype=".toCharArray();
    ...
    _jsp_string74 = "\";\r\n		dialog.Width = 600;\r\n		dialog.Height = 300;\r\n	}\r\n	dialog.Drag = true;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n}\r\n\r\nfunction addCompany(id)\r\n{\r\n	openDialog(\"add\",id);\r\n}\r\n\r\nfunction editCompany(id)\r\n{\r\n	openDialog(\"edit\",id);\r\n}\r\n\r\nfunction delCompany(){\r\n	jQuery.ajax({\r\n		url:\"/hrm/ajaxData.jsp?cmd=checkcompany&companyid=".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string71 = "&virtualtype=".toCharArray();
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    ...
    _jsp_string87 = "\";\r\n        dialog.Width = 550 ;\r\n        dialog.Height = 600;\r\n        dialog.Drag = true;\r\n        dialog.show();\r\n    });\r\n\r\n}\r\n</script>\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string154 = "\r\n				<input type=button class=\"e8_btn_top\" onclick=\"editCompany();\" value=\"".toCharArray();
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();

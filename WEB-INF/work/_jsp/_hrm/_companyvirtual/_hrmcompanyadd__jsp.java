...
public class _hrmcompanyadd__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(26603, user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/companyvirtual/HrmCompanyAdd.jsp"), -2655880509667965979L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string157 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"parentWin.closeDialog();\">\r\n				".toCharArray();
    ...
    _jsp_string141 = "\" class=\"e8_btn_top\" onclick=\"submitData();\">\r\n			".toCharArray();

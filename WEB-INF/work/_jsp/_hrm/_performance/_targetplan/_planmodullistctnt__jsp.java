...
public class _planmodullistctnt__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.conn.RecordSet RecordSetu;
      RecordSetu = (weaver.conn.RecordSet) pageContext.getAttribute("RecordSetu");
      if (RecordSetu == null) {
        RecordSetu = new weaver.conn.RecordSet();
        pageContext.setAttribute("RecordSetu", RecordSetu);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.conn.RecordSet RecordSetd;
      RecordSetd = (weaver.conn.RecordSet) pageContext.getAttribute("RecordSetd");
      if (RecordSetd == null) {
        RecordSetd = new weaver.conn.RecordSet();
        pageContext.setAttribute("RecordSetd", RecordSetd);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(18220,user.getLanguage())));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                if (Util.null2String(timeModul).equals("9")){
                ...
                if (Util.null2String(timeModul).equals("3")){
                out.write(_jsp_string155, 0, _jsp_string155.length);
                }
                out.write('>');
                ...
                if (Util.null2String(timeModul).equals("1")){
                out.write(_jsp_string155, 0, _jsp_string155.length);
                }
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(18222,user.getLanguage())));
                ...
                if (Util.null2String(timeModul).equals("2")){
                out.write(_jsp_string155, 0, _jsp_string155.length);
                }
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(18222,user.getLanguage())));
      ...
      out.print(( PageIdConst.WP_PlanModuleList));
      ...
      if (_jsp_SplitPageTag_4 == null) {
        ...
        _jsp_SplitPageTag_4.setIsShowTopInfo("true");
      }
      ...
      out.print((SystemEnv.getHtmlLabelName(21149,user.getLanguage())+(user.getLanguage() == 8?" ":"")+SystemEnv.getHtmlLabelName(25008,user.getLanguage())));
      out.write(_jsp_string181, 0, _jsp_string181.length);
      out.print((SystemEnv.getHtmlLabelName(21149,user.getLanguage())+(user.getLanguage() == 8?" ":"")+SystemEnv.getHtmlLabelName(25009,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/performance/targetPlan/PlanModulListCtnt.jsp"), -6718247863123276004L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string136 = "\" class=\"e8_btn_top middle\" onclick=\"add()\"/>\r\n			<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string139 = "\" class=\"cornerMenu middle\"></span>\r\n		</td>\r\n	</tr>\r\n</table>\r\n<div id=\"tabDiv\" >\r\n	<span id=\"hoverBtnSpan\" class=\"hoverBtnSpan\">\r\n			<span >".toCharArray();
    ...
    _jsp_string145 = "      \r\n					<INPUT class=\"inputstyle\"  maxLength=50 size=50 name=\"planName\" id=\"planName\" value=\"".toCharArray();
    _jsp_string123 = "\"></td>\r\n							".toCharArray();
    ...
    _jsp_string73 = "\";\r\n        dialog.Width = 550 ;\r\n        dialog.Height = 600;\r\n        dialog.Drag = true;\r\n        dialog.show();\r\n    });\r\n\r\n}\r\n</script>\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string160 = "</OPTION><!--\u5e74-->\r\n					</SELECT>\r\n				".toCharArray();
    _jsp_string9 = "\r\n<script type=\"text/javascript\" src=\"/wui/common/jquery/jquery.min_wev8.js\"></script>\r\n".toCharArray();
    _jsp_string42 = "\";\r\n  var str1 = \"".toCharArray();
    _jsp_string146 = "\" onchange='checkinput(\"name\",\"nameimage\")'>\r\n				".toCharArray();
    ...
    _jsp_string162 = "\r\n				<input type=\"button\" onclick=\"doSearchAgain();\" class=\"e8_btn_submit\" value=\"".toCharArray();
    ...
    _jsp_string175 = "\";\r\n	diag_vote.URL = \"/hrm/performance/targetPlan/PlanModelAdd.jsp?target=".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();

...
public class _hrmresourcepersonalviewnew__jsp extends com.caucho.jsp.JavaPage
{
...
while(HrmFieldGroupComInfo.next()){
	...
	while(hfm.next()){
      ...
      if (_jsp_ViewTag_4 == null) {
        ...
        _jsp_ViewTag_4.setAttributes("{'expandAllGroup':'true'}");
      }
...
if(HrmListValidate.isValidate(45)){
  ...
  rs.executeSql(sql);
          ...
          _jsp_GroupTag_5.setContext(SystemEnv.getHtmlLabelName(814,user.getLanguage()));
          _jsp_GroupTag_5.setAttributes("{'groupDisplay':'none','samePair':'HrmFamilyInfo'}");
          ...
          if (_jspEval29 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_ViewTag_7.setAttributes("{'cols':'5','expandAllGroup':'true'}");
                int _jspEval35 = _jsp_ViewTag_7.doStartTag();
                if (_jspEval35 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  if (_jspEval35 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
                    ...
                    _jsp_ViewTag_7.setBodyContent(_jsp_endTagHack33);
                  ...
                  do {
                    ...
                    int _jspEval38 = _jsp_GroupTag_8.doStartTag();
                    if (_jspEval38 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      if (_jspEval38 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
                        ...
                        _jsp_GroupTag_8.setBodyContent(_jsp_endTagHack36);
                      ...
                      do {
                        ...
                        _jsp_ItemTag_9.setBodyContent(_jsp_endTagHack39);
                        ...
                        _jsp_ItemTag_9.setBodyContent(_jsp_endTagHack43);
                        _jsp_ItemTag_9.doInitBody();
                        do {
                        ...
                        _jsp_ItemTag_9.setBodyContent(_jsp_endTagHack47);
                        _jsp_ItemTag_9.doInitBody();
                        do {
                        ...
                        _jsp_ItemTag_9.setBodyContent(_jsp_endTagHack51);
                        _jsp_ItemTag_9.doInitBody();
                        do {
                        ...
                        _jsp_ItemTag_9.setBodyContent(_jsp_endTagHack55);
                        _jsp_ItemTag_9.doInitBody();
                        do {
  ...
  while(rs.next()){
	...
	String address = Util.null2String(rs.getString("address"));
                        ...
                        _jsp_ItemTag_10.setBodyContent(_jsp_endTagHack59);
                        ...
                        _jsp_ItemTag_10.setBodyContent(_jsp_endTagHack63);
                        _jsp_ItemTag_10.doInitBody();
                        do {
                          out.print((title));
                        } while (_jsp_ItemTag_10.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
                        ...
                        _jsp_ItemTag_10.setBodyContent(_jsp_endTagHack67);
                        _jsp_ItemTag_10.doInitBody();
                        do {
                          out.print((company));
                        } while (_jsp_ItemTag_10.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
         ...
         while(RecordSet.next()){
          ...
          _jsp_GroupTag_5.setContext(RecordSet.getString("formlabel"));
          _jsp_GroupTag_5.setAttributes(attr );
...
attr = "{'cols':'"+col+"','layoutTableId':'oTable_"+subId+"','expandAllGroup':'true'}";
                ...
                _jsp_ViewTag_7.setAttributes(attr );
                int _jspEval91 = _jsp_ViewTag_7.doStartTag();
                if (_jspEval91 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  if (_jspEval91 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
                    ...
                    _jsp_ViewTag_7.setBodyContent(_jsp_endTagHack89);
                    _jsp_ViewTag_7.doInitBody();
                  }
                  do {
                    out.write(_jsp_string149, 0, _jsp_string149.length);
                    ...
                    int _jspEval94 = _jsp_GroupTag_8.doStartTag();
                    if (_jspEval94 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      if (_jspEval94 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
                        ...
                        _jsp_GroupTag_8.setBodyContent(_jsp_endTagHack92);
                        _jsp_GroupTag_8.doInitBody();
                      }
                      do {
       ...
       while(cfm2.next()){
		  ...
		  String fieldlable =String.valueOf(cfm2.getLable());
                        ...
                        _jsp_ItemTag_9.doInitBody();
                        do {
                          out.print((SystemEnv.getHtmlLabelName(Util.getIntValue(fieldlable,0) ,user.getLanguage())));
                        } while (_jsp_ItemTag_9.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
                        out = pageContext.popBody();
                        _jsp_ItemTag_9.doEndTag();
    ...
    while(CustomFieldTreeManager.nextMutiData()){
        while(cfm2.next()){
            ...
            String fieldvalue =  Util.null2String(CustomFieldTreeManager.getMutiData("field"+fieldid)) ;
                        ...
                        _jsp_ItemTag_10.setBodyContent(_jsp_endTagHack99);
                        _jsp_ItemTag_10.doInitBody();
                        do {
                          out.write(_jsp_string53, 0, _jsp_string53.length);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/resource/HrmResourcePersonalViewNew.jsp"), 3806505251952344039L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string176 = "&isView=".toCharArray();
    ...
    _jsp_string169 = " checked ".toCharArray();
    ...
    _jsp_string156 = "')\" target=\"_self\">".toCharArray();
    _jsp_string165 = "\r\n                ".toCharArray();

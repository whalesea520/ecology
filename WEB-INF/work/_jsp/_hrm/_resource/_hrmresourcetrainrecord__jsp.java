...
public class _hrmresourcetrainrecord__jsp extends com.caucho.jsp.JavaPage
{
...
if(!fromdatetoselect.equals("") && !fromdatetoselect.equals("0")&& !fromdatetoselect.equals("6")){
	...
	enddateto = TimeUtil.getDateByOption(fromdatetoselect,"1");
      ...
      out.print((SystemEnv.getHtmlLabelNames("24987,2121",user.getLanguage())));
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(33588,user.getLanguage())));
...
tableString =" <table pageId=\""+PageIdConst.HRM_ResourceTrainRecord+"\" tabletype=\"none\" pagesize=\""+ PageIdConst.getPageSize(PageIdConst.HRM_ResourceTrainRecord,user.getUID(),PageIdConst.HRM)+"\" >"+
    ...
    " </table>";
      ...
      out.print(( PageIdConst.HRM_ResourceTrainRecord ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/resource/HrmResourceTrainRecord.jsp"), 3334715447513585090L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string167 = "\" class=\"e8_btn_submit\" onclick=\"onBtnSearchClick();\"/>\r\n				<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string144 = "<input type=\"text\" id=\"planname\" name=\"planname\" class=\"inputStyle\" value='".toCharArray();

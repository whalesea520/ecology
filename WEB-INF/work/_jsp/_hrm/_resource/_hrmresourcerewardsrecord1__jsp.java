...
public class _hrmresourcerewardsrecord1__jsp extends com.caucho.jsp.JavaPage
{
...
while(rs.next()) {
    ...
    if(rs2.next()) kindname = Util.toScreen(rs2.getString("kindname"),user.getLanguage()) ;
      ...
      out.print((SystemEnv.getHtmlLabelName(15653,user.getLanguage())));
      out.write(_jsp_string143, 0, _jsp_string143.length);
      out.print((SystemEnv.getHtmlLabelName(15649,user.getLanguage())));
      out.write(_jsp_string143, 0, _jsp_string143.length);
      out.print((SystemEnv.getHtmlLabelName(15650,user.getLanguage())));
    ...
    while(rs2.next()) {
      ...
      out.print((resourceresultsum));
      out.write(_jsp_string149, 0, _jsp_string149.length);
      out.print((hasrecordcount));
...
String tableString = " <table pageId=\""+ PageIdConst.HRM_ResourceRewardRecord2+"\" tabletype=\"none\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.HRM_ResourceRewardRecord2,user.getUID(),PageIdConst.HRM)+"\" >"+
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/resource/HrmResourceRewardsRecord1.jsp"), -8934355785841357482L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string146 = "'>\r\n     <td><a href=\"/hrm/HrmTab.jsp?_fromURL=HrmResourceRewardsRecordDetail&checkid=".toCharArray();
    ...
    _jsp_string147 = "\" target=\"_fullwindow\">".toCharArray();

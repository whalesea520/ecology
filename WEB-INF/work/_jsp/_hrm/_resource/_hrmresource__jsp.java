...
public class _hrmresource__jsp extends com.caucho.jsp.JavaPage
{
...
while(rs.next())
{
	tabInfo.put(rs.getString("name"), rs.getString("tab_url")+"?id="+id);
      ...
      out.print((SystemEnv.getHtmlLabelName(20694,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/resource/HrmResource.jsp"), 6007749219682194724L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string67 = "\r\n<BODY scroll=\"no\"> \r\n<DIV style=\"\" id=loading><SPAN><IMG align=absMiddle src=\"/images/loading2_wev8.gif\"></SPAN> <SPAN id=loading-msg>".toCharArray();
    _jsp_string72 = ")>\r\n            <a href=\"".toCharArray();
    ...
    _jsp_string73 = "\" target=\"tabcontentframe\" onclick=\"$('#loading').show();\">\r\n             ".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    ...
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string76 = "\" id=\"tabcontentframe\" name=\"tabcontentframe\" class=\"flowFrame\" frameborder=\"0\" height=\"100%\" width=\"100%;\" onload=\"loading()\"></iframe>\r\n         </div>\r\n     </div>\r\n </div>  \r\n <table id=\"topTitle\" cellpadding=\"0\" cellspacing=\"0\">\r\n	<tr>\r\n		<td>\r\n		</td>\r\n		<td class=\"rightSearchSpan\" style=\"text-align:right;\">\r\n\r\n				<input type=button class=\"e8_btn_top\" onclick=\"onSave(this);\" value=\"".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();
  }
}

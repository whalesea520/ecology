...
public class _hrmscheduleabsensedatedetail__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	if(!curDate.equals("")){
      ...
      _jsp_ViewTag_0.setAttributes("{'cols':'6','cws':'18%,15%,12%,18%,15%,15%','formTableId':'oTable4op'}");
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setAttributes("{'samePair':'hrmStatus','groupDisplay':''}");
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(382099,user.getLanguage())));
      ...
      _jsp_ViewTag_0.setAttributes("{'cols':'5','cws':'20%,20%,20%,15%,25%','formTableId':'fTable4op'}");
      ...
      if (_jspEval62 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelNames("15880,18015",user.getLanguage()));
          _jsp_GroupTag_1.setAttributes("{'samePair':'flowStatus','groupDisplay':''}");
          ...
          if (_jspEval65 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(16070,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelNames("21551,81913,1925,81914",user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/resource/HrmScheduleAbsenseDateDetail.jsp"), 2971846064812583816L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

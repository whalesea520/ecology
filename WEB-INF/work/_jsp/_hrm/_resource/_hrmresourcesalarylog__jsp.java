...
public class _hrmresourcesalarylog__jsp extends com.caucho.jsp.JavaPage
{
...
if(show){
    ...
    for(int i=0;i<itemlist.size();i++) {
      ...
      out.print((itemname+"("+SystemEnv.getHtmlLabelName(6087,user.getLanguage())+")"));
      out.write(_jsp_string143, 0, _jsp_string143.length);
      out.print((itemname+"("+SystemEnv.getHtmlLabelName(1851,user.getLanguage())+")"));
      out.write(_jsp_string141, 0, _jsp_string141.length);
         }
    }
    ...
    if(salaryitems.size()>0){
      ...
      out.print((( isLight ? "datalight" : "datadark" )));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/resource/HrmResourceSalaryLog.jsp"), 1613038726127155583L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string150 = "style=\"cursor:hand\"".toCharArray();
    ...
    _jsp_string142 = "\r\n   <TH style=\"TEXT-ALIGN:LEFT\"><nobr>".toCharArray();
    _jsp_string124 = "\"></td>\r\n							".toCharArray();
    ...
    _jsp_string151 = "><nobr>".toCharArray();
    _jsp_string64 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();

...
public class _hrmresourcehire__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
        ...
        do {
          ...
          if (_jspEval6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(16090,user.getLanguage())));
		  ...
		  String browserUrl = "/systeminfo/BrowserMain.jsp?url=/hrm/resource/MultiResourceBrowserByRight.jsp?rightStr=HrmResourceAdd:Add&fromHrmStatusChange=HrmResourceHire&sqlwhere="+xssUtil.put(sqlwhere)+"&selectedids=";
			String completeUrl = "/data.jsp?whereClause="+xssUtil.put("(status =0  or status = 2 or status = 3) and t1.subcompanyid1 in("+subcomstr+")");
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(6122,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(6123,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(16091,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                _jsp_BrowserTag_4.setName("infoman");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/resource/HrmResourceHire.jsp"), -6653213038642301270L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string65 = "\r\n\r\n\r\n<html>\r\n".toCharArray();
    _jsp_string144 = "<IMG src='/images/BacoError_wev8.gif' align=absMiddle>".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string143 = "\r\n		 <!-- \r\n		 	<BUTTON class=Browser type=\"button\" onclick=\"onShowResourceID(resourceid,assistantidspan)\"></BUTTON> \r\n	        <SPAN id=assistantidspan>".toCharArray();
    ...
    _jsp_string148 = "\r\n	        </SPAN>\r\n	        <input class=inputstyle type=hidden name=resourceid onChange='checkinput(\"resourceid\",\"assistantidspan\")' value=\"".toCharArray();

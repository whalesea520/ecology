...
public class _hrmresourcerewardsrecord2__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.hrm.award.AwardComInfo AwardComInfo;
      AwardComInfo = (weaver.hrm.award.AwardComInfo) pageContext.getAttribute("AwardComInfo");
      if (AwardComInfo == null) {
        AwardComInfo = new weaver.hrm.award.AwardComInfo();
        pageContext.setAttribute("AwardComInfo", AwardComInfo);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.hrm.check.CheckItemComInfo CheckItemComInfo;
      CheckItemComInfo = (weaver.hrm.check.CheckItemComInfo) pageContext.getAttribute("CheckItemComInfo");
      if (CheckItemComInfo == null) {
        CheckItemComInfo = new weaver.hrm.check.CheckItemComInfo();
        pageContext.setAttribute("CheckItemComInfo", CheckItemComInfo);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
String qname = Util.null2String(request.getParameter("flowTitle"));
      ...
      out.print((SystemEnv.getHtmlLabelNames("81800,87",user.getLanguage())));
...
tableString =" <table pageId=\""+ PageIdConst.HRM_ResourceRewardRecord2+"\" tabletype=\"none\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.HRM_ResourceRewardRecord2,user.getUID(),PageIdConst.HRM)+"\" >"+
    ...
    " </table>";
      ...
      out.print(( PageIdConst.HRM_ResourceRewardRecord2 ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/resource/HrmResourceRewardsRecord2.jsp"), -7078686978712456199L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string146 = "\" class=\"e8_btn_submit\" onclick=\"onBtnSearchClick();\"/>\r\n			<input type=\"button\" value=\"".toCharArray();

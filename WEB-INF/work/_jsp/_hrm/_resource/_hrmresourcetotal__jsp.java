...
public class _hrmresourcetotal__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string52, 0, _jsp_string52.length);
      weaver.hrm.train.TrainComInfo TrainComInfo;
      TrainComInfo = (weaver.hrm.train.TrainComInfo) pageContext.getAttribute("TrainComInfo");
      if (TrainComInfo == null) {
        TrainComInfo = new weaver.hrm.train.TrainComInfo();
        pageContext.setAttribute("TrainComInfo", TrainComInfo);
      }
      out.write(_jsp_string52, 0, _jsp_string52.length);
      weaver.hrm.train.TrainPlanComInfo TrainPlanComInfo;
      TrainPlanComInfo = (weaver.hrm.train.TrainPlanComInfo) pageContext.getAttribute("TrainPlanComInfo");
      if (TrainPlanComInfo == null) {
        TrainPlanComInfo = new weaver.hrm.train.TrainPlanComInfo();
        pageContext.setAttribute("TrainPlanComInfo", TrainPlanComInfo);
      }
      out.write(_jsp_string52, 0, _jsp_string52.length);
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(16426, user.getLanguage())));
      out.write(_jsp_string139, 0, _jsp_string139.length);
      out.print((SystemEnv.getHtmlLabelName(17859, user.getLanguage())));
	...
	if(HrmListValidate.isValidate(24) && (isSelf || user.getUID() == 1)){
		...
		String[] wTitles = new String[] {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelNames("385,17463",user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              if (_jsp_ItemTag_2 == null) {
                ...
                _jsp_ItemTag_2.setAttributes("{'isTableList':'true','colspan':'full'}");
              }
              ...
              do {
                ...
                if (_jsp_ViewTag_3 == null) {
                  ...
                  _jsp_ViewTag_3.setAttributes("{'cols':'3','cws':'30%,30%,40%'}");
                }
                  ...
                  do {
                    ...
                    if (_jspEval14 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      ...
                      do {
                        ...
                        do {
                          out.print((SystemEnv.getHtmlLabelNames("385,63",user.getLanguage())));
...
while( RecordSet.next() ) {
    ...
    if (startdates.isEmpty() || enddates.isEmpty() || enddates.size()<12)
    	FnaExpenseResource = false;
                        ...
                        _jsp_ItemTag_6.doInitBody();
                        do {
                          out.print((SystemEnv.getHtmlLabelName(428,user.getLanguage())));
                        } while (_jsp_ItemTag_6.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
                        out = pageContext.popBody();
                        _jsp_ItemTag_6.doEndTag();
                        ...
                        _jsp_ItemTag_6.doInitBody();
                        do {
                          out.print((SystemEnv.getHtmlLabelName(386,user.getLanguage())));
                        } while (_jsp_ItemTag_6.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
                        out = pageContext.popBody();
                        _jsp_ItemTag_6.doEndTag();
	...
	//Added by wcd 2014-11-07 end
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(122,user.getLanguage())+","+SystemEnv.getHtmlLabelName(139,user.getLanguage()));
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(16068,user.getLanguage()));
...
String trainid = (String)al.get(i);
              ...
              do {
                ...
                out.print((TrainComInfo.getTrainname(trainid)));
                out.write(_jsp_string147, 0, _jsp_string147.length);
              } while (_jsp_ItemTag_8.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_8.doEndTag();
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(16069,user.getLanguage()));
...
String trainplanid = (String)al.get(i);
              ...
              do {
                ...
                out.print((trainplanid));
                out.write(_jsp_string149, 0, _jsp_string149.length);
                out.print((TrainPlanComInfo.getTrainPlanname(trainplanid)));
                out.write(_jsp_string147, 0, _jsp_string147.length);
              } while (_jsp_ItemTag_8.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_8.doEndTag();
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(15652,user.getLanguage()));
...
String resourceid = Util.null2String(rs.getString(3)) ;
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/resource/HrmResourceTotal.jsp"), -6531632345005080889L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string140 = "\"></input>\r\n		  <span title=\"".toCharArray();
    _jsp_string19 = "&f_weaver_belongto_usertype=".toCharArray();
    _jsp_string148 = "<a href=\"/fna/report/expense/FnaExpenseResourceDetail.jsp?resourceid=".toCharArray();
    _jsp_string103 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string165 = "&isView=1\";\r\n    }else{\r\n        if(".toCharArray();
    _jsp_string142 = "\r\n	".toCharArray();
    ...
    _jsp_string160 = "\" target=\"_Blank\">".toCharArray();
    ...
    _jsp_string149 = "\" target=\"_blank\">".toCharArray();
    ...
    _jsp_string147 = "</a>".toCharArray();
    _jsp_string159 = "&TrainPlanId=".toCharArray();
    ...
    _jsp_string151 = "\r\n		<table width=\"100%\">\r\n			".toCharArray();
    _jsp_string146 = "return false;\">".toCharArray();
    ...
    _jsp_string150 = "<a href=\"/fna/report/budget/FnaBudgetResourceDetail.jsp?resourceid=".toCharArray();
    ...
    _jsp_string157 = "<a href=\"/hrm/train/trainplan/HrmTrainPlanEdit.jsp?id=".toCharArray();
    _jsp_string35 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    ...
    _jsp_string145 = "<a href=\"javascript:void(0);\" onclick=\"".toCharArray();
    ...
    _jsp_string161 = "<a href=\"/hrm/actualize/HrmCheckMark.jsp?id=".toCharArray();
    ...
    _jsp_string39 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string166 = "){\r\n          location = \"HrmResourceContactEdit.jsp?id=".toCharArray();
    ...
    _jsp_string93 = "px\">\r\n</iframe>\r\n</div>\r\n".toCharArray();
    _jsp_string154 = "<a href=\"/hrm/HrmDialogTab.jsp?_fromURL=HrmTrainEditDo&isdialog=0&id=".toCharArray();
    ...
    _jsp_string158 = "<a href=\"/workflow/request/AddRequest.jsp?workflowid=".toCharArray();
    _jsp_string164 = ">0){\r\n      location = \"HrmResourceBasicEdit.jsp?id=".toCharArray();
    _jsp_string0 = "\r\n\r\n".toCharArray();

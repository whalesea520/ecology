...
public class _hrmimport__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(20211, user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
          ...
          if (_jspEval45 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(125868, user.getLanguage())));
                out.write(_jsp_string159, 0, _jsp_string159.length);
                out.print((SystemEnv.getHtmlLabelName(128365, user.getLanguage())));
                out.write(_jsp_string160, 0, _jsp_string160.length);
                out.print((SystemEnv.getHtmlLabelName(81697, user.getLanguage())));
                out.write(_jsp_string161, 0, _jsp_string161.length);
                out.print((SystemEnv.getHtmlLabelName(81698, user.getLanguage())));
                out.write(_jsp_string162, 0, _jsp_string162.length);
                out.print((SystemEnv.getHtmlLabelName(81699, user.getLanguage())));
                out.write(_jsp_string163, 0, _jsp_string163.length);
                out.print((SystemEnv.getHtmlLabelName(81700, user.getLanguage())));
                out.write(_jsp_string164, 0, _jsp_string164.length);
                out.print((SystemEnv.getHtmlLabelName(81701, user.getLanguage())));
                out.write(_jsp_string165, 0, _jsp_string165.length);
                out.print((SystemEnv.getHtmlLabelName(81702, user.getLanguage())));
                out.write(_jsp_string166, 0, _jsp_string166.length);
                out.print((SystemEnv.getHtmlLabelName(81703, user.getLanguage())));
                out.write(_jsp_string167, 0, _jsp_string167.length);
                out.print((SystemEnv.getHtmlLabelName(125869, user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/resource/HrmImport.jsp"), -8309515227943285456L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string145 = "</option>\r\n            <option value=\"loginid\">".toCharArray();
    _jsp_string123 = "\r\n							".toCharArray();
    ...
    _jsp_string182 = "</TH>\r\n			        </TR>\r\n			      </TABLE>\r\n			      <div id=\"result\"></div>\r\n           </DIV>\r\n	 </DIV>\r\n      <div style=\"padding-top: 5px\" align=\"center\">\r\n				<input id=\"closeBtn\" type=\"button\" value=\"[".toCharArray();
    _jsp_string168 = "		\r\n		".toCharArray();
    _jsp_string156 = " \r\n	\r\n	".toCharArray();
    ...
    _jsp_string146 = "</option>\r\n            <option value=\"lastname\">".toCharArray();
    ...
    _jsp_string153 = "<a href='/hrm/resource/inputexcellfile/hrminput.xls' style=\"color: #30b5ff\">".toCharArray();
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    _jsp_string194 = "]' class=zd_btn_cancle onclick=downLoadLog('\"+logFile+\"')>\");\r\n   }\r\n}\r\n\r\n\r\n/*\u5173\u95ed\u5f39\u51fa\u5c42\u5237\u65b0\u9875\u9762*/\r\n//  function closeDiv(){\r\n//   $(\"#divInfo\").dialog(\"close\");      //\u5173\u95eddialog\r\n//   window.location.reload();\r\n//}\r\n\r\n//modify yangdacheng 2011-12-02\r\n/*\u5173\u95ed\u5f39\u51fa\u5c42\u4e0d\u5237\u65b0\u9875\u9762*/\r\n  function closeDiv(){\r\n	document.getElementById(\"improstatus\").value='0';\r\n	//saveBtn.disabled = false;\r\n   $(\"#divInfo\").dialog(\"close\");      //\u5173\u95eddialog\r\n\r\n}\r\n\r\n\r\n/*\u6253\u5f00\u5386\u53f2\u5bfc\u5165\u8bb0\u5f55*/\r\nfunction openHistoryLog(){\r\n	$(\"#result\").html(\"\");\r\nvar tableHead = \"  <TABLE class=ListStyle cellspacing=1 >\" +\r\n		 \"<TBODY>\" + \r\n		 \"<TR class=HeaderForXtalbe>\" + \r\n		 \"<th width=\\\"30%\\\">".toCharArray();
    ...
    _jsp_string174 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.closeByHand();\">\r\n".toCharArray();
    _jsp_string76 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string154 = "</a>&nbsp;".toCharArray();
    _jsp_string181 = "</TH>\r\n					    <TH width=\"25%\">".toCharArray();

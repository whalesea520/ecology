...
public class _roleresourcebrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	String selectids = Util.null2String(request.getParameter("selectids"));
      ...
      out.print((JSONObject.quote(SystemEnv.getHtmlLabelName(33251, user.getLanguage())+SystemEnv.getHtmlLabelName(20570, user.getLanguage())) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/resource/RoleResourceBrowser.jsp"), 2081692332578504941L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string68 = "&sqlwhere=".toCharArray();
    _jsp_string49 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string67 = "&selectids=".toCharArray();
    _jsp_string39 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string69 = "\" width=\"100%\" height=\"80px\" frameborder=no scrolling=yes>\u6d4f\u89c8\u5668\u4e0d\u652f\u6301\u5d4c\u5165\u5f0f\u6846\u67b6\uff0c\u6216\u88ab\u914d\u7f6e\u4e3a\u4e0d\u663e\u793a\u5d4c\u5165\u5f0f\u6846\u67b6\u3002</iframe>\r\n					 -->\r\n					<iframe src=\"/hrm/resource/RoleResourceSelect.jsp?roleid=".toCharArray();
    ...
    _jsp_string70 = "\" onload=\"update();\" id=\"frame2\" name=\"frame2\" class=\"flowFrame\" frameborder=\"0\" height=\"455px\" width=\"100%;\"></iframe>\r\n				</div>\r\n			</div>\r\n		</div>\r\n		<script type=\"text/javascript\">\r\n			function onCancel(){\r\n				try{\r\n					var dialog = parent.getDialog(window);	\r\n					dialog.close();\r\n				}catch(ex1){}\r\n				doClose();\r\n			}\r\n\r\n			function doClose(){\r\n				try{\r\n					var parentWin = parent.parent.getParentWindow(window);\r\n					parentWin.closeDialog();\r\n				}catch(ex1){}\r\n			}\r\n			jQuery('.e8_box').Tabs({\r\n				getLine:1,\r\n				iframe:\"frame2\",\r\n				contentID:\"#frame1\",\r\n				mouldID:\"".toCharArray();
    _jsp_string2 = "\r\n<!DOCTYPE HTML>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n<html>\r\n<head>\r\n<!-- \r\n\u6dfb\u52a0\u81f3init.css\r\n<style type=\"text/css\">\r\n	html{height:100%;}\r\n</style>\r\n -->\r\n".toCharArray();

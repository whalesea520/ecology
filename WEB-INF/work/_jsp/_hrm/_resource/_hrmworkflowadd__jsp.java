...
public class _hrmworkflowadd__jsp extends com.caucho.jsp.JavaPage
{
...
int colorindex=0;
	...
	for(int i = 0 ; i<size; i++){
      ...
      out.print((WorkTypeComInfo.getWorkTypename(tmpType) ));
      out.write(_jsp_string145, 0, _jsp_string145.length);
      out.print((StringUtil.vString(WorkTypeComInfo.getWorkTypename(tmpType),10)));
      out.write(_jsp_string146, 0, _jsp_string146.length);
      out.print((wfMap.get(tmpType)));
      ...
      out.print((StringUtil.vString(WorkflowComInfo.getWorkflowname(wfid),20) ));
...
if(tdNum > 2){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/resource/HrmWorkflowAdd.jsp"), 8476800775085276469L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string146 = "\r\n	        	<font color=\"#989898\" style=\"font-weight: 400;margin-left:5px;\">(".toCharArray();
    ...
    _jsp_string144 = ";height:100%;float:left;\">\r\n	        	<label title=\"".toCharArray();
    _jsp_string155 = "\"==\"1\"){\r\n	parentWin.onBtnSearchClick();\r\n	parentWin.closeDialog();	\r\n}\r\nfunction onNewRequest(wfid,agent,beagenter){\r\n    var redirectUrl = \"/workflow/request/AddRequest.jsp?workflowid=\"+wfid+\"&isagent=\"+agent+\"&beagenter=\"+beagenter+\"&f_weaver_belongto_userid=".toCharArray();
    _jsp_string142 = "\r\n <tr>\r\n	<td width=\"25px\"></td>\r\n".toCharArray();
    ...
    _jsp_string149 = "\" style=\"margin-left:8px;margin-right:10px;cursor: pointer;\" onclick=\"javascript:onNewRequest(".toCharArray();

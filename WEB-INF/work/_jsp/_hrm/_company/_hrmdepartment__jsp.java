...
public class _hrmdepartment__jsp extends com.caucho.jsp.JavaPage
{
...
int hasshowrow = 0;
      ...
      if (_jsp_ViewTag_4 == null) {
        ...
        _jsp_ViewTag_4.setAttributes("{'cols':'2','expandAllGroup':'true'}");
      }
      ...
      if (_jspEval22 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_5.setContext(SystemEnv.getHtmlLabelName(124,user.getLanguage()));
       ...
       try{
	        ...
	        if("1".equals(caceled))
	        {
              ...
              do {
                ...
                out.print((cursubcompanyid));
                out.write(_jsp_string141, 0, _jsp_string141.length);
                out.print((isfirst==1?tmpname:""));
              ...
              do {
                ...
                out.print((DepartmentComInfo.getDepartmentid()));
                out.write(_jsp_string141, 0, _jsp_string141.length);
                out.print((DepartmentComInfo.getDepartmentmark()));
                out.write(_jsp_string145, 0, _jsp_string145.length);
                out.print((caceledstate ));
              } while (_jsp_ItemTag_7.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_7.doEndTag();
...
if(hasshowrow==0){
      ...
      out.print((SystemEnv.getHtmlNoteName(12,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/company/HrmDepartment.jsp"), 6808178598238468612L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string104 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string146 = "<a href=\"/hrm/company/HrmDepartmentDsp.jsp?id=".toCharArray();
    _jsp_string138 = "\r\n	".toCharArray();
    ...
    _jsp_string48 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string144 = "<a href=\"/hrm/company/HrmSubCompanyEdit.jsp?id=".toCharArray();
    ...
    _jsp_string140 = "\r\n       <a href=\"/hrm/company/HrmCompanyEdit.jsp?id=".toCharArray();

...
public class _mutidepartmentbyrightbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelNames("124",user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((passedDepartmentIds));
      out.write(_jsp_string146, 0, _jsp_string146.length);
      out.print((selectedDepartmentIds));
      ...
      if (_jsp_ViewTag_0 == null) {
        ...
        _jsp_ViewTag_0.setAttributes("{'formTableId':'BrowseTable'}");
      }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/company/MutiDepartmentByRightBrowser.jsp"), 7200565229065185847L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string164 = "&deptlevel=".toCharArray();
    ...
    _jsp_string162 = "&\" + treeNode.ajaxParam + \"&\" + new Date().getTime() + \"=\" + new Date().getTime();\r\n	    } else {\r\n	    	//\u521d\u59cb\u5316\u65f6\r\n	    	return \"/hrm/tree/DepartmentMultiByRightXML.jsp?rightStr=".toCharArray();
    _jsp_string157 = "\">\r\n				".toCharArray();
    ...
    _jsp_string155 = "\">\r\n				<input type=\"button\" class=zd_btn_submit accessKey=2  id=btnclear onclick=\"onClear()\" value=\"".toCharArray();
    ...
    _jsp_string145 = "\">\r\n            <textarea style=\"display:none\" name=passedDepartmentIds >".toCharArray();
    ...
    _jsp_string146 = "</textarea>\r\n            <textarea style=\"display:none\" name=selectedDepartmentIds >".toCharArray();
    _jsp_string156 = "\">\r\n        <input type=\"button\" class=zd_btn_submit accessKey=T  id=btncancel onclick=\"btncancel_onclick();\" value=\"".toCharArray();
    ...
    _jsp_string163 = "&isedit=".toCharArray();
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string165 = "&nodeids=".toCharArray();
    ...
    _jsp_string154 = "\r\n				<input type=\"button\" class=zd_btn_submit accessKey=O  id=btnok onclick=\"onSave()\" value=\"".toCharArray();

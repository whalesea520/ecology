...
public class _hrmdepartmentlist__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((id));
      out.write(_jsp_string135, 0, _jsp_string135.length);
      out.print((SystemEnv.getHtmlLabelNames("82,17587", user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(33930,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(33931,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(124,user.getLanguage())));
      out.write(_jsp_string155, 0, _jsp_string155.length);
      }else{ 
      out.write(_jsp_string156, 0, _jsp_string156.length);
      out.print((id ));
      out.write(_jsp_string154, 0, _jsp_string154.length);
      out.print((SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(17899,user.getLanguage())));
      out.write(_jsp_string157, 0, _jsp_string157.length);
      out.print((id ));
      out.write(_jsp_string154, 0, _jsp_string154.length);
      out.print((SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(17587,user.getLanguage())));
      out.write(_jsp_string155, 0, _jsp_string155.length);
      } 
...
tableString =" <table pageId=\""+PageIdConst.HRM_DepartmentList+"\" tabletype=\""+tabletype+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.HRM_DepartmentList,user.getUID(),PageIdConst.HRM)+"\" >"+
    ...
    " </table>";
      ...
      out.print(( PageIdConst.HRM_DepartmentList ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/company/HrmDepartmentList.jsp"), 3876372728501450965L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string156 = "\r\n				<input type=button class=\"e8_btn_top\" onclick=\"openDialog('addSiblingDepartment','".toCharArray();
    ...
    _jsp_string153 = "\r\n				<input type=button class=\"e8_btn_top\" onclick=\"openDialog('addDepartment','".toCharArray();
    ...
    _jsp_string150 = "\",function(){\r\n		var idArr = id.split(\",\");\r\n		var ajaxNum = 0;\r\n		for(var i=0;i<idArr.length;i++){\r\n			ajaxNum++;\r\n			jQuery.ajax({\r\n				url:\"HrmCanceledCheck.jsp?deptorsupid=\"+idArr[i]+\"&cancelFlag=1&userid=".toCharArray();
    _jsp_string138 = "&supdepid=".toCharArray();
    ...
    _jsp_string147 = "\",function(){\r\n		var idArr = id.split(\",\");\r\n		var ajaxNum = 0;\r\n		for(var i=0;i<idArr.length;i++){\r\n			ajaxNum++;\r\n			jQuery.ajax({\r\n				url:\"HrmCanceledCheck.jsp?deptorsupid=\"+idArr[i]+\"&userid=".toCharArray();
    _jsp_string171 = "\",function(){\r\n		var ajax=ajaxinit();\r\n    ajax.open(\"POST\", \"HrmCanceledCheck.jsp\", true);\r\n    ajax.setRequestHeader(\"Content-Type\",\"application/x-www-form-urlencoded\");\r\n    ajax.send(\"deptorsupid=\"+id+\"&cancelFlag=1&userid=".toCharArray();
    ...
    _jsp_string166 = "\",function(){\r\n	var ajax=ajaxinit();\r\n    ajax.open(\"POST\", \"HrmCanceledCheck.jsp\", true);\r\n    ajax.setRequestHeader(\"Content-Type\",\"application/x-www-form-urlencoded\");\r\n    ajax.send(\"deptorsupid=\"+id+\"&userid=".toCharArray();
    ...
    _jsp_string157 = "\"></input>\r\n				<input type=button class=\"e8_btn_top\" onclick=\"openDialog('addChildDepartment','".toCharArray();

...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelNames("93,30042", user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(34100,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelNames("82,30042",user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelNames("130759",user.getLanguage())));
...
operateString = "<operates width=\"20%\">";
      ...
      out.print(( PageIdConst.HRM_ResourceList ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/company/HrmResourceList.jsp"), 7746869025642864022L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string147 = "\r\n			<input type=button class=\"e8_btn_top\" onclick=\"setVirtualDepartment();\"  value=\"".toCharArray();
    ...
    _jsp_string61 = ")\">\r\n".toCharArray();
    _jsp_string138 = "\";\r\n	dialog.Width = jQuery(window).width();\r\n	dialog.Height = jQuery(window).height();\r\n	dialog.Drag = true;\r\n	dialog.maxiumnable = true;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n}\r\n\r\nfunction addHrmResource(){\r\n 	window.parent.parent.location.href=\"/hrm/resource/HrmResource_frm.jsp?departmentid=".toCharArray();

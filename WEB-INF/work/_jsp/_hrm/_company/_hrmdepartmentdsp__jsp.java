...
public class _hrmdepartmentdsp__jsp extends com.caucho.jsp.JavaPage
{
...
if(rs.next()){
    ...
    coadjutant = Util.getIntValue(rs.getString("coadjutant"),0);
      ...
      out.print((SystemEnv.getHtmlLabelNames("93,27511", user.getLanguage())));
      ...
      out.print((depid));
      out.write(_jsp_string66, 0, _jsp_string66.length);
      out.print((SystemEnv.getHtmlLabelNames("1421,17899", user.getLanguage())));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((subcompanyid));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((depid));
      out.write(_jsp_string66, 0, _jsp_string66.length);
      out.print((SystemEnv.getHtmlLabelNames("1421,17587", user.getLanguage())));
      out.write(_jsp_string71, 0, _jsp_string71.length);
      out.print((depid));
      out.write(_jsp_string66, 0, _jsp_string66.length);
      out.print((SystemEnv.getHtmlLabelName(15883, user.getLanguage())));
      out.write(_jsp_string72, 0, _jsp_string72.length);
      out.print((SystemEnv.getHtmlLabelNames("17887", user.getLanguage())));
      out.write(_jsp_string73, 0, _jsp_string73.length);
      out.print((xssUtil.put("where operateitem=12 and relatedid=")));
      out.write(_jsp_string74, 0, _jsp_string74.length);
      out.print((xssUtil.put("where operateitem=12")));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelNames("82,17899",user.getLanguage())));
	 ...
	 for(int tmp=0;lsGroup!=null&&tmp<lsGroup.size();tmp++){
  	...
  	for(int j=0;lsField!=null&&j<lsField.size();j++){
		...
		if(tmp==0){
			...
			if(rs.next()){
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelNames("1831,1859",user.getLanguage())+"/"+SystemEnv.getHtmlLabelNames("6091,1859",user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((resourceNum+"/"+resourceNum1));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
      ...
      out.print((SystemEnv.getHtmlLabelName(22153, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(22155, user.getLanguage())));
      out.write(_jsp_string189, 0, _jsp_string189.length);
      out.print((depid));
      out.write(_jsp_string190, 0, _jsp_string190.length);
      out.print((SystemEnv.getHtmlLabelName(82293, user.getLanguage())));
      out.write(_jsp_string191, 0, _jsp_string191.length);
      out.print((SystemEnv.getHtmlLabelName(82294, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(22156, user.getLanguage())));
      out.write(_jsp_string196, 0, _jsp_string196.length);
      out.print((depid));
      out.write(_jsp_string197, 0, _jsp_string197.length);
      out.print((SystemEnv.getHtmlLabelName(24296, user.getLanguage())));
      out.write(_jsp_string198, 0, _jsp_string198.length);
      out.print((SystemEnv.getHtmlLabelName(24297, user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/company/HrmDepartmentDsp.jsp"), 2097118509211323312L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string131 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string81 = "\");\r\n	             return;\r\n		 	}\r\n		 	\r\n		 	Validator.checkHasChildDepartment(".toCharArray();
    _jsp_string178 = "\r\n	".toCharArray();
    ...
    _jsp_string170 = "\r\n				<input type=button class=\"e8_btn_top\" onclick=\"addSiblingDepartment();\" value=\"".toCharArray();
    ...
    _jsp_string174 = "\r\n				<input type=button class=\"e8_btn_top\" onclick=\"doISCanceled();\" value=\"".toCharArray();
    _jsp_string93 = "&organizationtype=2\");\r\n}\r\nfunction jsFnaBudgetView(){\r\n	window.open(\"/fna/budget/FnaBudgetView.jsp?organizationid=".toCharArray();
    ...
    _jsp_string94 = "&organizationtype=2\");\r\n}\r\n</script>\r\n<BODY>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string78 = ",function checkHasChildDepartmentCallback(data){\r\n		if(data=='false')data=false;\r\n	 	if(data){\r\n	 		 window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string70 = "\";\r\n	}else if(cmd==\"addChildDepartment\"){\r\n		url = \"/hrm/HrmDialogTab.jsp?_fromURL=HrmDepartmentAdd&method=addChildDepartment&isdialog=1&subcompanyid=".toCharArray();
    ...
    _jsp_string149 = "\r\n							".toCharArray();
    _jsp_string124 = "visible".toCharArray();
    ...
    _jsp_string80 = ",function checkHasJobCallback(data){\r\n		 	if(data=='false')data=false;\r\n		 	if(data){\r\n		 		 window.top.Dialog.alert(\"".toCharArray();
    _jsp_string195 = "\");\r\n      ajax.onreadystatechange = function() {\r\n        if (ajax.readyState == 4 && ajax.status == 200) {\r\n            try{\r\n	            if(ajax.responseText == 1){\r\n	              window.top.Dialog.alert(\"".toCharArray();
    _jsp_string68 = "&supdepid=".toCharArray();
    _jsp_string84 = ");\r\n		 }) ;\r\n		\r\n		 }) ;\r\n	 }) ;\r\n}\r\nfunction check(o){\r\n		 if(o=='false')o=false;\r\n     if(o)\r\n     	window.top.Dialog.alert('".toCharArray();
    ...
    _jsp_string76 = "\";\r\n	dialog.Width = jQuery(window).width();\r\n	dialog.Height = jQuery(window).height();\r\n	dialog.Drag = true;\r\n	dialog.maxiumnable = true;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n}\r\n\r\nfunction checkHasJob(){\r\n	 Validator.checkHasJob(".toCharArray();
    _jsp_string171 = "\"></input>\r\n				<input type=button class=\"e8_btn_top\" onclick=\"editDepartment();\" value=\"".toCharArray();
    _jsp_string43 = "\r\n<script language=javascript>\r\nubsfirmcode0 = ".toCharArray();
    _jsp_string5 = "\r\n\r\n\r\n<script language=javascript>;\r\ntop.Dialog.alert(\"".toCharArray();
    _jsp_string151 = "\"></td>\r\n							".toCharArray();
    _jsp_string88 = "\r\n parent.setTabObjName('".toCharArray();
    _jsp_string45 = ";\r\nusbserial0 = \"".toCharArray();
    _jsp_string164 = "\">\r\n<input class=inputstyle type=hidden name=fromHrmTab value=\"".toCharArray();
    _jsp_string77 = ",checkHasJobCallback) ;\r\n}\r\n\r\nfunction onDelete(){\r\n\r\n		Validator.departmentIsUsed(".toCharArray();
    ...
    _jsp_string172 = "\"></input>\r\n				<input type=button class=\"e8_btn_top\" onclick=\"doCanceled();\" value=\"".toCharArray();
    ...
    _jsp_string90 = "\r\n});\r\n\r\nfunction jsHrmDepartmentRoles(){\r\n window.open(\"/hrm/HrmDialogTab.jsp?_fromURL=HrmDepartmentRoles&id=".toCharArray();
    ...
    _jsp_string114 = " oncontextmenu='return false'".toCharArray();
    ...
    _jsp_string85 = "\uff01') ;\r\n     else{\r\n     	window.top.Dialog.confirm(\"".toCharArray();
    _jsp_string35 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string120 = "px\" height=\"".toCharArray();
    ...
    _jsp_string196 = "\");\r\n	              //parent.leftframe.location.reload();\r\n	              window.location.href = \"HrmDepartmentDsp.jsp?id=".toCharArray();
    ...
    _jsp_string100 = "\";\r\n        dialog.Width = 550 ;\r\n        dialog.Height = 600;\r\n        dialog.Drag = true;\r\n        dialog.show();\r\n    });\r\n\r\n}\r\n</script>\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string197 = "\";\r\n	              onBtnSearchClick();\r\n				  return;\r\n	            } \r\n                if(ajax.responseText == 0) {\r\n	              window.top.Dialog.alert(\"".toCharArray();
    _jsp_string166 = "\r\n			<input type=button class=\"e8_btn_top\" onclick=\"openDialog('importexcel');\" value=\"".toCharArray();
    _jsp_string48 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    ...
    _jsp_string123 = "hidden".toCharArray();
    _jsp_string39 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    ...
    _jsp_string199 = "\");\r\n	              return;\r\n	            }\r\n            }catch(e){\r\n                return false;\r\n            }\r\n        }\r\n     }\r\n	});\r\n }\r\n</script>\r\n\r\n</BODY></HTML>\r\n".toCharArray();
    _jsp_string177 = "\" class=\"cornerMenu\"></span>\r\n	</td>\r\n	</tr>\r\n</table>\r\n".toCharArray();
    _jsp_string28 = "')) {\r\n				    lenck = false;\r\n				    break;\r\n			    }\r\n		    }\r\n		    if(lenck==false) return false;\r\n	    }\r\n	    catch(e) {}\r\n	    ".toCharArray();
    _jsp_string82 = ",function checkHasChildDepartmentCallback(data){\r\n		 	if(data=='false')data=false;\r\n		 	if(data){\r\n		 		 window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string92 = "\");\r\n}\r\nfunction jsFnaExpenseDetail(){\r\n	window.open(\"/fna/report/expense/FnaExpenseDetail.jsp?organizationid=".toCharArray();
    ...
    _jsp_string38 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string187 = "&userid=".toCharArray();
    _jsp_string136 = ";\r\n	".toCharArray();
    _jsp_string75 = "\";\r\n	}\r\n	dialog.Title = \"".toCharArray();
    _jsp_string71 = "\";\r\n		dialog.Height = 500;\r\n	}else if(cmd==\"addHrmResource\"){\r\n		url = \"/hrm/company/HrmResourceAdd.jsp?isdialog=1&departmentid=".toCharArray();

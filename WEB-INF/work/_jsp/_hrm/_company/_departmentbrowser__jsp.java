...
public class _departmentbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/company/DepartmentBrowser.jsp"), -3486507525743294476L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string175 = "\" + \"&\" + new Date().getTime() + \"=\" + new Date().getTime();\r\n	    }\r\n		}else{\r\n			if (treeNode != undefined && treeNode.isParent != undefined && treeNode.isParent != null) {\r\n	    	return \"/hrm/tree/DepartmentSingleXML.jsp?\"+ treeNode.ajaxParam + \"&\" + new Date().getTime() + \"=\" + new Date().getTime();\r\n	    } else {\r\n	    	//\u521d\u59cb\u5316\u65f6\r\n	    	return \"/hrm/tree/DepartmentSingleXML.jsp?deptlevel=".toCharArray();
    ...
    _jsp_string163 = "\r\n			".toCharArray();
    _jsp_string174 = "&init=true&nodeid=".toCharArray();
    ...
    _jsp_string39 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string171 = "&virtualtype=\"+virtualtype+\"&subcompanyid=".toCharArray();
    ...
    _jsp_string164 = "\r\n		<input type=\"button\" class=zd_btn_submit  id=btnok onclick=\"onSave();\" value=\"".toCharArray();
    ...
    _jsp_string172 = "&\" + treeNode.ajaxParam + \"&\" + new Date().getTime() + \"=\" + new Date().getTime();\r\n	    } else {\r\n	    	//\u521d\u59cb\u5316\u65f6\r\n	    	return \"/hrm/companyvirtual/DepartmentSingleXML.jsp?deptlevel=".toCharArray();
    ...
    _jsp_string173 = "&excludeid=".toCharArray();
    ...
    _jsp_string165 = "\">\r\n		<input type=\"button\" class=zd_btn_submit  id=btnclear onclick=\"onClear();\" value=\"".toCharArray();
    _jsp_string37 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    ...
    _jsp_string157 = "\" class=\"e8img e8imgSel\"><img src=\"/images/ecology8/doc/current_wev8.png\"/></span>\r\n			<span class=\"e8img\"><img src=\"/images/ecology8/doc/org_sel_wev8.png\"/></span>\r\n			<span class=\"e8text\" title=\"".toCharArray();
  }
}

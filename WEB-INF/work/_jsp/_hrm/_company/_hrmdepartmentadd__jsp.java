...
public class _hrmdepartmentadd__jsp extends com.caucho.jsp.JavaPage
{
...
if(msgid!=-1){
 ...
 if(!"".equals(errorMsg)){
	 ...
	 for(int tmp=0;lsGroup!=null&&tmp<lsGroup.size();tmp++){
    	...
    	if(HrmFieldComInfo.getIsmand(fieldid).equals("1")){
		  ...
		  if(fieldname.equals("supdepid")){
              ...
              do {
                ...
                _jsp_BrowserTag_3.setBrowserValue(""+supdepid );
                _jsp_BrowserTag_3.setIsMustInput(isMust);
                _jsp_BrowserTag_3.setBrowserSpanValue(DepartmentComInfo.getDepartmentname(""+supdepid) );
      ...
      int _jspEval27 = _jsp_ViewTag_4.doStartTag();
      if (_jspEval27 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval27 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_4.setBodyContent(_jsp_endTagHack25);
        ...
        do {
          ...
          int _jspEval30 = _jsp_GroupTag_5.doStartTag();
          if (_jspEval30 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval30 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_5.setBodyContent(_jsp_endTagHack28);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/company/HrmDepartmentAdd.jsp"), -9136734616092350336L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

...
public class _subcompanybrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/company/SubcompanyBrowser.jsp"), -1908854136382937346L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string162 = "\r\n			".toCharArray();
    _jsp_string171 = "&init=true&nodeid=".toCharArray();
    ...
    _jsp_string166 = "\">\r\n	        <input type=\"button\" class=zd_btn_submit class=btnReset  id=btncancel  onclick=\"btncancel_onclick();\" value=\"".toCharArray();
    ...
    _jsp_string172 = "\" + \"&\" + new Date().getTime() + \"=\" + new Date().getTime();\r\n	    }\r\n	  }else{\r\n	    if (treeNode != undefined && treeNode.isParent != undefined && treeNode.isParent != null) {\r\n	    	return \"/hrm/tree/DepartmentSingleXML.jsp?\" + treeNode.ajaxParam + \"&\" + new Date().getTime() + \"=\" + new Date().getTime();\r\n	    } else {\r\n	    	//\u521d\u59cb\u5316\u65f6\r\n	    	return \"/hrm/tree/SubcompanySingleXML.jsp?excludeid=".toCharArray();

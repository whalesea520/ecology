...
public class _hrmdepartlayoutedit__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	if(CompanyComInfo.next()){
      ...
      out.print((SystemEnv.getHtmlLabelNames("32470",user.getLanguage())));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/company/HrmDepartLayoutEdit.jsp"), -7891292318423994683L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    _jsp_string144 = "\r\n					<input type=\"button\" class=\"e8_btn_top\" onclick=\"showSet();\" value=\"".toCharArray();
    ...
    _jsp_string67 = "\";\r\n			}\r\n			\r\n			function doReset(){\r\n				location.reload();\r\n			}\r\n			\r\n			function showSet(){\r\n				var bean = new MFCommon();\r\n				bean.initDialog({width:500,height:300});\r\n				dialog = bean.showDialog(\"/hrm/HrmDialogTab.jsp?_fromURL=orgChartSet&cmd=system\", \"".toCharArray();

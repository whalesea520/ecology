...
public class _hrmsubcompanylist__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(17897,user.getLanguage())));
      out.write(_jsp_string163, 0, _jsp_string163.length);
      out.print((SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(17898,user.getLanguage())));
...
tableString =" <table pageId=\""+PageIdConst.HRM_SubCompanyList+"\" tabletype=\""+tabletype+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.HRM_SubCompanyList,user.getUID(),PageIdConst.HRM)+"\" >"+
    ...
    " </table>";
      ...
      out.print(( PageIdConst.HRM_SubCompanyList ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/company/HrmSubCompanyList.jsp"), 4222045424987519844L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string47 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string150 = "&operation=subcompany\");\r\n    ajax.onreadystatechange = function() {\r\n      if (ajax.readyState == 4 && ajax.status == 200) {\r\n          try{\r\n            if(ajax.responseText == 1){\r\n              window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string163 = "\"></input>\r\n			<input type=button class=\"e8_btn_top\" onclick=\"addChildSubCompany();\" value=\"".toCharArray();
    ...
    _jsp_string158 = "&operation=subcompany\",\r\n				type:\"post\",\r\n				async:true,\r\n				complete:function(xhr,status){\r\n					ajaxNum--;\r\n					if(ajaxNum==0){\r\n						_table.reLoad();\r\n					}\r\n				}\r\n			});\r\n		}\r\n	});\r\n}\r\n\r\n//\u89e3\u5c01\r\nfunction doSubComBatchIsCancel(id){\r\n	if(!id){\r\n		id = _xtable_CheckedCheckboxId();\r\n	}\r\n	if(!id){\r\n		window.top.Dialog.alert(\"".toCharArray();

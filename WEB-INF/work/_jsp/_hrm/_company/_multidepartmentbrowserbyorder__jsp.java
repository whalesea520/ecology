...
public class _multidepartmentbrowserbyorder__jsp extends com.caucho.jsp.JavaPage
{
...
String showId = "";//new AppDetachComInfo().getScopeIds(user, "department");
      ...
      out.print((JSONObject.quote(SystemEnv.getHtmlLabelName(124, user.getLanguage())) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/company/MultiDepartmentBrowserByOrder.jsp"), -7576468968223389173L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string72 = "&resourceids=".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    _jsp_string70 = "</IFRAME>\r\n						</td>\r\n					</tr>\r\n	    		<tr>\r\n	    			<td class='td2' style=\"height: 60%;width: 100%\">\r\n	    				<iframe  src=\"/hrm/company/MultiSelect.jsp?tabid=".toCharArray();
    ...
    _jsp_string71 = "&showId=".toCharArray();

...
public class _hrmdepartmentedit__jsp extends com.caucho.jsp.JavaPage
{
...
if(msgid!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(17428,user.getLanguage())));
	 ...
	 for(int tmp=0;lsGroup!=null&&tmp<lsGroup.size();tmp++){
  	...
  	String grouplabel = HrmGroupComInfo.getLabel(groupid);	
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(Integer.parseInt(grouplabel),user.getLanguage()));
    		...
    		needinputitems+=fieldname;
 			...
 			if(fieldname.equals("showid")){
              ...
              do {
                ...
                _jsp_BrowserTag_3.setName("supdepid");
                _jsp_BrowserTag_3.setGetBrowserUrlFn("onShowDepartment");
                _jsp_BrowserTag_3.setHasInput("true");
                _jsp_BrowserTag_3.setIsSingle("true");
                _jsp_BrowserTag_3.setHasBrowser("true");
                _jsp_BrowserTag_3.setCompleteUrl("javascript:getDepartmentCompleteUrl()");
                _jsp_BrowserTag_3.setWidth("165px");
                _jsp_BrowserTag_3.setBrowserValue( fieldValue );
                _jsp_BrowserTag_3.setIsMustInput(isMust);
      ...
      int _jspEval35 = _jsp_ViewTag_4.doStartTag();
      if (_jspEval35 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval35 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_4.setBodyContent(_jsp_endTagHack33);
        ...
        do {
          ...
          int _jspEval38 = _jsp_GroupTag_5.doStartTag();
          if (_jspEval38 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval38 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_5.setBodyContent(_jsp_endTagHack36);
      ...
      out.print((SystemEnv.getHtmlLabelName(15773,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(83471,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(18739,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/company/HrmDepartmentEdit.jsp"), -8792792138152924013L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string172 = " \r\n\r\n<script language=javascript>\r\n function onSave(){\r\n   if(jQuery(\"input[name=supdepid]\").val()==".toCharArray();
    ...
    _jsp_string147 = "\">\r\n    -->\r\n	 <INPUT id=subcompanyid1old type=hidden name=subcompanyid1old value=\"".toCharArray();
    ...
    _jsp_string24 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string148 = "\">\r\n	   <input class=inputstyle type=hidden id=scopeid  name=scopeid value=\"".toCharArray();
    _jsp_string156 = "\r\n   	".toCharArray();
    ...
    _jsp_string170 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.closeByHand();\">\r\n		".toCharArray();
    _jsp_string35 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string97 = "px\" height=\"".toCharArray();
    _jsp_string146 = "\">\r\n   <!-- \r\n   <INPUT id=subcompanyid1 type=hidden name=subcompanyid1 value=\"".toCharArray();
    ...
    _jsp_string145 = "\">\r\n   <input type=hidden name=allsupdepid value=\"".toCharArray();

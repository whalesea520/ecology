...
public class _editdeptfieldbatch__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.hrm.definedfield.HrmFieldComInfo HrmFieldComInfo;
      HrmFieldComInfo = (weaver.hrm.definedfield.HrmFieldComInfo) pageContext.getAttribute("HrmFieldComInfo");
      if (HrmFieldComInfo == null) {
        HrmFieldComInfo = new weaver.hrm.definedfield.HrmFieldComInfo();
        pageContext.setAttribute("HrmFieldComInfo", HrmFieldComInfo);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.hrm.definedfield.HrmFieldGroupComInfo HrmGroupComInfo;
      HrmGroupComInfo = (weaver.hrm.definedfield.HrmFieldGroupComInfo) pageContext.getAttribute("HrmGroupComInfo");
      if (HrmGroupComInfo == null) {
        HrmGroupComInfo = new weaver.hrm.definedfield.HrmFieldGroupComInfo();
        pageContext.setAttribute("HrmGroupComInfo", HrmGroupComInfo);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
String message =Util.null2String(request.getParameter("message"));
      ...
      out.print((SystemEnv.getHtmlLabelNames("83869,82455",user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelNames("15024,685",user.getLanguage())));
    ...
    for(int i=0;lsGroup!=null&&i<lsGroup.size();i++){
      ...
      out.print((SystemEnv.getHtmlLabelName(Integer.parseInt(fieldlabel),user.getLanguage())));
      ...
      out.print((fieldhtmltype.equals("1")?""+SystemEnv.getHtmlLabelName(688,user.getLanguage())+"":"" ));
      out.write(_jsp_string197, 0, _jsp_string197.length);
      out.print((fieldhtmltype.equals("2")?""+SystemEnv.getHtmlLabelName(689,user.getLanguage())+"":"" ));
      out.write(_jsp_string197, 0, _jsp_string197.length);
      out.print((fieldhtmltype.equals("3")?""+SystemEnv.getHtmlLabelName(695,user.getLanguage())+"":"" ));
      out.write(_jsp_string197, 0, _jsp_string197.length);
      out.print((fieldhtmltype.equals("4")?""+SystemEnv.getHtmlLabelName(691,user.getLanguage())+"":"" ));
      out.write(_jsp_string197, 0, _jsp_string197.length);
      out.print((fieldhtmltype.equals("5")?""+SystemEnv.getHtmlLabelName(690,user.getLanguage())+"":"" ));
      out.write(_jsp_string197, 0, _jsp_string197.length);
      out.print((fieldhtmltype.equals("6")?""+SystemEnv.getHtmlLabelName(17616,user.getLanguage())+"":""));
      ...
      out.print((fieldtype.equals("1")?""+SystemEnv.getHtmlLabelName(608,user.getLanguage())+"":""));
      out.write(_jsp_string208, 0, _jsp_string208.length);
      out.print((fieldtype.equals("2")?""+SystemEnv.getHtmlLabelName(696,user.getLanguage())+"":""));
      out.write(_jsp_string208, 0, _jsp_string208.length);
      out.print((fieldtype.equals("3")?""+SystemEnv.getHtmlLabelName(697,user.getLanguage())+"":""));
      ...
      out.write(_jsp_string197, 0, _jsp_string197.length);
      out.print((SystemEnv.getHtmlLabelName(Util.getIntValue(BrowserComInfo.getBrowserlabelid(fieldtype),0),user.getLanguage())));
      ...
      out.print((fieldtype.equals("1")?SystemEnv.getHtmlLabelName(20798,user.getLanguage()):SystemEnv.getHtmlLabelName(20001,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/company/editDeptFieldBatch.jsp"), 2057460565502919744L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string198 = "\r\n    	<input type=\"hidden\" name=\"fieldlabel\" value=\"".toCharArray();
    ...
    _jsp_string240 = "\" ".toCharArray();
    _jsp_string226 = " class=e8_btn_top onclick=\"addItemDialog(this,'".toCharArray();
    ...
    _jsp_string71 = "\u73b0\u6709\u5b57\u6bb5\u4e0d\u5b58\u5728\uff01\");\r\n".toCharArray();
    _jsp_string242 = "\r\n    	</select>\r\n    </td>\r\n        <td>\r\n            <input type=checkbox name=chkisuse ".toCharArray();
    ...
    _jsp_string200 = "\r\n    	<input  class=InputStyle name=\"fieldlabel\" value=\"".toCharArray();
    _jsp_string217 = "\">\r\n    </td>\r\n    <td>\r\n    	".toCharArray();
    ...
    _jsp_string78 = "&item_id=\"+item_id+\"&select_name=\"+select_name+\"&alloption=\"+alloption;;\r\n	dialog.Title = \"".toCharArray();
    ...
    _jsp_string244 = "\" >\r\n        </td>\r\n        <td>\r\n        		<input type=checkbox name=chkismand  ".toCharArray();
    _jsp_string107 = ");\r\n			}\r\n		}catch(e){}\r\n		".toCharArray();
    ...
    _jsp_string176 = " class=e8_btn_top onclick=\"addItemDialog(this,'','')\" style=\"width: 80px\">\r\n</div>\r\n\r\n<div style=\"DISPLAY: none\" id=\"fselectoptionview\">\r\n	".toCharArray();
    ...
    _jsp_string207 = "\" >\r\n    </td>\r\n    <td>\r\n	    ".toCharArray();
    _jsp_string201 = "\" onchange='hrmCheckinput(this);' style=\"width: 100px\">\r\n			<SPAN>\r\n			".toCharArray();
    ...
    _jsp_string192 = "<input name=\"fieldChk\" type=\"checkbox\" value=\"".toCharArray();
    _jsp_string184 = "</td>\r\n	  	<td>".toCharArray();
    _jsp_string223 = "\">\r\n		</td>\r\n		<td>\r\n		    <input name=flength type=hidden  value=\"100\">\r\n		    <input name=definebroswerType type=hidden  value=\"emptyVal\">&nbsp;\r\n		</td>\r\n		".toCharArray();
    _jsp_string58 = "\r\n<meta http-equiv=\"".toCharArray();
    _jsp_string227 = "')\" style=\"width: 95px\">\r\n		".toCharArray();
    _jsp_string75 = "!<br>".toCharArray();
    _jsp_string191 = "\" disabled=\"disabled\">\r\n  		".toCharArray();
    _jsp_string178 = "\"></input>\r\n				<input type=button class=\"e8_btn_top\" onclick=\"doDel();\" value=\"".toCharArray();
    _jsp_string247 = "\" style=\"width: 40px\" >\r\n        </td>\r\n    </tr>\r\n    ".toCharArray();

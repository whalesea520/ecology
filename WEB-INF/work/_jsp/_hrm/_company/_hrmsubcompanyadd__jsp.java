...
public class _hrmsubcompanyadd__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string52, 0, _jsp_string52.length);
      weaver.hrm.passwordprotection.manager.HrmResourceManager resourceManager;
      resourceManager = (weaver.hrm.passwordprotection.manager.HrmResourceManager) pageContext.getAttribute("resourceManager");
      if (resourceManager == null) {
        resourceManager = new weaver.hrm.passwordprotection.manager.HrmResourceManager();
        pageContext.setAttribute("resourceManager", resourceManager);
      }
...
String needinputitems = "";
	 ...
	 for(int tmp=0;lsGroup!=null&&tmp<lsGroup.size();tmp++){
      ...
      out.print((SystemEnv.getHtmlLabelName(81925,user.getLanguage())));
      out.write(_jsp_string163, 0, _jsp_string163.length);
      out.print((id));
      out.write(_jsp_string164, 0, _jsp_string164.length);
      out.print((SystemEnv.getHtmlLabelName(82442,user.getLanguage())));
      out.write(_jsp_string165, 0, _jsp_string165.length);
      out.print((SystemEnv.getHtmlLabelName(82488,user.getLanguage())));
      out.write(_jsp_string166, 0, _jsp_string166.length);
      out.print((SystemEnv.getHtmlLabelName(81923,user.getLanguage())+cntMem));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/company/HrmSubCompanyAdd.jsp"), -1151018894711568324L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string142 = "\" class=\"e8_btn_top\" onclick=\"submitData();\">\r\n			<span title=\"".toCharArray();
    _jsp_string135 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result9\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string168 = "\",48,\"".toCharArray();
    _jsp_string148 = "	\r\n   	".toCharArray();
    ...
    _jsp_string144 = "\r\n<FORM id=frmmain name=frmmain action=\"SubCompanyOperation.jsp\" method=post>\r\n<input class=inputstyle type=\"hidden\" name=companyid value=\"".toCharArray();
    _jsp_string159 = "\";\r\nvar isCheckSc = \"".toCharArray();
    ...
    _jsp_string156 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.closeByHand();\">\r\n".toCharArray();
    _jsp_string80 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string158 = " \r\n<script language=javascript>\r\nvar common = new MFCommon();\r\nvar isVs = \"".toCharArray();
    ...
    _jsp_string39 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string163 = "\", function(){limitUsers.value = cntMem;});\r\n			return false;\r\n		}\r\n		var result = eval(common.ajax(\"cmd=getSubcompanyLimitUsers&arg=".toCharArray();
    ...
    _jsp_string166 = "\");\r\n			return false;\r\n		}\r\n	}\r\n //frmmain.submit();\r\n    StartUploadAll();\r\n    checkuploadcomplet();\r\n }\r\n}\r\nfunction showSpan(id, name){\r\n	if(id !== \"84\") return;\r\n	var span = $GetEle(name);\r\n	if(span) {\r\n		span.innerHTML = \"<strong>".toCharArray();

...
public class _hrmlocation__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelName(26473,user.getLanguage())+SystemEnv.getHtmlLabelName(378,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(378,user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((SystemEnv.getHtmlLabelName(125447,user.getLanguage())));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((xssUtil.put("where operateitem=23 and relatedid=")));
      out.write(_jsp_string71, 0, _jsp_string71.length);
      out.print((xssUtil.put("where operateitem=23")));
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(378,user.getLanguage())+SystemEnv.getHtmlLabelName(399,user.getLanguage())));
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(378,user.getLanguage())+SystemEnv.getHtmlLabelName(15767,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
...
tableString =" <table pageId=\""+PageIdConst.HRM_Localtion+"\" tabletype=\""+tabletype+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.HRM_Localtion,user.getUID(),PageIdConst.HRM)+"\" >"+
    ...
    " </table>";
      ...
      out.print(( PageIdConst.HRM_Localtion ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/location/HrmLocation.jsp"), -5975488646234002201L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string154 = "\r\n				<input type=\"text\" id=\"locationname\" name=\"locationname\" class=\"inputStyle\" value=\"".toCharArray();
    ...
    _jsp_string156 = "\r\n				<input type=\"text\" id=\"locationdesc\" name=\"countryname\" class=\"inputStyle\" value=\"".toCharArray();
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();

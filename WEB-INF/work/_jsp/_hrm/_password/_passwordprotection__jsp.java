...
import weaver.hrm.passwordprotection.domain.*;
import weaver.hrm.passwordprotection.manager.*;
...
public class _passwordprotection__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	boolean showEdit = new HrmPasswordProtectionQuestionManager().find(map).size() > 0;
      ...
      out.print((SystemEnv.getHtmlLabelName(81607,user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((SystemEnv.getHtmlLabelNames("81605,68",user.getLanguage())));
...
if(userightmenu!=1){
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(81605,user.getLanguage())));
              ...
              do {
                ...
                out.print((showEdit ? (isEnabled ? "" : "none") : "none"));
          ...
          if (_jspEval17 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(81606,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/password/passwordProtection.jsp"), -5079025574088438689L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string67 = "&checked=\"+checked);\r\n				if(cShow){\r\n					showVerifyPswd(checked, true);\r\n				}\r\n				if(checked == false) {\r\n					$GetEle(\"upBtn\").style.display = \"none\";\r\n				} else {\r\n					$GetEle(\"upBtn\").style.display = \"".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string95 = "px\" height=\"".toCharArray();
    _jsp_string69 = "\");\r\n			}\r\n			\r\n			function showQuestion(cmd, checked, arg0){\r\n				if(cmd && cmd == \"close\"){\r\n					closeDialog();\r\n				}\r\n				if(checked == \"true\" || arg0 == \"false\"){\r\n					common.initDialog({width:800,height:480,showMax:false});\r\n					dialog = common.showDialog(\"/hrm/HrmDialogTab.jsp?_fromURL=questionSetStep\",\"".toCharArray();
    _jsp_string145 = "\" name=\"upBtn\" class=\"e8_btn_top\" onclick=\"doUpdate()\" style=\"margin-left:10px;display:".toCharArray();
    ...
    _jsp_string142 = "\r\n				  		<input type=\"checkbox\" tzCheckbox=\"true\" class=\"InputStyle\" name=\"enabled\" value=\"1\" onclick=\"changeValue(this.checked, true);\" ".toCharArray();
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string111 = ";\r\n	".toCharArray();
    _jsp_string109 = "\r\n}\r\n\r\nvar isIEBrowser =\"".toCharArray();
    _jsp_string147 = "\r\n					<div class=\"item_margin\">".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();

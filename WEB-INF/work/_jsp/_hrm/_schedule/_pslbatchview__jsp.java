...
public class _pslbatchview__jsp extends com.caucho.jsp.JavaPage
{
...
if(leaveTypes.size() > 0 && leavetype.length() == 0 ){
	leavetype = ""+leaveTypes.get(0).getField004();
      ...
      out.print((SystemEnv.getHtmlLabelNames("26473,131560",user.getLanguage())));
      out.write(_jsp_string74, 0, _jsp_string74.length);
      out.print((subcompanyid));
      out.write(_jsp_string75, 0, _jsp_string75.length);
      out.print((SystemEnv.getHtmlLabelNames("82,131560",user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_3.setContext(titlename);
		...
		tableString =" <table pageId=\""+PageIdConst.HRM_PSLBatchView+"\" tabletype=\""+tabletype+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.HRM_PSLBatchView,user.getUID(),PageIdConst.HRM)+"\" >"+
		    ...
		    " </table>";
                ...
                out.print(( PageIdConst.HRM_PSLBatchView ));
                ...
                int _jsp_end_24 = _jsp_SplitPageTag_5.doEndTag();
      ...
      out.print((SystemEnv.getHtmlLabelName(21677,user.getLanguage())));
      out.write(_jsp_string162, 0, _jsp_string162.length);
      out.print((SystemEnv.getHtmlLabelName(21669,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(18260,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/schedule/PSLBatchView.jsp"), 924340712305855199L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string163 = "\",function(){\r\n     	location.href=\"/hrm/schedule/PSLBatchOperation.jsp?operation=syn&subcompanyid=".toCharArray();
    ...
    _jsp_string74 = "\";\r\n		url = \"/hrm/HrmDialogTab.jsp?_fromURL=PSLBatchEdit&subcompanyid=".toCharArray();
    ...
    _jsp_string73 = "&leavetype=\"+jQuery(\"#leavetype\").val();\r\n	if(!!id){\r\n		dialog.Title = \"".toCharArray();
    ...
    _jsp_string167 = "\")){\r\n          location.href=\"/hrm/schedule/PSLBatchOperation.jsp?operation=syndelete&subcompanyid=".toCharArray();

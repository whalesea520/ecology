...
public class _hrmpubholiday__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
    ...
    if(user.getLanguage()==8){
      ...
      out.print((SystemEnv.getHtmlLabelName(26473,user.getLanguage())+SystemEnv.getHtmlLabelName(16750,user.getLanguage())));
      out.write(_jsp_string77, 0, _jsp_string77.length);
      out.print((SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(16750,user.getLanguage())));
      out.write(_jsp_string78, 0, _jsp_string78.length);
      out.print((xssUtil.put("where operateitem=21 and relatedid=")));
      out.write(_jsp_string79, 0, _jsp_string79.length);
      out.print((xssUtil.put("where operateitem=21")));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      _jsp_BrowserTag_0.setId("countryid");
      _jsp_BrowserTag_0.setName("countryid");
      _jsp_BrowserTag_0.setBrowserUrl("/systeminfo/BrowserMain.jsp?mouldID=hrm&url=/hrm/country/CountryBrowser.jsp?selectedids=");
      ...
      _jsp_BrowserTag_0.setCompleteUrl("/data.jsp?type=country");
      _jsp_BrowserTag_0.setWidth("150px");
      _jsp_BrowserTag_0.set_callback("jsSubmit");
      _jsp_BrowserTag_0.setBrowserValue(countryid );
      _jsp_BrowserTag_0.setBrowserSpanValue(Util.toScreen(CountryComInfo.getCountrydesc(countryid),user.getLanguage()) );
      ...
      out.print((SystemEnv.getHtmlLabelName( 491 ,user.getLanguage())));
...
tableString =" <table instanceid=\"hrmPubHolidayTable\" tabletype=\""+tabletype+"\" pagesize=\""+perpage+"\" >"+
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/schedule/HrmPubHoliday.jsp"), -350582744552759425L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string180 = "\r\n	  	<td height=20px width=\"3%\" ALIGN=CENTER>".toCharArray();
    ...
    _jsp_string190 = "\r\n			<a style=\"width: 100%; display: inline-block; height: 100%; text-decoration: none;\" href=\"javascript:void('0')\" onclick=\"openDialog('','".toCharArray();
    ...
    _jsp_string165 = "\" style=\"border-left:none;min-width:30px;font-size: 15px;width: auto;\">\r\n	      			".toCharArray();
    ...
    _jsp_string151 = "\">\r\n<input class=inputstyle type=hidden name=showtype id=showtype value=\"".toCharArray();
    ...
    _jsp_string184 = ";border-color: #E6E6E6\"\r\n		".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    ...
    _jsp_string167 = "\" style=\"border-left:none;padding-left:15px;min-width:30px;font-size: 15px;width: auto;\">\r\n	      			".toCharArray();
    ...
    _jsp_string192 = "\r\n		".toCharArray();
    _jsp_string164 = "txtbtnnoselcls".toCharArray();
    ...
    _jsp_string163 = "txtbtncls".toCharArray();
    ...
    _jsp_string166 = " \r\n	      		</div>\r\n	      		<div id=\"showLstbtn\" unselectable=\"on\" class=\"calHdBtn ".toCharArray();
    _jsp_string1 = "\r\n\r\n".toCharArray();

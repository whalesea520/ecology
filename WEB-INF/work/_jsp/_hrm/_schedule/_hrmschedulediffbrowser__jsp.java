...
public class _hrmschedulediffbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
String counttype = Util.null2String(request.getParameter("counttype"));
      ...
      out.print((SystemEnv.getHtmlLabelNames(difftype.equals("1")?"1881":"6159",user.getLanguage())));
...
RCMenuHeight += RCMenuHeightStep ;
      ...
      out.print((SystemEnv.getHtmlLabelName(447,user.getLanguage())));
...
while(rs.next()){
	if(i==0){
      ...
      out.print((rs.getString("diffname")));
      out.write(_jsp_string95, 0, _jsp_string95.length);
      out.print((rs.getString("diffdesc")));
      out.write(_jsp_string96, 0, _jsp_string96.length);
      out.print((WorkflowComInfo.getWorkflowname(""+rs.getInt("workflowid"))));
      out.write(_jsp_string97, 0, _jsp_string97.length);
      out.print((Util.toScreen(SalaryComInfo.getSalaryname(rs.getString("salaryitem")),user.getLanguage())));
      out.write(_jsp_string98, 0, _jsp_string98.length);
      if(rs.getString("difftype").equals("1")){
      out.print((SystemEnv.getHtmlLabelName(457,user.getLanguage())));
      }
      out.write(_jsp_string99, 0, _jsp_string99.length);
      if(rs.getString("difftype").equals("0")){
      out.print((SystemEnv.getHtmlLabelName(456,user.getLanguage())));
      }
      out.write(_jsp_string100, 0, _jsp_string100.length);
      if(rs.getString("difftime").equals("0")){
      out.print((SystemEnv.getHtmlLabelName(380,user.getLanguage())));
      out.print((SystemEnv.getHtmlLabelName(277,user.getLanguage())));
      }
      out.write(_jsp_string101, 0, _jsp_string101.length);
      if(rs.getString("difftime").equals("1")){
      out.print((SystemEnv.getHtmlLabelName(458,user.getLanguage())));
      }
      out.write(_jsp_string102, 0, _jsp_string102.length);
      if(rs.getString("difftime").equals("2")){
      out.print((SystemEnv.getHtmlLabelName(370,user.getLanguage())));
      out.print((SystemEnv.getHtmlLabelName(371,user.getLanguage())));
      }
      ...
      out.write(_jsp_string105, 0, _jsp_string105.length);
       if(rs.getString("counttype").equals("0")){
      out.print((SystemEnv.getHtmlLabelName(452,user.getLanguage())));
      }
      out.write(_jsp_string102, 0, _jsp_string102.length);
       if(rs.getString("counttype").equals("1")){
      out.print((SystemEnv.getHtmlLabelName(459,user.getLanguage())));
      }
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      int _jspEval18 = _jsp_ViewTag_3.doStartTag();
      if (_jspEval18 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval18 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_3.setBodyContent(_jsp_endTagHack16);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/schedule/HrmScheduleDiffBrowser.jsp"), -3590289370672047242L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string154 = "\r\n							".toCharArray();
    _jsp_string96 = "</TD>	\r\n	<TD>".toCharArray();
    _jsp_string129 = "visible".toCharArray();
    ...
    _jsp_string119 = " oncontextmenu='return false'".toCharArray();
    ...
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string125 = "px\" height=\"".toCharArray();
    _jsp_string76 = "\">\r\n<input class=inputstyle type=hidden name=difftype value=\"".toCharArray();
    ...
    _jsp_string130 = ";display:none;\" align=\"left\"  allowtransparency=\"true\" style=\"background-color:transparent\" >\r\n	</div>\r\n	<div id=\"divRightMenuIframe\" name=\"divRightMenuIframe\" style=\"display:none\">\r\n		<iframe id=\"rightMenuIframe\" name=\"rightMenuIframe\" frameborder=0 marginheight=0 marginwidth=0 hspace=0 vspace=0 scrolling=no width=\"".toCharArray();
    ...
    _jsp_string86 = "<input class=inputstyle name=diffname value='".toCharArray();
    _jsp_string90 = "</TH>-->\r\n<!--\r\n<TH width=10%>\u76f8\u5173\u65f6\u95f4</TH>\r\n<TH width=5%>\u85aa\u8d44\u8ba1\u7b97</TH>\r\n<TH width=10%>\u8ba1\u7b97\u7c7b\u578b</TH>-->\r\n".toCharArray();
    ...
    _jsp_string128 = "hidden".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string92 = "\r\n<TR class=DataDark>\r\n	".toCharArray();
    _jsp_string91 = "\r\n<TR class=DataLight>\r\n".toCharArray();

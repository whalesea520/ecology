...
public class _hrmschedulediff__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	if(!subcompanyid.equals(0))navName = SubCompanyComInfo.getMoreSubCompanyname(subcompanyid);
      ...
      out.print((SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(6139,user.getLanguage())));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((SystemEnv.getHtmlLabelName(93,user.getLanguage())+SystemEnv.getHtmlLabelName(6139,user.getLanguage())));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/schedule/HrmScheduleDiff.jsp"), 1827524251147826416L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string70 = "\");\r\n			}\r\n			\r\n			function doEdit(id){\r\n				doOpen(\"/hrm/HrmDialogTab.jsp?_fromURL=HrmScheduleDiffEdit&isdialog=1&id=\"+id,\"".toCharArray();
    ...
    _jsp_string73 = "&sqlwhere=where operateitem=17\";\r\n				doOpen(url,\"".toCharArray();
    ...
    _jsp_string71 = "\");\r\n			}\r\n		\r\n			function doLog(id){\r\n				doOpen(\"/systeminfo/SysMaintenanceLog.jsp?isdialog=1&sqlwhere=where operateitem=17 and relatedid=\"+id,\"".toCharArray();
    ...
    _jsp_string74 = "\",jQuery(window).width(),jQuery(window).height());\r\n			}\r\n		</script>\r\n	</head>\r\n	<BODY>\r\n		\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string72 = "\",jQuery(window).width(),jQuery(window).height());\r\n			}\r\n			\r\n			function showAllLog(){\r\n				var url = \"/systeminfo/SysMaintenanceLog.jsp?subcompanyid=".toCharArray();

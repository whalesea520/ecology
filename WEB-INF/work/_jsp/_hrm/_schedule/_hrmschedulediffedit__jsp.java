...
public class _hrmschedulediffedit__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(6139,user.getLanguage()));
    ...
    RecordSet.next() ; 
              ...
              do {
                ...
                out.print((Util.toScreenToEdit(RecordSet.getString("diffname") , user.getLanguage())));
                ...
                out.print((Util.toScreen(RecordSet.getString("diffname") , user.getLanguage())));
                }
                out.write(_jsp_string145, 0, _jsp_string145.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              ...
              do {
                ...
                out.print((Util.toScreenToEdit(RecordSet.getString("diffdesc"),user.getLanguage())));
                ...
                out.print((Util.toScreen(RecordSet.getString("diffdesc") , user.getLanguage())));
                }
                out.write(_jsp_string145, 0, _jsp_string145.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(19374,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                out.write(_jsp_string163, 0, _jsp_string163.length);
                 if(RecordSet.getString("diffscope").equals("1")){
                out.write(_jsp_string160, 0, _jsp_string160.length);
                }
                out.write(_jsp_string161, 0, _jsp_string161.length);
                out.print((SystemEnv.getHtmlLabelName(141 , user.getLanguage())));
                out.write(_jsp_string164, 0, _jsp_string164.length);
                 if(RecordSet.getString("diffscope").equals("2")){
                out.write(_jsp_string160, 0, _jsp_string160.length);
                }
                out.write(_jsp_string161, 0, _jsp_string161.length);
                out.print((SystemEnv.getHtmlLabelName(141 , user.getLanguage())));
              ...
              do {
                ...
                _jsp_BrowserTag_3.setBrowserValue(RecordSet.getString("subcompanyid") );
                _jsp_BrowserTag_3.setBrowserSpanValue(SubCompanyComInfo.getSubCompanyname(RecordSet.getString("subcompanyid")) );
      ...
      int _jspEval43 = _jsp_ViewTag_4.doStartTag();
      if (_jspEval43 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval43 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_4.setBodyContent(_jsp_endTagHack41);
        ...
        do {
          ...
          int _jspEval46 = _jsp_GroupTag_5.doStartTag();
          if (_jspEval46 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval46 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_5.setBodyContent(_jsp_endTagHack44);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/schedule/HrmScheduleDiffEdit.jsp"), 3506413964427366065L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string147 = "\r\n      <input class=inputstyle type = \"text\" name = \"diffname\" maxLength = 10 value = \"".toCharArray();
    ...
    _jsp_string140 = "\" class=\"e8_btn_top\" onclick=\"submitData();\">\r\n			<span title=\"".toCharArray();
    ...
    _jsp_string148 = "\" onchange = \"checkinput('diffname','InvalidFlag_Description1')\" size = 10>\r\n  		<SPAN id = InvalidFlag_Description1>\r\n  	  ".toCharArray();
    ...
    _jsp_string153 = "\" onchange = \"checkinput('diffdesc','InvalidFlag_Description3')\" >\r\n  	<SPAN id = InvalidFlag_Description3>\r\n  	".toCharArray();
    ...
    _jsp_string152 = "\r\n      <input class=inputstyle type = \"text\" name = \"diffdesc\" maxLength = 30 value = \"".toCharArray();

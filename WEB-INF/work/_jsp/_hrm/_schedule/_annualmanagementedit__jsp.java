...
public class _annualmanagementedit__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(21611,user.getLanguage())));
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(21602,user.getLanguage())));
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(21602,user.getLanguage())+SystemEnv.getHtmlLabelName(87,user.getLanguage()));
            ...
            do {
              ...
              do {
                ...
                if (_jsp_ViewTag_4 == null) {
                  ...
                  _jsp_ViewTag_4.setAttributes("{'cols':'5','cws':'20%,20%,20%,20%,20%'}");
                }

                int _jspEval23 = _jsp_ViewTag_4.doStartTag();
                if (_jspEval23 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  if (_jspEval23 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
                    ...
                    _jsp_ViewTag_4.setBodyContent(_jsp_endTagHack21);
                  ...
                  do {
                    ...
                    if (_jspEval26 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      ...
                      do {
                        ...
                        _jsp_ItemTag_6.doInitBody();
                        do {
                          out.print((SystemEnv.getHtmlLabelNames("33611,15878",user.getLanguage())));
                        } while (_jsp_ItemTag_6.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
                        out = pageContext.popBody();
                        _jsp_ItemTag_6.doEndTag();
                        ...
                        _jsp_ItemTag_6.doInitBody();
                        do {
                          out.print((SystemEnv.getHtmlLabelName(19517,user.getLanguage())));
                        } while (_jsp_ItemTag_6.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
                        out = pageContext.popBody();
                        _jsp_ItemTag_6.doEndTag();
			    ...
			    if(jobtitle.equals("")) continue;
                        ...
                        do {
                          ...
                          out.print((tempsubcompanyid));
                          out.write(_jsp_string157, 0, _jsp_string157.length);
                          out.print((SubCompanyComInfo.getSubCompanyname(tempsubcompanyid)));
                          out.write(_jsp_string158, 0, _jsp_string158.length);
                        } while (_jsp_ItemTag_7.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
                        out = pageContext.popBody();
                        _jsp_ItemTag_7.doEndTag();
                        ...
                        do {
                          ...
                          out.print((tempdepartmentid));
                          out.write(_jsp_string157, 0, _jsp_string157.length);
                          out.print((DepartmentComInfo.getDepartmentname(tempdepartmentid)));
                          out.write(_jsp_string158, 0, _jsp_string158.length);
                        } while (_jsp_ItemTag_7.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
                        out = pageContext.popBody();
                        _jsp_ItemTag_7.doEndTag();
                        ...
                        do {
                          ...
                          out.print((Util.round(Util.getFloatValue(tempannualdays,0)+"",2)));
      ...
      out.print((SystemEnv.getHtmlLabelName(129356,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/schedule/AnnualManagementEdit.jsp"), 6626014742485429058L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string160 = "<a href=javascript:this.openFullWindowForXtable('/hrm/company/HrmDepartmentDsp.jsp?id=".toCharArray();
    ...
    _jsp_string143 = "\"></input>\r\n				<input type=button class=\"e8_btn_top\" onclick=\"BatchProcess();\" value=\"".toCharArray();
    ...
    _jsp_string156 = "<a href=javascript:this.openFullWindowForXtable('/hrm/resource/HrmResource.jsp?id=".toCharArray();
    _jsp_string122 = "\"></td>\r\n							".toCharArray();
    _jsp_string45 = ";\r\nusbserial0 = \"".toCharArray();
    _jsp_string158 = "</a>".toCharArray();
    ...
    _jsp_string161 = "\r\n					<input type=text size=4 class=inputstyle name=annualdays value=\"".toCharArray();
    _jsp_string127 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result6\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string169 = "&subCompanyId=".toCharArray();
    _jsp_string4 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    _jsp_string78 = ")-1 : Math.ceil(bodyWidth/".toCharArray();
    _jsp_string139 = "\r\n<span><font color='red'>".toCharArray();
    ...
    _jsp_string166 = "\");\r\n			return;\r\n		}\r\n	}\r\n	obj.disable=true;\r\n    frmmain.submit();\r\n}\r\nfunction goBack(){\r\n    frmmain.action=\"AnnualManagementView.jsp?subCompanyId=".toCharArray();
    _jsp_string64 = "\r\n\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string168 = "\";\r\n    frmmain.submit();\r\n}\r\nfunction BatchProcess(){\r\n    document.frmmain.operation.value=\"batchprocess\";\r\n    frmmain.submit();\r\n}\r\nfunction onImport(){\r\n    frmmain.action=\"AnnualManagementImport.jsp?annualyear=".toCharArray();
    _jsp_string24 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string159 = "<a href=javascript:this.openFullWindowForXtable('/hrm/company/HrmDepartment.jsp?subcompanyid=".toCharArray();
    ...
    _jsp_string167 = "&departmentid=".toCharArray();
    _jsp_string22 = "\";\r\n					diag.show();\r\n			        return false;\r\n	    		}\r\n	    		else if(response_flag=='2') {\r\n	    			flag_msg = '".toCharArray();
    _jsp_string73 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string162 = "\">\r\n			     	<input type=hidden size=4 class=inputstyle name=resourceid value=\"".toCharArray();
    ...
    _jsp_string137 = "\">\r\n<input type=\"hidden\" name=\"annualyear\" value=\"".toCharArray();
    _jsp_string39 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();

...
public class _scheduleapplicationsetting__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string52, 0, _jsp_string52.length);
      weaver.hrm.attendance.manager.HrmScheduleApplicationManager hrmScheduleApplicationManager;
      hrmScheduleApplicationManager = (weaver.hrm.attendance.manager.HrmScheduleApplicationManager) pageContext.getAttribute("hrmScheduleApplicationManager");
      if (hrmScheduleApplicationManager == null) {
        hrmScheduleApplicationManager = new weaver.hrm.attendance.manager.HrmScheduleApplicationManager();
        pageContext.setAttribute("hrmScheduleApplicationManager", hrmScheduleApplicationManager);
      }
      out.write(_jsp_string0, 0, _jsp_string0.length);
...
//\u548c\u8003\u52e4\u6d41\u7a0b\u8bbe\u7f6e\u7684\u6743\u9650\u4e00\u81f4\uff1a\u8003\u52e4\u6d41\u7a0b\u8bbe\u7f6e
	if(!HrmUserVarify.checkUserRight("HrmAttendanceProcess:setting", user)){
      ...
      out.print((SystemEnv.getHtmlLabelNames("15880,579,68",user.getLanguage())));
...
if(userightmenu!=1){
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelNames("451,33425",user.getLanguage())));
              ...
              do {
                ...
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(128559,user.getLanguage())));
                out.write(_jsp_string149, 0, _jsp_string149.length);
                 if(ScheduleUnit == 2) {
                out.write(_jsp_string147, 0, _jsp_string147.length);
                }
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(27641,user.getLanguage())));
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelNames("149,21551",user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(128668,user.getLanguage())));
                out.write(_jsp_string154, 0, _jsp_string154.length);
                out.print((SystemEnv.getHtmlLabelName(128669,user.getLanguage())));
                out.write(_jsp_string154, 0, _jsp_string154.length);
                out.print((SystemEnv.getHtmlLabelName(128670,user.getLanguage())));
                out.write(_jsp_string154, 0, _jsp_string154.length);
                out.print((SystemEnv.getHtmlLabelName(128671,user.getLanguage())));
                out.write(_jsp_string154, 0, _jsp_string154.length);
                out.print((SystemEnv.getHtmlLabelName(128672,user.getLanguage())));
                out.write(_jsp_string154, 0, _jsp_string154.length);
                out.print((SystemEnv.getHtmlLabelName(382418,user.getLanguage())));
                out.write(_jsp_string154, 0, _jsp_string154.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
          ...
          if (_jsp_GroupTag_3 == null) {
            ...
            _jsp_GroupTag_3.setAttributes("{'samePair':'tr_schedulerule','groupOperDisplay':'none'}");
          }

          _jsp_GroupTag_3.setContext(SystemEnv.getHtmlLabelNames("15880,579,68",user.getLanguage()));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/schedule/ScheduleApplicationSetting.jsp"), -5232941478827812459L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string151 = "\r\n             <input class=InputStyle  name=\"onedayworkhours\" value=\"".toCharArray();
    ...
    _jsp_string152 = "\" onBlur='checknumber(\"onedayworkhours\")' />\r\n		".toCharArray();
    ...
    _jsp_string158 = "<div id=\"admintable\"></div>".toCharArray();

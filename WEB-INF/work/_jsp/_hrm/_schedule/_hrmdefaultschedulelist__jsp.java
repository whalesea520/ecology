...
public class _hrmdefaultschedulelist__jsp extends com.caucho.jsp.JavaPage
{
...
if(departmentid.length()>0) navName = DepartmentComInfo.getDepartmentName(departmentid);
	...
	navName = CompanyComInfo.getCompanyname("1");
      ...
      out.print((SystemEnv.getHtmlLabelName(26473,user.getLanguage())+SystemEnv.getHtmlLabelName(16254,user.getLanguage())));
      out.write(_jsp_string72, 0, _jsp_string72.length);
      out.print((SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(16254,user.getLanguage())));
      ...
      out.print((xssUtil.put("where operateitem=13 and relatedid=")));
      out.write(_jsp_string77, 0, _jsp_string77.length);
      out.print((xssUtil.put("where operateitem=13")));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              if (_jsp_ItemTag_3 == null) {
                ...
                _jsp_ItemTag_3.setAttributes("{'samePair':'buttonShowRelatedId'}");
              }
              ...
              do {
                ...
                _jsp_BrowserTag_4.setName("subcompanyid1");
                ...
                _jsp_BrowserTag_4.set_callback("");
                _jsp_BrowserTag_4.setBrowserValue(subcompanyid1);
                _jsp_BrowserTag_4.setBrowserSpanValue(SubCompanyComInfo.getSubCompanyname(subcompanyid1) );
...
tableString =" <table pageId=\""+PageIdConst.HRM_DefaultScheduleList+"\" tabletype=\""+tabletype+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.HRM_DefaultScheduleList,user.getUID(),PageIdConst.HRM)+"\" >"+
    ...
    " </table>";
      ...
      out.print(( PageIdConst.HRM_DefaultScheduleList ));
      ...
      int _jsp_end_43 = _jsp_SplitPageTag_6.doEndTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/schedule/HrmDefaultScheduleList.jsp"), -316242503638224081L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string171 = "</span>".toCharArray();
    _jsp_string62 = ")\">\r\n".toCharArray();
    ...
    _jsp_string179 = "\r\n	  ".toCharArray();
    _jsp_string178 = "\" class=\"e8_btn_cancel\" id=\"cancel\"/>\r\n	  	".toCharArray();
    ...
    _jsp_string176 = "\" class=\"e8_btn_submit\" onclick=\"onBtnSearchClick()\"/>\r\n				<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string42 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string186 = "\r\nhideEle(\"buttonShowRelatedId\");\r\n".toCharArray();
    _jsp_string165 = ">1".toCharArray();
    _jsp_string167 = ">2".toCharArray();
    ...
    _jsp_string170 = "<span id=spanShowRelatedIdLabel>".toCharArray();
    _jsp_string76 = "\";\r\n	dialog.Width = 800;\r\n	dialog.Height = 557;\r\n	dialog.Drag = true;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n}\r\n\r\nfunction onLog(id){\r\n	dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	var url = \"\";\r\n	if(id && id!=\"\"){\r\n		url = \"/docs/tabs/DocCommonTab.jsp?_fromURL=3&isdialog=1&secid=65&sqlwhere=".toCharArray();
    _jsp_string177 = "\" class=\"e8_btn_cancel\" onclick=\"common.resetCondition(this);\"/>\r\n				<input type=\"button\" value=\"".toCharArray();

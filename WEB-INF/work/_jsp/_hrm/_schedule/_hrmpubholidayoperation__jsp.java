...
public class _hrmpubholidayoperation__jsp extends com.caucho.jsp.JavaPage
{
...
if(opera.equals("delete")){
	...
	if(RecordSet.getInt(1)==2){ 
      ...
      out.print((SystemEnv.getHtmlLabelName(497,user.getLanguage())));
      out.print((SystemEnv.getHtmlLabelName(423,user.getLanguage())));
      out.write(_jsp_string65, 0, _jsp_string65.length);
...
if(opera.equals("copy")){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/schedule/HrmPubHolidayOperation.jsp"), -4382541740449730592L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string66 = "<a href=\"HrmPubHoliday.jsp\">".toCharArray();

...
public class _pslperiodedit__jsp extends com.caucho.jsp.JavaPage
{
...
if(msgid != -1) {
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(19548,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(19547,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
      ...
      out.print((SystemEnv.getHtmlNoteName(25,user.getLanguage())));
      out.write(_jsp_string167, 0, _jsp_string167.length);
      out.print((SystemEnv.getHtmlLabelNames("19547,27891,19548",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/schedule/PSLPeriodEdit.jsp"), -6335049302227677012L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string171 = "&operation=delete&id=".toCharArray();
    ...
    _jsp_string155 = "<BUTTON class=Calendar type=\"button\" id=selectenddate onclick=\"onShowDate('enddatespan','enddate')\"></BUTTON> \r\n       <SPAN id=enddatespan>".toCharArray();
    _jsp_string68 = "\r\n<BODY>\r\n".toCharArray();
    ...
    _jsp_string154 = "\">\r\n    ".toCharArray();
    _jsp_string168 = "\");\r\n		return false;\r\n	}\r\n	return true ;\r\n}\r\n\r\nfunction submitData() {\r\n	if(checkvalue()) frmMain.submit();\r\n}\r\nfunction goback(){\r\n    location=\"PSLPeriodView.jsp?subcompanyid=".toCharArray();
    ...
    _jsp_string152 = "<BUTTON class=Calendar type=\"button\" id=selectstartdate onclick=\"onShowDate('startdatespan','startdate')\"></BUTTON> \r\n      <SPAN id=startdatespan>".toCharArray();
    ...
    _jsp_string150 = " \r\n    	<input class=inputstyle id=PSLyear name=PSLyear value=\"".toCharArray();
    ...
    _jsp_string170 = "\")) {\r\n      location=\"PSLPeriodOperation.jsp?subcompanyid=".toCharArray();
    _jsp_string15 = "\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string77 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string144 = "\">\r\n<input class=inputstyle type=hidden name=subcompanyid value=\"".toCharArray();
    ...
    _jsp_string76 = "\";\r\n        dialog.Width = 550 ;\r\n        dialog.Height = 600;\r\n        dialog.Drag = true;\r\n        dialog.show();\r\n    });\r\n\r\n}\r\n</script>\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string145 = "\">\r\n<input class=inputstyle type=hidden name=leavetype value=\"".toCharArray();
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();

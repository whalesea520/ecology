...
public class _annualmanagementviewlog__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string52, 0, _jsp_string52.length);
      weaver.splitepage.transform.SptmForCowork SptmForCowork;
      SptmForCowork = (weaver.splitepage.transform.SptmForCowork) pageContext.getAttribute("SptmForCowork");
      if (SptmForCowork == null) {
        SptmForCowork = new weaver.splitepage.transform.SptmForCowork();
        pageContext.setAttribute("SptmForCowork", SptmForCowork);
      }
      out.write(_jsp_string0, 0, _jsp_string0.length);
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(32940,user.getLanguage()));
            ...
            do {
              ...
              do {
                ...
                if (_jsp_ViewTag_3 == null) {
                  ...
                  _jsp_ViewTag_3.setAttributes("{'cols':'4','cws':'25%,25%,25%,25%'}");
                }
                  ...
                  do {
                    ...
                    if (_jspEval14 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      ...
                      do {
                        ...
                        do {
                          out.print((SystemEnv.getHtmlLabelNames("17482,413",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/schedule/AnnualManagementViewLog.jsp"), 8608019580665447507L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

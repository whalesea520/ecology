...
public class _annualbatchview__jsp extends com.caucho.jsp.JavaPage
{
...
if(!subcompanyid.equals("0")) showname = SubCompanyComInfo.getSubCompanyname(subcompanyid);
      ...
      out.print((SystemEnv.getHtmlLabelNames("26473,21599",user.getLanguage())));
      out.write(_jsp_string72, 0, _jsp_string72.length);
      out.print((subcompanyid));
      out.write(_jsp_string73, 0, _jsp_string73.length);
      out.print((SystemEnv.getHtmlLabelNames("82,21599",user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(titlename );
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
			...
			tableString =" <table pageId=\""+PageIdConst.HRM_AnnualBatchView+"\" tabletype=\""+tabletype+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.HRM_AnnualBatchView,user.getUID(),PageIdConst.HRM)+"\" >"+
                ...
                out.print(( PageIdConst.HRM_AnnualBatchView ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/schedule/AnnualBatchView.jsp"), -3405601587423906248L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string160 = "&ids=\"+ids;\r\n     })\r\n  }\r\n}\r\n</script>\r\n</BODY>\r\n</HTML>\r\n\r\n".toCharArray();
    _jsp_string136 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result6\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    _jsp_string87 = ")-1 : Math.ceil(bodyWidth/".toCharArray();
    _jsp_string72 = "\";\r\n		url = \"/hrm/HrmDialogTab.jsp?_fromURL=AnnualBatchEdit&subcompanyid=".toCharArray();
    ...
    _jsp_string159 = "\",function(){\r\n     	location.href=\"/hrm/schedule/AnnualBatchOperation.jsp?operation=syn&subcompanyid=".toCharArray();

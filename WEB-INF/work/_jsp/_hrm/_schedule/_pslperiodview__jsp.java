...
public class _pslperiodview__jsp extends com.caucho.jsp.JavaPage
{
...
if(isSysadmin>0) {  //\u7528\u7cfb\u7edf\u7ba1\u7406\u5458sysadmin\u767b\u9646\u7cfb\u7edf\u53ef\u67e5\u770b\u9875\u9762\u5730\u5740
	...
	defaultMenuCount++;
      ...
      out.print((SystemEnv.getHtmlLabelNames("26473,131559",user.getLanguage())));
      out.write(_jsp_string81, 0, _jsp_string81.length);
      out.print((subcompanyid));
      out.write(_jsp_string82, 0, _jsp_string82.length);
      out.print((SystemEnv.getHtmlLabelNames("82,131559",user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(21671, user.getLanguage())));
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
		...
		tableString =" <table pageId=\""+PageIdConst.HRM_PSLPeriodView+"\" tabletype=\""+tabletype+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.HRM_PSLPeriodView,user.getUID(),PageIdConst.HRM)+"\" >"+
		    ...
		    " </table>";
                ...
                out.print(( PageIdConst.HRM_PSLPeriodView ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/schedule/PSLPeriodView.jsp"), 700000298599507340L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string164 = "\",function(){\r\n		location.href=\"/hrm/schedule/PSLPeriodOperation.jsp?operation=syn&subcompanyid=".toCharArray();
    ...
    _jsp_string81 = "\";\r\n		url = \"/hrm/HrmDialogTab.jsp?_fromURL=PSLPeriodEdit&subcompanyid=".toCharArray();
    ...
    _jsp_string80 = "&leavetype=\"+jQuery(\"#leavetype\").val();\r\n	if(!!id){\r\n		dialog.Title = \"".toCharArray();
    ...
    _jsp_string149 = "\"></input>\r\n				<input type=button class=\"e8_btn_top\" onclick=\"onSyn();\" value=\"".toCharArray();
    ...
    _jsp_string82 = "&id=\"+id+\"&leavetype=\"+jQuery(\"#leavetype\").val();\r\n	}else{\r\n		dialog.Title = \"".toCharArray();

...
public class _annualperiodview__jsp extends com.caucho.jsp.JavaPage
{
...
if(!subcompanyid.equals("0")) showname = SubCompanyComInfo.getSubCompanyname(subcompanyid);
      ...
      out.print((SystemEnv.getHtmlLabelNames("26473,21598",user.getLanguage())));
      out.write(_jsp_string76, 0, _jsp_string76.length);
      out.print((subcompanyid));
      out.write(_jsp_string77, 0, _jsp_string77.length);
      out.print((SystemEnv.getHtmlLabelNames("82,21598",user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(21598,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
			...
			tableString =" <table pageId=\""+PageIdConst.HRM_AnnualPeriodView+"\" tabletype=\""+tabletype+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.HRM_AnnualPeriodView,user.getUID(),PageIdConst.HRM)+"\" >"+
                ...
                out.print(( PageIdConst.HRM_AnnualPeriodView ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/schedule/AnnualPeriodView.jsp"), -1294846138499812807L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string76 = "\";\r\n		url = \"/hrm/HrmDialogTab.jsp?_fromURL=AnnualPeriodEdit&subcompanyid=".toCharArray();
    _jsp_string135 = "\"></td>\r\n							".toCharArray();
    ...
    _jsp_string168 = "&ids=\"+ids;       \r\n       }else{\r\n          location.href=\"/hrm/schedule/AnnualPeriodOperation.jsp?operation=delete&subcompanyid=".toCharArray();
    ...
    _jsp_string73 = "\",function(){\r\n      location.href=\"/hrm/schedule/AnnualPeriodOperation.jsp?operation=syn&subcompanyid=".toCharArray();
    _jsp_string78 = "\";\r\n	}\r\n	dialog.Width = 500;\r\n	dialog.Height = 500;\r\n	dialog.Drag = true;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n}\r\n</script>\r\n\r\n</head>\r\n<BODY>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    ...
    _jsp_string74 = "&ids=\"+id;       \r\n    });\r\n	 }\r\n}\r\n\r\nvar dialog = null;\r\nfunction closeDialog(){\r\n	if(dialog)\r\n		dialog.close();\r\n}\r\n\r\nfunction openDialog(id){\r\n	if(dialog==null){\r\n		dialog = new window.top.Dialog();\r\n	}\r\n	dialog.currentWindow = window;\r\n	if(id==null){\r\n		id=\"\";\r\n	}\r\n	var url = \"/hrm/HrmDialogTab.jsp?_fromURL=AnnualPeriodAdd&subcompanyid=".toCharArray();
    _jsp_string77 = "&id=\"+id;\r\n	}else{\r\n		dialog.Title = \"".toCharArray();
    _jsp_string0 = "\r\n\r\n ".toCharArray();
    ...
    _jsp_string2 = "\r\n\r\n".toCharArray();
    _jsp_string167 = "\")){       \r\n          location.href=\"/hrm/schedule/AnnualPeriodOperation.jsp?operation=syndelete&subcompanyid=".toCharArray();

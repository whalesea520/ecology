...
public class _hrmvalidateprivate__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(82922,user.getLanguage())+SystemEnv.getHtmlLabelName(82928,user.getLanguage()) ));
      ...
      out.print((SystemEnv.getHtmlLabelName(18274,user.getLanguage()) ));
      out.write('(');
      ...
      out.print((SystemEnv.getHtmlLabelName(6002,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/tools/HrmValidatePrivate.jsp"), -1542000751744881679L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string48 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string146 = "\",itemhtml:\"<input type='checkbox' class='InputStyle' name='isopen'  />\"}\r\n		];\r\n     var option= {\r\n    		 navcolor:\"#00cc00\",\r\n    		 basictitle:\"".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string142 = ")\",itemhtml:\"<input type='text' class='InputStyle'  style='width:120px!important;' name='groupnamecn' /><span class='mustinput'></span>\"},\r\n			{width:\"18%\",colname:\"".toCharArray();
    ...
    _jsp_string143 = "(English)\",itemhtml:\"<input type='text' class='InputStyle' style='width:120px!important;' name='groupnameen' />\"},\r\n			{width:\"18%\",colname:\"".toCharArray();
    ...
    _jsp_string145 = " <img id='remindImg' src='/wechat/images/remind_wev8.png' align='absMiddle' title='' />\",itemhtml:\"<input type='text' class='InputStyle' style='width:380px!important;' name='linkurl' /><span class='mustinput'></span>\"},\r\n			{width:\"10%\",colname:\"".toCharArray();

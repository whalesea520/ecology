...
public class _networksegmentstrategy__jsp extends com.caucho.jsp.JavaPage
{
...
String tableString=""+
      ...
      out.print((SystemEnv.getHtmlLabelName(26473,user.getLanguage())+SystemEnv.getHtmlLabelName(21384,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(21384,user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((xssUtil.put("where operateitem=101 and relatedid=")));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((xssUtil.put("where operateitem=101")));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(21387,user.getLanguage())));
      out.write(_jsp_string146, 0, _jsp_string146.length);
      out.print((inceptipaddress ));
      out.write(_jsp_string147, 0, _jsp_string147.length);
      out.print((SystemEnv.getHtmlLabelName(21388,user.getLanguage())));
      out.write(_jsp_string148, 0, _jsp_string148.length);
      out.print((endipaddress ));
      out.write(_jsp_string149, 0, _jsp_string149.length);
      out.print((SystemEnv.getHtmlLabelName(21386,user.getLanguage())));
      out.write(_jsp_string146, 0, _jsp_string146.length);
      out.print((segmentdesc ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/tools/NetworkSegmentStrategy.jsp"), -6791416368587495462L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string153 = "</td>\r\n</form>\r\n<form><input type=\"hidden\" name=\"s\" value=\"".toCharArray();
    _jsp_string108 = "\r\n		return false;\r\n		".toCharArray();
    ...
    _jsp_string147 = "\" name=\"inceptipaddress\"></TD>\r\n       <TD>".toCharArray();
    ...
    _jsp_string151 = "\" class=\"e8_btn_submit\" onclick=\"onBtnSearchClick();\"/>\r\n				<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string150 = "\" name=\"segmentdesc\"></TD>\r\n     	 <td class=Field></td>\r\n     	 <td class=Field></td>\r\n     </TR>\r\n     <TR style=\"height:1px\"><TD class=Line colSpan=4></TD></TR> \r\n     <tr align=\"center\">\r\n     	<td colspan=\"4\" class=\"btnTd\">\r\n     		<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string149 = "\" name=\"endipaddress\"></TD>\r\n     </TR>\r\n   	 <TR style=\"height:1px\"><TD class=Line colSpan=4></TD></TR> \r\n	   <TR>\r\n       <TD>".toCharArray();
    ...
    _jsp_string146 = "</TD>\r\n       <TD class=Field><input class=inputstyle type=text style=\"width: 95%\" value=\"".toCharArray();

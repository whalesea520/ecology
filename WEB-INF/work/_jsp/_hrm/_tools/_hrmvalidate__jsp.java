...
public class _hrmvalidate__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(32749,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/tools/HrmValidate.jsp"), 2080858571592906497L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string145 = "\r\n      <input class=inputstyle type=\"checkbox\" name=\"isValidate\" value=\"".toCharArray();
    ...
    _jsp_string146 = "\" onclick=\"jsChkChild(this)\" ".toCharArray();
    ...
    _jsp_string138 = "</th>\r\n		<th><input name=\"chkAll\" type=\"checkbox\" onclick=\"jsChkAll(this)\">".toCharArray();

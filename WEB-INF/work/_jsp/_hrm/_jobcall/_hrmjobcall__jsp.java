...
public class _hrmjobcall__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelName(26473,user.getLanguage())+SystemEnv.getHtmlLabelName(806,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(806,user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((xssUtil.put("where operateitem=65 and relatedid=")));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((xssUtil.put("where operateitem=65")));
...
tableString =" <table pageId=\""+PageIdConst.HRM_JobCall+"\" tabletype=\""+tabletype+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.HRM_JobCall,user.getUID(),PageIdConst.HRM)+"\" >"+
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/jobcall/HrmJobCall.jsp"), -8921462501140843519L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

...
package _jsp._hrm._career._inviteinfo;
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	String needhelp ="";
      ...
      out.print((SystemEnv.getHtmlLabelName(93,user.getLanguage())+SystemEnv.getHtmlLabelName(366,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(366,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(221,user.getLanguage())+SystemEnv.getHtmlLabelName(366,user.getLanguage())));
      out.write(_jsp_string77, 0, _jsp_string77.length);
      out.print((cmd));
      out.write(_jsp_string72, 0, _jsp_string72.length);
      out.print((planid));
      out.write(_jsp_string76, 0, _jsp_string76.length);
      out.print((SystemEnv.getHtmlLabelName(1863,user.getLanguage())+SystemEnv.getHtmlLabelName(33292,user.getLanguage())));
      out.write(_jsp_string78, 0, _jsp_string78.length);
      out.print((xssUtil.put("where operateitem=58 and relatedid=")));
      out.write(_jsp_string79, 0, _jsp_string79.length);
      out.print((xssUtil.put("where operateitem=58")));
      ...
      out.print((SystemEnv.getHtmlLabelNames("33251,366",user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      int _jsp_end_28 = _jsp_SplitPageTag_5.doEndTag();
      ...
      int _jspEval31 = _jsp_ViewTag_0.doStartTag();
      if (_jspEval31 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval31 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_0.setBodyContent(_jsp_endTagHack29);
          _jsp_ViewTag_0.doInitBody();
        }
        do {
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/career/inviteinfo/list.jsp"), -2110419066152722705L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string162 = "\" class=\"cornerMenu\"></span>\r\n					</td>\r\n				</tr>\r\n			</table>\r\n			<div class=\"advancedSearchDiv\" id=\"advancedSearchDiv\" style=\"display:none;\" >\r\n				".toCharArray();
    ...
    _jsp_string74 = "\";\r\n				url = \"/hrm/HrmDialogTab.jsp?_fromURL=inviteInfo&method=add&cmd=".toCharArray();
    ...
    _jsp_string81 = "\",jQuery(window).width(),jQuery(window).height());\r\n		}\r\n		\r\n		function selectInviteInfo(){\r\n			doOpen(\"/systeminfo/BrowserMain.jsp?url=/hrm/career/inviteinfo/MultiInviteBrowser.jsp&cmd=cleanMID\",\"".toCharArray();
    ...
    _jsp_string76 = "&isdialog=1&id=\"+id,\"".toCharArray();
    ...
    _jsp_string168 = "\" class=\"e8_btn_submit\" onclick=\"onBtnSearchClick()\"/>\r\n							<input type=\"button\" value=\"".toCharArray();
    _jsp_string3 = "\r\n	<script language=\"javascript\">\r\n		window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string154 = "\r\n								<input type=button class=\"e8_btn_top\" onclick=\"selectInviteInfo();\" value=\"".toCharArray();
    _jsp_string149 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result7\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    _jsp_string47 = "\";\r\nusblanguage = \"".toCharArray();
    _jsp_string82 = "\",550,520);\r\n		}\r\n		</script>\r\n	</head>\r\n	<BODY>\r\n		".toCharArray();
    ...
    _jsp_string75 = "&isdialog=1\";\r\n				dialog.Drag = true;\r\n			}\r\n			dialog.Width = 880;\r\n			dialog.Height = 500;\r\n			dialog.URL = url;\r\n			dialog.show();\r\n		}\r\n		\r\n		function showDetail(id){\r\n			doOpen(\"/hrm/HrmDialogTab.jsp?_fromURL=inviteInfo&method=show&cmd=".toCharArray();
    ...
    _jsp_string68 = "\",function(){\r\n				var idArr = id.split(\",\");\r\n				var ajaxNum = 0;\r\n				for(var i=0;i<idArr.length;i++){\r\n					ajaxNum++;\r\n					jQuery.ajax({\r\n						url:\"save.jsp?isdialog=1&operation=delete&planid=".toCharArray();
    ...
    _jsp_string84 = "\r\n		\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string69 = "&inviteId=\"+idArr[i],\r\n						type:\"post\",\r\n						async:true,\r\n						complete:function(xhr,status){\r\n							ajaxNum--;\r\n							if(ajaxNum==0){\r\n								_table.reLoad();\r\n							}\r\n						}\r\n					});\r\n				}\r\n			});\r\n		}\r\n		\r\n		var parentDialog = parent.parent.getDialog(parent);\r\n		\r\n		var dialog = null;\r\n		var dWidth = 880;\r\n		var dHeight = 500;;\r\n		var _id = \"\";\r\n		var _name = \"\";\r\n		\r\n		function doOpen(url,title,_dWidth,_dHeight){\r\n			if(dialog==null){\r\n				dialog = new window.top.Dialog();\r\n			}\r\n			dialog.currentWindow = window;\r\n			dialog.Title = title;\r\n			dialog.Width = _dWidth ? _dWidth : dWidth;\r\n			dialog.Height = _dHeight ? _dHeight : dHeight;\r\n			dialog.Drag = true;\r\n			dialog.maxiumnable = true;\r\n			dialog.URL = url;\r\n			dialog.show();\r\n		}\r\n		function closeDialog(cmd,planid){\r\n			if(dialog)\r\n				dialog.close();\r\n			if(_id != null){\r\n				window.location.href=\"/hrm/career/inviteinfo/save.jsp?operation=addinvite&planid=".toCharArray();
    _jsp_string72 = "&planid=".toCharArray();
    _jsp_string71 = "\";\r\n				url = \"/hrm/HrmDialogTab.jsp?_fromURL=inviteInfo&method=edit&cmd=".toCharArray();
    _jsp_string159 = "\"/>\r\n						<input type=\"hidden\" name=\"planid\" value=\"".toCharArray();
    ...
    _jsp_string179 = "\" class=\"e8_btn_cancel\" onclick=\"parentDialog.close();\">\r\n		    	".toCharArray();
    _jsp_string92 = "	\r\n		\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();

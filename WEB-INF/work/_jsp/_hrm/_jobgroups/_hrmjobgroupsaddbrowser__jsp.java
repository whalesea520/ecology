...
public class _hrmjobgroupsaddbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(id.length()>0)name = JobGroupsComInfo.getJobGroupsname(id);
      ...
      out.print((SystemEnv.getHtmlLabelNames("805",user.getLanguage())));
...
String isEnableExtranetHelp = KtreeHelp.getInstance().isEnableExtranetHelp;
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/jobgroups/HrmJobGroupsAddBrowser.jsp"), -1480121958688385467L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string78 = "\" class=\"e8_btn_top\" onclick=\"submitData();\">\r\n			<span title=\"".toCharArray();
    ...
    _jsp_string88 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.closeByHand();\">\r\n			".toCharArray();
    _jsp_string61 = ")\">\r\n".toCharArray();
    ...
    _jsp_string84 = "<input class=inputstyle type=text name=jobgroupremark >".toCharArray();

...
public class _hrmfieldgroup__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(83375,user.getLanguage()) ));
      ...
      out.print((SystemEnv.getHtmlLabelName(82933,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/definedform/HrmFieldGroup.jsp"), -5299636051146875359L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string145 = "\",\r\n    		 openindex:false,\r\n    		 colItems:items,\r\n    		 toolbarshow:false,\r\n    		 optionHeadDisplay:\"none\",\r\n    		 canDrag:true,\r\n    		 useajax:true,\r\n    		 ajaxurl:'/hrm/definedform/HrmFieldGroupOperation.jsp?grouptype=".toCharArray();
    ...
    _jsp_string142 = ")\",itemhtml:\"<input type='text' class='InputStyle'  style='width:220px!important;' name='groupnamecn' /><span class='mustinput'></span>\"},\r\n			{width:\"30%\",colname:\"".toCharArray();
    ...
    _jsp_string137 = "\" class=\"e8_btn_top\"  onclick=\"group1.deleteRows()\"/>\r\n			<input type=\"button\" value=\"".toCharArray();
    _jsp_string138 = "\" class=\"e8_btn_top\"  onclick=\"group1.copyRows()\"/>\r\n			<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string72 = "\";\r\n        dialog.Width = 550 ;\r\n        dialog.Height = 600;\r\n        dialog.Drag = true;\r\n        dialog.show();\r\n    });\r\n\r\n}\r\n</script>\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string146 = "',\r\n    		 ajaxparams:{\"src\":\"loadgroupdata\"},\r\n    		 configCheckBox:true,\r\n    		 checkBoxItem:{itemhtml:\"<input class='groupselectbox' name='groupid' type='checkbox'><img moveimg src='/proj/img/move_wev8.png' title='".toCharArray();
    _jsp_string48 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string118 = "\r\n		<script type=\"text/javascript\">\r\n\r\n			jQuery(\"#divTopMenu\").hide();\r\n			jQuery(\"#rightMenu\",_menuDocument).hide();\r\n		\r\n		</script>\r\n		".toCharArray();
    _jsp_string95 = "hidden".toCharArray();
    _jsp_string39 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string144 = ")\",itemhtml:\"<input type='text' class='InputStyle' style='width:220px!important;' name='groupnametw' />\"},\r\n		];\r\n     var option= {\r\n    		 navcolor:\"#00cc00\",\r\n    		 basictitle:\"".toCharArray();
    _jsp_string21 = "\";\r\n					//diag.InvokeElementId=\"pageOverlay\"\r\n					diag.URL = \"/wui/theme/ecology7/page/loginSmall.jsp?username=".toCharArray();
    _jsp_string136 = "\" class=\"e8_btn_top\" onclick=\"group1.addRow()\"/>\r\n			<input type=\"button\" value=\"".toCharArray();
    _jsp_string134 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result4\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string28 = "')) {\r\n				    lenck = false;\r\n				    break;\r\n			    }\r\n		    }\r\n		    if(lenck==false) return false;\r\n	    }\r\n	    catch(e) {}\r\n	    ".toCharArray();
    _jsp_string143 = "(English)\",itemhtml:\"<input type='text' class='InputStyle' style='width:220px!important;' name='groupnameen' />\"},\r\n			{width:\"30%\",colname:\"".toCharArray();

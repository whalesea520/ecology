...
public class _hrmcountry_0left__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	if(cid.length() == 0 || CountryComInfo.getCountryname(cid).length() == 0){
      ...
      out.print((SystemEnv.getHtmlLabelName(126719, user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/area/HrmCountry_left.jsp"), 819948138792786835L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string68 = "&selectedids=&id=\" + treeNode.id + \"&type=\"+treeNode.type+\"&\" + treeNode.ajaxParam + \"&\" + new Date().getTime() + \"=\" + new Date().getTime();\r\n	    } else {\r\n	    	//\u521d\u59cb\u5316\u65f6\r\n	    	return \"/hrm/area/HrmCountry_leftXml.jsp?searchStr=".toCharArray();

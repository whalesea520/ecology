...
public class _mapviewcontent__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	while(it.hasNext()){
      ...
      out.print((weaver.hrm.common.Constants.WEB_MAP_KEY));
      ...
      out.print((isToday ? SystemEnv.getHtmlLabelName(15537, user.getLanguage()) : thisDate));
      ...
      out.print((SystemEnv.getHtmlLabelName(83508,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/mobile/signin/mapViewContent.jsp"), -4582527664195041217L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string73 = "\"/>\r\n				<input type=\"hidden\" name=\"uid\" id=\"uid\" value=\"".toCharArray();
    ...
    _jsp_string74 = "\"/>\r\n				<div class=\"img img011\">\r\n					<a href=\"javascript:void(0);\" onclick=\"".toCharArray();
    _jsp_string1 = "\r\n<!DOCTYPE HTML>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n<html>\r\n<head>\r\n<!-- \r\n\u6dfb\u52a0\u81f3init.css\r\n<style type=\"text/css\">\r\n	html{height:100%;}\r\n</style>\r\n -->\r\n".toCharArray();
    ...
    _jsp_string76 = "\" style=\"position:absolute;margin: ".toCharArray();
    _jsp_string28 = "','".toCharArray();
    _jsp_string24 = "';\r\n	    		}\r\n	    		//\u4e3b\u4ece\u5e10\u6237\u7279\u6b8a\u5904\u7406 by alan for TD10156\r\n	    		if(response_flag=='3') {\r\n	    			flag_msg = '".toCharArray();
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string0 = " \r\n<!-- Added by wcd 2015-03-25 [\u79fb\u52a8\u7b7e\u5230-\u5730\u56fe\u89c6\u56fe] -->\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string75 = "\">\r\n						<div id=\"right\" class=\"img ".toCharArray();

...
public class _timeviewcontent__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.write(_jsp_string134, 0, _jsp_string134.length);
      out.print((resourceInfo.getResourcename((String)entry.getKey())));
      out.write(_jsp_string148, 0, _jsp_string148.length);
      out.print((SystemEnv.getHtmlLabelNames("557,20032,264",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/mobile/signin/timeViewContent.jsp"), 3622028309751936259L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string134 = "');\" onclick=\"pointerXY(event);\">".toCharArray();
    _jsp_string98 = "\r\n		return false;\r\n		".toCharArray();
    ...
    _jsp_string140 = "\" onclick=\"return blowUpImage(this);\"><img src=\"/weaver/weaver.file.FileDownload?fileid=".toCharArray();

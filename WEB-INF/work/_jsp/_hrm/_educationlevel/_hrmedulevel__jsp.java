...
package _jsp._hrm._educationlevel;
...
public class _hrmedulevel__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelName(26473,user.getLanguage())+SystemEnv.getHtmlLabelName(818,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelName(82,user.getLanguage())+SystemEnv.getHtmlLabelName(818,user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((xssUtil.put("where operateitem=80 and relatedid=")));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((xssUtil.put("where operateitem=80")));
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(818,user.getLanguage()) + SystemEnv.getHtmlLabelName(195,user.getLanguage())));
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(818,user.getLanguage()) + SystemEnv.getHtmlLabelName(433,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
...
tableString =" <table pageId=\""+PageIdConst.HRM_JobCall+"\" tabletype=\""+tabletype+"\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.HRM_JobCall,user.getUID(),PageIdConst.HRM)+"\" >"+
    ...
    " </table>";
      ...
      out.print(( PageIdConst.HRM_JobCall ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/educationlevel/HrmEduLevel.jsp"), -2941514492174081332L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string156 = "\" class=\"e8_btn_submit\" onclick=\"onBtnSearchClick();\"/>\r\n				<input type=\"button\" value=\"".toCharArray();

...
package _jsp._hrm._attendance._paidleave;
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.hrm.attendance.manager.HrmPaidLeaveSetManager paidLeaveSetManager;
      paidLeaveSetManager = (weaver.hrm.attendance.manager.HrmPaidLeaveSetManager) pageContext.getAttribute("paidLeaveSetManager");
      if (paidLeaveSetManager == null) {
        paidLeaveSetManager = new weaver.hrm.attendance.manager.HrmPaidLeaveSetManager();
        pageContext.setAttribute("paidLeaveSetManager", paidLeaveSetManager);
      }
	...
	bean = bean == null ? new HrmPaidLeaveSet() : bean;
      ...
      out.print((SystemEnv.getHtmlLabelName(21765,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelNames("18240,15242",user.getLanguage())));
...
if(userightmenu!=1){
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              if (_jsp_ItemTag_2 == null) {
                ...
                _jsp_ItemTag_2.setAttributes("{'samePair':'field002Item'}");
              }
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(82838,user.getLanguage())));
              ...
              do {
                ...
                if (_jsp_RequiredTag_3 == null) {
                  ...
                  _jsp_RequiredTag_3.setId("field003Span");
                }

                _jsp_RequiredTag_3.setRequired(String.valueOf(bean.getField003()).length() == 0);
                ...
                if (_jspEval15 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  do {
                    ...
                    out.print((bean.getField003() < 0 ? 365 : bean.getField003()));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/attendance/paidLeave/content.jsp"), 5566072888977148927L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string153 = "\r\n							<input class=\"inputstyle\" type=\"text\" maxlength=\"30\" style=\"width:120px\" name=\"field003\" onKeyPress=\"ItemCount_KeyPress()\" onBlur='checknumber(\"field003\");checkinput(\"field003\",\"field003Span\");' onchange='checkinput(\"field003\",\"field003Span\");' value=\"".toCharArray();
    _jsp_string133 = "\"></td>\r\n							".toCharArray();

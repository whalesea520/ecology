...
public class _wffields__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.hrm.attendance.manager.HrmAttProcFieldsManager attProcFieldsManager;
      attProcFieldsManager = (weaver.hrm.attendance.manager.HrmAttProcFieldsManager) pageContext.getAttribute("attProcFieldsManager");
      if (attProcFieldsManager == null) {
        attProcFieldsManager = new weaver.hrm.attendance.manager.HrmAttProcFieldsManager();
        pageContext.setAttribute("attProcFieldsManager", attProcFieldsManager);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
	...
	if(bean.isHAF() && relationList.size() == 0) {
      ...
      out.print((checkFields.toString()));
...
if(userightmenu!=1){
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelNames(fBean.getField003(), user.getLanguage())));
              ...
              do {
                ...
                out.print((wfBean.getFieldname()+"___"+wfBean.getId()));
                out.write(_jsp_string154, 0, _jsp_string154.length);
                out.print((selectFieldName.length() > 0 && selectFieldName.equals(wfBean.getFieldname()) ? "selected" : ""));
                out.write('>');
                out.print((wfBean.getLabelName()));
                ...
                out.print((fBean.getField010() == 1 && selectFieldName.length() == 0 ? "" : "none"));
                out.write(_jsp_string159, 0, _jsp_string159.length);
                out.print((SystemEnv.getHtmlLabelNames(fBean.getField005Title(),user.getLanguage())));
                out.write(_jsp_string160, 0, _jsp_string160.length);
                out.print((fBean.getId()));
                out.write(_jsp_string161, 0, _jsp_string161.length);
                out.print((fBean.getId()));
                out.write(_jsp_string150, 0, _jsp_string150.length);
                out.print((fBean.getField005()));
                out.write(_jsp_string150, 0, _jsp_string150.length);
                out.print((fBean.getField006()));
                out.write(_jsp_string151, 0, _jsp_string151.length);
                out.print((isDisabled ? "disabled" : ""));
                out.write(_jsp_string162, 0, _jsp_string162.length);
                out.print((SystemEnv.getHtmlLabelName(82481,user.getLanguage())));
                out.write(_jsp_string146, 0, _jsp_string146.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/attendance/hrmAttProcSet/wfFields.jsp"), -831254840249396496L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string69 = "&languageid=".toCharArray();
    ...
    _jsp_string157 = "\" class=\"img".toCharArray();
    ...
    _jsp_string160 = "\" /></span>\r\n							<input type=\"checkbox\" name=\"checkbox".toCharArray();
    ...
    _jsp_string158 = "\" style=\"display:".toCharArray();
    _jsp_string144 = "\">\r\n				".toCharArray();
    ...
    _jsp_string159 = "\"><img align='absmiddle' src='/images/BacoError_wev8.gif'></span>\r\n							<span style=\"padding-left:15px\"><img src=\"/wechat/images/remind_wev8.png\" align=\"absMiddle\" title=\"".toCharArray();
    ...
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string161 = "\" value=1 onclick=\"resetValue(this, '".toCharArray();
    ...
    _jsp_string149 = "\" class=\"inputStyle\" style=\"width:50%\" onchange=\"changeImg(this, 'img".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();

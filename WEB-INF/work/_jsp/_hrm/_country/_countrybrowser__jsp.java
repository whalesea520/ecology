...
public class _countrybrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelNames("377",user.getLanguage())));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/country/CountryBrowser.jsp"), 1106233517107519144L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string85 = "<input class=inputstyle name=countryname value='".toCharArray();
    _jsp_string87 = "<input class=inputstyle name=countrydesc value='".toCharArray();

...
public class _hrmshowcol__jsp extends com.caucho.jsp.JavaPage
{
...
for(int i=0;i<scopeIds.length;i++){
	...
	if(scopeId==-1){
		...
		labelid = 15688;
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(labelid,user.getLanguage()) );
  	...
  	if(fieldname.equals("workcode")){
              ...
              do {
                ...
                out.print((htSystemid.get("id") ));
                out.write(_jsp_string141, 0, _jsp_string141.length);
                out.print((lsFieldChecked.contains("id")?"checked":"" ));
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(547,user.getLanguage()) ));
                out.write(_jsp_string144, 0, _jsp_string144.length);
                out.print((lsFieldChecked.contains("id")?htSystemOrder.get("id"):"" ));
              ...
              do {
                ...
                out.print((htSystemid.get("subcompanyid1") ));
                out.write(_jsp_string141, 0, _jsp_string141.length);
                out.print((lsFieldChecked.contains("subcompanyid1")?"checked":"" ));
                out.write(_jsp_string142, 0, _jsp_string142.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                out.print((lsFieldChecked.contains("subcompanyid1")?htSystemOrder.get("subcompanyid1"):"" ));
                out.write(_jsp_string145, 0, _jsp_string145.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                out.print((htSystemid.get(fieldname) ));
                out.write(_jsp_string141, 0, _jsp_string141.length);
                out.print((lsFieldChecked.contains(fieldname)?"checked":"" ));
                out.write(_jsp_string142, 0, _jsp_string142.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                out.write(_jsp_string143, 0, _jsp_string143.length);
                out.print((SystemEnv.getHtmlLabelName(Util.getIntValue(hfm.getLable()),user.getLanguage()) ));
                ...
                out.print((lsFieldChecked.contains(fieldname)?htSystemOrder.get(fieldname):"" ));
                out.write(_jsp_string145, 0, _jsp_string145.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
...
fieldname = "seclevel";
      ...
      int _jspEval46 = _jsp_ViewTag_3.doStartTag();
      if (_jspEval46 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval46 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_3.setBodyContent(_jsp_endTagHack44);
        ...
        do {
          ...
          int _jspEval49 = _jsp_GroupTag_4.doStartTag();
          if (_jspEval49 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval49 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_4.setBodyContent(_jsp_endTagHack47);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/hrmShowCol.jsp"), 8064755954235409247L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string135 = "\" class=\"e8_btn_top\" onclick=\"saveShowColInfo();\">\r\n			<span title=\"".toCharArray();
    _jsp_string102 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string138 = "\r\n	".toCharArray();
    ...
    _jsp_string47 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string146 = "<input name=\"subcompanyid1\" type=\"checkbox\" value='".toCharArray();
    ...
    _jsp_string143 = "\r\n			<table style=\"width: 100%\">\r\n				<tr>\r\n					<td style=\"width: 25%\">".toCharArray();
    _jsp_string161 = "\" id=\"zd_btn_submit\" class=\"zd_btn_submit\" onclick=\"saveShowColInfo();\">\r\n					<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string145 = "\" onkeyup=\"this.value=this.value.replace(/\\D/g,'')\" onblur=\"this.value=this.value.replace(/\\D/g,'')\"></td>\r\n				</tr>\r\n			</table>\r\n		".toCharArray();
    ...
    _jsp_string156 = "\" onkeyup=\"this.value=this.value.replace(/\\D/g,'')\" onblur=\"this.value=this.value.replace(/\\D/g,'')\"></td>\r\n				</tr>\r\n			</table>\r\n	".toCharArray();
    ...
    _jsp_string153 = "<input name=\"".toCharArray();
    _jsp_string60 = ")\">\r\n".toCharArray();
    ...
    _jsp_string148 = "<input name='".toCharArray();
    _jsp_string122 = "\"></td>\r\n							".toCharArray();
    ...
    _jsp_string147 = "</td>\r\n					<td style=\"width: 75%\"><input style=\"width: 100px\" id=\"subcompanyid1_index\" name=\"subcompanyid1_index\" type=\"text\" value=\"".toCharArray();
    ...
    _jsp_string144 = "</td>\r\n					<td style=\"width: 75%\"><input style=\"width: 100px\" id=\"id_index\" name=\"id_index\" type=\"text\" value=\"".toCharArray();
    ...
    _jsp_string149 = "' type=\"checkbox\" value='".toCharArray();
    _jsp_string24 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string152 = "_index\" type=\"text\" value=\"".toCharArray();
    _jsp_string159 = "\r\n				".toCharArray();
    _jsp_string66 = "\r\n<BODY>\r\n<div class=\"zDialog_div_content\" style=\"overflow-x:hidden;\">\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string140 = "<input name=\"id\" type=\"checkbox\" value='".toCharArray();
    ...
    _jsp_string162 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.close();\">\r\n	    ".toCharArray();
    ...
    _jsp_string39 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string150 = "</td>\r\n					<td style=\"width: 75%\"><input style=\"width: 100px\" id=\"".toCharArray();
    ...
    _jsp_string142 = " onclick=\"jsChangeOrder(this)\">".toCharArray();
    ...
    _jsp_string92 = "px\">\r\n</iframe>\r\n</div>\r\n".toCharArray();
    _jsp_string151 = "_index\" name=\"".toCharArray();
    ...
    _jsp_string154 = "\" type=\"checkbox\" value=\"".toCharArray();
    _jsp_string0 = "\r\n\r\n".toCharArray();

...
public class _hrmschedulediffleaveearlydetail__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
    ...
    if(!ruleid.equals("")){
      ...
      out.print((SystemEnv.getHtmlLabelName(81528,user.getLanguage())));
      out.write(_jsp_string76, 0, _jsp_string76.length);
      out.print((SystemEnv.getHtmlLabelNames("367,81524",user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      _jsp_SplitPageTag_0.setTableString(table.toString());
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/report/schedulediff/HrmScheduleDiffLeaveEarlyDetail.jsp"), 9160788454104610082L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string67 = "');\r\n			});\r\n			function exportExcel(){\r\n				document.getElementById(\"excels\").src = \"HrmScheduleDiffReportExcel.jsp?cmd=HrmScheduleDiffLeaveEarlyDetail&tnum=20089&fromDate=".toCharArray();
    ...
    _jsp_string154 = "\" class=\"e8_btn_cancel\" onclick=\"parentDialog.close();\">\r\n					".toCharArray();
    ...
    _jsp_string73 = "&isRule=".toCharArray();
    ...
    _jsp_string3 = "\r\n	<script language=\"javascript\">\r\n		window.top.Dialog.alert(\"".toCharArray();
    _jsp_string74 = "&ruleid=".toCharArray();
    ...
    _jsp_string151 = "\r\n				".toCharArray();
    _jsp_string71 = "&departmentId=".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string70 = "&resourceId=".toCharArray();
    _jsp_string68 = "&toDate=".toCharArray();

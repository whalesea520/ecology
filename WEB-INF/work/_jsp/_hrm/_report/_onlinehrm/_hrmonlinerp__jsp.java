...
public class _hrmonlinerp__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              if (_jsp_ItemTag_3 == null) {
                ...
                _jsp_ItemTag_3.setAttributes("{'samePair':'rang_tr'}");
              }
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(31300,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(129082, user.getLanguage())));
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(31301,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(31302,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
      ...
      out.print((SystemEnv.getHtmlLabelName(15539,user.getLanguage())+SystemEnv.getHtmlLabelName(31303,user.getLanguage())));
      out.write(_jsp_string162, 0, _jsp_string162.length);
      out.print((SystemEnv.getHtmlLabelName(15541,user.getLanguage())+SystemEnv.getHtmlLabelName(31303,user.getLanguage())));
      out.write(_jsp_string163, 0, _jsp_string163.length);
      out.print((SystemEnv.getHtmlLabelName(31299,user.getLanguage())+SystemEnv.getHtmlLabelName(31303,user.getLanguage())));
      out.write(_jsp_string164, 0, _jsp_string164.length);
      out.print((SystemEnv.getHtmlLabelName(15384,user.getLanguage())+SystemEnv.getHtmlLabelName(31303,user.getLanguage())));
      out.write(_jsp_string165, 0, _jsp_string165.length);
      out.print((SystemEnv.getHtmlLabelName(21904,user.getLanguage())+SystemEnv.getHtmlLabelName(31303,user.getLanguage())));
      out.write(_jsp_string166, 0, _jsp_string166.length);
      out.print((SystemEnv.getHtmlLabelName(31304,user.getLanguage())));
      out.write(_jsp_string167, 0, _jsp_string167.length);
      out.print((SystemEnv.getHtmlLabelName(31305,user.getLanguage())));
      out.write(_jsp_string168, 0, _jsp_string168.length);
      out.print((hrmnumber));
      out.write(_jsp_string169, 0, _jsp_string169.length);
      out.print((concurrentFlag));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/report/onlineHrm/HrmOnlineRp.jsp"), 5752478049010263955L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string162 = "\",\"spline\");\r\n						checkLineReport(data.columnData,\"\",\"column\"); \r\n					}else if (itemType == \"month\"){\r\n						checkLineReport(data.splineData,\"".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string174 = "\");   //\u9875\u9762\u52a0\u8f7d\u4e2d\uff0c\u8bf7\u7a0d\u5019...\r\n				   else if(flag==\"data\")\r\n					  jQuery(\"#loadingMsg\").html(\"".toCharArray();
    _jsp_string173 = "\");   //\u6b63\u5728\u4fdd\u5b58\uff0c\u8bf7\u7a0d\u7b49...\r\n				   else if(flag==\"page\")\r\n					  jQuery(\"#loadingMsg\").html(\"".toCharArray();
    ...
    _jsp_string141 = "\r\n			<input id=\"serverip\" name=\"serverip\" type=\"hidden\" value=\"".toCharArray();
    ...
    _jsp_string136 = "\r\n					<input type=button class=\"e8_btn_top\" onclick=\"OnSearch();\" value=\"".toCharArray();
    _jsp_string164 = "\",\"spline\");\r\n						checkLineReport(data.columnData,\"\",\"column\");\r\n					}else if(itemType == \"year\"){\r\n						checkLineReport(data.splineData,\"".toCharArray();
    ...
    _jsp_string155 = "\r\n					<label id=\"maxNum\"></label>\r\n					<label id=\"tips\" style=\"display: none;color: red;\">&nbsp;&nbsp;(".toCharArray();
    _jsp_string74 = "	\r\n		\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();

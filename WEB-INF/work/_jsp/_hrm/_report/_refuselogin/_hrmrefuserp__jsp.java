...
public class _hrmrefuserp__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              if (_jsp_ItemTag_2 == null) {
                ...
                _jsp_ItemTag_2.setAttributes("{'samePair':'rang_tr'}");
              }
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(31316,user.getLanguage())));
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(129083, user.getLanguage())));
              ...
              _jsp_ItemTag_3.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(31317,user.getLanguage())));
              } while (_jsp_ItemTag_3.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_3.doEndTag();
      ...
      out.print((SystemEnv.getHtmlLabelName(15539,user.getLanguage())+SystemEnv.getHtmlLabelName(31323,user.getLanguage())));
      out.write(_jsp_string151, 0, _jsp_string151.length);
      out.print((SystemEnv.getHtmlLabelName(15541,user.getLanguage())+SystemEnv.getHtmlLabelName(31323,user.getLanguage())));
      out.write(_jsp_string152, 0, _jsp_string152.length);
      out.print((SystemEnv.getHtmlLabelName(31299,user.getLanguage())+SystemEnv.getHtmlLabelName(31319,user.getLanguage())));
      out.write(_jsp_string153, 0, _jsp_string153.length);
      out.print((SystemEnv.getHtmlLabelName(15384,user.getLanguage())+SystemEnv.getHtmlLabelName(31323,user.getLanguage())));
      out.write(_jsp_string154, 0, _jsp_string154.length);
      out.print((SystemEnv.getHtmlLabelName(21904,user.getLanguage())+SystemEnv.getHtmlLabelName(31323,user.getLanguage())));
      out.write(_jsp_string155, 0, _jsp_string155.length);
      out.print((SystemEnv.getHtmlLabelName(31321,user.getLanguage())));
      out.write(_jsp_string156, 0, _jsp_string156.length);
      out.print((SystemEnv.getHtmlLabelName(31320,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/report/refuseLogin/HrmRefuseRp.jsp"), 1653509669976140497L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string72 = "\";\r\n        dialog.Width = 550 ;\r\n        dialog.Height = 600;\r\n        dialog.Drag = true;\r\n        dialog.show();\r\n    });\r\n\r\n}\r\n</script>\r\n		\r\n\r\n\r\n".toCharArray();
    _jsp_string153 = "\",\"spline\",itemType);\r\n						checkLineReport(data.columnData,\"\",\"column\",itemType);\r\n					}else if(itemType == \"year\"){\r\n						checkLineReport(data.splineData,\"".toCharArray();
    ...
    _jsp_string156 = "\";\r\n				var seriesName=itemType==\"day\"?\"".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string164 = "\");   //\u9875\u9762\u52a0\u8f7d\u4e2d\uff0c\u8bf7\u7a0d\u5019...\r\n				   else if(flag==\"data\")\r\n					  jQuery(\"#loadingMsg\").html(\"".toCharArray();
    _jsp_string163 = "\");   //\u6b63\u5728\u4fdd\u5b58\uff0c\u8bf7\u7a0d\u7b49...\r\n				   else if(flag==\"page\")\r\n					  jQuery(\"#loadingMsg\").html(\"".toCharArray();
    ...
    _jsp_string154 = "\",\"spline\",itemType);\r\n						checkLineReport(data.columnData,\"\",\"column\",itemType);\r\n					}else if(itemType == \"quarter\"){\r\n						checkLineReport(data.splineData,\"".toCharArray();
    _jsp_string144 = ")</label>\r\n				".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string152 = "\",\"spline\",itemType);\r\n						checkLineReport(data.columnData,\"\",\"column\",itemType);\r\n					}else if(itemType == \"day\"){\r\n						checkLineReport(data.splineData,\"".toCharArray();
    _jsp_string107 = ";\r\n	".toCharArray();

...
public class _hrmrpresourcesalarysum__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.hrm.finance.SalaryComInfo SalaryComInfo;
      SalaryComInfo = (weaver.hrm.finance.SalaryComInfo) pageContext.getAttribute("SalaryComInfo");
      if (SalaryComInfo == null) {
        SalaryComInfo = new weaver.hrm.finance.SalaryComInfo();
        pageContext.setAttribute("SalaryComInfo", SalaryComInfo);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
          ...
          if (_jspEval6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/hrm/company/MutiDepartmentBrowser.jsp");
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(15842,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(15933,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_4.setAttributes("{'samePair':'hiddenItem'}");
      ...
      out.print((isself.equals("1")&&(!"".equals(startdatefrom)||!"".equals(startdateto)||!"".equals(departmentid)) ? "" : "display:none"));
      ...
      int _jspEval43 = _jsp_ViewTag_0.doStartTag();
      if (_jspEval43 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval43 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_0.setBodyContent(_jsp_endTagHack41);
          _jsp_ViewTag_0.doInitBody();
        }
        do {
          out.write(_jsp_string161, 0, _jsp_string161.length);
          ...
          int _jspEval46 = _jsp_GroupTag_1.doStartTag();
          if (_jspEval46 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval46 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_1.setBodyContent(_jsp_endTagHack44);
              _jsp_GroupTag_1.doInitBody();
            }
            do {
              out.write(_jsp_string138, 0, _jsp_string138.length);
              ...
              do {
                ...
                out.print((DepartmentComInfo.getDepartmentname(rs1.getString("id"))));
                out.write(_jsp_string165, 0, _jsp_string165.length);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/report/HrmRpResourceSalarySum.jsp"), -4397442784022414810L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string48 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string177 = "</td>\r\n						   <td style=\"TEXT-ALIGN:left;TEXT-VALIGN:middle\"><nobr>".toCharArray();
    ...
    _jsp_string164 = "\r\n					<TABLE class=ListStyle cellspacing=1 >\r\n					  <TBODY>\r\n					  <tr class=header>\r\n					  <TH width=\"10%\" rowspan=2 style=\"TEXT-ALIGN:left;TEXT-VALIGN:middle\"><nobr>".toCharArray();
    _jsp_string73 = "\r\n\r\n\r\n		".toCharArray();
    ...
    _jsp_string143 = "selected".toCharArray();
    _jsp_string155 = "\">\r\n						<input class=inputstyle type=hidden name=movedate id=movedate value=\"\">\r\n						<input  class=inputstyle type=hidden name=currentdate id=currentdate value=\"".toCharArray();
    ...
    _jsp_string169 = "\r\n					   <TH width=\"5%\" style=\"TEXT-ALIGN:left\"><nobr>".toCharArray();
    _jsp_string175 = "\r\n						   <td style=\"TEXT-ALIGN:left;TEXT-VALIGN:middle\"><nobr>".toCharArray();
    _jsp_string123 = "\"></td>\r\n							".toCharArray();
    _jsp_string46 = ";\r\nusbserial0 = \"".toCharArray();
    _jsp_string167 = "\r\n					   <TH colspan=2 style=\"TEXT-ALIGN:left\"><nobr>".toCharArray();
    _jsp_string184 = "\r\n					  </tr>\r\n					  </TBODY>\r\n					 </TABLE>\r\n				".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string154 = "\r\n						<input  class=inputstyle type=hidden name=year id=year value=\"".toCharArray();
    ...
    _jsp_string180 = "\r\n					   <TH width=\"10%\" style=\"TEXT-ALIGN:left;TEXT-VALIGN:middle\"><nobr>".toCharArray();
    _jsp_string179 = "\r\n					<tr class=header>\r\n					  <TH width=\"10%\" style=\"TEXT-ALIGN:right;TEXT-VALIGN:middle\"><nobr>".toCharArray();
    ...
    _jsp_string181 = "\r\n					   <TH style=\"TEXT-ALIGN:left;TEXT-VALIGN:middle\"><nobr>".toCharArray();
    _jsp_string166 = "\r\n					   <TH width=\"10%\" rowspan=2 style=\"TEXT-ALIGN:left;TEXT-VALIGN:middle\"><nobr>".toCharArray();
    ...
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string159 = "\"  style=\"height:24px;border:none;border-left:none;width:23px;_width:25px;\">\r\n								</div>\r\n							</div>\r\n						</div>\r\n					".toCharArray();
    _jsp_string108 = ";\r\n	".toCharArray();

...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	String needhelp ="";
      ...
      out.print((SystemEnv.getHtmlLabelNames("33401",user.getLanguage())));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/roles/HrmRolesBrowser.jsp"), 3217561049854306942L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string97 = "</A></TD>\r\n	<TD style=\"padding:0px 5px 0px 12px\">".toCharArray();
    ...
    _jsp_string87 = " \r\n			  <input class=inputstyle name=rolesname value=\"".toCharArray();
    ...
    _jsp_string85 = " \r\n			  <input class=inputstyle name=rolesmark value=\"".toCharArray();

...
public class _hrmrolesfucrightset__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	String otherGroupName = Util.null2String(rs.getString("rightgroupname"));
      ...
      out.print((SystemEnv.getHtmlLabelName(611,user.getLanguage())+SystemEnv.getHtmlLabelName(17864,user.getLanguage())));
      out.write(_jsp_string72, 0, _jsp_string72.length);
      out.print((detachable));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((id));
      out.write(_jsp_string73, 0, _jsp_string73.length);
      out.print((SystemEnv.getHtmlLabelName(93,user.getLanguage())+SystemEnv.getHtmlLabelName(17864,user.getLanguage())));
      ...
      out.print((xssUtil.put("where operateitem=102 and relatedid=")));
      out.write(_jsp_string78, 0, _jsp_string78.length);
      out.print((xssUtil.put("where operateitem=102")));
...
if(userightmenu!=1){
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(492,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/roles/HrmRolesFucRightSet.jsp"), -3642003656412814453L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string76 = "\",function(){\r\n					var idArr = id.split(\",\");\r\n					var ajaxNum = 0;\r\n					for(var i=0;i<idArr.length;i++){\r\n						ajaxNum++;\r\n						jQuery.ajax({\r\n							url:\"HrmRoleRightOperation.jsp?isdialog=1&operationType=deleteRoleRight&cmd=selectId&roleId=".toCharArray();
    ...
    _jsp_string163 = "<input type=\"text\" id=\"roleName\" name=\"roleName\" class=\"inputStyle\" value=\"\">".toCharArray();
    ...
    _jsp_string169 = "<input type=\"text\" id=\"groupName\" name=\"groupName\" class=\"inputStyle\" value=\"\">".toCharArray();
    ...
    _jsp_string160 = "\" class=\"cornerMenu\"></span>\r\n					</td>\r\n				</tr>\r\n			</table>\r\n			<div class=\"advancedSearchDiv\" id=\"advancedSearchDiv\" style=\"display:none;\" >\r\n				".toCharArray();
    ...
    _jsp_string80 = "\",jQuery(window).width(),jQuery(window).height());\r\n			}\r\n		</script>\r\n	</head>\r\n	<BODY>\r\n		".toCharArray();
    ...
    _jsp_string70 = "&isdialog=1&id=".toCharArray();
    _jsp_string55 = "/skins/".toCharArray();
    _jsp_string172 = "\" class=\"e8_btn_cancel\" onclick=\"resetCondtion();\"/>\r\n							<input type=\"button\" value=\"".toCharArray();
    _jsp_string104 = ");\r\n			}\r\n		}catch(e){}\r\n		".toCharArray();
    ...
    _jsp_string72 = "\",700,600);\r\n			}\r\n			\r\n			function doEdit(id){\r\n				doOpen(\"/hrm/HrmDialogTab.jsp?_fromURL=hrmRolesAuth&method=HrmRoleRightEdit&detachable=".toCharArray();
    ...
    _jsp_string69 = "\";\r\n				parentWin.closeDialog();	\r\n			}\r\n			\r\n			function doAdd(){\r\n				doOpen(\"/hrm/HrmDialogTab.jsp?_fromURL=hrmRolesAuth&method=HrmRoleRightAdd&detachable=".toCharArray();
    _jsp_string153 = "\">\r\n			<input type=hidden name=\"detachable\" value=\"".toCharArray();
    _jsp_string73 = "&rightid=\"+id,\"".toCharArray();
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    ...
    _jsp_string182 = "\" class=\"e8_btn_cancel\" onclick=\"parentDialog.close();\">\r\n		    	".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();

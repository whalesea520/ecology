...
public class _hrmresourcenewroles__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(16527,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(24055, user.getLanguage())));
              ...
              do {
                ...
                _jsp_BrowserTag_3.setName("rolesid");
                _jsp_BrowserTag_3.setBrowserValue("");
                _jsp_BrowserTag_3.setWidth("150px");
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/hrm/roles/MutiRolesBrowser.jsp");
          ...
          _jsp_GroupTag_4.setContext(SystemEnv.getHtmlLabelName(24055, user.getLanguage()));
	...
	tableString =" <table instanceid=\"rolesMembersTable\" tabletype=\"checkbox\" pagesize=\""+perpage+"\" >"+
	    ...
	    " </table>";
                ...
                int _jsp_end_32 = _jsp_SplitPageTag_6.doEndTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/roles/HrmResourceNewRoles.jsp"), -5846513796450690869L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

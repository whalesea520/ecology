...
public class _wfset__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.hrm.pm.manager.HrmStateProcActionManager stateProcActionManager;
      stateProcActionManager = (weaver.hrm.pm.manager.HrmStateProcActionManager) pageContext.getAttribute("stateProcActionManager");
      if (stateProcActionManager == null) {
        stateProcActionManager = new weaver.hrm.pm.manager.HrmStateProcActionManager();
        pageContext.setAttribute("stateProcActionManager", stateProcActionManager);
      }
	...
	for(int i=0; i<(list==null?0:list.size());i++) {
      ...
      out.print((String.valueOf(sBean.getField001())));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((bean.getField002()+"_field006"));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((bean.getField002()+"_field005"));
      out.write(_jsp_string149, 0, _jsp_string149.length);
      out.print((SystemEnv.getHtmlLabelNames(bean.getField003(),user.getLanguage())));
      ...
      _jsp_BrowserTag_0.setWidth("100%");
      ...
      _jsp_BrowserTag_0.setCompleteUrl("javascript:getCompleteUrl(currentId)");
      _jsp_BrowserTag_0.setName(bean.getField002()+"_field006");
      _jsp_BrowserTag_0.setBrowserValue(bean.getField006().equals("-1") || bean.getField006().equals("0") ? "" : String.valueOf(bean.getField006()));
      _jsp_BrowserTag_0.setBrowserSpanValue(bean.getField006().equals("-1") || bean.getField006().equals("0") ? "" : String.valueOf(bean.getField006Name()));
      _jsp_BrowserTag_0.setGetBrowserUrlFnParams(bean.getField002()+"_field005");
      _jsp_BrowserTag_0.doTag();
      out.write(_jsp_string158, 0, _jsp_string158.length);
      out.print((String.valueOf(bean.getField007())));
      out.write(_jsp_string159, 0, _jsp_string159.length);
      out.print((bean.getField002()+"_field007"));
      out.write(_jsp_string160, 0, _jsp_string160.length);
      out.print((bean.getField002()+"_field007"));
      out.write(_jsp_string161, 0, _jsp_string161.length);
      out.print((bean.getField007() == 1 ? "checked" : ""));
      out.write(_jsp_string162, 0, _jsp_string162.length);
      out.print((bean.getField002()+"_field003"));
      out.write(_jsp_string160, 0, _jsp_string160.length);
      out.print((bean.getField002()+"_field003"));
      out.write(_jsp_string163, 0, _jsp_string163.length);
      out.print((bean.getField003()));
      out.write(_jsp_string164, 0, _jsp_string164.length);
      out.print((bean.getField002()+"_field008"));
      out.write(_jsp_string160, 0, _jsp_string160.length);
      out.print((bean.getField002()+"_field008"));
      out.write(_jsp_string163, 0, _jsp_string163.length);
      out.print((bean.getField008()));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("hrm/pm/hrmStateProcSet/wfSet.jsp"), -8182329278987696973L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string53 = "\r\n".toCharArray();
    _jsp_string171 = "\" class=\"e8_btn_cancel\" onclick=\"parentDialog.closeByHand();\">\r\n					".toCharArray();
    ...
    _jsp_string152 = "' notBeauty=\"true\" onchange=\"clearLinkOrNode(this, '".toCharArray();
    _jsp_string29 = "')) {\r\n				    lenck = false;\r\n				    break;\r\n			    }\r\n		    }\r\n		    if(lenck==false) return false;\r\n	    }\r\n	    catch(e) {}\r\n	    ".toCharArray();
    _jsp_string149 = "\";</script>\r\n					<tr class=\"DataLight\">\r\n						<td nowrap>".toCharArray();

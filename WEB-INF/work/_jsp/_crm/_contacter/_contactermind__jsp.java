...
public class _contactermind__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(81294, user.getLanguage())));
      out.write(_jsp_string140, 0, _jsp_string140.length);
      out.print((customerId));
      out.write(_jsp_string141, 0, _jsp_string141.length);
      out.print((SystemEnv.getHtmlLabelName(31229, user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/contacter/contacterMind.jsp"), -4939499223830917580L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string141 = "\";\r\n			dialog.Title = \"".toCharArray();
    _jsp_string139 = "+\"&parentid=\"+parentid+\"&direction=\"+direction;\r\n		dialog.Title = \"".toCharArray();
    ...
    _jsp_string140 = "\";\r\n		dialog.Width = 420;\r\n		dialog.Height =420;\r\n		dialog.Drag = true;\r\n		dialog.URL = url;\r\n		dialog.show();\r\n	}\r\n	\r\n	function editContacter(){\r\n		var node = _jm.get_selected_node();\r\n		if(null == node){\r\n			window.top.Dialog.alert(\"\u8bf7\u9009\u4e2d\u8054\u7cfb\u4eba\u540e\u53f3\u952e\u7f16\u8f91\uff01\");\r\n		}else{\r\n			dialog = new window.top.Dialog();\r\n			dialog.currentWindow = window;\r\n			var contacterId = _jm.get_selected_node().id;\r\n			var url = \"/CRM/contacter/contacterMindNew.jsp?contacterId=\"+contacterId+\"&customerId=\"+\"".toCharArray();

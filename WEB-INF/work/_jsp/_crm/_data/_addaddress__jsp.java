...
public class _addaddress__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.conn.RecordSet RecordSetFF;
      RecordSetFF = (weaver.conn.RecordSet) pageContext.getAttribute("RecordSetFF");
      if (RecordSetFF == null) {
        RecordSetFF = new weaver.conn.RecordSet();
        pageContext.setAttribute("RecordSetFF", RecordSetFF);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
RCMenuHeight += RCMenuHeightStep ;
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("customer")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(110 ,user.getLanguage())+SystemEnv.getHtmlLabelName(87 ,user.getLanguage()), null), false);
      out.write(_jsp_string2, 0, _jsp_string2.length);
	...
	while(rs.next()){
		...
		if(0 == groupcount){
          ...
          _jsp_GroupTag_3.setContext(SystemEnv.getHtmlLabelName(rs.getInt("grouplabel"),user.getLanguage()));
          ...
          if (_jspEval17 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((comInfo.getFieldname().equals("district")?"citytwo":comInfo.getFieldname() ));
                out.write(_jsp_string93, 0, _jsp_string93.length);
                out.print((comInfo.getFieldname() ));
              ...
              _jsp_ItemTag_4.doInitBody();
              do {
                out.print((CrmUtil.getHtmlElementSetting(comInfo ,"", user)));
              } while (_jsp_ItemTag_4.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_4.doEndTag();
      ...
      int _jspEval38 = _jsp_ViewTag_5.doStartTag();
      if (_jspEval38 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval38 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_5.setBodyContent(_jsp_endTagHack36);
        ...
        do {
          ...
          int _jspEval41 = _jsp_GroupTag_6.doStartTag();
          if (_jspEval41 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval41 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_6.setBodyContent(_jsp_endTagHack39);
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/data/AddAddress.jsp"), 6777984168199850933L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string151 = "\r\n							".toCharArray();
    _jsp_string126 = "visible".toCharArray();
    ...
    _jsp_string88 = "\">\r\n".toCharArray();
    _jsp_string116 = " oncontextmenu='return false'".toCharArray();
    _jsp_string93 = "\" areaName=\"".toCharArray();
    ...
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string122 = "px\" height=\"".toCharArray();
    ...
    _jsp_string127 = ";display:none;\" align=\"left\"  allowtransparency=\"true\" style=\"background-color:transparent\" >\r\n	</div>\r\n	<div id=\"divRightMenuIframe\" name=\"divRightMenuIframe\" style=\"display:none\">\r\n		<iframe id=\"rightMenuIframe\" name=\"rightMenuIframe\" frameborder=0 marginheight=0 marginwidth=0 hspace=0 vspace=0 scrolling=no width=\"".toCharArray();
    _jsp_string94 = "\" areaValue=\"\" \r\n							areaSpanValue=\"\"  areaMustInput=\"1\"  areaCallback=\"callBack\"  class=\"_areaselect\" id=\"_areaselect_".toCharArray();
    ...
    _jsp_string125 = "hidden".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();

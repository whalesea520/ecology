...
public class _customerframe__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.write('(');
      //=this.getCountByType(-1,null,-1,null,userid) 
      ...
      out.print((SystemEnv.getHtmlLabelName(455,user.getLanguage())+SystemEnv.getHtmlLabelName(343,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/data/CustomerFrame.jsp"), 5120382100852740656L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

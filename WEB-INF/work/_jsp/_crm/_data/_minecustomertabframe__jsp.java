...
public class _minecustomertabframe__jsp extends com.caucho.jsp.JavaPage
{
...
int newCustomerNumber = CustomerStatusCount.getNewCustomerNumber(user.getUID()+"");//\u65b0\u5ba2\u6237\u6570\u91cf
      ...
      out.print((SystemEnv.getHtmlLabelName(6059,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelName(84357,user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      if(newCustomerNumber>0){
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((SystemEnv.getHtmlLabelName(16400,user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      }
      out.write(_jsp_string71, 0, _jsp_string71.length);
      out.print((SystemEnv.getHtmlLabelName(84358,user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/data/MineCustomerTabFrame.jsp"), -6637947256512013270L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string70 = "\r\n						<li>\r\n							<a href=\"\" target=\"tabcontentframe\" _labelid=\"new\">".toCharArray();

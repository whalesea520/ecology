...
public class _viewhrm__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("customer")+ "&" + "navName=" + ("\u4fee\u6539\u4eba\u5458"), false);
      out.write(_jsp_string53, 0, _jsp_string53.length);
      ...
      int _jspEval38 = _jsp_ViewTag_3.doStartTag();
      if (_jspEval38 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval38 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_3.setBodyContent(_jsp_endTagHack36);
          _jsp_ViewTag_3.doInitBody();
        }
        do {
          out.write(_jsp_string138, 0, _jsp_string138.length);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/data/viewHrm.jsp"), -8619371855781536100L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string151 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"parentWin.closeDialog();\">\r\n			".toCharArray();

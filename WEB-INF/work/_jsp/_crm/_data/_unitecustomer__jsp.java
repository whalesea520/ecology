...
public class _unitecustomer__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("customer")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(84367,user.getLanguage()), null), false);
      out.write(_jsp_string2, 0, _jsp_string2.length);
          ...
          if (_jspEval18 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(6074,user.getLanguage())));
              ...
              do {
                ...
                _jsp_BrowserTag_6.setLinkUrl("/CRM/data/ViewCustomer.jsp?CustomerID=");
                _jsp_BrowserTag_6.setWidth("90%");
                _jsp_BrowserTag_6.setBrowserValue(CustomerID);
                _jsp_BrowserTag_6.setBrowserUrl(browserUrl);
                _jsp_BrowserTag_6.setBrowserSpanValue(mainCustomerName);
      ...
      int _jspEval39 = _jsp_ViewTag_8.doStartTag();
      if (_jspEval39 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval39 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_8.setBodyContent(_jsp_endTagHack37);
        ...
        do {
          ...
          int _jspEval42 = _jsp_GroupTag_9.doStartTag();
          if (_jspEval42 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval42 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_9.setBodyContent(_jsp_endTagHack40);
            ...
            do {
              ...
              _jsp_ItemTag_10.setBodyContent(_jsp_endTagHack43);
      ...
      out.print((SystemEnv.getHtmlLabelName(15160,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/data/UniteCustomer.jsp"), -1754383676723555176L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string151 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"parent.getDialog(window).close()\">\r\n			".toCharArray();
    _jsp_string89 = ");\r\n			}\r\n		}catch(e){}\r\n		".toCharArray();

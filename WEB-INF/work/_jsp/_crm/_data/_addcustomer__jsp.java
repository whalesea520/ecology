...
public class _addcustomer__jsp extends com.caucho.jsp.JavaPage
{
...
if(RecordSetFF.getCounts()<=0)
	...
	RecordSetFF.first();
      ...
      out.print(( CrmUtil.getFieldIsMustInfo("CRM_CustomerInfo")));
      ...
      out.print((SystemEnv.getHtmlLabelName(18675,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(84349,user.getLanguage())));
...
if(userightmenu!=1){
	...
	while(rs.next()){
		...
		if(0 == groupcount){
          ...
          if (_jsp_GroupTag_4 == null) {
            ...
            _jsp_GroupTag_4.setAttributes("{'isColspan':'false'}");
          }
          ...
          if (_jspEval17 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jsp_ItemTag_5.doInitBody();
              do {
                out.print((CrmUtil.getHtmlElementSetting(comInfo ,Util.null2String(map.get(comInfo.getFieldname())), user)));
              } while (_jsp_ItemTag_5.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_5.doEndTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/data/AddCustomer.jsp"), -5439450406960933808L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string149 = "\" style=\"font-size: 12px;cursor: pointer;\">\r\n				<input class=\"e8_btn_top middle\" onclick=\"checkSubmit(this)\" type=\"button\" jQuery1392950000546=\"32\" value=\"".toCharArray();
    _jsp_string3 = "\r\n	<script language=\"javascript\">\r\n		window.top.Dialog.alert(\"".toCharArray();

...
public class _getevaluation__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(6072,user.getLanguage())));
      out.write(_jsp_string145, 0, _jsp_string145.length);
      out.print((SystemEnv.getHtmlLabelName(18093,user.getLanguage())));
      out.write(_jsp_string145, 0, _jsp_string145.length);
      out.print((SystemEnv.getHtmlLabelName(6071,user.getLanguage())));
      out.write(_jsp_string145, 0, _jsp_string145.length);
      out.print((SystemEnv.getHtmlLabelName(17506,user.getLanguage())));
...
while(RecordSet.next()){
	...
	if(isLight = !isLight){
      ...
      out.print((EvaluationLevelComInfo.getEvaluationLevellevelvalue()));
      out.write(_jsp_string154, 0, _jsp_string154.length);
      if(checkLevel.equals(EvaluationLevelComInfo.getEvaluationLevellevelvalue())){ 
      out.write(_jsp_string155, 0, _jsp_string155.length);
      }
      out.write(_jsp_string156, 0, _jsp_string156.length);
      out.print((EvaluationLevelComInfo.getEvaluationLevelname()));
      ...
      out.print((SystemEnv.getHtmlLabelName(84356,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(16497,user.getLanguage())));
      out.print((SystemEnv.getHtmlLabelName(15808,user.getLanguage())));
      out.write(_jsp_string170, 0, _jsp_string170.length);
      out.print((SystemEnv.getHtmlLabelName(16328,user.getLanguage())));
      out.print((SystemEnv.getHtmlLabelName(15808,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/data/GetEvaluation.jsp"), -3329730177428743355L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string160 = "</span></td>\r\n		<TD>\r\n			<input type=\"hidden\" name=\"proportion\" id=\"proportion_".toCharArray();
    _jsp_string123 = "\"></td>\r\n							".toCharArray();
    ...
    _jsp_string150 = "</TD>\r\n		<input type=\"hidden\" name=\"evaluationID\" value=\"".toCharArray();
    _jsp_string158 = "\r\n			</select>\r\n		</TD>\r\n		<td><span id=\"point_".toCharArray();
    _jsp_string164 = "\r\n		<td><span id=\"score_".toCharArray();

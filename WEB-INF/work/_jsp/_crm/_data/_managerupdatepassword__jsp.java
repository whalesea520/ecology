...
public class _managerupdatepassword__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      weaver.conn.RecordSet recordGet;
      recordGet = (weaver.conn.RecordSet) pageContext.getAttribute("recordGet");
      if (recordGet == null) {
        recordGet = new weaver.conn.RecordSet();
        pageContext.setAttribute("recordGet", recordGet);
      }
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("customer")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelNames("409",user.getLanguage()) , null), false);
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(502,user.getLanguage())));
                out.write(_jsp_string132, 0, _jsp_string132.length);
              ...
              do {
                ...
                _jsp_RequiredTag_3.setId("passwordoldSpan");
              ...
              do {
                ...
                _jsp_RequiredTag_3.setId("passwordnewSpan");
              ...
              do {
                ...
                _jsp_RequiredTag_3.setId("confirmpasswordSpan");
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(31864, user.getLanguage())));
                out.write(_jsp_string141, 0, _jsp_string141.length);
                out.print((SystemEnv.getHtmlLabelName(31862, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(20172,user.getLanguage())+6+SystemEnv.getHtmlLabelName(17081,user.getLanguage())));
      out.write(_jsp_string151, 0, _jsp_string151.length);
      out.print((SystemEnv.getHtmlLabelName(31865,user.getLanguage())+20+SystemEnv.getHtmlLabelName(17081,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/data/ManagerUpdatePassword.jsp"), -6716147502851003207L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string141 = ";</span><br/>\r\n				<span style=\"padding-left: 30px;\">2\u3001".toCharArray();
    ...
    _jsp_string133 = "\r\n				".toCharArray();
    _jsp_string146 = "\";//type\u4e3amanager\u8868\u793a\u5ba2\u6237\u7ecf\u7406\u64cd\u4f5c\uff0ctype\u4e3acustomer\u8868\u793a\u4e3a\u5ba2\u6237\u64cd\u4f5c\r\n    var prepassword = '".toCharArray();
    ...
    _jsp_string41 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string148 = ",\"passwordnew\":weaver.passwordnew.value},\r\n                function(){\r\n                    alert(\"".toCharArray();

...
public class _addcustomerframe__jsp extends com.caucho.jsp.JavaPage
{
...
String tabtype=Util.null2String(request.getParameter("tabtype"),"add");
      ...
      out.print((tabtype.equals("add")?"current":""));
      out.write(_jsp_string67, 0, _jsp_string67.length);
      out.print((SystemEnv.getHtmlLabelName(2086,user.getLanguage())+SystemEnv.getHtmlLabelName(82,user.getLanguage()) ));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((tabtype.equals("import")?"current":""));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/data/AddCustomerFrame.jsp"), 677333882250180626L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string67 = "\" >\r\n							<a href=\"\" target=\"tabcontentframe\" _datetype=\"add\">".toCharArray();
    ...
    _jsp_string69 = "\">\r\n							<a href=\"\" target=\"tabcontentframe\" _datetype=\"import\">".toCharArray();

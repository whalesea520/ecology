...
public class _customermain__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.crm.customer.CustomerLabelService CustomerLabelService;
      CustomerLabelService = (weaver.crm.customer.CustomerLabelService) pageContext.getAttribute("CustomerLabelService");
      if (CustomerLabelService == null) {
        CustomerLabelService = new weaver.crm.customer.CustomerLabelService();
        pageContext.setAttribute("CustomerLabelService", CustomerLabelService);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
String isEnableExtranetHelp = KtreeHelp.getInstance().isEnableExtranetHelp;
      ...
      out.print((SystemEnv.getHtmlLabelName(136, user.getLanguage())+SystemEnv.getHtmlLabelName(17534, user.getLanguage())));
      out.write(_jsp_string77, 0, _jsp_string77.length);
      if(birthdayCount>0){
      out.write(_jsp_string78, 0, _jsp_string78.length);
      out.print((birthdayCount));
      ...
      out.print((SystemEnv.getHtmlLabelName(84345,user.getLanguage())));
      out.write(_jsp_string89, 0, _jsp_string89.length);
      out.print((SystemEnv.getHtmlLabelNames("82857,25102",user.getLanguage())));
      out.write(_jsp_string90, 0, _jsp_string90.length);
      out.print((SystemEnv.getHtmlLabelNames("82857,575",user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(84346,user.getLanguage())));
      out.write(_jsp_string97, 0, _jsp_string97.length);
      out.print((SystemEnv.getHtmlLabelName(84347,user.getLanguage())));
      ...
      out.print((CustomerStatusComInfo.getCustomerStatusid()));
      out.write(_jsp_string104, 0, _jsp_string104.length);
      out.print((CustomerStatusComInfo.getCustomerStatusname() ));
      out.write(_jsp_string102, 0, _jsp_string102.length);
      }
      ...
      out.print((SectorInfoComInfo.getSectorInfoid()));
      out.write(_jsp_string104, 0, _jsp_string104.length);
      out.print((SectorInfoComInfo.getSectorInfoname()));
      out.write(_jsp_string102, 0, _jsp_string102.length);
      }
      out.write(_jsp_string107, 0, _jsp_string107.length);
      out.print((SystemEnv.getHtmlLabelNames("25397",user.getLanguage())));
      out.write(_jsp_string108, 0, _jsp_string108.length);
      out.print((SystemEnv.getHtmlLabelNames("25422",user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(84348,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/customer/CustomerMain.jsp"), -4319963160805947643L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string84 = "\r\n				<div id=\"resource\" _value=\"".toCharArray();
    ...
    _jsp_string103 = "\r\n						<div class=\"btn_add_type\" onclick=\"doChange(this,'status',".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string100 = "</div><!-- \u5168\u90e8 -->\r\n					<div class=\"btn_add_type\" style=\"display:none;\" onclick=\"markItemAsType(this)\" _markType=\"unread\">".toCharArray();
    ...
    _jsp_string81 = "\" type=button class=\"btn_top\" style=\"background:url('/CRM/images/icon_remind_wev8.png') no-repeat left;\" _type=\"remind\" onmouseover=\"doMouseover(this)\" onmouseout=\"doMouseout(this)\" onclick=\"openFullWindowHaveBar('/CRM/report/ContactFrame.jsp?tabtype=remind')\">\r\n							 	<div class=\"btndiv\"></div>\r\n							 	".toCharArray();
    ...
    _jsp_string76 = "\"  type=button class=\"btn_top\" style=\"background:url('/CRM/images/icon_import_wev8.png') no-repeat left;\" _type=\"import\" onmouseover=\"doMouseover(this)\" onmouseout=\"doMouseout(this)\" onclick=\"openFullWindowHaveBar('/CRM/data/AddCustomerFrame.jsp?tabtype=import')\">\r\n							 	<div class=\"btndiv\"></div>\r\n							 	<div style=\"clear:both;\"></div>\r\n							</button>\r\n						</span>\r\n						\r\n						<span style=\"width:30px;\">\r\n							<button title=\"".toCharArray();
    ...
    _jsp_string77 = "\" type=button class=\"btn_top\" style=\"background:url('/CRM/images/icon_birthday_wev8.png') no-repeat left;\" _type=\"birthday\" onmouseover=\"doMouseover(this)\" onmouseout=\"doMouseout(this)\" onclick=\"openFullWindowHaveBar('/CRM/CustomerContacterInfo.jsp')\">\r\n							 	<div class=\"btndiv\"></div>\r\n							 	".toCharArray();
    ...
    _jsp_string96 = "</div><!-- \u5168\u90e8 -->\r\n					<div class=\"btn_add_type\" onclick=\"doChange(this,'viewtype',1)\" _value=\"1\">".toCharArray();
    _jsp_string97 = "</div><!-- \u5168\u90e8 -->\r\n					<div class=\"btn_add_type\" onclick=\"doChange(this,'viewtype',2)\" _value=\"2\">".toCharArray();
    ...
    _jsp_string93 = ",4,this,'".toCharArray();
    ...
    _jsp_string85 = "\"  class=\"main_btn menuitem1\" style=\"text-align:left;width:60px;".toCharArray();
    ...
    _jsp_string99 = "</div><!-- \u5168\u90e8 -->\r\n					<div class=\"btn_add_type\" onclick=\"markItemAsType(this)\" _markType=\"import\">".toCharArray();
    ...
    _jsp_string75 = "\" type=button class=\"btn_top\" style=\"background:url('/CRM/images/icon_add_wev8.png') no-repeat left;\" _type=\"add\" onmouseover=\"doMouseover(this)\" onmouseout=\"doMouseout(this)\" onclick=\"openFullWindowHaveBar('/CRM/data/AddCustomerFrame.jsp?tabtype=add')\">\r\n							 	<div class=\"btndiv\"></div>\r\n							 	<div style=\"clear:both;\"></div>\r\n							</button>\r\n						</span>\r\n						\r\n						<span style=\"width:30px;\">\r\n							<button title=\"".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    ...
    _jsp_string108 = "</div><!-- \u5168\u90e8 -->\r\n					    <div class=\"btn_add_type\" onclick=\"markAsImportant(this)\" _important=\"0\">".toCharArray();
    _jsp_string88 = "\" onclick=\"showMenu(this,'viewtypeMenu',event)\">\r\n					<div class=\"menuitem1-l\" style=\"padding-left:5px;\">\r\n						<span class=\"menuName\">".toCharArray();
    _jsp_string58 = "\r\n<meta http-equiv=\"".toCharArray();
    _jsp_string87 = "\r\n					</div>	\r\n					<div class=\"marrow\"></div>\r\n					<div class=\"seprator\"></div>\r\n					\r\n				</div>\r\n				<div id=\"viewtype\" _value=\"0\" class=\"main_btn menuitem1\" style=\"width:60px;".toCharArray();

...
public class _customersettings__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
    ...
    String Sell_addRemindTo=Util.null2String(RecordSet.getString("sell_rmd_create2"));//\u521b\u5efa\u5546\u673a\u63d0\u9192\u5bf9\u8c61\u3002            1\uff1a\u76f4\u63a5\u4e0a\u7ea7\uff0c2\uff1a\u6240\u6709\u4e0a\u7ea7
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("customer")+ "&" + "navName=" + com.caucho.el.Expr.toString($label(84236,user.getLanguage()) + $label(31811,user.getLanguage()), null), false);
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext($label(21946,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print(($label(15006,user.getLanguage())+$label(21946,user.getLanguage())));
              ...
              do {
                ...
                if(null != CRM_addRemind&&CRM_addRemind.equals("Y")){
              ...
              do {
                out.write(_jsp_string136, 0, _jsp_string136.length);
                out.print(($label(15006,user.getLanguage())+$label(18013,user.getLanguage())));
                out.write(_jsp_string137, 0, _jsp_string137.length);
              ...
              do {
                ...
                if(null!=CRM_addRemindTo&&CRM_addRemindTo.equals("2")){
                out.write(_jsp_string144, 0, _jsp_string144.length);
                }
                out.write('>');
                out.print(($label(15762,user.getLanguage()) ));
                out.write(_jsp_string145, 0, _jsp_string145.length);
                if(null!=CRM_addRemindTo&&CRM_addRemindTo.equals("1")){
                out.write(_jsp_string144, 0, _jsp_string144.length);
                }
                out.write('>');
                out.print(($label(15709,user.getLanguage()) ));
              ...
              do {
                out.write(_jsp_string136, 0, _jsp_string136.length);
                out.print(($label(124910,user.getLanguage())+$label(21946,user.getLanguage())));
                out.write(_jsp_string137, 0, _jsp_string137.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                if(null != Sell_addRemind&&Sell_addRemind.equals("Y")){
                out.write(_jsp_string140, 0, _jsp_string140.length);
                }
                out.write(_jsp_string141, 0, _jsp_string141.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              ...
              _jsp_ItemTag_3.setAttributes("{'samePair':'sellNoImg'}");
              _jsp_ItemTag_3.doStartTag();
              out = pageContext.pushBody();
              ...
              do {
                out.write(_jsp_string136, 0, _jsp_string136.length);
                out.print(($label(124910,user.getLanguage())+$label(18013,user.getLanguage())));
                out.write(_jsp_string137, 0, _jsp_string137.length);
              } while (_jsp_ItemTag_3.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_3.doEndTag();
              ...
              do {
                ...
                if(null!=Sell_addRemindTo&&Sell_addRemindTo.equals("2")){
                out.write(_jsp_string144, 0, _jsp_string144.length);
                }
                out.write('>');
                out.print(($label(15762,user.getLanguage()) ));
                out.write(_jsp_string145, 0, _jsp_string145.length);
                if(null!=Sell_addRemindTo&&Sell_addRemindTo.equals("1")){
                out.write(_jsp_string144, 0, _jsp_string144.length);
                }
                out.write('>');
                out.print(($label(15709,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/Maint/CustomerSettings.jsp"), -8913704974284298836L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string139 = "\r\n					    <script>\r\n					       $(function(){\r\n					       	checkImgStatus()\r\n					       });\r\n					       function checkImgStatus(){\r\n					          if($(\"#CRM_addRemind\").is(\":checked\")){\r\n					          	showEle(\"noImg\");\r\n					          	$(\"#signbtn\").show();\r\n					          }else{\r\n					            hideEle(\"noImg\");\r\n					            $(\"#signbtn\").hide();\r\n					          }\r\n					       }\r\n					    </script>\r\n						<input type=\"checkbox\" id='CRM_addRemind' onclick=\"checkImgStatus()\" name=\"CRM_addRemind\" ".toCharArray();
    ...
    _jsp_string132 = "\" class=\"e8_btn_top\" onclick=\"doSave()\" />\r\n					<span title=\"".toCharArray();
    ...
    _jsp_string141 = " value=\"Y\" tzCheckbox=\"true\">\r\n					".toCharArray();
    ...
    _jsp_string148 = "\r\n					    <script>\r\n					       $(function(){\r\n					       	checkSellImgStatus()\r\n					       });\r\n					       function checkSellImgStatus(){\r\n					          if($(\"#Sell_addRemind\").is(\":checked\")){\r\n					          	showEle(\"sellNoImg\");\r\n					          	$(\"#signbtn\").show();\r\n					          }else{\r\n					            hideEle(\"sellNoImg\");\r\n					            $(\"#signbtn\").hide();\r\n					          }\r\n					       }\r\n					    </script>\r\n						<input type=\"checkbox\" id='Sell_addRemind' onclick=\"checkSellImgStatus()\" name=\"Sell_addRemind\" ".toCharArray();
    _jsp_string134 = "\r\n				".toCharArray();
    _jsp_string147 = "\r\n					<div><br/></div>\r\n					<!-- \u5546\u673a\u63d0\u9192 -->\r\n					".toCharArray();
    ...
    _jsp_string140 = "checked".toCharArray();
    _jsp_string48 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();

...
public class _listcustomerdescinner__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelName(16494,user.getLanguage()) ));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((PageIdConst.CRM_DescSet));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/Maint/ListCustomerDescInner.jsp"), 3316090341559754339L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string144 = "\" class=\"e8_btn_top\"  onclick=\"openDialog()\"/>&nbsp;&nbsp;\r\n			".toCharArray();
    ...
    _jsp_string145 = "\" class=\"e8_btn_top\" onclick=\"delMutli()\"/>&nbsp;&nbsp;\r\n			".toCharArray();
  }
}

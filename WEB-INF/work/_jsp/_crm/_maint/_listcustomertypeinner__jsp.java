...
public class _listcustomertypeinner__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelName(21930 ,user.getLanguage()) ));
      out.write(_jsp_string67, 0, _jsp_string67.length);
      out.print((SystemEnv.getHtmlLabelName(32651 ,user.getLanguage()) ));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((PageIdConst.CRM_TypeSet));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/Maint/ListCustomerTypeInner.jsp"), 6990721638949035290L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string145 = "\" class=\"e8_btn_top\"  onclick=\"openDialog()\"/>&nbsp;&nbsp;\r\n			".toCharArray();
    ...
    _jsp_string146 = "\" class=\"e8_btn_top\" onclick=\"delMutli()\"/>&nbsp;&nbsp;\r\n			".toCharArray();
  }
}

...
public class _editcustomerdesc__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("customer")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(16494,user.getLanguage()) , null), false);
      out.write(_jsp_string2, 0, _jsp_string2.length);
      ...
      if (_jspEval14 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_4.setAttributes("{groupDisplay:none,itemAreaDisplay:none}");
            ...
            do {
              ...
              do {
                ...
                if (_jsp_RequiredTag_6 == null) {
                  ...
                  _jsp_RequiredTag_6.setValue("");
                }

                int _jspEval39 = _jsp_RequiredTag_6.doStartTag();
                if (_jspEval39 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  if (_jspEval39 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
                    ...
                    _jsp_RequiredTag_6.setBodyContent(_jsp_endTagHack37);
                  ...
                  do {
                    ...
                    out.print((Util.toScreenToEdit(RecordSet.getString(2),user.getLanguage())));
                ...
                int _jsp_end_40 = _jsp_RequiredTag_6.doEndTag();
              ...
              do {
                ...
                out.print((Util.toScreenToEdit(RecordSet.getString(3),user.getLanguage())));
                out.write(_jsp_string153, 0, _jsp_string153.length);
                }else {
                out.print((Util.toScreen(RecordSet.getString(3),user.getLanguage())));
                }
                out.write(_jsp_string139, 0, _jsp_string139.length);
              } while (_jsp_ItemTag_5.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/Maint/EditCustomerDesc.jsp"), -7310265652419256790L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string152 = "<INPUT class=InputStyle maxLength=150 size=45 name=\"desc\" value=\"".toCharArray();
    _jsp_string140 = "\r\n			".toCharArray();
    ...
    _jsp_string146 = "</FONT>".toCharArray();
    ...
    _jsp_string123 = "\r\n							".toCharArray();
    _jsp_string156 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"parentWin.closeDialog();\">\r\n	    ".toCharArray();
    ...
    _jsp_string150 = "<INPUT class=InputStyle maxLength=150 style=\"width: 300px;\" size=45 name=\"name\" value=\"".toCharArray();
    ...
    _jsp_string145 = "<FONT color=\"red\" size=\"2\">".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    ...
    _jsp_string151 = "\" onchange='checkinput(\"name\",\"nameimage\")' >\r\n				".toCharArray();

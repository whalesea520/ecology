...
public class _editcustomerstatus__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	String ishowname = Util.null2String(request.getParameter("ishowname"),"1"); 
      ...
      out.print((SystemEnv.getHtmlLabelName(16495,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/Maint/EditCustomerStatus.jsp"), 4746306372316303475L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    _jsp_string67 = "\";\r\n$(function() {\r\n	$('.e8_box').Tabs({\r\n		getLine : 1,\r\n		iframe : \"tabcontentframe\",\r\n		needInitBoxHeight:false\r\n	});\r\n	attachUrl();\r\n});\r\n\r\n\r\nfunction attachUrl()\r\n{\r\n	\r\n	$(\"[name='tabcontentframe']\").attr(\"src\",\"EditCustomerStatusInner.jsp?id=\"+id+\"&winfo=".toCharArray();

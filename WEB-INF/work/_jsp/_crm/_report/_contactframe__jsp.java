...
public class _contactframe__jsp extends com.caucho.jsp.JavaPage
{
...
int count = CustomerStatusCount.getContactNumber(user.getUID()+"");
      ...
      out.print((SystemEnv.getHtmlLabelName(16405,user.getLanguage()) ));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelName(16402,user.getLanguage()) ));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((SystemEnv.getHtmlLabelName(16403,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/report/ContactFrame.jsp"), 1694279260024380612L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string68 = "</a>\r\n						</li>\r\n						<li>\r\n							<a href=\"\" target=\"tabcontentframe\" _datetype=\"plan\">".toCharArray();

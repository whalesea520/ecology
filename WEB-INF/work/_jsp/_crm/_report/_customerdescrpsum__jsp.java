...
public class _customerdescrpsum__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("customer")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(1283,user.getLanguage()) , null), false);
      out.write(_jsp_string0, 0, _jsp_string0.length);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/report/CustomerDescRpSum.jsp"), -7526797887799009963L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

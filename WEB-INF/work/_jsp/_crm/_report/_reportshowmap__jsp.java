...
public class _reportshowmap__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string52, 0, _jsp_string52.length);
      weaver.crm.report.CRMContants Contants;
      Contants = (weaver.crm.report.CRMContants) pageContext.getAttribute("Contants");
      if (Contants == null) {
        Contants = new weaver.crm.report.CRMContants();
        pageContext.setAttribute("Contants", Contants);
      }
      out.write(_jsp_string52, 0, _jsp_string52.length);
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(84378,user.getLanguage())));
      ...
      out.print((datastr.equals("")?"[]":datastr));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/report/ReportShowMap.jsp"), -2013323308499285287L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string156 = "&showtype=\"+type+\"&reportId=".toCharArray();
    ...
    _jsp_string121 = "\r\n							".toCharArray();
    _jsp_string157 = "&province=\"+pname+\"&random=\"+Math.floor(Math.random()*100000));\r\n				parent.showtype = type;\r\n		    }\r\n	        function changeSrc2(type,aname){\r\n				$(\"#detailview\").attr(\"src\",\"ReportShowDetail.jsp?datefrom=".toCharArray();
    ...
    _jsp_string144 = "/5);\r\n			var clickpath;\r\n			var dataStatus = ".toCharArray();
    _jsp_string140 = "\r\n					</select>\r\n					</div>\r\n				 </div>\r\n			</div>\r\n			<div id=\"divtag\" style=\"position: absolute;left: 10px;z-index: 100;display: none\">\r\n				<div style=\"line-height: 16px;float: left;margin-right: 4px;\">".toCharArray();
    _jsp_string2 = "\r\n	<script language=\"javascript\">\r\n		window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string64 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string139 = " selected=\"selected\" ".toCharArray();

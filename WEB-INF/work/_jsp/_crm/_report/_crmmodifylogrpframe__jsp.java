...
public class _crmmodifylogrpframe__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelName(33781,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/report/CRMModifyLogRpFrame.jsp"), 1891864599525767681L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

...
public class _customersizerpsum__jsp extends com.caucho.jsp.JavaPage
{
...
String needhelp ="";
      ...
      out.print((SystemEnv.getHtmlLabelName(20323,user.getLanguage()) ));
...
if(userightmenu!=1){
	...
	"</table>";
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("customer")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(1285,user.getLanguage()) , null), false);
      out.write(_jsp_string0, 0, _jsp_string0.length);
      ...
      out.print((PageIdConst.CRM_RPSize));
      ...
      int _jsp_end_15 = _jsp_SplitPageTag_3.doEndTag();
      if (_jsp_end_15 == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
        return;
      out.write(_jsp_string0, 0, _jsp_string0.length);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/report/CustomerSizeRpSum.jsp"), -5973000031431110750L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string98 = "px\">\r\n		</iframe>\r\n	</div>\r\n".toCharArray();
    _jsp_string139 = "\r\n			\r\n			<input type=\"text\" class=\"searchInput\"  id=\"searchName\" value=\"".toCharArray();

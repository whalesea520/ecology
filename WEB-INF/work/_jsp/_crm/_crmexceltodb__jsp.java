...
public class _crmexceltodb__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
          ...
          if (_jspEval17 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(18038,user.getLanguage())));
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(16699,user.getLanguage())));
              ...
              do {
                ...
                _jsp_BrowserTag_7.setWidth("40%");
                _jsp_BrowserTag_7.setName("manager");
                _jsp_BrowserTag_7.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/hrm/resource/ResourceBrowser.jsp");
                _jsp_BrowserTag_7.setBrowserValue(String.valueOf(user.getUID()) );
                _jsp_BrowserTag_7.setBrowserSpanValue(user.getUsername());
              ...
              do {
                ...
                _jsp_BrowserTag_7.setIsMustInput("2");
                _jsp_BrowserTag_7.setWidth("40%");
                _jsp_BrowserTag_7.setName("CustomerStatus");
                _jsp_BrowserTag_7.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/CRM/Maint/CustomerStatusBrowser.jsp");
                _jsp_BrowserTag_7.setBrowserValue(String.valueOf(1));
                _jsp_BrowserTag_7.setBrowserSpanValue(CustomerStatusComInfo.getCustomerStatusname("1"));
                _jsp_BrowserTag_7.setCompleteUrl("/data.jsp?type=customerStatus");
                _jsp_BrowserTag_7.doTag();
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(28445,user.getLanguage())));
                out.write(_jsp_string154, 0, _jsp_string154.length);
                out.print((SystemEnv.getHtmlLabelName(28447,user.getLanguage())));
                out.write(_jsp_string155, 0, _jsp_string155.length);
                out.print((SystemEnv.getHtmlLabelName(28446,user.getLanguage())));
                out.write(_jsp_string156, 0, _jsp_string156.length);
                out.print((SystemEnv.getHtmlLabelName(126071,user.getLanguage())));
                out.write(_jsp_string157, 0, _jsp_string157.length);
                out.print((SystemEnv.getHtmlLabelName(84295,user.getLanguage())));
                out.write(_jsp_string158, 0, _jsp_string158.length);
                out.print((SystemEnv.getHtmlLabelName(84297,user.getLanguage())));
                out.write(_jsp_string158, 0, _jsp_string158.length);
                out.print((SystemEnv.getHtmlLabelName(84298,user.getLanguage())));
                out.write(_jsp_string158, 0, _jsp_string158.length);
                out.print((SystemEnv.getHtmlLabelName(84300,user.getLanguage())));
                out.write(_jsp_string158, 0, _jsp_string158.length);
                out.print((SystemEnv.getHtmlLabelName(84302,user.getLanguage())));
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(84288,user.getLanguage())));
                out.write(_jsp_string162, 0, _jsp_string162.length);
                out.print((SystemEnv.getHtmlLabelName(84289,user.getLanguage())));
                out.write(_jsp_string162, 0, _jsp_string162.length);
                out.print((SystemEnv.getHtmlLabelName(84290,user.getLanguage())));
              ...
              do {
                out.write(_jsp_string144, 0, _jsp_string144.length);
                out.print((SystemEnv.getHtmlLabelName(84303,user.getLanguage())));
                out.write(_jsp_string145, 0, _jsp_string145.length);
              } while (_jsp_ItemTag_5.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_5.doEndTag();
              ...
              do {
                ...
                if (_jsp_ViewTag_8 == null) {
                  ...
                  _jsp_ViewTag_8.setParent((javax.servlet.jsp.tagext.Tag) _jsp_ItemTag_5);
                  _jsp_ViewTag_8.setAttributes("{cw1:50%,cw2:50%}");
                }
                  ...
                  do {
                    ...
                    if (_jspEval70 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      ...
                      do {
                        ...
                        _jsp_ItemTag_10.setAttributes("{'customAttrs':'id=msg valign=top'}");
                        ...
                        _jsp_ItemTag_10.setAttributes("{customAttrs:'valign=top'}");
                        _jsp_ItemTag_10.doStartTag();
                        out = pageContext.pushBody();
                        ...
                        do {
                          ...
                          out.print((SystemEnv.getHtmlLabelName(84305,user.getLanguage())));
                          out.write(_jsp_string176, 0, _jsp_string176.length);
                          out.print((SystemEnv.getHtmlLabelName(84306,user.getLanguage())));
                          out.write(_jsp_string177, 0, _jsp_string177.length);
                          out.print((SystemEnv.getHtmlLabelName(84307,user.getLanguage())));
                          out.write(_jsp_string178, 0, _jsp_string178.length);
                          out.print((SystemEnv.getHtmlLabelName(84308,user.getLanguage())));
                          out.write(_jsp_string179, 0, _jsp_string179.length);
                          out.print((SystemEnv.getHtmlLabelName(84309,user.getLanguage())));
                          out.write(_jsp_string180, 0, _jsp_string180.length);
                          out.print((SystemEnv.getHtmlLabelName(84310,user.getLanguage())));
                          out.write(_jsp_string181, 0, _jsp_string181.length);
                          out.print((SystemEnv.getHtmlLabelName(84311,user.getLanguage())));
                          out.write(_jsp_string182, 0, _jsp_string182.length);
                          out.print((SystemEnv.getHtmlLabelName(84312,user.getLanguage())));
                          out.write(_jsp_string183, 0, _jsp_string183.length);
                          out.print((SystemEnv.getHtmlLabelName(84313,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(18623, user.getLanguage())));
      out.write(_jsp_string188, 0, _jsp_string188.length);
      out.print((isNUllData));
      out.write(_jsp_string189, 0, _jsp_string189.length);
      out.print((SystemEnv.getHtmlLabelName(84314,user.getLanguage())));
      out.write(_jsp_string190, 0, _jsp_string190.length);
      out.print((isErrTemplate));
      out.write(_jsp_string189, 0, _jsp_string189.length);
      out.print((SystemEnv.getHtmlLabelName(84315,user.getLanguage())));
      out.write(_jsp_string191, 0, _jsp_string191.length);
      out.print((isErreData));
      out.write(_jsp_string192, 0, _jsp_string192.length);
      out.print((SystemEnv.getHtmlLabelName(84316,user.getLanguage())));
      ...
      out.print((success));
      out.write(_jsp_string189, 0, _jsp_string189.length);
      out.print((SystemEnv.getHtmlLabelName(33971,user.getLanguage())));
      out.write(_jsp_string195, 0, _jsp_string195.length);
      out.print((success));
      out.write(_jsp_string189, 0, _jsp_string189.length);
      out.print((SystemEnv.getHtmlLabelName(33970,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(18618,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("CRM/CrmExcelToDB.jsp"), -7415449089345626560L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string38 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string145 = "</strong></p>".toCharArray();
    ...
    _jsp_string156 = "</a>\uff0c<span style=\"color:red\">".toCharArray();
    _jsp_string172 = "	 \r\n										 <li>\r\n									".toCharArray();
    _jsp_string19 = "&time=\"+new Date()+\"&f_weaver_belongto_userid=".toCharArray();
    _jsp_string196 = "\");\r\n	}\r\n});\r\n\r\nfunction onSave(obj){\r\n	if(jQuery(\"#manager\").val()==\"\" || jQuery(\"#CustomerStatus\").val()==\"\"){\r\n		window.top.Dialog.alert(\"".toCharArray();
    _jsp_string147 = "<input class=InputStyle  type=file size=40 name=\"filename\" id=\"filename\" style=\"width:40%\">".toCharArray();
    ...
    _jsp_string161 = ":</strong></p>\r\n				<div style=\"padding-left: 43px;\">\r\n					<ul>\r\n						<li>".toCharArray();
    _jsp_string155 = "<a href=ExcelToDB.xls style=\"color:blue !important;text-decoration: underline !important;\">".toCharArray();
    ...
    _jsp_string144 = "<strong>".toCharArray();
    ...
    _jsp_string94 = "px\">\r\n</iframe>\r\n</div>\r\n".toCharArray();
    _jsp_string140 = "\" style=\"font-size: 12px;cursor: pointer;\">\r\n				<input class=\"e8_btn_top middle\" onclick=\"onSave(this)\" type=\"button\" jQuery1392950000546=\"32\" value=\"".toCharArray();

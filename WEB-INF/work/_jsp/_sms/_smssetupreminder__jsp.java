...
public class _smssetupreminder__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(32784,user.getLanguage()) ));
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(32785,user.getLanguage()) ));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
          ...
          if (_jsp_GroupTag_3 == null) {
            ...
            _jsp_GroupTag_3.setAttributes("{'itemAreaDisplay':'inline-block'}");
          }

          _jsp_GroupTag_3.setContext(SystemEnv.getHtmlLabelName(32787,user.getLanguage()));
          ...
          if (_jspEval33 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print(( PageIdConst.Sms_ReminderList));
      ...
      out.print((SystemEnv.getHtmlLabelName(1421,user.getLanguage())+SystemEnv.getHtmlLabelName(32787,user.getLanguage())));
      out.write(_jsp_string159, 0, _jsp_string159.length);
      out.print((SystemEnv.getHtmlLabelName(611,user.getLanguage())+SystemEnv.getHtmlLabelName(32787,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sms/SmsSetupReminder.jsp"), -8979625188034833804L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string151 = "\"></input>\r\n						 <input Class=\"delbtn\" type=\"button\" onclick=\"doDel()\" title=\"".toCharArray();
    ...
    _jsp_string144 = "\r\n				          <input type=\"text\" id=\"suffix\" name=\"suffix\" value=\"".toCharArray();
    ...
    _jsp_string141 = "\">\r\n			              <input type=\"text\" id=\"prefix\" name=\"prefix\" value=\"".toCharArray();
    ...
    _jsp_string150 = "\r\n				         <input Class=\"addbtn\" type=\"button\" onclick=\"doAdd()\" title=\"".toCharArray();
    ...
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string108 = ";\r\n	".toCharArray();
    _jsp_string140 = "\r\n				          <input type=\"hidden\" id=\"reminderid\" name=\"reminderid\" value=\"".toCharArray();

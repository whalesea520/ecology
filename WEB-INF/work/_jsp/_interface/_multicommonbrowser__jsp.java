...
public class _multicommonbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
RCMenuHeight += RCMenuHeightStep ;
      ...
      if (_jsp_ViewTag_0 == null) {
        ...
        _jsp_ViewTag_0.setAttributes("{'layoutTableId':'SearchBaseInfo'}");
      }
...
BrowserLogService.save(type);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("interface/MultiCommonBrowser.jsp"), 2599729565289810568L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string80 = "\">\r\n<input type=hidden id='issearch' name='issearch' value=\"1\">\r\n<input type=hidden id='requestjson' name='requestjson' value=\"".toCharArray();
    ...
    _jsp_string88 = "<input name='name' value='".toCharArray();
    ...
    _jsp_string92 = "<input name='".toCharArray();
    _jsp_string144 = "\"></td>\r\n							".toCharArray();
    _jsp_string46 = ";\r\nusbserial0 = \"".toCharArray();
    _jsp_string89 = "' class=\"InputStyle\" >".toCharArray();
    ...
    _jsp_string93 = "' value='".toCharArray();

...
public class _selectitemsettings__jsp extends com.caucho.jsp.JavaPage
{
...
tableString =   " <table instanceid=\"workflowTypeListTable\" tabletype=\"checkbox\" pagesize=\""+pageSize+"\" >"+
      ...
      out.print((SystemEnv.getHtmlLabelName(124895,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(33364,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/selectItem/selectItemSettings.jsp"), 5976349277191257864L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string136 = "\" class=\"e8_btn_top\"  onclick=\"newDialog(2,0)\"/>\r\n				<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string144 = "<input type=text name=\"selectitemname\" id=\"selectitemname\" class=Inputstyle value='".toCharArray();
    _jsp_string88 = ");\r\n			}\r\n		}catch(e){}\r\n		".toCharArray();
    _jsp_string37 = "\", function () {\r\n								formElementFocus(tempElement);\r\n							});\r\n							\r\n						}\r\n						return false;\r\n					}else{\r\n						if(window.__oriAlert__){\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string15 = "\\r\\n\\r\\n".toCharArray();
    _jsp_string146 = "<input type=text name=\"selectitemdesc\" id=\"selectitemdesc\" class=Inputstyle value='".toCharArray();

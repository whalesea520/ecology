...
public class _tabstylechoose__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	String tabstyle = Util.null2String(request.getParameter("tabstyle"), "-1");
      ...
      out.print((SystemEnv.getHtmlLabelName(128087, user.getLanguage())));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((SystemEnv.getHtmlLabelName(128088, user.getLanguage())));
      out.write(_jsp_string71, 0, _jsp_string71.length);
      out.print((SystemEnv.getHtmlLabelName(128089, user.getLanguage())));
      out.write(_jsp_string72, 0, _jsp_string72.length);
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("workflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(128090, user.getLanguage()), null), false);
      ...
      out.print((SystemEnv.getHtmlLabelName(129031, user.getLanguage())));
      out.write(_jsp_string75, 0, _jsp_string75.length);
      out.print((SystemEnv.getHtmlLabelName(129032, user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/exceldesign/tabStyleChoose.jsp"), 6653745839385148492L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string75 = "\" onclick=\"openStyleDesign('".toCharArray();
    ...
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string83 = "\" class=\"zd_btn_cancle\" onclick=\"confirmStyle()\">\r\n				<input type=\"button\" value=\"".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    ...
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string84 = "\" class=\"zd_btn_cancle\" onclick=\"dialog.close()\">\r\n			".toCharArray();
    _jsp_string82 = "\r\n				<input type=\"button\" value=\"".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();
  }
}

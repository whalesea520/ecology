...
public class _exceluploadimg__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelName(125079, user.getLanguage())));
      out.write(_jsp_string72, 0, _jsp_string72.length);
      out.print((SystemEnv.getHtmlLabelName(125080, user.getLanguage())));
      out.write(_jsp_string73, 0, _jsp_string73.length);
      out.print((SystemEnv.getHtmlLabelName(84078, user.getLanguage())));
      out.write(_jsp_string74, 0, _jsp_string74.length);
      out.print((SystemEnv.getHtmlLabelName(84079, user.getLanguage())));
      out.write(_jsp_string75, 0, _jsp_string75.length);
      out.print((SystemEnv.getHtmlLabelName(84080, user.getLanguage())));
      out.write(_jsp_string76, 0, _jsp_string76.length);
      out.print((SystemEnv.getHtmlLabelNames("126186,20001", user.getLanguage())));
...
if(isSysadmin>0) {  //\u7528\u7cfb\u7edf\u7ba1\u7406\u5458sysadmin\u767b\u9646\u7cfb\u7edf\u53ef\u67e5\u770b\u9875\u9762\u5730\u5740
	...
	defaultMenuCount++;
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("workflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(681, user.getLanguage()), null), false);
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(681, user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(128045, user.getLanguage())));
                ...
                out.print((SystemEnv.getHtmlLabelName(128046, user.getLanguage())));
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelNames("128047,74", user.getLanguage())));
                out.write(_jsp_string88, 0, _jsp_string88.length);
                out.print((SystemEnv.getHtmlLabelName(125077, user.getLanguage())));
                out.write(_jsp_string86, 0, _jsp_string86.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/exceldesign/excelUploadImg.jsp"), 3444190036075027380L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string98 = "\" id=\"zd_btn_confirm\"  class=\"zd_btn_cancle\" onclick=\"setPicDesc()\">\r\n			    	<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string90 = "</span>".toCharArray();
    _jsp_string61 = ")\">\r\n".toCharArray();
    ...
    _jsp_string99 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"doClose()\">\r\n				".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string89 = "<span id=\"imglabel\">".toCharArray();
    _jsp_string83 = "<select id=\"srcdtype\" name=\"srcdtype\">\r\n	    		<option value=\"1\">".toCharArray();
    ...
    _jsp_string96 = "\r\n				".toCharArray();
    _jsp_string87 = "<select id=\"srcdeal\" name=\"srcdeal\" onchange=\"doChangeImgSrc(this);\">\r\n	    		<option value=\"1\">".toCharArray();

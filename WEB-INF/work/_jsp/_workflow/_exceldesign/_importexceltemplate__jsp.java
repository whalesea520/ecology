...
public class _importexceltemplate__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	if(RecordSet.first())
      ...
      out.print((SystemEnv.getHtmlLabelName(128061, user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((Util.null2String(request.getParameter("wfid")) ));
      out.write(_jsp_string132, 0, _jsp_string132.length);
      out.print((nodeid ));
      out.write(_jsp_string133, 0, _jsp_string133.length);
      out.print((Util.null2String(request.getParameter("formid")) ));
      out.write(_jsp_string134, 0, _jsp_string134.length);
      out.print((Util.null2String(request.getParameter("isbill")) ));
      out.write(_jsp_string135, 0, _jsp_string135.length);
      out.print((Util.null2String(request.getParameter("layouttype")) ));
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(groupname );
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(128062, user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/exceldesign/importExcelTemplate.jsp"), 3777006285411737694L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string146 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.closeByHand()\">\r\n			".toCharArray();
    ...
    _jsp_string67 = "\");//\u9009\u62e9\u6587\u4ef6\u683c\u5f0f\u4e0d\u6b63\u786e,\u8bf7\u9009\u62e9xml\u6587\u4ef625644\r\n				return;\r\n			}\r\n		}\r\n	}\r\n	\r\n</script>\r\n</head>\r\n<body>\r\n\r\n\r\n\r\n".toCharArray();
  }
}

...
public class _exceluploadlink__jsp extends com.caucho.jsp.JavaPage
{
...
if(isSysadmin>0) {  //\u7528\u7cfb\u7edf\u7ba1\u7406\u5458sysadmin\u767b\u9646\u7cfb\u7edf\u53ef\u67e5\u770b\u9875\u9762\u5730\u5740
	...
	defaultMenuCount++;
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("workflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelNames("30615,81973", user.getLanguage()), null), false);
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(81973, user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(129000, user.getLanguage())));
              ...
              do {
                ...
                out.print(("1".equals(srcdeal) ? "selected" : "" ));
                out.write(_jsp_string72, 0, _jsp_string72.length);
                out.print(("2".equals(srcdeal) ? "selected" : "" ));
                out.write(_jsp_string73, 0, _jsp_string73.length);
                out.print(("3".equals(srcdeal) ? "selected" : "" ));
                out.write(_jsp_string74, 0, _jsp_string74.length);
                out.print(("4".equals(srcdeal) ? "selected" : "" ));
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(128048, user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/exceldesign/excelUploadLink.jsp"), -2796616987332053257L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string84 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.closeByHand()\">\r\n				".toCharArray();
    ...
    _jsp_string71 = "<select id=\"srcdeal\" name=\"srcdeal\">\r\n			    		<option value=\"1\" ".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    ...
    _jsp_string77 = "\"></input>".toCharArray();
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    ...
    _jsp_string81 = "\r\n				".toCharArray();
    _jsp_string70 = "\r\n			    	".toCharArray();
    _jsp_string76 = "<input type=\"text\" id=\"srcfile\" name=\"srcfile\" value=\"".toCharArray();

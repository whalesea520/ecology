...
public class _excelinitmodule__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	String isfieldisplay = "display:block";
      ...
      out.print((SystemEnv.getHtmlLabelNames("68,82113",user.getLanguage()) ));
      ...
      pageContext.include("/workflow/exceldesign/editDetailFieldAttr.jsp", "nodeid=" + com.caucho.el.Expr.toString(nodeid , null)+ "&" + "layouttype=" + com.caucho.el.Expr.toString(layouttype , null)+ "&" + "formid=" + com.caucho.el.Expr.toString(request.getParameter("formid") , null)+ "&" + "isbill=" + com.caucho.el.Expr.toString(request.getParameter("isbill") , null)+ "&" + "detailindex=" + com.caucho.el.Expr.toString(request.getParameter("detailindex") , null)+ "&" + "viewonly=" + com.caucho.el.Expr.toString(Util.null2String(request.getParameter("viewonly")) , null), false);
      out.write(_jsp_string73, 0, _jsp_string73.length);
      }else{ 
      out.write(_jsp_string73, 0, _jsp_string73.length);
      pageContext.include("/workflow/workflow/edithtmlnodefield.jsp", "wfid=" + com.caucho.el.Expr.toString(wfid , null)+ "&" + "ajax=" + ("1")+ "&" + "nodeid=" + com.caucho.el.Expr.toString(nodeid , null)+ "&" + "isExcel=" + ("1")+ "&" + "modeid=" + com.caucho.el.Expr.toString(modeid , null)+ "&" + "design=" + ("0")+ "&" + "eloutype=" + com.caucho.el.Expr.toString(layouttype , null), false);
      out.write(_jsp_string73, 0, _jsp_string73.length);
      } 
      ...
      out.print((SystemEnv.getHtmlLabelName(31644,user.getLanguage()) ));
      ...
      out.print((SystemEnv.getHtmlLabelName(128944,user.getLanguage()) ));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(1876,user.getLanguage()) ));
      ...
      out.print((SystemEnv.getHtmlLabelName(127980,user.getLanguage()) ));
      out.write(_jsp_string95, 0, _jsp_string95.length);
      out.print((SystemEnv.getHtmlLabelName(127981,user.getLanguage()) ));
      out.write(_jsp_string96, 0, _jsp_string96.length);
      out.print((SystemEnv.getHtmlLabelName(24520,user.getLanguage()) ));
      out.write(_jsp_string97, 0, _jsp_string97.length);
      out.print((SystemEnv.getHtmlLabelName(127982,user.getLanguage()) ));
      out.write(_jsp_string98, 0, _jsp_string98.length);
      out.print((SystemEnv.getHtmlLabelName(24519,user.getLanguage()) ));
      out.write(_jsp_string99, 0, _jsp_string99.length);
      out.print((SystemEnv.getHtmlLabelName(1402,user.getLanguage()) ));
      out.write(_jsp_string100, 0, _jsp_string100.length);
      out.print((Util.getIntValue(modeid)>0 ));
      out.write(_jsp_string101, 0, _jsp_string101.length);
      out.print((SystemEnv.getHtmlLabelName(125558,user.getLanguage()) ));
      ...
      out.print((SystemEnv.getHtmlLabelName(128945,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/exceldesign/excelInitModule.jsp"), -7322744508436812750L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string76 = "</div>\r\n						<div name=\"_field1\" style=\"border: 1px solid #90badd;padding-left: 80px;height:31px;line-height:31px;\">".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    _jsp_string81 = "</div>\r\n						<div name=\"_field1\" style=\"float: left;width: 95px;border: 1px solid #90badd;padding-left: 10px;margin-top: -1px;height:31px;line-height:31px;\">".toCharArray();
    ...
    _jsp_string67 = "\" class=\"close\" onclick=\"parentDialog.close();\"> </span>&nbsp;\r\n        </div>\r\n        <div class=\"moduleHeadStep\">\r\n        	<span name=\"ssstep\" class=\"step1\" style=\"padding-left:30px;\">".toCharArray();
    _jsp_string77 = "</div><!--\u8868\u5355\u5185\u5bb9  -->\r\n						<div name=\"_label1\" style=\"float: left;width: 60px;height:31px;line-height:31px;border: 1px solid #90badd;padding-left: 10px;margin-top: -1px;background:#e7f3fc;\">".toCharArray();
    ...
    _jsp_string74 = "\r\n		</div>\r\n		\r\n		<div class=\"styleContainer\" style=\"display:none;overflow-y:auto;\">\r\n			<div class=\"styleDiv\">\r\n				<input type=checkbox notBeauty=true name=\"styleCheck\" checked /> <span name=\"checkstylename\">".toCharArray();
    _jsp_string58 = "\r\n<meta http-equiv=\"".toCharArray();
    _jsp_string88 = "\" id=\"saveAttrBtn\" class=\"zd_btn_cancle\" onclick=\"onSaveSttr()\">\r\n					".toCharArray();
    ...
    _jsp_string90 = "\" id=\"cancelBtn\"  class=\"zd_btn_cancle\" onclick=\"dialog.closeByHand()\">\r\n				".toCharArray();

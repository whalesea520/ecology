...
public class _showmodule__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	String 	tableString=""+
      ...
      out.print((SystemEnv.getHtmlLabelName(128079, user.getLanguage())));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((SystemEnv.getHtmlLabelName(128080, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(128081, user.getLanguage())));
      out.write(_jsp_string84, 0, _jsp_string84.length);
      out.print((isbill ));
      out.write(_jsp_string85, 0, _jsp_string85.length);
      out.print((SystemEnv.getHtmlLabelName(129028, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelNames("68,128003",user.getLanguage()) ));
      out.write(_jsp_string91, 0, _jsp_string91.length);
      out.print((SystemEnv.getHtmlLabelName(128082, user.getLanguage())));
      out.write(_jsp_string92, 0, _jsp_string92.length);
      out.print((wfid));
      out.write(_jsp_string88, 0, _jsp_string88.length);
      out.print((layouttype));
      out.write(_jsp_string93, 0, _jsp_string93.length);
      out.print((SystemEnv.getHtmlLabelName(129029, user.getLanguage())));
      ...
      out.print((PageIdConst.WF_WORKFLOW_SHOWMODULE));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/exceldesign/showModule.jsp"), 6219703248838351524L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string82 = "\", choose_layoutid:datas.id, operuser:\"".toCharArray();
    ...
    _jsp_string93 = "&from_nodeid=\"+nodeid+\"&from_modeid=\"+layoutid;  \r\n		dlg.Title=\"".toCharArray();
    ...
    _jsp_string72 = "\", layoutid);\r\n			});\r\n		}else{\r\n			parent.reloadExcelMain(nodeid, \"".toCharArray();
    _jsp_string94 = "\";\r\n	\u3000\u3000 dlg.show();\r\n	}\r\n	\r\n	//\u8bbe\u4e3a\u6d3b\u52a8\u6a21\u677f\r\n	function setLayoutToActive(vthis){\r\n		var nodeid = jQuery(vthis).closest(\"tr\").find(\"[name='nodeid']\").val();\r\n		var layoutid = jQuery(vthis).closest(\"tr\").find(\"[name='layoutid']\").val();\r\n		jQuery.ajax({\r\n			type: \"post\",\r\n			url: \"/workflow/exceldesign/excelAjaxData.jsp\",\r\n			data: {src:\"setLayoutToActive\", wfid:\"".toCharArray();
    ...
    _jsp_string85 = "\"!=\"1\"){\r\n			window.top.Dialog.alert(\"".toCharArray();
    _jsp_string81 = "\", layouttype:\"".toCharArray();
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    ...
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string90 = "&nodeid=\"+nodeid+\"&modeid=\"+layoutid;\r\n		dialog.Title = '".toCharArray();
    _jsp_string86 = "\");\r\n			return;\r\n		}\r\n		var nodeid = jQuery(vthis).closest(\"tr\").find(\"[name='nodeid']\").val();\r\n		var url =  \"/workflow/exceldesign/importExcelTemplate.jsp?wfid=".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();
    _jsp_string92 = "\");\r\n			return;\r\n		}\r\n		var nodeid=jQuery(vthis).closest(\"tr\").find(\"[name='nodeid']\").val();\r\n		var layoutid=jQuery(vthis).closest(\"tr\").find(\"[name='layoutid']\").val();\r\n		var dlg=new window.top.Dialog();\r\n		dlg.currentWindow=window;\r\n		dlg.Model=true;\r\n	\u3000\u3000 dlg.Width=450;\r\n	\u3000\u3000 dlg.Height=550;\r\n	    dlg.URL=\"/workflow/exceldesign/syncNodesBrowser.jsp?wfid=".toCharArray();
  }
}

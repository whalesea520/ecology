...
import weaver.file.*;
import weaver.workflow.exceldesign.TemplateOperation;

public class _importexcelcheck__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	out.println("<script>var check_result = '"+check_result+"';</script>");
      ...
      out.print((SystemEnv.getHtmlLabelNames("20839,17998",user.getLanguage()) ));
      out.write(_jsp_string66, 0, _jsp_string66.length);
      out.print((excelFilePath ));
      ...
      out.print((SystemEnv.getHtmlLabelName(128059, user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/exceldesign/importExcelCheck.jsp"), -4148533989005417141L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

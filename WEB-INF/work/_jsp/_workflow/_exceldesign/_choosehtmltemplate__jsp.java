...
public class _choosehtmltemplate__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
          ...
          if (_jspEval6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_4.setName("search_wfid");
                _jsp_BrowserTag_4.setGetBrowserUrlFn("getWfBrowUrl");
                ...
                _jsp_BrowserTag_4.setBrowserValue(search_wfid );
                _jsp_BrowserTag_4.setCompleteUrl(completeUrl );
                _jsp_BrowserTag_4.setBrowserSpanValue(WorkflowComInfo.getWorkflowname(search_wfid));
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelNames("64,23247",user.getLanguage()) ));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                out.print((search_active==-1?"selected":"" ));
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(332,user.getLanguage()) ));
                out.write(_jsp_string139, 0, _jsp_string139.length);
                out.print((search_active==1?"selected":"" ));
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(678,user.getLanguage()) ));
                out.write(_jsp_string140, 0, _jsp_string140.length);
                out.print((search_active==0?"selected":"" ));
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(1477,user.getLanguage()) ));
      ...
      int _jspEval47 = _jsp_ViewTag_8.doStartTag();
      if (_jspEval47 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval47 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_8.setBodyContent(_jsp_endTagHack45);
        ...
        do {
          ...
          int _jspEval50 = _jsp_GroupTag_9.doStartTag();
          if (_jspEval50 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval50 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_9.setBodyContent(_jsp_endTagHack48);
            ...
            do {
              ...
              _jsp_ItemTag_10.setBodyContent(_jsp_endTagHack51);
      ...
      out.print((SystemEnv.getHtmlLabelName(127974,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(127976,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/exceldesign/chooseHtmlTemplate.jsp"), 6154333347067019207L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string148 = "\" />\r\n<input type=\"hidden\" name=\"curlayoutid\" value=\"".toCharArray();
    ...
    _jsp_string38 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string147 = "\" />\r\n<input type=\"hidden\" name=\"layouttype\" value=\"".toCharArray();
    ...
    _jsp_string130 = "\" onclick=\"doSearch();\" class=\"e8_btn_top\">\r\n	      	<span title=\"".toCharArray();
    ...
    _jsp_string155 = "\" == \"showModule\"){\r\n					window.top.Dialog.confirm(\"".toCharArray();
    _jsp_string117 = "\"></td>\r\n							".toCharArray();
    _jsp_string136 = "\r\n			<input type=\"text\" class=\"InputStyle\" name=\"search_layoutname\" value=\"".toCharArray();
    ...
    _jsp_string149 = "\" />\r\n<input type=\"hidden\" name=\"fromwhere\" value=\"".toCharArray();
    ...
    _jsp_string152 = "\" class=\"zd_btn_cancle\" onclick=\"doClear();\" />\r\n				<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string159 = "\", function(){//\u786e\u8ba4\u6e05\u9664\u8282\u70b9\u6d3b\u52a8\u6a21\u677f\u5417\uff1f\r\n					window.parent.__setloaddingeffect();\r\n					dialog.callback(retJson);\r\n				});\r\n			}\r\n		}else{\r\n			dialog.callback(retJson);\r\n		}\r\n	}\r\n}\r\n\r\nfunction doSearch(){\r\n	weaverform.submit();\r\n}\r\n\r\nfunction doClose(){\r\n	if(dialog)\r\n		dialog.close();\r\n}\r\n\r\nfunction getWfBrowUrl(){\r\n	return \"/systeminfo/BrowserMain.jsp?url=/workflow/workflow/WorkflowTypeBrowser.jsp?from=htmllayoutchoose&sqlwhere=".toCharArray();
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    ...
    _jsp_string153 = "\" class=\"zd_btn_cancle\" onclick=\"doClose();\" />\r\n			".toCharArray();

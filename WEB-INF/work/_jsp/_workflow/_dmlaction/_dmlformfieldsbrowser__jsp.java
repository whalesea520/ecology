...
public class _dmlformfieldsbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                if("1".equals(fieldtype)){out.print("selected");} 
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(83678,user.getLanguage())));
                out.write(_jsp_string141, 0, _jsp_string141.length);
                if("2".equals(fieldtype)){out.print("selected");} 
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(83679,user.getLanguage())));
                out.write(_jsp_string142, 0, _jsp_string142.length);
                if("3".equals(fieldtype)){out.print("selected");} 
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(83680,user.getLanguage())));
      ...
      int _jspEval26 = _jsp_ViewTag_3.doStartTag();
      if (_jspEval26 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval26 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_3.setBodyContent(_jsp_endTagHack24);
        ...
        do {
          ...
          _jsp_GroupTag_4.setContext( SystemEnv.getHtmlLabelName(33046,user.getLanguage()));
      ...
      int _jspEval42 = _jsp_ViewTag_7.doStartTag();
      if (_jspEval42 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval42 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_7.setBodyContent(_jsp_endTagHack40);
      ...
      out.print((SystemEnv.getHtmlLabelName(83684,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/dmlaction/dmlFormFieldsBrowser.jsp"), -5573296874070018495L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string150 = "\r\n			    	<input type=\"button\" class=zd_btn_cancle accessKey=2  id=btnclear value=\"2-".toCharArray();
    ...
    _jsp_string115 = "\r\n							".toCharArray();
    _jsp_string133 = "\">\r\n	<input type=\"hidden\" name=issearch value=\"1\">\r\n	<input type=\"hidden\" name=\"showdetail\" value=\"".toCharArray();
    ...
    _jsp_string152 = "\" onclick='closeDialog();'></input>\r\n				".toCharArray();
    ...
    _jsp_string138 = "\r\n				<input type=text size=20 class=inputstyle maxlength=20 id=\"fieldname\" name=\"fieldname\" value=\"".toCharArray();
    _jsp_string48 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string143 = "</option><!-- \u8282\u70b9\u64cd\u4f5c\u8005\u6570\u636e -->\r\n				</SELECT> \r\n			".toCharArray();
    ...
    _jsp_string134 = "\">\r\n	<input type=\"hidden\" name=\"tableid\" value=\"".toCharArray();

...
public class _dmltablefieldsbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(82104,user.getLanguage()));
      ...
      out.print((SystemEnv.getHtmlLabelName(82925,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/dmlaction/dmlTableFieldsBrowser.jsp"), 5730998089235640421L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string144 = "DataDark".toCharArray();
    ...
    _jsp_string157 = "\" onclick='closeDialog();'></input>\r\n				".toCharArray();
    ...
    _jsp_string143 = "DataLight".toCharArray();

...
public class _billapprovecustomeroperation__jsp extends com.caucho.jsp.JavaPage
{
...
out.print("<script>wfforward('/workflow/request/ViewRequest.jsp?requestid="+requestid+"&f_weaver_belongto_userid="+user.getUID()+"&f_weaver_belongto_usertype="+Util.null2String(""+f_weaver_belongto_usertype)+"');</script>");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/request/BillApproveCustomerOperation.jsp"), -2865550322347876483L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

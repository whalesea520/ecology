...
public class _requesttype__jsp extends com.caucho.jsp.JavaPage
{
...
if (querystring.length() > 0) {
    querystring = querystring.substring(1);
      ...
      out.print((SystemEnv.getHtmlLabelName(offical.equals("1")?33424:18015, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(28184, user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/request/RequestType.jsp"), 283834203957921159L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string89 = "&needPopupNewPage=true&dfdfid=b&needall=0&usedtodo=1\"\r\n						target=\"tabcontentframe\"> ".toCharArray();
    _jsp_string21 = "\";\r\n	    xmlhttp.open(\"GET\",URL, false);\r\n	    xmlhttp.send(null);\r\n	    var result = xmlhttp.status;\r\n	    if(result==200) {\r\n		    isconn = true;\r\n	    	var response_flag = xmlhttp.responseText;\r\n	    	if(response_flag!='0') {\r\n	    		var flag_msg = '';\r\n	    		if(response_flag=='1') {\r\n	    			var diag = new Dialog();\r\n					diag.Width = 300;\r\n					diag.Height = 180;\r\n					diag.ShowCloseButton=false;\r\n					diag.Title = \"".toCharArray();
    _jsp_string91 = "\r\n                 <li id=\"tab_1\">\r\n                	<a onclick=\"setcookie('wfcookie',0)\" href=\"/workflow/request/RequestTypeShowWithLetter.jsp?".toCharArray();
    ...
    _jsp_string76 = "&needPopupNewPage=true&dfdfid=a&needall=1\");\r\n			    	}\r\n			    	else if(_tabck == 0)\r\n			    	{\r\n			    		$(\"#tab_1\").addClass(\"current\");\r\n			    		if(showtype === \"1\")\r\n				    		$(\"#tabcontentframe\").attr(\"src\",\"/workflow/request/RequestTypeShowWithLetter.jsp?".toCharArray();
    _jsp_string73 = "&needPopupNewPage=true&dfdfid=b&needall=0\")\r\n		    		else\r\n		    			$(\"tabcontentframe\").attr(\"src\",\"/workflow/request/RequestTypeShow.jsp?".toCharArray();
    _jsp_string48 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    ...
    _jsp_string84 = "&needPopupNewPage=true&dfdfid=a&needall=1\"\r\n						target=\"tabcontentframe\"> ".toCharArray();
    _jsp_string66 = "\",\r\n			        iframe:\"tabcontentframe\",\r\n			        staticOnLoad:true,\r\n			        objName:\"".toCharArray();
    _jsp_string54 = "\r\n<!--For wui-->\r\n<link type='text/css' rel='stylesheet'  href='/wui/theme/".toCharArray();
    _jsp_string93 = "&needPopupNewPage=true&dfdfid=b&needall=1&usedtodo=1\"\r\n						target=\"tabcontentframe\"> ".toCharArray();
    _jsp_string74 = "&needPopupNewPage=true&dfdfid=b&needall=0\");\r\n			    }else{\r\n			    	var _tabck = getcookie(\"wfcookie\");\r\n			    	$(\"#tab_1\").removeClass(\"current\");\r\n			    	$(\"#tab_2\").removeClass(\"current\");\r\n			    	$(\"#tab_3\").removeClass(\"current\");\r\n			    	if(offical === \"1\"){\r\n			    		$(\"#tabcontentframe\").attr(\"src\",\"/workflow/request/RequestTypeOffical.jsp?".toCharArray();
    ...
    _jsp_string77 = "&needPopupNewPage=true&dfdfid=a&needall=1\")\r\n			    		else\r\n			    			$(\"#tabcontentframe\").attr(\"src\",\"/workflow/request/RequestTypeShow.jsp?".toCharArray();
    _jsp_string56 = "/wui_wev8.css'/>\r\n".toCharArray();
    _jsp_string69 = "\";\r\n			    var cywf = \"".toCharArray();
    _jsp_string88 = "\r\n				<li id=\"tab_3\">\r\n					<a onclick=\"setcookie('wfcookie',2)\" href=\"/workflow/request/RequestTypeShow.jsp?".toCharArray();
    ...
    _jsp_string78 = "&needPopupNewPage=true&dfdfid=a&needall=1\");\r\n		    		}\r\n			    	else if(_tabck == 1)\r\n			    	{\r\n			    		$(\"#tab_2\").addClass(\"current\");\r\n			    		if(showtype === \"1\")\r\n				    		$(\"#tabcontentframe\").attr(\"src\",\"/workflow/request/RequestTypeShowWithLetter.jsp?".toCharArray();
    _jsp_string61 = ")\">\r\n".toCharArray();
    ...
    _jsp_string92 = " </a>\r\n				</li>\r\n				<li id=\"tab_2\">\r\n					<a onclick=\"setcookie('wfcookie',1)\" href=\"/workflow/request/RequestTypeShowWithLetter.jsp?".toCharArray();
    ...
    _jsp_string86 = "&needPopupNewPage=true&dfdfid=b&needall=0\"\r\n						target=\"tabcontentframe\"> ".toCharArray();
    ...
    _jsp_string90 = "</a>\r\n				</li>\r\n                ".toCharArray();
    _jsp_string85 = " </a>\r\n				</li>\r\n				<li id=\"tab_2\">\r\n					<a onclick=\"setcookie('wfcookie',1)\" href=\"/workflow/request/RequestTypeShow.jsp?".toCharArray();
    ...
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string79 = "&needPopupNewPage=true&dfdfid=b&needall=0\")\r\n			    		else\r\n			    			$(\"#tabcontentframe\").attr(\"src\",\"/workflow/request/RequestTypeShow.jsp?".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    ...
    _jsp_string71 = "\";\r\n			    var offical = \"".toCharArray();
    _jsp_string70 = "\";\r\n			    var commonuse = \"".toCharArray();

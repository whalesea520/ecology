...
public class _workflowmanagesignforbill__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      out.write(_jsp_string0, 0, _jsp_string0.length);
      weaver.conn.RecordSet rs02;
      rs02 = (weaver.conn.RecordSet) pageContext.getAttribute("rs02");
      if (rs02 == null) {
        rs02 = new weaver.conn.RecordSet();
        pageContext.setAttribute("rs02", rs02);
      }
      out.write(_jsp_string2, 0, _jsp_string2.length);
      weaver.conn.RecordSet rs03;
      rs03 = (weaver.conn.RecordSet) pageContext.getAttribute("rs03");
      if (rs03 == null) {
        rs03 = new weaver.conn.RecordSet();
        pageContext.setAttribute("rs03", rs03);
      }
      ...
      out.write(_jsp_string0, 0, _jsp_string0.length);
      weaver.workflow.node.NodeOverTimeInfo NodeOverTimeInfo;
      NodeOverTimeInfo = (weaver.workflow.node.NodeOverTimeInfo) pageContext.getAttribute("NodeOverTimeInfo");
      if (NodeOverTimeInfo == null) {
        NodeOverTimeInfo = new weaver.workflow.node.NodeOverTimeInfo();
        pageContext.setAttribute("NodeOverTimeInfo", NodeOverTimeInfo);
      }
      out.write(_jsp_string0, 0, _jsp_string0.length);
...
if (_isbill == 1) {
    ...
    needcheck="";
      ...
      out.print((_intervenorusernames));
      if(_intervenorusernames.equals("")){
      out.write(_jsp_string19, 0, _jsp_string19.length);
      }
      out.write(_jsp_string20, 0, _jsp_string20.length);
      out.print((_intervenoruseridsType));
      out.write(_jsp_string21, 0, _jsp_string21.length);
      out.print((_intervenoruserids));
...
if (!"true".equals(_isPrint)) {
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/request/WorkflowManageSignForBill.jsp"), -1835559161460091014L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string420 = "\" value=\"0\">\r\n        <input type=\"hidden\" id=\"requestLogDataMaxRquestLogId\" value=\"0\">\r\n        ".toCharArray();
    _jsp_string150 = "&f_weaver_belongto_usertype=".toCharArray();
    _jsp_string115 = "\r\n                                        </div>\r\n                           \r\n                                        ".toCharArray();
    ...
    _jsp_string96 = "\",\r\n                                                      userid : \"".toCharArray();
    _jsp_string305 = "&creater=".toCharArray();
    _jsp_string229 = "\r\n            if(ischeckok==\"true\"){\r\n            	CkeditorExt.updateContent();\r\n                if(checktimeok()) {\r\n                	$GetEle(\"src\").value='save';\r\n                        jQuery($GetEle(\"flowbody\")).attr(\"onbeforeunload\", \"\");//added by xwj for td3425 20051231\r\n                        obj.disabled=true;\r\n                        var isSubmitDirect = \"\";\r\n                        if($G(\"SubmitToNodeid\")) {\r\n                            if($G(\"SubmitToNodeid\").value != \"\") {\r\n                            	isSubmitDirect = \"1\";\r\n                            }\r\n                     	}\r\n                        $GetEle(\"topage\").value=\"ViewRequest.jsp?isaffirmance=1&reEdit=0&fromFlowDoc=".toCharArray();
    _jsp_string436 = "\">\r\n	    ".toCharArray();
    _jsp_string249 = "\r\n			for(var tempindex1=0;tempindex1<nodesnum;tempindex1++){\r\n	    		try{\r\n		    		var capitalcount = $GetEle(\"node_\"+tempindex1+\"_capitalcount\").value*1;\r\n		    		var fetchingnumber=$GetEle(\"node_\"+tempindex1+\"_number\").value*1;\r\n		    		if(fetchingnumber<=capitalcount){\r\n			    		for(var tempindex2=0;tempindex2<nodesnum;tempindex2++){\r\n			    			try{\r\n				    			if(tempindex2!=tempindex1&&$GetEle(\"node_\"+tempindex1+\"_capitalid\").value==$GetEle(\"node_\"+tempindex2+\"_capitalid\").value){\r\n				    				fetchingnumber = fetchingnumber*1 + $GetEle(\"node_\"+tempindex2+\"_number\").value*1;\r\n				    			}\r\n				    		}catch(e){\r\n						    	continue;\r\n						    }\r\n			    		}\r\n		    		}\r\n		    		if(fetchingnumber>capitalcount){\r\n		    			alert(\"".toCharArray();
    _jsp_string306 = "&creatertype=".toCharArray();
    _jsp_string282 = ",obj,\"submit\");\r\n            }\r\n        }\r\n      }catch(e){}\r\n	}\r\n\r\nfunction cptcallback(obj){\r\n	CkeditorExt.updateContent();\r\n    if(checktimeok()) {\r\n    	if(\"".toCharArray();
    ...
    _jsp_string141 = "\".split(\",\").length;\r\nvar lenwf = \"".toCharArray();
    _jsp_string474 = "</font>".toCharArray();
    ...
    _jsp_string299 = "</a>\";\r\n    }else{\r\n    rightMenu.style.display=\"none\";\r\n    $GetEle(\"workflownextoperatorfrm\").src=\"/workflow/request/WorkflowNextOperator.jsp?requestid=".toCharArray();
    ...
    _jsp_string221 = "\"==1){//\u8d44\u4ea7\u62a5\u5e9f\u5355\u636e\u660e\u7ec6\u4e2d\u7684\u8d44\u4ea7\u62a5\u5e9f\u6570\u91cf\u5927\u4e8e\u5e93\u5b58\u6570\u91cf\uff0c\u4e0d\u80fd\u63d0\u4ea4\u3002\r\n\r\n            try{\r\n	    	nodesnum = $GetEle(\"nodesnum\").value;\r\n	    	for(var tempindex1=0;tempindex1<nodesnum;tempindex1++){\r\n	    		var capitalcount = $GetEle(\"node_\"+tempindex1+\"_capitalcount\").value*1;\r\n	    		var fetchingnumber=$GetEle(\"node_\"+tempindex1+\"_number\").value*1;\r\n	    		for(var tempindex2=0;tempindex2<nodesnum;tempindex2++){\r\n	    			if(tempindex2!=tempindex1&&$GetEle(\"node_\"+tempindex1+\"_capitalid\").value==$GetEle(\"node_\"+tempindex2+\"_capitalid\").value){\r\n	    				fetchingnumber = fetchingnumber*1 + $GetEle(\"node_\"+tempindex2+\"_number\").value*1;\r\n	    			}\r\n	    		}\r\n	    		if(fetchingnumber>capitalcount){\r\n	    			alert(\"".toCharArray();
    ...
    _jsp_string298 = ");' onclick='pointerXY(event);'>".toCharArray();
    _jsp_string205 = "\"+nodenum+\"".toCharArray();
    _jsp_string243 = "\r\n\r\n  		//add 2014-10-10 \u9a8c\u8bc1\u8d44\u4ea7\u9886\u7528\u7684\u6570\u91cf\r\n\r\n		if(\"".toCharArray();
    _jsp_string362 = " href=\"javascript:signtabchanges(0)\" ".toCharArray();
    ...
    _jsp_string220 = "\"==201&&\"".toCharArray();
    _jsp_string340 = "',requestid:'".toCharArray();
    _jsp_string302 = "\"+\r\n            \"&formid=".toCharArray();
    _jsp_string33 = "';\r\nwindow.__usertype = '".toCharArray();
    _jsp_string485 = "</a> <a class=\"signpage\" href=\"javascript:flipOver(4)\">".toCharArray();
    _jsp_string231 = "\");\r\n										}\r\n										return ;\r\n									}\r\n					        }\r\n					    }catch(e){\r\n					        //\u9644\u4ef6\u4e0a\u4f20\r\n					                    StartUploadAll();\r\n					                    checkuploadcomplet();\r\n					    }\r\n				\r\n".toCharArray();
    _jsp_string134 = "\r\n        initRemark(true);\r\n        ".toCharArray();
    _jsp_string190 = "\"+\"\\\"\"+\"".toCharArray();
    _jsp_string62 = " \r\n	                                	\r\n	                                	".toCharArray();
    _jsp_string476 = "<font\r\n			class=\"allPages\">".toCharArray();
    _jsp_string235 = "'))\r\n            ischeckok=\"true\";\r\n        }\r\n".toCharArray();
    _jsp_string14 = "selected".toCharArray();
    _jsp_string414 = "\r\n        ".toCharArray();
    _jsp_string404 = "</option>\r\n	                        <option value=\"2\">".toCharArray();
    _jsp_string352 = "+\"&workflowid=\"+".toCharArray();
    _jsp_string342 = "\")==true){\r\n									        flag = true;\r\n									    }else{\r\n									        flag = false;\r\n									    }\r\n									}else{//\u7981\u6b62\u63d0\u4ea4\r\n										alert(\"".toCharArray();
    _jsp_string120 = "\r\n                                        ".toCharArray();
    ...
    _jsp_string68 = "style=\"display:none;\"".toCharArray();
    ...
    _jsp_string486 = "</a>".toCharArray();
    _jsp_string446 = "\r\n			  	<div id=\"searchInfo_2\">\r\n				    <input type=\"hidden\" id=\"allItems\" value=\"".toCharArray();
    _jsp_string268 = "]\").val()*1+\",\"+jQuery(\"input[name=field".toCharArray();
    _jsp_string274 = "\"==1){//\u8d44\u4ea7\u62a5\u5e9f\u5355\u636e\u660e\u7ec6\u4e2d\u7684\u8d44\u4ea7\u62a5\u5e9f\u6570\u91cf\u5927\u4e8e\u5e93\u5b58\u6570\u91cf\uff0c\u4e0d\u80fd\u63d0\u4ea4\u3002\r\n\r\n            try{\r\n	    	nodesnum = $GetEle(\"nodesnum\").value;\r\n	    	for(var tempindex1=0;tempindex1<nodesnum;tempindex1++){\r\n	    		try{\r\n		    		var capitalcount = $GetEle(\"node_\"+tempindex1+\"_capitalcount\").value*1;\r\n		    		var fetchingnumber=$GetEle(\"node_\"+tempindex1+\"_number\").value*1;\r\n		    		if(fetchingnumber<=capitalcount){\r\n			    		for(var tempindex2=0;tempindex2<nodesnum;tempindex2++){\r\n			    			try{\r\n				    			if(tempindex2!=tempindex1&&$GetEle(\"node_\"+tempindex1+\"_capitalid\").value==$GetEle(\"node_\"+tempindex2+\"_capitalid\").value){\r\n				    				fetchingnumber = fetchingnumber*1 + $GetEle(\"node_\"+tempindex2+\"_number\").value*1;\r\n				    			}\r\n			    			}catch(e){\r\n						    	continue;\r\n						    }\r\n			    		}\r\n		    		}\r\n		    		if(fetchingnumber>capitalcount){\r\n		    			alert(\"".toCharArray();
    _jsp_string47 = "\r\n                        <COL width=\"*\">\r\n                        </COLGROUP>\r\n						".toCharArray();
    ...
    _jsp_string334 = "\" //xwj for td3665 20060224\r\n	}\r\n	else\r\n	{\r\n		displayAllmenu();\r\n		return false;\r\n	}\r\n}\r\nfunction doCancel(obj){\r\n	//\u60a8\u786e\u5b9a\u8981\u64a4\u9500\u5f53\u524d\u6d41\u7a0b\u5417?\r\n	if(confirm(\"".toCharArray();
    _jsp_string76 = "</textarea>\r\n                           		</div>\r\n                            </td>\r\n			    		 ".toCharArray();
    _jsp_string375 = "\r\n		   \r\n		   \r\n		   ".toCharArray();
    _jsp_string224 = "\"==1){//\u8d44\u4ea7\u9886\u7528\u5355\u636e\u660e\u7ec6\u4e2d\u7684\u8d44\u4ea7\u9886\u7528\u6570\u91cf\u5927\u4e8e\u5e93\u5b58\u6570\u91cf\uff0c\u4e0d\u80fd\u63d0\u4ea4\u3002\r\n\r\n    		try{\r\n	    	nodesnum = $GetEle(\"nodesnum\").value;\r\n	    	for(var tempindex1=0;tempindex1<nodesnum;tempindex1++){\r\n	    		var capitalcount = $GetEle(\"node_\"+tempindex1+\"_capitalcount\").value*1;\r\n	    		var fetchingnumber=$GetEle(\"node_\"+tempindex1+\"_number\").value*1;\r\n	    		for(var tempindex2=0;tempindex2<nodesnum;tempindex2++){\r\n	    			if(tempindex2!=tempindex1&&$GetEle(\"node_\"+tempindex1+\"_capitalid\").value==$GetEle(\"node_\"+tempindex2+\"_capitalid\").value){\r\n	    				fetchingnumber = fetchingnumber*1 + $GetEle(\"node_\"+tempindex2+\"_number\").value*1;\r\n	    			}\r\n	    		}\r\n	    		if(fetchingnumber>capitalcount){\r\n	    			alert(\"".toCharArray();
    ...
    _jsp_string300 = "&isremark=".toCharArray();
    _jsp_string198 = "').value;\r\n	   	nodesnum = nodesnum*1;\r\n	   	if(rowneed==\"1\")\r\n	   	{\r\n	   		if(nodesnum>0)\r\n	   		{\r\n	   			nodenum = 0;\r\n	   		}\r\n	   		else\r\n	   		{\r\n	   			nodenum = '".toCharArray();
    ...
    _jsp_string146 = "\".split(\",\").length);\r\n	jQuery(\"#signworkflowidsTD\").parent().parent().parent().parent().show();\r\n}\r\nif(lendoc>1||(lendoc ==1&&!\"".toCharArray();
    _jsp_string130 = "\r\n				                    </span>\r\n				                    </div>\r\n                                </div>\r\n                             </td>\r\n                        </tr>\r\n                    </table>\r\n\r\n</div>\r\n".toCharArray();
    _jsp_string175 = "\r\n	jQuery(\"#remarkShadowDiv1\").trigger(\"click\");\r\n".toCharArray();
    _jsp_string439 = "\">\r\n        <input type=\"hidden\" id=\"sign_relreqid\" value=\"".toCharArray();
    _jsp_string432 = "\">\r\n	    <!--\u603b\u4fe1\u606f\u6570-->\r\n	    <input type=\"hidden\" id=\"perItem\" value=\"".toCharArray();
    _jsp_string333 = "?\")){\r\n		jQuery($GetEle(\"flowbody\")).attr(\"onbeforeunload\", \"\");\r\n		enableAllmenu();\r\n		document.location.href=\"/workflow/workflow/wfFunctionManageLink.jsp?flag=stop&requestid=".toCharArray();
    _jsp_string326 = "\r\n        showtipsinfoReturn(\"\", src, \"\", \"\", \"\", \"\");\r\n        ".toCharArray();
    _jsp_string478 = " <a ".toCharArray();
    _jsp_string153 = "&url=\" + url + \"?documentids=\" + tmpids + uescape(\"&f_weaver_belongto_userid=".toCharArray();
    _jsp_string95 = "\",\r\n                                                      annexsecId : \"".toCharArray();
    _jsp_string214 = "\"))\r\n    return false; \r\n	}\r\n        try{\r\n            //\u4e3a\u4e86\u5bf9\u300a\u5de5\u4f5c\u5b89\u6392\u300b\u6d41\u7a0b\u4f5c\u7279\u6b8a\u7684\u5904\u7406\uff0c\u8bf7\u53c2\u8003MR1010\r\n            $GetEle(\"planDoRemark\").click();\r\n            //obj.disabled=true;\r\n        }catch(e){\r\n        	$GetEle(\"isremark\").value='".toCharArray();
    ...
    _jsp_string384 = "show".toCharArray();
    _jsp_string256 = "\r\n					\r\n			for(var tempindex1=0;tempindex1<nodesnum;tempindex1++){\r\n	    		try{\r\n		    		var capitalcount = $GetEle(\"node_\"+tempindex1+\"_capitalcount\").value*1;\r\n		    		var fetchingnumber=$GetEle(\"node_\"+tempindex1+\"_number\").value*1;\r\n		    		if(fetchingnumber<=capitalcount){\r\n			    		for(var tempindex2=0;tempindex2<nodesnum;tempindex2++){\r\n			    			try{\r\n				    			if(tempindex2!=tempindex1&&$GetEle(\"node_\"+tempindex1+\"_capitalid\").value==$GetEle(\"node_\"+tempindex2+\"_capitalid\").value){\r\n				    				fetchingnumber = fetchingnumber*1 + $GetEle(\"node_\"+tempindex2+\"_number\").value*1;\r\n				    			}\r\n			    			}catch(e){\r\n						    	continue;\r\n						    }\r\n			    		}\r\n		    		}\r\n		    		if(fetchingnumber>capitalcount){\r\n		    			alert(\"".toCharArray();
    ...
    _jsp_string331 = "\r\n                    }\r\n                }else{\r\n                	$GetEle(\"src\").value=src;\r\n                    jQuery($GetEle(\"flowbody\")).attr(\"onbeforeunload\", \"\");\r\n                    if(obj!=\"\"){\r\n					    obj.disabled=true;\r\n				    }\r\n//\u4fdd\u5b58\u7b7e\u7ae0\u6570\u636e\r\n".toCharArray();
    _jsp_string199 = "';\r\n	   		}\r\n	   	}\r\n	   	else\r\n	   	{\r\n	   		nodenum = 0;\r\n	   	}\r\n	   	if(nodenum>0)\r\n	   	{\r\n	   		return nodenum;\r\n	   	}\r\n	   	".toCharArray();
    _jsp_string152 = "&documentids=\" + tmpids;\r\n					   url = \"/systeminfo/BrowserMain.jsp?f_weaver_belongto_userid=".toCharArray();
    _jsp_string281 = ",0,".toCharArray();
    _jsp_string51 = "\r\n                                </a>\r\n                            ".toCharArray();
    _jsp_string29 = "');\r\n	})\r\n\r\n\r\n	</script>\r\n".toCharArray();
    ...
    _jsp_string387 = "showHuser".toCharArray();
    _jsp_string269 = "]\").val()*1+\",".toCharArray();
    _jsp_string75 = " onChange=\"checkinput('remark','remarkSpan')\" ".toCharArray();
    _jsp_string65 = "\r\n	                                	</span>\r\n                                	</div>\r\n                           		</div>\r\n			                <div class='signaturebyhand' style=\"display: none\">\r\n			                    ".toCharArray();
    _jsp_string355 = "+\"&formid=\"+".toCharArray();
    _jsp_string140 = "\".split(\",\").length;\r\nvar lenwd = \"".toCharArray();
    ...
    _jsp_string255 = "',function(){\r\n							cptcallback(obj);\r\n						});\r\n						return;\r\n					}\r\n			".toCharArray();
    _jsp_string385 = "hide".toCharArray();
    ...
    _jsp_string336 = "\" //xwj for td3665 20060224\r\n	}\r\n	else\r\n	{\r\n		displayAllmenu();\r\n		return false;\r\n	}\r\n}\r\nfunction doRestart(obj)\r\n{\r\n	//\u60a8\u786e\u5b9a\u8981\u542f\u7528\u5f53\u524d\u6d41\u7a0b\u5417?\r\n	if(confirm(\"".toCharArray();
    _jsp_string303 = "&isbill=".toCharArray();
    _jsp_string292 = ",\"\",\"reject\");\r\n        }\r\n    }\r\n\r\n	function doReopen(){        <!-- \u70b9\u51fb\u91cd\u65b0\u6fc0\u6d3b -->\r\n        try{\r\n            //\u4e3a\u4e86\u5bf9\u300a\u5de5\u4f5c\u5b89\u6392\u300b\u6d41\u7a0b\u4f5c\u7279\u6b8a\u7684\u5904\u7406\uff0c\u8bf7\u53c2\u8003MR1010\r\n            $GetEle(\"planDoReopen\").click();\r\n        }catch(e){\r\n        	$GetEle(\"src\").value='reopen';\r\n            $GetEle(\"remark\").value += \"\\n".toCharArray();
    _jsp_string291 = ",1,".toCharArray();
    _jsp_string313 = "\"+fileLenthByM+\"M,".toCharArray();
    _jsp_string261 = "\";\r\n				 }\r\n			}\r\n			".toCharArray();
    _jsp_string159 = "' target='_blank' style=\\\"color:#123885;\\\">\"+curname+ \"</a>&nbsp;&nbsp;\"; \r\n	                } else {\r\n	                	//sHtml = sHtml + \"<a href=\" + linkurl + curid + \" target='_blank'>\" + curname + \"</a> &nbsp; \";                	  \r\n	                	sHtml += \"<a href='/workflow/request/ViewRequest.jsp?f_weaver_belongto_userid=".toCharArray();
    _jsp_string67 = "\r\n                         <tr ".toCharArray();
    _jsp_string455 = "\" style=\"display:none;\">\r\n		          <input type=\"hidden\" id=\"sign_relwfid\" value=\"".toCharArray();
    ...
    _jsp_string258 = "\r\n			if(returnval==true){\r\n				return;\r\n			}\r\n			}catch(e){}\r\n		}\r\n		//\u9a8c\u8bc1\u8d44\u4ea7\u8c03\u62e8\u7684\u6570\u91cf\r\n\r\n		if(\"".toCharArray();
    _jsp_string284 = "\"==3){//\u5982\u679c\u63d0\u4ea4\u7684\u4e0b\u4e00\u4e2a\u8282\u70b9\u4e3a\u5f52\u6863\u8282\u70b9\uff0c\u68c0\u67e5\u5e93\u5b58\u662f\u5426\u8db3\u591f\uff0c\u4e0d\u8db3\u4e0d\u5141\u8bb8\u63d0\u4ea4\u5230\u4e0b\u4e00\u4e2a\u8282\u70b9\u3002\r\n\r\n    			try{\r\n    			nodesnum = $GetEle(\"nodesnum\").value;\r\n				    	for(var tempindex1=0;tempindex1<nodesnum;tempindex1++){\r\n				    		var capitalcount = $GetEle(\"node_\"+tempindex1+\"_capitalcount\").value*1;\r\n				    		var fetchingnumber=$GetEle(\"node_\"+tempindex1+\"_number\").value*1;\r\n				    		for(var tempindex2=0;tempindex2<nodesnum;tempindex2++){\r\n				    			if(tempindex2!=tempindex1&&$GetEle(\"node_\"+tempindex1+\"_capitalid\").value==$GetEle(\"node_\"+tempindex2+\"_capitalid\").value){\r\n				    				fetchingnumber = fetchingnumber*1 + $GetEle(\"node_\"+tempindex2+\"_number\").value*1;\r\n				    			}\r\n				    		}\r\n				    		if(fetchingnumber>capitalcount){\r\n				    			alert(\"".toCharArray();
    ...
    _jsp_string437 = "\r\n	    <!--\u603b\u5171\u9875\u6570-->\r\n	    <input type=\"hidden\" id=\"prePage\" value=\"".toCharArray();
    _jsp_string466 = "\r\n		\r\n		\r\n	".toCharArray();
    _jsp_string316 = "\"+maxsize+\"".toCharArray();
    _jsp_string189 = "\r\n						try{  \r\n					        if(typeof(eval(\"SaveSignature\"))==\"function\"){\r\n					              if(SaveSignature()){\r\n									    //\u9644\u4ef6\u4e0a\u4f20\r\n					                    StartUploadAll();\r\n					                    checkuploadcomplet();\r\n									}else{\r\n										if(isDocEmpty==1){\r\n											alert(\"\\\"\"+\"".toCharArray();
    _jsp_string440 = "\">\r\n        \r\n        ".toCharArray();
    _jsp_string246 = "		//alert(\"a\");\r\n			if(poststr.length){\r\n				checkformanager(poststr,'".toCharArray();
    _jsp_string162 = "\";\r\n	    if(jQuery.browser.msie){\r\n			dialog.Height = 570;\r\n		}else{\r\n			dialog.Height = 570;\r\n		}\r\n    }\r\n    \r\n    dialog.Drag = true;\r\n    //dialog.maxiumnable = true;\r\n    dialog.show();\r\n    ".toCharArray();
    _jsp_string40 = "<span style=\"color:#3f91ff;margin:0 2px;\">".toCharArray();
    ...
    _jsp_string359 = "\r\n			judgeBrowserPrint();\r\n		".toCharArray();
    _jsp_string386 = "\" class=\"tbItm back-end backgroundPosition ".toCharArray();
    _jsp_string74 = " temptitle=\"".toCharArray();
    _jsp_string21 = "\">\r\n                 <input type=hidden name=\"Intervenorid\" value=\"".toCharArray();
    _jsp_string468 = "\r\n		</ol>\r\n		<div class=\"ps-scrollbar-x\" style=\"display: none; left: 0px; bottom: 3px; width: 0px;\">\r\n		</div>\r\n		<div class=\"ps-scrollbar-y\" style=\"display: none; right: 0px; height: 0px;\">\r\n		</div>\r\n	</div>\r\n<!-- \r\n</div>\r\n -->\r\n\r\n\r\n	".toCharArray();
    _jsp_string163 = "\r\n	//\u5f53\u6709\u5f39\u7a97\u65f6\u5173\u95ed\u8868\u5355\u7b7e\u7ae0,\u5426\u5219\u663e\u793a\u767d\u8272\u5e95\u8272\u548c\u5f39\u7a97\u51b2\u7a81\r\n\r\n\r\n		if(top.Dialog._Array.length == 1){\r\n			var consTimer = window.setInterval(function(){\r\n				  if(top.Dialog._Array.length < dialognum){   \r\n				        jQuery(\"[id^=Consult]\").show();\r\n				        clearInterval(this);\r\n				  }else{\r\n				      	jQuery(\"[id^=Consult]\").hide();\r\n				  }\r\n			},300);\r\n	    }\r\n	".toCharArray();
    _jsp_string19 = "<img src='/images/BacoError_wev8.gif' align=absmiddle>".toCharArray();
    ...
    _jsp_string151 = "&url=\" + url + \"?f_weaver_belongto_userid=".toCharArray();
    _jsp_string71 = "\" onclick=\"initRemark()\" title=\"".toCharArray();
    _jsp_string335 = "?\")){\r\n		jQuery($GetEle(\"flowbody\")).attr(\"onbeforeunload\", \"\");\r\n		enableAllmenu();\r\n		document.location.href=\"/workflow/workflow/wfFunctionManageLink.jsp?flag=cancel&requestid=".toCharArray();
    ...
    _jsp_string225 = "\");\r\n	    			return;\r\n	    		}\r\n	    	}\r\n	    	}catch(e){}\r\n    	}\r\n\r\n                        obj.disabled=true;\r\n                        $GetEle(\"src\").value='save';\r\n                        jQuery($GetEle(\"flowbody\")).attr(\"onbeforeunload\", \"\");//added by xwj for td3425 20051231\r\n\r\n//\u4fdd\u5b58\u7b7e\u7ae0\u6570\u636e\r\n".toCharArray();
    _jsp_string400 = "</option>\r\n				     ".toCharArray();
    _jsp_string252 = "\"==1){\r\n			try{\r\n			var nodesum = $GetEle(\"nodesnum\").value;\r\n			var poststr=\"\";\r\n			var returnval=\"\";\r\n			for(var i=0;i<nodesum;i++){\r\n				if($GetEle(\"node_\"+i+\"_capitalid\")== null){\r\n						continue;\r\n					}else{\r\n						 poststr += \"|\"+$GetEle(\"node_\"+i+\"_capitalid\").value*1+\",\"+$GetEle(\"node_\"+i+\"_number\").value*1+\",".toCharArray();
    _jsp_string346 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string418 = "' style=\"position:absolute;top:20px;display: none; text-align: center; width: 100%; height: 18px; overflow: hidden;\"> <img src=\"/images/loading2_wev8.gif\" style=\"vertical-align: middle;\"> &nbsp; <span style=\"vertical-align: middle; line-height: 100%;\">".toCharArray();
    _jsp_string24 = "\r\n         \r\n         \r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string363 = "style=\"color:black!important;\"".toCharArray();
    ...
    _jsp_string408 = "</option>\r\n	                        <option value=\"6\">".toCharArray();
    _jsp_string186 = "\r\nif(ischeckok==\"true\"){\r\n	if (\"".toCharArray();
    _jsp_string312 = " \");\r\n		}\r\n        createAndRemoveObj(obj);\r\n        return  ;\r\n    }\r\n    if (fileLenth==-1) {\r\n        createAndRemoveObj(obj);\r\n        return ;\r\n    }\r\n    var fileLenthByM = (fileLenth/(1024*1024)).toFixed(1)\r\n    if (fileLenthByM>maxUploadImageSize) {\r\n     	alert(\"".toCharArray();
    _jsp_string473 = "<font class=\"allItems\">".toCharArray();
    _jsp_string203 = ";\r\n		       		}\r\n		       	}\r\n		       	else\r\n		       	{\r\n		       		nodenum = 0;\r\n		       	}\r\n		       	".toCharArray();
    _jsp_string479 = " class=\"signpage\" ".toCharArray();

...
public class _choosecreator__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	String workflowid = request.getParameter("workflowid");
      ...
      out.print((SystemEnv.getHtmlLabelName(84492,user.getLanguage())));
      out.write(_jsp_string130, 0, _jsp_string130.length);
      out.print((workflowid));
      out.write(_jsp_string131, 0, _jsp_string131.length);
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("workflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(125357,user.getLanguage()), null), false);
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(125357,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(84493,user.getLanguage())));
                out.write(_jsp_string136, 0, _jsp_string136.length);
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(32457,user.getLanguage()) ));
                out.write(_jsp_string139, 0, _jsp_string139.length);
                out.print((SystemEnv.getHtmlLabelName(32458,user.getLanguage()) ));
                ...
                _jsp_BrowserTag_3.setGetBrowserUrlFn("showBrowserByCreaterType");
                _jsp_BrowserTag_3.setIsMustInput("1");
                _jsp_BrowserTag_3.setIsSingle("true");
                _jsp_BrowserTag_3.setHasInput("true");
                _jsp_BrowserTag_3.setCompleteUrl("javascript:getajaxurl($('[name=creatertype]').val() == '1' ? '1' : '7')");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/request/ChooseCreator.jsp"), -1771734203690068563L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string133 = "\" class=\"e8_btn_top\" onclick=\"pager.doSave()\" />\r\n					<span title=\"".toCharArray();
    _jsp_string91 = "px\">\r\n		</iframe>\r\n	</div>\r\n".toCharArray();
    ...
    _jsp_string145 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.closeByHand()\">\r\n						".toCharArray();
  }
}

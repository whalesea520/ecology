...
public class _workflowmultiprintmiddlehandler__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.workflow.workflow.WorkFlowUtil WorkFlowUtil;
      WorkFlowUtil = (weaver.workflow.workflow.WorkFlowUtil) pageContext.getAttribute("WorkFlowUtil");
      if (WorkFlowUtil == null) {
        WorkFlowUtil = new weaver.workflow.workflow.WorkFlowUtil();
        pageContext.setAttribute("WorkFlowUtil", WorkFlowUtil);
      }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/request/WorkflowMultiPrintMiddleHandler.jsp"), 8576314762270129901L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

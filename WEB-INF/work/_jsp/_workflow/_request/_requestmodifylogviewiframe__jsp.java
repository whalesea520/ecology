...
public class _requestmodifylogviewiframe__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.workflow.field.FieldValue FieldValue;
      FieldValue = (weaver.workflow.field.FieldValue) pageContext.getAttribute("FieldValue");
      if (FieldValue == null) {
        FieldValue = new weaver.workflow.field.FieldValue();
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(15275, user.getLanguage())));
      ...
      out.print((RecordSet.getString("nodeName")));
      ...
      out.print((Util.toScreen(ResourceComInfo.getDepartmentID(RecordSet.getString("agentId")),user.getLanguage())));
      out.write(_jsp_string147, 0, _jsp_string147.length);
      out.print((Util.toScreen(DepartmentComInfo.getDepartmentname(ResourceComInfo.getDepartmentID(RecordSet.getString("agentId"))),user.getLanguage())));
      out.write(_jsp_string148, 0, _jsp_string148.length);
      out.print((RecordSet.getString("agentId")));
      out.write(_jsp_string149, 0, _jsp_string149.length);
      out.print((Util.toScreen(ResourceComInfo.getResourcename(RecordSet.getString("agentId")), user.getLanguage())));
      out.write(_jsp_string150, 0, _jsp_string150.length);
      
											}
											
      out.write(_jsp_string146, 0, _jsp_string146.length);
      out.print((Util.toScreen(ResourceComInfo.getDepartmentID(RecordSet.getString("modifierid")),user.getLanguage())));
      out.write(_jsp_string147, 0, _jsp_string147.length);
      out.print((Util.toScreen(DepartmentComInfo.getDepartmentname(ResourceComInfo.getDepartmentID(RecordSet.getString("modifierid"))),user.getLanguage())));
      out.write(_jsp_string151, 0, _jsp_string151.length);
      out.print((RecordSet.getString("modifierid")));
      out.write(_jsp_string149, 0, _jsp_string149.length);
      out.print((Util.toScreen(ResourceComInfo.getResourcename(RecordSet.getString("modifierid")), user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(RecordSet.getInt("fieldLableId"), user.getLanguage())));
      ...
      out.print((RecordSet.getString("fieldNameCn")));
      }else if(user.getLanguage()==9){
      out.print((RecordSet.getString("fieldNameTw")));
      }else{
      out.print((RecordSet.getString("fieldNameEn")));
      }
      out.write(_jsp_string172, 0, _jsp_string172.length);
      ...
      out.write(_jsp_string144, 0, _jsp_string144.length);
      out.print((SystemEnv.getHtmlLabelName(623, user.getLanguage())));
      out.write(_jsp_string173, 0, _jsp_string173.length);
      out.print((showname1));
      out.write(_jsp_string174, 0, _jsp_string174.length);
      out.print((SystemEnv.getHtmlLabelName(21623, user.getLanguage())));
      out.write(_jsp_string173, 0, _jsp_string173.length);
      out.print((showname2));
      ...
      out.print((SystemEnv.getHtmlLabelName(623, user.getLanguage())));
      out.write(_jsp_string173, 0, _jsp_string173.length);
      out.print((FieldValue.getFieldValue(session, RecordSet.getInt("fieldid"), RecordSet.getInt("fieldHtmlType"), RecordSet.getInt("fieldType"), Util.null2String(RecordSet.getString("fieldOldText")), RecordSet.getInt("isBill"))));
      out.write(_jsp_string174, 0, _jsp_string174.length);
      ...
      out.print((SystemEnv.getHtmlLabelName(21623, user.getLanguage())));
      out.write(_jsp_string173, 0, _jsp_string173.length);
      out.print((FieldValue.getFieldValue(session, RecordSet.getInt("fieldid"), RecordSet.getInt("fieldHtmlType"), RecordSet.getInt("fieldType"), Util.null2String(RecordSet.getString("fieldNewText")), RecordSet.getInt("isBill"))));
      out.write(_jsp_string175, 0, _jsp_string175.length);
...
if (cnt == 0) {
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/request/RequestModifyLogViewIframe.jsp"), 4759147787947329271L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string183 = "';\r\nfunction doViewAll(flag) {\r\n	location.href = URL+\"&isAll=\"+flag+\"&ismonitor=".toCharArray();
    ...
    _jsp_string149 = ");\" onclick='pointerXY(event);'>\r\n											".toCharArray();
    ...
    _jsp_string136 = "</th>\r\n									<th>".toCharArray();
    _jsp_string151 = "</a>\r\n	               							/\r\n											<a\r\n												href=\"javaScript:openhrm(".toCharArray();
    ...
    _jsp_string182 = "&nodeid=".toCharArray();
    ...
    _jsp_string159 = ");\" onclick='pointerXY(event);'>\r\n									".toCharArray();
    _jsp_string186 = "';\r\n}\r\n</script>".toCharArray();
    ...
    _jsp_string150 = "</a>\r\n											->\r\n											".toCharArray();
    _jsp_string3 = "\r\n	<script language=\"javascript\">\r\n		window.top.Dialog.alert(\"".toCharArray();
    _jsp_string181 = "\" class=\"cornerMenu\" id=\"rightclickcornerMenu\"></span>\r\n		</td>\r\n	</tr>\r\n</table>\r\n					\r\n</BODY>\r\n</HTML>\r\n\r\n<script>\r\nvar URL = '/workflow/request/RequestModifyLogViewIframe.jsp?requestid=".toCharArray();
    _jsp_string163 = " <!-- content start -->\r\n									<table id=dettb border=\"0\" cellpadding=\"0\" cellspacing=\"0\"\r\n										width=\"100%\">\r\n										<tr>\r\n											<td>".toCharArray();
    ...
    _jsp_string184 = "&urger=".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    ...
    _jsp_string152 = "</a>\r\n											".toCharArray();
    _jsp_string185 = "\";\r\n}\r\nfunction doBack() {\r\n	location.href = 'ViewRequest.jsp?requestid=".toCharArray();
  }
}

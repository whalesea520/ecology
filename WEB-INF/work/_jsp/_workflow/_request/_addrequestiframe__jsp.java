...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((version==2?"":"margin-top:10px;" ));
      ...
      out.print((SystemEnv.getHtmlLabelName(15805,user.getLanguage())));
...
if(modeid<1 || ismode.equals("2")){
    ...
    if(modeid>0 && "1".equals(ismode)){
      ...
      out.print((SystemEnv.getHtmlLabelName(24270,user.getLanguage())));
...
if( isCptwf){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/request/AddRequestIframe.jsp"), 4843301123522193211L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string237 = "&url=\" + url + \"?documentids=\" + tmpids;\r\n        dialog.Title = \"".toCharArray();
    _jsp_string165 = "\r\n			".toCharArray();
    ...
    _jsp_string195 = "&requestid=".toCharArray();
    ...
    _jsp_string298 = "\r\n                    //TD4262 \u589e\u52a0\u63d0\u793a\u4fe1\u606f  \u5f00\u59cb\r\n\r\n\r\n                ".toCharArray();
    _jsp_string207 = "\";\r\n\r\n	if(".toCharArray();
    _jsp_string247 = "&formid=".toCharArray();
    _jsp_string320 = "+\"_\"+i+\"']\").val();//\u9886\u7528\u7684\u8d44\u4ea7id\r\n				    if(zcid==undefined||zcid==\"\"){continue;}\r\n				    var cptnum = jQuery(\"input[name='field\"+".toCharArray();
    _jsp_string245 = "&nodeid=".toCharArray();
    ...
    _jsp_string300 = "\r\n                }\r\n            }\r\n        }\r\n	});\r\n}\r\n\r\nfunction doImportWorkflow(){\r\n	//\u4e0d\u518d\u9a8c\u8bc1\u662f\u5426\u586b\u5199\u6807\u9898\uff0c\u5982\u679c\u6ca1\u6709\u6dfb\u52a0\uff0c\u5219\u6839\u636e\u89c4\u5219\u751f\u6210\u4e00\u4e2a\r\n\r\n\r\n    //if(check_form($GetEle(\"frmmain\"),\"requestname\")){\r\n    	var dialog = new window.top.Dialog();\r\n    	dialog.currentWindow = window;\r\n    	//var url = \"/systeminfo/BrowserMain.jsp?url=/workflow/request/RequestImport.jsp?formid=".toCharArray();
    _jsp_string145 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result11\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string224 = ") {\r\n        if (wuiUtil.isNotNull(funFlag) && funFlag == 3) {\r\n        	url = \"/systeminfo/BrowserMain.jsp?url=/docs/docs/DocBrowser.jsp?f_weaver_belongto_userid=".toCharArray();
    ...
    _jsp_string244 = "&workflowid=".toCharArray();
    ...
    _jsp_string239 = "&url=\" + url + \"?resourceids=\" + tmpids;\r\n        dialog.Title = \"".toCharArray();
    ...
    _jsp_string161 = "\"/>\r\n			<input type=\"hidden\" name=\"lastloginuserid\" value=\"".toCharArray();
    _jsp_string179 = "\r\n		\r\n			".toCharArray();
    _jsp_string260 = "\r\n	                    contentBox = document.getElementById(\"divFavContent18979\");\r\n                        showObjectPopup(contentBox)\r\n".toCharArray();
    ...
    _jsp_string302 = "\";\r\n    	var url = \"/systeminfo/BrowserMain.jsp?url=\"+escape(\"/workflow/request/RequestImport.jsp?f_weaver_belongto_userid=".toCharArray();
    _jsp_string156 = "\r\n		 <input type=\"hidden\" name=\"needwfback\" id=\"needwfback\" value=\"1\" />\r\n		 <input type=\"hidden\" name=\"f_weaver_belongto_userid\" value=\"".toCharArray();
    _jsp_string99 = " oncontextmenu='return false'".toCharArray();
    _jsp_string286 = "\r\n	                    //\u9644\u4ef6\u4e0a\u4f20\r\n	                        StartUploadAll();\r\n	                        checkuploadcomplet();\r\n	                ".toCharArray();
    _jsp_string162 = "\">\r\n		   </form>\r\n            ".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string305 = "&newmodeid=".toCharArray();
    _jsp_string9 = "\r\n<script type=\"text/javascript\" src=\"/wui/common/jquery/jquery.min_wev8.js\"></script>\r\n".toCharArray();
    _jsp_string267 = "\";\r\n\r\n//\u4fdd\u5b58\u7b7e\u7ae0\u6570\u636e\r\n".toCharArray();
    _jsp_string172 = "\r\n              <form name=\"frmmain\" method=\"post\"  action=\"".toCharArray();
    _jsp_string266 = "&topage=".toCharArray();
    ...
    _jsp_string301 = "&status=2&ismode=".toCharArray();
    ...
    _jsp_string166 = "\r\n          ".toCharArray();
    _jsp_string153 = "\r\n				".toCharArray();
    _jsp_string76 = " onload=\"windowonload()\" ".toCharArray();
    _jsp_string231 = "){\r\n							var evt = getEvent();\r\n							var targetElement = evt.srcElement ? evt.srcElement : evt.target;\r\n							jQuery(targetElement).next(\"span[id=CreateNewDoc]\").html(\"<button type=button id='createdoc' class=AddDocFlow onclick=createDoc(\" + id + \",'','1') title='".toCharArray();
    _jsp_string269 = "\");\r\n								isDocEmpty=0;\r\n							}else{\r\n								alert(\"".toCharArray();
    _jsp_string173 = "\" style=\"margin-top:10px;\">\r\n            ".toCharArray();
    _jsp_string307 = "&imprequestid=\"+reqid+\"&isfrom=fromcreate\";\r\n        //$GetEle(\"frmmain\").enctype=\"multipart/form-data\"\r\n        jQuery($GetEle(\"flowbody\")).attr(\"onbeforeunload\", \"\");\r\n    ".toCharArray();
    _jsp_string322 = "&ismodecpt=".toCharArray();
    ...
    _jsp_string206 = "\";\r\n	var IsFreeWorkflow = \"".toCharArray();
    _jsp_string184 = "\r\n			\r\n			".toCharArray();
    _jsp_string296 = "\r\n                        //TD4262 \u589e\u52a0\u63d0\u793a\u4fe1\u606f  \u7ed3\u675f\r\n                        //$GetEle(\"frmmain\").submit();\r\n			StartUploadAll();\r\n                        checkuploadcomplet();\r\n                        enableAllmenu();\r\n                    } else {\r\n							if(isDocEmpty==1){\r\n								alert(\"".toCharArray();
    _jsp_string227 = "&fieldid=\" + id.substring(0, index) + \"&resourceids=\" + $GetEle(\"field\"+id).value);\r\n		        	id1 = window.showModalDialog(url + tmpids, \"\", \"dialogWidth=550px;dialogHeight=550px\");\r\n		        } else {\r\n		        	tmpids = uescape(\"?fieldid=\" + id + \"&isbill=".toCharArray();
    ...
    _jsp_string160 = "_addrequest_submit_token\" value=\"".toCharArray();
    _jsp_string295 = "\";\r\n                        showPrompt(content);\r\n                ".toCharArray();
    _jsp_string225 = "\"\r\n        } else {\r\n	    	url = \"/systeminfo/BrowserMain.jsp?url=/docs/docs/DocBrowserWord.jsp?f_weaver_belongto_userid=".toCharArray();
    _jsp_string152 = "\r\n                ".toCharArray();
    ...
    _jsp_string190 = "			\r\n\r\n			".toCharArray();
    _jsp_string235 = "</button>\");\r\n					}\r\n			   }\r\n			}\r\n		}\r\n	}\r\n}\r\n\r\nfunction getDate(i) {\r\n	var returndate = window.showModalDialog(\"/systeminfo/Calendar.jsp?f_weaver_belongto_userid=".toCharArray();
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    ...
    _jsp_string265 = "&isaffirmance=1&reEdit=0&fromFlowDoc=".toCharArray();
    _jsp_string291 = "\";\r\n\r\n		//\u4fdd\u5b58\u7b7e\u7ae0\u6570\u636e\r\n		".toCharArray();
    _jsp_string215 = "\";\r\n\r\n				//\u4fdd\u5b58\u7b7e\u7ae0\u6570\u636e\r\n                ".toCharArray();
    _jsp_string257 = "\r\n\r\n            if(ischeckok==\"true\"){\r\n                if(checktimeok()) {\r\n                    ".toCharArray();
    ...
    _jsp_string204 = "&workflowid=\"+wfid+\"&nodeid=\"+nodeid+\"&reqid=\"+reqid+\"&actionid=dialog&menuid=\" + menuid;\r\n	var dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	dialog.Title = \"".toCharArray();
    _jsp_string106 = "px\">\r\n</iframe>\r\n</div>\r\n".toCharArray();
    _jsp_string65 = "\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();

...
public class _workflowrequestpicture__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (isOldWf_) {
      ...
      out.print((all_allcnt ));
      out.write(_jsp_string84, 0, _jsp_string84.length);
      out.print((SystemEnv.getHtmlLabelName(15945,user.getLanguage())));
      out.write(_jsp_string85, 0, _jsp_string85.length);
      out.print((all_submitcnt ));
      ...
      out.print((SystemEnv.getHtmlLabelName(84657,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(84658,user.getLanguage())));
      ...
      _jsp_BrowserTag_0.setName("resouce");
      ...
      out.print((request.getQueryString().replaceAll("&disnodeid=[^&]*", "").replaceAll("&disresource=[^&]*", "") ));
      out.write(_jsp_string103, 0, _jsp_string103.length);
      out.print((request.getQueryString().replace("&disremark", "&disremark_2") ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/request/WorkflowRequestPicture.jsp"), 4362209796596742233L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string7 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    _jsp_string94 = "\r\n                <span style=\"margin-left:44px;\" >".toCharArray();
    ...
    _jsp_string90 = "\r\n                    </div>\r\n                </td>\r\n            </tr>\r\n        </table>\r\n    </div>\r\n</div>\r\n\r\n    <span onclick=\"toggersearchblock()\" class=\"e8_browflow\" style=\"display:inline-block;position:absolute;right:5px;bottom:5px;cursor:pointer;\" title=\"".toCharArray();
    _jsp_string38 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    ...
    _jsp_string104 = "\";\r\n        \r\n        var sindex = jQuery(this).attr(\"_index\"); \r\n        if (sindex == \"1\") {\r\n            ajaxurl = \"/workflow/request/WorkflowRequestPictureFrame.jsp?_token=\" + new Date().getTime() +\"&".toCharArray();

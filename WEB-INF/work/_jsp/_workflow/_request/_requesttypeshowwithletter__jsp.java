...
public class _requesttypeshowwithletter__jsp extends com.caucho.jsp.JavaPage
{
...
WorkTypeComInfo.setTofirstRow();
 ...
 if(true)
 {
	...
	while(WorkflowComInfo.next()){
      ...
      out.print((colorful[itemcolorindex%5]));
      ...
      out.print((SystemEnv.getHtmlLabelName(84525,user.getLanguage())));
      out.write(_jsp_string203, 0, _jsp_string203.length);
      out.print((SystemEnv.getHtmlLabelName(84526,user.getLanguage())));
      out.write(_jsp_string204, 0, _jsp_string204.length);
      out.print((SystemEnv.getHtmlLabelName(84527,user.getLanguage())));
      out.write(_jsp_string205, 0, _jsp_string205.length);
      out.print((SystemEnv.getHtmlLabelName(84528,user.getLanguage())));
      out.write(_jsp_string206, 0, _jsp_string206.length);
      out.print((SystemEnv.getHtmlLabelName(84529,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/request/RequestTypeShowWithLetter.jsp"), 6582727981994456281L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string216 = "\");\r\n						}\r\n					}\r\n				});  \r\n			  }else if(itemname==='totop'){\r\n				  jQuery(window).scrollTop(0);\r\n			  }else if(itemname==='freewf'){\r\n                jQuery.post('AddWorkflowUseCount.jsp',{wfid:'".toCharArray();
    _jsp_string212 = "&infoId=".toCharArray();
    _jsp_string195 = "\r\n            \r\n			 </div>  \r\n		  ".toCharArray();
    ...
    _jsp_string158 = "	\r\n																 <a style=\"color:grey;margin-left:8px;margin-right:10px;vertical-align: middle;\" href=\"javascript:onNewRequest(".toCharArray();
    _jsp_string43 = "\";\r\n\r\n  if(companyname.length >0 ){\r\n  	window.status = str1+companyname;\r\n  }\r\n</script>\r\n<!-- \u5220\u9664 -->\r\n</head></html>\r\n\r\n<!--USB \u9a8c\u8bc1 -->\r\n".toCharArray();
    _jsp_string226 = "\";\r\n	        document.getElementById(\"isagent\").value=\"".toCharArray();
    _jsp_string222 = "+\"&isagent=\"+".toCharArray();
    _jsp_string117 = "\";\r\n        dialog.Width = 550 ;\r\n        dialog.Height = 600;\r\n        dialog.Drag = true;\r\n        dialog.show();\r\n    });\r\n}\r\n\r\nfunction ___showHelp(flag){\r\n    /*var pathKey = this.location.pathname;\r\n    //alert(pathKey);\r\n    if(pathKey!=\"\"){\r\n        pathKey = pathKey.substr(1);\r\n    }*/\r\n    var pathKey = \"\";\r\n	var __url = this.location.href;\r\n	try {\r\n		var __regexp = new RegExp(\"http://[^/]+\", \"gmi\");\r\n		__url = __url.replace(__regexp, '');\r\n	} catch (e) {}\r\n	pathKey = encodeURIComponent(__url);\r\n    var operationPage = \"http://help.e-cology.com.cn/help/RemoteHelp.jsp\";\r\n    var screenWidth = window.screen.width*1;\r\n    var screenHeight = window.screen.height*1;\r\n    var isEnableExtranetHelp = ".toCharArray();
    _jsp_string223 = "+\"&beagenter=".toCharArray();
    ...
    _jsp_string219 = "&isagent=0&beagenter=0&handdata=".toCharArray();
    _jsp_string61 = ")\">\r\n".toCharArray();
    ...
    _jsp_string173 = "');\" class='opimg'  src='/images/ecology8/addwf_wev8.png' title='".toCharArray();
    ...
    _jsp_string224 = "\";\r\n	        var width = screen.availWidth-10 ;\r\n	        var height = screen.availHeight-50 ;\r\n	        var szFeatures = \"top=0,\" ;\r\n	        szFeatures +=\"left=0,\" ;\r\n	        szFeatures +=\"width=\"+width+\",\" ;\r\n	        szFeatures +=\"height=\"+height+\",\" ;\r\n	        szFeatures +=\"directories=no,\" ;\r\n	        szFeatures +=\"status=yes,toolbar=no,location=no,\" ;\r\n	        szFeatures +=\"menubar=no,\" ;\r\n	        szFeatures +=\"scrollbars=yes,\" ;\r\n	        szFeatures +=\"resizable=yes\" ; //channelmode\r\n	        window.open(redirectUrl,\"\",szFeatures) ;\r\n".toCharArray();
    _jsp_string213 = "&selectedContent=".toCharArray();
    _jsp_string165 = "');\" class='opimg'   src='/images/ecology8/importwf_wev8.png' title=\"".toCharArray();
    ...
    _jsp_string68 = "\" class=\"cornerMenu\"></span>\r\n				</td>\r\n			</tr>\r\n		</table>\r\n		\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string211 = "&needPopupNewPage=true&fromadvancedmenu=".toCharArray();
    ...
    _jsp_string149 = "</a></div>	\r\n           \r\n		     <script>\r\n				    if($(\"a[class='#".toCharArray();
    _jsp_string169 = "',this);\" class='opimg' src='/images/ecology8/mainsubwf_wev8.png' title=\"".toCharArray();
    ...
    _jsp_string235 = "\";\r\n	$G(\"subform\").action = \"/workflow/request/RequestType.jsp?offical=".toCharArray();
    ...
    _jsp_string194 = "\r\n				</div>\r\n               </div> \r\n                 \r\n			  \r\n			   ".toCharArray();
    _jsp_string152 = "']\").parent().find(\".letterhasdata\").show();\r\n                          letteritem.css(\"color\",\"#667dad\");\r\n						  letteritem.css(\"cursor\",\"pointer\");\r\n                          letteritem.addClass(\"linkletteritem\");\r\n			          }\r\n\r\n		     </script>\r\n\r\n\r\n\r\n			 <div class='letterline' style='background:".toCharArray();
    _jsp_string143 = "\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string218 = "\", \"/workflow/request/AddRequest.jsp?workflowid=".toCharArray();
    _jsp_string190 = " </a>\r\n					</div>\r\n						".toCharArray();
    _jsp_string157 = "\r\n																  </a> 		  \r\n															".toCharArray();
    _jsp_string150 = "']\").length>0)\r\n			          {\r\n				          var letteritem=$(\"a[class='#".toCharArray();
    ...
    _jsp_string147 = "' style='color:".toCharArray();
    _jsp_string145 = "  signalletter'  style='color:".toCharArray();
    _jsp_string136 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result4\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string164 = "',this,'".toCharArray();
    _jsp_string187 = "\r\n					</div>\r\n					".toCharArray();

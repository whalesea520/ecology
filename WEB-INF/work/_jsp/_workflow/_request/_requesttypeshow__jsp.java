...
public class _requesttypeshow__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.conn.RecordSet RecordSetX;
      RecordSetX = (weaver.conn.RecordSet) pageContext.getAttribute("RecordSetX");
      if (RecordSetX == null) {
        RecordSetX = new weaver.conn.RecordSet();
        pageContext.setAttribute("RecordSetX", RecordSetX);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.soa.workflow.WorkFlowInit WorkFlowInit;
      WorkFlowInit = (weaver.soa.workflow.WorkFlowInit) pageContext.getAttribute("WorkFlowInit");
      if (WorkFlowInit == null) {
        WorkFlowInit = new weaver.soa.workflow.WorkFlowInit();
        pageContext.setAttribute("WorkFlowInit", WorkFlowInit);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.datacenter.InputReportComInfo InputReportComInfo;
      InputReportComInfo = (weaver.datacenter.InputReportComInfo) pageContext.getAttribute("InputReportComInfo");
      if (InputReportComInfo == null) {
        InputReportComInfo = new weaver.datacenter.InputReportComInfo();
        pageContext.setAttribute("InputReportComInfo", InputReportComInfo);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      ...
      out.print((URLEncoder.encode(__topage) ));
...
WorkTypeComInfo.setTofirstRow();
      ...
      out.print((Util.toScreen(WorkflowComInfo.getWorkflowname(wfid),user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(84522,user.getLanguage())));
      ...
      out.write('/');
      out.print((Util.toScreen(jobName,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(84523,user.getLanguage())));
      ...
      out.print((beagenter));
      out.write(_jsp_string181, 0, _jsp_string181.length);
      out.print((Util.toScreen(agentname,user.getLanguage())));
      out.write('/');
      out.print((Util.toScreen(depName,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(84517,user.getLanguage())));
    ...
    while(WorkflowComInfo.next()){
      ...
      out.print((SystemEnv.getHtmlLabelName(193, user.getLanguage())));
      ...
      out.print((selectedWfid ));
      out.write(_jsp_string28, 0, _jsp_string28.length);
      out.print((curtypeid ));
      out.write(_jsp_string242, 0, _jsp_string242.length);
      out.print((SystemEnv.getHtmlLabelName(19133, user.getLanguage())));
      out.print((SystemEnv.getHtmlLabelName(18030, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(84518,user.getLanguage())));
    ...
    if(navigateTo){
      ...
      out.print((SystemEnv.getHtmlLabelName(84524,user.getLanguage())));
      out.write(_jsp_string311, 0, _jsp_string311.length);
      out.print((SystemEnv.getHtmlLabelName(124786,user.getLanguage())));
      out.write(_jsp_string312, 0, _jsp_string312.length);
      out.print((SystemEnv.getHtmlLabelName(84520,user.getLanguage())));
      out.write(_jsp_string313, 0, _jsp_string313.length);
      out.print((SystemEnv.getHtmlLabelName(84521,user.getLanguage())));
      out.write(_jsp_string314, 0, _jsp_string314.length);
      out.print((needPopupNewPage));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/request/RequestTypeShow.jsp"), -5310539916296718265L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string120 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string80 = "\";\r\n                    window.location=src;\r\n                </script>\r\n        ".toCharArray();
    _jsp_string69 = "\"+\r\n                    \"&selectedContent=".toCharArray();
    _jsp_string292 = "&infoId=".toCharArray();
    ...
    _jsp_string159 = ",0,0);\">    ".toCharArray();
    ...
    _jsp_string48 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string261 = "\r\n                                        <div class='agenter' style=\"float:none\">\r\n                                        <a style=\"vertical-align: middle;color:#5b5b5b;cursor: pointer;\"\r\n                                            onclick=\"javascript:onNewRequest(".toCharArray();
    _jsp_string173 = "\" />\r\n                                                                </div>\r\n                                                              ".toCharArray();
    _jsp_string240 = "' />\r\n                 </div>\r\n                 ".toCharArray();
    _jsp_string224 = "\r\n                <div>\r\n        ".toCharArray();
    _jsp_string176 = "',this);\" class='opimg' style='vertical-align: middle;margin-right:10px;'  src='/images/ecology8/mainsubwf_wev8.png' title=\"\u4e3b\u5b50\u8d26\u53f7\" />\r\n                                                                </div>\r\n                                                              ".toCharArray();
    _jsp_string170 = "\r\n                                                        \r\n\r\n                                                                       ".toCharArray();
    ...
    _jsp_string302 = "+\"&isagent=\"+".toCharArray();
    _jsp_string132 = "\";\r\n        dialog.Width = 550 ;\r\n        dialog.Height = 600;\r\n        dialog.Drag = true;\r\n        dialog.show();\r\n    });\r\n}\r\n\r\nfunction ___showHelp(flag){\r\n    /*var pathKey = this.location.pathname;\r\n    //alert(pathKey);\r\n    if(pathKey!=\"\"){\r\n        pathKey = pathKey.substr(1);\r\n    }*/\r\n    var pathKey = \"\";\r\n	var __url = this.location.href;\r\n	try {\r\n		var __regexp = new RegExp(\"http://[^/]+\", \"gmi\");\r\n		__url = __url.replace(__regexp, '');\r\n	} catch (e) {}\r\n	pathKey = encodeURIComponent(__url);\r\n    var operationPage = \"http://help.e-cology.com.cn/help/RemoteHelp.jsp\";\r\n    var screenWidth = window.screen.width*1;\r\n    var screenHeight = window.screen.height*1;\r\n    var isEnableExtranetHelp = ".toCharArray();
    _jsp_string172 = "',this);\" class='opimg' style='vertical-align: middle;margin-right:10px;'  src='/images/ecology8/mainsubwf_wev8.png' title=\"".toCharArray();
    _jsp_string303 = "+\"&beagenter=".toCharArray();
    _jsp_string54 = "\r\n<!--For wui-->\r\n<link type='text/css' rel='stylesheet'  href='/wui/theme/".toCharArray();
    _jsp_string299 = "&colnum4show=onecol&topage=".toCharArray();
    _jsp_string255 = "\r\n                <div class='importwf'>\r\n                    <div class='wrapper'></div>\r\n                    <div class='importSpan'>\r\n                    <span  class='importTxt'></span>\r\n                    </div>\r\n                </div>\r\n                ".toCharArray();
    _jsp_string146 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result9\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string215 = "\" style=\"border-bottom:2px solid ".toCharArray();
    _jsp_string242 = "',this);\" class='opimg'  src='/images/ecology8/rmwf_wev8.png' title='".toCharArray();
    _jsp_string198 = "',this);\" class='opimg' style='vertical-align: middle;'  src='/images/ecology8/mainsubwf_wev8.png' title=\"".toCharArray();
    _jsp_string230 = "\r\n                    <div class='imgspan import'>\r\n                        <img onclick=\"importWf('".toCharArray();
    _jsp_string174 = "                             \r\n                                                                 <!--".toCharArray();
    _jsp_string70 = "\"+\r\n                    \"&infoId=".toCharArray();
    _jsp_string314 = "\");\r\n    }\r\n}\r\nfunction onuserdefault(flag){\r\n    if(flag==0){\r\n        $G(\"needall\").value = 1;\r\n    }else{\r\n        $G(\"needall\").value = 0;\r\n    }\r\n    $G(\"needPopupNewPage\").value=\"".toCharArray();
    ...
    _jsp_string161 = " \r\n                                                                  <a class=\"e8contentover\" style=\"margin-left:8px;margin-right:10px;cursor: pointer;\" onclick=\"javascript:onNewRequest2(".toCharArray();
    ...
    _jsp_string308 = "\";\r\n            document.getElementById(\"f_weaver_belongto_userid\").value=\"".toCharArray();
    ...
    _jsp_string307 = "\";\r\n            document.getElementById(\"beagenter\").value=\"".toCharArray();
    ...
    _jsp_string229 = "\r\n                                                    \r\n\r\n                    <!--\u6807\u8bc6\u5f53\u524d\u7528\u6237\u81ea\u8eab\u53ef\u521b\u5efa\u81ea\u7531\u6d41\u7a0b-->      \r\n                    <input type='hidden' name='createfreewfbyself' value='1' />\r\n                </div>\r\n                <div class='imageItem'>\r\n                ".toCharArray();
    _jsp_string182 = " </a>\r\n                                                                \r\n                                                               </div>\r\n    \r\n                                                            \r\n                                                                   ".toCharArray();
    _jsp_string279 = "\">\r\n            <input type=hidden name=\"hrmid\" value=\"".toCharArray();
    _jsp_string152 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result5\"></span>\r\n									</td>\r\n								</tr>\r\n							</table>\r\n						</td>\r\n					</tr>\r\n					<tr height=\"42px\">\r\n						<td align=\"right\" valign=\"middle\" style=\"padding-right: 12px\">\r\n							<span class=\"STYLE6\" id=\"result0\"></span>\r\n						</td>\r\n					</tr>\r\n				</table>\r\n			</td>\r\n		</tr>\r\n	</table>\r\n</div>\r\n\r\n\r\n            ".toCharArray();
    _jsp_string266 = "\").append(\"<font color='#989898' style='font-weight: 400;margin-left:5px;'>(".toCharArray();
    _jsp_string286 = "\r\n        ".toCharArray();
    ...
    _jsp_string239 = "');\" class='opimg'  src='/images/ecology8/addwf_wev8.png' title='".toCharArray();
    _jsp_string284 = "\r\n      <script> \r\n\r\n       ".toCharArray();
    ...
    _jsp_string180 = " \r\n                                                                <div class='agenter' style=\"float:none\">\r\n                                                                \r\n                                                                   <a style=\"vertical-align: middle;color:#5b5b5b;cursor: pointer;\"\r\n                                                                        onclick=\"javascript:onNewRequest2(".toCharArray();
    _jsp_string168 = "');\" class='opimg' style='vertical-align: middle;margin-right:10px;'  src='/images/ecology8/importwf_wev8.png' title=\"".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    ...
    _jsp_string189 = "\r\n\r\n                                                                 \r\n                                                                  ".toCharArray();
    _jsp_string73 = "\"+\r\n                    \"&prjid=".toCharArray();
    _jsp_string293 = "&selectedContent=".toCharArray();
    _jsp_string231 = "');\" class='opimg'   src='/images/ecology8/importwf_wev8.png' title=\"".toCharArray();
    ...
    _jsp_string78 = "\"+\r\n                    \"&isec=".toCharArray();
    _jsp_string260 = "\" />\r\n                                </div>\r\n                            </div>\r\n                            \r\n                            <div  class='agentlistdata' style='display:none'>\r\n                             <div class='agenter' style=\"float:none\">\r\n                                \u4ee3\u7406\u4ed6\u4eba\u521b\u5efa\r\n                            </div>\r\n                                ".toCharArray();
    _jsp_string67 = "\r\n                <script type=\"text/javascript\">\r\n                var colNum = parent.getcookie(\"wfnewCol\");\r\n                    if(colNum===\"\")colNum = \"mulitcol\";\r\n                    var src = \"/workflow/request/RequestTypeShow.jsp?offical=".toCharArray();
    ...
    _jsp_string0 = "\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string235 = "',this);\" class='opimg' src='/images/ecology8/mainsubwf_wev8.png' title=\"".toCharArray();
    ...
    _jsp_string291 = "&fromadvancedmenu=".toCharArray();
    ...
    _jsp_string297 = "&colnum4show=mulitcol&topage=".toCharArray();
    ...
    _jsp_string202 = " </a>\r\n                                                        </div>\r\n                    \r\n                                                 ".toCharArray();
    _jsp_string169 = "\" />\r\n                                                                  </div>\r\n                                                                 ".toCharArray();
    _jsp_string306 = "\";\r\n            document.getElementById(\"isagent\").value=\"".toCharArray();
    _jsp_string243 = "' />\r\n                  </div>\r\n                 ".toCharArray();
    _jsp_string3 = "\r\n	<script language=\"javascript\">\r\n		window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string162 = ",0,".toCharArray();
    _jsp_string87 = "\";\r\n	var fav_querystring = \"".toCharArray();
    _jsp_string264 = "\r\n                            </div>\r\n                        </div>\r\n                 ".toCharArray();
    _jsp_string207 = "\r\n    </table>\r\n    </div>\r\n    <script language=javascript>\r\n        jQuery(\".commian\").append(\"<font color='#989898' style='font-weight: 400;margin-left:5px;'>(".toCharArray();
    _jsp_string68 = "&colnum4show=\"+colNum+\r\n                    \"&fromadvancedmenu=".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string209 = "\r\n            \u6682\u65e0\u5e38\u7528\u6d41\u7a0b\r\n            ".toCharArray();
    _jsp_string109 = "px\" height=\"".toCharArray();
    _jsp_string205 = "\r\n                                          </tr>\r\n                                         ".toCharArray();
    _jsp_string194 = "\r\n                                                                  </tr>\r\n                                                                 ".toCharArray();
    _jsp_string289 = "},\r\n                      success: function( msg ){\r\n                         if('success'===$.trim(msg)){\r\n                            //\u5148\u786e\u8ba4\u8bbe\u7f6e          \r\n                            var iframe=jQuery(parent.document).find(\".e8_box \").find(\"iframe\");\r\n                            var links=jQuery(parent.document).find(\".tab_menu\").find(\"a\");\r\n                            var url=\"/workflow/request/RequestTypeShowWithLetter.jsp?offical=".toCharArray();
    ...
    _jsp_string301 = "\r\n            var redirectUrl =  \"AddRequest.jsp?workflowid=\"+".toCharArray();
    ...
    _jsp_string166 = "\r\n                                                                 <div class='imgspan import'>\r\n                                                                  <img onclick=\"importWf('".toCharArray();
    _jsp_string216 = ";\"><label>".toCharArray();
    _jsp_string15 = "\\r\\n\\r\\n".toCharArray();
    _jsp_string249 = "\r\n                 <div class='agenter' style=\"float:none\">\r\n                    \u4ee3\u7406\u4ed6\u4eba\u521b\u5efa\r\n                </div>\r\n                ".toCharArray();
    _jsp_string259 = "',this);\" class='opimg'  src='/images/ecology8/mainsubwf_wev8.png' title=\"".toCharArray();
    ...
    _jsp_string217 = "</label>\r\n                    </div>\r\n                </div>\r\n                <div class='mainItem'>\r\n                    <!-- this1 end -->\r\n            ".toCharArray();
    _jsp_string234 = "\r\n                    <div class='imgspan agent'>\r\n                        <img  onclick=\"agentWf('".toCharArray();
    _jsp_string220 = "</a>\r\n                    </div>\r\n                    <div class='imageItem'>\r\n                    <div class='imgspan import'>\r\n                        <img class='opimg' src='/images/ecology8/importwf_wev8.png' title=\"".toCharArray();
    ...
    _jsp_string218 = "\r\n                                                         \r\n                <div class='centerItem'>\r\n                    <div class='fontItem' style=\"overflow:hidden;\">\r\n                        <img name='esymbol' src=\"/images/ecology8/request/workflowTitle_wev8.png\" style=\"vertical-align: middle;\">\r\n\r\n                        <a style=\"cursor: pointer;\" href=\"javascript:onNewWindow('/datacenter/input/InputReportDate.jsp?inprepid=".toCharArray();
    _jsp_string208 = ")</font>\")\r\n    </script>\r\n    </td>\r\n    ".toCharArray();
    _jsp_string256 = "\r\n            </div>\r\n            ".toCharArray();
    _jsp_string247 = "\r\n\r\n                                                                  ".toCharArray();
    _jsp_string71 = "\"+\r\n                    \"&needPopupNewPage=".toCharArray();
    _jsp_string185 = "\r\n                                                                <!--div  class='agentlistdata' style='display:none'-->\r\n                                                                 <div class='agenter' style=\"float:none\">\r\n                                                                             ".toCharArray();
    ...
    _jsp_string263 = " </a>\r\n                                            </div>\r\n    \r\n                                 ".toCharArray();
    _jsp_string232 = "\" />\r\n                    </div>\r\n                 ".toCharArray();
    _jsp_string317 = "\r\n        var redirectUrl = \"AddRequest.jsp?workflowid=\"+wfid+\"&isagent=\"+agent+\"&beagenter=\"+beagenter+\"&f_weaver_belongto_userid=\"".toCharArray();
    _jsp_string253 = "\r\n                ".toCharArray();
    ...
    _jsp_string269 = "\").parent().parent().remove();\r\n        ".toCharArray();
    _jsp_string171 = "\r\n                                                                  <div class='imgspan agent'>\r\n                                                                  <img onclick=\"agentWf('".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string188 = " </a>\r\n                                                               </div>\r\n                                                                   ".toCharArray();
    ...
    _jsp_string290 = "&needPopupNewPage=true&topage=".toCharArray();
    _jsp_string158 = "\r\n                                                                   <a class=\"e8contentover\" style=\"margin-left:8px;margin-right:10px;cursor: pointer;\" onclick=\"javascript:onNewRequest(".toCharArray();

...
public class _requestimportoption__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string2, 0, _jsp_string2.length);
      weaver.workflow.request.RequestImport RequestImport;
      synchronized (pageContext.getSession()) {
        RequestImport = (weaver.workflow.request.RequestImport) pageContext.getSession().getAttribute("RequestImport");
        if (RequestImport == null) {
          RequestImport = new weaver.workflow.request.RequestImport();
          pageContext.getSession().setAttribute("RequestImport", RequestImport);
        }
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/request/RequestImportOption.jsp"), -1146023280214117348L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

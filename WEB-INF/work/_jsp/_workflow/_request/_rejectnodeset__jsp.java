...
public class _rejectnodeset__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.workflow.request.RequestRejectManager RequestRejectManager;
      RequestRejectManager = (weaver.workflow.request.RequestRejectManager) pageContext.getAttribute("RequestRejectManager");
      if (RequestRejectManager == null) {
        RequestRejectManager = new weaver.workflow.request.RequestRejectManager();
        pageContext.setAttribute("RequestRejectManager", RequestRejectManager);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.workflow.request.WFLinkInfo wfli;
      wfli = (weaver.workflow.request.WFLinkInfo) pageContext.getAttribute("wfli");
      if (wfli == null) {
        wfli = new weaver.workflow.request.WFLinkInfo();
        pageContext.setAttribute("wfli", wfli);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
	...
	if(RecordSet.next()){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("workflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(84508,user.getLanguage()), null), false);
...
if(userightmenu!=1){
  ...
  if(isselectrejectnode>=1&&isEnableRejectNodeSelect.equals("1")){  
	 ...
	 if(nodeattribute.equals("2")){
		 BrancheNodes  = wfli.getFlowBrancheNodes(requestid,workflowid,nodeid);
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(26437,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((rejectnodename ));
                out.write('(');
                out.print((SystemEnv.getHtmlLabelName(126842,user.getLanguage())));
                out.write(_jsp_string148, 0, _jsp_string148.length);
                out.print((rejectnodeids.get(i)));
                out.write(_jsp_string149, 0, _jsp_string149.length);
                out.print((SystemEnv.getHtmlLabelName(126503,user.getLanguage()) ));
                ...
                out.print((rejectnodename ));
                out.write('(');
                out.print((SystemEnv.getHtmlLabelName(126456,user.getLanguage())));
                out.write(_jsp_string148, 0, _jsp_string148.length);
                out.print((rejectnodeids.get(i)));
                out.write(_jsp_string149, 0, _jsp_string149.length);
                out.print((SystemEnv.getHtmlLabelName(126504,user.getLanguage()) ));
                out.write(_jsp_string150, 0, _jsp_string150.length);
  ...
  if(isrejectremind==1&&ischangrejectnode==1){
	 ...
	 nodenames=nodelist[1];
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(26438,user.getLanguage()));
      ...
      int _jspEval22 = _jsp_ViewTag_3.doStartTag();
      if (_jspEval22 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval22 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_3.setBodyContent(_jsp_endTagHack20);
      ...
      out.print((SystemEnv.getHtmlLabelName(26436,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/request/RejectNodeSet.jsp"), -8396410267812226891L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string147 = "\" >\r\n									</td>\r\n									<td>".toCharArray();
    _jsp_string157 = "\" onclick=\"clearcheckall()\">\r\n					    </td>\r\n					    <td>\r\n					        ".toCharArray();
    ...
    _jsp_string153 = "\r\n	      <table class=\"ListStyle\" id=\"oTable\" cellspacing=0 style=\"overflow: scroll;\">\r\n	            <COLGROUP>\r\n					<COL width=\"30%\">\r\n					<COL width=\"70%\">\r\n				</COLGROUP>\r\n				<tr class=header>\r\n		            <td><input id=\"checkall\" onclick=\"javascript:changstatus(this);\" type=\"checkbox\">".toCharArray();
    ...
    _jsp_string156 = "\" value=\"".toCharArray();
    ...
    _jsp_string170 = "\").checked){\r\n            if(nodeids.length>0){\r\n                nodeids+=\",\"+$G(\"nodeid_".toCharArray();
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string139 = "\r\n							<td>\r\n								<input type=\"radio\" name=\"rejectnodeid\" onclick=\"checkIfSingle(this,0)\" onchange=\"checkIfSingle(this,0)\" value=\"".toCharArray();
    ...
    _jsp_string155 = "\r\n				 		<td>\r\n					        <input type=\"checkbox\" accesskey=\"nodeitem\" name=\"nodeid_".toCharArray();
    ...
    _jsp_string150 = "\"><IMG id=ext-gen124 align=absMiddle src=\"/images/remind_wev8.png\"></SPAN></td>\r\n								</tr>\r\n						".toCharArray();
    ...
    _jsp_string146 = "\r\n									<td>\r\n										<input type=\"radio\" name=\"rejectnodeid\" onclick=\"checkIfSingle(this,1)\" onchange=\"checkIfSingle(this,1)\" value=\"".toCharArray();
    ...
    _jsp_string133 = "\r\n	     ".toCharArray();
    _jsp_string148 = ")<SPAN class=\".e8tips\" style=\"CURSOR: hand\" id=\"remind_".toCharArray();
    ...
    _jsp_string141 = "checked".toCharArray();
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string151 = "\r\n									<td>\r\n										<input type=\"radio\" name=\"rejectnodeid\" onclick=\"checkIfSingle(this,2)\" onchange=\"checkIfSingle(this,2)\" value=\"".toCharArray();
    ...
    _jsp_string149 = "\" title=\"".toCharArray();
    _jsp_string88 = "px\">\r\n</iframe>\r\n</div>\r\n".toCharArray();

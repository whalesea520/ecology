...
public class _requesttypebytest__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.workflow.workflow.TestWorkflowComInfo WorkflowComInfo;
      WorkflowComInfo = (weaver.workflow.workflow.TestWorkflowComInfo) pageContext.getAttribute("WorkflowComInfo");
      if (WorkflowComInfo == null) {
        WorkflowComInfo = new weaver.workflow.workflow.TestWorkflowComInfo();
...
if(needall.equals("1")) {
	...
	fromAdvancedMenu=0;
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("workflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(33662,user.getLanguage()), null), false);
...
int rownum=(wftypetotal+2)/3;
 	...
 	while(WorkTypeComInfo.next()){
      ...
      out.print((SystemEnv.getHtmlLabelName(84516,user.getLanguage())));
      out.write(_jsp_string144, 0, _jsp_string144.length);
      out.print((SystemEnv.getHtmlLabelName(25497,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/request/RequestTypeByTest.jsp"), 3423482499172411135L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string135 = ");\" title=\"".toCharArray();

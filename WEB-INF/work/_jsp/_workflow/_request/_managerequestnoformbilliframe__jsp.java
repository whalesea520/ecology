...
public class _managerequestnoformbilliframe__jsp extends com.caucho.jsp.JavaPage
{
...
String isFree = WFManager.getIsFree();
	...
	if( message.equals("1") ) {//\u5de5\u4f5c\u6d41\u4fe1\u606f\u4fdd\u5b58\u9519\u8bef
      ...
      out.print((SystemEnv.getHtmlLabelName(18877,user.getLanguage())));
...
if( !managepage.equals("")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      pageContext.include(managepage, "requestid=" + com.caucho.el.Expr.toString(requestid, null)+ "&" + "requestlevel=" + com.caucho.el.Expr.toString(requestlevel, null)+ "&" + "creater=" + com.caucho.el.Expr.toString(creater, null)+ "&" + "creatertype=" + com.caucho.el.Expr.toString(creatertype, null)+ "&" + "deleted=" + com.caucho.el.Expr.toString(deleted, null)+ "&" + "billid=" + com.caucho.el.Expr.toString(billid, null)+ "&" + "workflowid=" + com.caucho.el.Expr.toString(workflowid, null)+ "&" + "workflowtype=" + com.caucho.el.Expr.toString(workflowtype, null)+ "&" + "formid=" + com.caucho.el.Expr.toString(formid, null)+ "&" + "nodeid=" + com.caucho.el.Expr.toString(nodeid, null)+ "&" + "nodetype=" + com.caucho.el.Expr.toString(nodetype, null)+ "&" + "nextnodetype=" + com.caucho.el.Expr.toString(nextnodetype, null)+ "&" + "isreopen=" + com.caucho.el.Expr.toString(isreopen, null)+ "&" + "isreject=" + com.caucho.el.Expr.toString(isreject, null)+ "&" + "isremark=" + com.caucho.el.Expr.toString(isremark, null)+ "&" + "currentdate=" + com.caucho.el.Expr.toString(currentdate, null)+ "&" + "currenttime=" + com.caucho.el.Expr.toString(currenttime, null)+ "&" + "docfileid=" + com.caucho.el.Expr.toString(docfileid, null)+ "&" + "newdocid=" + com.caucho.el.Expr.toString(newdocid, null)+ "&" + "topage=" + com.caucho.el.Expr.toString(topage, null)+ "&" + "languageid=" + com.caucho.el.Expr.toString(user.getLanguage(), null)+ "&" + "submit=" + com.caucho.el.Expr.toString(submit, null)+ "&" + "forward=" + com.caucho.el.Expr.toString(forward, null)+ "&" + "wfmonitor=" + com.caucho.el.Expr.toString(wfmonitor, null), true);
      out.write(_jsp_string53, 0, _jsp_string53.length);
      }else{
...
if(RecordSet.next()){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/request/ManageRequestNoFormBillIframe.jsp"), 6993007929042723970L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string137 = "&requestid=".toCharArray();
    ...
    _jsp_string338 = "&nodeId=".toCharArray();
    ...
    _jsp_string240 = "\r\n        <a href=\"javascript:$GetEle('src').value='submit';$GetEle('frmmain').submit();\">".toCharArray();
    _jsp_string101 = "\"+\"&remark=\"+escape(remark));\r\n\r\n	}catch(e){\r\n		//alert(12563);\r\n	}\r\n}\r\n\r\nfunction doLocationHref(resourceid,forwardflag){\r\n    //\u83b7\u53d6\u76f8\u5173\u6587\u6863-\u76f8\u5173\u6d41\u7a0b-\u76f8\u5173\u9644\u4ef6\u53c2\u6570\r\n    //var signdocids=$G(\"signdocids\").value;\r\n    //var signworkflowids=$G(\"signworkflowids\").value;\r\n    //\u9644\u4ef6\u4e0a\u4f20\u53c2\u6570\r\n    //var param = \"&annexmainId=\" + signannexParam.annexmainId + \"&annexsubId=\" + signannexParam.annexsubId + \"&annexsecId=\" + signannexParam.annexsecId + \"&userid=\" + signannexParam.userid + \"&logintype=\" + signannexParam.logintype + \"&annexmaxUploadImageSize=\" + signannexParam.annexmaxUploadImageSize + \"&userlanguage=\" + signannexParam.userlanguage + \"&field_annexupload=\" + $G(\"field-annexupload\").value + \"&field_annexupload_del_id=\" + $G(\"field_annexupload_del_id\").value;\r\n    //\u83b7\u53d6\u53c2\u6570end\r\n	var id = ".toCharArray();
    ...
    _jsp_string215 = "\r\n							".toCharArray();
    _jsp_string315 = "&isAll=0&ismonitor=".toCharArray();
    ...
    _jsp_string103 = "&requestid=\"+id+\"&workflowRequestLogId=\"+workflowRequestLogId+\"&\"+params+\"&resourceids=\"+resourceid +\"&forwardflag=\"+forwardflag + \"&requestname=".toCharArray();
    _jsp_string258 = "\r\n    \r\n    ".toCharArray();
    _jsp_string306 = "\r\n			if(ischeckok==\"true\"){	\r\n				jQuery($GetEle(\"flowbody\")).attr(\"onbeforeunload\", \"\");\r\n				obj.disabled=true;\r\n				$GetEle('frmmain').action=\"/workflow/workflow/wfFunctionManageLink.jsp?f_weaver_belongto_userid=".toCharArray();
    _jsp_string138 = "&workflowid=".toCharArray();
    _jsp_string286 = "'/>\r\n	                            <input type='hidden' name='trust_".toCharArray();
    _jsp_string274 = "'/>\r\n	                    <input type='hidden' name='trust_".toCharArray();
    _jsp_string316 = "&urger=0\");\r\n	var dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	var url = \"/workflow/request/RequestModifyLogView.jsp?f_weaver_belongto_userid=".toCharArray();
    _jsp_string371 = "&url=\"+url;\r\n			".toCharArray();
    ...
    _jsp_string99 = "\"+\"&remark=\"+escape(remark));\r\n		else\r\n        openDialog(\"".toCharArray();
    ...
    _jsp_string256 = "\r\n	   ".toCharArray();
    _jsp_string79 = "\";\r\n		  showPrompt(content);\r\n          //window.setTimeout(\"$GetEle('message_table_Div').style.display='none';$GetEle('HelpFrame').style.display='none'\", 2000);\r\n          window.setTimeout(\"$GetEle('message_table_Div').style.display='none';$GetEle('HelpFrame').style.display='none'\", 2000);\r\n\r\n".toCharArray();
    _jsp_string310 = "&id=\"+docid;\r\n    window.open(operationPage,\"_blank\",\"top=0,left=\"+(screenWidth-800)/2+\",height=\"+(screenHeight-90)+\",width=800,status=no,scrollbars=yes,toolbar=yes,menubar=no,location=no\");\r\n}\r\n// modify by xhheng @20050304 for TD 1691\r\nfunction openSignPrint() {\r\n    window.open(\"PrintRequest.jsp?f_weaver_belongto_userid=".toCharArray();
    ...
    _jsp_string352 = "\";\r\n	var dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	dialog.Width = 550;\r\n	dialog.Height = 550;\r\n	dialog.Modal = true;\r\n	dialog.Title = title;\r\n	dialog.URL =url;\r\n	dialog.isIframe=false;\r\n	dialog.show();\r\n\r\n    //window.showModalDialog(\"/workflow/workflow/BrowserMain.jsp?url=/workflow/request/FreeWorkflowSet.jsp?requestid=".toCharArray();
    _jsp_string160 = "\r\n    showAddFavMsg();\r\n".toCharArray();
    _jsp_string94 = "\";\r\n	dlg.maxiumnable = true;\u3000\u3000\u3000\r\n	dlg.show();\r\n	//\u4fdd\u7559\u5bf9\u8bdd\u6846\u5bf9\u8c61\r\n	window.dialog = dlg;\r\n}\r\n\r\n//\u6253\u5f00\u8f6c\u53d1\u5bf9\u8bdd\u6846\r\nfunction openDialog3(title, url) {\r\n	url = url.replace(/&{2,5}/g,\"&\");\u3000\r\n	var dlg = new window.top.Dialog(); //\u5b9a\u4e49Dialog\u5bf9\u8c61\r\n	dlg.currentWindow = window;\r\n	dlg.Model = false;\u3000\u3000\u3000\r\n	dlg.Width = 1060; //\u5b9a\u4e49\u957f\u5ea6\r\n	dlg.Height = 500;\u3000\u3000\u3000\r\n	dlg.URL = url;\u3000\u3000\u3000\r\n	dlg.Title = \"".toCharArray();
    _jsp_string89 = "&id=\"+showid+\"&imagefileId=\"+docImagefileid+\"&isFromAccessory=true&isrequest=1&requestid=".toCharArray();
    _jsp_string217 = "\"></td>\r\n							".toCharArray();
    ...
    _jsp_string98 = "&requestid=\"+id+\"&workflowRequestLogId=\"+workflowRequestLogId+\"&\"+params+\"&resourceids=\"+resourceid + \"&requestname=".toCharArray();
    _jsp_string135 = "\r\n                        doLocationHrefnoback(resourceid,3);\r\n".toCharArray();
    ...
    _jsp_string354 = "&isbill=1&billid=".toCharArray();
    ...
    _jsp_string267 = "'/>\r\n	                    <input type='hidden' name='nodeid_".toCharArray();
    _jsp_string323 = "&isovertime=".toCharArray();
    ...
    _jsp_string105 = "&requestid=\"+id+\"&workflowRequestLogId=\"+workflowRequestLogId+\"&\"+params + \"&forwardflag=\" + forwardflag + \"&requestname=".toCharArray();
    _jsp_string238 = "\r\n		<a href=\"javascript:$GetEle('isremark').value='1';$GetEle('src').value='save';$GetEle('frmmain').submit();\">".toCharArray();
    ...
    _jsp_string242 = "\r\n	   <a href=\"javascript:$GetEle('src').value='reject';$GetEle('frmmain').submit();\" >".toCharArray();
    _jsp_string324 = "&topage=".toCharArray();
    ...
    _jsp_string159 = "\");\r\n}\r\n\r\n".toCharArray();
    _jsp_string303 = "\"==\"1\"&&!confirm(\"".toCharArray();
    ...
    _jsp_string271 = "'/>\r\n	                    <input type='hidden' name='operatornames_".toCharArray();
    _jsp_string86 = "&fromrequest=1\";\r\n		}\r\n    function downloadsBatch(fieldvalue,requestid)\r\n    { \r\n       jQuery($GetEle(\"flowbody\")).attr(\"onbeforeunload\", \"\");\r\n       $GetEle(\"fileDownload\").src=\"/weaver/weaver.file.FileDownload?f_weaver_belongto_userid=".toCharArray();
    _jsp_string241 = "\r\n		<a href=\"javascript:$GetEle('src').value='submit';$GetEle('frmmain').submit();\">".toCharArray();
    _jsp_string114 = "&requestid=\"+id+\"&workflowRequestLogId=\"+workflowRequestLogId+\"&\"+params + \"&forwardflag=\" + forwardflag + \"&needwfback=0&requestname=".toCharArray();
    ...
    _jsp_string378 = ",\"\",\"reject\",\"0\",\"divFavContent18980\",\"".toCharArray();
    _jsp_string225 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result7\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string69 = "\r\n<!-- \u5fae\u4fe1\u63d0\u9192(QC:98106) -->\r\n".toCharArray();
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    _jsp_string47 = "\";\r\nusblanguage = \"".toCharArray();
    _jsp_string255 = "	  \r\n		  ".toCharArray();
    _jsp_string140 = "&isbill=".toCharArray();
    _jsp_string377 = ",1,".toCharArray();
    _jsp_string55 = "/skins/".toCharArray();
    _jsp_string322 = "&reEdit=1&fromFlowDoc=".toCharArray();
    _jsp_string182 = ");\r\n			}\r\n		}catch(e){}\r\n		".toCharArray();
    _jsp_string37 = "\", function () {\r\n								formElementFocus(tempElement);\r\n							});\r\n							\r\n						}\r\n						return false;\r\n					}else{\r\n						if(window.__oriAlert__){\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string296 = "\r\n	 <input type=\"hidden\" name=\"f_weaver_belongto_userid\" value=\"".toCharArray();
    _jsp_string82 = "\";\r\n   }\r\n\r\n     function doBack(){\r\n        jQuery($GetEle(\"flowbody\")).attr(\"onbeforeunload\", \"\");\r\n        parent.document.location.href=\"/workflow/request/RequestView.jsp?f_weaver_belongto_userid=".toCharArray();
    _jsp_string15 = "\\r\\n\\r\\n".toCharArray();
    _jsp_string100 = "&requestid=\"+id+\"&workflowRequestLogId=\"+workflowRequestLogId+\"&\"+params + \"&requestname=".toCharArray();
    ...
    _jsp_string83 = "\"; //xwj for td3425 20051201\r\n   }\r\n\r\n		function downloads(files)\r\n		{ jQuery($GetEle(\"flowbody\")).attr(\"onbeforeunload\", \"\");\r\n		$GetEle(\"fileDownload\").src=\"/weaver/weaver.file.FileDownload?f_weaver_belongto_userid=".toCharArray();
    ...
    _jsp_string313 = ",\"".toCharArray();
    _jsp_string341 = "\";\r\n	top.Dialog.confirm(info,function(){\r\n		$GetEle(\"triSubwfIframe\").src=\"/workflow/request/TriSubwfIframe.jsp?f_weaver_belongto_userid=".toCharArray();
    _jsp_string88 = "&fromrequest=1&requestid=\"+requestid;\r\n    }\r\n		function opendoc(showid,versionid,docImagefileid)\r\n		{jQuery($GetEle(\"flowbody\")).attr(\"onbeforeunload\", \"\");\r\n		openFullWindowHaveBar(\"/docs/docs/DocDspExt.jsp?f_weaver_belongto_userid=".toCharArray();
    _jsp_string257 = "\r\n    \r\n".toCharArray();
    _jsp_string116 = "&requestid=\"+id+ \"&forwardflag=\"+ forwardflag +\"&needwfback=0&signworkflowids=\"+signworkflowids+param+\"&workflowRequestLogId=\"+workflowRequestLogId;\r\n		openFullWindowHaveBar(forwardurl);\r\n	}\r\n}\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string84 = "&fileid=\"+files+\"&download=1&requestid=".toCharArray();
    ...
    _jsp_string364 = "&isFreeNode=".toCharArray();
    ...
    _jsp_string347 = "&isroutedit=".toCharArray();
    _jsp_string361 = "&isrejectremind=".toCharArray();
    ...
    _jsp_string142 = "\";				\r\n			$GetEle(\"picframe\").src=\"/workflow/request/WorkflowRequestPicture.jsp?f_weaver_belongto_userid=".toCharArray();
    ...
    _jsp_string299 = "_addrequest_submit_token\" value=\"".toCharArray();
    _jsp_string362 = "&ischangrejectnode=".toCharArray();
    _jsp_string339 = "&paramSubwfSetId=\"+paramSubwfSetId+\"&tempflag=\"+Math.random();\r\n}\r\n\r\nfunction triSubwf2(paramSubwfSetId,subworkflowname){\r\n	subworkflowname = subworkflowname.replace(new RegExp(',',\"gm\"),'\\n');\r\n	var info = \"".toCharArray();
    _jsp_string337 = "&operation=triSubwf&requestId=".toCharArray();
    _jsp_string360 = "&isrejecttype=1&requestid=".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string148 = "</font>\";\r\n		if(oDiv.style.display == \"none\"&&oDivInner.style.display == \"none\"){\r\n		    oDivAll.style.display = \"none\";\r\n            spanimage.innerHTML = \"<img src='/images/ArrowDownRed_wev8.gif' border=0>\" ;\r\n		}\r\n    }\r\n    else{\r\n        oDivInner.style.display = \"\";\r\n        workflowChartLabelSpan.innerHTML=\"<font color=green>".toCharArray();
    _jsp_string311 = "&isprint=1&fromFlowDoc=".toCharArray();
    _jsp_string314 = "\",returnTrue);\r\n\r\n}\r\n\r\n/** added by cyril on 2008-07-10 for TD:8835*/\r\nfunction doViewModifyLog() {\r\n	//window.open(\"/workflow/request/RequestModifyLogView.jsp?requestid=".toCharArray();
    _jsp_string115 = "&requestid=\"+id+\"&workflowRequestLogId=\"+workflowRequestLogId+\"&\"+params+\"&resourceids=\"+resourceid +\"&forwardflag=\"+forwardflag + \"&needwfback=0&requestname=".toCharArray();
    ...
    _jsp_string320 = "&workflowid=\"+wfid+\"&nodeid=\"+nodeid+\"&reqid=\"+reqid + \"&menuid=\" + menuid;\r\n	var dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	dialog.Title = \"".toCharArray();
    _jsp_string293 = "\"/>\r\n	        ".toCharArray();
    _jsp_string118 = "\r\n	                    //\u8f6c\u53d1\u65f6\u4e0d\u9a8c\u8bc1\u7b7e\u5b57\u610f\u89c1\u5fc5\u586b\r\n	            try{  \r\n					if(typeof(eval(\"SaveSignature\"))==\"function\"){\r\n	                    if(SaveSignature()||!SaveSignature()){\r\n                            doLocationHref(resourceid);\r\n                        }else{\r\n							if(isDocEmpty==1){\r\n								alert(\"\\\"\"+\"".toCharArray();
    ...
    _jsp_string381 = "&workflowid=\"+wfid+\"&nodeid=\"+nodeid+\"&reqid=\"+reqid+\"&actionid=dialog&menuid=\" + menuid;\r\n	var dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	dialog.Title = \"".toCharArray();
    ...
    _jsp_string363 = "&isselectrejectnode=".toCharArray();
    ...
    _jsp_string365 = "\");\r\n			  dialog.URL =\"/systeminfo/BrowserMain.jsp?f_weaver_belongto_userid=".toCharArray();
    _jsp_string308 = "&flag=rb&requestid=".toCharArray();
    _jsp_string113 = "&requestid=\"+id+\"&workflowRequestLogId=\"+workflowRequestLogId+\"&\"+params+\"&resourceids=\"+resourceid +\"&forwardflag=\"+forwardflag+\"&needwfback=0&requestname=".toCharArray();
  }
}

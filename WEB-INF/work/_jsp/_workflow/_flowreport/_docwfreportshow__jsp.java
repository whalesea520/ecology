...
public class _docwfreportshow__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      out.write(_jsp_string1, 0, _jsp_string1.length);
      weaver.workflow.report.DocWfReportSort docWfReportSort;
      docWfReportSort = (weaver.workflow.report.DocWfReportSort) pageContext.getAttribute("docWfReportSort");
      if (docWfReportSort == null) {
        docWfReportSort = new weaver.workflow.report.DocWfReportSort();
        pageContext.setAttribute("docWfReportSort", docWfReportSort);
      }
      out.write(_jsp_string1, 0, _jsp_string1.length);
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print(( PageIdConst.WF_FLOWREPORT_DOCWFREPORTSHOW ));
          ...
          if (_jspEval6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_3.setBrowserSpanValue(objnameShow);
              ...
              do {
                ...
                _jsp_BrowserTag_4.setName("wfId");
                ...
                _jsp_BrowserTag_4.setBrowserValue(wfIds );
                _jsp_BrowserTag_4.setBrowserSpanValue(wfNames );
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(81517, user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
          ...
          if (_jspEval34 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                int _jsp_end_41 = _jsp_SplitPageTag_6.doEndTag();
      ...
      pageContext.include("/workflow/flowReport/IncludeExcelBody.jsp", "exportProcess=" + ("docWFReport")+ "&" + "exportSQL=" + com.caucho.el.Expr.toString(exportSQL, null), false);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/flowReport/DocWfReportShow.jsp"), 4898876783823910283L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

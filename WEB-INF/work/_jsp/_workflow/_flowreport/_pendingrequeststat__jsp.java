...
public class _pendingrequeststat__jsp extends com.caucho.jsp.JavaPage
{
...
if (userRights.equals("-100")) {
	...
	return;
      ...
      out.print((SystemEnv.getHtmlLabelName(124826,user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((SystemEnv.getHtmlLabelName(1015,user.getLanguage())));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((SystemEnv.getHtmlLabelName(124827,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/flowReport/PendingRequestStat.jsp"), 6651419223529135025L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

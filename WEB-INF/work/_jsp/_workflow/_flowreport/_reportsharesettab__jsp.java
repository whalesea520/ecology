...
public class _reportsharesettab__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print(( PageIdConst.WF_FLOWREPORT_REPORTSHARESETTAB ));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(18513,user.getLanguage())));
                out.write(_jsp_string162, 0, _jsp_string162.length);
...
tableString =   " <table instanceid=\"workflowTypeListTable\" tabletype=\"checkbox\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.WF_FLOWREPORT_REPORTSHARESETTAB,user.getUID())+"\" >"+
      ...
      out.print((SystemEnv.getHtmlLabelName(33666,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/flowReport/ReportShareSetTab.jsp"), -6177625433545245126L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string170 = "<input type=text class=\"InputStyle\" name=seclevel size=6 value=\"\">".toCharArray();
    ...
    _jsp_string139 = "'/>\r\n			<input type=\"hidden\" name=typename  value='".toCharArray();
    _jsp_string123 = "\"></td>\r\n							".toCharArray();
    ...
    _jsp_string137 = "\" class=\"e8_btn_top\" onclick=\"newDialog()\"/>		\r\n			<input type=\"button\" value=\"".toCharArray();
    _jsp_string15 = "\\r\\n\\r\\n".toCharArray();

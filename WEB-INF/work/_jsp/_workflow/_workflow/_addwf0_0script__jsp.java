...
public class _addwf0_0script__jsp extends com.caucho.jsp.JavaPage
{
...
if(!ajax.equals("1")){
      ...
      out.print((SystemEnv.getHtmlLabelName(18682, user.getLanguage())));
      out.write(_jsp_string67, 0, _jsp_string67.length);
      out.print((SystemEnv.getHtmlLabelName(18682,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelName(18685, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(18684, user.getLanguage())));
      out.write(_jsp_string71, 0, _jsp_string71.length);
      out.print((SystemEnv.getHtmlLabelName(18684,user.getLanguage())));
      out.write(_jsp_string73, 0, _jsp_string73.length);
      out.print((SystemEnv.getHtmlLabelName(125058, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(128755, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(27615,user.getLanguage())));
      out.write(_jsp_string84, 0, _jsp_string84.length);
      out.print((SystemEnv.getHtmlLabelName(27616,user.getLanguage())));
      out.write(_jsp_string85, 0, _jsp_string85.length);
      out.print((SystemEnv.getHtmlLabelName(27617,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(21629,user.getLanguage())));
      out.write(_jsp_string102, 0, _jsp_string102.length);
      out.print((SystemEnv.getHtmlLabelName(21628,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(28058,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/addwf0_script.jsp"), 7127023464529002487L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string90 = "\r\n    	oldval = 0;//\u65b0\u8868\u5355\r\n\r\n\r\n    ".toCharArray();
    _jsp_string78 = "\";\r\n	dialog.Width = 550 ;\r\n	dialog.Height = 550 ;\r\n	dialog.Drag = true;\r\n	dialog.maxiumnable = true;\r\n	dialog.show();\r\n}\r\n\r\nfunction showFieldNotImport(inputname, spanname){\r\n	var oldfields = $GetEle(inputname).value;\r\n	var datas = window.showModalDialog(\"/systeminfo/BrowserMain.jsp?url=\" + escape(\"/workflow/workflow/browserFieldMutil.jsp?workflowid=".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string119 = "&nodeid=\"+nodeid+\"&formid=\"+formid+\"&isbill=\"+isbill+\"&iscust=\"+iscust;\r\n	dialog.Title = \"".toCharArray();
    _jsp_string81 = "\");\r\n				return;\r\n	        }\r\n		}\r\n	}catch(e){}\r\ntry{\r\n	if(!checkLengtpointerCut(\"wfdes\",'200',\"".toCharArray();
    ...
    _jsp_string100 = "\"; \r\n	diag_saveaswf.URL = \"/workflow/workflow/WFTitleSet.jsp?isdialog=1&ajax=1&wfid=".toCharArray();
    ...
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string114 = "\";\r\n	diag_vote.URL = \"/workflow/workflow/WFTitleCode.jsp?workflowid=".toCharArray();
    ...
    _jsp_string121 = "&nodeid=\"+nodeid+\"&formid=\"+formid+\"&isbill=\"+isbill+\"&iscust=\"+iscust+\"&id=\"+id;\r\n	dialog.Title = \"".toCharArray();
    _jsp_string87 = "\");\r\n   }\r\n}\r\n\r\nfunction refreshAddwf(wfid1){\r\n	var isbill1 = \"\";\r\n	try{\r\n		isbill1 = document.weaver.isbill.value;\r\n	}catch(e){\r\n		isbill1 = \"\";\r\n	}\r\n	if(isbill1 != \"\"){\r\n		try{\r\n			parent.parent.location.href = \"addwf.jsp?ajax=1&src=editwf&wfid=\"+wfid1+\"&isTemplate=".toCharArray();
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    ...
    _jsp_string108 = "\"){\r\n		href=\"#messageB\";\r\n	}else if(name==\"".toCharArray();
    _jsp_string88 = "\";\r\n		}catch(e){parent.parent.location.href = \"addwf.jsp?ajax=1&src=editwf&wfid=\"+wfid1+\"&isTemplate=".toCharArray();
    _jsp_string57 = "\r\n<meta http-equiv=\"".toCharArray();
    _jsp_string76 = "\";\r\n	dialog.Width = 550 ;\r\n	dialog.Height = 550 ;\r\n	dialog.Drag = true;\r\n	dialog.maxiumnable = true;\r\n	dialog.show();\r\n}\r\n\r\nfunction showNoSynFields(inputname, spanname){\r\n	var oldfields = $GetEle(inputname).value;\r\n	var datas = window.showModalDialog(\"/systeminfo/BrowserMain.jsp?url=\"+escape(\"/workflow/workflow/fieldMutilBrowser.jsp?workflowid=".toCharArray();
    _jsp_string112 = "\"){\r\n		href=\"#QIANZI\";\r\n	}else if(name=='".toCharArray();

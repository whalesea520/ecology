...
public class _browsedatadefinition__jsp extends com.caucho.jsp.JavaPage
{
    ...
    if(operatelevelCheckright < 0){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(32752,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((Browsedatadefinition.getFieldTypeString(String.valueOf(wfid), fieldId, String.valueOf(user.getLanguage())) ));
                out.write(_jsp_string75, 0, _jsp_string75.length);
                out.print((isdetailname));
                ...
                out.print((FormFieldTransMethod.getFieldname(fieldlabel,""+7) ));
                out.write(_jsp_string82, 0, _jsp_string82.length);
                out.print((SystemEnv.getHtmlLabelName(695,user.getLanguage())));
                out.write(_jsp_string76, 0, _jsp_string76.length);
                out.print((typename));
                out.write(_jsp_string82, 0, _jsp_string82.length);
                out.print((mainordetail ));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelNames("126832,16579",user.getLanguage()) ));
      out.write(_jsp_string153, 0, _jsp_string153.length);
      out.print((SystemEnv.getHtmlLabelName(129432, user.getLanguage())));
      out.write(_jsp_string154, 0, _jsp_string154.length);
      out.print((SystemEnv.getHtmlLabelNames("18946,33329",user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/Browsedatadefinition.jsp"), 8247564385352658121L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string118 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string75 = "</td>\r\n										    <td>".toCharArray();
    _jsp_string83 = "</td>\r\n									    <td>\r\n											<button class=\"Browser1\" type=\"button\" onclick=\"javascript:onShowFileConfig('/systeminfo/BrowserMain.jsp?url=/workflow/workflow/RequestBrowserfunction.jsp','".toCharArray();
    ...
    _jsp_string136 = "\r\n							".toCharArray();
    _jsp_string154 = "\uff08\"+wuiUtil.getJsonValueByIndex(retValue, 1)+\"\uff09\"+".toCharArray();
    ...
    _jsp_string151 = "';\r\n			browserDialog.checkDataChange = false;\r\n			browserDialog.callback=function(data) {\r\n				browserDialog.close();\r\n				frmMain.submit();\r\n			};\r\n			browserDialog.show();\r\n		}\r\n\r\n		function onShowWorkFlowBase() {\r\n			var browserDialog = new top.Dialog();\r\n			browserDialog.Width = 500;\r\n			browserDialog.Height = 600;\r\n			browserDialog.URL = \"/systeminfo/BrowserMain.jsp?url=/workflow/workflow/WorkflowBrowserMuti.jsp?wfid=".toCharArray();
    _jsp_string77 = "</td>\r\n										    <td> \r\n										    	<button class=\"Browser1\" type=\"button\" onclick=\"javascript:onShowFileConfig('/systeminfo/BrowserMain.jsp?url=/workflow/workflow/RequestBrowserfunction.jsp','".toCharArray();
    _jsp_string72 = "</th>\r\n								    <th>".toCharArray();
    ...
    _jsp_string70 = "\r\n\r\n						<input type=\"hidden\" name=\"src\" id=\"src\" value=\"addrequest\">\r\n						<input type=\"hidden\" name=\"wfid\" id=\"wfid\" value=\"".toCharArray();

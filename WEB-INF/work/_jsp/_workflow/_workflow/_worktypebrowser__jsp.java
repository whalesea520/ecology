...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((requestutil.getSysname(RecordSet.getInt("id"),showsysname) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/WorkTypeBrowser.jsp"), -1222892207621451810L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string130 = "\" class=\"e8_btn_top\"  onclick=\"javascript:onSubmit();\"/>&nbsp;&nbsp;\r\n			<span title=\"".toCharArray();

...
public class _wfcodeadd__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(17998, user.getLanguage()));
          ...
          if (_jspEval37 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print(("O-"+SystemEnv.getHtmlLabelName(826,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/WFCodeAdd.jsp"), -898674432457675930L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string174 = "\" id=\"zd_btn_submit_0\" class=\"zd_btn_submit\" onclick=\"onSure();\">\r\n		    	<input type=\"button\" accessKey=T  id=btncancel value=\"".toCharArray();
    ...
    _jsp_string173 = "\r\n				<input type=\"button\" accessKey=O  id=btnok  value=\"".toCharArray();
    ...
    _jsp_string78 = "</option>\";\r\n			option += \"<option value='7'>".toCharArray();
    ...
    _jsp_string86 = "\r\n			fieldValue.append(option); \r\n			fieldValue.selectbox(\"attach\");\r\n		}else if(fieldType == \"6\"){//\u5f53\u524d\u6708\u4efd\r\n			fieldValue.selectbox(\"detach\");\r\n			var option = \"<option value='12'>".toCharArray();
    ...
    _jsp_string82 = "\r\n			fieldValue.append(option);\r\n			fieldValue.selectbox(\"attach\");\r\n		}else if(fieldType == \"2\"){//\u5206\u90e8\r\n			fieldValue.selectbox(\"detach\");\r\n			var option = \"<option value='4'>".toCharArray();
    ...
    _jsp_string87 = "\r\n			fieldValue.append(option); \r\n			fieldValue.selectbox(\"attach\");\r\n		}else if(fieldType == \"7\"){//\u5f53\u524d\u65e5\u671f\r\n			fieldValue.selectbox(\"detach\");\r\n			var option = \"<option value='13'>".toCharArray();
    ...
    _jsp_string70 = "</option>\";\r\n			option += \"<option value='3'>".toCharArray();
    _jsp_string94 = "\";\r\n        dialog.Width = 550 ;\r\n        dialog.Height = 600;\r\n        dialog.Drag = true;\r\n        dialog.show();\r\n    });\r\n\r\n}\r\n</script>\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();

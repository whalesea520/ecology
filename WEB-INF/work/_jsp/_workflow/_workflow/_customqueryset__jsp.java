...
public class _customqueryset__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(20773,user.getLanguage())));
      ...
      if (_jsp_ViewTag_0 == null) {
        ...
        _jsp_ViewTag_0.setAttributes("{'cw1':'30%','cw2':'70%'}");
      }
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(20773,user.getLanguage())+SystemEnv.getHtmlLabelName(195,user.getLanguage())));
      ...
      out.print(( PageIdConst.WF_WORKFLOW_CUSTOMQUERYSET ));
...
tableString+=   " </table>";
      ...
      out.print((SystemEnv.getHtmlLabelName(20785,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/CustomQuerySet.jsp"), -2304579097645795206L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string103 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string138 = "\" class=\"e8_btn_top\" onclick=\"newDialog()\"/>\r\n				".toCharArray();
    ...
    _jsp_string175 = "\", function (){\r\n				window.location=\"/workflow/workflow/CustomOperation.jsp?otype=".toCharArray();
    ...
    _jsp_string150 = "\r\n		    	".toCharArray();
    _jsp_string123 = "\"></td>\r\n							".toCharArray();
    _jsp_string152 = "\r\n			    	<input type=\"text\" name=\"shortName\" class=\"inputStyle\" value='".toCharArray();
    ...
    _jsp_string165 = "&subcompanyid=".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    ...
    _jsp_string146 = "\" onclick=\"mnToggleleft()\">".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string171 = "\";\r\n		diag_vote.URL = \"/workflow/workflow/CustomQueryAdd.jsp?otype=".toCharArray();
    ...
    _jsp_string164 = "\r\n        location.href=\"/workflow/workflow/CustomQueryAdd.jsp?Querytypeid=".toCharArray();
    ...
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string167 = "\r\n    }\r\n</script>\r\n</BODY>\r\n<script type=\"text/javascript\">\r\n\r\n	function showEditDialog(id){\r\n\r\n		var dialog = new window.top.Dialog();\r\n		dialog.currentWindow = window;\r\n		var url = \"/workflow/workflow/CustomQueryEditTab.jsp?otype=".toCharArray();
    ...
    _jsp_string177 = "&shortName=\"+typename+\"&subcompanyid=".toCharArray();

...
public class _createworkplanbyworkflow__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(22125, user.getLanguage()));
      ...
      out.print(( PageIdConst.WF_WORKFLOW_CREATEWORKPLANBYWORKFLOW ));
      ...
      out.print((SystemEnv.getHtmlLabelNames("611,33526",user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelNames("19342",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/CreateWorkplanByWorkflow.jsp"), 5706485344271532037L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string154 = "\";\r\n	url=\"/docs/tabs/DocCommonTab.jsp?dialog=1&_fromURL=68&wfid=".toCharArray();
    _jsp_string104 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string138 = "\r\n	".toCharArray();
    ...
    _jsp_string141 = "\"></input>\r\n			<input class=\"delbtn\" type=\"button\" onclick=\"delWPRow();\" title=\"".toCharArray();
    ...
    _jsp_string155 = "&id=\"+id;\r\n	\r\n	diag_vote = new window.top.Dialog();\r\n	diag_vote.currentWindow = window;\r\n	diag_vote.Width = 500;\r\n	if(id){\r\n		diag_vote.Height = 400;\r\n	}else{\r\n		diag_vote.Height = 400;\r\n	}\r\n	diag_vote.Modal = true;\r\n	diag_vote.Title = title;\r\n	diag_vote.URL = url;\r\n	diag_vote.show();\r\n}\r\n\r\nfunction delWPRow(id){\r\n	if(!id){\r\n		id = _xtable_CheckedCheckboxId();\r\n	}\r\n	if(!id){\r\n		window.top.Dialog.alert(\"".toCharArray();
    _jsp_string160 = "\";\r\n	url=\"/docs/tabs/DocCommonTab.jsp?ajax=1&dialog=1&_fromURL=69&wfid=".toCharArray();
    ...
    _jsp_string140 = "\r\n			<input class=\"addbtn\" type=\"button\" onclick=\"addWPRow();\" title=\"".toCharArray();

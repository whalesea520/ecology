...
public class _addwfnodeportal__jsp extends com.caucho.jsp.JavaPage
{
...
if(ajax.equals("1")){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(259,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(15433,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
	...
	if( !isFree.equals("1")){
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(15602,user.getLanguage())));
			...
			if("3".equals(nodetypes.get(i))) continue;
                ...
                out.print(((String)nodeids.get(i)+"_"+(String)nodetypes.get(i)+"_"+nodeattrs.get(i)));
                out.write(_jsp_string152, 0, _jsp_string152.length);
                out.print(((String)nodenames.get(i)));
                ...
                out.print((SystemEnv.getHtmlLabelName(15607,user.getLanguage())));
                out.write(_jsp_string156, 0, _jsp_string156.length);
                out.print((SystemEnv.getHtmlLabelName(15608,user.getLanguage())));
                ...
                out.write(_jsp_string28, 0, _jsp_string28.length);
                out.print((nodenamestr));
                out.write(_jsp_string28, 0, _jsp_string28.length);
                out.print((nodeidattr4));
                out.write(_jsp_string160, 0, _jsp_string160.length);
                out.print((showwayoutinfo));
			...
			if( !isFree.equals("1") ){
                ...
                out.print((SystemEnv.getHtmlLabelName(15609,user.getLanguage())));
                out.write(_jsp_string173, 0, _jsp_string173.length);
                ...
                out.print((SystemEnv.getHtmlLabelName(21642,user.getLanguage())));
			...
			if(tmpid>maxrow){
                ...
                out.print(((String)nodenames.get(Util.getIntValue(""+nodeids.indexOf(""+curid)))));
                ...
                if((WFNodePortalMainManager.getNodepassHour()+WFNodePortalMainManager.getNodepassMinute())>0 || !WFNodePortalMainManager.getDateField().equals("") || (!WFNodePortalMainManager.getCondition().equals("")) || (!"".equals(WFNodePortalMainManager.getNewrule()))){
                ...
                out.write(_jsp_string224, 0, _jsp_string224.length);
			    	...
			    	if(WFNodePortalMainManager.getLinkname().equals("")){
                ...
                out.print((disabledWhenIsFree));
                out.write(_jsp_string236, 0, _jsp_string236.length);
                out.print((SystemEnv.getHtmlLabelName(15612,user.getLanguage())));
                ...
                out.print(((String)nodeids.get(i)));
                ...
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(21398,user.getLanguage())));
                ...
                out.print((WFNodePortalMainManager.getTipsinfo()));
      ...
      out.print((nodeattrs.get(i)));
      out.write(_jsp_string268, 0, _jsp_string268.length);
      out.print((nodeids.get(i)));
      ...
      out.print((SystemEnv.getHtmlLabelName(15613,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(18690,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(18850,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/addwfnodeportal.jsp"), -6880057257154305342L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string105 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string139 = "\r\n	".toCharArray();
    _jsp_string220 = "_linkspan\"),checkLength(\"por".toCharArray();
    _jsp_string215 = "_isBulidCode\" value=\"1\" ".toCharArray();
    _jsp_string264 = "' />\";\r\n				oDiv.innerHTML = sHtml;\r\n				oCell.appendChild(oDiv);\r\n				break;\r\n			case 1:\r\n				var oDiv = document.createElement(\"div\");\r\n				var sHtml = oOption.text+\"<input type='hidden' name='por\"+rowindex+\"_nodeid' value='\"+tmpval+\"'>\";\r\n\r\n\r\n				oDiv.innerHTML = sHtml;\r\n				oCell.appendChild(oDiv);\r\n				break;\r\n			case 2:\r\n				var oDiv = document.createElement(\"div\");\r\n				var sHtml = \"<input type='checkbox' name='por\" + rowindex +\"_rej' value='1'\";\r\n				if(tmptype != 1)\r\n					sHtml += \" disabled \";\r\n				sHtml += \">\";\r\n				oDiv.innerHTML = sHtml;\r\n				oCell.appendChild(oDiv);\r\n				break;\r\n			case 7:\r\n				var oDiv = document.createElement(\"div\");\r\n				var sHtml = \"<select class=inputstyle  name='por\"+rowindex+\"_des' onchange=checkSame('por\"+rowindex+\"_nodeid',this,'".toCharArray();
    ...
    _jsp_string158 = "\r\n		&nbsp;&nbsp;\r\n		<button Class=addbtn type=button accessKey=A onclick=\"addRow4port(".toCharArray();
    ...
    _jsp_string38 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string288 = "\\\")'>\";\r\n				sHtml += \"<span  id='por\"+rowindex4port+\"_linkspan'><IMG src='/images/BacoError_wev8.gif' align=absMiddle></span>\";\r\n				oDiv.innerHTML = sHtml;\r\n				jQuery(oCell).append(oDiv);\r\n				break;\r\n			case 7:\r\n				var oDiv = document.createElement(\"div\");\r\n				var sHtml = \"<select class=inputstyle  name='por\"+rowindex4port+\"_des' onchange=checkSame('por\"+rowindex4port+\"_nodeid',this,'\"+nodeidattr4+\"','por\"+rowindex4port+\"_ismustpass','por\"+rowindex4port+\"_ismustpassspan')><option value='-1'>".toCharArray();
    ...
    _jsp_string283 = "\r\n<div id=portrowsum style=\"display:none;\">".toCharArray();
    _jsp_string266 = "</option>\";\r\n                ".toCharArray();
    _jsp_string194 = "_rej\" value=\"1\" ".toCharArray();
    _jsp_string185 = "' />\r\n				<input type=\"hidden\" name=\"por".toCharArray();
    ...
    _jsp_string156 = "\"></button>\r\n		<button Class=delbtn type=button accessKey=D onclick=\"if(isdel()){deleteRow1();}\" title=\"D-".toCharArray();
    _jsp_string219 = "_link\",\"por".toCharArray();
    _jsp_string190 = "\r\n			    <input type=\"hidden\" name=\"por".toCharArray();
    _jsp_string242 = "_ismustpass\" value=\"1\" ".toCharArray();
    _jsp_string19 = "&time=\"+new Date()+\"&f_weaver_belongto_userid=".toCharArray();
    _jsp_string234 = "_ismustpass\",\"por".toCharArray();
    ...
    _jsp_string123 = "\r\n							".toCharArray();
    _jsp_string187 = "\">\r\n				<input type=\"hidden\" name=\"por_order_".toCharArray();
    _jsp_string150 = "**************</strong>\r\n		".toCharArray();
    _jsp_string275 = "!=1){\r\n                                sHtml += \"<option value='".toCharArray();
    _jsp_string98 = "visible".toCharArray();
    _jsp_string231 = "_des\" onchange='checkSame(\"por".toCharArray();
    ...
    _jsp_string227 = "\r\n					<input type=\"hidden\" name=\"por".toCharArray();
    _jsp_string271 = "!=3&&".toCharArray();
    _jsp_string267 = "\r\n                    switch(tmpattr){\r\n                        case \"0\":\r\n                        case \"3\":\r\n                        case \"4\":\r\n                            if(".toCharArray();
    _jsp_string191 = "_nodeid\" value=\"".toCharArray();
    _jsp_string273 = "</strong>\";\r\n                            }\r\n                            break;\r\n                        case \"2\":\r\n                            if(".toCharArray();
    _jsp_string206 = "_conspan\" id=\"por".toCharArray();
    ...
    _jsp_string199 = "\r\n			    <button type=\"button\" class=Browser1 onclick=\"onShowBrowser4port(".toCharArray();
    _jsp_string224 = "_linkspan>\r\n			    	".toCharArray();
    _jsp_string246 = "</SPAN>\r\n				</td>\r\n				".toCharArray();
    _jsp_string157 = "\"></button>\r\n		".toCharArray();
    _jsp_string143 = "		\r\n		".toCharArray();
    ...
    _jsp_string210 = "\r\n			    <td  height=\"23\">\r\n				<button type=\"button\" class=Browser1 onclick=\"onShowAddInBrowser(".toCharArray();
    _jsp_string147 = "\r\n            	\r\n            ".toCharArray();
    _jsp_string181 = " class='paddingLeft18'><div class='intervalDivClass'></div></td></tr>\r\n			".toCharArray();
    _jsp_string243 = "style=\"display:none;\"".toCharArray();
    _jsp_string125 = "\"></td>\r\n							".toCharArray();
    _jsp_string249 = ")\" value=\"".toCharArray();
    ...
    _jsp_string269 = "'><strong>".toCharArray();
    _jsp_string173 = "</td>\r\n	            <td>".toCharArray();
    _jsp_string228 = "_des\" value=\"".toCharArray();
    ...
    _jsp_string255 = " class='paddingLeft18'><div class='intervalDivClass'></div></td></tr>\r\n				".toCharArray();
    _jsp_string138 = "\r\n<input type=\"hidden\" name=\"ajax\" value=\"1\">\r\n".toCharArray();
    _jsp_string218 = "\" onchange='checkinput(\"por".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string223 = "\")'><SPAN id=por".toCharArray();
    _jsp_string295 = "\";\r\n		var url = \"/workflow/workflow/showaddinContent.jsp?wfid=".toCharArray();
    ...
    _jsp_string212 = "span1\">\r\n			 	".toCharArray();
    _jsp_string183 = "\r\n				<td height=\"23\"><input type='checkbox' name='check_node'  value=\"".toCharArray();
    ...
    _jsp_string225 = "<IMG src='/images/BacoError_wev8.gif' align=absMiddle>".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string200 = "')\"></button>\r\n			     ".toCharArray();
    _jsp_string203 = "_con_cn\" value=\"".toCharArray();
    _jsp_string174 = "</td>\r\n	            ".toCharArray();
    _jsp_string153 = "</strong>\r\n		".toCharArray();
    _jsp_string94 = "px\" height=\"".toCharArray();
    _jsp_string274 = "!=0&&".toCharArray();
    ...
    _jsp_string280 = "&isbill=".toCharArray();
    ...
    _jsp_string247 = "\r\n				<td height=\"23\">\r\n				<input type='text' class=inputstyle name=\"por".toCharArray();
    _jsp_string201 = "_con\" value=\"".toCharArray();
    ...
    _jsp_string148 = "	\r\n	".toCharArray();
    _jsp_string202 = "\">\r\n			    <!-- add by xhheng @20050205 for TD 1537 -->\r\n			    <input type=\"hidden\" name=\"por".toCharArray();
    _jsp_string184 = "\" >&nbsp;<img moveimg src='/proj/img/move_wev8.png' title='".toCharArray();
    _jsp_string244 = "><SPAN  id=\"por".toCharArray();
    ...
    _jsp_string149 = "\r\n		<select class=inputstyle  name=\"curnode\" style=\"width: 30%;float: left;\">\r\n			<option class=Inputstyle value=\"-1\"><STRONG>************".toCharArray();
    _jsp_string238 = "\r\n					<option value=\"".toCharArray();
    _jsp_string177 = "</td>".toCharArray();
    ...
    _jsp_string236 = ">\r\n					<option value=\"-1\"><STRONG>".toCharArray();
    ...
    _jsp_string145 = "\r\n            	".toCharArray();
    _jsp_string277 = "\r\n                sHtml+= \"</select><input type=checkbox name='por\"+rowindex+\"_ismustpass' value='1' style='display:none;'><SPAN id='por\"+rowindex+\"_ismustpassspan' style='display:none;'>".toCharArray();
    _jsp_string154 = "\r\n		</select>\r\n		".toCharArray();
    _jsp_string69 = "\r\n</head>\r\n\r\n<body>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string76 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string254 = "          \r\n				</tr>\r\n				<tr class='Spacing' style=\"height:1px!important;\"><td ".toCharArray();
    _jsp_string229 = "\"/>\r\n					".toCharArray();
    _jsp_string151 = "\r\n			<option value=\"".toCharArray();
    ...
    _jsp_string155 = "\r\n		&nbsp;&nbsp;\r\n		<button Class=addbtn type=button accessKey=A onclick=\"addRow();\" title=\"A-".toCharArray();
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string207 = "_conspan\">".toCharArray();
    _jsp_string120 = "\r\n		<script type=\"text/javascript\">\r\n\r\n			jQuery(\"#divTopMenu\").hide();\r\n			jQuery(\"#rightMenu\",_menuDocument).hide();\r\n		\r\n		</script>\r\n		".toCharArray();
    _jsp_string97 = "hidden".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string216 = " ></td>\r\n			    <td  height=\"23\"><input class=Inputstyle type=\"text\" name=\"por".toCharArray();
    _jsp_string67 = "\r\n<html>\r\n".toCharArray();
    _jsp_string241 = "\r\n					</select><input  type=\"checkbox\" name=\"por".toCharArray();
    _jsp_string260 = "\r\n		idStr =\"#oTable4port\";\r\n	".toCharArray();
    _jsp_string294 = "\");\r\n	else{\r\n		dialog = new window.top.Dialog();\r\n		dialog.currentWindow = window;\r\n		var titlename = \"".toCharArray();
    _jsp_string279 = "\");\r\n	else{\r\n	url = \"BrowserMain.jsp?url=showcondition.jsp?formid=".toCharArray();
    _jsp_string22 = "\";\r\n					//diag.InvokeElementId=\"pageOverlay\"\r\n					diag.URL = \"/wui/theme/ecology7/page/loginSmall.jsp?username=".toCharArray();
    _jsp_string161 = ");\" title=\"A-".toCharArray();
    _jsp_string250 = "\" maxlength=\"500\">\r\n				</td>\r\n				".toCharArray();
    _jsp_string136 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result4\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string29 = "')) {\r\n				    lenck = false;\r\n				    break;\r\n			    }\r\n		    }\r\n		    if(lenck==false) return false;\r\n	    }\r\n	    catch(e) {}\r\n	    ".toCharArray();
    _jsp_string197 = "\r\n			    <button type=\"button\" class=Browser1 onclick=\"onShowBrowser(".toCharArray();
    _jsp_string251 = "\r\n				<input type=\"hidden\" name=\"por".toCharArray();
    _jsp_string162 = "\"></button>\r\n		<button Class=delbtn type=button accessKey=D onclick=\"if(isdel()){deleteRow4port();}\" title=\"D-".toCharArray();
    _jsp_string58 = "\r\n<meta http-equiv=\"".toCharArray();
    _jsp_string265 = "','por\"+rowindex+\"_ismustpass','por\"+rowindex+\"_ismustpassspan')><option value='-1'>".toCharArray();
    _jsp_string226 = "</SPAN>\r\n			    </td>\r\n			    <td height=\"23\">\r\n			    	".toCharArray();
    ...
    _jsp_string221 = "_link\",\"60\",\"".toCharArray();
    _jsp_string95 = "px\">\r\n</iframe>\r\n</div>\r\n".toCharArray();
    _jsp_string171 = "\r\n		  	<col width=\"9%\">\r\n		  	<col width=\"9%\">\r\n		  	<col width=\"15%\">\r\n		  	<col width=\"25%\">\r\n	    	".toCharArray();
    _jsp_string28 = "','".toCharArray();
    _jsp_string24 = "';\r\n	    		}\r\n	    		//\u4e3b\u4ece\u5e10\u6237\u7279\u6b8a\u5904\u7406 by alan for TD10156\r\n	    		if(response_flag=='3') {\r\n	    			flag_msg = '".toCharArray();
    _jsp_string214 = "\r\n			    </span>\r\n				</td>\r\n			    <td  height=\"23\"><input type=\"checkbox\" name=\"por".toCharArray();
    ...
    _jsp_string180 = "colspan=8".toCharArray();
    ...
    _jsp_string179 = "colspan=9".toCharArray();
    ...
    _jsp_string296 = "&linkid=\"+row+\"&titlename=\"+titlename;\r\n		dialog.Title = \"".toCharArray();
    _jsp_string193 = "\r\n				<td  height=\"23\"><input type=\"checkbox\" name=\"por".toCharArray();
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    ...
    _jsp_string217 = "_link\" value=\"".toCharArray();
  }
}

...
public class _editversion__jsp extends com.caucho.jsp.JavaPage
{
...
String verionDesc = wfversion.getVersionDesc();
      ...
      out.print((SystemEnv.getHtmlLabelName(22186,user.getLanguage()) ));
      out.write(_jsp_string66, 0, _jsp_string66.length);
      out.print((Integer.parseInt(currentVersionID) ));
      out.write(_jsp_string67, 0, _jsp_string67.length);
      out.print((SystemEnv.getHtmlLabelName(125122,user.getLanguage()) ));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((verionDesc ));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((SystemEnv.getHtmlLabelName(125123,user.getLanguage()) ));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((wfversion.isActive() ? " checked='true' disabled='disabled'" : "" ));
      ...
      out.print((thisworkflowid));
      out.write(_jsp_string74, 0, _jsp_string74.length);
      out.print((targetwfid ));
      out.write(_jsp_string75, 0, _jsp_string75.length);
      out.print((SystemEnv.getHtmlLabelName(125124,user.getLanguage()) ));
      out.write(_jsp_string76, 0, _jsp_string76.length);
      out.print((SystemEnv.getHtmlLabelName(125125,user.getLanguage()) ));
      ...
      out.print((SystemEnv.getHtmlLabelName(125126,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/editVersion.jsp"), -3264069465680273413L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string77 = "\uff01\");\r\n	    	}\r\n	    	jQuery(\"#jmodaloptcontent\").html(\"<input type='button' value='".toCharArray();
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string72 = "\" onclick=\"saveAsVersion()\" class=\"zd_btn_submit\" id=\"btnok\">\r\n                <input type=\"button\" value=\"".toCharArray();

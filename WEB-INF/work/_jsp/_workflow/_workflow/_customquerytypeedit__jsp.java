...
public class _customquerytypeedit__jsp extends com.caucho.jsp.JavaPage
{
...
if(msgid!=-1){
            ...
            do {
              ...
              do {
                ...
                if (_jsp_RequiredTag_3 == null) {
                  ...
                  _jsp_RequiredTag_3.setId("typenameimage");
                  _jsp_RequiredTag_3.setRequired(new java.lang.Boolean(true));
                }

                _jsp_RequiredTag_3.setValue(typename);
      ...
      int _jspEval38 = _jsp_ViewTag_4.doStartTag();
      if (_jspEval38 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval38 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_4.setBodyContent(_jsp_endTagHack36);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/CustomQueryTypeEdit.jsp"), 2649687560781516725L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string152 = "</textarea>".toCharArray();
    _jsp_string38 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string151 = "<textarea rows=\"4\" cols=\"60\" name=\"typenamemark\" class=Inputstyle style=\"resize:none;margin-top: 2px;margin-bottom: 2px;\">".toCharArray();
    ...
    _jsp_string144 = "\r\n    ".toCharArray();
    _jsp_string3 = "\r\n	<script language=\"javascript\">\r\n		window.top.Dialog.alert(\"".toCharArray();
    _jsp_string148 = "\r\n	    		<input type=text style=\"width:60%;\" size=30 class=Inputstyle name=\"typename\" onchange='checkinput(\"typename\",\"typenameimage\")' value=\"".toCharArray();
    ...
    _jsp_string154 = "' onKeyPress=\"ItemNum_KeyPress('showorder')\" onBlur=\"checknumber1(this);\">".toCharArray();
    ...
    _jsp_string153 = "<input type=\"text\" style=\"width:60%;\"  class=Inputstyle name=\"showorder\" size=\"7\" value='".toCharArray();

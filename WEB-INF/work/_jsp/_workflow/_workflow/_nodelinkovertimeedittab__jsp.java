...
public class _nodelinkovertimeedittab__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	if(request.getQueryString() != null) {
      ...
      out.print((SystemEnv.getHtmlLabelName(125632, user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/nodelinkOverTimeEditTab.jsp"), -1481387869106884448L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string48 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string66 = "\"\r\n    });\r\n});\r\n</script>\r\n</head>\r\n<BODY scroll=\"no\">\r\n<div class=\"e8_box demo2\">\r\n	<div class=\"e8_boxhead\">\r\n		<div class=\"div_e8_xtree\" id=\"div_e8_xtree\"></div>\r\n		<div class=\"e8_tablogo\" id=\"e8_tablogo\"></div>\r\n		<div class=\"e8_ultab\">\r\n			<div class=\"e8_navtab\" id=\"e8_navtab\">\r\n				<span id=\"objName\"></span>\r\n			</div>\r\n			<div>\r\n				<ul class=\"tab_menu\">\r\n					<li class=\"defaultTab\">\r\n						<a href=\"#\" target=\"tabcontentframe\">".toCharArray();
    _jsp_string38 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string68 = "\" id=\"tabcontentframe\" name=\"tabcontentframe\" class=\"flowFrame\" frameborder=\"0\" height=\"100%\" width=\"100%;\" onload=\"update()\"></iframe>\r\n		</div>\r\n	</div>\r\n</div>\r\n</body>\r\n<script type=\"text/javascript\">\r\nfunction closeDialog() {\r\n	parent.getDialog(window).close();\r\n}\r\nfunction reloadWindow() {\r\n	var sourceWindow = parent.getDialog(window).currentWindow;\r\n	sourceWindow.location.reload();\r\n	closeDialog();\r\n}\r\n</script>\r\n</html>\r\n".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();

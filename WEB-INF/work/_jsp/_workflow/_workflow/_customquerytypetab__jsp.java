...
public class _customquerytypetab__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print(( PageIdConst.WF_WORKFLOW_CUSTOMQUERYTYPETAB ));
...
tableString =   " <table instanceid=\"workflowcustomQuerytypeTable\" tabletype=\"checkbox\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.WF_WORKFLOW_CUSTOMQUERYTYPETAB,user.getUID())+"\" >"+
      ...
      out.print((SystemEnv.getHtmlLabelName(125098,user.getLanguage())));
      out.write(_jsp_string154, 0, _jsp_string154.length);
      out.print((SystemEnv.getHtmlLabelName(125099,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/CustomQueryTypeTab.jsp"), 7644248076887741872L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string144 = "<input type=\"text\" name=\"shortName\" class=\"inputStyle\" value='".toCharArray();

...
public class _wfncontentshow__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("workflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelNames("68,15935",user.getLanguage()) , null), false);
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(17139, user.getLanguage()));
...
for(int j = 0;j<wfnTypeList.size();j++){
	if(i==0){
		...
		i=0;
                ...
                if(resourceids.indexOf(wfnTypeList.get(j))!=-1||resourceids.equals("1")){
...
rowNum++;
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/wfnContentShow.jsp"), 8123585115060801930L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string146 = "\" name=\"printNodesName_".toCharArray();
    ...
    _jsp_string143 = "\" name=\"printNodes_".toCharArray();
    ...
    _jsp_string142 = ">\r\n		<input type=\"hidden\" id=\"printNodes_".toCharArray();
    _jsp_string3 = "\r\n	<script language=\"javascript\">\r\n		window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string67 = "\r\n<BODY>\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string138 = "\r\n	<TD>\r\n		<input type=\"checkbox\" title=\"shownode\" value=\"1\" name=\"checkbox_".toCharArray();
    _jsp_string15 = "\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string156 = "\" id=\"zd_btn_submit\" class=\"zd_btn_submit\" onclick=\"onclear();\">\r\n		    	<input type=\"button\" accessKey=T  id=btncancel value=\"".toCharArray();
    _jsp_string137 = "\r\n<TR class=DataDark>\r\n	".toCharArray();
    _jsp_string136 = "\r\n<TR class=DataLight>\r\n".toCharArray();
    ...
    _jsp_string145 = "\">\r\n    	<input type=\"hidden\" id=\"printNodesName_".toCharArray();
    _jsp_string133 = "\r\n<FORM NAME=SearchForm STYLE=\"margin-bottom:0\" action=\"WorkflowNodeBrowserMulti.jsp\" method=post>\r\n<TABLE ID=BrowseTable class=ListStyle cellspacing=0 STYLE=\"margin-top:0\">\r\n<TR class=header>\r\n<TH width=50%><span style=\"display: inline-block;\"><input type=\"checkbox\" class=\"InputStyle\"  onclick=\"SelAll(this)\">".toCharArray();

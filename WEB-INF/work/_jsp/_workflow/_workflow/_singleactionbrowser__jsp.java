...
public class _singleactionbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_3.setContext(SystemEnv.getHtmlLabelName(83001,user.getLanguage())+SystemEnv.getHtmlLabelName(320,user.getLanguage()));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/SingleActionBrowser.jsp"), -4960604914376805134L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string133 = "\">\r\n\r\n".toCharArray();
    _jsp_string151 = "\" onclick='onClose();'></input>\r\n			".toCharArray();
    ...
    _jsp_string136 = "<input name=actionname class=\"InputStyle\" value='".toCharArray();

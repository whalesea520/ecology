...
public class _wfntypeshow__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("wokflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelNames("68,17139",user.getLanguage()) , null), false);
...
rowNum++;
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/wfnTypeShow.jsp"), 6639060919512825521L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string150 = "\" name=\"printNodesName_".toCharArray();
    ...
    _jsp_string161 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"onClose();\">\r\n			".toCharArray();
    ...
    _jsp_string147 = "\" name=\"printNodes_".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string160 = "\" id=\"zd_btn_submit\" class=\"zd_btn_submit\" onclick=\"onclear();\">\r\n		    	<input type=\"button\" accessKey=T  id=btncancel value=\"".toCharArray();
    _jsp_string141 = "\r\n<TR class=DataDark>\r\n	".toCharArray();

...
public class _workflowtypebrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(RecordSet.getDBType().equals("oracle")){
	...
	sqltemp="select top "+(RecordSetCounts-(pagenum-1)*perpage)+" * from "+temptable1+"  order by id ";
      ...
      out.print((propertyOfApproveWorkFlow));
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(groupContext);
      ...
      out.print((SystemEnv.getHtmlLabelName(22677,user.getLanguage())));
      ...
      out.print((requestUtil.getSysname(RecordSet.getInt("workflowtype"),showtype) ));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/WorkflowTypeBrowser.jsp"), -6663584651703996695L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string132 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string73 = "'>\r\n	<input type=\"hidden\" name=\"showos\" value='".toCharArray();
    _jsp_string165 = "\r\n<div id=\"zDialog_div_bottom\" class=\"zDialog_div_bottom\">\r\n		".toCharArray();
    _jsp_string74 = "'>\r\n	\r\n	<input type=\"hidden\" name=\"propertyOfApproveWorkFlow\" value=\"".toCharArray();
    _jsp_string82 = "\r\n	".toCharArray();
    ...
    _jsp_string81 = "\r\n				<input class=\"Inputstyle\"  name=\"description\" value=\"".toCharArray();
    ...
    _jsp_string99 = ";onSubmit();\"><U>P</U> - ".toCharArray();
    ...
    _jsp_string102 = ";onSubmit();\"><U>N</U> - ".toCharArray();
    ...
    _jsp_string92 = "</td>\r\n							<td>".toCharArray();
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string90 = "\r\n						<tr>\r\n							<td width=\"10%\"><a href=\"#\">".toCharArray();
    ...
    _jsp_string101 = "\r\n	<button type=button style=\"display:none\" class=btn accessKey=N  id=nextpage onclick=\"document.all('pagenum').value=".toCharArray();
    ...
    _jsp_string79 = "\r\n				<input class=\"Inputstyle\" name=\"fullname\" value=\"".toCharArray();
    ...
    _jsp_string70 = "\" class=\"e8_btn_top\"  onclick=\"javascript:onSubmit();\"/>&nbsp;&nbsp;\r\n			<span title=\"".toCharArray();
    ...
    _jsp_string98 = "\r\n	<button type=button  style=\"display:none\" class=btn accessKey=P id=prepage onclick=\"document.all('pagenum').value=".toCharArray();
    _jsp_string88 = "</th>\r\n            ".toCharArray();

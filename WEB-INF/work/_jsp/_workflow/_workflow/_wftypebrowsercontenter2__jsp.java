...
public class _wftypebrowsercontenter2__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/WFTypeBrowserContenter2.jsp"), -117670172322377649L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string68 = "\"\r\n	});\r\n	attachUrl();\r\n});\r\n\r\n\r\nfunction attachUrl()\r\n{\r\n	$(\"[name='tabcontentframe']\").attr(\"src\",\"/workflow/workflow/WFTypeBrowser2.jsp?wftypeid=".toCharArray();

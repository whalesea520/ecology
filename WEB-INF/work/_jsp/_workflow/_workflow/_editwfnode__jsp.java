...
public class _editwfnode__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.conn.RecordSet rsName;
      rsName = (weaver.conn.RecordSet) pageContext.getAttribute("rsName");
      if (rsName == null) {
        rsName = new weaver.conn.RecordSet();
        pageContext.setAttribute("rsName", rsName);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
if(!ajax.equals("1")){
    ...
    " </table>";
                ...
                out.print(( PageIdConst.WF_NODEINFOLIST ));
 ...
 if(!ajax.equals("1")){
      ...
      out.print((SystemEnv.getHtmlLabelName(611,user.getLanguage()) + SystemEnv.getHtmlLabelName(15072,user.getLanguage()) ));
      ...
      out.print((wfid));
      out.write(_jsp_string160, 0, _jsp_string160.length);
      out.print((SystemEnv.getHtmlLabelName(33485,user.getLanguage())));
      ...
      out.print((wfid));
      out.write(_jsp_string160, 0, _jsp_string160.length);
      out.print((SystemEnv.getHtmlLabelName(68,user.getLanguage())+SystemEnv.getHtmlLabelName(16380,user.getLanguage()) ));
      ...
      out.print((SystemEnv.getHtmlLabelName(33508,user.getLanguage())+SystemEnv.getHtmlLabelName(33473,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/Editwfnode.jsp"), -6323615953580135234L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string151 = "\" name=\"newversionWFID\" id=\"newversionWFID\">\r\n<input type=\"hidden\" value=\"".toCharArray();
    _jsp_string106 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string140 = "\r\n	".toCharArray();
    ...
    _jsp_string177 = "&nodeid=\"+row+\"&titlename=\"+titlename;\r\n	dialog.Title = \"".toCharArray();
    _jsp_string185 = "\";\r\n	dialog.Width = 1020;\r\n	dialog.Height = 580;\r\n	dialog.Drag = true;\r\n	dialog.maxiumnable = true;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n	\r\n}\r\n\r\nfunction nodeopedit(formid,nodeid,id,isbill,iscust){\r\n	dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	var url = \"/workflow/workflow/operatorgroupContent.jsp?ajax=1&wfid=".toCharArray();
    _jsp_string142 = "\r\n			".toCharArray();
    ...
    _jsp_string170 = "&nodeid=\"+nodeid+\"&isFree=".toCharArray();
    ...
    _jsp_string172 = "\";\r\n	dialog.Width = 600;\r\n	dialog.Height = 300;\r\n	dialog.Drag = true;\r\n	dialog.maxiumnable = false;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n}\r\n\r\n\r\nfunction onExceptionHandle(nodeid, nodename){\r\n	dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	var url = \"/workflow/workflow/showNodeAttrOperate.jsp?setType=exceptionhandle&wfid=".toCharArray();
    ...
    _jsp_string174 = "\";\r\n	dialog.Width = 600;\r\n	dialog.Height = 350;\r\n	dialog.Drag = true;\r\n	dialog.maxiumnable = false;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n}\r\n\r\n\r\nfunction onShowButtonNameBrowser(nodeid){\r\n	dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	var url = \"/workflow/workflow/showButtonNameContent.jsp?wfid=".toCharArray();
    _jsp_string126 = "\"></td>\r\n							".toCharArray();
    _jsp_string154 = "\r\n<script>\r\nfunction selectall(){\r\n	window.document.forms[1].submit();\r\n\r\n}\r\n\r\n\r\nfunction onShowBrowser1(wfid,nodeid){\r\n  url = \"BrowserMain.jsp?url=wfNodeBrownser.jsp?wfid=".toCharArray();
    ...
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string184 = "&nodeid=\"+nodeid+\"&formid=\"+formid+\"&isbill=\"+isbill+\"&iscust=\"+iscust;\r\n	dialog.Title = \"".toCharArray();
    _jsp_string157 = "\";\r\n	dialog.Width = 1000 ;\r\n	dialog.Height = 500 ;\r\n	dialog.Drag = true;\r\n	dialog.maxiumnable = true;\r\n	dialog.show();\r\n//  alert(con==undefined);\r\n}\r\n\r\nfunction onShowPreBrowser(row){\r\n	url = \"BrowserMain.jsp?url=showpreaddinoperate.jsp?wfid=".toCharArray();
    ...
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string162 = "\r\n<script type=\"text/javascript\">\r\nvar iTop = (window.screen.availHeight-30-550)/2+\"px\"; //\u83b7\u5f97\u7a97\u53e3\u7684\u5782\u76f4\u4f4d\u7f6e;\r\nvar iLeft = (window.screen.availWidth-10-550)/2+\"px\"; //\u83b7\u5f97\u7a97\u53e3\u7684\u6c34\u5e73\u4f4d\u7f6e;\r\nfunction nodeedit() {\r\n		window.location.href=\"/workflow/workflow/addwfnode.jsp?ajax=1&src=editwf&wfid=".toCharArray();
    _jsp_string175 = "\";\r\n	dialog.Width = 1020;\r\n	dialog.Height = 580;\r\n	dialog.Drag = true;\r\n	dialog.maxiumnable = false;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n}\r\n\r\nfunction onShowPreBrowser(row){\r\n	dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	var titlename = \"".toCharArray();
    _jsp_string95 = "px\" height=\"".toCharArray();
    _jsp_string168 = "\";\r\n	dialog.Width = 1000;\r\n	dialog.Height = 580;\r\n	dialog.Drag = true;\r\n	dialog.maxiumnable = false;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n}\r\n\r\n\r\nfunction onFormLog(id,nodeid,obj)\r\n{\r\n	dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	var url = \"/workflow/workflow/wfNodeBrownser.jsp?wfid=".toCharArray();
    _jsp_string176 = "\";\r\n	var url = \"/workflow/workflow/showpreaddinContent.jsp?wfid=".toCharArray();
    ...
    _jsp_string186 = "&nodeid=\"+nodeid+\"&formid=\"+formid+\"&isbill=\"+isbill+\"&iscust=\"+iscust+\"&id=\"+id;\r\n	dialog.Title = \"".toCharArray();
    ...
    _jsp_string163 = "\";\r\n}\r\n\r\nfunction onShowNodeAttrBrowser(nodeid){\r\n	url = \"BrowserMain.jsp?url=showNodeAttrOperate.jsp?wfid=".toCharArray();
    _jsp_string145 = "\r\n</form>\r\n".toCharArray();
    ...
    _jsp_string69 = "\r\n</head>\r\n\r\n<body>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string77 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string166 = "\";\r\n	dialog.Width = 600;\r\n	dialog.Height = 450;\r\n	dialog.Drag = true;\r\n	dialog.maxiumnable = false;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n}\r\n\r\n\r\nfunction onSign(id,nodeid,obj)\r\n{\r\n	dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	var url = \"/workflow/workflow/showNodeAttrOperate.jsp?setType=sign&wfid=".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string67 = "\r\n<html>\r\n".toCharArray();
    _jsp_string169 = "\";\r\n	dialog.Width = 600;\r\n	dialog.Height = 350;\r\n	dialog.Drag = true;\r\n	dialog.maxiumnable = false;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n}\r\n\r\n\r\nfunction onFreeWf(id,nodeid,obj)\r\n{\r\n	dialog = new window.top.Dialog();\r\n	dialog.currentWindow = window;\r\n	var url = \"/workflow/workflow/showNodeAttrOperate.jsp?setType=freewf&wfid=".toCharArray();
    _jsp_string188 = "\r\n</body>\r\n\r\n</html>\r\n".toCharArray();
    ...
    _jsp_string173 = "&nodeid=\"+nodeid+\"&nodename=\"+nodename;\r\n	dialog.Title = \"".toCharArray();

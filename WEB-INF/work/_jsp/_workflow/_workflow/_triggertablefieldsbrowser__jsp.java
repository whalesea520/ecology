...
public class _triggertablefieldsbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((PageIdConst.WF_WORKFLOW_TRIGGERTABLEFIELDSBROWSER ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/triggerTableFieldsBrowser.jsp"), -8744361460839533683L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string149 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"onClose();\">\r\n			".toCharArray();
    ...
    _jsp_string69 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string148 = "\" id=\"zd_btn_submit\" class=\"zd_btn_submit\" onclick=\"onClear();\">\r\n		    	<input type=\"button\" accessKey=T  id=btncancel value=\"".toCharArray();
    ...
    _jsp_string133 = "\">\r\n<input type=\"hidden\" id=\"datasourceid\" name=\"datasourceid\" value=\"".toCharArray();
    ...
    _jsp_string137 = "<input name=searchfieldname class=\"InputStyle\" value='".toCharArray();
  }
}

...
public class _workflowbrowser_0frm__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
  ...
  String initUrl = "/workflow/workflow/WorkflowBrowser1.jsp?isWorkflowDoc="+isWorkflowDoc+"&isTemplate="+isTemplate+"&iswfec="+iswfec;
      ...
      out.print((SystemEnv.getHtmlLabelName(18412, user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/WorkflowBrowser_frm.jsp"), 1705592258194147015L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string47 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string75 = "&tabid=1&isTemplate=".toCharArray();
    _jsp_string37 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string42 = "\";\r\n\r\n  if(companyname.length >0 ){\r\n  	window.status = str1+companyname;\r\n  }\r\n</script>\r\n<!-- \u5220\u9664 -->\r\n</head></html>\r\n\r\n<!--USB \u9a8c\u8bc1 -->\r\n".toCharArray();
    _jsp_string53 = "\r\n<!--For wui-->\r\n<link type='text/css' rel='stylesheet'  href='/wui/theme/".toCharArray();
    _jsp_string82 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.closeByHand()\" style=\"width: 60px!important;\">\r\n          ".toCharArray();
    _jsp_string18 = "&time=\"+new Date()+\"&f_weaver_belongto_userid=".toCharArray();
    _jsp_string69 = "&iswfec=".toCharArray();
    ...
    _jsp_string70 = "\");\r\n      else if(tabId == 2)\r\n        $(\"#tabcontentframe\").attr(\"src\",\"/workflow/workflow/WorkflowSearch.jsp?isWorkflowDoc=".toCharArray();
    ...
    _jsp_string68 = "&isTemplate=".toCharArray();
    _jsp_string76 = "\" width=100%  height=100% frameborder=no scrolling=no>\r\n    ".toCharArray();
    ...
    _jsp_string73 = "</a>\r\n                </li>\r\n              <li>\r\n                  <a onclick=\"openTab(2)\" target=\"tabcontentframe\">".toCharArray();
    _jsp_string35 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    ...
    _jsp_string67 = "\"\r\n         });\r\n    }); \r\n\r\n    function viewSourceUrl(){\r\n          prompt(\"\",location);\r\n    }\r\n\r\n    function openTab(tabId){\r\n      if(tabId == 1)\r\n        $(\"#tabcontentframe\").attr(\"src\",\"/workflow/workflow/WorkflowBrowser1.jsp?isWorkflowDoc=".toCharArray();
    ...
    _jsp_string81 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"doClear()\" style=\"width: 50px!important;\">\r\n              <input type=\"button\" value=\"".toCharArray();

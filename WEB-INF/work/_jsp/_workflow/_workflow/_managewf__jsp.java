...
public class _managewf__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.workflow.workflow.WFManager WFInfo;
      WFInfo = (weaver.workflow.workflow.WFManager) pageContext.getAttribute("WFInfo");
      if (WFInfo == null) {
        WFInfo = new weaver.workflow.workflow.WFManager();
        pageContext.setAttribute("WFInfo", WFInfo);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.workflow.workflow.WFMainManager WFMainManager;
      WFMainManager = (weaver.workflow.workflow.WFMainManager) pageContext.getAttribute("WFMainManager");
      if (WFMainManager == null) {
        WFMainManager = new weaver.workflow.workflow.WFMainManager();
        pageContext.setAttribute("WFMainManager", WFMainManager);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
    ...
    if(isTemplate.equals("1")){
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      {
        ...
        _jspParam = request.getParameter("isTemplate");
        if (_jspParam != null && ! _jspParam.equals(""))
          WFMainManager.setIsTemplate(_jspParam);
        _jspParam = request.getParameter("wfname");
        if (_jspParam != null && ! _jspParam.equals(""))
          WFMainManager.setWfname(_jspParam);
        _jspParam = request.getParameter("isValid");
        if (_jspParam != null && ! _jspParam.equals(""))
          WFMainManager.setIsValid(_jspParam);
        _jspParam = request.getParameter("wfnameQuery");
        if (_jspParam != null && ! _jspParam.equals(""))
          WFMainManager.setWfnameQuery(_jspParam);
        _jspParam = request.getParameter("subCompanyId");
        if (_jspParam != null && ! _jspParam.equals(""))
          WFMainManager.setSubCompanyId(java.lang.Integer.parseInt(_jspParam));
        _jspParam = request.getParameter("wfid");
        if (_jspParam != null && ! _jspParam.equals(""))
          WFMainManager.setWfid(java.lang.Integer.parseInt(_jspParam));
        _jspParam = request.getParameter("wftypeid");
        if (_jspParam != null && ! _jspParam.equals(""))
          WFMainManager.setWftypeid(java.lang.Integer.parseInt(_jspParam));
      }
      ...
      out.print((SystemEnv.getHtmlLabelName(15459,user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelNames("611,33684",user.getLanguage())));
      out.write(_jsp_string152, 0, _jsp_string152.length);
      out.print((SystemEnv.getHtmlLabelName(20230,user.getLanguage())));
      out.write(_jsp_string153, 0, _jsp_string153.length);
      } 
      out.write(_jsp_string154, 0, _jsp_string154.length);
      out.print((wfnameQuery));
        ...
        do {
          ...
          if (_jspEval6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_3.set_callback("");
          ...
          if (_jspEval26 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jsp_ItemTag_4.setBodyContent(_jsp_endTagHack27);
...
tableString+=" <checkboxpopedom  id=\"checkbox\" popedompara=\"column:id+"+isTemplate+"+"+isWorkflowDoc+"+" + detachable + "+column:subcompanyid+"+ user.getUID()+ "\" showmethod=\"weaver.workflow.workflow.WFMainManager.getCheckBox\" />";
      ...
      int _jsp_end_36 = _jsp_SplitPageTag_5.doEndTag();
      ...
      out.print((SystemEnv.getHtmlLabelNames("18015,18622",user.getLanguage()) ));
      out.write(_jsp_string184, 0, _jsp_string184.length);
      out.print((isWorkflowDoc));
      out.write(_jsp_string185, 0, _jsp_string185.length);
      out.print((SystemEnv.getHtmlLabelNames("32485",user.getLanguage())));
      out.write(_jsp_string186, 0, _jsp_string186.length);
      out.print((isWorkflowDoc));
      out.write(_jsp_string185, 0, _jsp_string185.length);
      out.print((SystemEnv.getHtmlLabelNames("611,23167",user.getLanguage())));
      out.write(_jsp_string187, 0, _jsp_string187.length);
      out.print((isWorkflowDoc));
      out.write(_jsp_string185, 0, _jsp_string185.length);
      out.print((SystemEnv.getHtmlLabelNames("82,23167",user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(125402,user.getLanguage())));
      ...
      out.print((xssUtil.put("where int(operateitem)=85"+templatestr)));
      out.write(_jsp_string195, 0, _jsp_string195.length);
      out.print((xssUtil.put("where operateitem=85"+templatestr)));
      ...
      out.print((isWorkflowDoc));
      out.write(_jsp_string185, 0, _jsp_string185.length);
      out.print((SystemEnv.getHtmlLabelNames("21954",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/managewf.jsp"), -6509092450140835356L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string146 = "&typeid=".toCharArray();
    ...
    _jsp_string179 = "\">\r\n<input type=hidden name=wfname value=\"".toCharArray();
    ...
    _jsp_string128 = "\r\n							".toCharArray();
    _jsp_string195 = "\";\r\n}\r\nfunction wflog(){\r\n    window.location=\"/systeminfo/SysMaintenanceLog.jsp?isdialog=no&_fromURL=3&sqlwhere=".toCharArray();
    ...
    _jsp_string202 = "&wfnameQuery=\"+typename+\"&isTemplate=".toCharArray();
    ...
    _jsp_string163 = "<input type=text name=wfnameQuery class=Inputstyle size=\"30\" value='".toCharArray();
    _jsp_string14 = "\";\r\nfunction check_conn() {\r\n	return confirm('".toCharArray();
    _jsp_string186 = "\";\r\n	dialog.Width = 860;\r\n	dialog.Height = 600;\r\n	dialog.maxiumnable = true;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n}\r\n\r\nfunction addOfficalWf(){\r\n	dialog = new top.Dialog();\r\n	dialog.currentWindow = window; \r\n	var url = \"/docs/tabs/DocCommonTab.jsp?_fromURL=48&isdialog=1&isWorkflowDoc=".toCharArray();
    _jsp_string184 = "');\r\n		return;\r\n	}\r\n	dialog = new top.Dialog();\r\n	dialog.currentWindow = window; \r\n	var url = \"/docs/tabs/DocCommonTab.jsp?wfid=\"+id+\"&_fromURL=49&isdialog=1&isWorkflowDoc=".toCharArray();
    ...
    _jsp_string165 = "\r\n		    		<input class=\"e8_btn_submit\" type=\"submit\" name=\"search\" value=\"".toCharArray();
    ...
    _jsp_string161 = "\r\n		    	    <span>\r\n			    	 	".toCharArray();
    _jsp_string167 = "\"/>\r\n					<input class=\"e8_btn_cancel\" type=\"button\" id=\"cancel\" value=\"".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string172 = "\r\n        </td>\r\n    </tr>\r\n</TABLE>\r\n".toCharArray();
    _jsp_string177 = "\">\r\n<input type=hidden name=typeid value=\"".toCharArray();
    _jsp_string99 = "px\" height=\"".toCharArray();
    _jsp_string152 = "\" class=\"e8_btn_top\" onclick=\"addOfficalWf();\"/>	\r\n				<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string145 = "\" class=\"e8_btn_top\" onclick=\"parent.location='addwf.jsp?isTemplate=".toCharArray();
    ...
    _jsp_string151 = "\" class=\"e8_btn_top\" onclick=\"newOfficalWf();\"/>\r\n				-->\r\n				<input type=\"button\" value=\"".toCharArray();
    _jsp_string81 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string199 = "');\r\n		return;\r\n	}\r\n	dialog = new top.Dialog();\r\n	dialog.currentWindow = window; \r\n	var url = \"/workflow/workflow/addwf.jsp?wfid=\"+id+\"&src=editwf&isdialog=1&isWorkflowDoc=".toCharArray();
    _jsp_string78 = "\";\r\n        dialog.Width = 550 ;\r\n        dialog.Height = 600;\r\n        dialog.Drag = true;\r\n        dialog.show();\r\n    });\r\n\r\n}\r\n</script>\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    ...
    _jsp_string153 = "\" class=\"e8_btn_top\" onclick=\"detachOfficalWf();\"/>\r\n			".toCharArray();
    ...
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string187 = "\";\r\n	dialog.Width = 400;\r\n	dialog.Height = 210;\r\n	dialog.URL = url;\r\n	dialog.show();\r\n}\r\n\r\nfunction newOfficalWf(){\r\n	dialog = new top.Dialog();\r\n	dialog.currentWindow = window; \r\n	var url = \"/docs/tabs/DocCommonTab.jsp?_fromURL=76&isdialog=1&isWorkflowDoc=".toCharArray();
    _jsp_string115 = ";\r\n	".toCharArray();
    _jsp_string171 = "\r\n<TABLE width=\"100%\" cellspacing=0>\r\n    <tr>\r\n        <td valign=\"top\">  \r\n            ".toCharArray();
    _jsp_string144 = "\r\n				<input type=\"button\" value=\"".toCharArray();
    _jsp_string180 = "\">\r\n<input type=hidden name=wfdes value=\"".toCharArray();

...
public class _workflownodebrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelNames("33417",user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jsp_ViewTag_0 == null) {
        ...
        _jsp_ViewTag_0.setAttributes("{'formTableId':'nodeTable','cols':'3','cws':'20%,40%,40%'}");
      }
		...
		while(RecordSet.next()){
			...
			tempPrintNodesType=Util.null2String(RecordSet.getString("nodeType"));
              ...
              do {
                ...
                if(tempPrintNodesType.equals("0")){
                ...
                out.write(_jsp_string140, 0, _jsp_string140.length);
                if(tempPrintNodesType.equals("2")){
                out.print((SystemEnv.getHtmlLabelName(615,user.getLanguage())));
                }
                out.write(_jsp_string140, 0, _jsp_string140.length);
                if(tempPrintNodesType.equals("3")){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/WorkFlowNodeBrowser.jsp"), 4883399309242173404L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string38 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string138 = "'/><input type=\"hidden\" id=\"nodename\" name=\"nodename\" value='".toCharArray();
    ...
    _jsp_string145 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"onClose();\">\r\n			".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string144 = "\" id=\"zd_btn_submit\" class=\"zd_btn_submit\" onclick=\"onclear();\">\r\n		    	<input type=\"button\" accessKey=T  id=btncancel value=\"".toCharArray();
    ...
    _jsp_string137 = "<input type=\"hidden\" id=\"nodeid\" name=\"nodeid\" value='".toCharArray();
  }
}

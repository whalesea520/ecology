...
public class _createdocumentdetailbyworkfloweditoperation__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      weaver.workflow.workflow.WFDocumentManager WFDocumentManager;
      WFDocumentManager = (weaver.workflow.workflow.WFDocumentManager) pageContext.getAttribute("WFDocumentManager");
      if (WFDocumentManager == null) {
        WFDocumentManager = new weaver.workflow.workflow.WFDocumentManager();
        pageContext.setAttribute("WFDocumentManager", WFDocumentManager);
      }
      out.write(_jsp_string0, 0, _jsp_string0.length);
...
if(!HrmUserVarify.checkUserRight("WorkflowManage:All", user)) {
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/CreateDocumentDetailByWorkFlowEditOperation.jsp"), -1513115460331605568L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

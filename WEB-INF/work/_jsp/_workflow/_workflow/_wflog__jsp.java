...
public class _wflog__jsp extends com.caucho.jsp.JavaPage
{
...
if(operateLevel < 1){
    ...
    return;
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("workflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(32940,user.getLanguage()) , null), false);
      ...
      if (_jsp_ViewTag_0 == null) {
        ...
        _jsp_ViewTag_0.setAttributes("{'layoutTableId':'top'}");
      }
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(63, user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(15587,user.getLanguage())));
                out.print((SystemEnv.getHtmlLabelName(83,user.getLanguage())));
      ...
      out.print((xssUtil.put("where operateitem=85 and relatedid="+wfid+" and (operatesmalltype is null or operatesmalltype<>1) ")));
      out.write(_jsp_string75, 0, _jsp_string75.length);
      out.print((xssUtil.put("where operateitem=86 and relatedid="+wfid)));
      out.write(_jsp_string76, 0, _jsp_string76.length);
      out.print((xssUtil.put("where operateitem=88 and relatedid="+wfid)));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/WFLog.jsp"), 6406390748760805561L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string76 = "\";\r\n    else if(obj.value==\"3\")\r\n   		$GetEle('slog').src=\"/systeminfo/SysMaintenanceLog.jsp?_fromURL=3&wflog=1&isdialog=1&sqlwhere=".toCharArray();

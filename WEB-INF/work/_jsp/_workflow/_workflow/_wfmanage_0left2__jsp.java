...
public class _wfmanage_0left2__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName("1".equals(isTemplate)?33658:16483,user.getLanguage()) ));
...
if(!cnodeid.equals("") && !cnodeid.equals("0")) {
	...
	if(!Util.null2String(nodeid).equals("") && !nodeid.equals("0"))
      ...
      out.print((isTemplate));
      out.write(_jsp_string135, 0, _jsp_string135.length);
      out.print((Util.getIntValue(request.getParameter("subCompanyId"),-1)));
      out.write(_jsp_string136, 0, _jsp_string136.length);
      out.print((operatelevel));
      out.write(_jsp_string137, 0, _jsp_string137.length);
      out.print((nodeid));
      out.write(_jsp_string142, 0, _jsp_string142.length);
      out.print((workflowIds ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/wfmanage_left2.jsp"), -6512788817484433231L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string96 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string142 = "&workflowIds=".toCharArray();
    ...
    _jsp_string140 = "';\r\n//alert(cxtree_id);\r\nCXLoadTreeItem(\"\", \"/workflow/workflow/WorkflowXML.jsp?isWorkflowDoc=".toCharArray();
    ...
    _jsp_string144 = "\r\ntry{\r\ndeeptree.scrollTop=workflowtype_".toCharArray();
    ...
    _jsp_string135 = "&init=true&subCompanyId=".toCharArray();
    ...
    _jsp_string145 = ".offsetTop;\r\ndeeptree.HighlightNode(workflowtype_".toCharArray();
    ...
    _jsp_string141 = "&isTemplate=".toCharArray();
    ...
    _jsp_string146 = ".parentElement);\r\ndeeptree.ExpandNode(workflowtype_".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    ...
    _jsp_string136 = "&operatelevel=".toCharArray();

...
public class _showchoosereservedcodeoperate__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(22785,user.getLanguage()));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/showChooseReservedCodeOperate.jsp"), 1549167626899926344L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string122 = "\r\n							".toCharArray();
    _jsp_string157 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.closeByHand()\" style=\"width: 60px!important;\">\r\n			".toCharArray();
    ...
    _jsp_string142 = "\" name=\"recordId\">\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string149 = "\">\r\n		    <td width=0% style=\"display:none\"><A HREF=#>".toCharArray();

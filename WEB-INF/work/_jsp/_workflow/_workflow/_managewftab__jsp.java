...
public class _managewftab__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	if (detachable == 1) {
      ...
      out.print(( MouldIDConst.getID(isWorkflowDoc.equals("1")?"offical":"workflow")));
      ...
      out.print((SystemEnv.getHtmlLabelName(33805,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/managewfTab.jsp"), -7744346350868217010L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string48 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string72 = "\" target=\"tabcontentframe\">".toCharArray();
    _jsp_string38 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string69 = "\r\n				      	<li class=\"e8_tree\">\r\n				        	<a onclick=\"javascript:mnToggleleft();\"><<".toCharArray();
    ...
    _jsp_string15 = "\\r\\n\\r\\n".toCharArray();
    _jsp_string78 = "\" onload=\"update()\" id=\"tabcontentframe\" name=\"tabcontentframe\" class=\"flowFrame\" frameborder=\"0\" height=\"100%\" width=\"100%;\" scrolling=no></iframe>\r\n	        </div>\r\n	    </div>\r\n	</div>     \r\n</body>\r\n<script type=\"text/javascript\">\r\n	function mnToggleleft(){\r\n		var f = window.parent.oTd1.style.display;\r\n		if (f != null) {\r\n			if(f==''){\r\n				window.parent.oTd1.style.display='none';\r\n				".toCharArray();
    _jsp_string76 = "\r\n					     ".toCharArray();
    ...
    _jsp_string74 = "\r\n								<li>\r\n						        	<a href=\"/workflow/workflow/wfRightEdit.jsp\" target=\"tabcontentframe\">".toCharArray();

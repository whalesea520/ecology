...
public class _editoperatorgroupmatrix__jsp extends com.caucho.jsp.JavaPage
{
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_3.setName("vf");
                _jsp_BrowserTag_3.setGetBrowserUrlFn("getMatrixBrowserUrl");
                _jsp_BrowserTag_3.setGetBrowserUrlFnParams("1");
                ...
                _jsp_BrowserTag_3.setCompleteUrl("javascript:getMatrixDataUrl(1);");
                _jsp_BrowserTag_3.setBrowserValue(gdMatrix.getValue_field());
                _jsp_BrowserTag_3.setBrowserSpanValue(gdMatrix.getValueFieldName(matrixUtil));
                ...
                out.print((gdMatrix.getValue_field()));
                out.write(_jsp_string145, 0, _jsp_string145.length);
                out.print((gdMatrix.getValueFieldName(matrixUtil)));
              ...
              if (_jsp_ItemTag_4 == null) {
                ...
                _jsp_ItemTag_4.setAttributes("{'colspan':'full','isTableList':'true'}");
              }
              ...
              do {
                ...
                _jsp_BrowserTag_5.setName("cf");
                _jsp_BrowserTag_5.setGetBrowserUrlFn("getMatrixBrowserUrl");
                _jsp_BrowserTag_5.setGetBrowserUrlFnParams("0");
                ...
                _jsp_BrowserTag_5.setCompleteUrl("javascript:getMatrixDataUrl(1);");
                _jsp_BrowserTag_5.setBrowserValue(gdmd.getCondition_field());
                _jsp_BrowserTag_5.setBrowserSpanValue(gdmd.getConditionFieldName(matrixUtil, gdMatrix.getMatrix()));
                ...
                out.write(_jsp_string144, 0, _jsp_string144.length);
                out.print((gdmd.getCondition_field()));
                out.write(_jsp_string145, 0, _jsp_string145.length);
                out.print((gdmd.getConditionFieldName(matrixUtil, gdMatrix.getMatrix())));
                ...
                _jsp_BrowserTag_6.setName("wf");
                _jsp_BrowserTag_6.setGetBrowserUrlFn("getFieldUrl");
                ...
                _jsp_BrowserTag_6.setBrowserValue(gdmd.getWorkflow_field());
                _jsp_BrowserTag_6.setCompleteUrl(valueFieldCompleteUrl);
                _jsp_BrowserTag_6.setBrowserSpanValue(gdmd.getWorkflowFieldName(recordSet, isbill, formid, user.getLanguage()));
...
if("1".equals(browsertypeid) || "17".equals(browsertypeid)){		 
   ...
   if(isbill.equals("0")){
	...
	if(isbill.equals("1")){	
	  sqlstr = "select distinct(t1.id) as id,t1.fieldname as name,t1.fieldlabel as label,t1.fieldhtmltype as htmltype,t1.type as type, t1.fielddbtype as dbtype,t1.viewtype as isdetail,t1.detailtable,t1.dsporder from workflow_billfield t1 where (t1.viewtype is null or t1.viewtype!=1) and t1.billid = "+ formid +" and t1.fieldhtmltype!=6 and not(t1.fieldhtmltype=2 and t1.type=2) and t1.type in (161) and t1.fieldhtmltype=3 ";
                ...
                out.write(_jsp_string144, 0, _jsp_string144.length);
                out.print((gdmd.getWorkflow_field()));
                out.write(_jsp_string145, 0, _jsp_string145.length);
                out.print((gdmd.getWorkflowFieldName(recordSet, isbill, formid, user.getLanguage())));
                out.write(_jsp_string167, 0, _jsp_string167.length);
                }else{
                out.write(_jsp_string147, 0, _jsp_string147.length);
                out.print((matrixruleid));
                out.write(_jsp_string148, 0, _jsp_string148.length);
                out.print((ruledescr));
                out.write(_jsp_string149, 0, _jsp_string149.length);
                }
                ...
                out.print((matrixruleid));
                out.write(' ');
                out.print((gdmd.getWorkflow_field().equals(matrixruleid)?"selected":"" ));
      ...
      int _jspEval22 = _jsp_ViewTag_0.doStartTag();
      if (_jspEval22 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval22 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_0.setBodyContent(_jsp_endTagHack20);
          _jsp_ViewTag_0.doInitBody();
        }
        do {
          out.write(_jsp_string140, 0, _jsp_string140.length);
          ...
          if (_jspEval25 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jsp_ItemTag_7.setBodyContent(_jsp_endTagHack26);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/editOperatorGroupMatrix.jsp"), 6943437136097351449L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string103 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string182 = "\r\n							</table>\r\n						".toCharArray();
    _jsp_string164 = ");changetype(".toCharArray();
    ...
    _jsp_string163 = "\"  onChange=\"selectShow(".toCharArray();
    ...
    _jsp_string172 = "\" name=\"matrixRulefield_".toCharArray();
    ...
    _jsp_string184 = "\r\n			</form>\r\n			".toCharArray();
    _jsp_string193 = "');\r\n				}\r\n			}\r\n\r\n			function cancel() {\r\n				if(parentDialog) {\r\n					try {\r\n						parentDialog.close();\r\n					} catch(e) {}\r\n				} else {\r\n					window.parent.parent.close();\r\n				}\r\n			}\r\n\r\n	\r\n   var insertindex = ".toCharArray();
    _jsp_string207 = " ;\r\n	  	var matrixTmp=".toCharArray();
    ...
    _jsp_string160 = "\" id=\"cf_".toCharArray();
    ...
    _jsp_string197 = "\");\r\n	    		return;\r\n	    	} else {\r\n					\r\n				   temp = returnValues.trim();\r\n				   j = temp.substring(0,temp.indexOf(\",\"))	;\r\n					typeid = temp.substring(temp.indexOf(\",\")+1,temp.length)\r\n				   if(162 == typeid){\r\n						 jQuery(\"#matrixCfield_\"+j).parent().parent().find('div.cf span').after('<span id = \"rule_'+j+'\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".toCharArray();
    _jsp_string135 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result5\"></span>\r\n									</td>\r\n								</tr>\r\n							</table>\r\n						</td>\r\n					</tr>\r\n					<tr height=\"42px\">\r\n						<td align=\"right\" valign=\"middle\" style=\"padding-right: 12px\">\r\n							<span class=\"STYLE6\" id=\"result0\"></span>\r\n						</td>\r\n					</tr>\r\n				</table>\r\n			</td>\r\n		</tr>\r\n	</table>\r\n</div>\r\n\r\n\r\n			\r\n			<input type=\"hidden\" id=\"matrix\" name=\"matrix\" value=\"".toCharArray();
    _jsp_string123 = "\"></td>\r\n							".toCharArray();
    _jsp_string46 = ";\r\nusbserial0 = \"".toCharArray();
    _jsp_string169 = " -->\r\n												  <input type=\"hidden\" issingle=\"true\" ismustinput=\"1\" viewtype=\"0\" onpropertychange=\"\" temptitle=\"\" name=\"wf_".toCharArray();
    ...
    _jsp_string165 = ");changetype2(".toCharArray();
    ...
    _jsp_string136 = "\" />\r\n			<form action=\"\" name=\"searchfrm\" id=\"searchfrm\">\r\n				<table id=\"topTitle\" cellpadding=\"0\" cellspacing=\"0\">\r\n					<tr>\r\n						<td></td>\r\n						<td class=\"rightSearchSpan\" style=\"text-align: right;\">\r\n							<input type=button class=\"e8_btn_top\" onclick=\"save();\" value=\"".toCharArray();
    _jsp_string175 = ">\r\n	                                        ".toCharArray();
    ...
    _jsp_string171 = "\">\r\n										<select style=\"width:140px\" class=inputstyle id=\"matrixRulefield_".toCharArray();
    _jsp_string88 = ");\r\n			}\r\n		}catch(e){}\r\n		".toCharArray();
    ...
    _jsp_string166 = ")\" style=\"float:left;\">\r\n														".toCharArray();
    ...
    _jsp_string170 = "\" id=\"wf_".toCharArray();
    ...
    _jsp_string187 = "\" class=\"e8_btn_cancel\" onclick=\"parentDialog.close();\">\r\n							".toCharArray();
    ...
    _jsp_string159 = "  -->\r\n												  <input type=\"hidden\" issingle=\"true\" ismustinput=\"1\" viewtype=\"0\" onpropertychange=\"\" temptitle=\"\" name=\"cf_".toCharArray();
    ...
    _jsp_string191 = "('+jQuery('#vfspan span a').text()+')';\r\n					var name = '".toCharArray();
    _jsp_string150 = "\r\n								</select>\r\n							  	<!--	<option  value=\"".toCharArray();
    ...
    _jsp_string161 = "\">\r\n										<select style=\"width:140px\" class=inputstyle id=\"matrixCfield_".toCharArray();
  }
}

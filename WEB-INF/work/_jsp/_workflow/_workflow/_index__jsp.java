...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.conn.RecordSet workflowtype;
      workflowtype = (weaver.conn.RecordSet) pageContext.getAttribute("workflowtype");
      if (workflowtype == null) {
        workflowtype = new weaver.conn.RecordSet();
        pageContext.setAttribute("workflowtype", workflowtype);
      }
    ...
    interfacenum = l.size();
      ...
      out.print((useform ));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((SystemEnv.getHtmlLabelName(125101,user.getLanguage())));
      ...
      out.print((workflownum ));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((SystemEnv.getHtmlLabelName(125102,user.getLanguage())));
      out.write(_jsp_string73, 0, _jsp_string73.length);
      out.print((useworkflow ));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((SystemEnv.getHtmlLabelName(125103,user.getLanguage())));
      out.write(_jsp_string74, 0, _jsp_string74.length);
      out.print((SystemEnv.getHtmlLabelName(26312,user.getLanguage())));
      out.write(_jsp_string75, 0, _jsp_string75.length);
      out.print((reportnum ));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((SystemEnv.getHtmlLabelName(125104,user.getLanguage())));
      ...
      out.print((interfacenum ));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((SystemEnv.getHtmlLabelName(125105,user.getLanguage())));
      out.write(_jsp_string78, 0, _jsp_string78.length);
      out.print((useinterface ));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((SystemEnv.getHtmlLabelName(125106,user.getLanguage())));
      out.write(_jsp_string79, 0, _jsp_string79.length);
      out.print((SystemEnv.getHtmlLabelName(125107,user.getLanguage())));
      out.write(_jsp_string80, 0, _jsp_string80.length);
      out.print((SystemEnv.getHtmlLabelName(32597,user.getLanguage())));
      out.write(_jsp_string81, 0, _jsp_string81.length);
      out.print((SystemEnv.getHtmlLabelName(125108,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(125109,user.getLanguage())));
      out.write(_jsp_string84, 0, _jsp_string84.length);
      out.print((SystemEnv.getHtmlLabelName(125110,user.getLanguage())));
      out.write(_jsp_string85, 0, _jsp_string85.length);
      out.print((SystemEnv.getHtmlLabelName(125111,user.getLanguage())));
      out.write(_jsp_string86, 0, _jsp_string86.length);
      out.print((SystemEnv.getHtmlLabelName(125112,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(125113,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(129499, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(33736, user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/index.jsp"), -3625577804583892653L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string107 = "\").animate({\"width\": \"".toCharArray();
    _jsp_string21 = "\";\r\n	    xmlhttp.open(\"GET\",URL, false);\r\n	    xmlhttp.send(null);\r\n	    var result = xmlhttp.status;\r\n	    if(result==200) {\r\n		    isconn = true;\r\n	    	var response_flag = xmlhttp.responseText;\r\n	    	if(response_flag!='0') {\r\n	    		var flag_msg = '';\r\n	    		if(response_flag=='1') {\r\n	    			var diag = new Dialog();\r\n					diag.Width = 300;\r\n					diag.Height = 180;\r\n					diag.ShowCloseButton=false;\r\n					diag.Title = \"".toCharArray();
    _jsp_string103 = "\r\n			if (".toCharArray();
    _jsp_string80 = "</div>\r\n	</div>\r\n	<div id=\"right3\">\r\n		<a onmouseover=\"showBt(this)\" onmouseout=\"hiddenBt(this)\"  href=\"/workflow/workflow/help1.jsp\" style=\"width:90px;height:30px;vertical-align:middle;\"><span class=\"btstyle01\">".toCharArray();
    ...
    _jsp_string94 = "\" style=\"width:0px;\"></span>\r\n  						</div>\r\n  						<div style=\"clear:both;\"></div>\r\n  					</div>\r\n  				".toCharArray();
    ...
    _jsp_string89 = "_wev8.png);\">".toCharArray();
    ...
    _jsp_string65 = "\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string111 = "\", promptWrod);\r\n	    		return;\r\n	    	} else {\r\n	    		var dataarray = eval(data);\r\n	    		\r\n	    		var total = 0;\r\n	    		for (var i=0; i<dataarray.length; i++) { \r\n  					var count = parseInt(dataarray[i].count);\r\n  					if(total<count)total=count;\r\n  				}\r\n	    		\r\n	    		for (var i=0; i<dataarray.length; i++) {\r\n	    			try {\r\n	    				var progress = \"0%\";\r\n	  					var progressShow = \"0%\";\r\n	  					\r\n	  					var count = parseInt(dataarray[i].count);\r\n	  					if(total==count){\r\n	  						if(total == 0) {\r\n	  							total=1;\r\n	  						}\r\n	  						progressShow=\"100%\";\r\n	  						progress = \"85%\";\r\n	  					}else{\r\n	  						progressShow = 	Math.round(count*1.0/total*100)+\"%\";\r\n	  						progress = (count*1.0/total*100*0.85)+\"%\";\r\n	  					}\r\n	  					if (count == 0) {\r\n	    					$(\"#log_\" + dataarray[i].opdate).html(\"".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string93 = "\" class=\"e8_progress e8_progress_".toCharArray();
    ...
    _jsp_string100 = "\" id=\"log_".toCharArray();
    _jsp_string29 = "')) {\r\n				    lenck = false;\r\n				    break;\r\n			    }\r\n		    }\r\n		    if(lenck==false) return false;\r\n	    }\r\n	    catch(e) {}\r\n	    ".toCharArray();
    _jsp_string58 = "\r\n<meta http-equiv=\"".toCharArray();
    _jsp_string98 = "_wev8.png);\"></div>\r\n  						<div class=\"e8_logcontent\">".toCharArray();
    _jsp_string97 = "\r\n  					<div style=\"margin-top:20px;\">\r\n  						<div class=\"e8_ranking\" style=\"background-image:url(/images/ecology8/doc/ranklog_".toCharArray();
    _jsp_string106 = "\").css(\"width\",\"200px\").removeClass(\"e8_progress_\"+i);\r\n			} else {\r\n				$(\"#top_wfid_".toCharArray();

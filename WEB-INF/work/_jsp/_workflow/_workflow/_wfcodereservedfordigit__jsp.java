...
public class _wfcodereservedfordigit__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("workflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(22779,user.getLanguage()) , null), false);
      ...
      out.print(( PageIdConst.WF_WORKFLOW_WORKFLOWSUBWFSET ));
...
tableString =   " <table instanceid=\"workflowCodeSeqTable\" tabletype=\"checkbox\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.WF_WORKFLOW_WORKFLOWSUBWFSET,user.getUID())+"\" >"+
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(125356,user.getLanguage()) ));
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(22779,user.getLanguage()) );
          ...
          if (_jspEval17 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                int _jsp_end_24 = _jsp_SplitPageTag_4.doEndTag();
      ...
      out.print((SystemEnv.getHtmlLabelName(22779,user.getLanguage()) + SystemEnv.getHtmlLabelName(33564,user.getLanguage())));
      out.write(_jsp_string156, 0, _jsp_string156.length);
      out.print((SystemEnv.getHtmlLabelName(365,user.getLanguage()) + SystemEnv.getHtmlLabelName(22779,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/WFCodeReservedForDigit.jsp"), 372818785395543859L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string164 = "\", function (){\r\n		window.location = \"/workflow/workflow/WorkflowCodeSeqSetOperation.jsp?ids=\"+ids+\"&actionKey=deleteAll&workflowId=".toCharArray();
    _jsp_string152 = "\r\n			".toCharArray();
    ...
    _jsp_string160 = "&formId=".toCharArray();
    _jsp_string159 = "\", function (){\r\n		window.location = \"/workflow/workflow/WorkflowCodeSeqSetOperation.jsp?id=\"+id+\"&actionKey=del&workflowId=".toCharArray();
    ...
    _jsp_string123 = "\r\n							".toCharArray();
    _jsp_string154 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.closeByHand()\" style=\"width: 60px!important;\">\r\n			".toCharArray();
    ...
    _jsp_string143 = "\" id=\"zd_btn_cancle\"  class=\"e8_btn_top\" onclick=\"creatNewCode(".toCharArray();
    ...
    _jsp_string145 = "\" id=\"zd_btn_cancle\"  class=\"e8_btn_top\" onclick=\"deltype()\">\r\n			<span title=\"".toCharArray();
    _jsp_string76 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();

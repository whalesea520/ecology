...
public class _workflowsubwfset__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.workflow.workflow.WorkflowSubwfSetManager WorkflowSubwfSetManager;
      WorkflowSubwfSetManager = (weaver.workflow.workflow.WorkflowSubwfSetManager) pageContext.getAttribute("WorkflowSubwfSetManager");
      if (WorkflowSubwfSetManager == null) {
        WorkflowSubwfSetManager = new weaver.workflow.workflow.WorkflowSubwfSetManager();
        pageContext.setAttribute("WorkflowSubwfSetManager", WorkflowSubwfSetManager);
      }
      out.write(_jsp_string2, 0, _jsp_string2.length);
...
if(isTriDiffWorkflow.equals("")){
	...
	if("1".equals(isTriDiffWorkflow)){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(31767,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(21579,user.getLanguage())));
              ...
              do {
                ...
                if (!"1".equals(isTriDiffWorkflow)) out.println("checked");
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(21580,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
          ...
          _jsp_GroupTag_3.setContext(SystemEnv.getHtmlLabelName(31769,user.getLanguage()));
          _jsp_GroupTag_3.setAttributes(attributes1 );
          ...
          if (_jspEval25 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_ViewTag_6.setAttributes("{'formTableId':'oTable'}");
                int _jspEval35 = _jsp_ViewTag_6.doStartTag();
                if (_jspEval35 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  if (_jspEval35 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
                    out = pageContext.pushBody();
                    _jsp_endTagHack33 = (com.caucho.jsp.BodyContentImpl) out;
                    _jsp_ViewTag_6.setBodyContent(_jsp_endTagHack33);
                  ...
                  do {
                    ...
                    int _jspEval38 = _jsp_GroupTag_7.doStartTag();
                    if (_jspEval38 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      if (_jspEval38 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
                        ...
                        _jsp_GroupTag_7.setBodyContent(_jsp_endTagHack36);
                      ...
                      do {
                        ...
                        if (_jsp_ItemTag_8 == null) {
                          ...
                          _jsp_ItemTag_8.setAttributes("{'isTableList':'true'}");
                        }
                        ...
                        do {
                          ...
                          if (_jsp_SplitPageTag_9 == null) {
                            ...
                            _jsp_SplitPageTag_9.setParent((javax.servlet.jsp.tagext.Tag) _jsp_ItemTag_8);
                          ...
                          int _jsp_end_45 = _jsp_SplitPageTag_9.doEndTag();
                ...
                if (_jsp_endTagHack33 != null) {
                  pageContext.releaseBody(_jsp_endTagHack33);
                  _jsp_endTagHack33 = null;
                }
                out.write(_jsp_string145, 0, _jsp_string145.length);
          ...
          _jsp_GroupTag_3.setContext(SystemEnv.getHtmlLabelName(31769,user.getLanguage()));
          _jsp_GroupTag_3.setAttributes(attributes2 );
          int _jspEval53 = _jsp_GroupTag_3.doStartTag();
          if (_jspEval53 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval53 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_3.setBodyContent(_jsp_endTagHack51);
              _jsp_GroupTag_3.doInitBody();
            }
            do {
              ...
              do {
                ...
                _jsp_ViewTag_6.setAttributes("{'formTableId':'oTableDiff'}");
                int _jspEval63 = _jsp_ViewTag_6.doStartTag();
                if (_jspEval63 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  if (_jspEval63 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
                    ...
                    _jsp_ViewTag_6.setBodyContent(_jsp_endTagHack61);
                    _jsp_ViewTag_6.doInitBody();
                  }
                  do {
                    out.write(_jsp_string150, 0, _jsp_string150.length);
                    ...
                    int _jspEval66 = _jsp_GroupTag_7.doStartTag();
                    if (_jspEval66 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      if (_jspEval66 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
                        ...
                        _jsp_GroupTag_7.setBodyContent(_jsp_endTagHack64);
                        _jsp_GroupTag_7.doInitBody();
                      }
                      do {
                        out.write(_jsp_string151, 0, _jsp_string151.length);
                        ...
                        do {
                          ...
                          _jsp_SplitPageTag_9.setTableString(tableString);
                          _jsp_SplitPageTag_9.doStartTag();
                          int _jsp_end_73 = _jsp_SplitPageTag_9.doEndTag();
      ...
      out.print((SystemEnv.getHtmlLabelName(25361,user.getLanguage())));
      out.write(_jsp_string173, 0, _jsp_string173.length);
      out.print((SystemEnv.getHtmlLabelName(25362,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelNames("33504",user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(25166, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelNames("31829",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/WorkflowSubwfSet.jsp"), 5872391436872209392L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string135 = "\r\n<form name=\"formWorkflowSubwfSet\" method=\"post\">     \r\n<INPUT type=\"hidden\" Name=\"mainWorkflowId\" value=\"".toCharArray();
    ...
    _jsp_string200 = "\";\r\n	url=\"/docs/tabs/DocCommonTab.jsp?dialog=1&_fromURL=65&ajax=1&triDiffWfDiffFieldId=\"+triDiffWfDiffFieldId+\"&mainWorkflowId=".toCharArray();
    ...
    _jsp_string144 = "\r\n    \r\n    ".toCharArray();
    _jsp_string162 = "\";\r\n	url=\"/docs/tabs/DocCommonTab.jsp?dialog=1&_fromURL=62&wfid=".toCharArray();
    _jsp_string187 = "\";\r\n	url=\"/docs/tabs/DocCommonTab.jsp?dialog=1&_fromURL=64&ajax=1&workflowSubwfSetId=\"+workflowSubwfSetId+\"&mainWorkflowId=".toCharArray();
    ...
    _jsp_string180 = "</option></select>\";                      \r\n      else  if (i==8) oDiv.innerHTML=\"<span id=detailLinkSpan><a href='#'>".toCharArray();
    ...
    _jsp_string137 = "\r\n    ".toCharArray();
    _jsp_string156 = " \r\n				<input type=button class=addbtn style=\"margin-top:7px;\" onclick=\"addSubWf('1')\" title=\"".toCharArray();
    _jsp_string3 = "\r\n	<script language=\"javascript\">\r\n		window.top.Dialog.alert(\"".toCharArray();
    _jsp_string143 = "  onclick=\"showSubwfSetContent(1)\">".toCharArray();
    ...
    _jsp_string151 = "\r\n						".toCharArray();
    _jsp_string177 = "</option><option value=1>".toCharArray();
    _jsp_string130 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result7\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string191 = "';\r\n   }else if(triggerOperationDiffValue!=\"\" && triggerOperationDiffValue==3){\r\n   		triggerOperationDiffText='".toCharArray();
    _jsp_string185 = "</A>\";\r\n    } else if(oRowIndex>2){\r\n    	jQuery(\"input[name=chkSubWorkflowSet]\")[oRowIndex-2].value = workflowSubwfSetId;\r\n		subWorkflowId=jQuery(\"input[name=subWorkflowIdValue]\")[oRowIndex-2].value;\r\n\r\n		jQuery(\"span[id=detailLinkSpan]\")[oRowIndex-2].innerHTML=\"<A HREF='#' onClick='goWorkflowSubwfSetDetail(\"+workflowSubwfSetId+\", \"+mainWorkflowId+\", \"+subWorkflowId+\")'\"+\">".toCharArray();
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    _jsp_string47 = "\";\r\nusblanguage = \"".toCharArray();
    _jsp_string55 = "/skins/".toCharArray();
    _jsp_string178 = "</option></select>\";\r\n                      else oDiv.innerHTML=\"<select class='inputStyle' name=isreaddetail onchange=isreadonchange(this)><option value=0>".toCharArray();
    _jsp_string87 = ");\r\n			}\r\n		}catch(e){}\r\n		".toCharArray();
    ...
    _jsp_string142 = "<input type=\"radio\" name=\"isTriDiffWorkflow\" value=\"1\" ".toCharArray();
    ...
    _jsp_string146 = " \r\n				<input type=button class=addbtn style=\"margin-top:7px;\" onclick=\"addSubWf('0')\" title=\"".toCharArray();
    _jsp_string29 = "')) {\r\n				    lenck = false;\r\n				    break;\r\n			    }\r\n		    }\r\n		    if(lenck==false) return false;\r\n	    }\r\n	    catch(e) {}\r\n	    ".toCharArray();
    _jsp_string140 = "<input type=\"radio\" name=\"isTriDiffWorkflow\" value=\"0\" ".toCharArray();
    _jsp_string58 = "\r\n<meta http-equiv=\"".toCharArray();
    _jsp_string183 = "\",function(){\r\n		jQuery.ajax({\r\n			url:\"officalwf_operation.jsp\",\r\n			type:\"post\",\r\n			data:{\r\n				workflowSubwfSetId:id,\r\n				operation:\"deleteSubWfSet\",\r\n				wfid:\"".toCharArray();
    _jsp_string164 = "\";\r\n	url=\"/docs/tabs/DocCommonTab.jsp?dialog=1&_fromURL=63&id=\"+id+\"&wfid=".toCharArray();
    ...
    _jsp_string179 = "</option><option value=1 selected>".toCharArray();
    ...
    _jsp_string188 = "&subWorkflowId=\"+subWorkflowId;\r\n	\r\n	diag_vote = new window.top.Dialog();\r\n	diag_vote.currentWindow = window;\r\n	diag_vote.Width = 800;\r\n	diag_vote.Height = 600;\r\n	diag_vote.maxiumnable = true;\r\n	diag_vote.Modal = true;\r\n	diag_vote.Title = title;\r\n	diag_vote.URL = url;\r\n	diag_vote.show();\r\n\r\n}\r\n\r\nfunction addValueDiff(){\r\n  \r\n   var mainWorkflowId=".toCharArray();

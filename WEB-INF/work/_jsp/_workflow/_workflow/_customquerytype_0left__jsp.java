...
public class _customquerytype_0left__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(125100,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/CustomQueryType_left.jsp"), 4523927788135077977L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string53 = "\r\n".toCharArray();
    _jsp_string131 = "';\r\n		//alert(cxtree_id);\r\n		CXLoadTreeItem(\"\", \"/workflow/workflow/CustomQueryTypeXML.jsp?init=true&subcompanyid=".toCharArray();

...
public class _triggertablebrowser__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelNames("33523",user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(33522,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(2115,user.getLanguage())));
                ...
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(2114,user.getLanguage())));
                out.write(_jsp_string146, 0, _jsp_string146.length);
                if(modetype==5){
                out.write(_jsp_string140, 0, _jsp_string140.length);
                }
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(2116,user.getLanguage())));
                out.write(_jsp_string147, 0, _jsp_string147.length);
                if(modetype==6){
                out.write(_jsp_string140, 0, _jsp_string140.length);
                }
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(2117,user.getLanguage())));
                out.write(_jsp_string148, 0, _jsp_string148.length);
                if(modetype==7){
                out.write(_jsp_string140, 0, _jsp_string140.length);
                }
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(18442,user.getLanguage())));
                out.write(_jsp_string149, 0, _jsp_string149.length);
                if(modetype==9){
                out.write(_jsp_string140, 0, _jsp_string140.length);
                }
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(20613,user.getLanguage())));
                ...
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(16371,user.getLanguage())));
          ...
          if (_jspEval25 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                int _jsp_end_32 = _jsp_SplitPageTag_4.doEndTag();
      ...
      out.print(( PageIdConst.WF_WORKFLOW_TRIGGERTABLEBROWSER ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/triggerTableBrowser.jsp"), -5619786933373500608L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string133 = "\">\r\n<input type=\"hidden\" id=\"searchflag\" name=\"searchflag\" value=\"".toCharArray();
    ...
    _jsp_string162 = "\" onclick='onClose();'></input>\r\n			".toCharArray();
    ...
    _jsp_string137 = "<input name=tablename class=\"InputStyle\" value='".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();

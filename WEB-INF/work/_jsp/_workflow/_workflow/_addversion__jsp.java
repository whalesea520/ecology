...
public class _addversion__jsp extends com.caucho.jsp.JavaPage
{
...
String lastVersionID = wfversion.getLastVersionID() + "";
      ...
      out.print((SystemEnv.getHtmlLabelName(129419, user.getLanguage())));
      out.write(_jsp_string67, 0, _jsp_string67.length);
      out.print((SystemEnv.getHtmlLabelName(129420, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(129421, user.getLanguage())));
      ...
      out.print((Integer.parseInt(lastVersionID) + 1 ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/addVersion.jsp"), 994340321052903400L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string74 = "\" onclick=\"saveAsVersion()\" class=\"zd_btn_submit\" id=\"btnok\">\r\n		          <input type=\"button\" value=\"".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string75 = "\" onclick=\"cancelSaveAs('wfversionDiv');\" class=\"zd_btn_cancle\" id=\"btncancel\">\r\n		      </td></tr>\r\n		  </table>\r\n	  </div>\r\n  </body>\r\n</html>\r\n".toCharArray();
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();

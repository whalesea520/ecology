...
public class _wfcodebrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("workflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(81822,user.getLanguage()), null), false);
      ...
      out.write(_jsp_string133, 0, _jsp_string133.length);
      out.print((SystemEnv.getHtmlLabelName(125082,user.getLanguage()) ));
...
while(RecordSet.next()){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/workflow/WFCodeBrowser.jsp"), -6540798408271624752L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string131 = "\" id=\"zd_btn_cancle\"  class=\"e8_btn_top\" onclick=\"onSure()\">\r\n			<span title=\"".toCharArray();
    ...
    _jsp_string141 = "\" name=\"printNodesName_".toCharArray();
    ...
    _jsp_string138 = "\" name=\"printNodes_".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string154 = "\" id=\"zd_btn_submit\" class=\"zd_btn_submit\" onclick=\"onclear();\">\r\n		    	<input type=\"button\" accessKey=T  id=btncancel value=\"".toCharArray();
    _jsp_string136 = "\r\n<TR class=DataDark>\r\n	".toCharArray();
    _jsp_string135 = "\r\n<TR class=DataLight>\r\n".toCharArray();

...
public class _multiworkflowfieldbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelNames("33331",user.getLanguage())));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/field/MultiWorkflowFieldBrowser.jsp"), 1336092870114992313L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string138 = "<input class=InputStyle id=fieldname name=fieldname value='".toCharArray();
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    ...
    _jsp_string147 = "\r\n<script type=\"text/javascript\">\r\n		jQuery(document).ready(function(){\r\n			resizeDialog(document);\r\n		});\r\n	</script>\r\n</div>\r\n<script type=\"text/javascript\">\r\n\r\njQuery(document).ready(function(){\r\n	showMultiMouldDialog(\"".toCharArray();
    ...
    _jsp_string134 = "'>\r\n<input type=\"hidden\" name=\"selfieldid\" value='".toCharArray();

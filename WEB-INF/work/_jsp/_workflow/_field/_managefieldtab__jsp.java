...
public class _managefieldtab__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	int current = Util.getIntValue(request.getParameter("current"), 0);
      ...
      out.print((SystemEnv.getHtmlLabelName(18549, user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/field/managefieldTab.jsp"), 3118115944064153990L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string71 = "class=\"current\"".toCharArray();

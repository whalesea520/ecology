...
public class _browsertypesetting__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.workflow.workflow.WorkTypeComInfo workType;
      workType = (weaver.workflow.workflow.WorkTypeComInfo) pageContext.getAttribute("workType");
      if (workType == null) {
        workType = new weaver.workflow.workflow.WorkTypeComInfo();
        pageContext.setAttribute("workType", workType);
      }
	...
	String noneedtree = Util.null2String(request.getParameter("noneedtree"),"0");
      ...
      out.print((SystemEnv.getHtmlLabelName(16490,user.getLanguage())));
      out.write(_jsp_string72, 0, _jsp_string72.length);
      out.print((SystemEnv.getHtmlLabelName(81830,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/field/browsertypesetting.jsp"), -930958524143090761L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string73 = "</a>\r\n					</li>    \r\n		    </ul>\r\n	    <div id=\"rightBox\" class=\"e8_rightBox\">\r\n	    </div>\r\n	    </div>\r\n	    </div>\r\n	    </div>\r\n	    <div class=\"tab_box\">\r\n	        <div>\r\n	            <iframe src=\"/workflow/field/browsermanagetype.jsp?isFromMode=".toCharArray();
    ...
    _jsp_string48 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string71 = "\" target=\"tabcontentframe\">".toCharArray();
    _jsp_string38 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string74 = "\" onload=\"update()\" id=\"tabcontentframe\" name=\"tabcontentframe\" class=\"flowFrame\" frameborder=\"0\" height=\"100%\" width=\"100%;\"></iframe>\r\n	        </div>\r\n	    </div>\r\n	</div>     \r\n</body>\r\n<script type=\"text/javascript\">\r\n    function searchTable(){\r\n	  window.frames[\"tabcontentframe\"].searchTable();\r\n	}\r\n</script>\r\n</html>\r\n".toCharArray();
    ...
    _jsp_string70 = "&noneedtree=".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string69 = "\"); });\r\n\r\n	var parentWin = null;\r\n	var dialog = null;\r\n	try{\r\n		parentWin = parent.parent.getParentWindow(parent);\r\n		dialog = parent.parent.getDialog(parent);\r\n	}catch(e){}\r\n	\r\n	function winclose(){\r\n		dialog.close();\r\n	}\r\n</script>\r\n</head>\r\n<BODY scroll=\"no\">\r\n	<div class=\"e8_box demo2\">\r\n	      <div class=\"e8_boxhead\">\r\n		    <div class=\"div_e8_xtree\" id=\"div_e8_xtree\"></div>\r\n	        <div class=\"e8_tablogo\" id=\"e8_tablogo\"></div>\r\n			<div class=\"e8_ultab\">\r\n				<div class=\"e8_navtab\" id=\"e8_navtab\">\r\n					<span id=\"objName\"></span>\r\n				</div>\r\n			<div>\r\n	       \r\n		    <ul class=\"tab_menu\">\r\n					<li class=\"current\">\r\n				    	<a href=\"/workflow/field/browsermanagetype.jsp?isFromMode=".toCharArray();
    ...
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string72 = "</a>\r\n				    </li>\r\n					<li>\r\n					    <a href=\"/workflow/field/browsertypeedit.jsp\" target=\"tabcontentframe\">".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();
  }
}

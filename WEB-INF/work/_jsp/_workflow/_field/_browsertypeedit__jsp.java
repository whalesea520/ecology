...
public class _browsertypeedit__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.print((SystemEnv.getHtmlLabelName(129044, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(129045, user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(23051,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/field/browsertypeedit.jsp"), 5248854598291156903L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string67 = "\"+undoNames.join(\",\")+\"".toCharArray();
    ...
    _jsp_string118 = "\r\n							".toCharArray();
    _jsp_string135 = "\" class=\"e8_btn_top\"  onclick=\"deleteRow()\">\r\n			<span title=\"".toCharArray();
    ...
    _jsp_string148 = ">\r\n			<input type=\"hidden\" name=\"changeable_".toCharArray();
    ...
    _jsp_string146 = "\" value=\"0\" ".toCharArray();
    _jsp_string144 = "\" size=\"20\" value=\"".toCharArray();
    ...
    _jsp_string133 = "\" class=\"e8_btn_top\"  onclick=\"addRow()\">\r\n			<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string140 = "\r\n		   		<input type=\"checkbox\"  name=\"select_".toCharArray();
    _jsp_string137 = "</th>\r\n		<th style=\"cursor: default;\">".toCharArray();
    ...
    _jsp_string155 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"winclose()\">\r\n				".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string134 = "\" class=\"e8_btn_top\"  onclick=\"save()\">\r\n			<input type=\"button\" value=\"".toCharArray();

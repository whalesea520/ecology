...
package _jsp._workflow._transfer;
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (!"".equals(objtype) && !"".equals(objid)) {
      ...
      out.print((SystemEnv.getHtmlLabelName(84568,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelName(84569,user.getLanguage())));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((SystemEnv.getHtmlLabelName(16379,user.getLanguage())));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((SystemEnv.getHtmlLabelName(84570,user.getLanguage())));
...
String isEnableExtranetHelp = KtreeHelp.getInstance().isEnableExtranetHelp;
      ...
      _jsp_BrowserTag_0.set_callback("objChanged");
      _jsp_BrowserTag_0.setAfterDelCallback("objDeleted");
      _jsp_BrowserTag_0.setWidth("129px");
      _jsp_BrowserTag_0.setBrowserValue(objid );
      _jsp_BrowserTag_0.setBrowserSpanValue(objidspanvalue );
      ...
      out.print((SystemEnv.getHtmlLabelName(125350,user.getLanguage()) ));
      ...
      _jsp_BrowserTag_1.setGetBrowserUrlFn("onshowBrowser2");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/transfer/permissionSearchResult.jsp"), 28824101758257411L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string90 = "&objid=".toCharArray();

...
public class _reporttypexml__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      weaver.workflow.report.ReportManager ReportManager;
      ReportManager = (weaver.workflow.report.ReportManager) pageContext.getAttribute("ReportManager");
      if (ReportManager == null) {
        ReportManager = new weaver.workflow.report.ReportManager();
        pageContext.setAttribute("ReportManager", ReportManager);
      }
...
envelope.marshal(out);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/report/ReportTypeXML.jsp"), 5559893157146668956L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
}

...
public class _reportshare__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print(( PageIdConst.WF_REPORT_REPORTSHARE ));
...
tableString =   " <table instanceid=\"workflowTypeListTable\" tabletype=\"checkbox\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.WF_REPORT_REPORTSHARE,user.getUID())+"\" >"+
      ...
      out.print((SystemEnv.getHtmlLabelNames("611,81597",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/report/ReportShare.jsp"), 7052203345769846798L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string166 = "&formID=".toCharArray();
    ...
    _jsp_string147 = "/option -->\r\n				  <option value=\"3\" selected=\"selected\">".toCharArray();
    ...
    _jsp_string142 = "\" class=\"e8_btn_top\" onclick=\"newDialog()\"/>\r\n					<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string172 = "\", function(){\r\n						window.location=\"/workflow/report/ReportShareOperation.jsp?method=deleteAll&isBill=".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    ...
    _jsp_string169 = "\", function(){\r\n						window.location=\"/workflow/report/ReportShareOperation.jsp?method=delete&isBill=".toCharArray();
    ...
    _jsp_string143 = "\" class=\"e8_btn_top\" onclick=\"removeRows()\"/>\r\n					".toCharArray();
    _jsp_string170 = "&reportid=".toCharArray();
    ...
    _jsp_string165 = "\";   81597\r\n	diag_vote.URL = \"/workflow/report/ReportShareAdd.jsp?dialog=1&isBill=".toCharArray();

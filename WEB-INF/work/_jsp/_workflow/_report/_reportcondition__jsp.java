...
public class _reportcondition__jsp extends com.caucho.jsp.JavaPage
{
...
if(mouldId == 0){
	...
	while(RecordSet.next()){
      ...
      out.print((fnaOrgType_fieldId_strs_2.toString() ));
      out.write(_jsp_string69, 0, _jsp_string69.length);
      out.print((fnaOrgId_fieldId_strs_3.toString() ));
      out.write(_jsp_string70, 0, _jsp_string70.length);
      out.print((fnaOrgType_fieldId_strs_11.toString() ));
      out.write(_jsp_string71, 0, _jsp_string71.length);
      out.print((fnaOrgId_fieldId_strs_12.toString() ));
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(15505,user.getLanguage()));
		...
		tempMouldName = Util.null2String(RecordSet.getString(2));
              ...
              do {
                ...
                if (_jsp_ViewTag_4 == null) {
                  ...
                  _jsp_ViewTag_4.setType("table");
                  _jsp_ViewTag_4.setAttributes("{'cols':'4','cws':'10%,10%,20%,60%'}");
                }
                  ...
                  do {
                    ...
                    if (_jspEval22 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      ...
                      do {
                        ...
                        do {
                          out.print((SystemEnv.getHtmlLabelName(33541,user.getLanguage())));
                        ...
                        _jsp_ItemTag_6.doInitBody();
                        do {
                          out.print((SystemEnv.getHtmlLabelName(15505,user.getLanguage())));
                        } while (_jsp_ItemTag_6.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
                        out = pageContext.popBody();
                        _jsp_ItemTag_6.doEndTag();
...
if(ids.indexOf("-1")>-1 || mouldId == 0){
                        ...
                        _jsp_ItemTag_7.setBodyContent(_jsp_endTagHack39);
		...
		if(strReportDspField.indexOf(",-1,")>-1){
			...
			if(ids.indexOf("-1")>-1){
   			...
   			//currNode.reset();
                        ...
                        _jsp_ItemTag_7.setBodyContent(_jsp_endTagHack43);
                        _jsp_ItemTag_7.doInitBody();
                        do {
			...
			if(ids.indexOf("-1")>-1){
				if(((String)isCheckConds.get(Util.getIntValue(""+ids.indexOf("-1")))).equals("1")){
                        ...
                        _jsp_ItemTag_7.setBodyContent(_jsp_endTagHack47);
                        _jsp_ItemTag_7.doInitBody();
                        do {
                        ...
                        _jsp_ItemTag_7.setBodyContent(_jsp_endTagHack51);
                        _jsp_ItemTag_7.doInitBody();
                        do {
                          out.write(_jsp_string156, 0, _jsp_string156.length);
...
if(ids.indexOf("-2")>-1 || mouldId == 0){
                        ...
                        _jsp_ItemTag_7.setBodyContent(_jsp_endTagHack55);
                        _jsp_ItemTag_7.doInitBody();
                        do {
                          out.write(_jsp_string156, 0, _jsp_string156.length);
			...
			if(ids.indexOf("-2")>-1){
   			...
   			//currNode.reset();
                        ...
                        _jsp_ItemTag_7.setBodyContent(_jsp_endTagHack59);
                        _jsp_ItemTag_7.doInitBody();
                        do {
...
if(ids.indexOf("-10")>-1 || mouldId == 0){
			...
			if(ids.indexOf("-10")!=-1){
		        ...
		        browserSpanValue = ((String)names.get(Util.getIntValue(""+ids.indexOf("-10"))));
                          ...
                          _jsp_BrowserTag_8.setName("con-10_value");
                          _jsp_BrowserTag_8.setBrowserValue(browserValue);
                          _jsp_BrowserTag_8.set_callback("changeclick10brow");
                          _jsp_BrowserTag_8.setCompleteUrl("/data.jsp");
                          _jsp_BrowserTag_8.setBrowserSpanValue(browserSpanValue);
...
if(ids.indexOf("-11")>-1 || mouldId == 0){
			...
			if(ids.indexOf("-11")>-1){
				if(((String)isCheckConds.get(Util.getIntValue(""+ids.indexOf("-11")))).equals("1")){
                        ...
                        _jsp_ItemTag_7.setBodyContent(_jsp_endTagHack99);
                        _jsp_ItemTag_7.doInitBody();
                        do {
                          out.write(_jsp_string156, 0, _jsp_string156.length);
...
if(ids.indexOf("-12")>-1 || mouldId == 0){
			...
			String browserUrl = "/systeminfo/BrowserMain.jsp?url=/workflow/workflow/WFTypeBrowser.jsp?reportCondition=1&reportwfid="+reportwfid;
                          ...
                          _jsp_BrowserTag_9.setName("con-12_value");
                          _jsp_BrowserTag_9.setBrowserOnClick("");
                          _jsp_BrowserTag_9.set_callback("changeclick12brow");
                          _jsp_BrowserTag_9.setAfterDelCallback("afterDelCallback12brow");
                          ...
                          _jsp_BrowserTag_9.setBrowserValue(browserValue);
                          _jsp_BrowserTag_9.setBrowserUrl(browserUrl );
                          _jsp_BrowserTag_9.setCompleteUrl(compurl);
                          _jsp_BrowserTag_9.setBrowserSpanValue(browserSpanValue);
                          _jsp_BrowserTag_9.setJspBody(_jsp_fragment_1 = com.caucho.jsp.StaticJspFragmentSupport.create(_jsp_fragment_1, pageContext, " \r\n				 "));
...
if(ids.indexOf("-13")>-1 || mouldId == 0){
			...
			if(ids.indexOf("-13")>-1){
				if(((String)isCheckConds.get(Util.getIntValue(""+ids.indexOf("-13")))).equals("1")){
                        ...
                        _jsp_ItemTag_7.setBodyContent(_jsp_endTagHack127);
                        _jsp_ItemTag_7.doInitBody();
                        do {
                          out.print((SystemEnv.getHtmlLabelName(18564,user.getLanguage())));
                          out.write(_jsp_string212, 0, _jsp_string212.length);
                          out.print((SystemEnv.getHtmlLabelName(126631,user.getLanguage()) ));
                        ...
                        _jsp_ItemTag_7.setBodyContent(_jsp_endTagHack131);
                        _jsp_ItemTag_7.doInitBody();
                        do {
                          out.write(_jsp_string156, 0, _jsp_string156.length);
			...
			String compurl2 = "javascript:getajaxurl('currentnodeBrowser')";
                          ...
                          _jsp_BrowserTag_10.setName("con-13_value");
                          _jsp_BrowserTag_10.setBrowserOnClick("");
                          _jsp_BrowserTag_10.set_callback("changeclick13brow");
                          _jsp_BrowserTag_10.setBrowserUrl("");
                          _jsp_BrowserTag_10.setGetBrowserUrlFn("get13browurl");
                          _jsp_BrowserTag_10.setHasInput("true");
                          _jsp_BrowserTag_10.setWidth("150px");
                          _jsp_BrowserTag_10.setIsSingle("true");
                          _jsp_BrowserTag_10.setHasBrowser("true");
                          _jsp_BrowserTag_10.setIsMustInput("1");
                          _jsp_BrowserTag_10.setBrowserSpanValue(browserSpanValue);
                          _jsp_BrowserTag_10.setBrowserValue(browserValue);
                          _jsp_BrowserTag_10.setCompleteUrl(compurl2);
                          _jsp_BrowserTag_10.setJspBody(_jsp_fragment_2 = com.caucho.jsp.StaticJspFragmentSupport.create(_jsp_fragment_2, pageContext, " \r\n				"));
...
if(ids.indexOf("-14")>-1 || mouldId == 0){
			...
			if(ids.indexOf("-14")!=-1){
		        ...
		        browserSpanValue = ((String)names.get(Util.getIntValue(""+ids.indexOf("-14"))));
                          ...
                          _jsp_BrowserTag_8.setHasBrowser("true");
                          _jsp_BrowserTag_8.setIsMustInput("1");
                          _jsp_BrowserTag_8.setName("con-14_value");
                          _jsp_BrowserTag_8.setBrowserSpanValue(browserSpanValue);
                          _jsp_BrowserTag_8.set_callback("changeclick14brow");
                          _jsp_BrowserTag_8.setBrowserValue(browserValue);
                          _jsp_BrowserTag_8.setCompleteUrl("javascript:getajaxurl(1)");
...
if(ids.indexOf("-16")>-1 || mouldId == 0){
			...
			if(ids.indexOf("-16")>-1){
				if(((String)isCheckConds.get(Util.getIntValue(""+ids.indexOf("-16")))).equals("1")){
                        ...
                        _jsp_ItemTag_7.setBodyContent(_jsp_endTagHack175);
                        _jsp_ItemTag_7.doInitBody();
                        do {
                        ...
                        _jsp_ItemTag_7.setBodyContent(_jsp_endTagHack179);
                        _jsp_ItemTag_7.doInitBody();
                        do {
                          out.write(_jsp_string156, 0, _jsp_string156.length);
			...
			if(ids.indexOf("-16")>-1){
                ...
                out.write(_jsp_string2, 0, _jsp_string2.length);
                pageContext.include("ReportCondition_inner.jsp", "isbill=" + com.caucho.el.Expr.toString(isbill , null)+ "&" + "formid=" + com.caucho.el.Expr.toString(formid , null)+ "&" + "reportwfid=" + com.caucho.el.Expr.toString(reportwfid , null)+ "&" + "sharelevel=" + com.caucho.el.Expr.toString(sharelevel , null)+ "&" + "reportid=" + com.caucho.el.Expr.toString(reportid , null)+ "&" + "mouldId=" + com.caucho.el.Expr.toString(mouldId , null)+ "&" + "fna=" + com.caucho.el.Expr.toString(fna , null), false);
      ...
      out.print((SystemEnv.getHtmlLabelName(16722,user.getLanguage())));
      out.write(_jsp_string242, 0, _jsp_string242.length);
      out.print((SystemEnv.getHtmlLabelName(81551,user.getLanguage())));
      out.write(_jsp_string243, 0, _jsp_string243.length);
      out.print((new BrowserComInfo().getBrowserurl("251") ));
      ...
      out.print((SystemEnv.getHtmlLabelName(683, user.getLanguage()==0?7:user.getLanguage())));
      out.write(_jsp_string262, 0, _jsp_string262.length);
      out.print((SystemEnv.getHtmlLabelName(18941, user.getLanguage()==0?7:user.getLanguage())));
      out.write(_jsp_string263, 0, _jsp_string263.length);
      out.print((SystemEnv.getHtmlLabelName(683, user.getLanguage()==0?7:user.getLanguage())));
      out.write(_jsp_string262, 0, _jsp_string262.length);
      out.print((SystemEnv.getHtmlLabelName(18942, user.getLanguage()==0?7:user.getLanguage())));
      out.write(_jsp_string264, 0, _jsp_string264.length);
      out.print((SystemEnv.getHtmlLabelName(3005, user.getLanguage()==0?7:user.getLanguage())));
      out.write(_jsp_string265, 0, _jsp_string265.length);
      out.print((SystemEnv.getHtmlLabelName(683, user.getLanguage()==0?7:user.getLanguage())));
      out.write(_jsp_string262, 0, _jsp_string262.length);
      out.print((SystemEnv.getHtmlLabelName(18945, user.getLanguage()==0?7:user.getLanguage())));
      out.write(_jsp_string266, 0, _jsp_string266.length);
      out.print((SystemEnv.getHtmlLabelName(683, user.getLanguage()==0?7:user.getLanguage())));
      out.write(_jsp_string262, 0, _jsp_string262.length);
      out.print((SystemEnv.getHtmlLabelName(18943, user.getLanguage()==0?7:user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/report/ReportCondition.jsp"), 2251849230698933105L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string68 = "\r\n\r\n<BODY>\r\n<script type=\"text/javascript\">\r\nvar fnaOrgType_fieldId_array_2 = [".toCharArray();
    _jsp_string256 = "\"==\"164\"){\r\n			for(var i=0;i<check_con.length;i++){\r\n				var cc = check_con[i];\r\n				if(cc.value==\"".toCharArray();
    ...
    _jsp_string177 = "\" style=\"width:150px;\" name=\"requestnamevalue\" onfocus=\"changeclick1()\"> \r\n      ".toCharArray();
    _jsp_string262 = ">=\"\r\n									+ secLevelValue\r\n									+ \"".toCharArray();
    ...
    _jsp_string216 = "\">\r\n      		<input type=hidden name=\"con-13_name\" id=\"con-13_name\" value=\"".toCharArray();
    ...
    _jsp_string70 = "];\r\n\r\nvar fnaOrgType_fieldId_array_11 = [".toCharArray();
    _jsp_string202 = "\r\n		<input type=\"checkbox\" name=\"workflowtoIsShow\" notBeauty=\"true\" value=\"1\" \r\n		".toCharArray();
    _jsp_string195 = "\r\n		<!-- \u521b\u5efa\u65e5\u671f -->\r\n".toCharArray();
    _jsp_string159 = "</option>\r\n			".toCharArray();
    _jsp_string225 = "\">\r\n      		<input type=hidden name=\"con-14_name\" id=\"con-14_name\" value=\"".toCharArray();
    ...
    _jsp_string224 = "      \r\n		   </div>\r\n\r\n      		<input type=hidden name=\"con-14_value\" id=\"con-14_value\" value=\"".toCharArray();
    ...
    _jsp_string126 = "\r\n							".toCharArray();
    _jsp_string152 = "\"  class=\"e8_btn_top\" onclick=\"addTemplate()\" >\r\n		".toCharArray();
    ...
    _jsp_string101 = "visible".toCharArray();
    ...
    _jsp_string251 = "\"){\r\n					cc.checked=true;\r\n				}\r\n			}\r\n			document.getElementById(\"con".toCharArray();
    _jsp_string212 = "&nbsp;<span class='e8tips' title='".toCharArray();
    ...
    _jsp_string171 = " selected ".toCharArray();
    ...
    _jsp_string151 = "\"  class=\"e8_btn_top\" onclick=\"onDeleteTemplate()\" >\r\n		".toCharArray();
    _jsp_string14 = "\";\r\nfunction check_conn() {\r\n	return confirm('".toCharArray();
    _jsp_string71 = "];\r\nvar fnaOrgId_fieldId_array_12 = [".toCharArray();
    ...
    _jsp_string198 = "\r\n		<span class=\"wuiDateSpan\" selectId=\"createdatespan\" onclick=\"changecreatedate()\" selectValue=\"\">\r\n			<input class=wuiDateSel type=\"hidden\" name=\"createdate\" value=\"".toCharArray();
    _jsp_string237 = "\">\r\n				<input class=wuiDateSel type=\"hidden\" name=\"filingdateend\" value=\"".toCharArray();
    _jsp_string270 = "&mouldId=".toCharArray();
    ...
    _jsp_string91 = " oncontextmenu='return false'".toCharArray();
    ...
    _jsp_string69 = "];\r\nvar fnaOrgId_fieldId_array_3 = [".toCharArray();
    _jsp_string164 = "\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string192 = " \r\n		    </div>\r\n      	\r\n      		<input type=hidden name=\"con-10_value\" id=\"con-10_value\" value=\"".toCharArray();
    ...
    _jsp_string271 = "&newMouldName=".toCharArray();
    _jsp_string201 = "\r\n		<!--  -->\r\n		<!-- \u5de5\u4f5c\u6d41 -->\r\n".toCharArray();
    _jsp_string218 = "\r\n		<!--  -->\r\n		<!-- \u672a\u64cd\u4f5c\u8005 -->\r\n".toCharArray();
    _jsp_string278 = "\",\r\n					mouldId:\"".toCharArray();
    ...
    _jsp_string199 = "\">\r\n			<input class=wuiDateSel type=\"hidden\" name=\"createdateend\" value=\"".toCharArray();
    _jsp_string180 = "\r\n		<input type=\"checkbox\" name=\"requestLevelIsShow\" notBeauty=\"true\" value=\"1\" \r\n		".toCharArray();
    _jsp_string254 = "\"){\r\n					cc.checked=true;\r\n				}\r\n			}		\r\n			document.getElementById(\"con".toCharArray();
    _jsp_string207 = "\">\r\n      		<input type=hidden name=\"con-12_name\"  id=\"con-12_name\" value=\"".toCharArray();
    ...
    _jsp_string102 = ";display:none;\" align=\"left\"  allowtransparency=\"true\" style=\"background-color:transparent\" >\r\n	</div>\r\n	<div id=\"divRightMenuIframe\" name=\"divRightMenuIframe\" style=\"display:none\">\r\n		<iframe id=\"rightMenuIframe\" name=\"rightMenuIframe\" frameborder=0 marginheight=0 marginwidth=0 hspace=0 vspace=0 scrolling=no width=\"".toCharArray();
    ...
    _jsp_string252 = "_value\").value = 3;\r\n		}else if(\"".toCharArray();
    _jsp_string217 = "\">\r\n     		 \r\n		".toCharArray();
    _jsp_string143 = "\">\r\n<input type=hidden name=mouldId value=\"".toCharArray();
    _jsp_string167 = "\r\n					checked\r\n		".toCharArray();
    _jsp_string208 = "\">\r\n		".toCharArray();
    _jsp_string193 = "\">\r\n      		<input type=hidden name=\"con-10_name\" id=\"con-10_name\" value=\"".toCharArray();

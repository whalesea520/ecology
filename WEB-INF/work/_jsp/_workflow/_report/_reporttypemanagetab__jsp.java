...
public class _reporttypemanagetab__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print(( PageIdConst.WF_REPORT_REPORTTYPEMANAGETAB));
...
tableString =   " <table instanceid=\"workflowReportTypeTable\" tabletype=\"checkbox\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.WF_REPORT_REPORTTYPEMANAGETAB,user.getUID())+"\" >"+
      ...
      out.print((SystemEnv.getHtmlLabelName(33664,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/report/ReportTypeManageTab.jsp"), 362571275977372116L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string147 = "<input type=\"text\" class=\"InputStyle\" size=\"40\" id=\"typename1\" name=\"typename1\" value=\"\">".toCharArray();
    ...
    _jsp_string148 = "<input type=\"text\" class=\"InputStyle\" size=\"40\" id=\"typedesc2\" name=\"typedesc2\" value=\"\">".toCharArray();
    _jsp_string146 = "\r\n		    ".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();

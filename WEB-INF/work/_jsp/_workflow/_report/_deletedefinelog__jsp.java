...
public class _deletedefinelog__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print(( PageIdConst.WF_DELETEDEFINELOG ));
        ...
        do {
          ...
          if (_jspEval7 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(23777,user.getLanguage())+SystemEnv.getHtmlLabelName(33569,user.getLanguage())));
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(33569,user.getLanguage())+"id"));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
...
tableString =   " <table tabletype=\"none\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.WF_DELETEDEFINELOG,user.getUID())+"\" >"+
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/report/DeleteDefineLog.jsp"), 2355326470771529889L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string162 = "\" class=\"e8_btn_cancel\" onclick=\"resetCondtion();\"/>\r\n								<span class=\"e8_sep_line\">|</span>\r\n								<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string161 = "\" class=\"e8_btn_submit\" onclick=\"doSubmit(2);\"/>\r\n								<span class=\"e8_sep_line\">|</span>\r\n								<input type=\"button\" value=\"".toCharArray();

...
public class _workflowofformbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("workflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(15295,user.getLanguage()) , null), false);
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print(( RecordSet.getString("workFlowName") ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/report/WorkFlowofFormBrowser.jsp"), -407381587974996571L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string149 = "\" onClick=\"javascript:deleteFromList();\">\r\n					<br><br>\r\n					<img class=\"leftall\" src=\"/js/dragBox/img/7_wev8.png\" title=\"".toCharArray();
    ...
    _jsp_string147 = "\" onclick=\"javascript:upFromList();\">\r\n					<br><br>\r\n					<img class=\"rightall\" src=\"/js/dragBox/img/6_wev8.png\" title=\"".toCharArray();
    ...
    _jsp_string156 = "\" id=\"zd_btn_submit\" class=\"zd_btn_submit\" onclick=\"btnclear_onclick()\">\r\n		    	<input type=\"button\" accessKey=T  id=btncancel value=\"".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string155 = "\" id=\"zd_btn_submit_0\" class=\"zd_btn_submit\" onclick=\"btnok_onclick();\">\r\n		    	<input type=\"button\" accessKey=2  id=btnclear value=\"".toCharArray();
    _jsp_string137 = "\r\n			<input class=inputstyle name=\"workFlowName\" maxlength=60 value=\"".toCharArray();
    ...
    _jsp_string138 = "\">\r\n			<input type=\"hidden\" name=\"value\" value=\"".toCharArray();

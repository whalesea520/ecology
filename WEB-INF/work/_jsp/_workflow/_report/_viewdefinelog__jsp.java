...
public class _viewdefinelog__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
        ...
        do {
          ...
          if (_jspEval7 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(730,user.getLanguage())+SystemEnv.getHtmlLabelName(33569,user.getLanguage())));
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(1273,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                _jsp_BrowserTag_3.setHasBrowser("true");
                _jsp_BrowserTag_3.setIsMustInput("1");
                _jsp_BrowserTag_3.setName("viewer");
                _jsp_BrowserTag_3.setBrowserValue( ""+viewer );
                ...
                _jsp_BrowserTag_3.setBrowserSpanValue(ResourceComInfo.getResourcename(viewer));
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelNames( "730,97" ,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
      ...
      out.print(( PageIdConst.WF_READlOG ));
...
tableString =   " <table tabletype=\"none\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.WF_READlOG,user.getUID(),PageIdConst.DOC)+"\" >"+
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/report/ViewDefineLog.jsp"), 4210667080080054544L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string159 = "\" class=\"e8_btn_submit\" onclick=\"doSubmit(2);\"/>\r\n								<span class=\"e8_sep_line\">|</span>\r\n								<input type=\"button\" value=\"".toCharArray();

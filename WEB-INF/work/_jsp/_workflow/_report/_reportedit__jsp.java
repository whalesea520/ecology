...
public class _reportedit__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("wokflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(titlename , null), false);
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_RequiredTag_3.setValue(reportName);
              ...
              do {
                ...
                _jsp_BrowserTag_4.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/hrm/company/SubcompanyBrowser2.jsp?rightStr=WorkflowCustomManage:All&isedit=1&selectedids=");
                _jsp_BrowserTag_4.setCompleteUrl("/data.jsp?type=164&show_virtual_org=-1");
                _jsp_BrowserTag_4.setBrowserValue(subcompanyid);
                _jsp_BrowserTag_4.setBrowserSpanValue(SubComanyComInfo.getSubCompanyname(subcompanyid) );
              ...
              do {
                ...
                _jsp_BrowserTag_4.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/workflow/report/ReportTypeBrowser.jsp?rightStr=WorkflowReportManage:All&isedit=1");
                _jsp_BrowserTag_4.setCompleteUrl("/data.jsp?type=reportTypeBrowser");
                _jsp_BrowserTag_4.setBrowserValue(reportType);
                _jsp_BrowserTag_4.setBrowserSpanValue(Util.toScreen(ReportTypeComInfo.getReportTypename(reportType),user.getLanguage()));
                _jsp_BrowserTag_4.doTag();
                out.write(_jsp_string159, 0, _jsp_string159.length);
                }else{ 
                out.write(_jsp_string160, 0, _jsp_string160.length);
                out.print((Util.toScreen(ReportTypeComInfo.getReportTypename(reportType),user.getLanguage())));
       	...
       	if(0 != reportWFList.size()){
              ...
              do {
                out.write(_jsp_string152, 0, _jsp_string152.length);
                out.print(( outputWorkFlowName.substring(0, outputWorkFlowName.length() - 1) ));
                out.write(_jsp_string143, 0, _jsp_string143.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(20832,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                out.write(_jsp_string172, 0, _jsp_string172.length);
                 if(isShowOnReportOutput.equals("1")) {
      ...
      out.print((SystemEnv.getHtmlLabelName(82260,user.getLanguage())));
      ...
      out.print((Util.toScreenToEdit(reportName,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/report/ReportEdit.jsp"), 3683880636747085155L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string181 = "&dbordercount=".toCharArray();
    ...
    _jsp_string180 = "&formID=".toCharArray();
    ...
    _jsp_string74 = "\r\n\r\n\r\n		".toCharArray();
    _jsp_string147 = "\r\n				<input type=text class=Inputstyle size=30 name=\"reportName\" onchange='checkinput(\"reportName\",\"reportnameimage\")' value=\"".toCharArray();
    ...
    _jsp_string160 = "\r\n         	<span id=reporttypeimage>".toCharArray();
    ...
    _jsp_string149 = "\r\n				<input type=text class=Inputstyle readOnly=\"true\" size=30 name=\"reportName\" onchange='checkinput(\"reportname\",\"reportnameimage\")' value=\"".toCharArray();
    ...
    _jsp_string179 = "&isBill=".toCharArray();
    ...
    _jsp_string159 = "\r\n         	".toCharArray();
    _jsp_string172 = "<input type=checkbox tzCheckbox='true' name=\"isShowOnReportOutput\" value=\"1\" ".toCharArray();
    ...
    _jsp_string170 = "    	 \r\n    	".toCharArray();
    _jsp_string173 = " checked ".toCharArray();
    _jsp_string161 = "</span> \r\n            ".toCharArray();

...
public class _wfsupervisesignature__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
	...
	int isSPA = Util.getIntValue(Util.null2String(request.getParameter("isSPA")), 0);
      ...
      out.print((SystemEnv.getHtmlLabelName(30700,user.getLanguage()) ));
      ...
      out.print((SystemEnv.getHtmlLabelName(84562,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(147338,user.getLanguage()) ));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("workflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(17614,user.getLanguage()) , null), false);
      out.write(_jsp_string137, 0, _jsp_string137.length);
      out.print((SystemEnv.getHtmlLabelName(fromtype == 1 ? 17598 : 21223,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(33861, user.getLanguage()) ));
      ...
      out.print((Util.delHtml(workflowPhrasesContent[i]).replaceAll("%nbsp;", " ").replaceAll("\"", "&quot;")));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/search/WFSuperviseSignature.jsp"), -4255390457076237732L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string149 = "\r\n			".toCharArray();
    _jsp_string151 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.close()\">\r\n			".toCharArray();
    ...
    _jsp_string0 = "\r\n \r\n".toCharArray();
    _jsp_string25 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string137 = "\r\n<table id=\"topTitle\" cellpadding=\"0\" cellspacing=\"0\">\r\n	<tr>\r\n		<td>\r\n		</td>\r\n		<td class=\"rightSearchSpan\" style=\"text-align:right;\">\r\n			<input type=\"button\" onclick=\"checkSubmit()\" class=\"e8_btn_top\" value=\"".toCharArray();
    ...
    _jsp_string71 = "\" +\r\n					\"						</span>\" +\r\n					\"					</span>\" +\r\n					\"				</div>\" +\r\n					\"			</li>\" +\r\n					\"		</ul>\" +\r\n					\"		<div id=\\\"addphraseblock\\\" class=\\\"addphraseblockClass\\\">\" +\r\n					\"			<input type=\\\"text\\\" name=\\\"phraseinput\\\" id=\\\"phraseinput\\\" class=\\\"phraseinputClass\\\" style=\\\"\\\"><span style=\\\"margin-left:12px;color:#3c82b0;cursor:pointer;\\\" id=\\\"phraseqdbtn\\\">".toCharArray();

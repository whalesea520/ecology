...
public class _wftabnewframe__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	String curTab = Util.getIntValue(Util.null2String(request.getParameter("viewcondition")),0)+"";
      ...
      out.print((!curTab.equals("3")?"class=current":"" ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/search/wfTabNewFrame.jsp"), 541909739897510475L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string78 = "\" class=\"requestParameters\">\r\n					".toCharArray();

...
import weaver.workflow.request.WFAgentTreeUtil;
...
public class _wfsupervisetreelist__jsp extends com.caucho.jsp.JavaPage
{
...
if(isSysadmin>0) {  //\u7528\u7cfb\u7edf\u7ba1\u7406\u5458sysadmin\u767b\u9646\u7cfb\u7edf\u53ef\u67e5\u770b\u9875\u9762\u5730\u5740
	...
	defaultMenuCount++;
      ...
      out.print((SystemEnv.getHtmlLabelName(129410, user.getLanguage())));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/search/WFSuperviseTreeList.jsp"), -1703890246879346749L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string72 = "\"},\r\n	    flowAll:{hoverColor:\"#A6A6A6\",color:\"black\",title:\"".toCharArray();
    ...
    _jsp_string71 = "\"},\r\n		flowResponse:{hoverColor:\"#FFC600\",color:\"#FFC600\",title:\"".toCharArray();
    _jsp_string3 = "\r\n\r\n".toCharArray();

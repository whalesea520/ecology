...
public class _requestbrowserfunction_0select_0config__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(32715, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(18353, user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/browserdatadefinition/RequestBrowserfunction_select_config.jsp"), -1564554280850810098L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string140 = "\r\n			<tr>\r\n				<td style=\"display:none;\"><input type=\"hidden\" name=\"value\" value=\"".toCharArray();
    ...
    _jsp_string143 = "</td>\r\n				<td><input class=\"_default\" type=\"checkbox\" onclick=\"onDefaultClick(this);\" ".toCharArray();
    _jsp_string154 = ")';\r\n				}\r\n				if (id != '') {\r\n					id += ',';\r\n				}\r\n				id += tempId;\r\n				if (name != '') {\r\n					name += ',';\r\n				}\r\n				name += tempName;\r\n			}\r\n			selectData(id, name, defaultId);\r\n		}\r\n	</script>\r\n</HTML>".toCharArray();
    _jsp_string149 = "\" class=\"zd_btn_cancle\" onclick=\"dialog.closeByHand();\" style=\"width: 50px!important;\">\r\n				".toCharArray();
    ...
    _jsp_string147 = "\r\n				".toCharArray();
    _jsp_string141 = "\"></td>\r\n				<td><input class=\"_check\" type=\"checkbox\" onclick=\"onCheckClick(this);\" ".toCharArray();
    ...
    _jsp_string136 = "\" onClick=\"btnok_onclick();\" />\r\n				<span title=\"".toCharArray();

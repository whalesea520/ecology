...
public class _addformcolcal_0new__jsp extends com.caucho.jsp.JavaPage
{
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(18550,user.getLanguage())+SystemEnv.getHtmlLabelName(579,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.write(_jsp_string151, 0, _jsp_string151.length);
                out.print((SystemEnv.getHtmlLabelName(18746,user.getLanguage())));
                out.write(_jsp_string152, 0, _jsp_string152.length);
                
				while(RecordSet.next()){
				
                out.write(_jsp_string153, 0, _jsp_string153.length);
                out.print((SystemEnv.getHtmlLabelName(RecordSet.getInt("fieldlabel"),user.getLanguage())));
                ...
                out.print(((colcalstr.indexOf("detailfield_"+RecordSet.getString("id"))==-1?"":"checked")));
                ...
                out.print((mainid.get(i)));
                out.write(_jsp_string156, 0, _jsp_string156.length);
                out.print(((maincalstr.indexOf("mainfield_"+mainid.get(i)+"=detailfield_"+RecordSet.getString("id"))==-1?"":"selected")));
                out.write('>');
                out.print((mainlable.get(i)));
...
if(!ajax.equals("1")){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/form/addformcolcal_new.jsp"), 675472126821135764L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string165 = "\r\n</form>\r\n".toCharArray();
    _jsp_string159 = "\" style=\"width:60%\">\r\n						<option value=\"\">\r\n						".toCharArray();
    _jsp_string55 = "/skins/".toCharArray();
    _jsp_string157 = ">\r\n					</td>\r\n					<td>\r\n						<input type=\"hidden\" name=\"detailfield\" value=\"".toCharArray();
    _jsp_string90 = ");\r\n			}\r\n		}catch(e){}\r\n		".toCharArray();
    ...
    _jsp_string155 = "\" tzCheckbox=\"true\" value=\"".toCharArray();
    ...
    _jsp_string145 = "\" id=\"zd_btn_submit\" class=\"e8_btn_top\"  onclick=\"javascript:colsaveRole()\">\r\n    			".toCharArray();
    ...
    _jsp_string169 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.closeByHand()\" style=\"width: 50px!important;\">\r\n			".toCharArray();
    ...
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string158 = "\">\r\n						<select name=\"mainfield".toCharArray();
    _jsp_string110 = ";\r\n	".toCharArray();

...
public class _addformfield__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.conn.RecordSet RecordSet02;
      RecordSet02 = (weaver.conn.RecordSet) pageContext.getAttribute("RecordSet02");
      if (RecordSet02 == null) {
        RecordSet02 = new weaver.conn.RecordSet();
        pageContext.setAttribute("RecordSet02", RecordSet02);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
int sapclos=1;
      ...
      out.print((SystemEnv.getHtmlLabelName(22410,user.getLanguage())));
      out.write(_jsp_string152, 0, _jsp_string152.length);
      }else if(errorcode==2){
      out.write(_jsp_string151, 0, _jsp_string151.length);
      out.print((SystemEnv.getHtmlLabelName(24311,user.getLanguage())));
      out.write(_jsp_string152, 0, _jsp_string152.length);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jsp_GroupTag_1.setContext(SystemEnv.getHtmlLabelName(261,user.getLanguage()));
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((SystemEnv.getHtmlLabelName(15453,user.getLanguage())));
                ...
                out.print((SystemEnv.getHtmlLabelName(18765,user.getLanguage())));
                ...
                out.print((FieldMainManager.getFieldManager().getFieldname() ));
                out.write('[');
                out.print((SystemEnv.getHtmlLabelName(63,user.getLanguage())));
                out.write(':');
                out.print((FieldMainManager.getFieldManager().getFielddbtype()));
                out.write(']');
                ...
                out.write(':');
                out.print((FieldMainManager.getFieldManager().getDescription()));
                out.write(']');
                }
                out.write(_jsp_string160, 0, _jsp_string160.length);
                out.print((FieldMainManager.getFieldManager().getFieldid() ));
                ...
                out.write(_jsp_string159, 0, _jsp_string159.length);
                out.print((FieldComInfo.getFieldname(""+FormFieldMainManager.getFieldid())));
                out.write('[');
                out.print((SystemEnv.getHtmlLabelName(63,user.getLanguage())));
                out.write(':');
                out.print((FormFieldMainManager.getFieldDbType()));
                out.write(']');
                if (!FormFieldMainManager.getDescription().equals("")){
                out.write('[');
                out.print((SystemEnv.getHtmlLabelName(433,user.getLanguage())));
                out.write(':');
                out.print((FormFieldMainManager.getDescription()));
                out.write(']');
                }
                out.write(_jsp_string160, 0, _jsp_string160.length);
                out.print((FormFieldMainManager.getFieldid()));
                out.write(_jsp_string161, 0, _jsp_string161.length);
                out.print((FieldComInfo.getFieldname(""+FormFieldMainManager.getFieldid())));
                out.write('[');
                out.print((SystemEnv.getHtmlLabelName(63,user.getLanguage())));
                ...
                _jsp_BrowserTag_3.setNeedHidden("true");
                _jsp_BrowserTag_3.setName("newsapmultiBrowservalue_0");
                _jsp_BrowserTag_3.setBrowserValue(browmark );
                _jsp_BrowserTag_3.setBrowserSpanValue(browmark );
                _jsp_BrowserTag_3.setBrowserOnClick("OnsapMultiBrowser('this',0)");
                ...
                out.print((SystemEnv.getHtmlLabelName(18766,user.getLanguage())));
                ...
                out.write(_jsp_string159, 0, _jsp_string159.length);
                out.print((DetailFieldComInfo.getFieldname(""+FormFieldMainManager.getFieldid())));
                out.write('[');
                out.print((SystemEnv.getHtmlLabelName(63,user.getLanguage())));
                out.write(':');
                out.print((FormFieldMainManager.getFieldDbType()));
                ...
                _jsp_BrowserTag_3.setCompleteUrl("");
                _jsp_BrowserTag_3.setNeedHidden("true");
                _jsp_BrowserTag_3.setName("newsapmultiBrowservalue_1");
                _jsp_BrowserTag_3.setBrowserValue(browmark );
                _jsp_BrowserTag_3.setBrowserSpanValue(browmark );
                _jsp_BrowserTag_3.setBrowserOnClick("OnsapMultiBrowser('this',1)");
                _jsp_BrowserTag_3.doTag();
                ...
                _jsp_BrowserTag_3.setBrowserValue(browmark );
                _jsp_BrowserTag_3.setBrowserSpanValue(browmark );
                _jsp_BrowserTag_3.setBrowserOnClick(browserclick );
                _jsp_BrowserTag_3.doTag();
...
if(!ajax.equals("1")){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/form/addformfield.jsp"), 6029038520840230995L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string207 = "\" onClick=\"javascript:deleteFromDestList3('srcListMul".toCharArray();
    _jsp_string20 = "&f_weaver_belongto_usertype=".toCharArray();
    _jsp_string192 = "\r\n						\r\n						<div style=\"display:block;float:left;\">\r\n						".toCharArray();
    _jsp_string151 = "\r\n	<font color=\"red\">".toCharArray();
    _jsp_string111 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string178 = "\r\n						<option class=\"vtip\" title=\"".toCharArray();
    _jsp_string220 = "'   type=hidden value=\"".toCharArray();
    _jsp_string199 = "\r\n						<select class=inputstyle  size=\"15\" name=\"srcListMul".toCharArray();
    _jsp_string21 = "\";\r\n	    xmlhttp.open(\"GET\",URL, false);\r\n	    xmlhttp.send(null);\r\n	    var result = xmlhttp.status;\r\n	    if(result==200) {\r\n		    isconn = true;\r\n	    	var response_flag = xmlhttp.responseText;\r\n	    	if(response_flag!='0') {\r\n	    		var flag_msg = '';\r\n	    		if(response_flag=='1') {\r\n	    			var diag = new Dialog();\r\n					diag.Width = 300;\r\n					diag.Height = 180;\r\n					diag.ShowCloseButton=false;\r\n					diag.Title = \"".toCharArray();
    _jsp_string115 = "\";\r\nvar __closeRightMenu__ = ".toCharArray();
    _jsp_string213 = "-->\r\n					<input style=\"border:0px;cursor: pointer;\" id='newsapmultiBrowser_".toCharArray();
    ...
    _jsp_string201 = "','destListMul".toCharArray();
    ...
    _jsp_string182 = "\" onClick=\"javascript:deleteFromDestList2()\">\r\n						<br><br>\r\n						<img class=\"rightimg\" src=\"/js/dragBox/img/4_wev8.png\"  title=\"".toCharArray();
    _jsp_string38 = "\");\r\n						}else{\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string186 = "\r\n						</select>\r\n					</td>\r\n					<td >&nbsp;</td>\r\n				</tr>\r\n			</table>    \r\n			".toCharArray();
    ...
    _jsp_string211 = "\" onclick=\"javascript:downFromDestList3('destListMul".toCharArray();
    ...
    _jsp_string129 = "\r\n							".toCharArray();
    _jsp_string219 = "'   name='newsapmultiBrowservalue_".toCharArray();
    _jsp_string145 = "\" id=\"zd_btn_submit\" class=\"e8_btn_top\" ".toCharArray();
    _jsp_string104 = "visible".toCharArray();
    _jsp_string225 = "\r\n						</select>\r\n						</div>\r\n				    </td>\r\n				    <td >&nbsp;</td>\r\n				</tr>\r\n				".toCharArray();
    _jsp_string147 = " onclick=\"javascript:fieldselectall(this)\"".toCharArray();
    ...
    _jsp_string159 = "\r\n							<option class=\"vtip\" title=\"".toCharArray();
    _jsp_string200 = "\" multiple style=\"width:100%;height:262px\" onchange=\"showtitle(event)\" ondblclick=\"addSrcToDestList3('srcListMul".toCharArray();
    _jsp_string198 = "\r\n				<tr>\r\n				    <td vaglin=\"middle\">\r\n				    ".toCharArray();
    _jsp_string168 = "\r\n						</select>\r\n					</td>\r\n					<td >&nbsp;</td>\r\n				</tr>\r\n				<tr class=header>\r\n				    <td align=center class=field>".toCharArray();
    ...
    _jsp_string222 = "\r\n						<div style=\"display:block;float:left;\">\r\n						<select class=inputstyle  size=15 name=\"destListMul".toCharArray();
    _jsp_string212 = "');\">\r\n						</div>\r\n				    </td>\r\n				    <td align=left>    \r\n						".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    ...
    _jsp_string202 = "')\">\r\n					    ".toCharArray();
    _jsp_string210 = "');\">\r\n							<br><br>\r\n							<img class=\"downimg\" src=\"/js/dragBox/img/down_wev8.png\"   title=\"".toCharArray();
    ...
    _jsp_string209 = "\" onclick=\"javascript:addSrcToDestList3('srcListMul".toCharArray();
    _jsp_string183 = "\" onclick=\"javascript:addSrcToDestList2();\">\r\n						<br><br>\r\n						<img class=\"downimg\" src=\"/js/dragBox/img/down_wev8.png\"   title=\"".toCharArray();
    _jsp_string163 = "\r\n						</select>\r\n					</td>\r\n					<td align=center>   \r\n						<img class=\"upimg\" src=\"/js/dragBox/img/up_wev8.png\" title=\"".toCharArray();
    _jsp_string153 = "\r\n    ".toCharArray();
    ...
    _jsp_string167 = "\" onclick=\"javascript:downFromDestList();\">\r\n					</td>\r\n					<td align=center>\r\n						<select class=inputstyle  size=15 name=\"destList\" multiple style=\"width:100%;height:100%\" onchange=\"showtitle(event)\" ondblclick=\"deleteFromDestList()\">\r\n							".toCharArray();
    _jsp_string164 = "\" onclick=\"javascript:upFromDestList();\">\r\n						<br><br>\r\n						<img class=\"leftimg\" src=\"/js/dragBox/img/5_wev8.png\" title=\"".toCharArray();
    _jsp_string96 = ");\r\n			}\r\n		}catch(e){}\r\n		".toCharArray();
    _jsp_string37 = "\", function () {\r\n								formElementFocus(tempElement);\r\n							});\r\n							\r\n						}\r\n						return false;\r\n					}else{\r\n						if(window.__oriAlert__){\r\n							window.top.Dialog.alert(\"".toCharArray();
    _jsp_string15 = "\\r\\n\\r\\n".toCharArray();
    _jsp_string214 = "' class=e8_browflow onclick='OnsapMultiBrowser(this,".toCharArray();
    ...
    _jsp_string165 = "\" onClick=\"javascript:deleteFromDestList();\">\r\n						<br><br>\r\n						<img class=\"rightimg\" src=\"/js/dragBox/img/4_wev8.png\"  title=\"".toCharArray();
    ...
    _jsp_string170 = "\r\n					\r\n					\r\n					<div style=\"display:block;float:left;\">\r\n						".toCharArray();
    _jsp_string195 = "</SPAN>\r\n					 <INPUT id='newsapmultiBrowservalue_1'   name='newsapmultiBrowservalue_1'   type=hidden value=\"".toCharArray();
    _jsp_string187 = "\r\n			<table class=\"viewform\" width=\"100%\">\r\n				<tr>\r\n					<td>\r\n						<button class=addbtn type=button accessKey=A onclick=\"addRowx('fromfieldoTable');\" title=\"A-".toCharArray();
    _jsp_string203 = "\r\n						</select>\r\n					</td>\r\n				    <td align=center>\r\n				    ".toCharArray();
    ...
    _jsp_string223 = "\" multiple style=\"width:100%;height:262px\" onchange=\"showtitle(event)\" ondblclick=\"deleteFromDestList3('srcListMul".toCharArray();
    ...
    _jsp_string82 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string215 = ")' name='newsapmultiBrowser_".toCharArray();

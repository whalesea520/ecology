...
public class _editformfield__jsp extends com.caucho.jsp.JavaPage
{
...
if(isSysadmin>0) {  //\u7528\u7cfb\u7edf\u7ba1\u7406\u5458sysadmin\u767b\u9646\u7cfb\u7edf\u53ef\u67e5\u770b\u9875\u9762\u5730\u5740
	...
	defaultMenuCount++;
      ...
      out.print(( PageIdConst.WF_FORM_EDITFORMFIELD ));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(25055, user.getLanguage()) ));
...
if(!ajax.equals("1")){
      ...
      out.print((SystemEnv.getHtmlLabelName(20839,user.getLanguage())+SystemEnv.getHtmlLabelName(17998,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/form/editformfield.jsp"), 1523571296220593667L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string164 = "\",\"/workflow/form/addfieldbatch.jsp?formid=\"+".toCharArray();
    ...
    _jsp_string162 = "+\"&dialog=1&isFromMode=".toCharArray();
    ...
    _jsp_string143 = "\" id=\"zd_btn_submit\" class=\"e8_btn_top\" onclick=\"addField()\">\r\n	    			<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string148 = "\" id=\"zd_btn_submit\" class=\"e8_btn_top\" onclick=\"deleteData()\">\r\n    			".toCharArray();
    ...
    _jsp_string144 = "\" id=\"zd_btn_submit\" class=\"e8_btn_top\" onclick=\"batchAddField()\">				\r\n	    			<input type=\"button\" value=\"".toCharArray();
    _jsp_string34 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string145 = "\" id=\"zd_btn_submit\" class=\"e8_btn_top\" onclick=\"editorField()\">\r\n				".toCharArray();
    ...
    _jsp_string161 = "\",\"/workflow/field/addfield0.jsp?formid=\"+".toCharArray();
    _jsp_string93 = ");\r\n			}\r\n		}catch(e){}\r\n		".toCharArray();
    ...
    _jsp_string166 = "\",\"/workflow/form/editfieldbatch.jsp?formid=\"+".toCharArray();

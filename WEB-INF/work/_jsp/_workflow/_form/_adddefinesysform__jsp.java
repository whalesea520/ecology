...
public class _adddefinesysform__jsp extends com.caucho.jsp.JavaPage
{
...
String url="/workflow/form/editSysform.jsp?ajax=1&formid="+formid+"&dialog="+dialog;
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/form/addDefineSysForm.jsp"), 7184625230138726052L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string78 = "\r\n</body>\r\n</html>\r\n<SCRIPT language=\"javascript\">\r\nfunction viewSourceUrl(){\r\n   prompt(\"\",location);\r\n}\r\nfunction settab1(){\r\n	$(\"#tabcontentframe\").attr(\"src\",\"/workflow/form/editSysform.jsp?ajax=1&formid=".toCharArray();
    _jsp_string60 = ")\">\r\n".toCharArray();
    ...
    _jsp_string70 = "\" onload=\"update()\" id=\"tabcontentframe\" name=\"tabcontentframe\" class=\"flowFrame\" frameborder=\"0\" height=\"100%\" width=\"100%;\"></iframe>\r\n	        </div>\r\n	    </div>\r\n	</div> \r\n	".toCharArray();
    _jsp_string24 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string80 = "&isbill=1\");\r\n}\r\n\r\njQuery(document).ready(function(){\r\n	jQuery(window).resize();\r\n})\r\n</script>\r\n".toCharArray();
    ...
    _jsp_string73 = "\r\n				".toCharArray();
    _jsp_string1 = "\r\n<!DOCTYPE HTML>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n<html>\r\n<head>\r\n<!-- \r\n\u6dfb\u52a0\u81f3init.css\r\n<style type=\"text/css\">\r\n	html{height:100%;}\r\n</style>\r\n -->\r\n".toCharArray();
    _jsp_string79 = "\");\r\n}\r\nfunction settab2(){\r\n	$(\"#tabcontentframe\").attr(\"src\",\"/workflow/workflow/BillManagementDetail0.jsp?billId=".toCharArray();
    ...
    _jsp_string75 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.closeByHand()\" style=\"width: 60px!important;\">\r\n				".toCharArray();

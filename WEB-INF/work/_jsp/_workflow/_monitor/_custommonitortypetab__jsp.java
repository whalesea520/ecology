...
public class _custommonitortypetab__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print(( PageIdConst.WF_MONITOR_CUSTOMMONITORTYPETAB ));
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                out.print((SystemEnv.getHtmlLabelName(15520,user.getLanguage())));
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(15521,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
...
tableString =   " <table instanceid=\"WorkflowMonitorTypeTable\" tabletype=\"checkbox\" pagesize=\""+PageIdConst.getPageSize(PageIdConst.WF_MONITOR_CUSTOMMONITORTYPETAB,user.getUID())+"\" >"+
      ...
      out.print((SystemEnv.getHtmlLabelNames("93,2239",user.getLanguage())));
      out.write(_jsp_string155, 0, _jsp_string155.length);
      out.print((SystemEnv.getHtmlLabelNames("83981,2239",user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/monitor/CustomMonitorTypeTab.jsp"), 5994914795716336950L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string139 = "' onchange=\"reSetInputt1()\" />\r\n			<span id=\"advancedSearch\" class=\"advancedSearch\">".toCharArray();
    _jsp_string147 = "\r\n			<input type=text name=\"inputt2\" class=inputstyle  value=\"".toCharArray();
    ...
    _jsp_string149 = "\" class=\"e8_btn_submit\" onclick=\"doSubmit();\"/>\r\n			<span class=\"e8_sep_line\">|</span>\r\n			<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string145 = "\r\n			<input type=text name=\"inputt1\" class=inputstyle  value=\"".toCharArray();
    ...
    _jsp_string137 = "\" class=\"e8_btn_top\" onclick=\"newDialog(2,0)\"/>			\r\n			<input type=\"button\" value=\"".toCharArray();
    _jsp_string39 = "\");\r\n						}\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    _jsp_string109 = ";\r\n	".toCharArray();

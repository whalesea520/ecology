...
public class _showfieldbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("workflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(33331,user.getLanguage())+SystemEnv.getHtmlLabelName(320,user.getLanguage()) , null), false);
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((ftype.equals("2")?"selected":"" ));
                out.write('>');
                out.print((SystemEnv.getHtmlLabelName(28415,user.getLanguage()) ));
    ...
    tableString+="<col width=\"34%\"  text=\""+SystemEnv.getHtmlLabelName(15456,user.getLanguage())+"\" column=\"label\" otherpara=\""+user.getLanguage()+"+"+isbill+"\" transmethod=\"weaver.workflow.design.WFDesignTransMethod.getFieldLabel\"/>";
      ...
      int _jsp_end_31 = _jsp_SplitPageTag_4.doEndTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/ruleDesign/showFieldBrowser.jsp"), -5560807296168961306L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string149 = "\" style=\"height: 30px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: 33%;\">".toCharArray();
    ...
    _jsp_string47 = "\";\r\ndoCheckusb();\r\n</script>\r\n".toCharArray();
    _jsp_string151 = "</td>\r\n			<td align=\"left\" style=\"height: 30px; vertical-align: middle; word-wrap: break-word; word-break: break-all;\">".toCharArray();
    ...
    _jsp_string88 = "visible".toCharArray();
    ...
    _jsp_string137 = "<input name=\"fshowname\" type=\"text\" style=\"width:130px\"/>".toCharArray();
    ...
    _jsp_string64 = "\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string70 = ">1 ? Math.ceil(bodyWidth/".toCharArray();
    ...
    _jsp_string78 = " oncontextmenu='return false'".toCharArray();
    ...
    _jsp_string35 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string148 = "</th>\r\n				<th align=\"left\" title=\"".toCharArray();
    _jsp_string84 = "px\" height=\"".toCharArray();
    ...
    _jsp_string160 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"submitClear();\">\r\n				<input type=\"button\" value=\"".toCharArray();
    _jsp_string51 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    ...
    _jsp_string133 = "\" class=\"e8_btn_top\"  onclick=\"onSearch();\"/>&nbsp;&nbsp;\r\n			<span title=\"".toCharArray();
    _jsp_string14 = "\\r\\n\\r\\n".toCharArray();
    ...
    _jsp_string161 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.close();\">\r\n	    ".toCharArray();
    ...
    _jsp_string89 = ";display:none;\" align=\"left\"  allowtransparency=\"true\" style=\"background-color:transparent\" >\r\n	</div>\r\n	<div id=\"divRightMenuIframe\" name=\"divRightMenuIframe\" style=\"display:none\">\r\n		<iframe id=\"rightMenuIframe\" name=\"rightMenuIframe\" frameborder=0 marginheight=0 marginwidth=0 hspace=0 vspace=0 scrolling=no width=\"".toCharArray();
    ...
    _jsp_string52 = "\r\n".toCharArray();
    _jsp_string147 = "\" style=\"height: 30px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: 34%;\">".toCharArray();
    ...
    _jsp_string87 = "hidden".toCharArray();

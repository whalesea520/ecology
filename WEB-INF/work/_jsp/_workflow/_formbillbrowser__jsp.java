...
public class _formbillbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("workflow")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(15451,user.getLanguage()) , null), false);
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jsp_GroupTag_1 == null) {
            ...
            _jsp_GroupTag_1.setAttributes("{'samePair':'BaseInfo','groupOperDisplay':'none','groupSHBtnDisplay':'none'}");
          }
      ...
      if (_jspEval26 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jsp_GroupTag_4 == null) {
            ...
            _jsp_GroupTag_4.setAttributes("{'samePair':'SearchInfo','groupOperDisplay':'none'}");
          }

          _jsp_GroupTag_4.setContext(SystemEnv.getHtmlLabelNames("563,320",user.getLanguage()) );
          ...
          if (_jspEval29 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              if (_jsp_ItemTag_5 == null) {
                ...
                _jsp_ItemTag_5.setAttributes("{'samePair':'tablelistdatas','isTableList':'true','colspan':'full'}");
              }
			...
			if(!"1".equals(isBill))
			{
                ...
                out.print((billName));
                out.write(_jsp_string156, 0, _jsp_string156.length);
                out.print((RecordSet.getString("formdes")));
                out.write(_jsp_string157, 0, _jsp_string157.length);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("workflow/FormBillBrowser.jsp"), 1689455222155823141L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string152 = " DataLight ".toCharArray();
    ...
    _jsp_string132 = "\" class=\"e8_btn_top\" onclick=\"document.SearchForm.submit()\"/>\r\n					<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string141 = " selected ".toCharArray();
    _jsp_string150 = "</TH>\r\n				</TR>\r\n	    <!--================== \u8868\u5355 ================== -->\r\n		".toCharArray();
    ...
    _jsp_string165 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"onClose();\">\r\n			".toCharArray();
    ...
    _jsp_string168 = "');\r\n	jQuery('input[name=\"formName\"]').val('".toCharArray();
    _jsp_string66 = "\r\n<HTML>\r\n    <HEAD>\r\n    ".toCharArray();
    ...
    _jsp_string52 = "\r\n\r\n\r\n<!--For wui-->\r\n".toCharArray();
    _jsp_string137 = "\" type=\"hidden\" id=\"from\"/>			\r\n".toCharArray();
    ...
    _jsp_string133 = "\" class=\"e8_btn_top\" onclick=\"onReset()\"/>\r\n					<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string153 = " DataDark ".toCharArray();
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    ...
    _jsp_string146 = "<input class=inputstyle name=formName value='".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();

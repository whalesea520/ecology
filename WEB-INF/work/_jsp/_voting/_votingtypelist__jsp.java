...
public class _votingtypelist__jsp extends com.caucho.jsp.JavaPage
{
...
String typename = Util.null2String(request.getParameter("flowTitle"));
      ...
      out.print((SystemEnv.getHtmlLabelName(1421, user.getLanguage()) + SystemEnv.getHtmlLabelName(24111, user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(93, user.getLanguage()) + SystemEnv.getHtmlLabelName(24111, user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((PageIdConst.Voting_VotingTypeListTable ));
...
if (noDelMeetTypes != null && noDelMeetTypes!="") {
      ...
      out.print((SystemEnv.getHtmlLabelName(24111, user.getLanguage())));
      out.write(' ');
      out.print((noDelMeetTypes));
      out.write(' ');
      out.print((SystemEnv.getHtmlLabelName(24112, user.getLanguage())));
...
session.setAttribute("noDelMeetTypes","");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("voting/VotingTypeList.jsp"), 8051471829647973089L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

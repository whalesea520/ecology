...
public class _votingtypeedit__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("voting")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(24090,user.getLanguage()) , null), false);
      out.write(_jsp_string2, 0, _jsp_string2.length);
          ...
          if (_jspEval17 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                int _jspEval27 = _jsp_RequiredTag_6.doStartTag();
                if (_jspEval27 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  if (_jspEval27 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
                    ...
                    _jsp_RequiredTag_6.setBodyContent(_jsp_endTagHack25);
                ...
                int _jsp_end_28 = _jsp_RequiredTag_6.doEndTag();
              ...
              do {
                ...
                _jsp_BrowserTag_7.setName("approver");
                _jsp_BrowserTag_7.setBrowserOnClick("");
                _jsp_BrowserTag_7.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/workflow/workflow/WorkflowBrowser.jsp?sqlwhere=where isvalid=1 and isbill=1 and formid=241");
                ...
                _jsp_BrowserTag_7.setWidth("280px");
                _jsp_BrowserTag_7.setCompleteUrl("/data.jsp?type=-99991&whereClause=where isbill=1 and formid=241");
                _jsp_BrowserTag_7.setBrowserValue((approver > 0?(""+approver):""));
                _jsp_BrowserTag_7.setBrowserSpanValue(WorkflowComInfo.getWorkflowname(""+approver));
      ...
      int _jspEval42 = _jsp_ViewTag_8.doStartTag();
      if (_jspEval42 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval42 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_8.setBodyContent(_jsp_endTagHack40);
        ...
        do {
          ...
          int _jspEval45 = _jsp_GroupTag_9.doStartTag();
          if (_jspEval45 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval45 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_9.setBodyContent(_jsp_endTagHack43);
            ...
            do {
              ...
              _jsp_ItemTag_10.setBodyContent(_jsp_endTagHack46);
      ...
      out.print((SystemEnv.getHtmlLabelName(84101,user.getLanguage())));
      out.write(_jsp_string152, 0, _jsp_string152.length);
      out.print((SystemEnv.getHtmlLabelName(84073,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("voting/VotingTypeEdit.jsp"), -9013293945059880609L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string133 = "\" style=\"font-size: 12px;cursor: pointer;\">\r\n				<input class=\"e8_btn_top middle\" onclick=\"doSubmit()\" type=\"button\" jQuery1392950000546=\"32\" value=\"".toCharArray();
    ...
    _jsp_string148 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"parentDialog.close();\">\r\n				".toCharArray();
    ...
    _jsp_string36 = "\");\r\n						}else{\r\n							var tempElement = thiswin.elements[i-1];\r\n							\r\n							//ueditor\u5fc5\u586b\u9a8c\u8bc1\r\n							if (checkueditorContent(tempElement)) {\r\n								continue;\r\n							}\r\n							\r\n							window.top.Dialog.alert(\"&quot;\"+thiswin.elements[i-1].getAttribute(\"temptitle\")+\"&quot;\"+\"".toCharArray();
    _jsp_string139 = "\r\n				<INPUT class=inputstyle type=text maxLength=60 value=\"".toCharArray();
    ...
    _jsp_string151 = "+\"&method=checkname&typename=\"+$(\"#typename\").val(),\r\n          timeout: 20000,\r\n          success: function (rs) {\r\n             if(rs && rs.trim()=='1'){\r\n                 window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string68 = "\r\n\r\n\r\n\r\n\r\n".toCharArray();
    _jsp_string140 = "\" size=25 name=typename id=typename onchange='checkinput(\"typename\",\"nameimage\")'>\r\n			".toCharArray();

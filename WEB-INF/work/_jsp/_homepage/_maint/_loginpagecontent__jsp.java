...
public class _loginpagecontent__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	if (operatelevel > 0)
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("portal")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(23017,user.getLanguage()) , null), false);
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("homepage/maint/LoginPageContent.jsp"), 2420190086678124649L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string150 = "&subCompanyId=-1\"\r\n				window.location.replace(url);\r\n			}\r\n		}\r\n	}\r\n</SCRIPT>\r\n".toCharArray();
    _jsp_string136 = "\" class=\"e8_btn_top\"  onclick=\"onSave();\"/>\r\n				<input type=\"button\" value=\"".toCharArray();

...
public class _homepageleft__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(83715,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("homepage/maint/homepageLeft.jsp"), -4176858550152701987L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string140 = "';\r\nCXLoadTreeItem(\"\", \"/systeminfo/menuconfig/MenuMaintenanceTreeLeftXML.jsp?rightStr=".toCharArray();
    _jsp_string97 = "\r\n		return false;\r\n		".toCharArray();
    ...
    _jsp_string137 = "&init=true&nodeid=".toCharArray();
    ...
    _jsp_string136 = "\", \"/systeminfo/menuconfig/MenuMaintenanceTreeLeftXML.jsp?rightStr=".toCharArray();
    ...
    _jsp_string134 = "\">\r\n  <input class=inputstyle type=hidden id=\"needsystem\" name=needsystem value=\"".toCharArray();

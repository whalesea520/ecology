...
public class _homepagelocation__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	String titlename = SystemEnv.getHtmlLabelName(24668, user.getLanguage());
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("portal")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelName(24668, user.getLanguage()), null), false);
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(83718,user.getLanguage())));
      out.write(_jsp_string139, 0, _jsp_string139.length);
      out.print((SystemEnv.getHtmlLabelName(83719,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("homepage/maint/HomepageLocation.jsp"), -6763801588245685058L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

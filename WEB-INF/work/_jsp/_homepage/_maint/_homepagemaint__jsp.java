...
public class _homepagemaint__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    String  hpname = hpc.getInfoname(hpid);
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("portal")+ "&" + "navName=" + com.caucho.el.Expr.toString(hpname , null), false);
...
if(isSysadmin>0) {  //\u7528\u7cfb\u7edf\u7ba1\u7406\u5458sysadmin\u767b\u9646\u7cfb\u7edf\u53ef\u67e5\u770b\u9875\u9762\u5730\u5740
	...
	defaultMenuCount++;
      ...
      out.print((SystemEnv.getHtmlLabelName(611,user.getLanguage())+SystemEnv.getHtmlLabelName(19909,user.getLanguage())));
...
if(userightmenu!=1){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("homepage/maint/HomepageMaint.jsp"), -4548807019045530802L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string147 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"onCancel();\"/>\r\n		".toCharArray();
    ...
    _jsp_string150 = "\",\"/homepage/maint/HomepageMaintAddBrowser.jsp?hpid=".toCharArray();
    ...
    _jsp_string77 = "\" id=\"zd_btn_submit_0\" class=\"e8_btn_top\" onclick=\"doAdd(this);\">						\r\n				<input type=\"button\" value=\"".toCharArray();
    _jsp_string5 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    ...
    _jsp_string78 = "\" id=\"zd_btn_submit_0\" class=\"e8_btn_top\" onclick=\"delPrm('')\">\r\n				&nbsp;&nbsp;&nbsp;\r\n				<span title=\"".toCharArray();

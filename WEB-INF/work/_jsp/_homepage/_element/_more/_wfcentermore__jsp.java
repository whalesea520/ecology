...
package _jsp._homepage._element._more;
...
import weaver.hrm.*;
import weaver.homepage.cominfo.*;
import weaver.synergy.*;
import weaver.conn.*;
import oracle.sql.CLOB;
import java.io.BufferedReader;
import weaver.page.HPTypeEnum;
import weaver.workflow.request.todo.*;
import java.util.*;
import java.net.*;
...
public class _wfcentermore__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
 ...
 //   User user = HrmUserVarify.getUser (request , response) ;
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("homepage/element/more/wfCenterMore.jsp"), 8058145023138479013L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

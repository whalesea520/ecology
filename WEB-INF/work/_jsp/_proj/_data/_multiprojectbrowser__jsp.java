...
public class _multiprojectbrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(isSingle){
	...
	srcfield="['id','name','prjtype','prjworktype','prjmanager','status']";
      ...
      out.print((SystemEnv.getHtmlLabelNames("101",user.getLanguage())));
...
String resourcenames = "";
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("proj")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelNames("101",user.getLanguage()) , null), false);
      ...
      if (_jspEval2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
		...
		for(int i=0;i<arr.length();i++){
			...
			if("name".equalsIgnoreCase(fieldname)){
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(586,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                _jsp_BrowserTag_3.setName("prjtype");
                _jsp_BrowserTag_3.setBrowserValue(fieldvalue );
                _jsp_BrowserTag_3.setBrowserSpanValue(ProjectTypeComInfo.getProjectTypename(fieldvalue) );
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/proj/Maint/ProjectTypeBrowser.jsp");
                _jsp_BrowserTag_3.setHasInput((""+!isReadonly) );
                _jsp_BrowserTag_3.setIsMustInput((isReadonly?"0":"1") );
                _jsp_BrowserTag_3.setCompleteUrl("/data.jsp?type=244");
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(432,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                _jsp_BrowserTag_3.setIsSingle("true");
                _jsp_BrowserTag_3.setHasBrowser("true");
                _jsp_BrowserTag_3.setName("worktype");
                _jsp_BrowserTag_3.setBrowserValue(fieldvalue );
                _jsp_BrowserTag_3.setBrowserSpanValue(WorkTypeComInfo.getWorkTypename(fieldvalue) );
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/proj/Maint/WorkTypeBrowser.jsp");
                _jsp_BrowserTag_3.setHasInput((""+!isReadonly) );
                _jsp_BrowserTag_3.setIsMustInput((isReadonly?"0":"1") );
                _jsp_BrowserTag_3.setCompleteUrl("/data.jsp?type=245");
                _jsp_BrowserTag_3.doTag();
                out.write(_jsp_string146, 0, _jsp_string146.length);
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(587,user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
              ...
              do {
                ...
                out.print((tmpval.equals(fieldvalue)?"selected":"" ));
                out.write('>');
                out.print((Util.toScreen(ProjectStatusComInfo.getProjectStatusdesc(tmpval),user.getLanguage()) ));
                ...
                out.write('>');
                out.print((Util.toScreen(ProjectStatusComInfo.getProjectStatusdesc(tmpstatus),user.getLanguage()) ));
              ...
              do {
                ...
                _jsp_BrowserTag_3.setIsSingle("true");
                _jsp_BrowserTag_3.setHasBrowser("true");
                _jsp_BrowserTag_3.setName("manager");
                _jsp_BrowserTag_3.setBrowserValue(fieldvalue );
                _jsp_BrowserTag_3.setBrowserSpanValue(ResourceComInfo.getLastname(fieldvalue ) );
...
for(int i=0;i<arr.length();i++){
          ...
          if (_jspEval53 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                _jsp_BrowserTag_3.setHasBrowser("true");
                _jsp_BrowserTag_3.setName("prjtype");
                _jsp_BrowserTag_3.setBrowserValue(prjtype );
                _jsp_BrowserTag_3.setBrowserSpanValue(ProjectTypeComInfo.getProjectTypename(prjtype) );
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/proj/Maint/ProjectTypeBrowser.jsp");
              ...
              do {
                ...
                _jsp_BrowserTag_3.setHasBrowser("true");
                _jsp_BrowserTag_3.setName("worktype");
                _jsp_BrowserTag_3.setBrowserValue(worktype );
                _jsp_BrowserTag_3.setBrowserSpanValue(WorkTypeComInfo.getWorkTypename(worktype) );
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/proj/Maint/WorkTypeBrowser.jsp");
                _jsp_BrowserTag_3.setHasInput("true");
                _jsp_BrowserTag_3.setIsMustInput("1");
                _jsp_BrowserTag_3.setCompleteUrl("/data.jsp?type=245");
	...
	if(!user.getLogintype().equals("2")){
              ...
              do {
                ...
                _jsp_BrowserTag_3.setHasBrowser("true");
                _jsp_BrowserTag_3.setName("manager");
                _jsp_BrowserTag_3.setBrowserValue(manager );
                _jsp_BrowserTag_3.setBrowserSpanValue(ResourceComInfo.getLastname(manager) );
                _jsp_BrowserTag_3.setBrowserUrl("/systeminfo/BrowserMain.jsp?url=/hrm/resource/ResourceBrowser.jsp");
                _jsp_BrowserTag_3.setHasInput("true");
                _jsp_BrowserTag_3.setIsMustInput("1");
                _jsp_BrowserTag_3.setCompleteUrl("/data.jsp?type=1");
      ...
      int _jspEval98 = _jsp_ViewTag_4.doStartTag();
      if (_jspEval98 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval98 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_4.setBodyContent(_jsp_endTagHack96);
        ...
        do {
          ...
          int _jspEval101 = _jsp_GroupTag_5.doStartTag();
          if (_jspEval101 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval101 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_5.setBodyContent(_jsp_endTagHack99);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("proj/data/MultiProjectBrowser.jsp"), 8003938229975893899L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string166 = "' class=\"InputStyle\">".toCharArray();
    ...
    _jsp_string163 = "	\r\n<input type=\"hidden\" name=\"statusAll\" id=\"statusAll\" value=\"".toCharArray();
    ...
    _jsp_string141 = "<input name=name value='".toCharArray();
    _jsp_string49 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();

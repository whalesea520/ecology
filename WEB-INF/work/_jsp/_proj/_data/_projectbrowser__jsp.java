...
public class _projectbrowser__jsp extends com.caucho.jsp.JavaPage
{
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              do {
                ...
                out.print((Util.toScreen(SystemEnv.getHtmlLabelName(Util.getIntValue(ProjectStatusComInfo.getProjectStatusname()),user.getLanguage()),user.getLanguage())));
              ...
              do {
	       	...
	       	while(ProjectTypeComInfo.next()){
                ...
                out.print((ProjectTypeComInfo.getProjectTypeid()));
                out.write(_jsp_string145, 0, _jsp_string145.length);
                if(prjtype.equalsIgnoreCase(ProjectTypeComInfo.getProjectTypeid())) {
                out.write(_jsp_string139, 0, _jsp_string139.length);
                }
                out.write('>');
                out.print((ProjectTypeComInfo.getProjectTypename()));
              ...
              do {
	       	...
	       	while(WorkTypeComInfo.next()){
                ...
                out.write(_jsp_string145, 0, _jsp_string145.length);
                if(worktype.equalsIgnoreCase(WorkTypeComInfo.getWorkTypeid())) {
                out.write(_jsp_string139, 0, _jsp_string139.length);
                }
                out.write('>');
...
tableString =   " <table instanceid=\"BrowseTable\" id=\"BrowseTable\" tabletype=\"none\" pagesize=\""+perpage+"\" >"+
      ...
      int _jspEval54 = _jsp_ViewTag_5.doStartTag();
      if (_jspEval54 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        if (_jspEval54 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
          ...
          _jsp_ViewTag_5.setBodyContent(_jsp_endTagHack52);
        ...
        do {
          ...
          int _jspEval57 = _jsp_GroupTag_6.doStartTag();
          if (_jspEval57 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspEval57 == javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_BUFFERED) {
              ...
              _jsp_GroupTag_6.setBodyContent(_jsp_endTagHack55);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("proj/data/ProjectBrowser.jsp"), 8971598040608797856L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string139 = "selected".toCharArray();
    ...
    _jsp_string129 = "\" class=\"e8_btn_top\"  onclick=\"submitData()\"/>\r\n			<span title=\"".toCharArray();
    ...
    _jsp_string136 = "' class=\"InputStyle\">".toCharArray();
    ...
    _jsp_string135 = "<input name=name value='".toCharArray();
    _jsp_string50 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    ...
    _jsp_string153 = "\" id=\"zd_btn_submit\" class=\"zd_btn_submit\" onclick=\"btnclear_onclick();\">\r\n		    	<input type=\"button\" accessKey=T  id=btncancel value=\"".toCharArray();
    _jsp_string144 = "		  \r\n	          <option value=\"".toCharArray();

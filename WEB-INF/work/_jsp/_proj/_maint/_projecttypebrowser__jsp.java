...
public class _projecttypebrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(!description.equals("")){
	if(ishead==0){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("proj")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelNames("586",user.getLanguage()) , null), false);
...
tableString =   " <table instanceid=\"BrowseTable\" id=\"BrowseTable\" tabletype=\"none\" pagesize=\""+perpage+"\" >"+
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("proj/Maint/ProjectTypeBrowser.jsp"), -174216401970299660L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string130 = "\" class=\"e8_btn_top\"  onclick=\"submitData()\"/>\r\n			<span title=\"".toCharArray();
    ...
    _jsp_string137 = "<input name=description value='".toCharArray();
    ...
    _jsp_string40 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string135 = "<input name=fullname value='".toCharArray();
    ...
    _jsp_string141 = "\" id=\"zd_btn_submit\" class=\"zd_btn_submit\" onclick=\"submitClear();\">\r\n		    	<input type=\"button\" accessKey=T  id=btncancel value=\"".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();

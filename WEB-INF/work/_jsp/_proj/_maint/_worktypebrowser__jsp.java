...
public class _worktypebrowser__jsp extends com.caucho.jsp.JavaPage
{
...
if(!description.equals("")){
	if(ishead==0){
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("proj")+ "&" + "navName=" + com.caucho.el.Expr.toString(SystemEnv.getHtmlLabelNames("432",user.getLanguage()) , null), false);
...
tableString =   " <table instanceid=\"BrowseTable\" id=\"BrowseTable\" tabletype=\"none\" pagesize=\""+perpage+"\" >"+
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("proj/Maint/WorkTypeBrowser.jsp"), 2401788008837457661L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string143 = "\" id=\"zd_btn_cancle\"  class=\"zd_btn_cancle\" onclick=\"dialog.close();\">\r\n			".toCharArray();
    ...
    _jsp_string142 = "\" id=\"zd_btn_submit\" class=\"zd_btn_submit\" onclick=\"submitClear();\">\r\n		    	<input type=\"button\" accessKey=T  id=btncancel value=\"".toCharArray();
    _jsp_string2 = "\r\n\r\n".toCharArray();

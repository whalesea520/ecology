...
package _jsp._pweb._careerapply;
...
public class _hrmcareerinviteweb__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.hrm.job.EducationLevelComInfo EduLevelComInfo;
      EduLevelComInfo = (weaver.hrm.job.EducationLevelComInfo) pageContext.getAttribute("EduLevelComInfo");
      if (EduLevelComInfo == null) {
        EduLevelComInfo = new weaver.hrm.job.EducationLevelComInfo();
        pageContext.setAttribute("EduLevelComInfo", EduLevelComInfo);
      }
...
String sqlstr = "select * from HrmCareerInvite where isweb = 1";
      ...
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelName(1859,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelName(416,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelName(1860,user.getLanguage())));
      out.write(_jsp_string68, 0, _jsp_string68.length);
      out.print((SystemEnv.getHtmlLabelName(17883,user.getLanguage())));
...
if(i==0){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("pweb/careerapply/HrmCareerInviteWeb.jsp"), 7052193021222957023L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string72 = "\r\n    <TD><a href='/pweb/careerapply/HrmCareerApplyViewDetail.jsp?paraid=".toCharArray();

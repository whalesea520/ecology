...
public class _menumaintenanceshareoperation__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
    ...
    if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string53, 0, _jsp_string53.length);
      weaver.page.menu.MenuShareCominfo MenuShareCominfo;
      MenuShareCominfo = (weaver.page.menu.MenuShareCominfo) pageContext.getAttribute("MenuShareCominfo");
      if (MenuShareCominfo == null) {
        MenuShareCominfo = new weaver.page.menu.MenuShareCominfo();
        pageContext.setAttribute("MenuShareCominfo", MenuShareCominfo);
      }
      out.write(_jsp_string53, 0, _jsp_string53.length);
...
if(method.equals("delShare")){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("systeminfo/menuconfig/MenuMaintenanceShareOperation.jsp"), -7315455638025436567L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);

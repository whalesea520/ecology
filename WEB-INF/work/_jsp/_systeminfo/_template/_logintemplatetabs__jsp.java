...
public class _logintemplatetabs__jsp extends com.caucho.jsp.JavaPage
{
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(172,user.getLanguage())+SystemEnv.getHtmlLabelName(1014,user.getLanguage()) ));
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
			...
			if(tempatename.equals("")){
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelName(129976,user.getLanguage()) ));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
      ...
      out.print((SystemEnv.getHtmlLabelName(32459,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("systeminfo/template/loginTemplateTabs.jsp"), -5488095977314928905L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string141 = "'><img src=\"/images/BacoError_wev8.gif\" align=\"absMiddle\"></span>\r\n	".toCharArray();
    ...
    _jsp_string140 = "\r\n        <span id=\"saveAsNameSpan\" style='display:".toCharArray();
    ...
    _jsp_string148 = "&init=true\" id=\"tabcontentframe\" name=\"tabcontentframe\" class=\"flowFrame\" frameborder=\"0\" height=\"100%\" width=\"100%;\" ></iframe>\r\n</div>\r\n</div>\r\n</body>\r\n</html>\r\n\r\n<script language=\"javascript\">\r\njQuery(function(){\r\n    jQuery('.e8_box').Tabs({\r\n        getLine:1,\r\n        iframe:\"tabcontentframe\",\r\n        mouldID:\"".toCharArray();
    _jsp_string121 = "\"></td>\r\n							".toCharArray();
    ...
    _jsp_string136 = "\r\n    ".toCharArray();
    _jsp_string143 = "\r\n		<input type=\"text\" class=\"inputstyle\" name=\"domainName\" id =\"domainName\" value=\"".toCharArray();
    _jsp_string2 = "\r\n	<script language=\"javascript\">\r\n		window.top.Dialog.alert(\"".toCharArray();
    ...
    _jsp_string139 = "\" style=\"width:200px!important\" onchange=\"checkinput('templatename','saveAsNameSpan')\">\r\n		".toCharArray();
    _jsp_string144 = "\" style=\"width:200px!important\">\r\n	".toCharArray();

...
public class _portaltemplate__jsp extends com.caucho.jsp.JavaPage
{
...
if (transitionTime != null && !transitionTime.equals("") && !transitionTime.equals("0")) {
      ...
      out.write(_jsp_string52, 0, _jsp_string52.length);
      weaver.general.BaseBean bean;
      bean = (weaver.general.BaseBean) pageContext.getAttribute("bean");
      if (bean == null) {
        bean = new weaver.general.BaseBean();
      ...
      out.write(_jsp_string52, 0, _jsp_string52.length);
      weaver.splitepage.transform.SptmForSystemTemplate SptmForSystemTemplate;
      SptmForSystemTemplate = (weaver.splitepage.transform.SptmForSystemTemplate) pageContext.getAttribute("SptmForSystemTemplate");
      if (SptmForSystemTemplate == null) {
        SptmForSystemTemplate = new weaver.splitepage.transform.SptmForSystemTemplate();
        pageContext.setAttribute("SptmForSystemTemplate", SptmForSystemTemplate);
      }
...
if(templateType.equals("ecology8")){
	...
	url= "/wui/theme/office/page/main.jsp?templateid="+templateid;
      ...
      pageContext.include("/systeminfo/commonTabHead.jsp", "mouldID=" + ("portal")+ "&" + "navName=" + com.caucho.el.Expr.toString(tempatename , null), false);
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((theme8.get("id") ));
      out.write(_jsp_string147, 0, _jsp_string147.length);
      out.print((theme8.get("name") ));
      ...
      out.print((theme7.get("id") ));
      out.write(_jsp_string147, 0, _jsp_string147.length);
      out.print((theme7.get("name") ));
      out.write(_jsp_string148, 0, _jsp_string148.length);
      out.print((i+1 ));
      out.write(_jsp_string153, 0, _jsp_string153.length);
      out.print((theme7.get("preview") ));
      ...
      out.print((SystemEnv.getHtmlLabelName(33809,user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelName(28050,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("systeminfo/template/PortalTemplate.jsp"), 5187087779610072784L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    _jsp_string168 = "']\").find(\".themeimg\").addClass(\"themeimgOver\");\r\n    $(\".themeitem[type='".toCharArray();
    _jsp_string19 = "&f_weaver_belongto_usertype=".toCharArray();
    _jsp_string103 = "\r\n		return false;\r\n		".toCharArray();
    _jsp_string167 = "'][skin='".toCharArray();
    ...
    _jsp_string138 = "\" id=\"zd_btn_submit_0\" class=\"e8_btn_top\" onclick=\"doSaveAndEnable()\">\r\n							".toCharArray();
    ...
    _jsp_string161 = "\r\n					".toCharArray();
    _jsp_string142 = "\" id=\"zd_btn_submit_0\" class=\"e8_btn_top\" onclick=\"doDel()\">						\r\n						".toCharArray();
    ...
    _jsp_string148 = "\">\r\n							<div class=\"themeindex\">\r\n								".toCharArray();
    _jsp_string183 = "\"; \r\n 	showDialogMax(title,url,700,500,true);\r\n}\r\n\r\nfunction doSaveAs(){\r\n	\r\n	\r\n	var url = \"/systeminfo/template/templateSaveAs.jsp?from=edit&id=".toCharArray();
    ...
    _jsp_string187 = "',templateid:'".toCharArray();
    _jsp_string132 = "&nbsp;:&nbsp;&nbsp;&nbsp;</span>\r\n										<span class=\"STYLE61\" id=\"result11\"></span>\r\n									</td>\r\n								</tr>\r\n								<tr>\r\n									<td style=\"WORD-WRAP: break-word;TEXT-VALIGN: left;word-break:break-all;\">\r\n										<span class=\"STYLE6\">".toCharArray();
    _jsp_string169 = "']\").find(\".themeindex\").addClass(\"themeindexOver\");\r\n    var top = $(\".themeitem[type='".toCharArray();
    ...
    _jsp_string181 = "&subcompanyId=".toCharArray();
    ...
    _jsp_string174 = "&skin=\"+skin;\r\n    	}else if(type==\"ecology7\"){\r\n    		url= \"/systeminfo/template/PortalTemplateEditor.jsp?subCompanyId=".toCharArray();
    _jsp_string140 = "\" id=\"zd_btn_submit_0\" class=\"e8_btn_top\" onclick=\"dosubmit()\">	\r\n						<input type=\"button\" value=\"".toCharArray();
    _jsp_string123 = "\"></td>\r\n							".toCharArray();
    _jsp_string180 = "'},\r\n			function(){\r\n				top.getDialog(window).currentWindow.document.location.reload();\r\n				dialog = top.getDialog(window);\r\n				dialog.close();\r\n			});\r\n		})\r\n}\r\n    \r\nfunction doPreview(){\r\n	\r\n	url = '/systeminfo/template/templatePreview.jsp?from=edit&id=".toCharArray();
    ...
    _jsp_string176 = "&subCompanyId=".toCharArray();
    _jsp_string4 = "\";\r\n		});		\r\n	</script>\r\n	".toCharArray();
    ...
    _jsp_string173 = "&skin=\"+skin+\"&e=\"+new Date().getTime();\r\n    	}else if(type==\"ecology8\"){\r\n    		url = \"/systeminfo/template/PortalTemplateE8Editor.jsp?subCompanyId=".toCharArray();
    _jsp_string112 = "\r\n	_menuDocument.getElementById(\"rightMenu\").style.visibility=\"visible\";\r\n	if (!_menuWindow.ActiveXObject) {\r\n		_menuDocument.getElementById(\"rightMenu\").style.display=\"\";\r\n	}\r\n	".toCharArray();
    _jsp_string33 = "\");\r\n							}\r\n						}else{\r\n							try{\r\n								window.top.Dialog.alert(\"".toCharArray();
    _jsp_string136 = "\" id=\"zd_btn_submit_0\" class=\"e8_btn_top\" onclick=\"doPreview()\">\r\n						".toCharArray();
    ...
    _jsp_string145 = "\r\n				</div>\r\n				".toCharArray();
    _jsp_string179 = "\",function(){\r\n			$.post(\"/systeminfo/template/templateOperation.jsp\",\r\n			{operationType:'delete',templateid:'".toCharArray();
    ...
    _jsp_string189 = "},\r\n		function(){\r\n			$(\"#tabcontentframe\").attr(\"src\",url)\r\n	});\r\n   	$.post(\"/systeminfo/template/PortalTemplateOperation.jsp\",{method:'updateThemeInfo',templatetype:templatetype,skin:skin,id:".toCharArray();
    _jsp_string41 = "\";\r\n  var str1 = \"".toCharArray();
    _jsp_string153 = "\r\n							</div>\r\n							<div class=\"themeimg\" >\r\n								<img style=\"padding-top:5px;padding-left: 5px;\" width=\"118px\" height=\"68px\" src=\"".toCharArray();
    ...
    _jsp_string171 = "\";\r\n    	\r\n    	if(type==\"ecologyBasic\"){\r\n    		url = \"/systeminfo/template/PortalTemplateBasicEditor.jsp?subCompanyId=".toCharArray();
    ...
    _jsp_string147 = "\" extendtempletid=\"0\" title=\"".toCharArray();
    ...
    _jsp_string160 = "\r\n						<div class=\"themeitem\" type=office skin=\"".toCharArray();
    _jsp_string14 = "\\r\\n\\r\\n".toCharArray();
    _jsp_string156 = "\r\n						<div class=\"themeitem\" type=\"ecologyBasic\" skin=\"".toCharArray();
    ...
    _jsp_string146 = "\r\n						<div class=\"themeitem\" type=\"ecology8\" skin=\"".toCharArray();
    ...
    _jsp_string191 = "},\r\n		function(){\r\n			$(\"#tabcontentframe\").attr(\"src\",url)\r\n	});\r\n   	$.post(\"/systeminfo/template/PortalTemplateOperation.jsp\",{method:'updateThemeInfoandenable',templatetype:templatetype,skin:skin,id:".toCharArray();
    ...
    _jsp_string93 = "px\">\r\n</iframe>\r\n</div>\r\n".toCharArray();
    _jsp_string172 = "&templateid=".toCharArray();

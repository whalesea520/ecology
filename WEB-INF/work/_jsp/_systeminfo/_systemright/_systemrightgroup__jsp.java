...
public class _systemrightgroup__jsp extends com.caucho.jsp.JavaPage
{
...
session.setAttribute("SESSION_TEMP_CURRENT_SKIN", curskin);
	...
	String needhelp ="1";
      ...
      out.print((SystemEnv.getHtmlLabelNames("93,492",user.getLanguage())));
      ...
      out.print((SystemEnv.getHtmlLabelNames("492,84",user.getLanguage())));
      out.write(_jsp_string76, 0, _jsp_string76.length);
      out.print((id));
      out.write(_jsp_string75, 0, _jsp_string75.length);
      out.print((SystemEnv.getHtmlLabelNames("440,1331",user.getLanguage())));
...
if(userightmenu!=1){
	...
	if(realPath.indexOf("/workflow/request/AddRequest")!=-1||realPath.indexOf("/workflow/request/ManageRequest")!=-1||realPath.indexOf("/workflow/request/ViewRequest")!=-1){
      ...
      out.print((SystemEnv.getHtmlLabelName(33363, user.getLanguage())+"("+allAuthSize+")"));
        ...
        do {
          ...
          if (_jspEval5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jsp_ItemTag_2.doInitBody();
              do {
                out.print((SystemEnv.getHtmlLabelNames("492,85",user.getLanguage())));
              } while (_jsp_ItemTag_2.doAfterBody() == javax.servlet.jsp.tagext.IterationTag.EVAL_BODY_AGAIN);
              out = pageContext.popBody();
              _jsp_ItemTag_2.doEndTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("systeminfo/systemright/SystemRightGroup.jsp"), 9156278280511310008L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string74 = "' == '9999' || '".toCharArray();
    ...
    _jsp_string15 = "\\r\\n\\r\\n".toCharArray();
    _jsp_string160 = "<input type=\"text\" id=\"rightgroupname\" name=\"rightgroupname\" class=\"inputStyle\" value=\"\">".toCharArray();
    _jsp_string62 = "\r\n<!-- \u9875\u9762\u5207\u6362\u6548\u679cEnd -->\r\n\r\n\r\n<script language=\"javascript\">\r\n\r\n//------------------------------\r\n// the folder of current skins \r\n//------------------------------\r\n//\u5f53\u524d\u4f7f\u7528\u7684\u4e3b\u9898\r\nvar GLOBAL_CURRENT_THEME = \"".toCharArray();
    _jsp_string159 = "<input type=\"text\" id=\"rightgroupmark\" name=\"rightgroupmark\" class=\"inputStyle\" value=\"\">".toCharArray();
    ...
    _jsp_string72 = "' == 'f' || '".toCharArray();
    _jsp_string67 = "\");\r\n					return;\r\n				}\r\n				if(id.match(/,$/)){\r\n					id = id.substring(0,id.length-1);\r\n				}\r\n				window.top.Dialog.confirm(\"".toCharArray();
    _jsp_string58 = "\r\n<meta http-equiv=\"".toCharArray();
    _jsp_string70 = "\");\r\n			}\r\n			\r\n			function doShowDetail(id){\r\n				if(id == \"9980\"){\r\n					id = \"-2\";\r\n				}\r\n				todo(\"/hrm/HrmDialogTab.jsp?_fromURL=systemRightGroup&method=edit&showpage=2&id=\"+id,\"".toCharArray();
    _jsp_string153 = "\r\n						<input type=button class=\"e8_btn_top\" onclick=\"doShowAuth();\" value=\"".toCharArray();
    ...
    _jsp_string122 = ";\r\n	".toCharArray();
    _jsp_string69 = "\");\r\n			}\r\n			\r\n			function doEdit(id){\r\n				if(id == \"9980\"){\r\n					id = \"-2\";\r\n				}\r\n				todo(\"/hrm/HrmDialogTab.jsp?_fromURL=systemRightGroup&method=edit&showpage=1&id=\"+id,\"".toCharArray();

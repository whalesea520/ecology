...
public class _version__jsp extends com.caucho.jsp.JavaPage
{
...
if (RecordSet.next())
{
	...
	cversion=RecordSet.getString("cversion");
      ...
      out.print((SystemEnv.getHtmlLabelName(16899,user.getLanguage())));
      out.write(_jsp_string74, 0, _jsp_string74.length);
      out.print((SystemEnv.getHtmlLabelName(16897,user.getLanguage())));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("systeminfo/version.jsp"), -3336787041965198307L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string75 = ":</span>&nbsp;<a href=\"http://www.weaver.com.cn\" target=\"_blank\"><span class=\"style04\">www.weaver.com.cn</span></a>\r\n		</div>\r\n	</div>\r\n	<div style=\"width:1px;height:20px!important;float:left;\"></div>\r\n	<div style=\"clear:both;\"></div>\r\n	<div style=\"width: 100%;height:30px;margin-top:35px;\">\r\n		<div style=\"float:right;width:70px;height:30px;margin-right:35px;\">\r\n			<button name=\"submit\" onclick=\"dialog.closeByHand()\" style=\"width:70px;height:30px;background-color:#018df7;\">".toCharArray();
    ...
    _jsp_string74 = "&nbsp;&nbsp;&copy;&nbsp;&nbsp;Shanghai Weaver Network Co., Ltd</span>\r\n		</div>\r\n		<div style=\"float:right;margin-right:35px;\">\r\n			<span class=\"style03\">".toCharArray();
